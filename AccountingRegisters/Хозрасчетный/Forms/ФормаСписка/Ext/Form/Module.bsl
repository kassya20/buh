...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.СписокНадписьНУ.Видимость = БухгалтерскийУчетКлиентСервер.ИспользоватьСуммуНУ(ВидИспользованияСумм);

	ЕстьСуммыРазниц = БухгалтерскийУчетКлиентСервер.ИспользоватьСуммыРазниц(ВидИспользованияСумм);
	Элементы.СписокНадписьПР.Видимость = ЕстьСуммыРазниц;
	Элементы.СписокНадписьВР.Видимость = ЕстьСуммыРазниц;
