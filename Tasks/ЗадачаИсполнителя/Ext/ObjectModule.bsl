...
Процедура ПередЗаписью(Отказ)
	...
	Если ИсходныеРеквизиты.ПометкаУдаления <> ПометкаУдаления И ЗначениеЗаполнено(БизнесПроцесс) Тогда
		БизнесПроцессыИЗадачиСервер.ПриПометкеУдаленияЗадачи(Ссылка, ПометкаУдаления);
	КонецЕсли;
	
	Если Не ЗначениеЗаполнено(СтатусЗадачи) Тогда
		СтатусЗадачи = Перечисления.СтатусЗадачи.НеВыполнена;
	КонецЕсли;
	
	Если ЗначениеЗаполнено(БизнесПроцесс) Тогда
		Если Выполнена Тогда
			СтатусЗадачи = Перечисления.СтатусЗадачи.Выполнена;
		КонецЕсли;
	Иначе
		Если СтатусЗадачи = Перечисления.СтатусЗадачи.Выполнена Тогда
			Выполнена = Истина;
		ИначеЕсли СтатусЗадачи = Перечисления.СтатусЗадачи.Отменена Тогда
			Выполнена = Истина;
		ИначеЕсли СтатусЗадачи = Перечисления.СтатусЗадачи.НеВыполнена Тогда
			Выполнена = Ложь;
		Иначе
			Выполнена = Ложь;
		КонецЕсли;
...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	Если НЕ ЗначениеЗаполнено(СостояниеБизнесПроцесса) И ЗначениеЗаполнено(БизнесПроцесс) Тогда
		СостояниеБизнесПроцесса = Перечисления.СостоянияБизнесПроцессов.Активен;
	КонецЕсли;
