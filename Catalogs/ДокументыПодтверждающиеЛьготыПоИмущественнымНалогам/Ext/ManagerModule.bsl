...
//  			 Если ОсновноеСредство не указано, то функция вернет общее количество документов по организации, включая те,
	//  			 которые распорастраняются на конкретные объекты налогообложения данной организации. 
//  Период - дата - дата, на которую определяется действие льгот
//  ОсновноеСредство - СправочникСсылка.ОсновныеСредства - объект налогообложения, по которому нужно посчитать документы
// 
