...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИначеЕсли ТекущаяДатаПользователя < '2021-10-01' Тогда
		ПериодНачалаДействия = "2017";
	ИначеЕсли ТекущаяДатаПользователя < '2022-05-01' Тогда
		ПериодНачалаДействия = "2021";
	Иначе
		ПериодНачалаДействия = "2022";
	КонецЕсли;
