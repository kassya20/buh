...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ФормаСоздатьРегистрация.Видимость = Не РежимВыбора;
	Элементы.ФормаСоздатьСнятиеСРегистрации.Видимость = Не РежимВыбора;
	...
	ПравоРедактированияРегистраций = ПравоДоступа("Редактирование", Метаданные.РегистрыСведений.РегистрацияЗемельныхУчастков);
	
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
					Элементы,
					"ФормаСоздатьРегистрация",
					"Видимость",
					ПравоРедактированияРегистраций);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
					Элементы,
					"ФормаСоздатьСнятиеСРегистрации",
					"Видимость",
					ПравоРедактированияРегистраций);
...
Процедура АдаптироватьМККонтекстСписокФормы()
	...
	МобильныйКлиентБПФормаОбъекта.ПереместитьЭлементФормы(Элементы,
		Элементы.ФормаСоздатьРегистрация,
		Элементы.Список.КонтекстноеМеню);
	МобильныйКлиентБПФормаОбъекта.ПереместитьЭлементФормы(Элементы,
		Элементы.ФормаСоздатьСнятиеСРегистрации,
		Элементы.Список.КонтекстноеМеню);
...
Процедура АдаптироватьМКСписокФормы()
	...
	МобильныйКлиентБПФормаСписка.ВстроитьЭлементВГруппуМК_Важное(ЭтотОбъект, Элементы.КадастровыйНомер);
