...
// Возвращает массив или список стран мира, являющиеся государствами-членоми таможенного союза (ЕАЭС)
...
//
// Возвращаемое значение:
//  Массив         - страны мира, являющиеся государствами-членоми таможенного союза (ЕАЭС),
//                   если параметр ВыводитьВВидеСписка = ЛОЖЬ.
//                   Элементы массива:
//                   * - СправочникСсылка.СтраныМира - страна мира.
//  СписокЗначений - страны мира, являющиеся государствами-членоми таможенного союза (ЕАЭС),
//                   если параметр ВыводитьВВидеСписка = Истина.
//                   Элементы списка:
//                   * - СправочникСсылка.СтраныМира - страна мира.
Функция СтраныЕАЭС(Знач ВыводитьВВидеСписка = Ложь) Экспорт
