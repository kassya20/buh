...
Процедура УправлениеФормой(Форма);
	...
	ИначеЕсли Форма.ОписаниеТипа.СодержитТип(Тип("СправочникСсылка.НазначенияИспользованияНоменклатуры")) Тогда
...
Процедура СвязьПоВладельцуНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ИначеЕсли ОписаниеТипа.СодержитТип(Тип("СправочникСсылка.НазначенияИспользованияНоменклатуры")) Тогда
