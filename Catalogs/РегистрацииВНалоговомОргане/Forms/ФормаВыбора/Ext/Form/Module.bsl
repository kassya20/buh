...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ПолучитьФункциональнуюОпцию("РасширенныйФункционал") Тогда
		Если Параметры.Отбор.Свойство("КрупнейшийНалогоплательщик") Тогда
			
			ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
				Список, "КрупнейшийНалогоплательщик", Параметры.Отбор.КрупнейшийНалогоплательщик, , , Истина,
				РежимОтображенияЭлементаНастройкиКомпоновкиДанных.Недоступный);
			
			Параметры.Отбор.Удалить("КрупнейшийНалогоплательщик");
