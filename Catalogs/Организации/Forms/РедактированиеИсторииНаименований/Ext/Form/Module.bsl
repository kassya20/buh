...
Процедура ИсторияНаименованийНаименованиеСокращенноеПриИзменении(Элемент)
	...
	Если НЕ ЭтоФизическоеЛицо Тогда
		Если ПустаяСтрока(ТекущиеДанные.НаименованиеПолное)
			Или ОбщегоНазначенияБПКлиентСервер.ПолноеНаименованиеСоответствуетСокращенномуНаименованию(НаименованиеСокращенноеДоИзменения, ТекущиеДанные.НаименованиеПолное) Тогда
			ТекущиеДанные.НаименованиеПолное = ОбщегоНазначенияБПКлиентСервер.ПолноеНаименованиеПоСокращенномуНаименованию(ТекущиеДанные.НаименованиеСокращенное);
		КонецЕсли;
	КонецЕсли;
...
Процедура ФИОПриИзменении()
	...
	Если ЗначениеЗаполнено(ТекущиеДанные.ФамилияИП)
		...
		ИЛИ ЗначениеЗаполнено(ТекущиеДанные.ОтчествоИП) Тогда
			...
			ТекущиеДанные.НаименованиеСокращенное = ОбщегоНазначенияБПКлиентСервер.СокращенноеНаименованиеИндивидуальногоПредпринимателя(
									ТекущиеДанные.ФамилияИП, ТекущиеДанные.ИмяИП, ТекущиеДанные.ОтчествоИП);
			ТекущиеДанные.НаименованиеПолное = ОбщегоНазначенияБПКлиентСервер.ПолноеНаименованиеИндивидуальногоПредпринимателя(
									ТекущиеДанные.ФамилияИП, ТекущиеДанные.ИмяИП, ТекущиеДанные.ОтчествоИП);
