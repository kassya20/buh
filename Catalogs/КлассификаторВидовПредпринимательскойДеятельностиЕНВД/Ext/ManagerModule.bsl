...
Процедура Обновить() Экспорт
	...
	Для Каждого СтрокаКлассификатора Из ТаблицаКлассификатора Цикл
		...
		Если ЗначениеЗаполнено(СтрокаКлассификатора.ФизическийПоказатель) Тогда
			Объект.ИмяФизическогоПоказателя = Перечисления.ФизическиеПоказатели[СтрокаКлассификатора.ФизическийПоказатель];
		КонецЕсли;
