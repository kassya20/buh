...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ОбновитьБанкиИзКлассификатора", Истина);
	Методы.Вставить("УстановитьСтрануВБанках");
...
Функция ПолучитьТаблицуБанковПоРеквизитам(Поле, Значение, Валютный = Ложь, ТаможенныйСоюз = Ложь) Экспорт
	...
	Колонки.Добавить("РучноеИзменение");
	...
	ТаблицаБанков.Сортировать("Код, РучноеИзменение");
...
Функция ОбновитьБанкиИзКлассификатора() Экспорт
	
	Результат = Новый Структура();
	
	УспешноОбновлены = РаботаСБанкамиБП.ОбновитьБанкиИзКлассификатора();
	Результат.Вставить("УспешноОбновлены", УспешноОбновлены);
...
Функция ПолучитьРезультатЗапросаПоКлассификатору(Код, КоррСчет)
	...
	Если ЗначениеЗаполнено(КоррСчет) Тогда
		...
		Отбор.КоррСчет.ВидСравнения = ВидСравнения.Равно;
