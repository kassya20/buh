...
Процедура НачальноеЗаполнение() Экспорт
	...
	Для Каждого ЭлементКлассификатора Из ДанныеМакетаКлассификатора Цикл
		...
		ИзвестнаяПричина = Неопределено;
		Если ЗначениеЗаполнено(ЭлементКлассификатора.ErroneousCode) Тогда
			ИзвестнаяПричина = ИзвестныеПричины.Найти(ЭлементКлассификатора.ErroneousCode, "Код");
		КонецЕсли;
