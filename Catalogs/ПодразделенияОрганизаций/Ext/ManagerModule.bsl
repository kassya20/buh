...
// Определяет использование обособленных подразделений, не выделенных на отдельный баланс, с учетом
// тарификации и функциональной опции ВестиУчетПоПодразделениям
//
// Параметры:
//  Организация - СправочникСсылка.Организации - Организация, для которой проверяется использование
// 
// Возвращаемое значение:
//  Булево - признак использования обособленных подразделений
//
Функция ИспользуютсяОбособленныеПодразделенияНеВыделенныеНаОтдельныйБаланс(Организация) Экспорт
	
	ОбособленныеПодразделенияИспользуются = Ложь;
	
	УчетОбособленныхПодразделений.ПроверитьИспользованиеОбособленныхПодразделенийНеВыделенныхНаОтдельныйБаланс(
		ОбособленныеПодразделенияИспользуются, Организация);
	
	Возврат ОбособленныеПодразделенияИспользуются;
	
КонецФункции

// Возвращает список обособленных подразделений, не выделенных на отдельный баланс.
//
// Параметры:
//  Организация - СправочникСсылка.Организации
// 
// Возвращаемое значение:
//  Массив - список подразделений
//
Функция ОбособленныеПодразделенияНеВыделенныеНаОтдельныйБаланс(Организация) Экспорт
	
	СписокПодразделений = Новый Массив;
	
	УчетОбособленныхПодразделений.ОбособленныеПодразделенияНеВыделенныеНаОтдельныйБаланс(СписокПодразделений, Организация);
...
Функция СоздатьОсновноеПодразделение(Организация, ОбменДаннымиЗагрузка = Ложь) Экспорт
	...
	Подразделение.Наименование = НаименованиеПодразделенияПоУмолчанию();
...
Функция НаименованиеПодразделенияПоУмолчанию() Экспорт
	
	Возврат НСтр("ru='Основное подразделение'");
