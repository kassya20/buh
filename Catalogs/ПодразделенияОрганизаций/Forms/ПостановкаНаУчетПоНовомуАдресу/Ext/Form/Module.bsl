...
Процедура ОбновитьРегистрациюВНалоговомОргане(Форма, КПП, КодНалоговогоОргана, НоваяРегистрация)
	...
	НастроитьРеквизитыПредставителя(Форма);
...
Функция СведенияОНалоговомОрганеПоАдресу(НовыйАдресЗначениеАдресаJSON)
	...
	СведенияОНалоговомОрганеПоАдресу = АдресныйКлассификатор.КодыАдреса(НовыйАдресЗначениеАдресаJSON, АдресныйКлассификаторБП.ИсточникПолученияСведенийОбАдресныхСведениях());
...
Процедура НастроитьРеквизитыПредставителя(Форма)
	...
	СведенияОПредставителях = РегистрацияВНОСервер.СведенияОПодписантахПоРегистрации(Форма.РегистрацияВНалоговомОргане);
	Форма.ОписаниеПредставителейПодписанияОтчетности = РегистрацияВНОСервер.ОписаниеПредставителей(СведенияОПредставителях);
