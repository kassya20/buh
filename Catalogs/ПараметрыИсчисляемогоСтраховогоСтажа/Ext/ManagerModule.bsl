...
Процедура НачальноеЗаполнение() Экспорт
	...
	УстановитьРеквизитыИспользования2023();
...
Процедура УстановитьРеквизитыИспользования2023() 
	
	ОбновитьОбъектКлассификатора("КВАЛИФОБ", "Повышение квалификации с отрывом от производства (профессиональное обучение или дополнительное профессиональное образование)", Истина);
	ОбновитьОбъектКлассификатора("КВАЛИФОЦ", "Повышение квалификации с отрывом от производства (прохождение независимой оценки квалификации)", Истина);
	ОбновитьОбъектКлассификатора("ДИСПР", "Период прохождения диспансеризации", Истина);
