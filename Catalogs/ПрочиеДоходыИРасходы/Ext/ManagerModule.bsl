...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("НазначитьПредопределенныеЭлементы");
	Методы.Вставить("ОбновитьРеквизиты_РезервыПоОплатеТруда");
	Методы.Вставить("УстановитьВидСтатьиДоходовИзлишкиПриИнвентаризацииОтложенно");
	Методы.Вставить("СоздатьПредопределенныеЭлементыДляОсновныхСредств");
	Методы.Вставить("ОбновитьРеквизиты_СтатьиПроцентовПоЗаймамИЛизингу");
	Методы.Вставить("УстановитьНУСтатьеИзменениеСтоимостиПредметовАренды");
	Методы.Вставить("ОбновитьРеквизиты_ДоходыПоАвансамПрошлогоНалоговогоПериодаИП");
	Методы.Вставить("СоздатьПредопределенныеЭлементыДляРеализацииЧерезКомиссионеров");
	Методы.Вставить("ВключитьНастройкуПорядкаЭлементов");
...
Процедура ЗаполнитьОписанияПоставляемыхЭлементов(ОписаниеЭлементов) Экспорт
	...
	// Процентные расходы (аренда, лизинг)
	ОписаниеЭлемента = ДобавитьОписаниеПоставляемогоЭлемента(
		ОписаниеЭлементов,
		"ПроцентныеРасходы",
		Перечисления.ВидыПрочихДоходовИРасходов.ПроцентыКУплате,
		"ru = 'Процентные расходы (аренда, лизинг)'",
		"",
		Истина);
	...
	ОписаниеЭлемента = ДобавитьОписаниеПоставляемогоЭлемента(
		ОписаниеЭлементов,
		"ПроцентыКПолучениюУплате",
		Перечисления.ВидыПрочихДоходовИРасходов.ПроцентыКПолучениюУплате,
		"ru = 'Проценты к получению, уплате (до 2025 г.)'",
		"",
		Ложь);
	
	// Проценты к получению (депозиты, займы выданные)
	ОписаниеЭлемента = ДобавитьОписаниеПоставляемогоЭлемента(
		ОписаниеЭлементов,
		"ПроцентыКПолучению",
		Перечисления.ВидыПрочихДоходовИРасходов.ПроцентыКПолучению,
		"ru = 'Проценты к получению (депозиты, займы выданные)'",
		"",
		Истина);
	
	// Проценты к уплате (кредиты, займы полученные)
	ОписаниеЭлемента = ДобавитьОписаниеПоставляемогоЭлемента(
		ОписаниеЭлементов,
		"ПроцентыКУплате",
		Перечисления.ВидыПрочихДоходовИРасходов.ПроцентыКУплате,
		"ru = 'Проценты к уплате (кредиты, займы полученные)'",
		"",
		Истина);
	...
	ОписаниеЭлемента = ДобавитьОписаниеПоставляемогоЭлемента(
		...
		"ru = 'Ликвидация основных средств'",
		"ru = 'Документ ""Списание ОС""'",
		Истина);
	ОписаниеЭлемента.Функциональность.Добавить("ВедетсяУчетОсновныхСредств");
	...
	ОписаниеЭлемента = ДобавитьОписаниеПоставляемогоЭлемента(
		...
		"ru = 'Документ ""Реализация (акт, накладная, УПД)"", если счет доходов от реализации 91'",
		Истина);
	...
	ОписаниеЭлемента = ДобавитьОписаниеПоставляемогоЭлемента(
		...
		Перечисления.ВидыПрочихДоходовИРасходов.ИзлишкиПриИнвентаризации,
		"ru = 'Пересортица товаров (оприходование)'");
	ОписаниеЭлемента.Функциональность.Добавить("ИспользоватьДокументыПоступления");
	...
	ОписаниеЭлемента = ДобавитьОписаниеПоставляемогоЭлемента(
		...
		"ru = 'Пересортица товаров (списание)'");
	ОписаниеЭлемента.Функциональность.Добавить("ИспользоватьДокументыПоступления");
	ОписаниеЭлемента.Реквизиты.Вставить("ПринятиеКНалоговомуУчету", Ложь);
	...
	ОписаниеЭлемента.Функциональность.Добавить("ВестиУчетРасчетовСКонтрагентами");
	...
	ОписаниеЭлемента = ДобавитьОписаниеПоставляемогоЭлемента(
		...
		"ШтрафыПоНалогам",
		Перечисления.ВидыПрочихДоходовИРасходов.ПрочиеВнереализационныеДоходыРасходы,
		"ru = 'Штрафы по налогам и сборам'");
	ОписаниеЭлемента.Реквизиты.Вставить("ПринятиеКНалоговомуУчету", Ложь);
	
	// Проценты по налогам к уплате. Расходы принимаются к НУ.
	ОписаниеЭлемента = ДобавитьОписаниеПоставляемогоЭлемента(
		ОписаниеЭлементов,
		"ПроцентыПоНалогамКУплате",
		Перечисления.ВидыПрочихДоходовИРасходов.ПрочиеВнереализационныеДоходыРасходы,
		"ru = 'Проценты по налогам и сборам к уплате'");
	
	// Проценты по налогам к получению. Доходы не принимаются к НУ.
	ОписаниеЭлемента = ДобавитьОписаниеПоставляемогоЭлемента(
		ОписаниеЭлементов,
		"ПроцентыПоНалогамКПолучению",
		Перечисления.ВидыПрочихДоходовИРасходов.ПрочиеВнереализационныеДоходыРасходы,
		"ru = 'Проценты по налогам и сборам к получению'");
	ОписаниеЭлемента.Реквизиты.Вставить("ПринятиеКНалоговомуУчету", Ложь);
	
	// Госпошлины по судебным спорам
	ОписаниеЭлемента = ДобавитьОписаниеПоставляемогоЭлемента(
		ОписаниеЭлементов,
		"ГосПошлиныПоСудебнымСпорам",
		Перечисления.ВидыПрочихДоходовИРасходов.ПрочиеВнереализационныеДоходыРасходы,
		"ru = 'Государственные пошлины по судебным спорам'");
	...
	ОписаниеЭлемента = ДобавитьОписаниеПоставляемогоЭлемента(
		...
		Перечисления.ВидыПрочихДоходовИРасходов.ПрочиеВнереализационныеДоходыРасходы,
		"ru = 'Оценочные обязательства по оплате труда'");
	ОписаниеЭлемента.Функциональность.Добавить("ВедетсяУчетЗарплатыКадров");
	
	// Оценочные обязательства по предстоящим отпускам (ЕНВД)
	ОписаниеЭлемента = ДобавитьОписаниеПоставляемогоЭлемента(
		ОписаниеЭлементов,
		"РезервыПоОплатеТрудаЕНВД",
		Перечисления.ВидыПрочихДоходовИРасходов.ПрочиеВнереализационныеДоходыРасходы,
		"ru = 'Оценочные обязательства по оплате труда (ЕНВД)'");
	...
	// Изменение стоимости предметов аренды.
	// Используется при уменьшении обязательства по аренде сверх балансовой стоимости ППА, п.21 ФСБУ 25.
	// Принимается к НУ, так как уменьшение расходов в БУ приведет к моменту окончания аренды или выкупа предмета лизинга
	// к соответствующему уменьшению расходов НУ, разница в доходах и расходах - временная.
	ОписаниеЭлемента = ДобавитьОписаниеПоставляемогоЭлемента(
		ОписаниеЭлементов,
		"ИзменениеСтоимостиПредметовАренды",
		Перечисления.ВидыПрочихДоходовИРасходов.ПереоценкаВнеоборотныхАктивов,
		"ru = 'Изменение стоимости предметов аренды'");
	ОписаниеЭлемента.Функциональность.Добавить("ВедетсяУчетПредметовАренды");
	ОписаниеЭлемента.Функциональность.Добавить("ВедетсяУчетЛизинговогоИмущества");
	...
	ОписаниеЭлемента = ДобавитьОписаниеПоставляемогоЭлемента(
		...
		Перечисления.ВидыПрочихДоходовИРасходов.ПрочиеВнереализационныеДоходыРасходы,
		"ru = 'Списание товаров у комиссионера'",
		"ru = 'Документ ""Отчет комиссионера о списании""'",
		Истина);
	ОписаниеЭлемента.Функциональность.Добавить("ОсуществляетсяРеализацияТоваровУслугЧерезКомиссионеров");
	ОписаниеЭлемента.Функциональность.Добавить("ИспользоватьПродажиЧерезМаркетплейс");
	...
	// Расходы на НИОКР, относящиеся к стадии исследования
	ОписаниеЭлемента = ДобавитьОписаниеПоставляемогоЭлемента(
		ОписаниеЭлементов,
		"СобственныеИсследования",
		Перечисления.ВидыПрочихДоходовИРасходов.ПрочиеОперационныеДоходыРасходы,
		"ru = 'Расходы на НИОКР, относящиеся к стадии исследования'");
	ОписаниеЭлемента.Функциональность.Добавить("ВедетсяУчетНМА");
	
	// Доходы и расходы при переходе с УСН на ОСН
	ОписаниеЭлемента = ДобавитьОписаниеПоставляемогоЭлемента(
		ОписаниеЭлементов,
		"ДоходыРасходыПриПереходеСУСННаОСНО",
		Перечисления.ВидыПрочихДоходовИРасходов.ПрибыльУбытокПрошлыхЛет,
		"ru = 'Доходы и расходы при переходе с УСН на ОСН'");
...
Процедура СоздатьПредопределенныеЭлементыДляОсновныхСредств() Экспорт
	
	Если Константы.ВедетсяУчетОсновныхСредств.Получить() Тогда
...
Процедура СоздатьПредопределенныеЭлементыДляРеализацииЧерезКомиссионеров() Экспорт
	
	Если Константы.ОсуществляетсяРеализацияТоваровУслугЧерезКомиссионеров.Получить() Тогда
		КлассификаторыДоходовРасходов.ОбеспечитьФункциональность(
			Справочники.ПрочиеДоходыИРасходы,
...
Процедура СоздатьПредопределенныеЭлементыДляПродажиЧерезМаркетплейс() Экспорт
	
	Если Константы.ИспользоватьПродажиЧерезМаркетплейс.Получить() Тогда
		КлассификаторыДоходовРасходов.ОбеспечитьФункциональность(
			Справочники.ПрочиеДоходыИРасходы,
...
Процедура УстановитьНУСтатьеИзменениеСтоимостиПредметовАренды(Параметры) Экспорт
	
	Ссылка = ОбщегоНазначения.ПредопределенныйЭлемент("Справочник.ПрочиеДоходыИРасходы.ИзменениеСтоимостиПредметовАренды");
	
	Если Не ЗначениеЗаполнено(Ссылка) Тогда
		// Статья еще не создана.
	...
	ЭлементБлокировки = Блокировка.Добавить("Справочник.ПрочиеДоходыИРасходы");
	...
	Исключение
		...
		ШаблонОшибки = НСтр("ru = 'Ошибка при выполнении обработчика %1
			|%2'", ОбщегоНазначения.КодОсновногоЯзыка());
		ПредставлениеОшибки = СтрШаблон(
			ШаблонОшибки,
			"Справочники.ПрочиеДоходыИРасходы.УстановитьНУСтатьеИзменениеСтоимостиПредметовАренды",
...
Процедура ОбновитьРеквизиты_РезервыПоОплатеТруда() Экспорт
...
// Выполняет обновление реквизитов элементов ПроцентныеРасходы и ПроцентыКПолучениюУплате
//
Процедура ОбновитьРеквизиты_СтатьиПроцентовПоЗаймамИЛизингу() Экспорт
	...
	// Процентные расходы (аренда, лизинг)
	ОбновитьРеквизитыПредопределенногоЭлементаСПроверкой("ПроцентныеРасходы");
	
	// Проценты к получению, уплате (до 2025 г.)
	ОбновитьРеквизитыПредопределенногоЭлементаСПроверкой("ПроцентыКПолучениюУплате");
	
	// Если в БД ранее был создан элемент ПроцентыКПолучениюУплате, на замену
	// создадим два новых элемента, ПроцентыКПолучению и ПроцентыКУплате
	ИмяЭлемента = "Справочник.ПрочиеДоходыИРасходы.ПроцентыКПолучениюУплате";
	Элемент = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент(ИмяЭлемента);
	Если ЗначениеЗаполнено(Элемент) Тогда
		Справочники.ПрочиеДоходыИРасходы.ПредопределенныйЭлемент("ПроцентыКПолучению");
		Справочники.ПрочиеДоходыИРасходы.ПредопределенныйЭлемент("ПроцентыКУплате")
	КонецЕсли;
	
КонецПроцедуры

// Добавляет предопределенный элемент ДоходыИРасходыПриПереходеСУСННаОСНО
//
Процедура ДобавитьРеквизит_ДоходыИРасходыПриПереходеСУСННаОСНО() Экспорт
	...
	ИмяЭлемента = "Справочник.ПрочиеДоходыИРасходы.ДоходыРасходыПриПереходеСУСННаОСНО";
	Элемент = ОбщегоНазначения.ПредопределенныйЭлемент(ИмяЭлемента);
	Если Элемент = Неопределено Тогда
		Справочники.ПрочиеДоходыИРасходы.ПредопределенныйЭлемент("ДоходыРасходыПриПереходеСУСННаОСНО");
	КонецЕсли;
...
// Выполняет обновление реквизитов предопределенного элемента справочника, если он существует в базе
// реквизиты обновляются согласно заданного описания (см. ЗаполнитьОписанияПоставляемыхЭлементов()) 
//
// Параметры:
//  ИмяЭлемента	- Строка - имя предопределенного элемента справочника ПрочиеДоходыИРасходы
//
Процедура ОбновитьРеквизитыПредопределенногоЭлементаСПроверкой(ИмяЭлемента)
	
	ИмяДляПоиска = СтрШаблон("Справочник.ПрочиеДоходыИРасходы.%1", ИмяЭлемента);
	
	Элемент = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент(ИмяДляПоиска);
	Если ЗначениеЗаполнено(Элемент) Тогда
		КлассификаторыДоходовРасходов.ОбновитьРеквизитыКлассификатора(
			Справочники.ПрочиеДоходыИРасходы,
			ИмяЭлемента);
