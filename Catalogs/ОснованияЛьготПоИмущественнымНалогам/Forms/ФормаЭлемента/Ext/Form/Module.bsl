...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Объект.УстановленаМестнымНормативнымАктом Тогда
		...
		КодРегиона = XMLСтрока(Объект.КодРегиона);
		НастройкиУчетаНалогаНаПрибыльФормы.ЗаполнитьСписокВыбораРегиона(
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если ТекущийОбъект.УстановленаМестнымНормативнымАктом Тогда
		ТекущийОбъект.ОснованиеМестнойЛьготы = ЛьготыПоИмущественнымНалогамКлиентСервер.ОснованиеМестнойЛьготыСтрокой(
...
Процедура ЗаполнитьСписокРегионовСервер(СписокРегионов)
	НастройкиУчетаНалогаНаПрибыльФормы.ЗаполнитьСписокВыбораРегиона(СписокРегионов);
КонецПроцедуры
