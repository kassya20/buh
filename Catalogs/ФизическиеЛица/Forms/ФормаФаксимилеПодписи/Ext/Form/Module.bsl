...
Процедура УстановитьКартинкуВЭлементе(ФайлКартинки)
	...
	Модифицированность = Истина;
	УстановитьКартинкуНаФорме(АдресФаксимилеПодписи, ФайлКартинки);
	Если Не ЗначениеЗаполнено(АдресФаксимилеПодписи) Тогда
		ФайлКартинки = "";
	КонецЕсли;
...
Функция ПолучитьКартинку(ФайлКартинки, УникальныйИдентификатор)
	...
	Если ПроверитьРазмерКартинки(ДанныеКартинки) Тогда
