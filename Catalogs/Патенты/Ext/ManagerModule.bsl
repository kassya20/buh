...
// Устарела. Следует использовать Документы.ОперацияСПатентом.РеквизитыНалоговогоПлатежа
//
Функция РеквизитыНалоговогоПлатежа(Патент) Экспорт
	...
	|	ВЫБОР
	|		КОГДА Патенты.УдалитьПостановкаНаУчетВНалоговомОргане = ЗНАЧЕНИЕ(Перечисление.ПостановкаНаУчетВНалоговомОргане.ВДругомНалоговомОргане)
	|			ТОГДА Патенты.УдалитьНалоговыйОрган.Код
	|		ИНАЧЕ Патенты.Владелец.РегистрацияВНалоговомОргане.Код
	|	КОНЕЦ КАК КодНалоговогоОргана,
	|	ВЫБОР
	|		КОГДА Патенты.УдалитьПостановкаНаУчетВНалоговомОргане = ЗНАЧЕНИЕ(Перечисление.ПостановкаНаУчетВНалоговомОргане.ВДругомНалоговомОргане)
	|			ТОГДА Патенты.УдалитьКодПоОКТМО
	...
	|	ВЫБОР
	|		КОГДА Патенты.УдалитьПостановкаНаУчетВНалоговомОргане = ЗНАЧЕНИЕ(Перечисление.ПостановкаНаУчетВНалоговомОргане.ВДругомНалоговомОргане)
	|			ТОГДА Патенты.УдалитьНалоговыйОрган
	|		ИНАЧЕ Патенты.Владелец.РегистрацияВНалоговомОргане
