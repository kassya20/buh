...
Функция СформироватьТаблицуСчетовУчета(Номенклатура, СчетаУчетаСкрытьНеИспользуемые)
	...
	|	СчетаУчетаНоменклатуры.СчетУчетаАкцизаПоРеализации КАК СчетУчетаАкцизаПоРеализации,
	|	СчетаУчетаНоменклатуры.СчетУчетаАкцизаПоИмпорту КАК СчетУчетаАкцизаПоИмпорту
	|ИЗ
