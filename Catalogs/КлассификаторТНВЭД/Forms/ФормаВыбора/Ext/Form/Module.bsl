...
Функция ДобавитьЭлементКлассификатора(СвойстваЭлемента)
	...
	ЭлементТНВЭД = Справочники.КлассификаторТНВЭД.СоздатьОбновитьЭлементКлассификатора(
		СвойстваЭлемента);
