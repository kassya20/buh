...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		...
		ЭтотОбъект.ТолькоПросмотр = ТолькоПросмотр Или НЕ ОбъектДоступен;
	КонецЕсли;
...
Процедура ПриЗакрытии(ЗавершениеРаботы)
	...
	Если ОбъектДоступен Тогда
		РазблокироватьБанковскийСчетПриРедактированииНаСервере(Объект.Ссылка, УникальныйИдентификатор);
	КонецЕсли;
...
Функция РазблокироватьБанковскийСчетПриРедактированииНаСервере(Ссылка, УникальныйИдентификатор)
