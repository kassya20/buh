...
Процедура ЗаполнитьЗначенияПараметров()
	...
	Если КадровыеДанные <> Неопределено Тогда
		...
		УстановитьЗначение(ЭтотОбъект, "ДанныеСотрудникаПодразделениеОрганизации", КадровыеДанные.Подразделение);
	...
	Если ЗначениеЗаполнено(КадровыеДанные.Подразделение) Тогда
		ДополнитьСклонениямиОбъекта("ДанныеСотрудникаПодразделениеОрганизации", КадровыеДанные.Подразделение);
	КонецЕсли;
