...
Функция ДанныеШаблоновДокументовДляПубликации(Ссылки) Экспорт
	...
	|	ВЫБОР
	|		КОГДА ШаблоныДокументов.ВидДокумента.ВариантПодписания = ЗНАЧЕНИЕ(Перечисление.ВариантыПодписанияДокументовЭДОБЗК.Требуется)
	|			ТОГДА ИСТИНА
	|		ИНАЧЕ ЛОЖЬ
	|	КОНЕЦ КАК ТребуетПодписания,
...
Функция ОписаниеРеквизитаШаблонаДокументов(ДанныеРеквизита)
	...
	Если ЗначениеЗаполнено(ДоступныеЗначения) Тогда
		Если ОписаниеРеквизита.Тип = Перечисления.ТипыРеквизитовШаблоновДокументов.Строка
			Или ОписаниеРеквизита.Тип = Перечисления.ТипыРеквизитовШаблоновДокументов.Текст Тогда
...
Процедура ГруппаУсловийИзJSON(КоллекцияЭлементовОтбора, УсловияВывода, ТипГруппы = Неопределено)
	...
	Для Каждого ОписаниеУсловия Из УсловияВывода.Элементы Цикл
		Если ОписаниеУсловия.ЭтоГруппа Тогда
			ГруппаУсловийИзJSON(ГруппаОбласти.Элементы, ОписаниеУсловия, ТипГруппыЭлементовОтбораИзJSON(ОписаниеУсловия.ТипГруппы));
		Иначе
			...
			ЭлементОтбора.ВидСравнения = ВидСравненияИзJSON(ОписаниеУсловия.ВидСравнения);
...
Функция ТипГруппыЭлементовОтбораИзJSON(JSONТипГруппы)
	Если JSONТипГруппы = "ТипГруппыЭлементовОтбораКомпоновкиДанных.ГруппаИли" Тогда
		Возврат ТипГруппыЭлементовОтбораКомпоновкиДанных.ГруппаИли;
	ИначеЕсли JSONТипГруппы = "ТипГруппыЭлементовОтбораКомпоновкиДанных.ГруппаИ" Тогда
		Возврат ТипГруппыЭлементовОтбораКомпоновкиДанных.ГруппаИ;
	ИначеЕсли JSONТипГруппы = "ТипГруппыЭлементовОтбораКомпоновкиДанных.ГруппаНе" Тогда
		Возврат ТипГруппыЭлементовОтбораКомпоновкиДанных.ГруппаНе;
	КонецЕсли;
	Возврат Неопределено;
КонецФункции

Функция ВидСравненияИзJSON(JSONВидСравнения)
	Если JSONВидСравнения = "ВидСравненияКомпоновкиДанных.Больше" Тогда
		Возврат ВидСравненияКомпоновкиДанных.Больше
	ИначеЕсли JSONВидСравнения = "ВидСравненияКомпоновкиДанных.БольшеИлиРавно" Тогда
		Возврат ВидСравненияКомпоновкиДанных.БольшеИлиРавно
	ИначеЕсли JSONВидСравнения = "ВидСравненияКомпоновкиДанных.ВИерархии" Тогда
		Возврат ВидСравненияКомпоновкиДанных.ВИерархии
	ИначеЕсли JSONВидСравнения = "ВидСравненияКомпоновкиДанных.ВСписке" Тогда
		Возврат ВидСравненияКомпоновкиДанных.ВСписке
	ИначеЕсли JSONВидСравнения = "ВидСравненияКомпоновкиДанных.ВСпискеПоИерархии" Тогда
		Возврат ВидСравненияКомпоновкиДанных.ВСпискеПоИерархии
	ИначеЕсли JSONВидСравнения = "ВидСравненияКомпоновкиДанных.Заполнено" Тогда
		Возврат ВидСравненияКомпоновкиДанных.Заполнено
	ИначеЕсли JSONВидСравнения = "ВидСравненияКомпоновкиДанных.Меньше" Тогда
		Возврат ВидСравненияКомпоновкиДанных.Меньше
	ИначеЕсли JSONВидСравнения = "ВидСравненияКомпоновкиДанных.МеньшеИлиРавно" Тогда
		Возврат ВидСравненияКомпоновкиДанных.МеньшеИлиРавно
	ИначеЕсли JSONВидСравнения = "ВидСравненияКомпоновкиДанных.НачинаетсяС" Тогда
		Возврат ВидСравненияКомпоновкиДанных.НачинаетсяС
	ИначеЕсли JSONВидСравнения = "ВидСравненияКомпоновкиДанных.НеВИерархии" Тогда
		Возврат ВидСравненияКомпоновкиДанных.НеВИерархии
	ИначеЕсли JSONВидСравнения = "ВидСравненияКомпоновкиДанных.НеВСписке" Тогда
		Возврат ВидСравненияКомпоновкиДанных.НеВСписке
	ИначеЕсли JSONВидСравнения = "ВидСравненияКомпоновкиДанных.НеВСпискеПоИерархии" Тогда
		Возврат ВидСравненияКомпоновкиДанных.НеВСпискеПоИерархии
	ИначеЕсли JSONВидСравнения = "ВидСравненияКомпоновкиДанных.НеЗаполнено" Тогда
		Возврат ВидСравненияКомпоновкиДанных.НеЗаполнено
	ИначеЕсли JSONВидСравнения = "ВидСравненияКомпоновкиДанных.НеНачинаетсяС" Тогда
		Возврат ВидСравненияКомпоновкиДанных.НеНачинаетсяС
	ИначеЕсли JSONВидСравнения = "ВидСравненияКомпоновкиДанных.НеПодобно" Тогда
		Возврат ВидСравненияКомпоновкиДанных.НеПодобно
	ИначеЕсли JSONВидСравнения = "ВидСравненияКомпоновкиДанных.НеРавно" Тогда
		Возврат ВидСравненияКомпоновкиДанных.НеРавно
	ИначеЕсли JSONВидСравнения = "ВидСравненияКомпоновкиДанных.НеСодержит" Тогда
		Возврат ВидСравненияКомпоновкиДанных.НеСодержит
	ИначеЕсли JSONВидСравнения = "ВидСравненияКомпоновкиДанных.Подобно" Тогда
		Возврат ВидСравненияКомпоновкиДанных.Подобно
	ИначеЕсли JSONВидСравнения = "ВидСравненияКомпоновкиДанных.Равно" Тогда
		Возврат ВидСравненияКомпоновкиДанных.Равно
	ИначеЕсли JSONВидСравнения = "ВидСравненияКомпоновкиДанных.Содержит" Тогда
...
Процедура ЗаполнитьТребуетПодписания(ПараметрыОбновления = Неопределено) Экспорт
	...
	Запрос.Текст =
		...
		|	И НЕ ШаблоныДокументов.УдалитьТребуетПодписания";
	...
	Пока Выборка.Следующий() Цикл
		...
		СправочникОбъект.УдалитьТребуетПодписания = Истина;
...
Процедура ОбновитьПредопределенныеШаблоны_3_2_0(ПараметрыОбновления = Неопределено) Экспорт

	Справочники.ШаблоныДокументов.ОбновитьПредопределенныйШаблонДокумента("ЗаявлениеНаОтмену", ПараметрыОбновления);
	Справочники.ШаблоныДокументов.ОбновитьПредопределенныйШаблонДокумента("ЗаявлениеВПроизвольнойФорме", ПараметрыОбновления);

КонецПроцедуры

Процедура ОбновитьПредопределенныеШаблоны_3_4_0(ПараметрыОбновления = Неопределено) Экспорт
	
	Справочники.ШаблоныДокументов.ОбновитьПредопределенныйШаблонДокумента("ЗаявлениеНаОтмену", ПараметрыОбновления);
	Справочники.ШаблоныДокументов.ОбновитьПредопределенныйШаблонДокумента("ЗаявлениеОСпособеВыплатыЗарплаты", ПараметрыОбновления);
