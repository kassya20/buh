...
&НаКлиенте
Процедура СоздатьДоговорНаЗакупкуУслугУСамозанятого(Команда)
	
	ОткрытьВыбранныйШаблон("ДоговорНаЗакупкуУслугУСамозанятого");
...
&НаКлиенте
Процедура СоздатьДополнительноеСоглашениеОбИзмененииСрокаДействия(Команда)
	
	ОткрытьВыбранныйШаблон("ДополнительноеСоглашениеОбИзмененииСрокаДействия");
	
КонецПроцедуры

&НаКлиенте
Процедура СоздатьДополнительноеСоглашениеОбИзмененииСуммы(Команда)
	
	ОткрытьВыбранныйШаблон("ДополнительноеСоглашениеОбИзмененииСуммы");
