...
Процедура ПослеЗагрузкиДанных()
	...
	Если Не ЭтотОбъект.ЭтотУзел Тогда
...
Процедура ПослеВыгрузкиДанных()
	...
	Если ТарификацияБПВызовСервераПовтИсп.ИспользуетсяНедоступнаяФункциональность()
		Или ТарификацияБПВызовСервераПовтИсп.ИспользуетсяНедоступнаяСистемаНалогообложения()
