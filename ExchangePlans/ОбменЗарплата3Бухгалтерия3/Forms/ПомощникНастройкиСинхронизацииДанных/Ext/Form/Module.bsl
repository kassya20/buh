...
&НаКлиенте
Функция СтраницаОжидание_ДлительнаяОперация(Отказ, ПерейтиДалее)
...
&НаКлиенте
Функция СтраницаДатаНачалаИспользованияОбмена_ПроверкаЗаполнения(Отказ)
	...
	Если ЭтоПереходДалее Тогда
		...
		Если СтрокиПерехода.Количество() > 0 Тогда
			...
			Если Не ПустаяСтрока(СтрокаПерехода.ИмяОбработчикаПриПереходеДалее)
				...
				Отказ = Ложь;
				СтраницаДатаНачалаИспользованияОбмена_ПроверкаЗаполнения(Отказ);
...
Процедура ВыполнитьОбработчикДлительнойОперации()
	...
	Если Не ПустаяСтрока(СтрокаПереходаТекущая.ИмяОбработчикаДлительнойОперации) Тогда
		...
		Отказ = Ложь;
		ПерейтиДалее = Истина;
		СтраницаОжидание_ДлительнаяОперация(Отказ, ПерейтиДалее);
