...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ЗаполнитьУстанавливатьПечатьПрефиксаИБДокументов");
	Методы.Вставить("ОтключитьРегистрациюДокументовДляОбменаСУНФ");
	Методы.Вставить("ОтключитьПечатьПрефиксовИБДляОбменаСУНФ");
	Методы.Вставить("СкорректироватьПравилаОтправкиЦенПриОбменеСЗУП");
	Методы.Вставить("ИзменитьИдентификаторИНастройкиОбменаСКассой");
	Методы.Вставить("ВключитьОбменСправочникамиСЗУП");
...
Процедура ПриПолученииНастроек(Настройки) Экспорт
	...
	ВерсииФормата.Вставить("1.10", МенеджерОбменаЧерезУниверсальныйФормат13);
	ВерсииФормата.Вставить("1.11", МенеджерОбменаЧерезУниверсальныйФормат13);
	ВерсииФормата.Вставить("1.12", МенеджерОбменаЧерезУниверсальныйФормат13);
	ВерсииФормата.Вставить("1.15", МенеджерОбменаЧерезУниверсальныйФормат13);
	ВерсииФормата.Вставить("1.16", МенеджерОбменаЧерезУниверсальныйФормат13);
	ВерсииФормата.Вставить("1.17", МенеджерОбменаЧерезУниверсальныйФормат13);
	ВерсииФормата.Вставить("1.19", МенеджерОбменаЧерезУниверсальныйФормат13);
	ВерсииФормата.Вставить("1.20", МенеджерОбменаЧерезУниверсальныйФормат13);
	ВерсииФормата.Вставить("1.21", МенеджерОбменаЧерезУниверсальныйФормат13);
	ВерсииФормата.Вставить("1.22", МенеджерОбменаЧерезУниверсальныйФормат13);
...
Процедура ПриПолученииВариантовНастроекОбмена(ВариантыНастроекОбмена, ПараметрыКонтекста) Экспорт
	...
	Если НЕ ЗначениеЗаполнено(ПараметрыКонтекста.ИмяКорреспондента) Тогда
		...
		ВариантНастройки.ИдентификаторНастройки        = "ОбменУТБ_БП3";
	...
	Если ПараметрыКонтекста.ИмяКорреспондента = "УправлениеТорговлей"
		...
		ВариантНастройки = ВариантыНастроекОбмена.Добавить();
		ВариантНастройки.ИдентификаторНастройки        = "ОбменУТ_БП3";
		ВариантНастройки.КорреспондентВМоделиСервиса   = Истина;
		ВариантНастройки.КорреспондентВЛокальномРежиме = Истина;
	...
	Если ПараметрыКонтекста.ИмяКорреспондента = "УправлениеПредприятием"
		...
		ВариантНастройки = ВариантыНастроекОбмена.Добавить();
		ВариантНастройки.ИдентификаторНастройки        = "ОбменERP_БП3";
		ВариантНастройки.КорреспондентВМоделиСервиса   = Истина;
		ВариантНастройки.КорреспондентВЛокальномРежиме = Истина;
	...
	Если Метаданные.Имя <> "БухгалтерияПредприятияКОРП" Тогда
		...
		Если ПараметрыКонтекста.ИмяКорреспондента = "УправлениеНебольшойФирмой"
			ИЛИ НЕ ЗначениеЗаполнено(ПараметрыКонтекста.ИмяКорреспондента) Тогда
			ВариантНастройки = ВариантыНастроекОбмена.Добавить();
			ВариантНастройки.ИдентификаторНастройки        = ИдентификаторОбменаСУНФ();
			ВариантНастройки.КорреспондентВМоделиСервиса   = Истина;
			ВариантНастройки.КорреспондентВЛокальномРежиме = Истина;
		КонецЕсли;
	...
	Если ПараметрыКонтекста.ИмяКорреспондента = "Розница"
		ИЛИ НЕ ЗначениеЗаполнено(ПараметрыКонтекста.ИмяКорреспондента) Тогда
		ВариантНастройки = ВариантыНастроекОбмена.Добавить();
		ВариантНастройки.ИдентификаторНастройки        = ИдентификаторОбменаСРозницей();
		ВариантНастройки.КорреспондентВМоделиСервиса   = Истина;
		ВариантНастройки.КорреспондентВЛокальномРежиме = Истина;
	КонецЕсли;
	...
	Если ПараметрыКонтекста.ИмяКорреспондента = "Касса"
		...
		ВариантНастройки = ВариантыНастроекОбмена.Добавить();
		ВариантНастройки.ИдентификаторНастройки        = ПланыОбмена.СинхронизацияДанныхЧерезУниверсальныйФормат.ИдентификаторОбменаСКассой();
		ВариантНастройки.КорреспондентВМоделиСервиса   = Истина;
	...
	Если Метаданные.Имя = "БухгалтерияПредприятияКОРП" Тогда
		...
		Если ЭтоКонфигурацияДокументооборота(ПараметрыКонтекста.ИмяКорреспондента)
			ИЛИ НЕ ЗначениеЗаполнено(ПараметрыКонтекста.ИмяКорреспондента) Тогда
			ВариантНастройки = ВариантыНастроекОбмена.Добавить();
			ВариантНастройки.ИдентификаторНастройки        = ИдентификаторОбменаСДокументооборотом();
			ВариантНастройки.КорреспондентВМоделиСервиса   = Истина;
			ВариантНастройки.КорреспондентВЛокальномРежиме = Истина;
		КонецЕсли;
...
Процедура ПриПолученииОписанияВариантаНастройки(ОписаниеВарианта, ИдентификаторНастройки, ПараметрыКонтекста) Экспорт
	...
	Если ЭтоОбмен_УТ_Базовая(ИдентификаторНастройки) Тогда
	...
	ИначеЕсли ЭтоОбмен_УТ(ИдентификаторНастройки) Тогда
		КраткаяИнформацияПоОбмену = НСтр("ru = 'Данная настройка позволит синхронизировать данные между программами ""Бухгалтерия предприятия, редакция 3.0""
		|и ""1С:Управление торговлей, редакция 11"". В синхронизации участвуют документы и нормативно-справочная информация.'");
	ИначеЕсли ЭтоОбмен_УП(ИдентификаторНастройки) Тогда
		КраткаяИнформацияПоОбмену = НСтр("ru = 'Данная настройка позволит синхронизировать данные между программами ""Бухгалтерия предприятия, редакция 3.0""
		|и ""1С:ERP Управление предприятием 2.0"". В синхронизации участвуют документы и нормативно-справочная информация.'");
	ИначеЕсли ЭтоОбмен_УФН(ИдентификаторНастройки) Тогда
		КраткаяИнформацияПоОбмену = НСтр("ru = 'Данная настройка позволит синхронизировать данные между программами ""Бухгалтерия предприятия, редакция 3.0""
		|и ""1С:Управление нашей фирмой 3.0"". В синхронизации участвуют документы и нормативно-справочная информация.'");
	ИначеЕсли ЭтоОбмен_Розница(ИдентификаторНастройки) Тогда
		КраткаяИнформацияПоОбмену = НСтр("ru = 'Данная настройка позволит синхронизировать данные между программами ""Бухгалтерия предприятия, редакция 3.0""
		|и ""1С:Розница, редакция 3.0"". В синхронизации участвуют документы и нормативно-справочная информация.'");
	ИначеЕсли ИдентификаторНастройки = ПланыОбмена.СинхронизацияДанныхЧерезУниверсальныйФормат.ИдентификаторОбменаСКассой() Тогда
		КраткаяИнформацияПоОбмену = НСтр("ru = 'Данная настройка позволит синхронизировать данные между программами ""Бухгалтерия предприятия, редакция 3.0""
		|и ""1С:Касса"". В синхронизации участвуют документы и нормативно-справочная информация.'");
	ИначеЕсли ИдентификаторНастройки = ПланыОбмена.СинхронизацияДанныхЧерезУниверсальныйФормат.ИдентификаторОбменаСМобильнойКассой() Тогда
		КраткаяИнформацияПоОбмену = НСтр("ru = 'Данная настройка позволит синхронизировать данные между программами ""Бухгалтерия предприятия, редакция 3.0""
	...
	ИначеЕсли ИдентификаторНастройки = "ОбменЗУПБП" Тогда
		КраткаяИнформацияПоОбмену = НСтр("ru = 'Данная настройка позволит синхронизировать данные между программами ""Бухгалтерия предприятия, редакция 3.0""
		|и ""Зарплата и управление персоналом, редакция 3.1"". В синхронизации участвуют документы и нормативно-справочная информация.'");
	ИначеЕсли ЭтоОбмен_ДО(ИдентификаторНастройки) Тогда
		КраткаяИнформацияПоОбмену = НСтр("ru = 'Данная настройка позволит синхронизировать данные между программами ""Бухгалтерия предприятия, редакция 3.0""
		|и ""Документооборот, редакция 3"". В синхронизации участвуют документы и нормативно-справочная информация.'");
	Иначе
	...
	ИначеЕсли ЭтоОбмен_УФН(ИдентификаторНастройки) Тогда
		...
		ОписаниеВарианта.ЗаголовокКомандыДляСозданияНовогоОбменаДанными = НСтр("ru = '1С:Управление нашей фирмой 3.0'");
		ОписаниеВарианта.ЗаголовокПомощникаСозданияОбмена =               НСтр("ru = 'Настройка синхронизации с программой ""1С:Управление нашей фирмой 3.0""'");
		ОписаниеВарианта.ЗаголовокУзлаПланаОбмена =                       НСтр("ru = 'Синхронизация с программой ""1С:Управление нашей фирмой 3.0""'");
		ОписаниеВарианта.НаименованиеКонфигурацииКорреспондента =         НСтр("ru = '1С:Управление нашей фирмой 3.0'");
	ИначеЕсли ЭтоОбмен_Розница(ИдентификаторНастройки) Тогда
		ОписаниеВарианта.ИмяКонфигурацииКорреспондента = "Розница";
		ОписаниеВарианта.ЗаголовокКомандыДляСозданияНовогоОбменаДанными = НСтр("ru = '1С:Розница, редакция 3.0'");
		ОписаниеВарианта.ЗаголовокПомощникаСозданияОбмена =               НСтр("ru = 'Настройка синхронизации с программой ""1С:Розница, редакция 3.0""'");
		ОписаниеВарианта.ЗаголовокУзлаПланаОбмена =                       НСтр("ru = 'Синхронизация с программой ""1С:Розница, редакция 3.0""'");
		ОписаниеВарианта.НаименованиеКонфигурацииКорреспондента =         НСтр("ru = '1С:Розница, редакция 3.0'");
	ИначеЕсли ИдентификаторНастройки = ПланыОбмена.СинхронизацияДанныхЧерезУниверсальныйФормат.ИдентификаторОбменаСКассой() Тогда
	...
	ИначеЕсли ИдентификаторНастройки = "ОбменЗУПБП" Тогда
		...
		ОписаниеВарианта.ЗаголовокКомандыДляСозданияНовогоОбменаДанными = НСтр("ru = '1С:Зарплата и управление персоналом, редакция 3.1. Обмен с использованием универсального формата обмена ""Enterprise Data""'");
		ОписаниеВарианта.ЗаголовокПомощникаСозданияОбмена =               НСтр("ru = 'Настройка синхронизации с программой ""1С:Зарплата и управление персоналом, редакция 3.1""'");
		ОписаниеВарианта.ЗаголовокУзлаПланаОбмена =                       НСтр("ru = 'Синхронизация с программой ""1С:Зарплата и управление персоналом, редакция 3.1""'");
		ОписаниеВарианта.НаименованиеКонфигурацииКорреспондента =         НСтр("ru = '1С:Зарплата и управление персоналом, редакция 3.1'");
	ИначеЕсли ЭтоОбмен_ДО(ИдентификаторНастройки) Тогда
		ОписаниеВарианта.ИмяКонфигурацииКорреспондента = "Розница";
		ОписаниеВарианта.ЗаголовокКомандыДляСозданияНовогоОбменаДанными = НСтр("ru = '1С:Документооборот, редакция 3'");
		ОписаниеВарианта.ЗаголовокПомощникаСозданияОбмена =               НСтр("ru = 'Настройка синхронизации с программой ""1С:Документооборот, редакция 3""'");
		ОписаниеВарианта.ЗаголовокУзлаПланаОбмена =                       НСтр("ru = 'Синхронизация с программой ""1С:Документооборот, редакция 3""'");
		ОписаниеВарианта.НаименованиеКонфигурацииКорреспондента =         НСтр("ru = '1С:Документооборот, редакция 3'");
	Иначе
...
Функция ЭтоОбмен_УТ_Базовая(ИдентификаторНастройки) Экспорт
	
	Возврат ИдентификаторНастройки = "ОбменУТБ_БП3"
		Или ИдентификаторНастройки = "ОбменУТБП";
	
КонецФункции

Функция ЭтоОбмен_УТ(ИдентификаторНастройки) Экспорт
	
	Возврат ИдентификаторНастройки = "ОбменУТ_БП3"
		Или ИдентификаторНастройки = "ОбменУТ_БПКОРП30"
		Или ИдентификаторНастройки = "ОбменУТ11";
	
КонецФункции

Функция ЭтоОбмен_УП(ИдентификаторНастройки) Экспорт
	
	Возврат ИдентификаторНастройки = "ОбменERP_БП3"
		Или ИдентификаторНастройки = "ОбменУПБП";
	
КонецФункции

Функция ЭтоОбмен_УФН(ИдентификаторНастройки) Экспорт
	
	Возврат ИдентификаторНастройки = ИдентификаторОбменаСУНФ()
		Или ИдентификаторНастройки = "ОбменУНФ"
		Или ИдентификаторНастройки = "ОбменБП30";
	
КонецФункции

Функция ЭтоОбмен_Розница(ИдентификаторНастройки) Экспорт
	
	Возврат ИдентификаторНастройки = ИдентификаторОбменаСРозницей();
	
КонецФункции

Функция ЭтоОбмен_ДО(ИдентификаторНастройки) Экспорт
	
	Возврат ИдентификаторНастройки = ИдентификаторОбменаСДокументооборотом();
	
КонецФункции

Функция ЭтоКонфигурацияДокументооборота(ИмяКонфигурацииКорреспондента)
	
	Возврат ВРег(ИмяКонфигурацииКорреспондента) = ВРег("ДокументооборотХолдинга")
		Или ВРег(ИмяКонфигурацииКорреспондента) = ВРег("ДокументооборотКОРП")
		Или ВРег(ИмяКонфигурацииКорреспондента) = ВРег("ДокументооборотКОРПРусскийИАнглийскийИнтерфейс")
		Или ВРег(ИмяКонфигурацииКорреспондента) = ВРег("ДокументооборотПРОФ");
...
Процедура ОбработатьНастройкиТранспортаСообщенийОбмена(СтарыйУзел, НовыйУзел, ВыгружатьСообщениеПослеПерехода)
	...
	МассивДоступныеТранспортыСообщений.Добавить(Обработки.ТранспортСообщенийОбменаCOM);
	МассивДоступныеТранспортыСообщений.Добавить(Обработки.ТранспортСообщенийОбменаEMAIL);
	МассивДоступныеТранспортыСообщений.Добавить(Обработки.ТранспортСообщенийОбменаESB1C);
	МассивДоступныеТранспортыСообщений.Добавить(Обработки.ТранспортСообщенийОбменаFILE);
	МассивДоступныеТранспортыСообщений.Добавить(Обработки.ТранспортСообщенийОбменаFTP);
	МассивДоступныеТранспортыСообщений.Добавить(Обработки.ТранспортСообщенийОбменаGoogleDrive);
	МассивДоступныеТранспортыСообщений.Добавить(Обработки.ТранспортСообщенийОбменаHTTP);
	МассивДоступныеТранспортыСообщений.Добавить(Обработки.ТранспортСообщенийОбменаWS);
	МассивДоступныеТранспортыСообщений.Добавить(Обработки.ТранспортСообщенийОбменаПассивныйРежим);
	МассивДоступныеТранспортыСообщений.Добавить(Обработки.ТранспортСообщенийОбменаЯндексДиск);
	
	ТранспортНовогоУзла = Новый Массив;
	
	Блокировка = Новый БлокировкаДанных;
	ЭлементБлокировки = Блокировка.Добавить("Справочник.НастройкиТранспортаСообщенийОбмена");
	ЭлементБлокировки.УстановитьЗначение("Корреспондент", СтарыйУзел);
	...
	Запрос.УстановитьПараметр("Корреспондент", СтарыйУзел);
	...
	Попытка
		...
		Если Не РезультатЗапроса.Пустой() Тогда
			...
			ИдентификаторТранспортаПоУмолчаниюСтарый = ТранспортСообщенийОбмена.ТранспортПоУмолчанию(СтарыйУзел);
			ИдентификаторТранспортаПоУмолчаниюНовый = Неопределено;
			
			Выборка = РезультатЗапроса.Выбрать();
			
			Пока Выборка.Следующий() Цикл
				
				МенеджерТранспорта = ТранспортСообщенийОбмена.МенеджерТранспортаПоИдентификатору(Выборка.ИдентификаторТранспорта);
				
				Если МассивДоступныеТранспортыСообщений.Найти(МенеджерТранспорта) = Неопределено Тогда
					Продолжить;
				КонецЕсли;
				
				НоваяНастройка = Выборка.Ссылка.Скопировать();
				НоваяНастройка.Корреспондент = НовыйУзел;
				НоваяНастройка.Записать();
				
				Если НоваяНастройка.НастройкаПоУмолчанию Тогда
					ИдентификаторТранспортаПоУмолчаниюНовый = Выборка.ИдентификаторТранспорта;
				КонецЕсли;
				
				ТранспортНовогоУзла.Добавить(НоваяНастройка);
				
			КонецЦикла;
			
			ТранспортСообщенийОбмена.УдалитьВсеНастройкиТранспорта(СтарыйУзел);
			
			// Переопределение вида транспорта по умолчанию.
			Если ИдентификаторТранспортаПоУмолчаниюНовый = Неопределено Тогда
				
				НоваяНастройка = ТранспортНовогоУзла[0];
				НоваяНастройка.НастройкаПоУмолчанию = Истина;
				НоваяНастройка.Записать();
				
				ИдентификаторТранспортаПоУмолчаниюНовый = НоваяНастройка.ИдентификаторТранспорта;
					
				ИмяСобытияЖурналРегистрации = 
					НСтр("ru = 'Переход на синхронизацию данных через универсальный формат.Заполнение настроек транспорта сообщений'",
					ОбщегоНазначения.КодОсновногоЯзыка());
					
				Шаблон = НСтр("ru = 'Используемое ранее подключение по умолчанию недоступно для синхронизации данных через универсальный формат (%1)'",
					ОбщегоНазначения.КодОсновногоЯзыка());
				Сообщение = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Шаблон, ИдентификаторТранспортаПоУмолчаниюСтарый);
				ЗаписьЖурналаРегистрации(ИмяСобытияЖурналРегистрации, УровеньЖурналаРегистрации.Ошибка, , ,Сообщение);
					
				Шаблон = НСтр("ru = 'Взамен назначено подключение по умолчанию: %1. Необходимо проверить корректность настроек транспорта сообщений'",
					ОбщегоНазначения.КодОсновногоЯзыка());
				Сообщение = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Шаблон, ИдентификаторТранспортаПоУмолчаниюНовый);
				ЗаписьЖурналаРегистрации(ИмяСобытияЖурналРегистрации, УровеньЖурналаРегистрации.Ошибка, , ,Сообщение);
				
			КонецЕсли;
			
			Если НЕ ЗначениеЗаполнено(ИдентификаторТранспортаПоУмолчаниюНовый) Тогда
			...
			Если ЗначениеЗаполнено(ИдентификаторТранспортаПоУмолчаниюНовый)
				И Не ТранспортСообщенийОбмена.ПараметрТранспорта(ИдентификаторТранспортаПоУмолчаниюНовый, "ПрямоеПодключение") Тогда
...
Процедура ИзменитьИдентификаторИНастройкиОбменаСКассой() Экспорт
	
	Запрос = Новый Запрос();
	Запрос.Параметры.Вставить("ВариантНастройки", "ОбменКасса");
	Запрос.Параметры.Вставить("ЭтотУзел", ПланыОбмена.СинхронизацияДанныхЧерезУниверсальныйФормат.ЭтотУзел());
	Запрос.Текст =
	"ВЫБРАТЬ
	|	СинхронизацияДанныхЧерезУниверсальныйФормат.Ссылка КАК Ссылка
	...
	Пока Выборка.Следующий() Цикл
		ПланОбменаОбъект = Выборка.Ссылка.ПолучитьОбъект();
		ПланОбменаОбъект.ВариантНастройки = ИдентификаторОбменаСКассой();
		ПланОбменаОбъект.ОтправлятьСправочники = Истина;
		// Второй параметр указывается для обхода ошибки использования ОбновлениеИнформационнойБазы.ЗаписатьДанные для планов обмена.
		ОбновлениеИнформационнойБазы.ЗаписатьДанные(ПланОбменаОбъект, Истина);
	КонецЦикла;
...
Процедура ОтключитьРегистрациюДокументовДляОбменаСУНФ() Экспорт
	
	ВариантыНастройкиУНФ = Новый Массив;
	ВариантыНастройкиУНФ.Добавить("ОбменУНФ"); // Этот вариант настроек был раньше, сейчас он изменен. Но обмены тоже нужно скорректировать.
	ВариантыНастройкиУНФ.Добавить(ИдентификаторОбменаСУНФ());
	
	Запрос = Новый Запрос();
	Запрос.Параметры.Вставить("ВариантыНастройкиУНФ", ВариантыНастройкиУНФ);
	Запрос.Параметры.Вставить("ЭтотУзел", ПланыОбмена.СинхронизацияДанныхЧерезУниверсальныйФормат.ЭтотУзел());
	Запрос.Текст =
	"ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	СинхронизацияДанныхЧерезУниверсальныйФормат.Ссылка КАК Ссылка
	...
	|ГДЕ
	|	СинхронизацияДанныхЧерезУниверсальныйФормат.Ссылка <> &ЭтотУзел
	|	И СинхронизацияДанныхЧерезУниверсальныйФормат.ВариантНастройки В(&ВариантыНастройкиУНФ)
	|	И (СинхронизацияДанныхЧерезУниверсальныйФормат.ОтправлятьДокументыПокупкиПродажи
	|			ИЛИ СинхронизацияДанныхЧерезУниверсальныйФормат.ОтправлятьСкладскиеДокументы
	|			ИЛИ СинхронизацияДанныхЧерезУниверсальныйФормат.ОтправлятьАвансовыеОтчеты
	|			ИЛИ СинхронизацияДанныхЧерезУниверсальныйФормат.ОтправлятьВедомостиНаВыплатуЗарплаты
	|			ИЛИ СинхронизацияДанныхЧерезУниверсальныйФормат.ОтправлятьРегламентированныеОтчеты)";
	
	Выборка = Запрос.Выполнить().Выбрать();
	Пока Выборка.Следующий() Цикл
		ПланОбменаОбъект = Выборка.Ссылка.ПолучитьОбъект();
		ПланОбменаОбъект.ОтправлятьДокументыПокупкиПродажи = Ложь;
		ПланОбменаОбъект.ОтправлятьСкладскиеДокументы = Ложь;
		ПланОбменаОбъект.ОтправлятьАвансовыеОтчеты = Ложь;
		ПланОбменаОбъект.ОтправлятьВедомостиНаВыплатуЗарплаты = Ложь;
		ПланОбменаОбъект.ОтправлятьРегламентированныеОтчеты = Ложь;
		// Второй параметр указывается для обхода ошибки использования ОбновлениеИнформационнойБазы.ЗаписатьДанные для планов обмена.
		ОбновлениеИнформационнойБазы.ЗаписатьДанные(ПланОбменаОбъект, Истина);
	КонецЦикла;
...
Процедура ВключитьОбменСправочникамиСЗУП() Экспорт
	...
	Запрос = Новый Запрос();
	Запрос.Параметры.Вставить("ВариантНастройки", "ОбменЗУПБП");
	Запрос.Параметры.Вставить("ЭтотУзел", ПланыОбмена.СинхронизацияДанныхЧерезУниверсальныйФормат.ЭтотУзел());
	Запрос.Текст =
	"ВЫБРАТЬ
	|	СинхронизацияДанныхЧерезУниверсальныйФормат.Ссылка КАК Ссылка
	...
	|	СинхронизацияДанныхЧерезУниверсальныйФормат.Ссылка <> &ЭтотУзел
	|	И СинхронизацияДанныхЧерезУниверсальныйФормат.ВариантНастройки = &ВариантНастройки
	|	И НЕ СинхронизацияДанныхЧерезУниверсальныйФормат.ОтправлятьСправочники
...
Процедура СкорректироватьПравилаОтправкиЦенПриОбменеСЗУП() Экспорт
	...
	Запрос.Параметры.Вставить("ВариантНастройки", "ОбменЗУПБП");
	Запрос.Параметры.Вставить("ЭтотУзел", ПланыОбмена.СинхронизацияДанныхЧерезУниверсальныйФормат.ЭтотУзел());
	Запрос.Параметры.Вставить("ПравилаОтправкиЦен", ПравилаОтправкиЦен);
	Запрос.Параметры.Вставить("РежимВыгрузкиЦен", РежимВыгрузкиЦен);
	Запрос.Текст =
	"ВЫБРАТЬ
	|	СинхронизацияДанныхЧерезУниверсальныйФормат.Ссылка КАК Ссылка
	|ИЗ
	...
	|	И СинхронизацияДанныхЧерезУниверсальныйФормат.ВариантНастройки = &ВариантНастройки
	|	И НЕ СинхронизацияДанныхЧерезУниверсальныйФормат.ПометкаУдаления
	|	И (СинхронизацияДанныхЧерезУниверсальныйФормат.ПравилаОтправкиЦен <> &ПравилаОтправкиЦен
	|			ИЛИ СинхронизацияДанныхЧерезУниверсальныйФормат.РежимВыгрузкиЦен <> &РежимВыгрузкиЦен)";
	
	Выборка = Запрос.Выполнить().Выбрать();
	Пока Выборка.Следующий() Цикл
		ПланОбменаОбъект = Выборка.Ссылка.ПолучитьОбъект();
		ПланОбменаОбъект.ПравилаОтправкиЦен = ПравилаОтправкиЦен;
		ПланОбменаОбъект.РежимВыгрузкиЦен = РежимВыгрузкиЦен;
		// Второй параметр указывается для обхода ошибки использования ОбновлениеИнформационнойБазы.ЗаписатьДанные для планов обмена.
		ОбновлениеИнформационнойБазы.ЗаписатьДанные(ПланОбменаОбъект, Истина);
	КонецЦикла;
...
Функция ИдентификаторОбменаСУНФ() Экспорт
	
	Возврат "ОбменУНФ_БП3";
	
КонецФункции

Функция ИдентификаторОбменаСРозницей() Экспорт
	
	Возврат "ОбменРозница_БП3";
	
КонецФункции

Функция ИдентификаторОбменаСДокументооборотом() Экспорт
