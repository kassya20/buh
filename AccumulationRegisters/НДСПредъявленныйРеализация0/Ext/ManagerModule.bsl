...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ЗаполнитьПризнакНеПрименяетсяПоставщикДляРегистраНДСПредъявленныйРеализация0");
	Методы.Вставить("ЗаполнитьПоставщикаПриОбновленииОтложенно");
	Методы.Вставить("ЗаполнитьПоставщикаПриОбновлении");
