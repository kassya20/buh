...
Функция МобильнаяБухгалтерия_СформироватьПечатнуюФормуСЗВ_М(МассивОбъектов, ОбъектыПечати) Экспорт
	
	Возврат СформироватьПечатнуюФормуСЗВ_М(МассивОбъектов, ОбъектыПечати);
