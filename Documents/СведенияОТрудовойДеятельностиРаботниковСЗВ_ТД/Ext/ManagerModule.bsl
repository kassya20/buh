...
Функция ВыборкаПоСотрудникам(МассивОбъектов)
	...
	Запрос.Текст = 
		...
		|				И (СведенияОТрудовойДеятельностиРаботниковСЗВ_ТДСотрудники.ЗаявлениеОПродолжении <> НЕОПРЕДЕЛЕНО)
		...
		|				И (СведенияОТрудовойДеятельностиРаботниковСЗВ_ТДСотрудники.ЗаявлениеОПредоставлении <> НЕОПРЕДЕЛЕНО)
...
Функция ПрочитатьПротоколПриема(ДокументОбъект, АдресДанныхПротоколаПриемки, ИмяФайла) Экспорт
	...
	Если ЗначениеЗаполнено(РезультатПроверки)
		И ДанныеОрганизации.РегистрационныйНомерПФР <> РегистрационныйНомерПФР
		И ДанныеОрганизации.РегистрационныйНомерСФР <> РегистрационныйНомерПФР Тогда
