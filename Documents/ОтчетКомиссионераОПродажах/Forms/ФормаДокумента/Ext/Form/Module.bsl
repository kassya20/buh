...
Процедура ПодготовитьФормуНаСервере()
	...
	ФормыДокумента   = Новый ФиксированноеСоответствие(
		Документы.ОтчетКомиссионераОПродажах.ПолучитьСоответствиеВидовОперацийФормам());
...
Функция ПолучитьСписокВидовОпераций()
	...
	ВсеВидыОпераций = Перечисления.ВидыОперацийОтчетКомиссионера;
	
	СписокВидовОпераций.Добавить(ВсеВидыОпераций.ОтчетОПродажах,          НСтр("ru = 'Оптовые продажи'"));
	СписокВидовОпераций.Добавить(ВсеВидыОпераций.ОтчетОРозничныхПродажах, НСтр("ru = 'Розничные продажи'"));
	СписокВидовОпераций.Добавить(ВсеВидыОпераций.ОтчетОСписании,          НСтр("ru = 'Списание товаров'"));
	СписокВидовОпераций.Добавить(ВсеВидыОпераций.ОтчетОбОприходовании,    НСтр("ru = 'Оприходование товаров'"));
...
Процедура ОткрытьДокументВида(ВыбранныйВидОперации)
	...
	ОткрытьФорму("Документ.ОтчетКомиссионераОПродажах.Форма." + ФормыДокумента[ВыбранныйВидОперации], СтруктураПараметров, ВладелецФормы);
