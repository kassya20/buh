...
Функция ТекстЗапросаРеквизитыДокумента()
	...
	|ИЗ
	|	Документ.ИзменениеОтраженияРасходовПоАренднымПлатежамОС КАК Реквизиты
	|ГДЕ
...
Функция ТекстЗапросаТаблицаОС(НомераТаблиц)
	...
	|ПОМЕСТИТЬ ТаблицаОС
	|ИЗ
	|	Документ.ИзменениеОтраженияРасходовПоАренднымПлатежамОС.ОС КАК ТаблицаОС
	|ГДЕ
...
Функция ТекстЗапросаСпособОтраженияРасходовПоАмортизацииОС(НомераТаблиц)
	...
	НомераТаблиц.Вставить("СпособОтраженияРасходовПоАренднымПлатежамОС", НомераТаблиц.Количество());
