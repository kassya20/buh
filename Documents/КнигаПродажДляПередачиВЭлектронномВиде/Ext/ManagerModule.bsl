...
Функция ПечатьКнигиПродаж(МассивОбъектов, ОбъектыПечати)
	...
	Запрос.Текст =
	"ВЫБРАТЬ
	|	ТабличнаяЧастьКнигаПродаж.НомерСтроки КАК НомерСтроки,
	|	ТабличнаяЧастьКнигаПродаж.ДатаНомер КАК ДатаНомер,
	|	ТабличнаяЧастьКнигаПродаж.НомерДатаИсправления КАК НомерДатаИсправления,
	|	ТабличнаяЧастьКнигаПродаж.НомерДатаКорректировки КАК НомерДатаКорректировки,
	|	ТабличнаяЧастьКнигаПродаж.НомерДатаИсправленияКорректировки КАК НомерДатаИсправленияКорректировки,
	|	ТабличнаяЧастьКнигаПродаж.Покупатель КАК Покупатель,
	|	ТабличнаяЧастьКнигаПродаж.ПокупательИНН КАК ПокупательИНН,
	|	ТабличнаяЧастьКнигаПродаж.ПокупательКПП КАК ПокупательКПП,
	|	ТабличнаяЧастьКнигаПродаж.ДатаОплаты КАК ДатаОплаты,
	|	ТабличнаяЧастьКнигаПродаж.ВсегоПродаж КАК ВсегоПродаж,
	|	ТабличнаяЧастьКнигаПродаж.СуммаБезНДС18 КАК СуммаБезНДС18,
	|	ТабличнаяЧастьКнигаПродаж.НДС18 КАК НДС18,
	|	ТабличнаяЧастьКнигаПродаж.СуммаБезНДС10 КАК СуммаБезНДС10,
	|	ТабличнаяЧастьКнигаПродаж.НДС10 КАК НДС10,
	|	ТабличнаяЧастьКнигаПродаж.НДС0 КАК НДС0,
	|	ТабличнаяЧастьКнигаПродаж.СуммаБезНДС20 КАК СуммаБезНДС20,
	|	ТабличнаяЧастьКнигаПродаж.НДС20 КАК НДС20,
	|	ТабличнаяЧастьКнигаПродаж.СуммаСовсемБезНДС КАК СуммаСовсемБезНДС,
	|	ТабличнаяЧастьКнигаПродаж.Ном КАК Ном,
	|	ТабличнаяЧастьКнигаПродаж.СчетФактура КАК СчетФактура,
	...
	|				И КнигаПродажДляПередачиВЭлектронномВиде.Организация.КрупнейшийНалогоплательщик
	|			ТОГДА КнигаПродажДляПередачиВЭлектронномВиде.Организация.КрупнейшийНалогоплательщикКПП
	|		ИНАЧЕ КнигаПродажДляПередачиВЭлектронномВиде.Организация.КПП
	|	КОНЕЦ КАК ОрганизацияКПП,
	|	КнигаПродажДляПередачиВЭлектронномВиде.ВсегоПродаж КАК ВсегоПродажИтог,
	|	КнигаПродажДляПередачиВЭлектронномВиде.ПредставлениеОтчета КАК ПредставлениеОтчета
	|ИЗ
	|	Документ.КнигаПродажДляПередачиВЭлектронномВиде КАК КнигаПродажДляПередачиВЭлектронномВиде
	...
	Пока ВыборкаПоОбъектам.Следующий() Цикл
		...
		Если ВыборкаТабличнойЧасти.Количество() = 0 Тогда
			...
			Иначе
				...
				Свидетельство = БухгалтерскийУчетПереопределяемый.СвидетельствоОРегистрации(
					СведенияОЮрФизЛице,
					ВыборкаПоОбъектам.НалоговыйПериод);
			КонецЕсли;
