...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	ТаблицаРазметкиАУСН = РазметкаОперацийАУСН.ПодготовитьТаблицуЗачетАвансаПоставщику(
		ПараметрыПроведения.ПоступлениеНематериальныхАктивовРеквизиты,
	...
	// УСН-онлайн
	РазметкаОперацийАУСН.СформироватьДвиженияПоступлениеРасходов(ПараметрыПроведения.ПоступлениеНематериальныхАктивовРеквизиты,
		ПараметрыПроведения.РасходыАУСН, Движения);
	
	РазметкаОперацийАУСН.СформироватьДвиженияРазметки(ПараметрыПроведения.ПоступлениеНематериальныхАктивовРеквизиты,
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если Не ЭтоНовый() Тогда
		Документы.ПоступлениеНМА.ЗаполнитьПодразделениеТабличнойЧастиЕслиОбъектНеОбработан(ЭтотОбъект);
	КонецЕсли;
