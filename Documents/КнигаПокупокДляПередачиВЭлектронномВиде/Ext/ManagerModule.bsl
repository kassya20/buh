...
Функция ПечатьКнигиПокупок(МассивОбъектов, ОбъектыПечати)
	...
	|	ТабличнаяЧастьДокумента.ДатаНомер КАК ДатаНомер,
	|	ТабличнаяЧастьДокумента.НомерДатаИсправления КАК НомерДатаИсправления,
	|	ТабличнаяЧастьДокумента.НомерДатаКорректировки КАК НомерДатаКорректировки,
	|	ТабличнаяЧастьДокумента.НомерДатаИсправленияКорректировки КАК НомерДатаИсправленияКорректировки,
	|	ТабличнаяЧастьДокумента.ДатаОплаты КАК ДатаОплаты,
	|	ТабличнаяЧастьДокумента.ДатаОприходования КАК ДатаОприходования,
	|	ТабличнаяЧастьДокумента.Продавец КАК Продавец,
	|	ТабличнаяЧастьДокумента.ПродавецИНН КАК ПродавецИНН,
	|	ТабличнаяЧастьДокумента.ПродавецКПП КАК ПродавецКПП,
	|	ТабличнаяЧастьДокумента.НомерГТД КАК НомерГТД,
	|	ТабличнаяЧастьДокумента.ВсегоПокупок КАК ВсегоПокупок,
	|	ТабличнаяЧастьДокумента.СуммаБезНДС18 КАК СуммаБезНДС18,
	|	ТабличнаяЧастьДокумента.НДС18 КАК НДС18,
	|	ТабличнаяЧастьДокумента.СуммаБезНДС10 КАК СуммаБезНДС10,
	|	ТабличнаяЧастьДокумента.НДС10 КАК НДС10,
	|	ТабличнаяЧастьДокумента.НДС0 КАК НДС0,
	|	ТабличнаяЧастьДокумента.СуммаСовсемБезНДС КАК СуммаСовсемБезНДС,
	|	ТабличнаяЧастьДокумента.Ном КАК Ном,
	|	ТабличнаяЧастьДокумента.СчетФактура КАК СчетФактура,
	...
	|				И КнигаПокупокДляПередачиВЭлектронномВиде.Организация.КрупнейшийНалогоплательщик
	|			ТОГДА КнигаПокупокДляПередачиВЭлектронномВиде.Организация.КрупнейшийНалогоплательщикКПП
	|		ИНАЧЕ КнигаПокупокДляПередачиВЭлектронномВиде.Организация.КПП
	...
	|	КнигаПокупокДляПередачиВЭлектронномВиде.Ссылка КАК Ссылка,
	|	КнигаПокупокДляПередачиВЭлектронномВиде.ПредставлениеОтчета КАК ПредставлениеОтчета
	|ИЗ
	|	Документ.КнигаПокупокДляПередачиВЭлектронномВиде КАК КнигаПокупокДляПередачиВЭлектронномВиде
