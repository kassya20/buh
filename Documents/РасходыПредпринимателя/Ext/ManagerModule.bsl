...
Функция ПодготовитьПараметрыПроведения(ДокументСсылка, Отказ) Экспорт
	...
	Запрос.УстановитьПараметр("ПлательщикНДС",
		УчетнаяПолитика.ПлательщикНДС(ДокументСсылка.Организация, ДокументСсылка.Дата)
		ИЛИ УчетнаяПолитика.ПлательщикНДСНаУСНСВычетами(ДокументСсылка.Организация, ДокументСсылка.Дата));
...
Функция ТекстЗапросаПоступлениеТоваров(НомераТаблиц)
	...
	|   ТаблицаРасходы.Ссылка.Склад КАК Склад
	|ИЗ
