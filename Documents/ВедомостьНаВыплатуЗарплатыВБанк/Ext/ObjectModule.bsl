...
Процедура ПриКопировании(ОбъектКопирования)
	...
	Если НЕ ЗначениеЗаполнено(ВидДоходаИсполнительногоПроизводства) Тогда
		ВидДоходаИсполнительногоПроизводства = Перечисления.ВидыДоходовИсполнительногоПроизводства.ЗарплатаВознаграждения;
	КонецЕсли;
...
Функция ИзменилисьКлючевыеРеквизитыЭлектронногоДокумента() Экспорт
	...
	ИзменилисьКлючевыеРеквизиты = 
		ЭлектронноеВзаимодействиеБЗК.ИзменилисьРеквизитыОбъекта(ЭтотОбъект, "Дата, Номер, Организация, ЗарплатныйПроект, НомерРеестра, ВидЗачисления, ВидДоходаИсполнительногоПроизводства")	
		Или ЭлектронноеВзаимодействиеБЗК.ИзмениласьТабличнаяЧастьОбъекта(ЭтотОбъект, "Зарплата", "Сотрудник, КВыплате")
...
Процедура ЗагрузитьВыплаты(Зарплата, НДФЛ, Финансирование = Неопределено) Экспорт
	...
	ВедомостьНаВыплатуЗарплаты.УстановитьВзыскания(ЭтотОбъект, Зарплата, Финансирование);
КонецПроцедуры
