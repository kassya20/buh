...
Процедура ДатаПриИзменении(Элемент)
	...
	Иначе
		...
		ТаможенноеДекларированиеКодовОпераций();
	КонецЕсли;
...
Процедура ЗаполнитьКоллекциюСписковВыбора()
	...
	КодыОперации.Загрузить(УчетНДС.ТаможенноеДекларированиеКодовОперацийПоСтавке0(Объект.Дата));
	
	УчетНДСКлиентСервер.ЗаполнитьСписокВыбораВидовТранспорта(Элементы.СопроводительныеДокументыКодТС.СписокВыбора);
	
КонецПроцедуры

&НаСервере
Процедура ТаможенноеДекларированиеКодовОпераций()
	КодыОперации.Загрузить(УчетНДС.ТаможенноеДекларированиеКодовОперацийПоСтавке0(Объект.Дата));
КонецПроцедуры
