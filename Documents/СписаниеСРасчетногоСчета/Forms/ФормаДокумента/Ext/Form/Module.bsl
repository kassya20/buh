...
&НаКлиенте
Процедура ПеречислениеПоДоговоруПодрядаПриИзменении(Элемент)
...
Процедура ПеречислениеПоДоговоруПодрядаВедомостьПриИзменении(Элемент)
	...
	СтрокаПлатеж = Элементы.ПеречислениеПоДоговоруПодряда.ТекущиеДанные;
...
&НаКлиенте
Процедура ПеречислениеПоДоговоруПодрядаВедомостьОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	
	СписаниеСРасчетногоСчетаФормыКлиент.ПеречислениеПоДоговоруПодрядаВедомостьОбработкаВыбора(
		ЭтотОбъект, Элемент, ВыбранноеЗначение, СтандартнаяОбработка);
	
КонецПроцедуры

&НаКлиенте
Процедура ПеречислениеПоДоговоруПодрядаПриОкончанииРедактирования(Элемент, НоваяСтрока, ОтменаРедактирования)
	
	СписаниеСРасчетногоСчетаФормыКлиент.ПеречислениеПоДоговоруПодрядаПриОкончанииРедактирования(
		ЭтотОбъект, Элемент, НоваяСтрока, ОтменаРедактирования);
...
Процедура ПеречислениеПоДоговоруПодрядаВедомостьОчистка(Элемент, СтандартнаяОбработка)
	...
	СписаниеСРасчетногоСчетаФормыКлиент.ПеречислениеПоДоговоруПодрядаВедомостьОчистка(
		ЭтотОбъект, Элемент, СтандартнаяОбработка);
	
КонецПроцедуры

&НаКлиенте
Процедура ПеречислениеПоДоговоруПодрядаПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
	
	СписаниеСРасчетногоСчетаФормыКлиент.ПеречислениеПоДоговоруПодрядаПриНачалеРедактирования(
		ЭтотОбъект, Элемент, НоваяСтрока, Копирование);
...
&НаКлиенте
Процедура ПеречислениеПоДоговоруПодрядаПослеУдаления(Элемент)
...
Функция СоздатьПодобратьНенайденныеНаСервере()
	...
	Возврат СписаниеСРасчетногоСчетаФормы.СоздатьПодобратьНенайденные(ЭтотОбъект);
...
Функция ПослеВыбораКонтрагентаСОтборомНаСервере(Контрагент)
	...
	Возврат СписаниеСРасчетногоСчетаФормы.СоздатьПодобратьПослеВыбораКонтрагента(ЭтотОбъект, Контрагент);
