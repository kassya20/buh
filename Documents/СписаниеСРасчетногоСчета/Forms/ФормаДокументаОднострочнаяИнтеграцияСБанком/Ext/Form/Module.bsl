...
Процедура УстановитьСписокВыбораСчетовОрганизации()
	...
	Элементы.ВторойСчетОрганизации.ПараметрыВыбора = Новый ФиксированныйМассив(МассивПараметровВыбора);
...
Процедура АдаптироватьМКШапкаФормы()
	...
	МобильныйКлиентБПФормаОбъекта.ВстроитьЭлементФормыВГруппаМКФормаВажное(Элементы, Элементы.ГруппаРеквизитыПлатежа);
	...
	Исключения = "Дата,СуммаДокумента,РасшифровкаПлатежаВидПлатежаПоКредитамЗаймам";
