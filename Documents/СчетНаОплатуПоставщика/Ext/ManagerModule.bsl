...
Функция ПолучитьТекстЗапросаДляФормированияТаблицыСведенийСчетаНаОплату()
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ДокументыДляПечати.Документ КАК Документ,
	...
	|	ДокументыДляПечати.Валюта КАК Валюта,
	|	ДокументыДляПечати.ВалютаКод КАК ВалютаКод,
	|	ДокументыДляПечати.ВалютаНаименование КАК ВалютаНаименование,
	|	ДокументыДляПечати.СуммаДокумента КАК СуммаДокумента,
	|	ДокументыДляПечати.КратностьВзаиморасчетов КАК КратностьВзаиморасчетов,
	|	ДокументыДляПечати.КурсВзаиморасчетов КАК КурсВзаиморасчетов,
	|	ДокументыДляПечати.СуммаВключаетНДС КАК СуммаВключаетНДС,
	|	ДокументыДляПечати.Организация КАК Организация,
	|	ДокументыДляПечати.Подразделение КАК Подразделение,
	|	ДокументыДляПечати.Поставщик КАК Поставщик,
	|	ДокументыДляПечати.Покупатель КАК Покупатель,
	|	ДокументыДляПечати.Получатель КАК Получатель,
	|	ДокументыДляПечати.ДоговорКонтрагента КАК ДоговорКонтрагента,
	|	ДокументыДляПечати.БанковскийСчетПродавца КАК БанковскийСчетПродавца,
	|	ДокументыДляПечати.ТекстКорреспондента КАК ТекстКорреспондента,
	|	ДокументыДляПечати.БанкДляРасчетов КАК БанкДляРасчетов,
	|	ДокументыДляПечати.НаименованиеБанкаПолучателя КАК НаименованиеБанкаПолучателя,
	|	ДокументыДляПечати.БанкПолучателя КАК БанкПолучателя,
	|	ДокументыДляПечати.БикБанкаПолучателя КАК БикБанкаПолучателя,
	|	ДокументыДляПечати.СчетБанкаПолучателя КАК СчетБанкаПолучателя,
	|	ДокументыДляПечати.ГородБанкаПолучателя КАК ГородБанкаПолучателя,
	|	ДокументыДляПечати.НомерСчетаПолучателя КАК НомерСчетаПолучателя,
	|	ДокументыДляПечати.БанкТекстКорресподента КАК БанкТекстКорресподента,
	|	ДокументыДляПечати.НомерСчета КАК НомерСчета,
	|	ДокументыДляПечати.БанкНаименование КАК БанкНаименование,
	|	ДокументыДляПечати.БИК КАК БИК,
	|	ДокументыДляПечати.КоррСчет КАК КоррСчет
	|ИЗ
	|	ДокументыДляПечати КАК ДокументыДляПечати
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ДанныеПервичныхДокументов КАК ДанныеПервичныхДокументов
	|		ПО ДокументыДляПечати.Документ = ДанныеПервичныхДокументов.Документ
	|			И ДокументыДляПечати.Организация = ДанныеПервичныхДокументов.Организация
	|
	|УПОРЯДОЧИТЬ ПО
	|	ДатаДокумента,
	|	Документ
	...
	|ИЗ
	|	ДокументыДляПечати КАК ДокументыДляПечати
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.СчетНаОплатуПоставщика.Товары КАК СчетНаОплату
	|		ПО ДокументыДляПечати.Документ = СчетНаОплату.Ссылка
	|ГДЕ
	|	НЕ СчетНаОплату.Ссылка ЕСТЬ NULL
	|
	|УПОРЯДОЧИТЬ ПО
	|	ДатаДокумента,
	|	Документ,
...
Функция НаличиеСтавкиНДСПоУСН(ТекущийДокумент, СтавкаНДСПоУСН) Экспорт
	...
	|ГДЕ
	|	СчетНаОплатуПоставщикаТовары.Ссылка = &СсылкаНаДокумент
	|	И СчетНаОплатуПоставщикаТовары.СтавкаНДС В (&СтавкаНДСПоУСН)
	|
	|СГРУППИРОВАТЬ ПО
	|	СчетНаОплатуПоставщикаТовары.Ссылка";
