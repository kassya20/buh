...
// Функция возвращает список доступных видов продукции для работы с документом Разрешение на отгрузку ИС МП.
//  
// Возвращаемое значение:
//  Массив из ПеречислениеСсылка.ВидыПродукцииИС
Функция ДоступныеВидыПродукцииИСМП() Экспорт
	
	Возврат ОбщегоНазначенияИСМПКлиентСерверПовтИсп.ВидыПродукцииРазрешенияНаОтгрузку();
