...
Функция ПечатьДоверенности(МассивОбъектов, ОбъектыПечати, НазваниеМакета, ПараметрыПечати)
	...
	Пока Шапка.Следующий() Цикл
		...
		ДокументыФизЛица = КадровыйУчет.ДокументыФизическихЛиц(Шапка.ДоверенноеЛицо, Истина);
		...
		Если ДействующийПаспорт <> Неопределено Тогда
			ПараметрыМакета.Вставить("ПаспортСерия",                  ДействующийПаспорт.Серия);
			ПараметрыМакета.Вставить("ПаспортНомер",                  ДействующийПаспорт.Номер);
			ПараметрыМакета.Вставить("ПаспортВыдан",                  ДействующийПаспорт.КемВыдан);
			ПараметрыМакета.Вставить("ПаспортДатаВыдачи",             ДействующийПаспорт.ДатаВыдачи);
		КонецЕсли;
