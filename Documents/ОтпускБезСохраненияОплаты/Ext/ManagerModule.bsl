...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ru = 'Приказ на отпуск (Т-6)'");
	...
	Если ДокументОбъект.ДатаОкончания >= ДокументОбъект.ДатаНачала
		...
		Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ЗарплатаКадрыДляНебольшихОрганизаций.РасчетЗарплаты") Тогда
			...
			Пока ДатаНачалаОтпуска <= ДокументОбъект.ДатаОкончания Цикл
				...
				РабочихДнейЧасов = МодульРасчетЗарплатыДляНебольшихОрганизаций.РабочихДнейЧасовВПериодеОрганизации(
					СтрокаНачислений.ДатаНачала, СтрокаНачислений.ДатаОкончания, ДокументОбъект.Организация);
