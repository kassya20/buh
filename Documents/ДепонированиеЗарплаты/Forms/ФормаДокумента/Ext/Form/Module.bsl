...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	Оповестить(ВзаиморасчетыССотрудникамиКлиент.ИмяСобытияИзмененияОплатыВедомости(), , Объект.Ведомость);
...
Процедура УстановитьДоступностьЭлементов(Форма)
	...
	Форма.Элементы.ДепонентыКоманды.Доступность = ВедомостьВыбрана;
