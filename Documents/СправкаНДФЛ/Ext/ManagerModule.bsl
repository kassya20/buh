...
Функция ДанныеНовогоДокумента() Экспорт
	...
	ДанныеДокумента.Вставить("НалоговыйПериод", Год(ТекущаяДатаСеанса()));
	ДанныеДокумента.Вставить("Дата", ТекущаяДатаСеанса());
	ДанныеДокумента.Вставить("Организация", Справочники.Организации.ПустаяСсылка());
	ДанныеДокумента.Вставить("РегистрацияВНалоговомОргане", Справочники.РегистрацииВНалоговомОргане.ПустаяСсылка());
	ДанныеДокумента.Вставить("СпособФормирования", Перечисления.ПорядокФормированияСправкиОДоходахФизическогоЛица.Сводно);
	ДанныеДокумента.Вставить("ВариантФормированияФайлаОтвета", Перечисления.ВариантыФормированияФайлаОтветаЗаявкиСотрудника.ФайлДляВыводаНаПринтер);
	ДанныеДокумента.Вставить("Сотрудник", Справочники.ФизическиеЛица.ПустаяСсылка());
	
	ДанныеДокумента.Вставить("НачалоПериода", Дата(1, 1, 1));
	ДанныеДокумента.Вставить("ОкончаниеПериода", Дата(1, 1, 1));
...
Функция РегистрацияВНалоговомОргане() Экспорт
...
Функция НовыеПараметрыФормированияФайлаСправки() Экспорт
	
	ПараметрыФормированияФайлаСправки = Новый Структура;  
	ПараметрыФормированияФайлаСправки.Вставить("ИспользуетсяЭДОБЗК");
	ПараметрыФормированияФайлаСправки.Вставить("СправкаНДФЛ");
	ПараметрыФормированияФайлаСправки.Вставить("ИмяФайла");
	ПараметрыФормированияФайлаСправки.Вставить("ТребуетсяПодписьФайла");
	ПараметрыФормированияФайлаСправки.Вставить("ФизическоеЛицо");
	ПараметрыФормированияФайлаСправки.Вставить("Организация");
	
	Возврат ПараметрыФормированияФайлаСправки;
	
КонецФункции  

Функция ИмяФайла(РеквизитыДокумента) Экспорт
