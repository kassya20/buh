...
Процедура ПодготовитьФормуНаСервере()
	...
	ДоступныеЗначенияВидовОпераций = Перечисления.ВидыОперацийПередачаТоваров.ПолучитьСписокДоступныхЗначений(
...
Функция ВидыОперацийПоДаннымЗаполнения(ЗначенияЗаполнения)
	...
	Возврат РаботаСДоговорамиКонтрагентовБПВызовСервера.ВидыОперацийДокумента(
		СвойстваДоговора.ВидДоговора, Тип("ДокументСсылка.ПередачаТоваров"), Ложь);
