...
Процедура УстановитьУсловноеОформление()
	...
	ЭлементУО = УсловноеОформление.Элементы.Добавить();
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУО.Поля, "ОСПрименяетсяИнвестиционныйВычет");
...
Процедура ПодготовитьФормуНаСервере()
	...
	ВключитьКапитальныеВложенияВРасходыНУ = ПараметрыАмортизационнойПремииЗаполнены(ЭтотОбъект);
	УстановитьДоступностьПараметровАмортизационнойПремии(ЭтотОбъект);
...
Процедура ЗаполнитьДополнительныеСведенияОС()
	...
	|	СписокОС.СрокПолезногоИспользованияБУ КАК СрокПолезногоИспользованияБУ,
	|	СписокОС.СрокПолезногоИспользованияНУ КАК СрокПолезногоИспользованияНУ,
	|	СписокОС.ОбъемПродукцииРаботБУ КАК ОбъемПродукцииРаботБУ,
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ВТСписокОС.НомерСтроки КАК НомерСтроки,
	...
	|	ВТСписокОС.ПрослеживаемыйТовар КАК ПрослеживаемыйТовар
	|ИЗ
