...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если ИспользуетсяДатаПроизводства
		...
		И Не ОбщегоНазначенияИСКлиентСервер.ЭтоМолочнаяПродукцияИСМП(ВидПродукции)
	...
	Если ОтчетПроизводственнойЛинии Тогда
		...
		Если ПрисутствуетОперацияНанесения
			...
			И Не ОперацияНанесенияТолькоДляНаборов Тогда
		...
		Если ПрисутствуетОперацияНанесения
			И ИнтеграцияИСМПКлиентСервер.ОбязательноеУказаниеСодержанияЭтиловогоСпиртаДляВидаПродукцииВОтчетеОНанесении(ВидПродукции) Тогда
			...
			Если Не ЗначениеЗаполнено(ОперацияНанесения) Или ДополнятьОбязательныеРеквизитыВводВОборот(СтатусИСМП) Тогда
				...
				Если Операция = Перечисления.ВидыОперацийИСМП.ВводВОборотПроизводствоВнеЕАЭС
					...
					Если Операция = Перечисления.ВидыОперацийИСМП.ВводВОборотИмпортСФТС 
						...
						ОбязательныеРеквизиты.Добавить("ДатаПроизводства");
					ИначеЕсли Операция = Перечисления.ВидыОперацийИСМП.ВводВОборотПроизводствоВнеЕАЭС Тогда
	...
	Иначе
		...
		ИначеЕсли ОбщегоНазначенияИСПовтИсп.ЭтоПродукцияИСМП(ВидПродукции) Тогда
			...
			Если ОбщегоНазначенияИСКлиентСервер.ЭтоМолочнаяПродукцияИСМП(ВидПродукции) Тогда
				Если ПрисутствуетОперацияНанесения И Не ОперацияНанесенияТолькоДляНаборов Тогда
...
Функция ПроверятьЗаполнениеДанныхДекларации(СтатусИСМП)
	...
	Если СтатусИСМП = Перечисления.СтатусыОбработкиМаркировкиТоваровИСМП.КодыАТКСформированы 
		...
		Или (ВариантЗаполненияДекларации = Перечисления.ВариантыЗаполненияДекларацииИСМП.КодыУпаковок
			Или ВариантЗаполненияДекларации = Перечисления.ВариантыЗаполненияДекларацииИСМП.АТК)
