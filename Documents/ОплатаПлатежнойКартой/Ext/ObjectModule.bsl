...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если ВидОперации = Перечисления.ВидыОперацийОплатаПлатежнойКартой.ОплатаСчетаЧерезСБП Тогда
		МассивНепроверяемыхРеквизитов.Добавить("Патент");
...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	СтруктураТаблицИП = Документы.ОплатаПлатежнойКартой.ПодготовитьСтруктуруТаблицИП(
	...
	ТаблицаОплаченныеПродажиИП = УчетДоходовИРасходовПредпринимателя.ПодготовитьТаблицуОплатыПокупателя(
		СтруктураТаблицИП.ТаблицаЗачтенныеОплаты, ПараметрыПроведения.Реквизиты);
	...
	Если Не БезЗакрывающихДокументов Тогда
		...
		УчетВзаиморасчетов.СформироватьДвиженияПоПрочимРасчетам(СтруктураТаблицИП.ТаблицаПрочиеРасчеты, Движения, Отказ);
		...
		УчетВзаиморасчетов.СформироватьДвиженияРасчетыПоЭквайрингуЗачетАвансов(
			СтруктураТаблицИП.ТаблицаПрочиеРасчетыЗачетОплаты, СтруктураТаблицИП.ТаблицаПроводокВспомогательныеРасчеты,
			ПараметрыПроведения.Реквизиты, Движения, Отказ);
		
		УчетДоходовИРасходовПредпринимателя.СформироватьДвиженияЗачетОплатыПокупателя(
			ТаблицаОплаченныеПродажиИП,
			СтруктураТаблицИП.ТаблицаВзаиморасчеты,
			ПараметрыПроведения.Реквизиты, Движения, Отказ);
		
		УчетПСН.СформироватьДвиженияКнигаУчетаДоходовПатент(
			СтруктураТаблицИП.ДвиженияКУДиРПатент, Движения, Отказ);
