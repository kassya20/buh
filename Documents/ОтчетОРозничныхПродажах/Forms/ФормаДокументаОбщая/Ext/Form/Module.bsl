...
&НаКлиенте
Перем ЭтоНоваяСтрокаТовары;
&НаКлиенте
Перем ЭтоНоваяСтрокаВозвраты;
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Ключ.Пустая() Тогда
		...
		УчетПСН.УстановитьПатентПриРеализации(ЭтотОбъект);
	КонецЕсли;
	...
	СписокТабличныхЧастей.Добавить("Предоплаты",             "Предоплаты");
	СписокТабличныхЧастей.Добавить("ЗачетАвансов",           "ЗачетАвансов");
	СписокТабличныхЧастей.Добавить("Оплата",                 "Оплата");
	СписокТабличныхЧастей.Добавить("ВозвратОплат",           "ВозвратОплаты");
	СписокТабличныхЧастей.Добавить("ОплатаСчетов",           "ОплатаСчетов");
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	ИначеЕсли ИмяСобытия = "ЗаполненыДанныеYclients"
		И Параметр.ИдентификаторВызывающейФормы = УникальныйИдентификатор Тогда
		ОбработатьОповещениеОЗаполненииДанныхYclients(Параметр);
	Иначе
...
Процедура ПриЧтенииНаСервере(ТекущийОбъект)
	...
	ЗаполнитьСопоставленныеПозицииНаСервере(Ложь);
...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	...
	Оповестить("Запись_ОтчетОРозничныхПродажах", ПараметрыЗаписи, Объект.Ссылка);
...
Процедура ТоварыПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
	...
	ЭтоНоваяСтрокаТовары = НоваяСтрока;
	...
	Если НоваяСтрока И ПлательщикТуристическогоНалога Тогда
...
Процедура ТоварыНоменклатураПриИзменении(Элемент)
	...
	Контекст = Новый Структура(
		...
		|ВедетсяУчетПрослеживаемыхТоваров, ПлательщикТуристическогоНалога");
	...
	ДанныеСтроки = Новый Структура(
		...
		|УслугаРазмещения, Гостиница, ВидЛьготыПоТуристическомуНалогу");
...
Процедура ТоварыРНПТНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ПрослеживаемостьФормыКлиентБП.ОткрытьФормуПодбораРНПТ(ЭтотОбъект, "Товары", ПараметрыФормыПодбора);
...
Процедура ТоварыРНПТОчистка(Элемент, СтандартнаяОбработка)
	...
	Если СтрокаТабличнойЧасти <> Неопределено Тогда
		...
		ОчиститьСведенияПрослеживаемостиПоСтроке(СтрокаТабличнойЧасти);
...
Процедура ТоварыПриАктивизацииЯчейки(Элемент)
	...
	Если ЭтоНоваяСтрокаТовары Тогда
...
Процедура ВозвратыПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
	...
	ЭтоНоваяСтрокаВозвраты = НоваяСтрока;
...
Процедура ВозвратыНоменклатураПриИзменении(Элемент)
	...
	Контекст = Новый Структура(
		"Дата, ВидОперации, Организация, ДеятельностьНаПатенте, Склад,
		|ТипЦен, ВалютаДокумента, КурсДокумента, КратностьДокумента,
		|СуммаВключаетНДС, Реализация, АТТПоПродажнойСтоимости, ДокументБезНДС, ВедетсяУчетПрослеживаемыхТоваров");
	...
	Если ЗначениеЗаполнено(ТекущиеДанные.ДатаРеализации) Тогда
		Контекст.Дата = ТекущиеДанные.ДатаРеализации;
	КонецЕсли;
...
&НаКлиенте
Процедура ВозвратыРНПТНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ПрослеживаемостьФормыКлиентБП.ОткрытьФормуПодбораРНПТ(ЭтотОбъект, "Возвраты", ПараметрыФормыПодбора);
	
КонецПроцедуры

&НаКлиенте
Процедура ВозвратыРНПТОчистка(Элемент, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ВозвратыСтранаПроисхожденияПриИзменении(Элемент)
...
&НаКлиенте
Процедура ВозвратыПриАктивизацииЯчейки(Элемент)
	
	Если Элементы.Возвраты.ТекущиеДанные = Неопределено Тогда
		Возврат;
	КонецЕсли;

	Если ЭтоНоваяСтрокаВозвраты Тогда
		ТекущаяКолонкаТаблицы = Элементы.Возвраты.ТекущийЭлемент;
		Если ТекущаяКолонкаТаблицы.Имя = "ТоварыРНПТ" 
			И Не ЗначениеЗаполнено(Элементы.Возвраты.ТекущиеДанные.РНПТ) Тогда
			ПараметрыФормыПодбора = ПрослеживаемостьФормыКлиентБП.ПодготовитьСтруктуруПараметровДляФормыПодбораРНПТ();
			ПараметрыФормыПодбора.ЭтоПоступление         = Ложь;
			ПараметрыФормыПодбора.ПрослеживаемыйКомплект = Элементы.Возвраты.ТекущиеДанные.ПрослеживаемыйКомплект;
...
Процедура ВозвратыВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если Поле.Имя = "ВозвратыРНПТ" Тогда
		ТекущиеДанные = Элементы.Возвраты.ТекущиеДанные;
		Если ТекущиеДанные.ПрослеживаемыйТовар Тогда
			ПараметрыФормыПодбора = ПрослеживаемостьФормыКлиентБП.ПодготовитьСтруктуруПараметровДляФормыПодбораРНПТ();
			ПараметрыФормыПодбора.ЭтоПоступление         = Ложь;
	...
	Если Поле.Имя = "ВозвратыПрослеживаемыйТовар" Тогда
		ТекущиеДанные = Элементы.Возвраты.ТекущиеДанные;
		Если ТекущиеДанные.ПрослеживаемыйТовар Тогда
			ПрослеживаемостьФормыКлиентБП.ПоказатьПредупреждениеПрослеживаемыйТовар();
		Конецесли;
...
&НаКлиенте
Процедура ВозвратыДатаРеализацииПриИзменении(Элемент)
	
	ТекущиеДанные = Элементы.Возвраты.ТекущиеДанные;
	
	Если ЗначениеЗаполнено(ТекущиеДанные.ДатаРеализации) И НЕ Объект.ДокументБезНДС Тогда
		
		ДанныеОбъекта = Новый Структура("Дата, Организация, Склад, СуммаВключаетНДС");
		ЗаполнитьЗначенияСвойств(ДанныеОбъекта, Объект);
		
		ДанныеОбъекта.Дата = ТекущиеДанные.ДатаРеализации; 
		
		НоваяСтавкаНДС = СтавкаНДСНаДату(ТекущиеДанные.Номенклатура, ДанныеОбъекта);
...
Процедура ОплатаВидОплатыОткрытие(Элемент, СтандартнаяОбработка)
	...
	ИначеЕсли ИспользоватьПродажиЧерезМаркетплейс Тогда
...
#Область ОбработчикиСобытийТаблицыФормыОплатаСчетов

&НаКлиенте
Процедура ОплатаСчетовПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
	Если НоваяСтрока И НЕ Копирование Тогда
		Элемент.ТекущиеДанные.СтавкаНДС = СтавкаНДСПриРеализации;
	КонецЕсли;
...
&НаКлиенте
Процедура ПредоплатыПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
	Если НоваяСтрока И НЕ Копирование Тогда
		Элемент.ТекущиеДанные.СтавкаНДС = СтавкаНДСПриРеализации;
	КонецЕсли;
КонецПроцедуры
...
Процедура ПоказатьНесопоставленныеОбъектыНаКлиенте()
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ПоказатьНесопоставленныеОбъектыЗавершение", ЭтотОбъект);
	
	Если Объект.ЗагрузкаИзОФД Тогда
		ПараметрыФормы = Новый Структура;
		ПараметрыФормы.Вставить("ДокументЗагрузки", Объект.Ссылка);
		ОткрытьФорму("Обработка.ЗагрузкаИзОФД.Форма.ФормаСопоставления",
			ПараметрыФормы, ЭтотОбъект, УникальныйИдентификатор,,,ОписаниеОповещения,РежимОткрытияОкнаФОрмы.БлокироватьОкноВладельца);
	ИначеЕсли Объект.ЗагрузкаИзYclients Тогда
		ПараметрыФормы = Новый Структура;
		ПараметрыФормы.Вставить("ДокументСсылка", Объект.Ссылка);	
		ОткрытьФорму("Обработка.ОбменСYclients.Форма.ФормаСопоставления",
			ПараметрыФормы, ЭтотОбъект, УникальныйИдентификатор,,,ОписаниеОповещения,РежимОткрытияОкнаФОрмы.БлокироватьОкноВладельца);
...
&НаКлиенте
Процедура ПоказатьНесопоставленныеОбъектыЗавершение(Результат, ЭтотОбъект) Экспорт
	ЗаполнитьСопоставленныеПозицииНаСервере(Истина); 
КонецПроцедуры

&НаСервере
Процедура ЗаполнитьСопоставленныеПозицииНаСервере(Перезаполнить)
	
	Если Объект.ЗагрузкаИзYclients 
		И ПравоДоступа("Изменение", Метаданные.РегистрыСведений.НесопоставленныеОбъектыИнтернетМагазина) Тогда
		
		НесопоставленныеОбъекты = РегистрыСведений.НесопоставленныеОбъектыИнтернетМагазина.СоздатьНаборЗаписей();
		НесопоставленныеОбъекты.Отбор.Документ.Установить(Объект.Ссылка);
		НесопоставленныеОбъекты.Прочитать();
		
		ЕстьНесопоставленнаяНоменклатура = НесопоставленныеОбъекты.Количество() > 0;
		
	ИначеЕсли Объект.ЗагрузкаИзОФД Тогда
		
		НоменклатураПоДокументу = РегистрыСведений.НоменклатураДокументовОФД.СопоставлениеНоменклатурыПоДокументу(ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(Объект.Ссылка));
		
		Элементы.ЗагруженнаяНоменклатураЧеков.Видимость = НоменклатураПоДокументу.Количество() > 0;
		
		НоменклатураИзменилась = Ложь;
		
		СопоставленнаяНоменклатура = НоменклатураПоДокументу.НайтиСтроки(Новый Структура("НоменклатураСопоставлена", Истина));
		Для каждого СтрокаСопоставление Из СопоставленнаяНоменклатура Цикл
			СтрокиДокумента = Объект[СтрокаСопоставление.ИмяТабличнойЧасти].НайтиСтроки(Новый Структура("ИдентификаторСтроки", Строка(СтрокаСопоставление.ИдентификаторСтроки)));
			Для каждого СтрокаДокумента Из СтрокиДокумента Цикл
				// ранее заполненные строки перезаполняем только по флагу
				Если Перезаполнить ИЛИ СтрокаДокумента.Номенклатура.Пустая() Тогда
					НоменклатураИзменилась = НоменклатураИзменилась 
					ИЛИ СтрокаДокумента.Номенклатура <> СтрокаСопоставление.НоменклатураСсылка;
					
					СтрокаДокумента.Номенклатура = СтрокаСопоставление.НоменклатураСсылка;
				КонецЕсли;
			КонецЦикла;
		КонецЦикла;
		
		Если НоменклатураИзменилась И НЕ Модифицированность Тогда
			Модифицированность = Истина;
		КонецЕсли;
		
		ЕстьНесопоставленнаяНоменклатура = СопоставленнаяНоменклатура.Количество() <> НоменклатураПоДокументу.Количество();
...
Процедура УстановитьУсловноеОформлениеВидимость()
	...
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУО.Поля, "ПредоплатыСтавкаНДС");
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУО.Поля, "ПредоплатыСуммаНДС");
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУО.Поля, "ОплатаСчетовСтавкаНДС");
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУО.Поля, "ОплатаСчетовСуммаНДС");
...
Процедура УстановитьУсловноеОформлениеТовары() Экспорт
	...
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУО.Поля, "ТоварыГостиница");

	ОбщегоНазначенияКлиентСервер.ДобавитьЭлементКомпоновки(ЭлементУО.Отбор,
		"Объект.Товары.УслугаРазмещения", ВидСравненияКомпоновкиДанных.НеЗаполнено, Ложь);
	...
	ОбщегоНазначенияКлиентСервер.ДобавитьЭлементКомпоновки(ЭлементУО.Отбор,
		"Объект.Товары.ИдентификаторРодительскойСтроки", ВидСравненияКомпоновкиДанных.НеЗаполнено);
	...
	ОбщегоНазначенияКлиентСервер.ДобавитьЭлементКомпоновки(ЭлементУО.Отбор,
		"Объект.Товары.УслугаРазмещения", ВидСравненияКомпоновкиДанных.Равно, Перечисления.ВидыУслугРазмещения.РаннийЗаездПозднийВыезд);
	ОбщегоНазначенияКлиентСервер.ДобавитьЭлементКомпоновки(ЭлементУО.Отбор,
		"Объект.Товары.ИдентификаторРодительскойСтроки", ВидСравненияКомпоновкиДанных.Заполнено);
...
Процедура УстановитьУсловноеОформлениеВозвраты() Экспорт
	...
	// ВозвратыДатаРеализации
	
	ЭлементУО = УсловноеОформление.Элементы.Добавить();

	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУО.Поля, "ВозвратыДатаРеализации");
	...
	// Авто
	ЭлементУО = УсловноеОформление.Элементы.Добавить();
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУО.Поля, "ВозвратыРНПТ");
	
	ОбщегоНазначенияКлиентСервер.ДобавитьЭлементКомпоновки(ЭлементУО.Отбор,
		"Объект.Возвраты.РНПТ", ВидСравненияКомпоновкиДанных.НеЗаполнено, "");
	
	ОбщегоНазначенияКлиентСервер.ДобавитьЭлементКомпоновки(ЭлементУО.Отбор,
		"Объект.Возвраты.ПрослеживаемыйТовар", ВидСравненияКомпоновкиДанных.Равно, Истина);
	
	ОбщегоНазначенияКлиентСервер.ДобавитьЭлементКомпоновки(ЭлементУО.Отбор,
		"Объект.Возвраты.ДатаРеализации", ВидСравненияКомпоновкиДанных.БольшеИлиРавно, '20210701');

	ОбщегоНазначенияКлиентСервер.ДобавитьЭлементКомпоновки(ЭлементУО.Отбор,
		"Объект.Возвраты.ПрослеживаемыйКомплект", ВидСравненияКомпоновкиДанных.Равно, Ложь);
	...
	ОбщегоНазначенияКлиентСервер.ДобавитьЭлементКомпоновки(ЭлементУО.Отбор,
		"Объект.Возвраты.ПрослеживаемыйКомплект", ВидСравненияКомпоновкиДанных.Равно, Истина);
	...
	ОбщегоНазначенияКлиентСервер.ДобавитьЭлементКомпоновки(ЭлементУО.Отбор,
		"Объект.Возвраты.СтранаПроисхождения", ВидСравненияКомпоновкиДанных.НеЗаполнено, "");
	
	ОбщегоНазначенияКлиентСервер.ДобавитьЭлементКомпоновки(ЭлементУО.Отбор,
		"Объект.Возвраты.НомерГТД", ВидСравненияКомпоновкиДанных.НеЗаполнено, "");
	
	ОбщегоНазначенияКлиентСервер.ДобавитьЭлементКомпоновки(ЭлементУО.Отбор,
		"Объект.Возвраты.ПрослеживаемыйТовар", ВидСравненияКомпоновкиДанных.Равно, Ложь);
	...
	ОбщегоНазначенияКлиентСервер.ДобавитьЭлементКомпоновки(ЭлементУО.Отбор,
		"Объект.Возвраты.ДатаРеализации", ВидСравненияКомпоновкиДанных.Заполнено);

	ОбщегоНазначенияКлиентСервер.ДобавитьЭлементКомпоновки(ЭлементУО.Отбор,
		"Объект.Возвраты.ДатаРеализации", ВидСравненияКомпоновкиДанных.Меньше, '20210701');
	...
	// Страна происхождения
	ЭлементУО = УсловноеОформление.Элементы.Добавить();
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУО.Поля, "ВозвратыСтранаПроисхождения");
...
Процедура УправлениеФормой(Форма)
	...
	Элементы.ВозвратыГруппаРНПТ.Заголовок = ТекстЗаголовкаРНПТ;
...
Процедура УстановитьВидимость()
	...
	Элементы.СтраницаПредоплаты.Видимость      = Не ЭтоОтчетНТТОПродажах ИЛИ Объект.Предоплаты.Количество() > 0;
	Элементы.СтраницаЗачетПредоплаты.Видимость = Не ЭтоОтчетНТТОПродажах ИЛИ Объект.ЗачетАвансов.Количество() > 0;
	Элементы.СтраницаОплатаСчетов.Видимость    = Не ЭтоОтчетНТТОПродажах ИЛИ Объект.ОплатаСчетов.Количество() > 0;
КонецПроцедуры
...
Процедура ДатаПриИзмененииНаСервере()
	...
	РаботаСНоменклатуройБП.ОбновитьПризнакПрослеживаемости(Объект.Возвраты, ВедетсяУчетПрослеживаемыхТоваров, Объект.Дата);
...
Процедура ОрганизацияПриИзмененииНаСервере()
	...
	ТуристическийНалогПроверитьРеквизиты();
...
&НаСервере
Процедура ТуристическийНалогПроверитьРеквизиты()
	Если НЕ ПлательщикТуристическогоНалога Тогда
		Возврат;
	КонецЕсли;
	
	МассивНоменклатура = ОбщегоНазначения.ВыгрузитьКолонку(Объект.Товары, "Номенклатура", Истина);
	СведенияОСпискеНоменклатуры = ОБщегоНазначения.ЗначениеРеквизитаОбъектов(МассивНоменклатура, "УслугаРазмещения");
    ГостиницыОрганизаций = Новый Соответствие;

	Для Каждого ДанныеСтроки Из Объект.Товары Цикл
		УслугаРазмещения = СведенияОСпискеНоменклатуры[ДанныеСтроки.Номенклатура];
		Если Не ЗначениеЗаполнено(УслугаРазмещения) Тогда
			Продолжить;
		КонецЕсли;
	
		ДанныеСтроки.УслугаРазмещения = УслугаРазмещения;
		
		Гостиница = ГостиницыОрганизаций[Объект.Организация];  
		Если Гостиница = Неопределено Тогда
			ТуристическийНалогСервер.УстановитьГостиницу(ДанныеСтроки.Гостиница, Объект.Организация);
			ГостиницыОрганизаций.Вставить(Объект.Организация, ДанныеСтроки.Гостиница);  
		Иначе
			ДанныеСтроки.Гостиница = Гостиница;
		КонецЕсли; 
		
		Если НЕ ЗначениеЗаполнено(ДанныеСтроки.ВидЛьготыПоТуристическомуНалогу) Тогда
			ДанныеСтроки.ВидЛьготыПоТуристическомуНалогу = Перечисления.ВидыЛьготПоТуристическомуНалогу.НеПрименяется;
		КонецЕсли;
	КонецЦикла;
КонецПроцедуры
...
Процедура НоменклатураПриИзмененииНаСервере(ИмяТабличнойЧасти, ДанныеСтроки, Знач ДанныеОбъекта, Знач СчетаУчетаКЗаполнению)
	...
	ПараметрыДанныхОНоменклатуре = Новый Структура("Дата, Организация, Склад, СуммаВключаетНДС, ПлательщикТуристическогоНалога");
	...
	ПлательщикТуристическогоНалога = ДанныеОбъекта.Свойство("ПлательщикТуристическогоНалога") 
		И ДанныеОбъекта.ПлательщикТуристическогоНалога;
	...
	Если СведенияОНоменклатуре <> Неопределено Тогда
		...
		ДанныеСтроки.ЭтоУслуга           = СведенияОНоменклатуре.Услуга;
		
		
		Если ПлательщикТуристическогоНалога Тогда
			ДанныеСтроки.УслугаРазмещения    = СведенияОНоменклатуре.УслугаРазмещения;
			
			Если ЗначениеЗаполнено(ДанныеСтроки.УслугаРазмещения)  Тогда
				ТуристическийНалогСервер.УстановитьГостиницу(ДанныеСтроки.Гостиница, ДанныеОбъекта.Организация);
			Иначе
				ДанныеСтроки.Гостиница = Справочники.Гостиницы.ПустаяСсылка();
			КонецЕсли;
			
			Если ЗначениеЗаполнено(ДанныеСтроки.УслугаРазмещения)
				И Не ДанныеСтроки.УслугаРазмещения = Перечисления.ВидыУслугРазмещения.РаннийЗаездПозднийВыезд Тогда
				ДанныеСтроки.ВидЛьготыПоТуристическомуНалогу = Перечисления.ВидыЛьготПоТуристическомуНалогу.НеПрименяется;
			Иначе
				ДанныеСтроки.ВидЛьготыПоТуристическомуНалогу = Перечисления.ВидыЛьготПоТуристическомуНалогу.ПустаяСсылка();
			КонецЕсли;
		КонецЕсли;
		
		Если СведенияОНоменклатуре.ВидМаркировки = Перечисления.ВидыПродукцииИС.ПродукцияИзНатуральногоМеха Тогда
			ДанныеСтроки.Количество = 1;
		КонецЕсли;
		
		Если ДанныеОбъекта.ВедетсяУчетПрослеживаемыхТоваров Тогда
			ДанныеСтроки.ПрослеживаемыйТовар    = СведенияОНоменклатуре.ПрослеживаемыйТовар Или СведенияОНоменклатуре.ПрослеживаемыйКомплект;
			ДанныеСтроки.ПрослеживаемыйКомплект = СведенияОНоменклатуре.ПрослеживаемыйКомплект;
		Иначе
			ДанныеСтроки.ПрослеживаемыйТовар    = Ложь;
			ДанныеСтроки.ПрослеживаемыйКомплект = Ложь;
		КонецЕсли;
...
Процедура ЗаполнитьРассчитатьСуммы(Знач ВалютаДоИзменения, КурсДоИзменения, КратностьДоИзменения, ПерезаполнитьЦены = Ложь, ПересчитатьЦены = Ложь, ПересчитатьНДС = Ложь);
	...
	Если ПерезаполнитьЦены Тогда
		...
		ОбщегоНазначенияКлиентСервер.ДополнитьМассив(СписокНоменклатуры,
			ОбщегоНазначения.ВыгрузитьКолонку(Объект.Возвраты, "Номенклатура"), Истина);
...
Процедура ЗаполнитьДобавленныеКолонкиТаблиц(ИмяТаблицы = "")
	...
	Если ПустаяСтрока(ИмяТаблицы) ИЛИ ИмяТаблицы = "Товары" Тогда
		...
		Для каждого СтрокаТаблицы Из Объект.Товары Цикл
			...
			ЗаполнитьДобавленныеКолонкиСтрокиТаблицыТовары(ЭтотОбъект, СтрокаТаблицы, Объект.СуммаВключаетНДС, СведенияОНоменклатуре);
			ОтобразитьСубконтоСчетаДоходов = ОтобразитьСубконтоСчетаДоходов
				Или Не СтрокаТаблицы.СчетДоходовВедетсяУчетПоНоменклатурнымГруппам;
		КонецЦикла;
...
Процедура ОбработкаОповещенияОбработкиТабличнойЧастиТоварыНаСервере(Параметры)
	...
	Для Каждого СтрокаТабличнойЧасти ИЗ ДобавленныеСтроки Цикл
		...
		ЗаполнитьДобавленныеКолонкиСтрокиТаблицыТовары(ЭтотОбъект, СтрокаТабличнойЧасти, Объект.СуммаВключаетНДС, СведенияОНоменклатуре);
...
Процедура ОбработкаВыбораПодборВставкаИзБуфераНаСервере(ВыбранноеЗначение, ИмяТаблицы)
	...
	Для Каждого СтрокаТабличнойЧасти ИЗ ТаблицаТоваров Цикл
		...
		НоваяСтрокаТабличнойЧасти = Объект[ИмяТаблицы].Добавить();
		ЗаполнитьЗначенияСвойств(НоваяСтрокаТабличнойЧасти, СтрокаТабличнойЧасти);
		
		СтрокиДляЗаполненияСчетов.Добавить(НоваяСтрокаТабличнойЧасти);
		
		Если ИмяТаблицы = "АгентскиеУслуги" Тогда
			ЗаполнитьДобавленныеКолонкиСтрокиТаблицыАгентскиеУслуги(НоваяСтрокаТабличнойЧасти, Объект.СуммаВключаетНДС);
			Продолжить;
		КонецЕсли;
		...
		Если ВедетсяУчетПрослеживаемыхТоваров Тогда
			НоваяСтрокаТабличнойЧасти.ПрослеживаемыйТовар = СведенияОНоменклатуре.ПрослеживаемыйТовар Или СведенияОНоменклатуре.Прослеживаемыйкомплект;
			НоваяСтрокаТабличнойЧасти.Прослеживаемыйкомплект = СведенияОНоменклатуре.ПрослеживаемыйКомплект;
		Иначе
			НоваяСтрокаТабличнойЧасти.ПрослеживаемыйТовар = Ложь;
			НоваяСтрокаТабличнойЧасти.ПрослеживаемыйКомплект = Ложь;
		КонецЕсли;
		
		ЗаполнитьДобавленныеКолонкиСтрокиТаблицыТовары(ЭтотОбъект, НоваяСтрокаТабличнойЧасти, Объект.СуммаВключаетНДС, СведенияОНоменклатуре);
...
#Область КандидатыНаПереносвУчетПрослеживаемыхТоваровКлиентСервер

&НаКлиенте
Процедура ОчиститьСведенияПрослеживаемостиПоСтроке(СтрокаТабличнойЧасти)
...
Процедура УдалитьСвязанныеЗаписиНаСервере()
	...
	Для каждого СтрокаКлюча Из ТаблицаУдаленныхСтрок Цикл
		...
		КонецЕсли;
		СтрокиВозвратов = Объект.Возвраты.НайтиСтроки(СтруктураОтбора);
		Если СтрокиВозвратов.Количество() > 0 Тогда
			ПрослеживаемостьФормыКлиентСерверБП.ЗаполнитьПредставлениеРНПТ(ЭтаФорма, СтрокиВозвратов[0]);
		КонецЕсли;
	КонецЦикла;
...
Функция ПолучитьИмяТекущейТабличнойЧасти()
	...
	ИначеЕсли ИмяТекущейСтраницы = "СтраницаВозвраты" Тогда	
		ИмяТаблицы = "Возвраты";
	ИначеЕсли ИмяТекущейСтраницы = "СтраницаАгентскиеУслуги" Тогда	
		ИмяТаблицы = "АгентскиеУслуги";
	КонецЕсли;
...
Процедура УстановитьДоступностьКомандыВставки(Форма, Доступность)
	...
	Элементы.АгентскиеУслугиВставитьСтроки.Доступность				 = Доступность;
	Элементы.АгентскиеУслугиКонтекстноеМенюВставитьСтроки.Доступность = Доступность;
...
Функция НачатьЗаполнениеСчетовУчета(ПричиныИзменения, Объект = Неопределено, СтрокаСписка = Неопределено, КонтейнерОбъект = Неопределено, КонтейнерСтрокаСписка = Неопределено)
	...
	// ПредоплатыПолученные.Контрагент
	Если ПараметрыЗаполнения.ПричиныИзменения.Найти("Предоплаты.Контрагент") <> Неопределено Тогда
		СчетаУчетаВДокументахКлиентСервер.НачатьЗаполнениеРеквизита(ПараметрыЗаполнения, "Предоплаты.СчетРасчетов");
	КонецЕсли;
	
	// ПредоплатыПолученные.Контрагент
	Если ПараметрыЗаполнения.ПричиныИзменения.Найти("ЗачетАвансов.Контрагент") <> Неопределено Тогда
		СчетаУчетаВДокументахКлиентСервер.НачатьЗаполнениеРеквизита(ПараметрыЗаполнения, "ЗачетАвансов.СчетРасчетов");
	КонецЕсли;
...
&НаСервереБезКонтекста
Функция СтавкаНДСНаДату(Номенклатура, ПараметрыДанныхОНоменклатуре)
	
	ПараметрыДанныхОНоменклатуре.Вставить("Реализация", Истина);
	
	СведенияОНоменклатуре = БухгалтерскийУчетПереопределяемый.ПолучитьСведенияОНоменклатуре(
		Номенклатура, ПараметрыДанныхОНоменклатуре, Ложь, Ложь);
		
	Возврат СведенияОНоменклатуре.СтавкаНДС
КонецФункции
...
&НаКлиенте
Процедура ЗагруженнаяНоменклатураЧеков(Команда)
	ПодключитьОбработчикОжидания("ПоказатьНесопоставленныеОбъектыНаКлиенте", 0.1, Истина);
КонецПроцедуры

&НаСервереБезКонтекста
Функция ПредоплатаКонтрагентПриИзмененииНаСервере(Знач ДанныеОбъекта, Знач ДанныеСтроки, Знач СчетаУчетаКЗаполнению);
	Результат = Новый Структура;
...
&НаСервереБезКонтекста
Функция ЗачетПредоплатыКонтрагентПриИзмененииНаСервере(Знач ДанныеОбъекта, Знач ДанныеСтроки, Знач СчетаУчетаКЗаполнению);
	Результат = Новый Структура;
...
&НаКлиенте
Процедура ПредоплатыСуммаПолученоПриИзменении(Элемент)
	ТекущиеДанные = Элементы.Предоплаты.ТекущиеДанные;
	ТекущиеДанные.СуммаВозврат = 0;
КонецПроцедуры

&НаКлиенте
Процедура ПредоплатыСуммаВозвращеноПриИзменении(Элемент)
	ТекущиеДанные = Элементы.Предоплаты.ТекущиеДанные;
...
Процедура УстановитьПараметрыВыбораСтавкиНДС()
	...
	УчетНДС.УстановитьПараметрыВыбораСтавкиНДС(ЭтотОбъект, "ВозвратыСтавкаНДС", "РозничнаяПродажа");
	УчетНДС.УстановитьПараметрыВыбораСтавкиНДС(ЭтотОбъект, "АгентскиеУслугиСтавкаНДС", "РозничнаяПродажа");
	УчетНДС.УстановитьПараметрыВыбораСтавкиНДС(ЭтотОбъект, "ПредоплатыСтавкаНДС", "РозничнаяПродажа");
	УчетНДС.УстановитьПараметрыВыбораСтавкиНДС(ЭтотОбъект, "ОплатаСчетовСтавкаНДС", "РозничнаяПродажа");
	
КонецПроцедуры

#КонецОбласти

#Область ОбработчикиСобытийТаблицыФормыЗачетАвансов

&НаКлиенте
Процедура ЗачетАвансовКонтрагентПриИзменении(Элемент)
	...
	ПричиныИзменения = Новый Массив;
	ПричиныИзменения.Добавить("ЗачетАвансов.Контрагент");
	ПричиныИзменения.Добавить("ЗачетАвансов.ДоговорКонтрагента"); // Договор может измениться в ходе серверного вызова
	...
	// Заполним
	Изменения = ЗачетПредоплатыКонтрагентПриИзмененииНаСервере(ДанныеОбъекта, ДанныеСтроки, ПараметрыЗаполненияСчетовУчета.КЗаполнению);
	ЗаполнитьЗначенияСвойств(СтрокаТаблицы, Изменения);
КонецПроцедуры
	
#КонецОбласти

#Область ОбработчикиСобытийТаблицыФормыПредоплаты

&НаКлиенте
Процедура ПредоплатыКонтрагентПриИзменении(Элемент)
	СтрокаТаблицы = Элементы.Предоплаты.ТекущиеДанные;
	Если СтрокаТаблицы = Неопределено Тогда
		Возврат;
	КонецЕсли;
	...
	ПричиныИзменения = Новый Массив;
	ПричиныИзменения.Добавить("Предоплаты.Контрагент");
	ПричиныИзменения.Добавить("Предоплаты.ДоговорКонтрагента"); // Договор может измениться в ходе серверного вызова
	...
	// Заполним
	Изменения = ПредоплатаКонтрагентПриИзмененииНаСервере(ДанныеОбъекта, ДанныеСтроки, ПараметрыЗаполненияСчетовУчета.КЗаполнению);
	ЗаполнитьЗначенияСвойств(СтрокаТаблицы, Изменения);
КонецПроцедуры
...
Процедура АдаптироватьМККоманднаяПанельФормы()
	...
	//Печать создается в группе ГруппаВажныеКоманды
	ПечатьОтчетККМ = Элементы.Найти("ПодменюПечатьОбычное__ОтчетККМ");
	Если ПечатьОтчетККМ <> Неопределено Тогда
		МобильныйКлиентБПФормаОбъекта.ПеренестиКомандуВПодменюМКПоделиться(Элементы, ПечатьОтчетККМ);
	КонецЕсли;
...
Процедура АдаптироватьМКШапкаФормы()
	...
	МобильныйКлиентБПФормаОбъекта.ВстроитьЭлементФормыВГруппаМКФормаВажное(Элементы, Элементы.ИнвентаризацияТоваровНаСкладе);
	...
	МобильныйКлиентБПФормаОбъекта.ВстроитьЭлементФормыВГруппаМКФормаПрочее(Элементы, Элементы.ДеятельностьНаТорговомСборе);
	
	МобильныйКлиентБПФормаОбъекта.ВстроитьЭлементФормыВГруппаМКФормаПрочее(Элементы,
		Элементы.ЗагруженнаяНоменклатураЧеков);
	...
	Элементы.ВалютаВсего.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Лево;
	Элементы.ВалютаВсего.ГоризонтальноеПоложение = ГоризонтальноеПоложениеЭлемента.Право;
	Элементы.ВалютаВсего.РастягиватьПоГоризонтали = Истина;
	Элементы.ВалютаВсего.Ширина = 0;
	
	Элементы.ВалютаСуммаБезнал.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Лево;
	Элементы.ВалютаСуммаБезнал.ГоризонтальноеПоложение = ГоризонтальноеПоложениеЭлемента.Право;
	Элементы.ВалютаСуммаБезнал.РастягиватьПоГоризонтали = Истина;
	Элементы.ВалютаСуммаБезнал.Ширина = 0;
	
	Элементы.ГруппаИтогиВсего.Объединенная = Ложь;
	Элементы.ГруппаИтогиСуммаБезнал.Объединенная = Ложь;
	...
	Элементы.ГруппаИтогиСуммаБезнал.ГоризонтальноеПоложениеПодчиненных = ГоризонтальноеПоложениеЭлемента.Авто;
	МобильныйКлиентБПФормаОбъекта.ВстроитьЭлементФормыВГруппаМКФормаПодвал(Элементы, Элементы.ГруппаИтогиФон);
...
Процедура АдаптироватьМККонтекстСписокФормы()
	...
	МобильныйКлиентБПФормаОбъекта.АдаптироватьКонтекстноеМеню(ЭтотОбъект, "", "Возвраты");
	...
	МобильныйКлиентБПФормаОбъекта.АдаптироватьКонтекстноеМеню(ЭтотОбъект, "", "ВозвратОплат");
...
Процедура АдаптироватьМКСписокФормы()
	...
	АдаптироватьМКСписокФормыВозвраты();
	...
	АдаптироватьМКСписокФормыВозвратОплат();
	
	АдаптироватьМКСписокФормыОплатаСчетов();
...
&НаСервере
Процедура АдаптироватьМКСписокФормыВозвраты()
	
	КомандыПоля = МобильныйКлиентБПФормаОбъекта.НовыйОписаниеКомандТабличноеПолеФормы();
	КомандыПоля.ИмяКомандыПодбор ="ПодборТоварыВозвраты";
	КомандыПоля.ИмяКомандыДобавитьСтроку = "ТоварыВозвратыДобавить";
	
	ОписаниеГруппыПоля = МобильныйКлиентБПФормаОбъекта.НовыйОписаниеГруппыТабличноеПолеФормы();
	ОписаниеГруппыПоля.ЭлементГруппаПоля = Элементы.СтраницаВозвраты;
	
	ОписаниеКолонокПоля = МобильныйКлиентБПФормаОбъекта.НовыйОписаниеКолонокПоляТабличноеПолеФормы();
	ОписаниеКолонокПоля.КолонкаНомерСтроки = "ВозвратыНомерСтроки";
	ОписаниеКолонокПоля.ВажныеКолонки = "ВозвратыГруппаНоменклатура,ВозвратыНоменклатура";
	ОписаниеКолонокПоля.УстановитьВерхниеЗаголовки = 
		"ВозвратыНоменклатура,ВозвратыКиЗ_ГИСМ,ВозвратыСтранаПроисхождения,ВозвратыСтранаПроисхождения";
	ОписаниеКолонокПоля.СкрытьКолонки = "ВозвратыОтступ,ВозвратыПрослеживаемыйТовар,ВозвратыПодсказкаРНПТ";
	
	МобильныйКлиентБПФормаОбъекта.ПодготовитьТабличноеПолеФормыДокумента(ЭтотОбъект,
		Элементы.Возвраты, ОписаниеГруппыПоля, КомандыПоля, ОписаниеКолонокПоля);
	
	Элементы.Переместить(Элементы.ВозвратыНоменклатура, Элементы.Возвраты, Элементы.ВозвратыГруппаНоменклатура);
	
	Элементы.ВозвратыНоменклатураКод.ФиксацияВТаблице = ФиксацияВТаблице.Нет;
	Элементы.Переместить(Элементы.ВозвратыНоменклатураКод, Элементы.Возвраты, Элементы.ВозвратыГруппаКоличество);

	Элементы.ВозвратыНоменклатураАртикул.ФиксацияВТаблице = ФиксацияВТаблице.Нет;
	Элементы.Переместить(Элементы.ВозвратыНоменклатураАртикул, Элементы.Возвраты, Элементы.ВозвратыГруппаКоличество);
	
	Элементы.ВозвратыКоличество.Формат = "ЧФ='Кол-во: Ч'";
	Элементы.ВозвратыЦена.Формат = "ЧФ='Цена: Ч'";
	Элементы.ВозвратыСумма.Формат = "ЧФ='Сумма: Ч'";
	Элементы.ВозвратыСуммаНДС.Формат = "ЧФ='НДС: Ч'";
	Элементы.ВозвратыВсего.Формат = "ЧФ='Всего: Ч'";
	
	Элементы.ВозвратыРНПТ.ПодсказкаВвода = НСтр("ru = 'Нажмите для выбора'");
	
	Элементы.ВозвратыПрослеживаемыйТовар.ФиксацияВТаблице = ФиксацияВТаблице.Нет;
	
	Элементы.Переместить(Элементы.ВозвратыКиЗ_ГИСМ, Элементы.Возвраты, Элементы.ВозвратыСтранаПроисхождения);
	
	УстановитьУсловноеОформлениеВозвраты();
...
Процедура АдаптироватьМКСписокФормыПодарочныеСертификаты()
	...
	ОписаниеГруппыПоля = МобильныйКлиентБПФормаОбъекта.НовыйОписаниеГруппыТабличноеПолеФормы();
	ОписаниеГруппыПоля.ЭлементГруппаПоля = Элементы.СтраницаПродажаСертификатов;
...
Процедура АдаптироватьМКСписокФормыОплата()
	...
	ОписаниеГруппыПоля = МобильныйКлиентБПФормаОбъекта.НовыйОписаниеГруппыТабличноеПолеФормы();
	ОписаниеГруппыПоля.ЭлементГруппаПоля = Элементы.СтраницаОплата;
	
	ОписаниеКолонокПоля = МобильныйКлиентБПФормаОбъекта.НовыйОписаниеКолонокПоляТабличноеПолеФормы();
	ОписаниеКолонокПоля.КолонкаНомерСтроки = "ОплатаНомерСтроки";
	ОписаниеКолонокПоля.ВажныеКолонки = "ОплатаВидОплаты,ОплатаСуммаОплаты";
	...
	УстановитьУсловноеОформлениеОплата();
	
КонецПроцедуры

&НаСервере
Процедура АдаптироватьМКСписокФормыВозвратОплат()
	
	КомандыПоля = МобильныйКлиентБПФормаОбъекта.НовыйОписаниеКомандТабличноеПолеФормы();
	КомандыПоля.ИмяКомандыДобавитьСтроку = "ВозвратОплатДобавить";
	
	ОписаниеГруппыПоля = МобильныйКлиентБПФормаОбъекта.НовыйОписаниеГруппыТабличноеПолеФормы();
	ОписаниеГруппыПоля.ЭлементГруппаПоля = Элементы.СтраницаВозвратОплаты;
	
	ОписаниеКолонокПоля = МобильныйКлиентБПФормаОбъекта.НовыйОписаниеКолонокПоляТабличноеПолеФормы();
	ОписаниеКолонокПоля.КолонкаНомерСтроки = "ВозвратОплатыНомерСтроки";
	ОписаниеКолонокПоля.ВажныеКолонки = "ВозвратОплатыВидОплаты,ВозвратОплатыСуммаОплаты";
	ОписаниеКолонокПоля.УстановитьВерхниеЗаголовки = "ВозвратОплатыВидОплаты";
	ОписаниеКолонокПоля.СкрытьКолонки = "ВозвратОплатОтступ";
	
	МобильныйКлиентБПФормаОбъекта.ПодготовитьТабличноеПолеФормыДокумента(ЭтотОбъект,
		Элементы.ВозвратОплат, ОписаниеГруппыПоля, КомандыПоля, ОписаниеКолонокПоля);
	
	Элементы.ВозвратОплатыВидОплаты.Ширина = 0;
	
КонецПроцедуры

&НаСервере
Процедура АдаптироватьМКСписокФормыОплатаСчетов()
	
	КомандыПоля = МобильныйКлиентБПФормаОбъекта.НовыйОписаниеКомандТабличноеПолеФормы();
	КомандыПоля.ИмяКомандыДобавитьСтроку = "ОплатаСчетовДобавить";
	
	ОписаниеГруппыПоля = МобильныйКлиентБПФормаОбъекта.НовыйОписаниеГруппыТабличноеПолеФормы();
	ОписаниеГруппыПоля.ЭлементГруппаПоля = Элементы.СтраницаОплатаСчетов;
	
	ОписаниеКолонокПоля = МобильныйКлиентБПФормаОбъекта.НовыйОписаниеКолонокПоляТабличноеПолеФормы();
	ОписаниеКолонокПоля.КолонкаНомерСтроки = "ОплатаСчетовНомерСтроки";
	ОписаниеКолонокПоля.ВажныеКолонки = "ОплатаСчетовКонтрагент,ОплатаСчетовСчетНаОплату";
	ОписаниеКолонокПоля.УстановитьВерхниеЗаголовки = 
		"ОплатаСчетовКонтрагент,ОплатаСчетовСчетНаОплату";
	ОписаниеКолонокПоля.СкрытьКолонки = "ОплатаСчетовОтступ";
	
	МобильныйКлиентБПФормаОбъекта.ПодготовитьТабличноеПолеФормыДокумента(ЭтотОбъект,
		Элементы.ОплатаСчетов, ОписаниеГруппыПоля, КомандыПоля, ОписаниеКолонокПоля);
	
	Элементы.ОплатаСчетовСуммаОплаты.Формат = "ЧФ='Сумма оплаты: Ч'";
	Элементы.ОплатаСчетовСуммаНДС.Формат = "ЧФ='НДС: Ч'";
...
Функция ОписаниеТипаРеквизитаДокументОприходования()
	...
	Возврат Метаданные.Документы.ОтчетОРозничныхПродажах.ТабличныеЧасти.Товары.Реквизиты.ДокументОприходования.Тип;
	
КонецФункции

#КонецОбласти

#Область ТуристическийНалог
...
&НаСервере
Процедура ОбработатьОповещениеОЗаполненииДанныхYclients(Параметры)
	...
	Если ЗначениеЗаполнено(Параметры.Номенклатура) Тогда
		...
		Для Каждого СоответствиеНоменклатуры из Параметры.Номенклатура Цикл
			МассивНоменклатуры.Добавить(СоответствиеНоменклатуры.Значение);
		КонецЦикла;
		...
		СоответствиеСведенийОНоменклатуре = БухгалтерскийУчетПереопределяемый.ПолучитьСведенияОСпискеНоменклатуры(
			МассивНоменклатуры, ДанныеОбъекта, Ложь, Ложь);
			
		СтрокиДляЗаполненияСчетов = Новый Массив;
		
		Для Каждого СоответствиеНоменклатуры из Параметры.Номенклатура Цикл
			СтрокаТаблицыТовары = Объект.Товары.НайтиПоИдентификатору(СоответствиеНоменклатуры.Ключ-1);
			Если СтрокаТаблицыТовары <> Неопределено Тогда
				СтрокаТаблицыТовары.Номенклатура = СоответствиеНоменклатуры.Значение;
				
				СведенияОНоменклатуре = СоответствиеСведенийОНоменклатуре.Получить(СтрокаТаблицыТовары.Номенклатура);
				Если СведенияОНоменклатуре = Неопределено Тогда
					Продолжить;
				КонецЕсли;
				
				СтрокаТаблицыТовары.СтавкаНДС           = СведенияОНоменклатуре.СтавкаНДС;
				СтрокаТаблицыТовары.НомерГТД            = СведенияОНоменклатуре.НомерГТД;
				СтрокаТаблицыТовары.СтранаПроисхождения = СведенияОНоменклатуре.СтранаПроисхождения;
				ОбработкаТабличныхЧастейКлиентСервер.РассчитатьСуммуНДСТабЧасти(СтрокаТаблицыТовары, Объект.СуммаВключаетНДС);
				СтрокаТаблицыТовары.Всего = СтрокаТаблицыТовары.Сумма + ?(Объект.СуммаВключаетНДС, 0, СтрокаТаблицыТовары.СуммаНДС);
				
				ЗаполнитьДобавленныеКолонкиСтрокиТаблицыТовары(ЭтотОбъект, СтрокаТаблицыТовары, Объект.СуммаВключаетНДС, СведенияОНоменклатуре);
				
				СтрокиДляЗаполненияСчетов.Добавить(СтрокаТаблицыТовары);
		...
		// Заполнение счетов учета
		СчетаУчетаВДокументах.ЗаполнитьСтроки(СтрокиДляЗаполненияСчетов, "Товары", Объект, Документы.ОтчетОРозничныхПродажах, Истина);
	
		ОбновитьИтоги(ЭтаФорма);
		
	КонецЕсли;
	
	Если Параметры.Свойство("ДанныеСопоставленыАвтоматически")
		И Параметры.ДанныеСопоставленыАвтоматически Тогда
		Записать();
