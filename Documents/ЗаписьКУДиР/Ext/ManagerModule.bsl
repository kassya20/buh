...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ДобавитьДвиженияПоРасходамУменьшающимНалогУСН");
	Методы.Вставить("ЗарегистрироватьДанныеПервичныхДокументов");
	Методы.Вставить("ДобавитьДвиженияПоУплаченномуТорговомуСбору");
...
Функция ПодготовитьПараметрыПроведения(ДокументСсылка, Отказ) Экспорт
	...
	Запрос.Текст = ТекстЗапросаТаблицаСтроки(НомераТаблиц)
		...
		+ ТекстЗапросаУплаченныйТорговыйСбор(НомераТаблиц)
		+ ТекстЗапросаТаблицаУменьшениеНалогаНаБольничные(НомераТаблиц);
...
Функция ТекстЗапросаУплаченныйТорговыйСбор(НомераТаблиц)
...
Функция ТекстЗапросаТаблицаУменьшениеНалогаНаБольничные(НомераТаблиц)
	
	НомераТаблиц.Вставить("ТаблицаУменьшениеНалогаНаБольничные", НомераТаблиц.Количество());

	ТекстЗапроса =
	"ВЫБРАТЬ
	|	ЗаписьКУДиРУменьшениеНалогаНаБольничные.НомерСтроки КАК НомерСтроки,
	|	ЗаписьКУДиРУменьшениеНалогаНаБольничные.ДокументРасхода КАК ДокументРасхода,
	|	ЕСТЬNULL(ДанныеПервичныхДокументов.Дата, ДАТАВРЕМЯ(1, 1, 1)) КАК ДокументРасходаДата,
	|	ЗаписьКУДиРУменьшениеНалогаНаБольничные.Сумма КАК Сумма
	|ИЗ
	|	Документ.ЗаписьКУДиР.УменьшениеНалогаНаБольничные КАК ЗаписьКУДиРУменьшениеНалогаНаБольничные
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ДанныеПервичныхДокументов КАК ДанныеПервичныхДокументов
	|		ПО ЗаписьКУДиРУменьшениеНалогаНаБольничные.ДокументРасхода = ДанныеПервичныхДокументов.Документ
	|ГДЕ
	|	ЗаписьКУДиРУменьшениеНалогаНаБольничные.Ссылка = &Ссылка
	|
	|УПОРЯДОЧИТЬ ПО
	|	НомерСтроки";
...
Процедура СформироватьДвиженияЗаписьКУДиР(ПараметрыПроведения, Движения, Отказ) Экспорт
	...
	ТаблицаУменьшениеНалогаНаБольничные = ПараметрыПроведения.ТаблицаУменьшениеНалогаНаБольничные;
	...
	Для Каждого ЗаписьУменьшениеНалогаНаБольничные Из ТаблицаУменьшениеНалогаНаБольничные Цикл
		
		ДвижениеРасходыУменьшающиеНалог = Движения.РасходыУменьшающиеНалогПоОтдельнымРежимам.Добавить();
		ЗаполнитьЗначенияСвойств(ДвижениеРасходыУменьшающиеНалог, Реквизиты);
		ЗаполнитьЗначенияСвойств(ДвижениеРасходыУменьшающиеНалог, ЗаписьУменьшениеНалогаНаБольничные);
		
		ДвижениеРасходыУменьшающиеНалог.СчетУчета = ПланыСчетов.Хозрасчетный.РасчетыСПерсоналомПоОплатеТруда;
		
		Если Реквизиты.ДеятельностьНаПатенте Тогда
			
			ДвижениеРасходыУменьшающиеНалог.СуммаРасходаПСН = ЗаписьУменьшениеНалогаНаБольничные.Сумма;
			
		Иначе
			
			ДвижениеРасходыУменьшающиеНалог.СуммаРасхода = ЗаписьУменьшениеНалогаНаБольничные.Сумма;
			
			ДвижениеУменьшениеНалога = Движения.КнигаУчетаДоходовИРасходовРаздел4.Добавить();
			ЗаполнитьЗначенияСвойств(ДвижениеУменьшениеНалога, Реквизиты);
			ЗаполнитьЗначенияСвойств(ДвижениеУменьшениеНалога, ЗаписьУменьшениеНалогаНаБольничные);
			
			ДвижениеУменьшениеНалога.Больничные = ЗаписьУменьшениеНалогаНаБольничные.Сумма;
