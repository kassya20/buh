...
Процедура ЗаполнитьДокумент(Параметры, АдресРезультата) Экспорт
	...
	Иначе
		...
		ДанныеТаблиц = ПрослеживаемостьБП.ЗаполнитьДокументДаннымиИзКоррДокументов(
							Параметры.Дата,
							Параметры.Организация,
...
Функция ЗаполнитьДокументДанными(Период, Организация, ДокументОснование = Неопределено, ПервичныйДокумент = Неопределено, НомерКорректирвоки = 0) Экспорт
	...
	|		ПО РеализацияПрослеживаемыхТоваровОстатки.КорректировочныйДокумент = ДанныеПервичныхДокументов.Документ
	|ГДЕ
	|	ВЫБОР
	...
	|			ИНАЧЕ ИСТИНА
	|		КОНЕЦ
	|	И ДанныеПервичныхДокументов.Документ ЕСТЬ NULL
	|	И &НомерКорректировки = 0
	|	И РеализацияПрослеживаемыхТоваровОстатки.КоличествоОстаток > 0
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
