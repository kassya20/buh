...
Функция ЗаполнитьДокументНаСервере()
	...
	ПараметрыОбработчика = Новый Структура("Организация,Дата,НомерКорректировки,ПервичныйДокумент",
		Объект.Организация, КонецДня(Объект.Дата), Объект.НомерКорректировки, Объект.ПервичныйДокумент);
