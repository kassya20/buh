...
Процедура ПодготовитьФормуНаСервере()
	...
	ВидыОпераций = Перечисления.ВидыОперацийВозвратТоваровОтПокупателя.СписокДоступныхЗначений(
...
Функция ВидыОперацийПоДаннымЗаполнения(ЗначенияЗаполнения)
	...
	Возврат РаботаСДоговорамиКонтрагентовБПВызовСервера.ВидыОперацийДокумента(
		СвойстваДоговора.ВидДоговора, Тип("ДокументСсылка.ВозвратТоваровОтПокупателя"), Ложь);
