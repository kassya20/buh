...
Процедура УстановитьУсловноеОформлениеВидимость()
	...
	// НДСсАвансов реквизиты отгрузочного счета-фактуры.
	ЭлементУО = УсловноеОформление.Элементы.Добавить();

	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУО.Поля, "НДСсАвансовНомерИсправленияСчетаФактуры");
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУО.Поля, "НДСсАвансовДатаИсправленияСчетаФактуры");
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУО.Поля, "НДСсАвансовНомерСчетаФактуры");
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУО.Поля, "НДСсАвансовДатаСчетаФактуры");
...
Процедура УстановитьФункциональныеОпцииФормы()
	...
	ДатаНачалаРаботыКонтроляДолиВычетов   = УчетНДСКлиентСервер.НачалоРаботыКонтроляДолиВычетов();
...
Функция ПараметрыПереносаСтрокТабличныхЧастей(РежимЗаписи)
	...
	Если Элементы.ГруппаНДСсАвансовВыданных.Видимость Тогда
		ТабличныеЧасти.Вставить("НДСсАвансовВыданных", Новый Структура("КоличествоСтрокДляПереноса", 0));
	КонецЕсли;
...
Процедура ИспользуемыеКодыОперацийПоСтавке0(Знач ДокументОтгрузки, Знач ДокументПриобретения, Знач Состояние)
	...
	Запрос.УстановитьПараметр("ТаблицаКодовОпераций0", ДанныеФормыВЗначение(ТоварыИУслугиКодыОпераций0, Тип("ТаблицаЗначений")));
