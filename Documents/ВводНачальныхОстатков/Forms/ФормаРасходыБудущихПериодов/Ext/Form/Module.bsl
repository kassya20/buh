...
Процедура РасходыБудущихПериодовПередНачаломИзменения(Элемент, Отказ)
	...
	ИзменитьПараметрыВыбораПолейСубконто(ЭтотОбъект);
	УстановитьЗаголовкиИДоступностьСубконто(ЭтотОбъект, СтрокаТаблицы.СчетУчета);
...
Процедура ПоказатьОписаниеРаздела(Команда)
	...
	ОткрытьФорму("Документ.ВводНачальныхОстатков.Форма.ФормаСправки", Новый Структура("ДанныеЗаполнения", ДанныеЗаполнения), ЭтотОбъект);
...
Процедура ПодготовитьФормуНаСервере()
	...
	МассивСчетов.Добавить(ПланыСчетов.Хозрасчетный.ПриобретениеПравНаИспользованиеРезультатовИнтеллектуальнойДеятельности );
...
Функция ОписаниеТипаРеквизитаРасчетныйДокумент()
	...
	Возврат Метаданные.Документы.ВводНачальныхОстатков.ТабличныеЧасти.РасходыБудущихПериодов.Реквизиты.РасчетныйДокумент.Тип;
