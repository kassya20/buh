...
Процедура ПодготовитьФормуНаСервере()
	...
	ИначеЕсли Объект.РазделУчета = Перечисления.РазделыУчетаДляВводаОстатков.НДСПоАвансамПолученным Тогда
		...
		УчетНДС.УстановитьПараметрыВыбораСтавкиНДС(ЭтотОбъект, "ДанныеПоНДССтавкаНДС", "Авансы");
	Иначе
...
Процедура ДокументОплатыНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка, СтрокаТаблицы, ИсточникТиповДокументов)
	...
	ПараметрыОбъекта.Вставить("ДоговорКонтрагента",		СтрокаТаблицы.ДоговорКонтрагента);
	ПараметрыОбъекта.Вставить("ОстаткиОбороты",			"Дт");
	ПараметрыОбъекта.Вставить("ТипыДокументов",			ОписаниеТипаРеквизитаДокументОплаты(ИсточникТиповДокументов));
	ПараметрыОбъекта.Вставить("РежимОтбораДокументов",	ПредопределенноеЗначение("Перечисление.РежимОтбораДокументов.ПоРеквизитам"));
...
Процедура ЗаполнитьРеквизитыСчетаФактуры(ДанныеСтроки)
	...
	Если ДанныеСтроки.ПредъявленСФ 
		...
		Если Объект.РазделУчета = Перечисления.РазделыУчетаДляВводаОстатков.НДСНачисленный Тогда
			//выданный СФ
			РеквизитыСчетаФактурыДляПредставления = Новый Структура("Дата, Номер, Исправление, НомерИсправления, ОтредактированНомерСчетаФактуры,
			...
			РеквизитыСчетаФактурыДляПредставления.ОтредактированНомерСчетаФактуры = Ложь;
...
Функция ОписаниеТипаРеквизитаСчетФактура()
	...
	Возврат Метаданные.Документы.ВводНачальныхОстатков.ТабличныеЧасти.ДанныеПоНДС.Реквизиты.СчетФактура.Тип;
	
КонецФункции

&НаСервереБезКонтекста
Функция ОписаниеТипаРеквизитаДокументОплаты(ИсточникТиповДокументов)
	
	Возврат Метаданные.РегистрыНакопления[ИсточникТиповДокументов].Измерения.ДокументОплаты.Тип;
