...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	РасходныйКассовыйОрдерФормыКлиент.ЗадатьВопросОПроверкеПравильностиРеквизитов(
		ЭтотОбъект, ПроверкаРеквизитовПередЗаписьюНаСервере(), ПараметрыЗаписи, Отказ);
...
Процедура ОбработкаНавигационнойСсылки(НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	РасходныйКассовыйОрдерФормыКлиент.ОбработкаНавигационнойСсылки(ЭтотОбъект, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка);
КонецПроцедуры
...
Процедура ДатаПриИзменении(Элемент)
	...
	ПлатежиВБюджетКлиентСервер.ПроверитьИсправитьНедопустимыеРеквизитыПлатежаВБюджет(
		Объект.ВидПеречисленияВБюджет, Объект.Дата, Объект.СтатусСоставителя, Объект.ПоказательОснования);
	НадписьРеквизитыПлатежейВБюджет = РасходныйКассовыйОрдерФормыКлиентСервер.НадписьРеквизитыПлатежейВБюджет(ЭтотОбъект);
...
Процедура КонтрагентСоздание(Элемент, СтандартнаяОбработка)
	...
	РасходныйКассовыйОрдерФормыКлиент.КонтрагентСоздание(ЭтотОбъект, Элемент, Элемент.ТекстРедактирования, СтандартнаяОбработка);
...
Процедура ВедомостьПоДоговоруПодрядаПриИзменении(Элемент)
	...
	РасходныйКассовыйОрдерФормыКлиент.ВедомостьЗарплатаРаботникуПриИзменении(ЭтотОбъект, Элемент);
	УстановитьДоступностьРеквизитовВыплатыПоДоговору();
...
Процедура ВедомостьПоДоговоруПодрядаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	РасходныйКассовыйОрдерФормыКлиент.ВедомостьПоДоговоруПодрядаНачалоВыбора(ЭтотОбъект, Элемент, ДанныеВыбора, СтандартнаяОбработка);
...
Процедура ПрочееОтражениеВУСНПриИзменении(Элемент)
	...
	РасходныйКассовыйОрдерФормыКлиент.ПрочееОтражениеВУСНПриИзменении(ЭтотОбъект, Элемент);
...
Процедура НомерЧекаНПДНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	РасходныйКассовыйОрдерФормыКлиент.НомерЧекаНПДНачалоВыбора(ЭтотОбъект, Элемент, ДанныеВыбора, СтандартнаяОбработка);
...
Процедура НомерЧекаНПДАвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
	...
	РасходныйКассовыйОрдерФормыКлиент.НомерЧекаНПДАвтоПодбор(
...
&НаКлиенте
Процедура РасшифровкаПлатежаСтатьяДвиженияДенежныхСредствАвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
...
Процедура РасшифровкаПлатежаДоговорКонтрагентаСоздание(Элемент, СтандартнаяОбработка)
	...
	РасходныйКассовыйОрдерФормыКлиент.РасшифровкаПлатежаДоговорКонтрагентаСоздание(
...
Процедура РасшифровкаПлатежаДоговорКонтрагентаОкончаниеВводаТекста(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, СтандартнаяОбработка)
	...
	РасходныйКассовыйОрдерФормыКлиент.РасшифровкаПлатежаДоговорКонтрагентаОкончаниеВводаТекста(
...
Процедура РасшифровкаПлатежаОтражениеВУСНПриИзменении(Элемент)
	...
	РасходныйКассовыйОрдерФормыКлиент.РасшифровкаПлатежаОтражениеВУСНПриИзменении(ЭтотОбъект, Элемент);
...
Процедура РасшифровкаПлатежаОтражениеДоходаПредставлениеПриИзменении(Элемент)
	...
	РасходныйКассовыйОрдерФормыКлиент.РасшифровкаПлатежаОтражениеДоходаПредставлениеПриИзменении(
		ЭтотОбъект, Элемент);
...
Процедура РасшифровкаПлатежаОтражениеДоходаПредставлениеОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	РасходныйКассовыйОрдерФормыКлиент.РасшифровкаПлатежаОтражениеДоходаПредставлениеОбработкаВыбора(
		ЭтотОбъект, Элемент, ВыбранноеЗначение, СтандартнаяОбработка);
...
Процедура СчетОрганизацииПриИзмененииСервер()
	...
	РасходныйКассовыйОрдерФормы.СчетОрганизацииПриИзмененииСервер(ЭтотОбъект);
...
Процедура ОбновитьРеквизитыПоНомеруНПД();
	...
	Если ЗначениеЗаполнено(ВыбранныйДокумент) Тогда
		ОбработкаВыбораПКО(ВыбранныйДокумент);
	КонецЕсли;
	
КонецПроцедуры 

&НаСервере
Процедура ОбработкаВыбораПКО(ВыбранныйДокумент)
	
	Документы.РасходныйКассовыйОрдер.ЗаполнитьПоПКО(ВыбранныйДокумент, ЭтотОбъект);
...
Процедура НаправлениеДеятельностиПриИзмененииНаСервере()
	...
	РасходныйКассовыйОрдерФормы.ЗаполнитьБыстрыйВыборСтатьиРасходов(ЭтотОбъект);
	
КонецПроцедуры

&НаСервере
Процедура УстановитьДоступностьРеквизитовВыплатыПоДоговору()
...
Процедура МобильныйКлиентАдаптацияФормы()
	...
	РасходныйКассовыйОрдерФормы.АдаптироватьЭлементыМКФормыДокумента(ЭтотОбъект);
...
Процедура АдаптироватьМКШапкаФормы()
	...
	МобильныйКлиентБПФормаОбъекта.ВстроитьЭлементФормыВГруппаМКФормаВажное(Элементы, Элементы.НадписьРеквизитыПлатежейВБюджет);
	МобильныйКлиентБПФормаОбъекта.ВстроитьЭлементФормыВГруппаМКФормаВажное(Элементы, Элементы.ГруппаКонтрагент);
	МобильныйКлиентБПФормаОбъекта.ВстроитьЭлементФормыВГруппаМКФормаВажное(Элементы, Элементы.СчетКонтрагента);
	...
	Элементы.ГруппаСуммаДокументаВалютаДокумента.Группировка = ГруппировкаПодчиненныхЭлементовФормы.Вертикальная;
	...
	//Адаптация элементов выполняется в общем модуле РасходныйКассовыйОрдерФормы
