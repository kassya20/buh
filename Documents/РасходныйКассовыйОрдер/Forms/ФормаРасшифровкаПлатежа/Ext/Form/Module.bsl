...
Процедура РасшифровкаПлатежаОтражениеДоходаПредставлениеПриИзменении(Элемент)
	...
	РасходныйКассовыйОрдерФормыКлиент.РасшифровкаПлатежаОтражениеДоходаПредставлениеПриИзменении(ЭтотОбъект, Элемент);
...
Процедура АдаптироватьМКСписокФормы()
	...
	ОписаниеГруппыПоля.ЭлементГруппаПоля = Элементы.ГруппаРасшифровкаПлатежа;
	
	ОписаниеКолонокПоля = МобильныйКлиентБПФормаОбъекта.НовыйОписаниеКолонокПоляТабличноеПолеФормы();
	ОписаниеКолонокПоля.ВажныеКолонки = "РасшифровкаПлатежаВидПлатежаПоКредитамЗаймам,РасшифровкаПлатежаДоговорКонтрагента,РасшифровкаПлатежаСуммаПлатежа";
	ОписаниеКолонокПоля.УстановитьВерхниеЗаголовки = 
		"РасшифровкаПлатежаВидПлатежаПоКредитамЗаймам,РасшифровкаПлатежаДоговорКонтрагента,РасшифровкаПлатежаСтатьяДвиженияДенежныхСредств,"
		+ "РасшифровкаПлатежаСчетНаОплату,РасшифровкаПлатежаСделка";
	...
	Элементы.РасшифровкаПлатежаДоговорКонтрагента.Ширина = 10;
	Элементы.РасшифровкаПлатежаВидПлатежаПоКредитамЗаймам.Ширина = 10;
	Элементы.РасшифровкаПлатежаВидПлатежаПоКредитамЗаймам.РастягиватьПоГоризонтали = Истина;
	Элементы.Переместить(Элементы.РасшифровкаПлатежаВидПлатежаПоКредитамЗаймам, Элементы.РасшифровкаПлатежа, Элементы.РасшифровкаПлатежаГруппаДоговор);
	...
	Элементы.РасшифровкаПлатежаРасходыУСН.Формат = "ЧФ='Расход УСН: Ч'";
	...
	ОписаниеКолонокПоля = МобильныйКлиентБПФормаОбъекта.НовыйОписаниеКолонокПоляТабличноеПолеФормы();
	ОписаниеКолонокПоля.ВажныеКолонки = "РасшифровкаВыручкиСуммаПлатежа";
