...
&НаКлиенте
Процедура ФакторинговаяКомпанияСоздание(Элемент, СтандартнаяОбработка)
...
Функция ОписаниеТипаРеквизитаСделка()
	...
	Возврат Метаданные.Документы.ПередачаЗадолженностиНаФакторинг.ТабличныеЧасти.ДебиторскаяЗадолженность.Реквизиты.Сделка.Тип;
