...
Процедура УстановитьУсловноеОформлениеШапкаИВидимость()
	...
	ОбщегоНазначенияКлиентСервер.ДобавитьЭлементКомпоновки(ЭлементУО.Отбор,
		"ЕНВДОтменен", ВидСравненияКомпоновкиДанных.Равно, Ложь);
...
Процедура УстановитьУсловноеОформлениеНДСКРаспределению() Экспорт
	...
	// РаспределяемыйНДСИсправленныйСчетФактура
	
	ЭлементУО = УсловноеОформление.Элементы.Добавить();

	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУО.Поля, "РаспределяемыйНДСИсправленныйСчетФактура");
	ОбщегоНазначенияКлиентСервер.ДобавитьЭлементКомпоновки(ЭлементУО.Отбор,
...
Процедура УстановитьФункциональныеОпцииФормы()
	...
	Если Объект.Дата >= ДатаОтменыЕНВД Тогда
		ЕНВДОтменен = Истина;
	Иначе
		ЕНВДОтменен = Ложь;
	КонецЕсли;
...
Процедура УправлениеФормой(Форма)
	...
	Если Форма.ЕНВДОтменен Тогда
		Элементы.ВыручкаБезНДС.Заголовок   = НСтр("ru='- не облагаемой НДС'");
	Иначе
		Элементы.ВыручкаБезНДС.Заголовок   = НСтр("ru='- не облагаемой НДС (не ЕНВД)'");
	КонецЕсли;
	...
	Элементы.ВыручкаЕНВД.Видимость                                           = НЕ Форма.ЕНВДОтменен;
	Элементы.СоставКосвенныхРасходовБазисРаспределенияВключаетЕНВД.Видимость = НЕ Форма.ЕНВДОтменен;
	Элементы.СоставКосвенныхРасходовГруппаЕНВД.Видимость                     = НЕ Форма.ЕНВДОтменен;
	Элементы.ГруппаСтатьиЗатрат.Видимость                                    = Не Форма.ЕНВДОтменен;
