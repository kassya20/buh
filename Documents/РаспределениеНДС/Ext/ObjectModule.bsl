...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если НЕ ЕстьВыручкаБезНДС ИЛИ ЕНВДОтменен Тогда
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	СтруктураТаблицУСН = Новый Структура("ТаблицаВключенныйВСтоимостьНДС", ПараметрыПроведения.ТаблицаВключенныйВСтоимостьНДСУСН);
