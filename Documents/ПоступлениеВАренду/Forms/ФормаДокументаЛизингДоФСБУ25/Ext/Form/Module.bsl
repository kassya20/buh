...
Процедура КонтрагентОбработатьИзменениеНаСервере()
	...
	Если НЕ ПолучитьФункциональнуюОпцию("ВестиУчетПоДоговорам") Тогда
		...
		Для Каждого СтрокаТаблицы Из Объект.ПредметыЛизинга Цикл
			Документы.ПоступлениеВАренду.ЗаполнитьСчетаУчетаВСтрокеТабличнойЧасти(ДанныеОбъекта, СтрокаТаблицы, "ПредметыЛизинга");
		КонецЦикла;
	КонецЕсли;
...
Процедура ОбработкаВыбораПодборНаСервере(ВыбранноеЗначение, ИмяТаблицы)
	...
	Для Каждого СтрокаТаблицы Из Таблица Цикл
		...
		Иначе
			...
			Документы.ПоступлениеВАренду.ЗаполнитьСчетаУчетаВСтрокеТабличнойЧасти(ДанныеОбъекта, СтрокаТабличнойЧасти, ИмяТаблицы);
...
Процедура ПредметыЛизингаНоменклатураПриИзмененииНаСервере(СтрокаТабличнойЧасти, Знач ДанныеОбъекта)
	...
	Документы.ПоступлениеВАренду.ЗаполнитьСчетаУчетаВСтрокеТабличнойЧасти(
