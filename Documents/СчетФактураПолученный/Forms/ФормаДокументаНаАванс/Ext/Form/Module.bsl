...
Процедура ПриЧтенииНаСервере(ТекущийОбъект)
	...
	КомментарииДокументовЗакрытогоПериодаВызовСервера.ПриЧтенииНаСервере(ЭтаФорма, ТекущийОбъект, "ГруппаПодвал", "Ответственный");
КонецПроцедуры
...
Функция ДанныеОбъектаДляОпределенияКВО()
	...
	КонецЕсли;
	ДанныеОбъекта.Вставить("ВидАгентскогоДоговора", ВидАгентскогоДоговора);
...
Функция ПараметрыДоплатыКАвансу(ДанныеСтроки)
	...
	|	И (СчетФактураПолученныйАвансы.СтавкаНДС = &УстаревшаяСтавкаНДС
	|			ИЛИ СчетФактураПолученныйАвансы.СтавкаНДС = &УстаревшаяРасчетнаяСтавкаНДС)
	|
	|СГРУППИРОВАТЬ ПО
...
Процедура АдаптироватьМКШапкаФормы()
	...
	Элементы.ГруппаПолучение.Группировка = ГруппировкаПодчиненныхЭлементовФормы.Вертикальная;
	Элементы.ОригиналПолучен.ПоложениеЗаголовка=ПоложениеЗаголовкаЭлементаФормы.Авто;
	МобильныйКлиентБПФормаОбъекта.ВстроитьЭлементФормыВГруппаМКФормаВажное(Элементы, Элементы.ГруппаПолучение);
	...
	МобильныйКлиентБПФормаОбъекта.ВстроитьЭлементФормыВГруппаМКФормаВажное(Элементы, Элементы.ГруппаЛевая);
	МобильныйКлиентБПФормаОбъекта.ПеренестиЭлементыВГруппаМКФормаПрочее(Элементы, Элементы.ГруппаПравая);
	
	МобильныйКлиентБПФормаОбъекта.ВстроитьЭлементФормыВГруппаМКФормаПрочее(Элементы, Элементы.ГруппаВидаОперации);
	МобильныйКлиентБПФормаОбъекта.ВстроитьЭлементФормыВГруппаМКФормаПрочее(Элементы, Элементы.КодСпособаПолучения);
	МобильныйКлиентБПФормаОбъекта.ВстроитьЭлементФормыВГруппаМКФормаПрочее(Элементы, Элементы.ГруппаСостояниеЭДО);
	
	МобильныйКлиентБПФормаОбъекта.ПеренестиЭлементыВГруппаМКФормаПрочее(Элементы, Элементы.ГруппаПодвал);
	...
	Элементы.ГруппаИтогиВсего.ЦветФона = ЦветаСтиля.ЦветФонаФормы;
	Элементы.ГруппаИтогиВсего.ГоризонтальноеПоложениеПодчиненных = ГоризонтальноеПоложениеЭлемента.Авто;
	Элементы.ГруппаИтогиВсего.Группировка = ГруппировкаПодчиненныхЭлементовФормы.Вертикальная;
	Элементы.ГруппаЕстьКомиссия.Группировка = ГруппировкаПодчиненныхЭлементовФормы.Вертикальная;
	
	МобильныйКлиентБПФормаОбъекта.ВстроитьЭлементФормыВГруппаМКФормаПодвал(Элементы, Элементы.ГруппаИтогиВсего);
...
Процедура АдаптироватьМКСписокФормы()
	...
	ОписаниеГруппыПоля.ЭлементГруппаПоля = Элементы.ГруппаРеквизитыСчетаФактурыНаАванс;
	...
	ОписаниеКолонокПоля.ВажныеКолонки = "АвансыКорректируемыйСчетФактура, АвансыСуммаДоКорректировки";
	ОписаниеКолонокПоля.УстановитьВерхниеЗаголовки = "АвансыКорректируемыйСчетФактура";
