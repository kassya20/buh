...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьЗначенияСвойств(ЭтотОбъект, Параметры,
		"ЭтоИсправлениеСобственнойОшибки, ВозвратЧерезКомиссионера,
		|ЗаявлениеОВвозеТоваровОтКомиссионера, ДатаВходящегоДокумента, ВидДоговораКонтрагента");
...
Процедура ПриЗакрытии(ЗавершениеРаботы)
	...
	Если ПеренестиВДокумент Тогда
		...
		Если ИзмененСоставПродавцов Тогда
			
			МассивПродавцов = Новый Массив;
			Для каждого Продавец Из Продавцы Цикл
				МассивПродавцов.Добавить(Продавец.Продавец);
			КонецЦикла;
			ЗаявлениеОВвозеТоваровОтКомиссионера = ДатаВходящегоДокумента >= '20240101'
			И ВидДоговораКонтрагента = ПредопределенноеЗначение("Перечисление.ВидыДоговоровКонтрагентов.СКомиссионеромНаЗакупку")
			И ЕстьПродавцыИзЕАЭС(МассивПродавцов);
		КонецЕсли;
		
		СтруктураВозврата.Вставить("ЗаявлениеОВвозеТоваровОтКомиссионера", ЗаявлениеОВвозеТоваровОтКомиссионера);
...
Функция ЕстьПродавцыИзЕАЭС(Знач Продавцы)
	
	Возврат Справочники.Контрагенты.ЕстьКонтрагентыИзЕАЭС(Продавцы);
