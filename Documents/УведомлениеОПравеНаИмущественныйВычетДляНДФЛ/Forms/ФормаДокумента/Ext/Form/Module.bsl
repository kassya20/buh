...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УправлениеПредупреждениямиАУСНВызовСервера.ДобавитьБаннерСПредупреждениемАУСН(ЭтотОбъект);
	УправлениеПредупреждениямиАУСНКлиентСервер.УстановитьВидимостьБаннераСПредупреждениемАУСН(ЭтотОбъект);
