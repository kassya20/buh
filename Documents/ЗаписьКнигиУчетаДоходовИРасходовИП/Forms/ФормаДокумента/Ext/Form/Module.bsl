...
Процедура ЗаполнитьПоАвансам(Команда)
	...
	ИначеЕсли Не МожноЗаполнитьПоАвансам(Объект.Организация, Объект.Дата) Тогда
		...
		ТекстСообщения = НСтр("ru = 'Авансы отражаются в составе доходов в конце квартала или в месяце перехода с общей системы налогообложения на иной налоговый режим'");
