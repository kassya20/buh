...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьЗначенияСвойств(ЭтотОбъект,
		ПараметрыРасчета,
		"Ссылка, Организация, Подразделение, МесяцНачисления, Сотрудник, ФизическоеЛицо, Начисление, ДатаВыплатыДохода, ЕдинаяДатаВыплатаДокумента");
...
Функция Начисление()
	...
	Если Новое Тогда
		...
		Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ЗарплатаКадрыДляНебольшихОрганизаций.РасчетЗарплаты") Тогда
			...
			Если МодульРасчетЗарплатыДляНебольшихОрганизаций.ОрганизацияПрименяетАУСН(Организация, МесяцНачисления) Тогда
