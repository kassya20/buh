...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	ИспользуетсяЕдинаяДатаВыплатыДохода = УчетЗарплаты.ИспользуетсяЕдинаяДатаВыплатыДохода(Организация, МесяцНачисления);
	МассивДатВыплаты = ОбщегоНазначения.ВыгрузитьКолонку(Начисления,"ПланируемаяДатаВыплаты", Истина);
	ЕдинаяДатаВыплатаДокумента = МассивДатВыплаты.Количество() < 2;
	Если ИспользуетсяЕдинаяДатаВыплатыДохода И ЕдинаяДатаВыплатаДокумента Тогда
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Иначе
		...
		// Страховые взносы
		УчетСтраховыхВзносов.СформироватьСведенияОДоходахСтраховыеВзносы(Движения, Отказ, Организация, МесяцНачисления, ДанныеДляПроведения.МенеджерВременныхТаблиц, , Истина, Ссылка);
