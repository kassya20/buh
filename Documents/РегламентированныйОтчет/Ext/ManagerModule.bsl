...
Функция ПолучитьБлокируемыеРеквизитыОбъекта() Экспорт
	...
	БлокируемыеРеквизиты.Добавить("ФормаНастроитьЗаполнение;ФормаНастроитьЗаполнение");
...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ИзменитьНаименованияРеестровПоАкцизамИСчетовФактур_2024");
	Методы.Вставить("ИзменитьНаименованияДекларацийПоАлкоголю4кв2019");
	Методы.Вставить("ИзменитьНаименованияДекларацийПоАлкоголю");
	Методы.Вставить("ИзменитьНаименованияРеестровПоНДС");
	Методы.Вставить("ИзменитьНаименованияДекларацийПоФармАлкоголю");
	Методы.Вставить("ИзменитьНаименованияРеестровПоНДС_2024");
	Методы.Вставить("ИзменитьНаименованияДекларацийПоФСРАР2021кв1");
	Методы.Вставить("ИзменитьНаименованиеБухгалтерскойОтчетности");
КонецПроцедуры
