...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	...
	СчетаФактурыНеТребуются = Документы.ПередачаНМА.СчетаФактурыНеТребуются(МассивДокументов);
...
Процедура ДатаОбработатьИзменение()
	...
	Если ПлательщикНДС Тогда 
		...
		Объект.СтавкаНДС = СтавкаНДСПриРеализации;
	КонецЕсли;
...
Функция ОписаниеТипаРеквизитаДокументАванса()
	...
	Возврат Метаданные.Документы.ПередачаНМА.ТабличныеЧасти.ЗачетАвансов.Реквизиты.ДокументАванса.Тип;
