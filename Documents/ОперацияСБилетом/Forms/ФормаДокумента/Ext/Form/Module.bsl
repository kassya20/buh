...
Процедура ДатаПриИзменении(Элемент)
	...
	УчетКомандировокКлиентСервер.ЗаполнитьДанныеВыбораСтавкиНДС(Элементы.СтавкаНДС.СписокВыбора, Объект.Дата, Истина);
...
Процедура УстановитьДоговор(ПричиныИзмененияСчетовУчета)
	...
	РаботаСДоговорамиКонтрагентовБП.УстановитьДоговорКонтрагента(Объект.ДоговорКонтрагента,
		Объект.Контрагент, Объект.Организация, ВидыДоговоровАгента, ОтборДоговора);
...
Функция ОписаниеТипаРеквизитаДокументАванса()
	...
	Возврат Метаданные.Документы.ОперацияСБилетом.ТабличныеЧасти.ЗачетАвансов.Реквизиты.ДокументАванса.Тип;
