...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ПлатежныеРеквизиты.Свойство("ПлательщикЕНП") И Параметры.ПлатежныеРеквизиты.ПлательщикЕНП
		И Реквизиты.Вид = Перечисления.ВидыГосударственныхОрганов.НалоговыйОрган Тогда
