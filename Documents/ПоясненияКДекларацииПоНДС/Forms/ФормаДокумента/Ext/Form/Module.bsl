...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Наступило = ДокументооборотСКОВызовСервера.СобытиеНаступилоНовыйФорматПояснДеклНДС("5.04");
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	ТекущийОбъект.СведенияСФВСчетРанееПолученнойОплаты.Очистить();
	ТекущийОбъект.СведенияСФПродавца.Очистить();
	...
	Для Каждого СтрокаКнигиПокупок Из Объект.КнигаПокупок Цикл
		...
		ЗаписатьСведенияВТаблицу(СтрокаКнигиПокупок, "СчетФактураВСчетРанееПолученнойОплаты",
		ТекущийОбъект.СведенияСФВСчетРанееПолученнойОплаты);
		ЗаписатьСведенияВТаблицу(СтрокаКнигиПокупок, "СчетФактураВСчетРанееПолученнойОплатыРасхождение",
		ТекущийОбъект.СведенияСФВСчетРанееПолученнойОплаты);
	...
	Для Каждого СтрокаКнигиПокупок Из Объект.КнигаПродаж Цикл
		...
		ЗаписатьСведенияВТаблицу(СтрокаКнигиПокупок, "СчетФактураПродавца", ТекущийОбъект.СведенияСФПродавца);
		ЗаписатьСведенияВТаблицу(СтрокаКнигиПокупок, "СчетФактураПродавцаРасхождение", ТекущийОбъект.СведенияСФПродавца);
...
Процедура КнигаПокупокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	ИначеЕсли Поле.Имя = "КнигаПокупокСчетФактураВСчетРанееПолученнойОплатыПредставление" Тогда
		СтандартнаяОбработка = Ложь;
		ОткрытьФормуСпискаСчетовФактур("КнигаПокупок", ДанныеСтроки, "СчетФактураВСчетРанееПолученнойОплаты");
	ИначеЕсли Поле.Имя = "КнигаПокупокСчетФактураВСчетРанееПолученнойОплатыРасхождениеПредставление" Тогда
		СтандартнаяОбработка = Ложь;
		ОткрытьФормуСпискаСчетовФактур("КнигаПокупок", ДанныеСтроки, "СчетФактураВСчетРанееПолученнойОплатыРасхождение");
...
Процедура КнигаПокупокПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
	...
	Если НоваяСтрока Тогда
		...
		СписокРеквизитов = "ДокументОплаты,ДокументОплатыРасхождение,ДатаПринятияНаУчет,ДатаПринятияНаУчетРасхождение,"
		+ "Продавец,ПродавецРасхождение,СчетФактураВСчетРанееПолученнойОплаты,СчетФактураВСчетРанееПолученнойОплатыРасхождение";
		
		УстановитьИдентификаторыСписков(Элемент.ТекущиеДанные, СписокРеквизитов);
...
&НаКлиенте
Процедура КнигаПокупокСписокСчетовФактурНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
	
	СтандартнаяОбработка = Ложь;  
	ДанныеСтроки = Элементы.КнигаПокупок.ТекущиеДанные;
    НазваниеРеквизита = "СчетФактураВСчетРанееПолученнойОплаты";
	
	Если СтрНайти(Элемент.Имя, "Расхождение") > 0 Тогда
		НазваниеРеквизита = НазваниеРеквизита + "Расхождение";
	КонецЕсли;	
	
	ОткрытьФормуСпискаСчетовФактур("КнигаПокупок", ДанныеСтроки, НазваниеРеквизита);
...
Процедура КнигаПокупокДлВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	ИначеЕсли Поле.Имя = "КнигаПокупокДлПосредникИНН" Тогда
		СтандартнаяОбработка = Ложь;
		КонтекстЭДОКлиент.ОткрытьКонтрагентовИзТребования(ДанныеСтроки.ПосредникИННКонтрагенты);		
	ИначеЕсли Поле.Имя = "КнигаПокупокДлСчетФактураВСчетРанееПолученнойОплатыПредставление" Тогда
		СтандартнаяОбработка = Ложь;
		ОткрытьФормуСпискаСчетовФактур("КнигаПокупокДл", ДанныеСтроки, "СчетФактураВСчетРанееПолученнойОплаты");
	ИначеЕсли Поле.Имя = "КнигаПокупокДлСчетФактураВСчетРанееПолученнойОплатыРасхождениеПредставление" Тогда
		СтандартнаяОбработка = Ложь;
		ОткрытьФормуСпискаСчетовФактур("КнигаПокупокДл", ДанныеСтроки, "СчетФактураВСчетРанееПолученнойОплатыРасхождение");
	ИначеЕсли ЭтоПолеПериода(Поле.Имя) Тогда
		ПоказатьПериодОтражения(ДанныеСтроки, СтандартнаяОбработка);
	ИначеЕсли ЭтоПолеКодаОшибки(Поле.Имя) Тогда
		ПоказатьОшибку(ДанныеСтроки, СтандартнаяОбработка);
...
&НаКлиенте
Процедура КнигаПокупокДлСписокСчетовФактурНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
	...
	ОткрытьФормуСпискаСчетовФактур("КнигаПокупокДл", ДанныеСтроки, НазваниеРеквизита);
...
Процедура КнигаПродажВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	ИначеЕсли Поле.Имя = "КнигаПродажПосредникИНН" Тогда
		СтандартнаяОбработка = Ложь;
		КонтекстЭДОКлиент.ОткрытьКонтрагентовИзТребования(ДанныеСтроки.ПосредникИННКонтрагенты);		
	ИначеЕсли Поле.Имя = "КнигаПродажСчетФактураПродавцаПредставление" Тогда
		СтандартнаяОбработка = Ложь;
		ОткрытьФормуСпискаСчетовФактур("КнигаПродаж", ДанныеСтроки, "СчетФактураПродавца");
	ИначеЕсли Поле.Имя = "КнигаПродажСчетФактураПродавцаРасхождениеПредставление" Тогда
		СтандартнаяОбработка = Ложь;
		ОткрытьФормуСпискаСчетовФактур("КнигаПродаж", ДанныеСтроки, "СчетФактураПродавцаРасхождение");
	ИначеЕсли ЭтоПолеПериода(Поле.Имя) Тогда
		ПоказатьПериодОтражения(ДанныеСтроки, СтандартнаяОбработка);
	ИначеЕсли ЭтоПолеКодаОшибки(Поле.Имя) Тогда
		ПоказатьОшибку(ДанныеСтроки, СтандартнаяОбработка);
...
Процедура КнигаПродажПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
	...
	Если НоваяСтрока Тогда
		...
		СписокРеквизитов = "ДокументОплаты,ДокументОплатыРасхождение,Покупатель,ПокупательРасхождение,"
		+ "СчетФактураПродавца,СчетФактураПродавцаРасхождение";
...
&НаКлиенте
Процедура КнигаПродажСписокСчетовФактурНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
	
	СтандартнаяОбработка = Ложь;  
	ДанныеСтроки = Элементы.КнигаПродаж.ТекущиеДанные;
    НазваниеРеквизита = "СчетФактураПродавца";
	
	Если СтрНайти(Элемент.Имя, "Расхождение") > 0 Тогда
		НазваниеРеквизита = НазваниеРеквизита + "Расхождение";
	КонецЕсли;	
	
	ОткрытьФормуСпискаСчетовФактур("КнигаПродаж", ДанныеСтроки, НазваниеРеквизита);
...
&НаКлиенте
Процедура КнигаПродажСтоимость22ПриИзменении(Элемент)
	
	СкопироватьЗначениеВРасхождение("КнигаПродаж", "Стоимость22");
...
&НаКлиенте
Процедура КнигаПродажСтоимость1820ПриИзменении(Элемент)
	
	СкопироватьЗначениеВРасхождение("КнигаПродаж", "Стоимость1820");
...
&НаКлиенте
Процедура КнигаПродажСуммаНДС22ПриИзменении(Элемент)
	
	СкопироватьЗначениеВРасхождение("КнигаПродаж", "СуммаНДС22");
...
&НаКлиенте
Процедура КнигаПродажСуммаНДС1820ПриИзменении(Элемент)
	
	СкопироватьЗначениеВРасхождение("КнигаПродаж", "СуммаНДС1820");
...
&НаКлиенте
Процедура КнигаПродажСуммаНДС22РасхождениеПриИзменении(Элемент)
...
&НаКлиенте
Процедура КнигаПродажСуммаНДС1820РасхождениеПриИзменении(Элемент)
...
Процедура КнигаПродажДлВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	ИначеЕсли Поле.Имя = "КнигаПродажДлПосредникИНН" Тогда
		СтандартнаяОбработка = Ложь;
		КонтекстЭДОКлиент.ОткрытьКонтрагентовИзТребования(ДанныеСтроки.ПосредникИННКонтрагенты);
	ИначеЕсли Поле.Имя = "КнигаПродажДлСчетФактураПродавцаПредставление" Тогда
		СтандартнаяОбработка = Ложь;
		ОткрытьФормуСпискаСчетовФактур("КнигаПродажДл", ДанныеСтроки, "СчетФактураПродавца");
	ИначеЕсли Поле.Имя = "КнигаПродажДлСчетФактураПродавцаРасхождениеПредставление" Тогда
		СтандартнаяОбработка = Ложь;
		ОткрытьФормуСпискаСчетовФактур("КнигаПродажДл", ДанныеСтроки, "СчетФактураПродавцаРасхождение");
	ИначеЕсли ЭтоПолеПериода(Поле.Имя) Тогда
		ПоказатьПериодОтражения(ДанныеСтроки, СтандартнаяОбработка);
	ИначеЕсли ЭтоПолеКодаОшибки(Поле.Имя) Тогда
		ПоказатьОшибку(ДанныеСтроки, СтандартнаяОбработка);
...
&НаКлиенте
Процедура КнигаПродажДлСписокСчетовФактурНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
	...
	ОткрытьФормуСпискаСчетовФактур("КнигаПродажДл", ДанныеСтроки, НазваниеРеквизита);
...
&НаКлиенте
Процедура КнигаПродажДлСтоимость22ПриИзменении(Элемент)
	
	СкопироватьЗначениеВРасхождение("КнигаПродажДл", "Стоимость22");
...
&НаКлиенте
Процедура КнигаПродажДлСтоимость1820ПриИзменении(Элемент)
	
	СкопироватьЗначениеВРасхождение("КнигаПродажДл", "Стоимость1820");
...
&НаКлиенте
Процедура КнигаПродажДлСуммаНДС22ПриИзменении(Элемент)
	
	СкопироватьЗначениеВРасхождение("КнигаПродажДл", "СуммаНДС22");
...
&НаКлиенте
Процедура КнигаПродажДлСуммаНДС1820ПриИзменении(Элемент)
	
	СкопироватьЗначениеВРасхождение("КнигаПродажДл", "СуммаНДС1820");
...
&НаКлиенте
Процедура КнигаПродажДлСуммаНДС22РасхождениеПриИзменении(Элемент)
...
&НаКлиенте
Процедура КнигаПродажДлСуммаНДС1820РасхождениеПриИзменении(Элемент)
...
Процедура УстановитьВидимостьКолонокТаблиц()
	...
	Если Не Наступило Тогда
		
		Элементы.КнигаПокупокГруппаРеквизитыСчетаФактурыВСчетРанееПолученнойОплаты.Видимость = Ложь;
		Элементы.КнигаПокупокДлГруппаРеквизитыСчетаФактурыВСчетРанееПолученнойОплаты.Видимость = Ложь;
		Элементы.КнигаПродажГруппаРеквизитыСчетаФактурыПродавца.Видимость = Ложь;
		Элементы.КнигаПродажДлГруппаРеквизитыСчетаФактурыПродавца.Видимость = Ложь;
		Элементы.КнигаПродажГруппаРеквизитыСчетаФактурыПродавца.Видимость = Ложь;
		Элементы.КнигаПродажГруппаСтоимость22.Видимость = Ложь;
		Элементы.КнигаПродажГруппаСуммаНДС22.Видимость = Ложь;
		Элементы.КнигаПродажГруппаСтоимость1820.Видимость = Ложь;
		Элементы.КнигаПродажГруппаСуммаНДС1820.Видимость = Ложь;
		Элементы.КнигаПродажДлГруппаРеквизитыСчетаФактурыПродавца.Видимость = Ложь;
		Элементы.КнигаПродажДлГруппаСтоимость22.Видимость = Ложь;
		Элементы.КнигаПродажДлГруппаНДС22.Видимость = Ложь;
		Элементы.КнигаПродажДлГруппаСтоимость1820.Видимость = Ложь;
		Элементы.КнигаПродажДлГруппаНДС1820.Видимость = Ложь;
...
Процедура УстановитьУсловноеОформлениеКнигаПокупок()
	...
	#Область ВидимостьСтрокиРасхождений
		...
		ДобавитьОформляемоеПоле(ЭлементУО.Поля, "КнигаПокупокСчетФактураВСчетРанееПолученнойОплатыРасхождениеПредставление");
...
Процедура УстановитьУсловноеОформлениеКнигаПокупокДл()
	...
	#Область ВидимостьСтрокиРасхождений
		...
		ДобавитьОформляемоеПоле(ЭлементУО.Поля, "КнигаПокупокДлСчетФактураВСчетРанееПолученнойОплатыРасхождениеПредставление");
...
Процедура УстановитьУсловноеОформлениеКнигаПродаж()
	...
	#Область ВидимостьСтрокиРасхождений
		...
		ДобавитьОформляемоеПоле(ЭлементУО.Поля, "КнигаПродажСтоимость22Расхождение");
		ДобавитьОформляемоеПоле(ЭлементУО.Поля, "КнигаПродажСуммаНДС22Расхождение");
		...
		ДобавитьОформляемоеПоле(ЭлементУО.Поля, "КнигаПродажСтоимость1820Расхождение");
		ДобавитьОформляемоеПоле(ЭлементУО.Поля, "КнигаПродажСуммаНДС1820Расхождение");
		...
		ДобавитьОформляемоеПоле(ЭлементУО.Поля, "КнигаПродажСчетФактураПродавцаРасхождениеПредставление");
...
Процедура УстановитьУсловноеОформлениеКнигаПродажДл()
	...
	#Область ВидимостьСтрокиРасхождений
		...
		ДобавитьОформляемоеПоле(ЭлементУО.Поля, "КнигаПродажДлСтоимость22Расхождение");
		ДобавитьОформляемоеПоле(ЭлементУО.Поля, "КнигаПродажДлСуммаНДС22Расхождение");
		...
		ДобавитьОформляемоеПоле(ЭлементУО.Поля, "КнигаПродажДлСтоимость1820Расхождение");
		ДобавитьОформляемоеПоле(ЭлементУО.Поля, "КнигаПродажДлСуммаНДС1820Расхождение");
		...
		ДобавитьОформляемоеПоле(ЭлементУО.Поля, "КнигаПродажДлСчетФактураПродавцаРасхождениеПредставление");
...
Процедура УправлениеФормой(Форма)
	...
	Элементы.НалоговыйОрган.ТолькоПросмотр = Форма.ПояснениеОтправлено;
...
Процедура УстановитьСвойстваКолонокТабличныхЧастей()
	...
	Элементы.КнигаПокупокСчетФактураВСчетРанееПолученнойОплатыПредставление.ТолькоПросмотр = Не ДоступноРедактированиеДанныхФНС;
	...
	Элементы.КнигаПокупокДлСчетФактураВСчетРанееПолученнойОплатыПредставление.ТолькоПросмотр = Не ДоступноРедактированиеДанныхФНС;	
	...
	Элементы.КнигаПродажСтоимость22.ТолькоПросмотр = НЕ ДоступноРедактированиеДанныхФНС;
	Элементы.КнигаПродажСуммаНДС22.ТолькоПросмотр = НЕ ДоступноРедактированиеДанныхФНС;
	...
	Элементы.КнигаПродажСтоимость1820.ТолькоПросмотр = НЕ ДоступноРедактированиеДанныхФНС;
	Элементы.КнигаПродажСуммаНДС1820.ТолькоПросмотр = НЕ ДоступноРедактированиеДанныхФНС;
	...
	Элементы.КнигаПродажСчетФактураПродавцаПредставление.ТолькоПросмотр = Не ДоступноРедактированиеДанныхФНС;
	...
	Элементы.КнигаПродажДлСтоимость22.ТолькоПросмотр = НЕ ДоступноРедактированиеДанныхФНС;
	Элементы.КнигаПродажДлСуммаНДС22.ТолькоПросмотр = НЕ ДоступноРедактированиеДанныхФНС;
	...
	Элементы.КнигаПродажДлСтоимость1820.ТолькоПросмотр = НЕ ДоступноРедактированиеДанныхФНС;
	Элементы.КнигаПродажДлСуммаНДС1820.ТолькоПросмотр = НЕ ДоступноРедактированиеДанныхФНС;
	...
	Элементы.КнигаПродажДлСчетФактураПродавцаПредставление.ТолькоПросмотр = Не ДоступноРедактированиеДанныхФНС;
...
Процедура ЗаполнитьДобавленныеКолонкиТаблиц()
	...
	СведенияОСФВСчетРанееПолученнойОплаты = Объект.СведенияСФВСчетРанееПолученнойОплаты.Выгрузить();
	СведенияОСФВСчетРанееПолученнойОплаты.Индексы.Добавить("ИдентификаторЗначения");
	
	СведенияОСФПродавца = Объект.СведенияСФПродавца.Выгрузить();
	СведенияОСФПродавца.Индексы.Добавить("ИдентификаторЗначения");
	
	Для каждого СтрокаТаблицы Из Объект.КнигаПокупок Цикл
		ЗаполнитьДанныеРеквизитовСоСпискамиРаздела8(СтрокаТаблицы, СведенияОКонтрагентах,
		СведенияОДокументахОплаты, СведенияОДатахПринятияНаУчет, ТаблицаКонтрагентов, СведенияОСФВСчетРанееПолученнойОплаты);
	...
	Для каждого СтрокаТаблицы Из Объект.КнигаПродаж Цикл
		ЗаполнитьДанныеРеквизитовСоСпискамиРаздела9(СтрокаТаблицы, СведенияОКонтрагентах,
		СведенияОДокументахОплаты, СведенияОДатахПринятияНаУчет, ТаблицаКонтрагентов, СведенияОСФПродавца);
...
&НаСервере
Процедура ЗаполнитьДанныеРеквизитовСоСпискамиРаздела8(СтрокаТаблицы, СведенияОКонтрагентах,
	СведенияОДокументахОплаты, СведенияОДатахПринятияНаУчет, ТаблицаКонтрагентов, СведенияОСФВСчетРанееПолученнойОплаты)
	...
	ЗаполнитьСписокЗначенийРеквизита(СтрокаТаблицы, "СчетФактураВСчетРанееПолученнойОплаты",
	РеквизитыСчетовФактур, СведенияОСФВСчетРанееПолученнойОплаты);
	ЗаполнитьСписокЗначенийРеквизита(СтрокаТаблицы, "СчетФактураВСчетРанееПолученнойОплатыРасхождение",
	РеквизитыСчетовФактур, СведенияОСФВСчетРанееПолученнойОплаты);
	
КонецПроцедуры

&НаСервере
Процедура ЗаполнитьДанныеРеквизитовСоСпискамиРаздела9(СтрокаТаблицы, СведенияОКонтрагентах,
	...
	ЗаполнитьСписокЗначенийРеквизита(СтрокаТаблицы, "СчетФактураПродавца", РеквизитыСчетовФактур, СведенияОСФПродавца);
	ЗаполнитьСписокЗначенийРеквизита(СтрокаТаблицы, "СчетФактураПродавцаРасхождение", РеквизитыСчетовФактур, СведенияОСФПродавца);	
...
Процедура ЗаполнитьДобавленныеКолонкиСтрокиРаздела8(СтрокаТаблицы)
	...
	УстановитьПредставлениеСпискаСчетовФактур(СтрокаТаблицы, "СчетФактураВСчетРанееПолученнойОплаты");
	УстановитьПредставлениеСпискаСчетовФактур(СтрокаТаблицы, "СчетФактураВСчетРанееПолученнойОплатыРасхождение");
...
Процедура ЗаполнитьДобавленныеКолонкиСтрокиРаздела9(СтрокаТаблицы)
	...
	УстановитьПредставлениеСпискаСчетовФактур(СтрокаТаблицы, "СчетФактураПродавца");
	УстановитьПредставлениеСпискаСчетовФактур(СтрокаТаблицы, "СчетФактураПродавцаРасхождение");
...
Процедура РезультатПроверкиПриИзмененииНаСервере(ИмяТабличнойЧасти, ВыбраннаяСтрока)
	...
	Если ДанныеСтроки.РезультатПроверки = Перечисления.РезультатПроверкиСтрокиДекларации.СведенияВерны Тогда
		Если ИмяТабличнойЧасти = "КнигаПокупок"
			...
			ДанныеСтроки.СчетФактураВСчетРанееПолученнойОплатыРасхождениеДанные = ДанныеСтроки.СчетФактураВСчетРанееПолученнойОплатыДанные.Скопировать();
		...
		ИначеЕсли ИмяТабличнойЧасти = "КнигаПродаж"
			...
			ДанныеСтроки.ДокументОплатыРасхождениеДанные = ДанныеСтроки.ДокументОплатыДанные.Скопировать();
			ДанныеСтроки.ПосредникИННРасхождениеКонтрагенты = ДанныеСтроки.ПосредникИННКонтрагенты.Скопировать();
			ДанныеСтроки.СчетФактураПродавцаРасхождениеДанные = ДанныеСтроки.СчетФактураПродавцаДанные.Скопировать();
...
&НаКлиентеНаСервереБезКонтекста
Процедура УстановитьПредставлениеСпискаСчетовФактур(СтрокаТаблицы, ИмяРеквизита)
	
	СписокСчетовФактур = СтрокаТаблицы[ИмяРеквизита + "Данные"];
	СтрокаТаблицы[ИмяРеквизита + "Представление"] = ПредставлениеПоСпискуСтрок(СписокСчетовФактур);
...
Процедура ЗаполнитьСписокЗначенийРеквизита(СтрокаТаблицы, ИмяРеквизита, СписокПолей, ТаблицаСпискаПолей);
	...
	Для Каждого ЗначенияПоля ИЗ МассивЗначенийПолей Цикл
		...
		ИначеЕсли ИмяРеквизита = "СчетФактураВСчетРанееПолученнойОплаты"
			ИЛИ ИмяРеквизита = "СчетФактураВСчетРанееПолученнойОплатыРасхождение"
			ИЛИ ИмяРеквизита = "СчетФактураПродавца"
			ИЛИ ИмяРеквизита = "СчетФактураПродавцаРасхождение" Тогда	
			Представление = Документы.ПоясненияКДекларацииПоНДС.ПредставлениеСчетовФактур(СтруктураДанных);
...
&НаКлиенте
Процедура ОткрытьФормуСпискаСчетовФактур(ИмяТабличнойЧасти, ДанныеСтроки, ИмяРеквизита)
	
	Если ДанныеСтроки = Неопределено Тогда
		Возврат;
	КонецЕсли;
	
	СписокСчетовФактур = ДанныеСтроки[ИмяРеквизита + "Данные"];
	
	ЭтоРасхождение = Найти(ИмяРеквизита, "Расхождение") = 0;
	ОткрытьФормуДляПросмотра = ТолькоПросмотр Или (Не ДоступноРедактированиеДанныхФНС И ЭтоРасхождение);
	
	Если Не ОткрытьФормуДляПросмотра И ДанныеСтроки[ИмяРеквизита] = "" Тогда
		ДанныеСтроки[ИмяРеквизита] = Новый УникальныйИдентификатор;
	КонецЕсли;
	
	ПараметрыФормы = Новый Структура();
	ПараметрыФормы.Вставить("СчетаФактуры", СписокСчетовФактур);
	ПараметрыФормы.Вставить("ТолькоПросмотр", ОткрытьФормуДляПросмотра);
	
	ДополнительныеПараметры = Новый Структура("ИмяТабличнойЧасти, ИдентификаторСтроки, ИмяРеквизита", 
					ИмяТабличнойЧасти, ДанныеСтроки.ПолучитьИдентификатор(), ИмяРеквизита);
	
	ОповещениеФормы = Новый ОписаниеОповещения("ОбработчикЗакрытияФормыСпискаСчетовФактурЗавершение", ЭтотОбъект, ДополнительныеПараметры);
	
	ОткрытьФорму("Документ.ПоясненияКДекларацииПоНДС.Форма.ФормаСписокСчетовФактур", ПараметрыФормы, ЭтаФорма,,,,ОповещениеФормы);
	
КонецПроцедуры

&НаКлиенте
Процедура ОбработчикЗакрытияФормыСпискаСчетовФактурЗавершение(РезультатЗакрытия, ДополнительныеПараметры) Экспорт
	...
	УстановитьПредставлениеСпискаСчетовФактур(ДанныеСтроки, ДополнительныеПараметры.ИмяРеквизита);
	
	СкопироватьСведенияОСпискеСчетовФактурВРасхождение(ДанныеСтроки, ДополнительныеПараметры.ИмяРеквизита);
...
&НаКлиентеНаСервереБезКонтекста
Процедура СкопироватьСведенияОСпискеСчетовФактурВРасхождение(ДанныеСтроки, ИмяРеквизита)
	...
	Если СтрНайти(ИмяРеквизита, "Расхождение") = 0 Тогда
		...
		Если ДанныеСтроки[ИмяРеквизитаРасхождение+"Данные"].Количество() = 0
			...
			ДанныеСтроки[ИмяРеквизитаРасхождение+"Данные"] = ДанныеСтроки[ИмяРеквизита + "Данные"].Скопировать();
			ДанныеСтроки[ИмяРеквизитаРасхождение+"Представление"] = ДанныеСтроки[ИмяРеквизита + "Представление"];
...
Функция НеобходимаУточненнаяДекларация(Объект)
	Возврат Объект.КнигаПокупок.Итог("СуммаНДСРасхождение") <> Объект.КнигаПокупок.Итог("СуммаНДС")
		...
		ИЛИ Объект.КнигаПродаж.Итог("СуммаНДС22Расхождение") <> Объект.КнигаПродаж.Итог("СуммаНДС22")
		ИЛИ Объект.КнигаПродаж.Итог("СуммаНДС20Расхождение") <> Объект.КнигаПродаж.Итог("СуммаНДС20")
		ИЛИ Объект.КнигаПродаж.Итог("СуммаНДС1820Расхождение") <> Объект.КнигаПродаж.Итог("СуммаНДС1820")
		...
		ИЛИ Объект.КнигаПродажДл.Итог("СуммаНДС22Расхождение") <> Объект.КнигаПродажДл.Итог("СуммаНДС22")
		ИЛИ Объект.КнигаПродажДл.Итог("СуммаНДС20Расхождение") <> Объект.КнигаПродажДл.Итог("СуммаНДС20")		
		ИЛИ Объект.КнигаПродажДл.Итог("СуммаНДС1820Расхождение") <> Объект.КнигаПродажДл.Итог("СуммаНДС1820")
...
Функция ПоляПроверкиРасхожденийКнигиПокупок()
	...
	ПоляПроверки = Новый Структура();
	ПоляПроверки.Вставить("Поле",            "СчетФактураВСчетРанееПолученнойОплатыПредставление");
	ПоляПроверки.Вставить("ПолеРасхождение", "СчетФактураВСчетРанееПолученнойОплатыРасхождениеПредставление");
	ПоляПроверки.Вставить("Элементы",        "СчетФактураВСчетРанееПолученнойОплатыРасхождениеПредставление");
...
Функция ПоляПроверкиРасхожденийКнигиПродаж()
	...
	ПоляПроверки = Новый Структура();
	ПоляПроверки.Вставить("Поле",            "Стоимость22");
	ПоляПроверки.Вставить("ПолеРасхождение", "Стоимость22Расхождение");
	ПоляПроверки.Вставить("Элементы",        "Стоимость22Расхождение");	
	...
	ПоляПроверки = Новый Структура();
	ПоляПроверки.Вставить("Поле",            "Стоимость1820");
	ПоляПроверки.Вставить("ПолеРасхождение", "Стоимость1820Расхождение");
	ПоляПроверки.Вставить("Элементы",        "Стоимость1820Расхождение");	
	...
	ПоляПроверки = Новый Структура();
	ПоляПроверки.Вставить("Поле",            "СуммаНДС22");
	ПоляПроверки.Вставить("ПолеРасхождение", "СуммаНДС22Расхождение");
	ПоляПроверки.Вставить("Элементы",        "СуммаНДС22Расхождение");
	ПоляПроверки.Вставить("Важно",           Истина);
	...
	ПоляПроверки = Новый Структура();
	ПоляПроверки.Вставить("Поле",            "СуммаНДС1820");
	ПоляПроверки.Вставить("ПолеРасхождение", "СуммаНДС1820Расхождение");
	ПоляПроверки.Вставить("Элементы",        "СуммаНДС1820Расхождение");
	ПоляПроверки.Вставить("Важно",           Истина);
	...
	ПоляПроверки = Новый Структура();
	ПоляПроверки.Вставить("Поле",            "СчетФактураПродавцаПредставление");
	ПоляПроверки.Вставить("ПолеРасхождение", "СчетФактураПродавцаРасхождениеПредставление");
	ПоляПроверки.Вставить("Элементы",        "СчетФактураПродавцаРасхождениеПредставление");
...
Процедура Подключаемый_ОбработкаНавигационнойСсылкиВВажномСообщении(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	ИначеЕсли НРег(НавигационнаяСсылкаФорматированнойСтроки) = "отправка" Тогда
		Декорация1ОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка);
