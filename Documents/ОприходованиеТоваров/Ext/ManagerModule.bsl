...
Функция ПодготовитьПараметрыПроведения(ДокументСсылка, Отказ) Экспорт
	...
	|	Реквизиты.ОтражатьВПрослеживаемости КАК ОтражатьВПрослеживаемости
	|ИЗ
	...
	ВедетсяУчетПрослеживаемыхТоваров  = ПолучитьФункциональнуюОпцию("ВестиУчетПрослеживаемыхТоваров")
		И ПрослеживаемостьБРУ.ВедетсяУчетПрослеживаемыхТоваров(Выборка.Период) И Выборка.ОтражатьВПрослеживаемости;
		
	ПлательщикНДС = УчетнаяПолитика.ПлательщикНДС(Выборка.Организация, Выборка.Период)
		Или УчетнаяПолитика.ПлательщикНДСПрименяющийУСН(Выборка.Организация, Выборка.Период);
...
Функция ТекстЗапросаОприходованиеТоваров(НомераТаблиц)
	...
	|	Реквизиты.СтатьяПрочихДоходовРасходов КАК СубконтоДоходов1,
	|	НЕОПРЕДЕЛЕНО КАК СубконтоДоходов2,
	|	НЕОПРЕДЕЛЕНО КАК СубконтоДоходов3
	|ИЗ
...
Функция ТекстЗапросаПрослеживаемыеТовары(НомераТаблиц, ПараметрыПроведения, ВедетсяУчетПрослеживаемыхТоваров)
	...
	ТекстЗапроса = 
		...
		|	ОприходованиеТоваровСведенияПрослеживаемости.Номенклатура КАК Комплектующие,
		|	ОприходованиеТоваровСведенияПрослеживаемости.Сумма КАК СуммаБезНДС,
		|	ОприходованиеТоваровТовары.ПрослеживаемыйКомплект КАК ПрослеживаемыйКомплект
		...
		|		ПО ОприходованиеТоваровТовары.Ссылка = ДанныеПервичныхДокументов.Документ
		|			И ОприходованиеТоваровТовары.Ссылка.Организация = ДанныеПервичныхДокументов.Организация
		|ГДЕ
		...
		|	ОприходованиеТоваровСведенияПрослеживаемости.Номенклатура,
		|	ОприходованиеТоваровСведенияПрослеживаемости.Сумма,
		|	ОприходованиеТоваровТовары.ПрослеживаемыйКомплект
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
