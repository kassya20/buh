...
Функция ФиксируемыеРеквизиты(Документ = Неопределено)
	...
	ДобавитьФиксируемыйРеквизит(ФиксируемыеРеквизиты, Группа, "ИсключаемыеПериодыПримечание", Ложь);
	ДобавитьФиксируемыйРеквизит(ФиксируемыеРеквизиты, Группа, "ИсключаемыеПериодыВыгружатьПримечание", Ложь);
...
Процедура ВыгрузитьДанныеДляРасчета(Документ, МенеджерXML, УзелДанных, ВидПособия, Особенности, Примечание)
	...
	Если ВидПособия.ЭтоОбычныйБольничный Или ВидПособия.ЭтоНСПЗ Тогда
		...
		ВыгрузитьИсключаемыеПериоды(Документ, МенеджерXML, УзелРасчет, Примечание);
	КонецЕсли;
...
Процедура ВыгрузитьИсключаемыеПериоды(Документ, МенеджерXML, УзелДанных, Примечание)
	...
	КонецЦикла;
	Если Документ.ИсключаемыеПериодыВыгружатьПримечание И Не ПустаяСтрока(Документ.ИсключаемыеПериодыПримечание) Тогда
		Примечание = СокрП(Примечание + Символы.ПС + Документ.ИсключаемыеПериодыПримечание);
	КонецЕсли;
КонецПроцедуры
