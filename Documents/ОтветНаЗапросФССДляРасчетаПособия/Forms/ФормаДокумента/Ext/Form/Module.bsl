...
&НаКлиенте
Процедура ИсключаемыеПериодыПримечаниеНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
	ОбщегоНазначенияКлиент.ПоказатьФормуРедактированияКомментария(Элемент.ТекстРедактирования, ЭтотОбъект,
		"Объект.ИсключаемыеПериодыПримечание", НСтр("ru = 'Примечание по исключаемым периодам'"));
КонецПроцедуры
