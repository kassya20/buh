...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	// корректировка поступения на несколько складов
	...
	Если СкладВСписке Тогда
		Для Каждого Строка Из Товары Цикл
			Если УчетТоваров.РозницаВПродажныхЦенах(СпособОценкиТоваровВРознице, Строка.Склад, ЭтоКомиссия, ДанныеОТипеСклада) Тогда
		...
		КонецЦикла;
	Иначе
		РозницаВПродажныхЦенах = УчетТоваров.РозницаВПродажныхЦенах(СпособОценкиТоваровВРознице, Склад, ЭтоКомиссия, ДанныеОТипеСклада);
