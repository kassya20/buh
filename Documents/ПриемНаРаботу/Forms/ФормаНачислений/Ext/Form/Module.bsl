...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьЗначенияСвойств(ЭтотОбъект, ПередаваемыеСведения, "УникальныйИдентификаторВладельца, Организация, Дата");
	...
	УчетЗарплаты.ФормаДокументаУстановитьПараметрыВыбораНачислений(ЭтотОбъект, Организация, Дата);
