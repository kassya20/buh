...
Функция ЗаполнитьСМРхозспособом(ПараметрыДокумента)
	...
	СтавкаНДСПоУмолчанию = УчетНДСКлиентСервер.СтавкаНДСПриРеализации(ПараметрыДокумента.Дата, ПараметрыДокумента.Организация);
...
Функция ПодготовитьПараметрыПроведения(ДокументСсылка, Отказ) Экспорт
	...
	Реквизиты.ПлательщикНДС = УчетнаяПолитика.ПлательщикНДС(Реквизиты.Организация, Реквизиты.Период)
...
Функция ТекстЗапросаРеквизитыДокумента(НомераТаблиц)
	...
	|	Неопределено КАК ПлательщикНДС
	|ИЗ
	|	Документ.НачислениеНДСпоСМРхозспособом КАК Реквизиты
	|ГДЕ
