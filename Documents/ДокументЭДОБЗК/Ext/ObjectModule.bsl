...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	Если ПолучитьФункциональнуюОпцию("ИспользуетсяЭДОБЗККабинетСотрудника") Тогда
		...
		Запрос.Текст =
			...
			|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ВыгруженныеОбъектыУправлениеПерсоналом КАК ВыгруженныеОбъектыУправлениеПерсоналом
			|		ПО ФизическиеЛица.Ссылка = ВыгруженныеОбъектыУправлениеПерсоналом.Ссылка
			|ГДЕ
			|	ФизическиеЛица.Ссылка В(&ВнешниеПодписанты)
			|	И ВыгружаемыеОбъектыКабинетСотрудника.Ссылка ЕСТЬ NULL
			|	И ВыгруженныеОбъектыУправлениеПерсоналом.Ссылка ЕСТЬ NULL
			|
			|УПОРЯДОЧИТЬ ПО
