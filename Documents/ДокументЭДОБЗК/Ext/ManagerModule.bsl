...
Процедура ДобавитьКомандыОтчетов(КомандыОтчетов, Параметры) Экспорт
	...
	Отчеты.КонтрольОзнакомленияСРасчетнымиЛистками.ДобавитьКомандыФормированияОтчетов(КомандыОтчетов, Параметры);
...
Функция СвойстваДокумента(ЭлектронныйДокумент, Организация, ФизическоеЛицо,
	...
	ВидДокумента = Неопределено, ФорматДокументаСоответствуетТребованиям = Истина) Экспорт
...
Процедура ЗаполнитьВариантПодписанияДокументов(ПараметрыОбновления = Неопределено) Экспорт
	...
	Запрос.Текст =
		...
		|	ДокументЭДОБЗК.Ссылка КАК Ссылка,
		|	ВЫБОР
		|		КОГДА ЕСТЬNULL(НастройкиПечатныхФормБЗК.УдалитьВариантПодписания, ЗНАЧЕНИЕ(Перечисление.ВариантыПодписанияДокументовЭДОБЗК.ПустаяСсылка)) = ЗНАЧЕНИЕ(Перечисление.ВариантыПодписанияДокументовЭДОБЗК.ПустаяСсылка)
		|			ТОГДА ЗНАЧЕНИЕ(Перечисление.ВариантыПодписанияДокументовЭДОБЗК.Требуется)
		|		ИНАЧЕ НастройкиПечатныхФормБЗК.УдалитьВариантПодписания
