...
Процедура ПодготовитьФормуНаСервере()
	...
	ФормыДокумента = Новый ФиксированноеСоответствие(
		Документы.ОтчетПроизводстваЗаСмену.ПолучитьСоответствиеВидовОперацийФормам());
...
Функция ПолучитьСписокВидовОпераций()
	...
	ВсеВидыОпераций = Перечисления.ВидыОперацийОтчетПроизводстваЗаСмену;
	
	СписокВидовОпераций.Добавить(ВсеВидыОпераций.ВыпускПродукции, НСтр("ru = 'Выпуск продукции'"));
	Если ПолучитьФункциональнуюОпцию("ВедетсяПроизводственнаяДеятельность") Тогда
		СписокВидовОпераций.Добавить(ВсеВидыОпераций.ОтчетПроизводстваЗаСмену, НСтр("ru = 'Отчет производства за смену'"));
	КонецЕсли;
...
Процедура ОткрытьДокументВида(ВыбранныйВидОперации)
	...
	ОткрытьФорму("Документ.ОтчетПроизводстваЗаСмену.Форма." + ФормыДокумента[ВыбранныйВидОперации], СтруктураПараметров, ВладелецФормы);
