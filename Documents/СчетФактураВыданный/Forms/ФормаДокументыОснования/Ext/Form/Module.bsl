...
Функция ПолучитьТаблицуИтоговПоОснованиям(СписокОснований, ЭтоСводнаяСправка, ЭтоКорректировочнаяСправка)
	...
	|	ОтчетКомиссионераОПродажах.Ссылка,
	|	ВЫБОР
	|		КОГДА ОтчетКомиссионераОПродажах.ВалютаДокумента = &ВалютаРегламентированногоУчета
	|			ТОГДА СУММА(ОтчетКомиссионераОПродажахТовары.Сумма)
	|		ИНАЧЕ СУММА(ОтчетКомиссионераОПродажахТовары.Сумма * ОтчетКомиссионераОПродажах.КурсВзаиморасчетов / ОтчетКомиссионераОПродажах.КратностьВзаиморасчетов)
	|	КОНЕЦ,
	|	ОтчетКомиссионераОПродажах.Контрагент
	|ИЗ
	...
	|				ТОГДА ОтчетКомиссионераОПродажахТоварыВозвращенные.Ссылка В
	|						(ВЫБРАТЬ
	|							ОснованияИсправляемогоСчетаФактуры.ДокументОснование
	|						ИЗ
	|							ОснованияИсправляемогоСчетаФактуры)
	|			ИНАЧЕ ОтчетКомиссионераОПродажахТоварыВозвращенные.ДокументРеализации В
	|					(ВЫБРАТЬ
	|						ОснованияИсправляемогоСчетаФактуры.ДокументОснование
	|					ИЗ
	|						ОснованияИсправляемогоСчетаФактуры)
