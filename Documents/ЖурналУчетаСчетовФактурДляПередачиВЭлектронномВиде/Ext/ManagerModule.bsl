...
Функция ПечатьЖурналаУчетаСчетовФактур(МассивОбъектов, ОбъектыПечати)
	...
	|	ЖурналУчетаСчетовФактурДляПередачиВЭлектронномВиде.НалоговыйПериод КАК НалоговыйПериод,
	|	ЖурналУчетаСчетовФактурДляПередачиВЭлектронномВиде.ВыставленныеСчетаФактуры.(
	|		Ссылка КАК Ссылка,
	|		НомерСтроки КАК НомерСтроки,
	|		ДатаПередачиПолучения КАК ДатаПередачиПолучения,
	|		КодСпособаВыставления КАК КодСпособаВыставления,
	|		КодВидаОперации КАК КодВидаОперации,
	|		НомерСчетаФактуры КАК НомерСчетаФактуры,
	|		ДатаСчетаФактуры КАК ДатаСчетаФактуры,
	|		НомерКорректировочногоСчетаФактуры КАК НомерКорректировочногоСчетаФактуры,
	|		ДатаКорректировочногоСчетаФактуры КАК ДатаКорректировочногоСчетаФактуры,
	...
	|		КонтрагентИННКПП КАК КонтрагентИННКПП,
	|		Валюта КАК Валюта,
	|		СуммаДокумента КАК СуммаДокумента,
	|		СуммаНДС КАК СуммаНДС,
	|		СуммаДокументаРазницаУменьшение КАК СуммаДокументаРазницаУменьшение,
	|		СуммаДокументаРазницаУвеличение КАК СуммаДокументаРазницаУвеличение,
	|		СуммаНДСРазницаУменьшение КАК СуммаНДСРазницаУменьшение,
	|		СуммаНДСРазницаУвеличение КАК СуммаНДСРазницаУвеличение,
	|		Ном КАК Ном,
	|		СчетФактура КАК СчетФактура
	|	) КАК ВыставленныеСчетаФактуры,
	...
	|		Ном КАК Ном,
	|		СчетФактура КАК СчетФактура
	|	) КАК ПолученныеСчетаФактуры,
	|	ЖурналУчетаСчетовФактурДляПередачиВЭлектронномВиде.Организация.ИНН КАК ОрганизацияИНН,
	|	ВЫБОР
	|		КОГДА &РасширенныйФункционал
	|				И ЖурналУчетаСчетовФактурДляПередачиВЭлектронномВиде.Организация.КрупнейшийНалогоплательщик
	|			ТОГДА ЖурналУчетаСчетовФактурДляПередачиВЭлектронномВиде.Организация.КрупнейшийНалогоплательщикКПП
	|		ИНАЧЕ ЖурналУчетаСчетовФактурДляПередачиВЭлектронномВиде.Организация.КПП
	|	КОНЕЦ КАК ОрганизацияКПП,
	|	ЖурналУчетаСчетовФактурДляПередачиВЭлектронномВиде.ПредставлениеОтчета КАК ПредставлениеОтчета
	|ИЗ
	|	Документ.ЖурналУчетаСчетовФактурДляПередачиВЭлектронномВиде КАК ЖурналУчетаСчетовФактурДляПередачиВЭлектронномВиде
	|ГДЕ
	...
	Пока ВыборкаПоОбъектам.Следующий() Цикл
		...
		СтруктураПараметров = Новый Структура("Организация, ДатаЗначения, СведенияОбОрганизации",
			ВыборкаПоОбъектам.Организация, НалоговыйПериод, СведенияОбОрганизации);
		...
		СведенияОбОрганизации.Вставить("Свидетельство",
			БухгалтерскийУчетПереопределяемый.СвидетельствоОРегистрации(СведенияОЮрФизЛице, НалоговыйПериод));
		...
		Подвал.Параметры.Свидетельство = БухгалтерскийУчетПереопределяемый.СвидетельствоОРегистрации(
