...
Функция ДанныеДляВосстановленияНДСПоОстаткам(Параметры) Экспорт
	...
	СчетаУчетаНМА.Добавить(ПланыСчетов.Хозрасчетный.АмортизацияНематериальныхАктивов_);
	...
	Запрос.УстановитьПараметр("СокращеннаяАналитика", УчетНДСРаздельный.СокращеннаяАналитика(Параметры.Дата));
...
Функция ТекстЗапросаТоварыИМатериалыУчетНДСПоСпособамУчета()
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	РСАналитикаУчетаНДС.ВидЦенности КАК ВидЦенности,
	|	РСАналитикаУчетаНДС.СчетФактура КАК СчетФактура,
	|	РСАналитикаУчетаНДС.СтавкаНДС КАК СтавкаНДС,
	|	РСАналитикаУчетаНДС.СчетУчетаНДС КАК СчетУчетаНДС,
	...
	|	РСАналитикаУчетаНДС.Поставщик КАК Поставщик
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ВТ_ОстаткиРаздельныйУчетНДС.ВидЦенности КАК ВидЦенности,
	|	ЛОЖЬ КАК НетДанныхОСчетеФактуре,
	|	ВЫБОР
	|		КОГДА НЕ &СокращеннаяАналитика
	|			ТОГДА ВТ_ОстаткиРаздельныйУчетНДС.Поставщик
	|		ИНАЧЕ ВЫБОР
	...
	|			КОНЕЦ
	|	КОНЕЦ КАК Поставщик,
	|	ВТ_ОстаткиРаздельныйУчетНДС.СчетФактура КАК СчетФактура,
	|	ЕСТЬNULL(ДанныеПервичныхДокументов.ДатаРегистратора, ДАТАВРЕМЯ(1, 1, 1)) КАК ДатаСчетаФактуры,
	|	ВТ_ОстаткиРаздельныйУчетНДС.СтавкаНДС КАК СтавкаНДС,
	|	ВТ_ОстаткиРаздельныйУчетНДС.СчетУчетаНДС КАК СчетУчетаНДС,
	|	ВТ_ОстаткиРаздельныйУчетНДС.СпособУчетаНДС КАК СпособУчетаНДС,
	|	ВТ_ОстаткиРаздельныйУчетНДС.СуммаБезНДС КАК СуммаБезНДС,
	|	ВТ_ОстаткиРаздельныйУчетНДС.СуммаНДС КАК СуммаНДС
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ВТ_ДанныеРаздельногоУчета.ВидЦенности КАК ВидЦенности,
	|	ВТ_ДанныеРаздельногоУчета.НетДанныхОСчетеФактуре КАК НетДанныхОСчетеФактуре,
	|	ВТ_ДанныеРаздельногоУчета.Поставщик КАК Поставщик,
	|	ВТ_ДанныеРаздельногоУчета.СчетФактура КАК СчетФактура,
	|	ВТ_ДанныеРаздельногоУчета.ДатаСчетаФактуры КАК ДатаСчетаФактуры,
	|	ВТ_ДанныеРаздельногоУчета.СтавкаНДС КАК СтавкаНДС,
	|	ВТ_ДанныеРаздельногоУчета.СчетУчетаНДС КАК СчетУчетаНДС,
...
Функция ПечатьВосстановлениеНДС(МассивОбъектов, ОбъектыПечати)
	...
	Запрос.Текст = УчетНДСОтчетыПереопределяемый.ТекстЗапросаРеквизитыСчетовФактурПостановление735КнигаПокупок()
	+ "ВЫБРАТЬ
