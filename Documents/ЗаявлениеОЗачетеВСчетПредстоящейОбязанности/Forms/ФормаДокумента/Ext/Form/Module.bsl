...
Процедура ПолучитьРеквизитыОрганизации()
	...
	ПростойУчетЕНС = Объект.Дата >= ЕдиныйНалоговыйСчет.НачалоПростогоУчета();
...
Процедура УстановитьУсловноеОформление()
	...
	ЭлементУО = УсловноеОформление.Элементы.Добавить();
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУО.Поля, "НалогиСчетУчета");
	ОбщегоНазначенияКлиентСервер.ДобавитьЭлементКомпоновки(ЭлементУО.Отбор,
		"ПростойУчетЕНС", ВидСравненияКомпоновкиДанных.Равно, Истина);
