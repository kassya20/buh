...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Для счета затрат ограничим список калькуляционными счетами.
...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	...
	СчетаФактурыНеТребуются = Документы.АктОбОказанииПроизводственныхУслуг.СчетаФактурыНеТребуются(МассивДокументов);
...
Процедура УстановитьФункциональныеОпцииФормы()
	...
	УчетПроизводства.НастроитьВидимостьЭлементовПлановойСебестоимости(
		Элементы.УслугиИспользоватьПлановуюСебестоимость,
		Объект.Дата,
		Объект.Организация);
...
Процедура ЗаписатьСтатусДокументаНаСервере(ДокументСсылка, СтатусДокумента)
	...
	СтатусыДокумента.Статус = Документы.АктОбОказанииПроизводственныхУслуг.СтатусДокументаПеречислением(СтатусДокумента);
...
Процедура УстановитьСтатусДокумента()
	...
	СтатусыДокумента = РегистрыСведений.СтатусыДокументов.НовыеСтатусыДокумента();
	СтатусыДокумента.Статус = Документы.АктОбОказанииПроизводственныхУслуг.СтатусДокументаПеречислением(
		СтатусДокумента);
	
	СтатусыДокумента.СтатусСФ = Перечисления.СтатусыСчетаФактуры.Отсутствует;
...
Функция ОписаниеТипаРеквизитаДокументАванса()
	...
	Возврат Метаданные.Документы.АктОбОказанииПроизводственныхУслуг.ТабличныеЧасти.ЗачетАвансов.Реквизиты.ДокументАванса.Тип;
