...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Иначе
		...
		// Возможно, в данных заполнения указано, что нужно заполнить по данным организации.
		Если ТипЗнч(ДанныеЗаполнения) = Тип("Структура") Тогда
			ДанныеЗаполнения.Свойство("ЗаполнитьПоДаннымОрганизации", ЗаполнитьПоДаннымОрганизации);
		КонецЕсли;
	КонецЕсли;
	...
	Документы.АктСверкиВзаиморасчетов.УстановитьПериодСверки(ЭтотОбъект, ПараметрДатаНачала, ПараметрДатаОкончания);
	...
	Если ЗаполнитьПоДаннымОрганизации = Истина Тогда
