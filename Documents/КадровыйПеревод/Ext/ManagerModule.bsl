...
Процедура ОбработкаПолученияПредставления(Данные, Представление, СтандартнаяОбработка)
	...
	СтандартнаяОбработка = Ложь;
	Представление = СтрШаблон(НСтр("ru = 'Кадровый перевод %1 от %2'"), Данные.НомерПриказа, Формат(Данные.Дата, "ДЛФ=D"));
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	ПодключаемыеКоманды.ДобавитьУсловиеВидимостиКоманды(КомандаПечати, "ЗагруженИзВнешнегоИсточника", Ложь);
