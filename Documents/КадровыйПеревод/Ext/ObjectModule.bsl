...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если Не ИзменитьПодразделениеИДолжность Тогда
		...
		Если Не ЗагруженИзВнешнегоИсточника Тогда
	...
	Если Не ЗагруженИзВнешнегоИсточника 
		И (Не ИзменитьПодразделениеИДолжность И Не ИзменитьНачисления И Не ИзменитьАванс) Тогда
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Если ЗагруженИзВнешнегоИсточника Тогда
		...
		КонецЕсли;
		Если ИзменитьВидЗанятости Тогда
...
Функция ПолучитьДанныеДляПроведения()
	...
	ДанныеДляПроведения.Вставить("МероприятияТрудовойДеятельности",
		Документы.КадровыйПеревод.ДанныеДляПроведенияМероприятияТрудовойДеятельности(Ссылка).Получить(Ссылка));
