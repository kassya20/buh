...
//
Процедура ЗаполнитьСчетаУчетаВТабличнойЧасти(Объект, ИмяТабличнойЧасти, ЗаполнятьТолькоНезаполенные = Ложь) Экспорт
	...
	Для каждого СтрокаТабличнойЧасти Из ТабличнаяЧасть Цикл
		...
		ЗаполнитьСчетаУчетаВСтрокеТабличнойЧасти(ДанныеОбъекта, СтрокаТаблицы, ИмяТабличнойЧасти, СчетаУчета, ЗаполнятьТолькоНезаполенные);
...
//
Процедура ЗаполнитьСчетаУчетаВСтрокеТабличнойЧасти(ДанныеОбъекта, СтрокаТабличнойЧасти, ИмяТабличнойЧасти, СведенияОНоменклатуре, ЗаполнятьТолькоНезаполенные = Ложь) Экспорт
	...
	Если (ИмяТабличнойЧасти = "Спецодежда") ИЛИ (ИмяТабличнойЧасти = "Спецоснастка") Тогда
		...
		Если Не ЗаполнятьТолькоНезаполенные
			Или Не ЗначениеЗаполнено(СтрокаТабличнойЧасти.СчетПередачи) Тогда
...
Функция ТекстЗапросаСписаниеИнвентаря(НомераТаблиц)
	...
	|	ТаблицаИнвентарь.ПартияМатериаловВЭксплуатации КАК ПартияМатериаловВЭксплуатации,
...
Функция ТекстЗапросаПрослеживаемыеТовары(НомераТаблиц, ПараметрыПроведения, ВедетсяУчетПрослеживаемыхТоваров)
	...
	|	СУММА(СписаниеМатериаловИзЭксплуатацииСведенияПрослеживаемости.Количество) КАК Количество,
	|	ВЫБОР
	|		КОГДА СписаниеМатериаловИзЭксплуатацииИнвентарьИХозяйственныеПринадлежности.ПрослеживаемыйКомплект
	|			ТОГДА СписаниеМатериаловИзЭксплуатацииСведенияПрослеживаемости.СтранаПроисхождения
	|		ИНАЧЕ СписаниеМатериаловИзЭксплуатацииИнвентарьИХозяйственныеПринадлежности.СтранаПроисхождения
	|	КОНЕЦ КАК СтранаПроисхождения,
	|	СписаниеМатериаловИзЭксплуатацииСведенияПрослеживаемости.РНПТ КАК РНПТ,
	|	СУММА(СписаниеМатериаловИзЭксплуатацииСведенияПрослеживаемости.КоличествоПрослеживаемости) КАК КоличествоПрослеживаемости,
	|	СписаниеМатериаловИзЭксплуатацииИнвентарьИХозяйственныеПринадлежности.Ссылка КАК ДокументОперации,
	|	НАЧАЛОПЕРИОДА(СписаниеМатериаловИзЭксплуатацииИнвентарьИХозяйственныеПринадлежности.Ссылка.Дата, КВАРТАЛ) КАК ПериодОперации,
	...
	|	СписаниеМатериаловИзЭксплуатации.КодОперацииПрослеживаемости КАК КодОперации,
	|	ЗНАЧЕНИЕ(Справочник.ТипыДокументов.Акт) КАК ТипДокументаВПрослеживаемости,
	|	СписаниеМатериаловИзЭксплуатацииИнвентарьИХозяйственныеПринадлежности.ИдентификаторСтроки КАК ИдентификаторСтроки,
	|	СписаниеМатериаловИзЭксплуатацииСведенияПрослеживаемости.Номенклатура КАК Комплектующие,
	|	СписаниеМатериаловИзЭксплуатацииСведенияПрослеживаемости.Сумма КАК СуммаБезНДС,
	|	СписаниеМатериаловИзЭксплуатацииИнвентарьИХозяйственныеПринадлежности.ПрослеживаемыйКомплект КАК ПрослеживаемыйКомплект
	...
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.СписаниеМатериаловИзЭксплуатации.СведенияПрослеживаемости КАК СписаниеМатериаловИзЭксплуатацииСведенияПрослеживаемости
	|		ПО СписаниеМатериаловИзЭксплуатацииИнвентарьИХозяйственныеПринадлежности.Ссылка = СписаниеМатериаловИзЭксплуатацииСведенияПрослеживаемости.Ссылка
	|			И СписаниеМатериаловИзЭксплуатацииИнвентарьИХозяйственныеПринадлежности.ИдентификаторСтроки = СписаниеМатериаловИзЭксплуатацииСведенияПрослеживаемости.ИдентификаторСтроки
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ДанныеПервичныхДокументов КАК ДанныеПервичныхДокументов
	|		ПО СписаниеМатериаловИзЭксплуатацииИнвентарьИХозяйственныеПринадлежности.Ссылка = ДанныеПервичныхДокументов.Документ
	|			И СписаниеМатериаловИзЭксплуатацииИнвентарьИХозяйственныеПринадлежности.Ссылка.Организация = ДанныеПервичныхДокументов.Организация
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.СписаниеМатериаловИзЭксплуатации КАК СписаниеМатериаловИзЭксплуатации
	|		ПО СписаниеМатериаловИзЭксплуатацииИнвентарьИХозяйственныеПринадлежности.Ссылка = СписаниеМатериаловИзЭксплуатации.Ссылка
	|ГДЕ
	|	СписаниеМатериаловИзЭксплуатацииИнвентарьИХозяйственныеПринадлежности.ПрослеживаемыйТовар
	|	И СписаниеМатериаловИзЭксплуатацииИнвентарьИХозяйственныеПринадлежности.Ссылка = &Ссылка
	|
	|СГРУППИРОВАТЬ ПО
	|	СписаниеМатериаловИзЭксплуатацииСведенияПрослеживаемости.РНПТ,
	...
	|	НАЧАЛОПЕРИОДА(СписаниеМатериаловИзЭксплуатацииИнвентарьИХозяйственныеПринадлежности.Ссылка.Дата, КВАРТАЛ),
	|	ЕСТЬNULL(ДанныеПервичныхДокументов.Номер, """"),
	|	ЕСТЬNULL(ДанныеПервичныхДокументов.Дата, ДАТАВРЕМЯ(1, 1, 1)),
	|	СписаниеМатериаловИзЭксплуатацииИнвентарьИХозяйственныеПринадлежности.ИдентификаторСтроки,
	|	СписаниеМатериаловИзЭксплуатации.КодОперацииПрослеживаемости,
	|	ВЫБОР
	|		КОГДА СписаниеМатериаловИзЭксплуатацииИнвентарьИХозяйственныеПринадлежности.ПрослеживаемыйКомплект
	|			ТОГДА СписаниеМатериаловИзЭксплуатацииСведенияПрослеживаемости.СтранаПроисхождения
	|		ИНАЧЕ СписаниеМатериаловИзЭксплуатацииИнвентарьИХозяйственныеПринадлежности.СтранаПроисхождения
	|	КОНЕЦ,
	|	СписаниеМатериаловИзЭксплуатацииСведенияПрослеживаемости.Номенклатура,
	|	СписаниеМатериаловИзЭксплуатацииСведенияПрослеживаемости.Сумма,
	|	СписаниеМатериаловИзЭксплуатацииИнвентарьИХозяйственныеПринадлежности.ПрослеживаемыйКомплект
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
