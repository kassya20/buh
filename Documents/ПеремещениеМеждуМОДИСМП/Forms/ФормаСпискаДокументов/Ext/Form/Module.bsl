...
Процедура СписокПриПолученииДанныхНаСервере(ИмяЭлемента, Настройки, Строки)
	...
	УчитываемаяПивнаяПродукция = Новый Массив;
	УчитываемыеВидыПродукции   = ОбщегоНазначенияИСМПВызовСервера.УчитываемыеВидыМаркируемойПродукции();
	
	МассивПивнойПродукции = Новый Массив;
	МассивПивнойПродукции.Добавить(Перечисления.ВидыПродукцииИС.Пиво);
	МассивПивнойПродукции.Добавить(Перечисления.ВидыПродукцииИС.ПивоВПотребительскихУпаковках);
	
	Для Каждого ПивнаяПродукция Из МассивПивнойПродукции Цикл
		
		Если УчитываемыеВидыПродукции.Найти(ПивнаяПродукция) = Неопределено Тогда
			Продолжить;
		КонецЕсли;
		
		УчитываемаяПивнаяПродукция.Добавить(ПивнаяПродукция);
		
	КонецЦикла;
	
	ПредставлениеПивнойПродукции = СтрСоединить(УчитываемаяПивнаяПродукция, ", ");
	...
	Для Каждого СтрокаСписка Из Строки Цикл
		...
		Если ЗначениеЗаполнено(ДанныеСтроки.ВидПродукции) Тогда
			Продолжить;
		КонецЕсли;
		
		ОформлениеСтроки["ВидПродукции"].УстановитьЗначениеПараметра("Текст", ПредставлениеПивнойПродукции);
