...
&НаКлиенте
Процедура ФамилияФЛОтпрАвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ИмяФЛОтпрАвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
	
	Если ЗначениеЗаполнено(ФамилияФЛОтпр) Тогда
		ПараметрыПолученияДанных.Отбор = Новый Структура("Фамилия", ФамилияФЛОтпр);
	КонецЕсли;
...
&НаКлиенте
Процедура ОтчествоФЛОтпрАвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
	
	Если ЗначениеЗаполнено(ФамилияФЛОтпр) Тогда
		ПараметрыПолученияДанных.Отбор = Новый Структура("Фамилия", ФамилияФЛОтпр);
	КонецЕсли;
	Если ЗначениеЗаполнено(ИмяФЛОтпр) Тогда
		Если ТипЗнч(ПараметрыПолученияДанных.Отбор) <> Тип("Структура") Тогда
			ПараметрыПолученияДанных.Отбор = Новый Структура("Имя", ИмяФЛОтпр);
		Иначе
			ПараметрыПолученияДанных.Отбор.Вставить("Имя", ИмяФЛОтпр);
		КонецЕсли;
	КонецЕсли;
...
&НаКлиенте
Процедура ФамилияФЛИмпортАвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ИмяФЛИмпортАвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
	
	Если ЗначениеЗаполнено(ФамилияФЛИмпорт) Тогда
		ПараметрыПолученияДанных.Отбор = Новый Структура("Фамилия", ФамилияФЛИмпорт);
	КонецЕсли;
...
&НаКлиенте
Процедура ОтчествоФЛИмпортАвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
	
	Если ЗначениеЗаполнено(ФамилияФЛИмпорт) Тогда
		ПараметрыПолученияДанных.Отбор = Новый Структура("Фамилия", ФамилияФЛИмпорт);
	КонецЕсли;
	Если ЗначениеЗаполнено(ИмяФЛИмпорт) Тогда
		Если ТипЗнч(ПараметрыПолученияДанных.Отбор) <> Тип("Структура") Тогда
			ПараметрыПолученияДанных.Отбор = Новый Структура("Имя", ИмяФЛИмпорт);
		Иначе
			ПараметрыПолученияДанных.Отбор.Вставить("Имя", ИмяФЛИмпорт);
		КонецЕсли;
	КонецЕсли;
...
&НаКлиенте
Процедура ФамилияПодп1АвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ИмяПодп1АвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
	
	Если ЗначениеЗаполнено(ФамилияПодп1) Тогда
		ПараметрыПолученияДанных.Отбор = Новый Структура("Фамилия", ФамилияПодп1);
	КонецЕсли;
...
&НаКлиенте
Процедура ОтчествоПодп1АвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
	
	Если ЗначениеЗаполнено(ФамилияПодп1) Тогда
		ПараметрыПолученияДанных.Отбор = Новый Структура("Фамилия", ФамилияПодп1);
	КонецЕсли;
	Если ЗначениеЗаполнено(ИмяПодп1) Тогда
		Если ТипЗнч(ПараметрыПолученияДанных.Отбор) <> Тип("Структура") Тогда
			ПараметрыПолученияДанных.Отбор = Новый Структура("Имя", ИмяПодп1);
		Иначе
			ПараметрыПолученияДанных.Отбор.Вставить("Имя", ИмяПодп1);
		КонецЕсли;
	КонецЕсли;
