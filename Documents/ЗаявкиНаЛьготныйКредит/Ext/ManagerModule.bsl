...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ОпределитьЗаявкиВНеправильномСтатусеВФоне", Истина);
	Методы.Вставить("ПолучитьСсылкуНаБанкиВФоне", Истина);
	Методы.Вставить("ОтправитьЗаявкуОператоруВФоне", Истина);
	Методы.Вставить("ПроверитьДоступностьКредитаВФоне", Истина);
	Методы.Вставить("ПроверитьОрганизациюВФоне", Истина);
	Методы.Вставить("ПолучитьБанкиВФоне", Истина);
	Методы.Вставить("ПолучитьДанныеДляПодписанияИТокенВФоне", Истина);
	Методы.Вставить("ОбновитьСтатусЗаявкиВФоне", Истина);
КонецПроцедуры
