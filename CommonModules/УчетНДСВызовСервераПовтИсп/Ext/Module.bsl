...
Функция ПолучитьСтавкуНДСдляККТ(СтавкаНДС, ПрименяютсяРасчетныеСтавки = Ложь, ПрименяютсяСтавки4и2 = Ложь) Экспорт
	...
	СтавкаНДСЧислом = УчетНДСПереопределяемый.ПолучитьСтавкуНДС(СтавкаНДС, ПрименяютсяСтавки4и2);
	Если ПрименяютсяРасчетныеСтавки И Перечисления.СтавкиНДС.ЭтоРасчетнаяСтавкаНДС(СтавкаНДС) Тогда
		СтавкаНДСЧислом = 100 + СтавкаНДСЧислом;
	КонецЕсли;
