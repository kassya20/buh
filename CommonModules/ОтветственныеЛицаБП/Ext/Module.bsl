...
Функция ПолучитьСоздатьФизЛицо(ДанныеФизЛица) Экспорт
	...
	Иначе
		...
		ОрганизацииФормыКлиентСервер.ОпределитьПолПоОтчеству(НовоеФизлицо.Пол, Отчество);
...
Функция ПолучитьСоздатьДолжность(НазваниеДолжности) Экспорт
	...
	Иначе
		ОписаниеДолжности = УчетЗарплаты.ЗаполнитьДолжностьПоПараметрам(Новый Структура("Наименование", НазваниеДолжности));
		ДолжностьРуководителя = Справочники.Должности.СоздатьЭлемент();
		ЗаполнитьЗначенияСвойств(ДолжностьРуководителя, ОписаниеДолжности);
