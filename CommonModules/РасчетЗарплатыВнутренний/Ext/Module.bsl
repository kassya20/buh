...
Процедура СформироватьДвиженияНачисленийПоДоговорам(Движения, Отказ, Организация, ПериодРегистрации, Начисления) Экспорт
	...
	РасчетЗарплатыБазовый.СформироватьДвиженияНачисленийПоДоговорам(Движения, Отказ, Организация, ПериодРегистрации, Начисления);
...
Функция РезультатНачисленияРасчетаЗарплаты(Организация, МесяцНачисления, Документ, Подразделение, Сотрудники, ПерваяПоловинаМесяца, ПланируемаяДатаВыплаты = '00010101') Экспорт
	Возврат РасчетЗарплатыБазовый.РезультатНачисленияРасчетаЗарплаты(Организация, МесяцНачисления, Документ, Подразделение, Сотрудники, ПерваяПоловинаМесяца, ПланируемаяДатаВыплаты);
КонецФункции
...
Процедура ЗаполнитьНачисления(ДанныеДляПроведенияНачисленияЗарплаты, Документ, ТаблицаНачислений, ПолеДатыДействия, ПолеВидаНачисления = Неопределено, ПолеВидаНачисленияВШапке = Неопределено, ФизическиеЛица = Неопределено) Экспорт
	РасчетЗарплатыБазовый.ЗаполнитьНачисления(ДанныеДляПроведенияНачисленияЗарплаты, Документ, ТаблицаНачислений, ПолеДатыДействия, ПолеВидаНачисления, ПолеВидаНачисленияВШапке, ФизическиеЛица);
КонецПроцедуры
...
Процедура ЗаполнитьДанныеНДФЛ(ДанныеДляПроведения, ДокументСсылка, ФизическиеЛица = Неопределено, РаспределениеУдержаний = Истина) Экспорт
	РасчетЗарплатыБазовый.ЗаполнитьДанныеНДФЛ(ДанныеДляПроведения, ДокументСсылка, ФизическиеЛица, РаспределениеУдержаний);
КонецПроцедуры
...
Процедура ЗаполнитьДокументНачисленияЗарплаты(ДанныеНачисленияЗарплаты, ПерваяПоловинаМесяца, ПланируемаяДатаВыплаты = '00010101') Экспорт
	РасчетЗарплатыБазовый.ЗаполнитьДокументНачисленияЗарплаты(ДанныеНачисленияЗарплаты, ПерваяПоловинаМесяца, ПланируемаяДатаВыплаты);
КонецПроцедуры	
...
Процедура СформироватьНачисленияОплатыДолейРКиСН() Экспорт
	РасчетЗарплатыБазовый.СформироватьНачисленияОплатыДолейРКиСН();
КонецПроцедуры

Процедура ПриПримененииТарифаСтраховыхВзносов(Источник, Отказ, Замещение) Экспорт
	
	РасчетЗарплатыБазовый.ПриПримененииТарифаСтраховыхВзносов(Источник, Отказ, Замещение);
