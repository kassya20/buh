...
Процедура ПриДобавленииПереименованийОбъектовМетаданных(Переименования) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриДобавленииПереименованийОбъектовМетаданных(Переименования);
...
Процедура ПриНачальномЗаполненииРолейИсполнителей(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	ЗаявкиСотрудников.ПриНачальномЗаполненииРолейИсполнителей(КодыЯзыков, Элементы, ТабличныеЧасти);
...
Процедура ПриПолученииФормыВыполненияЗадачи(ИмяБизнесПроцесса, ЗадачаСсылка, ТочкаМаршрутаБизнесПроцесса, ПараметрыФормы) Экспорт
	...
	ЭДОБЗК.ПриПолученииФормыВыполненияЗадачи(ИмяБизнесПроцесса, ЗадачаСсылка, ТочкаМаршрутаБизнесПроцесса, ПараметрыФормы);
...
Процедура ПриСозданииНаСервереФормыОтчета(Форма, Отказ, СтандартнаяОбработка) Экспорт
	ЗарплатаКадрыВнутренний.ПриСозданииНаСервереФормыОтчета(Форма, Отказ, СтандартнаяОбработка);
КонецПроцедуры
...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.КонфигурацииЗарплатаКадры") Тогда
		...
		МодульКонфигурацииЗарплатаКадры.ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти);
	КонецЕсли;
	
	ФизическиеЛицаЗарплатаКадры.ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти);
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыРасширеннаяПодсистемы") Тогда
		...
		Модуль.ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти);
	КонецЕсли;
	// АПК:278-вкл
...
Процедура ПриЗаполненииРеквизитовФизическогоЛица(ФизическоеЛицо, Реквизиты) Экспорт
	...
	ДанныеФизическогоЛица = КадровыйУчет.КадровыеДанныеФизическогоЛица(Истина, ФизическоеЛицо, СписокПолей, ТекущаяДатаСеанса());
...
Процедура ПриОпределенииДоступныхДляПереводаМакетов(Макеты) Экспорт
	...
	КадровыйУчет.ПриОпределенииДоступныхДляПереводаМакетов(Макеты);
	ЭДОБЗК.ПриОпределенииДоступныхДляПереводаМакетов(Макеты);
	УчетНачисленнойЗарплаты.ПриОпределенииДоступныхДляПереводаМакетов(Макеты);
	УчетРабочегоВремени.ПриОпределенииДоступныхДляПереводаМакетов(Макеты);
	
	ЗарплатаКадрыВнутренний.ПриОпределенииДоступныхДляПереводаМакетов(Макеты);
...
Процедура ПриПолученииСпискаШаблоновОчередиЗаданий(Шаблоны) Экспорт
	...
	ЭДОБЗК.ПриПолученииСпискаШаблоновОчередиЗаданий(Шаблоны);
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ИнтеграцияС1САрхивом") Тогда
		...
		МодульОбменСАрхивом.ПриПолученииСпискаШаблонов(Шаблоны);
	КонецЕсли;
...
Процедура ПриОпределенииПсевдонимовОбработчиков(СоответствиеИменПсевдонимам) Экспорт
	...
	ЭДОБЗК.ПриОпределенииПсевдонимовОбработчиков(СоответствиеИменПсевдонимам);
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ИнтеграцияС1САрхивом") Тогда
		МодульОбменСАрхивом = ОбщегоНазначения.ОбщийМодуль("ОбменСАрхивом");
		МодульОбменСАрхивом.ПриОпределенииПсевдонимовОбработчиков(СоответствиеИменПсевдонимам);
	КонецЕсли;
	// Конец ИнтеграцияС1САрхивом
	
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.КонфигурацииЗарплатаКадры") Тогда
		МодульКонфигурацииЗарплатаКадры = ОбщегоНазначения.ОбщийМодуль("КонфигурацииЗарплатаКадры");
		МодульКонфигурацииЗарплатаКадры.ПриОпределенииПсевдонимовОбработчиков(СоответствиеИменПсевдонимам);
	КонецЕсли;
...
Процедура ПриОпределенииНастроекРегламентныхЗаданий(Настройки) Экспорт
	...
	ЭДОБЗК.ПриОпределенииНастроекРегламентныхЗаданий(Настройки);
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ИнтеграцияС1САрхивомЗарплатаКадры") Тогда
		...
		МодульИнтеграцияС1САрхивом.ПриОпределенииНастроекРегламентныхЗаданий(Настройки);
	КонецЕсли;
...
Функция ПриИзмененииСтатусаОтправкиДокумента(Ссылка, СтатусОтправки) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриИзмененииСтатусаОтправкиДокумента(Ссылка, СтатусОтправки);
...
Процедура ОтчетыПриАктивизацииСтрокиНаСервере(СсылкаНаОбъект) Экспорт
	ЗарплатаКадрыВнутренний.ОтчетыПриАктивизацииСтрокиНаСервере(СсылкаНаОбъект);
КонецПроцедуры

// См. РегламентированнаяОтчетностьПереопределяемый.ПриСозданииФормыРеглОтчета.
Процедура ФормаРегламентированнойОтчетности_ПриСозданииНаСервере(Форма) Экспорт
	ЗарплатаКадрыВнутренний.ФормаРегламентированнойОтчетности_ПриСозданииНаСервере(Форма);
КонецПроцедуры
...
Процедура ПриДобавленииКлассификаторов(Классификаторы) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриДобавленииКлассификаторов(Классификаторы);
...
Процедура ПриЗагрузкеКлассификатора(Идентификатор, Версия, Адрес, Обработан, ДополнительныеПараметры = Неопределено) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриЗагрузкеКлассификатора(Идентификатор, Версия, Адрес, Обработан, ДополнительныеПараметры);
...
Процедура ПриОтключенииТекущихДел(ОтключаемыеДела) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриОтключенииТекущихДел(ОтключаемыеДела);
...
Процедура ПриСозданииНаСервере(Форма, ПараметрыРазмещения, ЭтоФормаОбъекта) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриСозданииНаСервере(Форма, ПараметрыРазмещения, ЭтоФормаОбъекта);
...
Функция ЭтоФормаОбъекта(Форма) Экспорт
	...
	Возврат ЗарплатаКадрыВнутренний.ЭтоФормаОбъекта(Форма);
...
Функция ИмяРеквизитаФормыСодержащегоИнтегрируемыйОбъект(Форма) Экспорт
	...
	Возврат ЗарплатаКадрыВнутренний.ИмяРеквизитаФормыСодержащегоИнтегрируемыйОбъект(Форма);
...
Процедура ПриОпределенииИменИсключаемыхКоманд(Форма, ИменаИсключаемыхКоманд) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриОпределенииИменИсключаемыхКоманд(Форма, ИменаИсключаемыхКоманд);
...
Процедура УстановитьВидимостьИДоступностьКоманд(Форма, СтандартнаяОбработка) Экспорт
	...
	ЗарплатаКадрыВнутренний.УстановитьВидимостьИДоступностьКоманд(Форма, СтандартнаяОбработка);
...
Процедура ПроверитьГотовностьДокументаКОтправке(Ссылка, Отказ) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПроверитьГотовностьДокументаКОтправке(Ссылка, Отказ);
...
Функция ТаблицаДанныхНСИДляВыгрузки(СсылкиНаОбъектыНСИ, ТипОбъектаXDTO) Экспорт
	...
	Возврат ЗарплатаКадрыВнутренний.ТаблицаДанныхНСИДляВыгрузки(СсылкиНаОбъектыНСИ, ТипОбъектаXDTO);
...
Процедура ОбновитьВидыДокументовПриОбновленииКонфигурации(ПараметрОбработчика) Экспорт
	...
	ЗарплатаКадрыВнутренний.ОбновитьВидыДокументовПриОбновленииКонфигурации(ПараметрОбработчика);
...
Функция СоздатьДокументыБИА(СсылкаНаОбъектИсточник) Экспорт
	...
	Возврат ЗарплатаКадрыВнутренний.СоздатьДокументыБИА(СсылкаНаОбъектИсточник);
...
Процедура ПриЗаписиКонстантыИнтеграцияС1САрхивом(Объект, Отказ) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриЗаписиКонстантыИнтеграцияС1САрхивом(Объект, Отказ);
...
Процедура ПриОпределенииНастроек(Настройки) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриОпределенииНастроек(Настройки);
...
Процедура ОбновитьИЗаполнитьТребованияФНС(Организация, Дата) Экспорт
	...
	ЗарплатаКадрыВнутренний.ОбновитьИЗаполнитьТребованияФНС(Организация, Дата);
...
Процедура ЗарегистрироватьИзменениеСтатусаЗадачТребованиеФНС(Ссылка) Экспорт
	...
	ЗарплатаКадрыВнутренний.ЗарегистрироватьИзменениеСтатусаЗадачТребованиеФНС(Ссылка);
...
Процедура ПолучитьДоступныеВидыДействийКалендаряБухгалтера(МассивДоступныхДействий) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПолучитьДоступныеВидыДействийКалендаряБухгалтера(МассивДоступныхДействий);
...
Процедура ЗаполнитьКорректныеИдентификаторыТребованийОтчетов(ИдентификаторыТребований) Экспорт
	...
	ЗарплатаКадрыВнутренний.ЗаполнитьКорректныеИдентификаторыТребованийОтчетов(ИдентификаторыТребований);
...
Процедура ПолучитьПравилаИсключения(МенеджерВременныхТаблиц) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПолучитьПравилаИсключения(МенеджерВременныхТаблиц);
...
Процедура ДополнитьПредопределенныеПравила(Правила, ВерсияПравил) Экспорт
	...
	ЗарплатаКадрыВнутренний.ДополнитьПредопределенныеПравила(Правила, ВерсияПравил);
...
Процедура УстановитьВерсиюДополнительныхПравилПредставленияОтчетовУплатыНалогов(ВерсияДополнительныхПравил) Экспорт
	...
	ЗарплатаКадрыВнутренний.УстановитьВерсиюДополнительныхПравилПредставленияОтчетовУплатыНалогов(ВерсияДополнительныхПравил);
...
Процедура ПриОпределенииТекстаЗапросаСпискаЗадач(СписокЗадач) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриОпределенииТекстаЗапросаСпискаЗадач(СписокЗадач);
...
Процедура ПриОпределенииОписанияДействия(ОписаниеДействия, Событие) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриОпределенииОписанияДействия(ОписаниеДействия, Событие);
...
Процедура ПриОпределенииОписанияДействияФормированиеПлатежныхПорученийНаУплатуНалогов(Событие, ОписаниеДействия) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриОпределенииОписанияДействияФормированиеПлатежныхПорученийНаУплатуНалогов(Событие, ОписаниеДействия);
...
Процедура ПриОпределенииОписанияДействияВыплатаЗарплатыИУплатаНДФЛ(Событие, Аванс, ОписаниеДействия) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриОпределенииОписанияДействияВыплатаЗарплатыИУплатаНДФЛ(Событие, Аванс, ОписаниеДействия);
...
Процедура ПриОпределенииОписанияДействияСведенияЭТКЕжемесячные(Событие, ОписаниеДействия) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриОпределенииОписанияДействияСведенияЭТКЕжемесячные(Событие, ОписаниеДействия);
...
Процедура ПолучитьСвязанныеЗадачиВыплатыЗарплаты(ТаблицаЗадач, РеквизитыДокумента, ПравилоВыплатыЗарплатыАванс) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПолучитьСвязанныеЗадачиВыплатыЗарплаты(ТаблицаЗадач, РеквизитыДокумента, ПравилоВыплатыЗарплатыАванс);
...
Процедура ЗаполнитьСсылкиНаРеглОтчеты(ПараметрыРеглОтчетов) Экспорт
	...
	ЗарплатаКадрыВнутренний.ЗаполнитьСсылкиНаРеглОтчеты(ПараметрыРеглОтчетов);
...
Процедура ПриОпределенииПризнакаДокументВыполняетЗадачу(ДокументВыполняетЗадачу, ДокументОбъект) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриОпределенииПризнакаДокументВыполняетЗадачу(ДокументВыполняетЗадачу, ДокументОбъект);
...
Процедура ОпределитьРеквизитыПлатежаПоДаннымДокумента(РеквизитыПлатежа, ДокументСсылка) Экспорт
	...
	ЗарплатаКадрыВнутренний.ОпределитьРеквизитыПлатежаПоДаннымДокумента(РеквизитыПлатежа, ДокументСсылка);
...
Процедура УстановитьТекстЗапросаРеспондентыРосстата(ТекстЗапроса) Экспорт
	...
	ЗарплатаКадрыВнутренний.УстановитьТекстЗапросаРеспондентыРосстата(ТекстЗапроса);
...
Процедура ОпределитьОрганизациюПоРеспонденту(Организация, Респондент)Экспорт
	...
	ЗарплатаКадрыВнутренний.ОпределитьОрганизациюПоРеспонденту(Организация, Респондент);
...
Процедура ОпределитьОрганизацияПрименяетРайонныйКоэффициент(ПрименятьРайонныйКоэффициент, Организация, Период) Экспорт
	...
	ЗарплатаКадрыВнутренний.ОпределитьОрганизацияПрименяетРайонныйКоэффициент(ПрименятьРайонныйКоэффициент, Организация, Период);
...
Процедура ОпределитьОрганизацияПрименяетСевернуюНадбавку(ПрименятьСевернуюНадбавку, Организация, Период) Экспорт
	...
	ЗарплатаКадрыВнутренний.ОпределитьОрганизацияПрименяетСевернуюНадбавку(ПрименятьСевернуюНадбавку, Организация, Период);
...
Процедура ОпределитьОрганизацияРаботаетВСельскойМестности(РаботаетВСельскойМестности, Организация, Период) Экспорт
	...
	ЗарплатаКадрыВнутренний.ОпределитьОрганизацияРаботаетВСельскойМестности(РаботаетВСельскойМестности, Организация, Период);
...
Процедура ОпределитьЕстьДоговорыПодряда(ДоговорыПодряда, Организация, Период, Периодичность) Экспорт
	...
	ЗарплатаКадрыВнутренний.ОпределитьЕстьДоговорыПодряда(ДоговорыПодряда, Организация, Период, Периодичность);
...
Процедура ОпределитьЕстьДокументыОтпускаБезСодержания(ОтпускаБезСодержания, Организация, Период, Периодичность) Экспорт
	...
	ЗарплатаКадрыВнутренний.ОпределитьЕстьДокументыОтпускаБезСодержания(ОтпускаБезСодержания, Организация, Период, Периодичность);
...
Процедура ОпределитьЕстьСотрудники_ЧАЭС(Сотрудники_ЧАЭС, Организация, Период) Экспорт
	...
	ЗарплатаКадрыВнутренний.ОпределитьЕстьСотрудники_ЧАЭС(Сотрудники_ЧАЭС, Организация, Период);
...
Процедура ОпределитьИспользуетсяТрудНаемныхРаботников(Признак, УсловияПримененияПравил, Организация) Экспорт
	...
	ЗарплатаКадрыВнутренний.ОпределитьИспользуетсяТрудНаемныхРаботников(Признак, УсловияПримененияПравил, Организация);
...
Процедура ОпределитьВыплачиваетсяЗарплата(Признак, УсловияПримененияПравил, Организация, Период) Экспорт
	...
	ЗарплатаКадрыВнутренний.ОпределитьВыплачиваетсяЗарплата(Признак, УсловияПримененияПравил, Организация, Период);
...
Процедура ОпределитьЗарегистрированыКадровыеМероприятия(Признак, УсловияПримененияПравил, Организация, Период, Периодичность) Экспорт
	...
	ЗарплатаКадрыВнутренний.ОпределитьЗарегистрированыКадровыеМероприятия(Признак, УсловияПримененияПравил, Организация, Период, Периодичность);
...
Процедура ПроверитьСведенияОДоходахНДФЛ(ЕстьДоходы, Организация, НачалоПериода, КонецПериода) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПроверитьСведенияОДоходахНДФЛ(ЕстьДоходы, Организация, НачалоПериода, КонецПериода);
...
Процедура ОпределитьПлательщикЕНП(ПлательщикЕНП, Организация, Период) Экспорт
	...
	ЗарплатаКадрыВнутренний.ОпределитьПлательщикЕНП(ПлательщикЕНП, Организация, Период);
...
Процедура ОпределитьЭтоПлательщикТорговогоСбора(ПлательщикТорговогоСбора, Организация, Период) Экспорт
	...
	ЗарплатаКадрыВнутренний.ОпределитьЭтоПлательщикТорговогоСбора(ПлательщикТорговогоСбора, Организация, Период);
...
Процедура УточнитьЕстьНалогКУплатеПоДекларации3НДФЛ(ЕстьНалог, Организация, Период) Экспорт
	...
	ЗарплатаКадрыВнутренний.УточнитьЕстьНалогКУплатеПоДекларации3НДФЛ(ЕстьНалог, Организация, Период);
...
Процедура ОпределитьЭтоОбособленноеПодразделение(ЭтоОбособленноеПодразделение, Организация) Экспорт
	...
	ЗарплатаКадрыВнутренний.ОпределитьЭтоОбособленноеПодразделение(ЭтоОбособленноеПодразделение, Организация);
...
Процедура ПроверитьПлательщикФиксированныхВзносов(Плательщик, Организация, Период) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПроверитьПлательщикФиксированныхВзносов(Плательщик, Организация, Период);
...
Процедура ПроверитьПорядокУплатыФиксированныхСтраховыхВзносов(УсловиеВыполняется, Условие, Организация, Период) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПроверитьПорядокУплатыФиксированныхСтраховыхВзносов(УсловиеВыполняется, Условие, Организация, Период);
...
Процедура ПроверитьПлательщикФиксированныхВзносовНаДатуЗакрытия(Плательщик, Организация, Период, ДатаЗакрытия) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПроверитьПлательщикФиксированныхВзносовНаДатуЗакрытия(Плательщик, Организация, Период, ДатаЗакрытия);
...
Процедура ОпределитьНалогиПорядокКоторыхУстанавливаетсяНаМестах(СписокНалогов) Экспорт
	...
	ЗарплатаКадрыВнутренний.ОпределитьНалогиПорядокКоторыхУстанавливаетсяНаМестах(СписокНалогов);
...
Процедура ОпределитьПорядокУплатыРегиональныхМестныхНалогов(ПорядокУплаты, Организация, ТекущаяДата) Экспорт
	...
	ЗарплатаКадрыВнутренний.ОпределитьПорядокУплатыРегиональныхМестныхНалогов(ПорядокУплаты, Организация, ТекущаяДата);
...
Процедура ОпределитьУчетЗарплатыИКадровВЭтойПрограмме(УсловиеВыполняется) Экспорт
	...
	ЗарплатаКадрыВнутренний.ОпределитьУчетЗарплатыИКадровВЭтойПрограмме(УсловиеВыполняется);
...
Процедура ОпределитьНачисляютсяДополнительныеВзносыЧленамЛетныхЭкипажейИлиШахтерам(УсловиеВыполняется, Организация) Экспорт
	...
	ЗарплатаКадрыВнутренний.ОпределитьНачисляютсяДополнительныеВзносыЧленамЛетныхЭкипажейИлиШахтерам(УсловиеВыполняется, Организация);
...
Процедура ОпределитьОтправлятьУведомления(ОтправлятьУведомления, ВладелецДанныхВХранилище) Экспорт
	...
	ЗарплатаКадрыВнутренний.ОпределитьОтправлятьУведомления(ОтправлятьУведомления, ВладелецДанныхВХранилище);
...
Процедура ОпределитьОтправлятьУведомленияСЭДО(ОтправлятьУведомления, ВладелецДанныхВХранилище, ОтправлятьУведомленияСЭДОПоЭлектроннойПочте) Экспорт
	...
	ЗарплатаКадрыВнутренний.ОпределитьОтправлятьУведомленияСЭДО(ОтправлятьУведомления, ВладелецДанныхВХранилище, ОтправлятьУведомленияСЭДОПоЭлектроннойПочте);
...
Процедура ОпределитьПолучателя(Получатель, ВладелецДанныхВХранилище) Экспорт
	...
	ЗарплатаКадрыВнутренний.ОпределитьПолучателя(Получатель, ВладелецДанныхВХранилище);
...
Процедура ЗаполнитьАдресИнформационнойБазы(АдресИнформационнойБазы, ВладелецДанныхВХранилище) Экспорт
	...
	ЗарплатаКадрыВнутренний.ЗаполнитьАдресИнформационнойБазы(АдресИнформационнойБазы, ВладелецДанныхВХранилище);
...
Процедура УстановитьОтправлятьУведомления(ОтправлятьУведомления, ВладелецДанныхВХранилище, КлючДанных) Экспорт
	...
	ЗарплатаКадрыВнутренний.УстановитьОтправлятьУведомления(ОтправлятьУведомления, ВладелецДанныхВХранилище, КлючДанных);
...
Процедура УстановитьПолучателя(Получатель, ВладелецДанныхВХранилище) Экспорт
	...
	ЗарплатаКадрыВнутренний.УстановитьПолучателя(Получатель, ВладелецДанныхВХранилище);
...
Процедура ПриПолученииПравилПредоставленияОтчетаУплатыНДФЛПредпринимателя(Правила, Организация, Период) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриПолученииПравилПредоставленияОтчетаУплатыНДФЛПредпринимателя(Правила, Организация, Период);
...
Процедура ПриОпределенииОписанияДействияНалоговыйПлатежОтчетУведомление(ОписаниеДействия, Правило, Событие, ПолноеИмяПравила) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриОпределенииОписанияДействияНалоговыйПлатежОтчетУведомление(ОписаниеДействия, Правило, Событие, ПолноеИмяПравила);
...
Процедура ПриОпределенииЗадачСвязанныхСОтчетом(ЗадачиСвязанныеСОтчетом, Документ, СвойстваОтчета, ИсточникОтчета) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриОпределенииЗадачСвязанныхСОтчетом(ЗадачиСвязанныеСОтчетом, Документ, СвойстваОтчета, ИсточникОтчета);
...
Процедура ПриПолученииОтбораНалоговыеОрганы(ОтборНалоговыеОрганы, Организация, КодНалоговогоОргана) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриПолученииОтбораНалоговыеОрганы(ОтборНалоговыеОрганы, Организация, КодНалоговогоОргана);
...
Процедура УдалитьНеЗаполненныеЭлементыМассива(МассивЭлементов) Экспорт
	...
	ЗарплатаКадрыВнутренний.УдалитьНеЗаполненныеЭлементыМассива(МассивЭлементов);
...
Процедура ЗаполнитьДоступныеОрганизацииДляОтбора(Результат, Организация, ПравоНаИзменение) Экспорт
	...
	ЗарплатаКадрыВнутренний.ЗаполнитьДоступныеОрганизацииДляОтбора(Результат, Организация, ПравоНаИзменение);
...
Процедура ПриОпределенииНоваяТаблицаПлатежи(ТаблицаПлатежи, ТаблицаЗадач) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриОпределенииНоваяТаблицаПлатежи(ТаблицаПлатежи, ТаблицаЗадач);
...
Процедура ЗаполнитьКорректныйПериодВводаДокументов(КорректныйПериод) Экспорт
	...
	ЗарплатаКадрыВнутренний.ЗаполнитьКорректныйПериодВводаДокументов(КорректныйПериод);
...
Процедура ПолучитьИмяЗадачиБухгалтера(ИмяЗадачи, ВидНалога, Организация, Период) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПолучитьИмяЗадачиБухгалтера(ИмяЗадачи, ВидНалога, Организация, Период);
...
Процедура ПолучитьОсобыеСрокиСверкиИмущественныхНалогов(ОсобыеСрокиСверки, Организация) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПолучитьОсобыеСрокиСверкиИмущественныхНалогов(ОсобыеСрокиСверки, Организация);

КонецПроцедуры

Процедура ЗаполнитьТаблицуСоответствияЗадачБухгалтераДляУведомлений(ВидыКодыНалогов) Экспорт
	
	ЗарплатаКадрыВнутренний.ЗаполнитьТаблицуСоответствияЗадачБухгалтераДляУведомлений(ВидыКодыНалогов);
...
Процедура ПроверитьЭтоПравилоУплатыВзносовСДоходов(ЭтоПравилоУплатыВзносовСДоходов, Правило) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПроверитьЭтоПравилоУплатыВзносовСДоходов(ЭтоПравилоУплатыВзносовСДоходов, Правило);
...
Процедура ЗаполнитьДоступныеОрганизации(ДоступныеОрганизации) Экспорт
	...
	ЗарплатаКадрыВнутренний.ЗаполнитьДоступныеОрганизации(ДоступныеОрганизации);
...
Процедура ЗаполнитьДоступныеОрганизацииПоRLS(ВсеОрганизации) Экспорт
	...
	ЗарплатаКадрыВнутренний.ЗаполнитьДоступныеОрганизацииПоRLS(ВсеОрганизации);
...
Процедура ПриПолученииЗадачНовыхОрганизаций(ЗадачиОрганизаций) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриПолученииЗадачНовыхОрганизаций(ЗадачиОрганизаций);
...
Процедура ПриПолученииТиповПравил(ТипыПравил) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриПолученииТиповПравил(ТипыПравил);
...
Процедура СоздатьПравилоВыплатаЗарплатыУплатаНДФЛ(МенеджерВременныхТаблиц, Организация, ОтборПравил) Экспорт
	...
	ЗарплатаКадрыВнутренний.СоздатьПравилоВыплатаЗарплатыУплатаНДФЛ(МенеджерВременныхТаблиц, Организация, ОтборПравил);
...
Процедура СоздатьПравилаУплатыНалоговНаМестах(МенеджерВременныхТаблиц, Организация, ИмяЗадачи = "", ТекущийПериод = Неопределено) Экспорт
	...
	ЗарплатаКадрыВнутренний.СоздатьПравилаУплатыНалоговНаМестах(МенеджерВременныхТаблиц, Организация, ИмяЗадачи, ТекущийПериод);
...
Процедура УстановитьОтборПоОсновнойОрганизации(Форма, ИмяСписка = "Список", ИмяРеквизита = "Организация", ЗначениеОтбора = Неопределено) Экспорт
	...
	ЗарплатаКадрыВнутренний.УстановитьОтборПоОсновнойОрганизации(Форма, ИмяСписка, ИмяРеквизита, ЗначениеОтбора);
...
Процедура ДополнитьДанныеЗаполненияПриОднофирменномУчете(ДанныеЗаполнения, ИмяРеквизитаОрганизация) Экспорт
	...
	ЗарплатаКадрыВнутренний.ДополнитьДанныеЗаполненияПриОднофирменномУчете(ДанныеЗаполнения, ИмяРеквизитаОрганизация);
...
Процедура ПроверитьПравоРедактированияНалогиОтчеты(Право) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПроверитьПравоРедактированияНалогиОтчеты(Право);
...
Процедура ДополнитьЗапросПриПолученииАктуальныхПравил(Запрос, ТекстЗапроса) Экспорт
	...
	ЗарплатаКадрыВнутренний.ДополнитьЗапросПриПолученииАктуальныхПравил(Запрос, ТекстЗапроса);
...
Процедура ПроверитьКорректностьЗагружаемогоТребования(Некорректное, КорректныеИдентификаторы, МассивДоступныхДействий, ИдентификаторЗадачи, ИдентификаторТребования, Действие) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПроверитьКорректностьЗагружаемогоТребования(Некорректное, КорректныеИдентификаторы, МассивДоступныхДействий, ИдентификаторЗадачи, ИдентификаторТребования, Действие);
...
Процедура ПриСозданииНаСервереСписокЗадачНастройка(Форма) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриСозданииНаСервереСписокЗадачНастройка(Форма);
...
Процедура ПриСозданииНаСервереСписокЗадач(Форма) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриСозданииНаСервереСписокЗадач(Форма);
...
Процедура ПроверитьПоддерживается1СФинОтчетность(Поддерживается1СФинОтчетность) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПроверитьПоддерживается1СФинОтчетность(Поддерживается1СФинОтчетность);
...
Процедура ВосстановитьОтборСписка(Список, Настройки, ИмяОтбора) Экспорт
	...
	ЗарплатаКадрыВнутренний.ВосстановитьОтборСписка(Список, Настройки, ИмяОтбора);
...
Процедура ЗаполнитьУсловияПримененияПравил(Условия, Организация, НачалоПериода, КонецПериода) Экспорт
	...
	ЗарплатаКадрыВнутренний.ЗаполнитьУсловияПримененияПравил(Условия, Организация, НачалоПериода, КонецПериода);
...
Процедура ДобавитьОформляемоеПоле(КоллекцияОформляемыхПолей, ИмяПоля) Экспорт
	...
	ЗарплатаКадрыВнутренний.ДобавитьОформляемоеПоле(КоллекцияОформляемыхПолей, ИмяПоля);
...
Процедура ПолучитьСтруктуруИзРезультатаЗапроса(СтруктураПараметров, РезультатЗапроса) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПолучитьСтруктуруИзРезультатаЗапроса(СтруктураПараметров, РезультатЗапроса);
...
Процедура ПолучитьБаннерНаСервере(РезультатПолученияБаннера, СторонниеСертификаты, ПоказатьПредыдущий, Форма) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПолучитьБаннерНаСервере(РезультатПолученияБаннера, СторонниеСертификаты, ПоказатьПредыдущий, Форма);
...
Процедура ПолучитьПравоВыполненияЗадачи(ЕстьПраво, Задача) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПолучитьПравоВыполненияЗадачи(ЕстьПраво, Задача);
...
Процедура ЗаполнитьСобытияКалендаряБухгалтера(ЗадачиОрганизаций, Организации, ОтборЗадач) Экспорт
	...
	ЗарплатаКадрыВнутренний.ЗаполнитьСобытияКалендаряБухгалтера(ЗадачиОрганизаций, Организации, ОтборЗадач);
...
Процедура ПолучитьДанныеЗадачиБухгалтера(ДанныеЗадачиБухгалтера, Организация) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПолучитьДанныеЗадачиБухгалтера(ДанныеЗадачиБухгалтера, Организация);
...
Процедура ПолучитьКоличествоПросроченныхСобытийКалендаряБухгалтера(КоличествоПросроченных, Организации, ОтборЗадач) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПолучитьКоличествоПросроченныхСобытийКалендаряБухгалтера(КоличествоПросроченных, Организации, ОтборЗадач);
...
Процедура ПолучитьОрганизацииДанныеКоторыхДоступныПользователю(ДоступныеОрганизации, ПравоНаИзменение, Пользователь) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПолучитьОрганизацииДанныеКоторыхДоступныПользователю(ДоступныеОрганизации, ПравоНаИзменение, Пользователь);
...
Процедура ПолучитьДатуНачалаДеятельности(Дата, Организация) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПолучитьДатуНачалаДеятельности(Дата, Организация);
...
Процедура ПолучитьДатуПостановкиНаУчетНалогоплательщика(Дата, Организация, КонецФинансовогоПериода) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПолучитьДатуПостановкиНаУчетНалогоплательщика(Дата, Организация, КонецФинансовогоПериода);
...
Процедура ПриОпределенииИмениФормыНалогиОтчеты(ИмяФормы) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриОпределенииИмениФормыНалогиОтчеты(ИмяФормы);
...
Процедура КалендарьОтчетностиПриСозданииНаСервере(Форма, Параметры, Отказ, СтандартнаяОбработка) Экспорт
	...
	ЗарплатаКадрыВнутренний.КалендарьОтчетностиПриСозданииНаСервере(Форма, Параметры, Отказ, СтандартнаяОбработка);
...
Процедура ПриОпределенииСтатусовЗадачПоДокументамСЭДО(ТаблицаЗадач, ЗадачиСоСтатусами, Запрос) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриОпределенииСтатусовЗадачПоДокументамСЭДО(ТаблицаЗадач, ЗадачиСоСтатусами, Запрос);
...
Процедура ОпределитьЭтоДокументСЗВ_ТД(ЭтоДокументСЗВ_ТД, Документ) Экспорт
	...
	ЗарплатаКадрыВнутренний.ОпределитьЭтоДокументСЗВ_ТД(ЭтоДокументСЗВ_ТД, Документ);
...
Процедура ЗаполнитьДанныеПлатежей(ДанныеПлатежей, Параметры) Экспорт
	...
	ЗарплатаКадрыВнутренний.ЗаполнитьДанныеПлатежей(ДанныеПлатежей, Параметры);
...
Процедура ПриОпределенииСпискаТиповПравила(СписокТипов) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриОпределенииСпискаТиповПравила(СписокТипов);
...
Процедура ПриУстановкеТекстаЗапросаДанныеПриложения(ТекстЗапроса) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриУстановкеТекстаЗапросаДанныеПриложения(ТекстЗапроса);
...
Процедура ПриЗаполненииНаименованияОрганизацииОблачногоПриложения(Организация, Наименование) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриЗаполненииНаименованияОрганизацииОблачногоПриложения(Организация, Наименование);
...
Процедура УстановитьПараметрыВыводаКалендаряОтчетности(ПараметрыВывода) Экспорт
	...
	ЗарплатаКадрыВнутренний.УстановитьПараметрыВыводаКалендаряОтчетности(ПараметрыВывода);
...
Процедура ЗаполнитьРасписаниеДокументыСЭДО(Запрос, Расписание) Экспорт
	...
	ЗарплатаКадрыВнутренний.ЗаполнитьРасписаниеДокументыСЭДО(Запрос, Расписание);
...
Процедура ЗаполнитьЗаписьРасписанияДокументСЭДО(Запрос, Расписание) Экспорт
	...
	ЗарплатаКадрыВнутренний.ЗаполнитьЗаписьРасписанияДокументСЭДО(Запрос, Расписание);
...
Процедура ПриОпределенииЗапросаИзменений(Запрос) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриОпределенииЗапросаИзменений(Запрос);
...
Процедура ВТЗадачиПоКадровымМероприятиям(Запрос, ИмяТаблицы) Экспорт
	...
	ЗарплатаКадрыВнутренний.ВТЗадачиПоКадровымМероприятиям(Запрос, ИмяТаблицы);
...
Процедура ПриИзмененииРучногоСтатуса(Ссылка, Статус) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриИзмененииРучногоСтатуса(Ссылка, Статус);
...
Процедура ПриПолученииДоступныхОрганизацийПользователя(Организации) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриПолученииДоступныхОрганизацийПользователя(Организации);
...
Процедура ПриПодготовкеОтветаДанныеОтчетности(Ответ, Отбор) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриПодготовкеОтветаДанныеОтчетности(Ответ, Отбор);
...
Процедура ИзменитьРучнойСтатус(Ссылка, Статус) Экспорт
	...
	ЗарплатаКадрыВнутренний.ИзменитьРучнойСтатус(Ссылка, Статус);
...
Процедура ПриОпределенииОписанияДополнительныхОбработчиковПОД(МассивОбработчиков) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриОпределенииОписанияДополнительныхОбработчиковПОД(МассивОбработчиков);
...
Процедура ИзменитьСтатусЗаявкиНаПолучениеОбразовательногоСертификата(Параметры) Экспорт
	...
	ЗарплатаКадрыВнутренний.ИзменитьСтатусЗаявкиНаПолучениеОбразовательногоСертификата(Параметры);
...
// Возвращает соответствие с ФИО физических лиц на дату.
//
// Параметры:
//	ДатаАктуальности - Дата - дата, на которую определяется ФИО.
...
//	 * Значение - Строка - ФИО
//
Функция СоответствиеФИОФизЛицСсылкам(ДатаАктуальности, ФизическиеЛица) Экспорт 
	...
	КадровыйУчет.СоздатьНаДатуВТКадровыеДанныеФизическихЛиц(Запрос.МенеджерВременныхТаблиц, Истина, ФизическиеЛица,
		МассивНеобходимыхПолей, ДатаАктуальности);
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ПодборПерсонала") Тогда
		...
		МодульПодборПерсонала.ДополнитьСоответствиеФИОФизическихЛиц(СоответствиеФИОФизЛицСсылкам, ДатаАктуальности,
			ФизическиеЛица);
	КонецЕсли;
...
Функция СведенияОбОрганизации(Знач Организация, Знач ИменаПолей, Знач ДатаПолучения = Неопределено) Экспорт
	...
	Если Результат.Свойство("ЭтоЮридическоеЛицо") И ТипЗнч(Результат.ЭтоЮридическоеЛицо) <> Тип("Булево") Тогда
	...
	Если Результат.Свойство("НомерСтрахователяФСС") И Результат.НомерСтрахователяФСС = Неопределено Тогда
		...
		КонецЕсли;
	КонецЕсли;
	Если Результат.Свойство("ГоловнаяОрганизация") И ТипЗнч(Результат.ГоловнаяОрганизация) <> Тип("СправочникСсылка.Организации") Тогда
...
Процедура ПриСозданииФормыЭлементаФайлов(Форма) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриСозданииФормыЭлементаФайлов(Форма);
...
Процедура ДобавитьПользовательскийОтборПоОрганизацииВДинамическийСписок(Форма, ПользовательскиеНастройки, ФиксированныеОтборы)
	...
	Если Форма.Параметры.Свойство("ДополнительныеПараметры") И
		Форма.Параметры.ДополнительныеПараметры.Свойство("ИспользоватьНесколькоОрганизаций") Тогда
		ИспользоватьНесколькоОрганизаций = Форма.Параметры.ДополнительныеПараметры.ИспользоватьНесколькоОрганизаций;
	КонецЕсли;
...
// Возвращает структуру для заполнения данных ФИО.
// 
// Возвращаемое значение:
//  Структура:
//   * ФамилияИО - Строка 
...
//   * Имя - Строка 
//   * Отчество - Строка 
Функция НовоеОписаниеФИО() Экспорт
	
	ОписаниеФИО = Новый Структура;
	ОписаниеФИО.Вставить("ФамилияИО", "");
	ОписаниеФИО.Вставить("Фамилия", "");
	ОписаниеФИО.Вставить("Имя", "");
	ОписаниеФИО.Вставить("Отчество", "");
...
Процедура ОбработатьЗаписьНабораФИО(НаборЗаписей, Замещение) Экспорт
