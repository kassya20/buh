...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("УстановкаПараметровСеанса", Истина);
	Методы.Вставить("ПодготовитьСертификатСПараметрами", Истина);
КонецПроцедуры
...
Функция ВыполнитьВФоне(ИмяПроцедуры, ПараметрыПроцедуры) Экспорт
	...
	Если ИмяПроцедуры = "ДокументооборотСКООблачнаяПодписьВызовСервера.ПодготовитьСертификатСПараметрами" Тогда
		Возврат ДлительныеОперации.ВыполнитьВФоне(
			"ДокументооборотСКООблачнаяПодписьВызовСервера.ПодготовитьСертификатСПараметрами",
			ПараметрыПроцедуры,
			ПараметрыВыполнения);
		
	Иначе
		ТекстОшибки = СтрШаблон(
			НСтр("ru = 'Фоновый вызов процедуры облачной подписи ""%1"" не реализован.'"),
			ИмяПроцедуры);
