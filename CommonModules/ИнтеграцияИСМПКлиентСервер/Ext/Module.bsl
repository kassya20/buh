...
Функция ШаблоныГрупповыхУпаковок() Экспорт
	...
	Если ОбщегоНазначенияИСМПКлиентСервер.МоторныеМаслаИспользуетГрупповуюУпаковку() Тогда
		...
		КонецЕсли;
	КонецЕсли;
	Если ОбщегоНазначенияИСМПКлиентСервер.АвтозапчастиИКомплектующиеТранспортныхСредствИспользуетГрупповуюУпаковку() Тогда
		Если ОбщегоНазначенияИСМПКлиентСервер.АвтозапчастиИКомплектующиеТранспортныхСредствИспользуетУкороченныйКМ() Тогда
			Результат.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.АвтозапчастиИКомплектующиеТранспортныхСредствГрупповаяУпаковка"));
		КонецЕсли;
		Если ОбщегоНазначенияИСМПКлиентСервер.АвтозапчастиИКомплектующиеТранспортныхСредствИспользуетСтандартныйКМ() Тогда
			Результат.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.АвтозапчастиИКомплектующиеТранспортныхСредствГрупповаяУпаковкаСтандартныйКМ"));
		КонецЕсли;
	КонецЕсли;
...
Функция ШаблоныИндивидуальныхУпаковокВСоставеГрупповых() Экспорт
	...
	Если ОбщегоНазначенияИСМПКлиентСервер.АвтозапчастиИКомплектующиеТранспортныхСредствИспользуетГрупповуюУпаковку() Тогда
		Если ОбщегоНазначенияИСМПКлиентСервер.АвтозапчастиИКомплектующиеТранспортныхСредствИспользуетУкороченныйКМ() Тогда
			Результат.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.АвтозапчастиИКомплектующиеТранспортныхСредств"));
		КонецЕсли;
		Если ОбщегоНазначенияИСМПКлиентСервер.АвтозапчастиИКомплектующиеТранспортныхСредствИспользуетСтандартныйКМ() Тогда
			Результат.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.АвтозапчастиИКомплектующиеТранспортныхСредствСтандартныйКМ"));
		КонецЕсли;
	КонецЕсли;
	Если ОбщегоНазначенияИСМПКлиентСервер.ПолимерныеТрубыИспользуетГрупповуюУпаковку() Тогда
		Если ОбщегоНазначенияИСМПКлиентСервер.ПолимерныеТрубыИспользуетУкороченныйКМ() Тогда
...
Функция ШаблоныНаборов() Экспорт
	...
	Результат.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.ТоварыИзНатуральногоМехаНабор"));
	...
	Если ОбщегоНазначенияИСМПКлиентСервер.МоторныеМаслаИспользуетНабор() Тогда
		...
		КонецЕсли;
	КонецЕсли;
	Если ОбщегоНазначенияИСМПКлиентСервер.АвтозапчастиИКомплектующиеТранспортныхСредствИспользуетНабор() Тогда
		Если ОбщегоНазначенияИСМПКлиентСервер.АвтозапчастиИКомплектующиеТранспортныхСредствИспользуетУкороченныйКМ() Тогда
			Результат.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.АвтозапчастиИКомплектующиеТранспортныхСредствНабор"));
		КонецЕсли;
		Если ОбщегоНазначенияИСМПКлиентСервер.АвтозапчастиИКомплектующиеТранспортныхСредствИспользуетСтандартныйКМ() Тогда
			Результат.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.АвтозапчастиИКомплектующиеТранспортныхСредствНаборСтандартныйКМ"));
		КонецЕсли;
	КонецЕсли;
...
Функция ШаблоныКомплектующихНаборов() Экспорт
	...
	Результат.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.Морепродукты"));
	Результат.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.МорепродуктыСтандартныйКМ"));
	Результат.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.ТоварыИзНатуральногоМеха"));
...
Функция ШаблоныКодовПоВидуПродукции(ВидПродукции, РежимВключенияУпаковокИНаборов = 1) Экспорт
	...
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ЛегкаяПромышленность")
		...
		Или ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ЛегкаяПромышленность2026") Тогда
		Если ВключатьИндивидуальныеУпаковки Тогда
	...
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ТелефоныИНоутбуки") Тогда
		...
		Если ВключатьНаборы Тогда
			...
			СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.ТелефоныИНоутбукиНаборСтандартныйКМ"));
		КонецЕсли;
	...
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.АвтозапчастиИКомплектующиеТранспортныхСредств") Тогда
		Если ВключатьИндивидуальныеУпаковки Тогда
			Если ОбщегоНазначенияИСМПКлиентСервер.АвтозапчастиИКомплектующиеТранспортныхСредствИспользуетУкороченныйКМ() Тогда
				СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.АвтозапчастиИКомплектующиеТранспортныхСредств"));
			КонецЕсли;
			Если ОбщегоНазначенияИСМПКлиентСервер.АвтозапчастиИКомплектующиеТранспортныхСредствИспользуетСтандартныйКМ() Тогда
				СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.АвтозапчастиИКомплектующиеТранспортныхСредствСтандартныйКМ"));
			КонецЕсли;
		КонецЕсли;
		Если ВключатьГрупповыеУпаковки
			И ОбщегоНазначенияИСМПКлиентСервер.АвтозапчастиИКомплектующиеТранспортныхСредствИспользуетГрупповуюУпаковку() Тогда
			Если ОбщегоНазначенияИСМПКлиентСервер.АвтозапчастиИКомплектующиеТранспортныхСредствИспользуетУкороченныйКМ() Тогда
				СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.АвтозапчастиИКомплектующиеТранспортныхСредствГрупповаяУпаковка"));
			КонецЕсли;
			Если ОбщегоНазначенияИСМПКлиентСервер.АвтозапчастиИКомплектующиеТранспортныхСредствИспользуетСтандартныйКМ() Тогда
				СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.АвтозапчастиИКомплектующиеТранспортныхСредствГрупповаяУпаковкаСтандартныйКМ"));
			КонецЕсли;
		КонецЕсли;
		Если ВключатьНаборы
			И ОбщегоНазначенияИСМПКлиентСервер.АвтозапчастиИКомплектующиеТранспортныхСредствИспользуетНабор() Тогда
			Если ОбщегоНазначенияИСМПКлиентСервер.АвтозапчастиИКомплектующиеТранспортныхСредствИспользуетУкороченныйКМ() Тогда
				СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.АвтозапчастиИКомплектующиеТранспортныхСредствНабор"));
			КонецЕсли;
			Если ОбщегоНазначенияИСМПКлиентСервер.АвтозапчастиИКомплектующиеТранспортныхСредствИспользуетСтандартныйКМ() Тогда
				СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.АвтозапчастиИКомплектующиеТранспортныхСредствНаборСтандартныйКМ"));
			КонецЕсли;
		КонецЕсли;
	...
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.СладостиИКондитерскиеИзделия") Тогда
		...
		Если ВключатьНаборы
			...
			КонецЕсли;
		КонецЕсли;
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ТоварыИзНатуральногоМеха") Тогда
		Если ВключатьИндивидуальныеУпаковки Тогда
			СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.ТоварыИзНатуральногоМеха"));
		КонецЕсли;
		Если ВключатьНаборы Тогда
			СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.ТоварыИзНатуральногоМехаНабор"));
		КонецЕсли;
	КонецЕсли;
...
Функция ЭтоВидПродукцииСоСрокамиГодностиБезОбязательногоЗаполнения(ВидПродукции) Экспорт
	...
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.АвтозапчастиИКомплектующиеТранспортныхСредств") Тогда
		Возврат АвтозапчастиИКомплектующиеТранспортныхСредствИспользуетСрокГодностиБезОбязательногоЗаполнения();
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ПолимерныеТрубы") Тогда
	...
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ТоварыИзНатуральногоМеха") Тогда
		Возврат ТоварыИзНатуральногоМехаИспользуетСрокГодностиБезОбязательногоЗаполнения();
	КонецЕсли;
...
Функция ДляВидаПродукцииИспользуетсяДатаПроизводства(ВидПродукции) Экспорт
	...
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.АвтозапчастиИКомплектующиеТранспортныхСредств") Тогда
		Возврат АвтозапчастиИКомплектующиеТранспортныхСредствИспользуетДатуПроизводства();
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ПолимерныеТрубы") Тогда
		Возврат ПолимерныеТрубыИспользуетДатуПроизводства();
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.СладостиИКондитерскиеИзделия") Тогда
		Возврат СладостиИКондитерскиеИзделияИспользуетДатуПроизводства();
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ТоварыИзНатуральногоМеха") Тогда
		Возврат ТоварыИзНатуральногоМехаИспользуетДатуПроизводства();
	КонецЕсли;
...
Функция ОперацииСписанияКодовМаркировки() Экспорт
	...
	Результат = Новый Массив;
	Результат.Добавить(ПредопределенноеЗначение("Перечисление.ВидыОперацийИСМП.СписаниеКодовВыбывшихДоОбязательностиМаркировки"));
	...
	Результат.Добавить(ПредопределенноеЗначение("Перечисление.ВидыОперацийИСМП.СписаниеЭмитированныхКодовМаркировкиПриПоступлении"));
...
Процедура УстановитьКартинкуСканированияКодаПоВидуПродукции(ЭлементФормыКартинка, ВидМаркируемойПродукции) Экспорт
	...
	ИначеЕсли ВидМаркируемойПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ПродукцияИзНатуральногоМеха")
		Или ВидМаркируемойПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ТоварыИзНатуральногоМеха") Тогда
	...
	ИначеЕсли ВидМаркируемойПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.СоковаяПродукция")
		Или ВидМаркируемойПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.БезалкогольныеНапитки")
		Или ВидМаркируемойПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.НапиткиССодержаниемМолокаКакаоПрочие") Тогда
	...
	ИначеЕсли ВидМаркируемойПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.Бакалея")
		Или ВидМаркируемойПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.РастворимыеЗавариваемыеНапитки") Тогда
	...
	ИначеЕсли ВидМаркируемойПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.АвтозапчастиИКомплектующиеТранспортныхСредств") Тогда
		КартинкаСканированияКода = БиблиотекаКартинок.СканированиеКодаМаркировкиМоторныхМаселИСМП;
	...
	ИначеЕсли ВидМаркируемойПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.БАДы2025") Тогда
		КартинкаСканированияКода = БиблиотекаКартинок.СканированиеКодаМаркировкиБАДовИСМП;
	ИначеЕсли ВидМаркируемойПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.СпортивноеПитание") Тогда
		КартинкаСканированияКода = БиблиотекаКартинок.СканированиеКодаМаркировкиБАДовИСМП;
	ИначеЕсли ВидМаркируемойПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ТоварыЛичнойГигиены") Тогда
		КартинкаСканированияКода = БиблиотекаКартинок.СканированиеКодаМаркировкиПарфюмерияИБытоваяХимияИСМП;
	ИначеЕсли ВидМаркируемойПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.БритвыИЛезвия") Тогда
		КартинкаСканированияКода = БиблиотекаКартинок.СканированиеКодаМаркировкиПарфюмерияИБытоваяХимияИСМП;
	Иначе
...
Функция ПредставленияШаблоновКодаМаркировки() Экспорт
	...
	ПродукцияИспользуетСтандартныйКМ     = ОбщегоНазначенияИСМПКлиентСервер.АвтозапчастиИКомплектующиеТранспортныхСредствИспользуетСтандартныйКМ();
	ПродукцияИспользуетУкороченныйКМ     = ОбщегоНазначенияИСМПКлиентСервер.АвтозапчастиИКомплектующиеТранспортныхСредствИспользуетУкороченныйКМ();
	ПродукцияИспользуетГрупповуюУпаковку = ОбщегоНазначенияИСМПКлиентСервер.АвтозапчастиИКомплектующиеТранспортныхСредствИспользуетГрупповуюУпаковку();
	ПродукцияИспользуетНабор             = ОбщегоНазначенияИСМПКлиентСервер.АвтозапчастиИКомплектующиеТранспортныхСредствИспользуетНабор();
	Если ПродукцияИспользуетСтандартныйКМ И ПродукцияИспользуетУкороченныйКМ Тогда
		СписокВидовПродукции.Добавить(
			ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.АвтозапчастиИКомплектующиеТранспортныхСредств"),
			НСтр("ru = 'Единица товара (Укороченный КМ)'"));
		СписокВидовПродукции.Добавить(
			ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.АвтозапчастиИКомплектующиеТранспортныхСредствСтандартныйКМ"),
			НСтр("ru = 'Единица товара (Стандартный КМ)'"));
		Если ПродукцияИспользуетГрупповуюУпаковку Тогда
			СписокВидовПродукции.Добавить(
				ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.АвтозапчастиИКомплектующиеТранспортныхСредствГрупповаяУпаковка"),
				НСтр("ru = 'Групповая упаковка (Укороченный КМ)'"));
			СписокВидовПродукции.Добавить(
				ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.АвтозапчастиИКомплектующиеТранспортныхСредствГрупповаяУпаковкаСтандартныйКМ"),
				НСтр("ru = 'Групповая упаковка (Стандартный КМ)'"));
		КонецЕсли;
		Если ПродукцияИспользуетНабор Тогда
			СписокВидовПродукции.Добавить(
				ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.АвтозапчастиИКомплектующиеТранспортныхСредствНабор"),
				НСтр("ru = 'Набор (Укороченный КМ)'"));
			СписокВидовПродукции.Добавить(
				ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.АвтозапчастиИКомплектующиеТранспортныхСредствНаборСтандартныйКМ"),
				НСтр("ru = 'Набор (Стандартный КМ)'"));
		КонецЕсли;
	ИначеЕсли ПродукцияИспользуетСтандартныйКМ Тогда
		СписокВидовПродукции.Добавить(
	...
	СписокВидовПродукции.Добавить(
		ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.ТоварыИзНатуральногоМеха"),
		НСтр("ru = 'Единица товара'"));
	СписокВидовПродукции.Добавить(
		ПредопределенноеЗначение("Перечисление.ШаблоныКодовМаркировкиСУЗ.ТоварыИзНатуральногоМехаНабор"),
		НСтр("ru = 'Набор'"));
...
Функция ИспользуетсяТипОплатыКодовМаркировки(ВидПродукции, Организация = Неопределено) Экспорт
	...
	Возврат ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.УпакованнаяВода")
		Или ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.СоковаяПродукция")
		Или ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.БезалкогольныеНапитки")
		Или ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.НапиткиССодержаниемМолокаКакаоПрочие")
		Или ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.Пиво")
		...
		Или ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.СтроительныеМатериалы")
		Или ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ТоварыИзНатуральногоМеха");
	
КонецФункции

Функция ИспользуетсяВладелецGTINВЗаказеНаЭмиссию(СпособВводаВОборот) Экспорт
	...
	Возврат СпособВводаВОборот = ПредопределенноеЗначение("Перечисление.СпособыВводаВОборотСУЗ.Перемаркировка")
		...
		Или СпособВводаВОборот = ПредопределенноеЗначение("Перечисление.СпособыВводаВОборотСУЗ.МаркировкаВнеПроизводстваИмпорта");
...
Функция ПредставлениеПервичногоДокумента(Реквизиты) Экспорт
	...
	ИначеЕсли Реквизиты.ВидПервичногоДокумента = ПредопределенноеЗначение("Перечисление.ВидыПервичныхДокументовИСМП.ЭлектронныйСертификат") Тогда
		ЧастиИмени.Добавить(НСтр("ru = 'Электронный сертификат'"));
	ИначеЕсли Реквизиты.ВидПервичногоДокумента = ПредопределенноеЗначение("Перечисление.ВидыПервичныхДокументовИСМП.АктПротезноОртопедическогоИзделия") Тогда
		ЧастиИмени.Добавить(НСтр("ru = 'Акт протезно-ортопедического изделия'"));
...
Функция ОбязательноеУказаниеСодержанияЭтиловогоСпиртаДляВидаПродукцииВОтчетеОНанесении(ВидПродукции) Экспорт
...
Функция АвтозапчастиИКомплектующиеТранспортныхСредствИспользуетСрокГодностиБезОбязательногоЗаполнения()
	Возврат Ложь;
КонецФункции
...
Функция ТоварыИзНатуральногоМехаИспользуетСрокГодностиБезОбязательногоЗаполнения()
	Возврат Ложь;
КонецФункции
...
Функция АвтозапчастиИКомплектующиеТранспортныхСредствИспользуетДатуПроизводства()
	Возврат Истина;
КонецФункции
...
Функция ТоварыИзНатуральногоМехаИспользуетДатуПроизводства()
	Возврат Истина;
КонецФункции
