...
Процедура ПослеЗагрузкиКонтрактаИзЕИС(СсылкаНаКонтракт) Экспорт
	...
	ЭлектронноеАктированиеБП.ПослеЗагрузкиКонтрактаИзЕИС(СсылкаНаКонтракт);
...
Процедура ПередЗаписьюНаСервереГосударственногоКонтракта(
	...
	ЭлектронноеАктированиеБП.ПередЗаписьюНаСервереГосударственногоКонтракта(ЭтотОбъект, Отказ, ТекущийОбъект, ПараметрыЗаписи);
...
Процедура ЗаполнитьСвязиПараметровВыбораИПараметрыВыбораДоговора(СвязиПараметровВыбора,
	...
	ЭлектронноеАктированиеБП.ЗаполнитьСвязиПараметровВыбораИПараметрыВыбораДоговора(
...
Процедура ДляДокументаЗаполняютсяМестаПоставки(Документ, МестаПоставкиЗаполняются) Экспорт
	...
	ЭлектронноеАктированиеБП.ДляДокументаЗаполняютсяМестаПоставки(Документ, МестаПоставкиЗаполняются);
...
Процедура РазрешаетсяИспользоватьЭлектронноеАктированиеДляПоставщиков(ИспользованиеРазрешено) Экспорт
	...
	ИспользованиеРазрешено = ПолучитьФункциональнуюОпцию("РасширенныйФункционал");
...
Процедура ЗаполнитьТабличнуюЧастьДокументаПоДаннымДереваТоваровУслуг(
	...
	РезультатЗаполнения = ЭлектронноеАктированиеБП.
		ЗаполнитьТабличнуюЧастьДокументаПоДаннымДереваТоваровУслуг(
			СсылкаНаДокумент, ДеревоТоваров, ДеревоРаботУслуг);
...
Процедура СоздатьЭлементФормыПараметровЭлектронногоАктированияДокумента(Форма, Элемент) Экспорт
	...
	ЭлектронноеАктированиеБП.СоздатьЭлементФормыПараметровЭлектронногоАктированияДокумента(Форма, Элемент);
...
Процедура КнопкиЗаполненияТабличныхЧастейДокументов(Форма, Кнопки) Экспорт
	...
	ЭлектронноеАктированиеБП.КнопкиЗаполненияТабличныхЧастейДокументов(Форма, Кнопки);
...
Процедура ВерсияПриложения(Версия) Экспорт
	...
	Версия = ЭлектронноеАктированиеБП.Версия();
...
Процедура ОпределитьВладельцаПрисоединенныхФайлов(Знач ОбъектыУчетаЭД, Владелец) Экспорт
	...
	Владелец = ЭлектронноеАктированиеБП.ВладелецПрисоединенныхФайлов(ОбъектыУчетаЭД);
...
Процедура СтавкаНДСДляПриложенияЕИС(Знач СтавкаНДС, СтавкаНДСПриложения) Экспорт
	...
	СтавкаНДСПриложения = ЭлектронноеАктированиеБП.СтавкаНДСДляПриложенияЕИС(СтавкаНДС);
...
Процедура НайтиСоздатьКонтрагентаПоСведениямОЗаказчике(ДанныеКонтрагента, Контрагент) Экспорт
	...
	Контрагент = ЭлектронноеАктированиеБП.НайтиСоздатьКонтрагентаПоСведениямОЗаказчике(ДанныеКонтрагента);
...
Процедура ГосударственныйКонтрактДокумента(Документ, ГосударственныйКонтракт) Экспорт
	...
	ГосударственныйКонтракт = ЭлектронноеАктированиеБП.ГосударственныйКонтрактДокумента(Документ);
...
Процедура ДоговорКонтрагентаИсточникаКоманды(ИсточникКоманды, ДоговорКонтрагента) Экспорт
	...
	ДоговорКонтрагента = ИсточникКоманды.ДоговорКонтрагента;
...
Процедура СтавкаНДСОбъектаЗакупки(Знач СтавкаНДСОбъектаЗакупки, СтавкаНДС) Экспорт
	...
	СтавкаНДС = ЭлектронноеАктированиеБП.СтавкаНДСОбъектаЗакупки(СтавкаНДСОбъектаЗакупки);
...
Процедура СоздатьДоговорНаОснованииКонтракта(СсылкаНаКонтракт, РезультатСоздания) Экспорт
	...
	ЭлектронноеАктированиеБП.СоздатьДоговорНаОснованииКонтракта(СсылкаНаКонтракт, РезультатСоздания);
