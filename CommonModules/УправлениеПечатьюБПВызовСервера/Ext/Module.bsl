...
Функция ЭлектроннаяНакладнаяБольшеНеСпрашивать() Экспорт

	Возврат ХранилищеОбщихНастроек.Загрузить("ЭлектроннаяТранспортнаяНакладная", "БольшеНеСпрашивать") = ИСТИНА;
