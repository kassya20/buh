...
//
Функция ДоступнаРаботаСКодамиМаркировкиПродукцииПеремещенияМеждуМОД(Отказ = Неопределено) Экспорт
	...
	Если Не (Отказ = Неопределено) Тогда
		ОбщегоНазначения.СообщитьПользователю(
			НСтр("ru = 'Для работы с документом перемещения между МОД требуется включить использование хотя бы вида продукции, подлежащего контролю перемещений между МОД
...
Процедура ЗаполнитьДоступныеВидыДокументовСертификации(Элемент, ВидПродукции) Экспорт
	...
	Если ВидПродукции <> Перечисления.ВидыПродукцииИС.БАДы
		...
		И ВидПродукции <> Перечисления.ВидыПродукцииИС.СпортивноеПитание
		...
		ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.АвтозапчастиИКомплектующиеТранспортныхСредств Тогда
			Если АвтозапчастиИКомплектующиеТранспортныхСредствДоступенСертификатСоответствия() Тогда
				Элемент.СписокВыбора.Добавить(Перечисления.ВидыДокументовОбязательнойСертификацииИС.СертификатСоответствия);
			КонецЕсли;
		...
		ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.СладостиИКондитерскиеИзделия Тогда
			Если СладостиИКондитерскиеИзделияДоступенСертификатСоответствия() Тогда
				Элемент.СписокВыбора.Добавить(Перечисления.ВидыДокументовОбязательнойСертификацииИС.СертификатСоответствия);
			КонецЕсли;
		ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.ТоварыИзНатуральногоМеха Тогда
			Если ТоварыИзНатуральногоМехаДоступенСертификатСоответствия() Тогда
				Элемент.СписокВыбора.Добавить(Перечисления.ВидыДокументовОбязательнойСертификацииИС.СертификатСоответствия);
			КонецЕсли;
		Иначе
			Элемент.СписокВыбора.Добавить(Перечисления.ВидыДокументовОбязательнойСертификацииИС.СертификатСоответствия);
	...
	Если ВидПродукции <> Перечисления.ВидыПродукцииИС.БАДы
		И ВидПродукции <> Перечисления.ВидыПродукцииИС.БАДы2025
		И ВидПродукции <> Перечисления.ВидыПродукцииИС.СпортивноеПитание Тогда
		Если ВидПродукции = Перечисления.ВидыПродукцииИС.КормаДляЖивотныхПодконтрольныеВЕТИС
			Или ВидПродукции = Перечисления.ВидыПродукцииИС.КормаДляЖивотныхВлажныеПодконтрольныеВЕТИС Тогда
		...
		ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.МоторныеМасла Тогда
			...
			КонецЕсли;
		ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.АвтозапчастиИКомплектующиеТранспортныхСредств Тогда
			Если АвтозапчастиИКомплектующиеТранспортныхСредствДоступнаДекларацияСоответствия() Тогда
				Элемент.СписокВыбора.Добавить(Перечисления.ВидыДокументовОбязательнойСертификацииИС.ДекларацияСоответствия);
			КонецЕсли;
		ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.ПолимерныеТрубы Тогда
		...
		ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.СладостиИКондитерскиеИзделия Тогда
			...
			КонецЕсли;
		ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.ТоварыИзНатуральногоМеха Тогда
			Если ТоварыИзНатуральногоМехаДоступнаДекларацияСоответствия() Тогда
				Элемент.СписокВыбора.Добавить(Перечисления.ВидыДокументовОбязательнойСертификацииИС.ДекларацияСоответствия);
			КонецЕсли;
		Иначе
			Элемент.СписокВыбора.Добавить(Перечисления.ВидыДокументовОбязательнойСертификацииИС.ДекларацияСоответствия);
	...
	Если ВидПродукции = Перечисления.ВидыПродукцииИС.ВетеринарныеПрепараты Тогда
...
Функция АвтозапчастиИКомплектующиеТранспортныхСредствДоступенСертификатСоответствия()
...
Функция ТоварыИзНатуральногоМехаДоступенСертификатСоответствия()
...
Функция АвтозапчастиИКомплектующиеТранспортныхСредствДоступнаДекларацияСоответствия()
...
Функция ТоварыИзНатуральногоМехаДоступнаДекларацияСоответствия()
