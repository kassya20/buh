...
Процедура ДоговорКонтрагентаСоздание(Форма, Элемент, СтандартнаяОбработка) Экспорт
	
	Объект = Форма.Объект;
	ТекущиеДанные = ОплатаПлатежнойКартойКлиентСервер.РасшифровкаПлатежаТекущиеДанные(Форма);
...
Процедура ДоговорКонтрагентаОбработкаВыбора(Форма, Элемент, ВыбранноеЗначение, СтандартнаяОбработка) Экспорт
...
Процедура ДоговорКонтрагентаАвтоПодбор(Форма, Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка) Экспорт
...
Процедура ДоговорКонтрагентаОкончаниеВводаТекста(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, СтандартнаяОбработка) Экспорт
...
Процедура КурсВзаиморасчетовПриИзменении(Форма, Элемент) Экспорт
	...
	Если ОплатаПлатежнойКартойКлиентСервер.ФормаДокументаОднострочная(Форма) Тогда
		ОплатаПлатежнойКартойКлиентСервер.ЗаполнитьРеквизитыРасшифровкаПлатежа(Форма, Ложь);
...
Процедура СделкаНачалоВыбора(Форма, Элемент, ДанныеВыбора, СтандартнаяОбработка) Экспорт
	...
	ПараметрыОбъекта.Вставить("ТипыДокументов",
		ОплатаПлатежнойКартойВызовСервера.ОписаниеТипаРеквизитаСделка());
...
Процедура ПоказатьЧекНПД(Форма) Экспорт
...
#Область СертификатыНСПК

Процедура ПередатьДанныеФискальногоЧекаНСПК(ДокументСсылка) Экспорт

	ПараметрыОплатыЭС = ОплатаПлатежнойКартойВызовСервера.ПараметрыОплатыЭС(ДокументСсылка);
	...
	Если ПараметрыОплатыЭС.ОплатаСертификатНСПК > 0 Тогда 
		...
		ПечатьФискальныхДокументовКлиент.НачатьПередачуДанныхФискальногоЧека(
			ДокументСсылка, ПараметрыОплатыЭС.ИдентификаторУстройстваЭТ, 
