...
Процедура СотрудникиПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка) Экспорт
	...
	Форма.ИспользоватьКадровыйУчетПриВнешнейЗарплате = ПолучитьФункциональнуюОпцию("ИспользоватьКадровыйУчетПриВнешнейЗарплате");
	Форма.РасчетЗарплатыДляНебольшихОрганизаций      = ПолучитьФункциональнуюОпцию("РасчетЗарплатыДляНебольшихОрганизаций");
	Форма.ИспользоватьКадровуюИсторию                = УчетЗарплаты.ИспользоватьКадровуюИсторию();
	...
	Если СозданиеНового Тогда 
		...
		Если Форма.ИспользоватьКадровуюИсторию Тогда
	...
	Если Форма.ИспользоватьКадровуюИсторию И ЗначениеЗаполнено(Форма.Сотрудник.ГоловнаяОрганизация) Тогда
...
Процедура СотрудникиОбновитьЭлементыФормы(Форма) Экспорт
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		...
		"ТекущаяОрганизация",
		"ТолькоПросмотр",
		Форма.ИспользоватьКадровуюИсторию);
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		...
		"ТолькоПросмотр",
		ЭтоПодработка
			Или Форма.ИспользоватьКадровуюИсторию
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		...
		"ТекущаяОрганизация",
		"Видимость",
		Не Форма.ИспользоватьКадровуюИсторию);
...
Функция ОписаниеМенюВводаНаОсновании(ПараметрыПостроения) Экспорт
	...
	Если Не ПолучитьФункциональнуюОпцию("ИспользоватьНачислениеЗарплаты")
		...
		// Зарплата откючена. Справочник наполняется "по необходимости".
		// Ввода на основании - нет.
	...
	ПунктыМеню.Добавить("Документы.РегистрацияОблагаемойБазыРуководителя");
