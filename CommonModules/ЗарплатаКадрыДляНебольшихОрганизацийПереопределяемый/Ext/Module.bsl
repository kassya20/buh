...
Процедура ПриИзмененииБанковскогоСчета(БанковскийСчет, РеквизитыСчета) Экспорт
	...
	РеквизитыСчета = Новый Структура("НомерСчета, БИК");
	
	Если ЗначениеЗаполнено(БанковскийСчет) Тогда
		Реквизиты = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(БанковскийСчет, "НомерСчета, Банк.Код");
		РеквизитыСчета.НомерСчета = Реквизиты.НомерСчета;
		РеквизитыСчета.БИК        = Реквизиты.БанкКод;
	КонецЕсли;
