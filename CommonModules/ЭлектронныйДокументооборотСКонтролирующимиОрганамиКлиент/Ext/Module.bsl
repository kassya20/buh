...
Процедура ОтправитьВКонтролирующийОрганНеИспользуется1СОтчетность(СсылкаНаОтчет, КонтролирующийОрган, Форма, ЭтоОтправкаИзФормыОтчетность) Экспорт
	...
	Если НЕ ЭтоОтправкаИзФормыОтчетность Тогда
		...
		Оповестить(РегламентированнаяОтчетностьКлиент.ИмяСобытияЗавершениеОтправки(), ПараметрыОповещения, СсылкаНаОтчет);
	Иначе
...
Процедура ОбновитьПанельСостоянияОтправкиЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	Оповестить(РегламентированнаяОтчетностьКлиент.ИмяСобытияЗавершениеОтправки(), ПараметрыОповещения, Ссылка);
...
#Область СтатусыИВажныеСообщения_85

Процедура ЗакрытьВажноеСообщение(Форма, ИмяКоманды) Экспорт
...
Процедура ОбработатьНажатиеКнопкиВВажномСообщении(Форма, ИмяКоманды, КонтролирующийОрган = "ФНС") Экспорт

КонецПроцедуры

Процедура ОбработатьНавигационнуюСсылкуВВажномСообщении(Форма, Элемент, НавигационнаяСсылка, СтандартнаяОбработка, КонтролирующийОрган = "ФНС") Экспорт

КонецПроцедуры  

Процедура ОбработатьНажатиеВФормеРасшифровкиСтатуса(Форма, Результат, КонтролирующийОрган = "ФНС") Экспорт
