...
//
// Параметры:
//	ПриемникЗначения - ОтборКомпоновкиДанных, УсловноеОформлениеКомпоновкиДанных, ПорядокКомпоновкиДанных - коллекция элементов КД, куда копируются параметры.
//	ИсточникЗначения - ОтборКомпоновкиДанных, УсловноеОформлениеКомпоновкиДанных, ПорядокКомпоновкиДанных - коллекция элементов КД, откуда копируются параметры.
