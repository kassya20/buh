...
Процедура ПриОпеределенииТаблицыПродукцииПринятойБезРасхождений(ДокументОснование, НоменклатураПоДаннымЭДО, ВидыМаркируемойПродукции, ТаблицаПродукции) Экспорт
	...
	ИнтеграцияИСМПБП.ПриОпеределенииТаблицыПродукцииПринятойБезРасхождений(ДокументОснование, НоменклатураПоДаннымЭДО, ВидыМаркируемойПродукции, ТаблицаПродукции);
...
Процедура ПриЗаполненииЗначенияШтрихкодовПродукцииПоДокументу(ДокументСсылка, ТаблицаТоваровЗначенийШтрихкодов) Экспорт
	...
	ИнтеграцияИСМПБП.ПриЗаполненииЗначенияШтрихкодовПродукцииПоДокументу(ДокументСсылка, ТаблицаТоваровЗначенийШтрихкодов);
...
Процедура ПриОпределенииПараметровИнтеграцииФормыСверкиПоКодамМаркировки(Форма, ПараметрыИнтеграции) Экспорт
	...
	Если ИнтеграцияИСБПКлиентСервер.ЭтоДокументПоНаименованию(Форма, "АктОРасхождениях") Тогда
	
		ПараметрыИнтеграции.ИмяРодительскойГруппыФормы                 = "ГруппаТовары";
		ПараметрыИнтеграции.ИмяСледующейКолонкиРасхождения             = "ГруппаТоварыЗаголовкиСтрок";
		...
		ПараметрыИнтеграции.ИмяТабличнойЧастиШтрихкодыУпаковокРасхождения   = "УпаковкиРасхождения";
	...
	ИначеЕсли ИнтеграцияИСБПКлиентСервер.ЭтоДокументПоНаименованию(Форма, "АктОРасхожденияхПолученный") Тогда
		ПараметрыИнтеграции.ИмяРодительскойГруппыФормы                 = "ГруппаТовары";
		ПараметрыИнтеграции.ИмяСледующейКолонкиРасхождения             = "ГруппаТоварыЗаголовкиСтрок";
...
Процедура ПриОпределенииВидовПродукцииДокумента(Знач ДокументСсылка, ВидыПродукции) Экспорт
	...
	Если ТипЗнч(ДокументСсылка) = Тип("ДокументСсылка.КорректировкаПоступления")
		...
		Запрос.УстановитьПараметр("ФильтрВидПродукции", ОбщегоНазначенияИСКлиентСервер.ВидыПродукцииИСМП(Истина));
		...
		|   И  ТоварыНакладной.Номенклатура.ВидМаркировки В (&ФильтрВидПродукции)";
...
Процедура ПриОпределенииМаркируемойПродукцииДокумента(Знач ДокументСсылка, ТаблицаМаркируемойПродукции) Экспорт
	...
	ИнтеграцияИСМПБП.ЗаполнитьМаркируемуюПродукциюДокумента(ДокументСсылка, ФильтрВидПродукции, ТаблицаМаркируемойПродукции);
...
Процедура ПриОпределенииНеобходимостиОбработкиКодовМаркировкиВДокументе(ДокументОбъект, ПараметрыИнтеграции, ТребуетсяОбработка) Экспорт
	...
	ИмяТабличнойЧастиШтрихкодыУпаковокРасхождения = ПараметрыИнтеграции.ИмяТабличнойЧастиШтрихкодыУпаковокРасхождения;
...
Процедура ОтразитьРезультатыСверкиВДокументе(ПараметрыОкончанияСверки) Экспорт
	Если ТипЗнч(ПараметрыОкончанияСверки.ПроверяемыйДокумент) = Тип("ДокументСсылка.АктОРасхожденияхПолученный") Тогда
		ИнтеграцияИСМПБП.ОтразитьРезультатыСверкиАктОРасхожденияхПолученный(ПараметрыОкончанияСверки);
	КонецЕсли; 
КонецПроцедуры
...
Процедура ПриОпределенииДокументОснованиеСверкиКодов(ДокументСсылка, ДокументОснование) Экспорт
	...
	ДокументОснование = ИнтеграцияИСМПБП.ОпределитьДокументОснованиеСверкиКодов(ДокументСсылка);
