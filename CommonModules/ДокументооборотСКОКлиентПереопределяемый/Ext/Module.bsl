...
Процедура ПерейтиКСверкеПоИмущественномуНалогу(Форма, Сообщение) Экспорт
	...
	СписокРасчетовИзСообщения = СверкаСФНСПоИмущественнымНалогамФормыВызовСервера.СписокРасчетовИзСообщения(
		Сообщение);
...
Процедура СформироватьВыгрузкуПлатежныхПоручений(Форма, МассивПлатежныхПоручений) Экспорт
	...
	УчетДенежныхСредствКлиент.СформироватьВыгрузкуПлатежныхПоручений(Форма, МассивПлатежныхПоручений);
...
Процедура ОткрытьПлатежноеПоручениеТребования(ПараметрыФормы, Открыта) Экспорт
	...
	ОткрытьФорму("Документ.ПлатежноеПоручение.Форма.ФормаДокументаНалоговая", ПараметрыФормы);
