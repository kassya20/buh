...
Процедура ЭкземплярОфлайнОборудованияПриСозданииНаСервере(Объект, ЭтаФорма, Отказ, Параметры, СтандартнаяОбработка) Экспорт
	МенеджерОборудованияБП.ЭкземплярОфлайнОборудованияПриСозданииНаСервере(Объект, ЭтаФорма, Отказ, Параметры, СтандартнаяОбработка);
КонецПроцедуры
...
Процедура ЭкземплярОфлайнОборудованияПриЧтенииНаСервере(ТекущийОбъект, ЭтаФорма) Экспорт
	МенеджерОборудованияБП.ЭкземплярОфлайнОборудованияПриЧтенииНаСервере(ТекущийОбъект, ЭтаФорма);
КонецПроцедуры
...
Процедура ЭкземплярОфлайнОборудованияПриЗаписиНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи) Экспорт
	МенеджерОборудованияБП.ЭкземплярОфлайнОборудованияПриЗаписиНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи);
КонецПроцедуры
...
Процедура ЭкземплярОфлайнОборудованияОбработкаПроверкиЗаполненияНаСервере(Объект, ЭтаФорма, Отказ, ПроверяемыеРеквизиты) Экспорт
	МенеджерОборудованияБП.ЭкземплярОфлайнОборудованияОбработкаПроверкиЗаполненияНаСервере(Объект, ЭтаФорма, Отказ, ПроверяемыеРеквизиты);
КонецПроцедуры
...
Процедура ОбработатьПереходСправочникаПодключаемоеОборудованиеНаОфлайнОборудование(СсылкаНаПодключаемоеОборудование, СсылкаНаОфлайнОборудование) Экспорт
	НаборЗаписейПодключаемоеОборудование = РегистрыСведений.КодыВидовОплатыКММ.СоздатьНаборЗаписей();
	НаборЗаписейПодключаемоеОборудование.Отбор.УдалитьОборудование.Установить(СсылкаНаПодключаемоеОборудование);
	
	ТаблицаНаборЗаписей = НаборЗаписейПодключаемоеОборудование.Выгрузить();
	
	ТаблицаНаборЗаписей.ЗаполнитьЗначения("УдалитьОборудование", Неопределено);
	ТаблицаНаборЗаписей.ЗаполнитьЗначения("ОфлайнОборудование", СсылкаНаОфлайнОборудование);
	
	НаборЗаписейОфлайнОборудование = РегистрыСведений.КодыВидовОплатыКММ.СоздатьНаборЗаписей();
	НаборЗаписейОфлайнОборудование.Отбор.ОфлайнОборудование.Установить(СсылкаНаОфлайнОборудование);
	НаборЗаписейОфлайнОборудование.Загрузить(ТаблицаНаборЗаписей);
	
	НаборЗаписейПодключаемоеОборудование.Очистить();
	
	ОбновлениеИнформационнойБазы.ЗаписатьНаборЗаписей(НаборЗаписейПодключаемоеОборудование);
	ОбновлениеИнформационнойБазы.ЗаписатьНаборЗаписей(НаборЗаписейОфлайнОборудование);
	
	// Записи регистра "Оборудование по организациям"
	
	НаборЗаписейПодключаемоеОборудование = РегистрыСведений.ОборудованиеПоОрганизациям.СоздатьНаборЗаписей();
	НаборЗаписейПодключаемоеОборудование.Отбор.УдалитьОборудование.Установить(СсылкаНаПодключаемоеОборудование);
	...
	НаборЗаписейОфлайнОборудование = РегистрыСведений.ОборудованиеПоОрганизациям.СоздатьНаборЗаписей();
	НаборЗаписейОфлайнОборудование.Отбор.ОфлайнОборудование.Установить(СсылкаНаОфлайнОборудование);
	НаборЗаписейОфлайнОборудование.Загрузить(ТаблицаНаборЗаписей);
