...
Процедура ПриОпределенииНастроекРегламентныхЗаданий(Настройки) Экспорт
	...
	Настройка = Настройки.Добавить();
	Настройка.РегламентноеЗадание = Метаданные.РегламентныеЗадания.АвтоматическоеЗакрытиеМесяца;
	Настройка.Параметризуется = Истина;
	
	Настройка = Настройки.Добавить();
	Настройка.РегламентноеЗадание = Метаданные.РегламентныеЗадания.АвтоматическаяЗагрузкаОтчетовМаркетплейсов;
	Настройка.Параметризуется = Истина;
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ИнтеграцияС1СДокументооборотом") Тогда
		...
		МодульИнтеграцияС1СДокументооборотБазоваяФункциональность.ПриОпределенииНастроекРегламентныхЗаданий(Настройки);
	КонецЕсли;
	...
	ИнтеграцияАУСН.ПриОпределенииНастроекРегламентныхЗаданий(Настройки);
	ИнтеграцияСтатусСамозанятогоБП.ПриОпределенииНастроекРегламентныхЗаданий(Настройки);
	
	ИнтеграцияПодсистемБПО.ПриОпределенииНастроекРегламентныхЗаданий(Настройки, Метаданные.ФункциональныеОпции.ИспользоватьФискальныйРегистратор);
	...
	// РекламныйСервис
	РекламныйСервис.ПриОпределенииНастроекРегламентныхЗаданий(Настройки);
