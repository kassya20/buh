...
Функция ПолучитьТекстОбщегоЗапроса(ИсточникДанных, ТолькоРазрешенные) Экспорт
	...
	Если ВРег(ИсточникДанных) = ВРег("НачисленияУдержания") Тогда
		...
		|	КадровыеДанныеГоловныхСотрудников.ТарифнаяСтавка КАК ТарифнаяСтавка,
...
Функция ПолучитьЗапросПоПредставлению(ТекстЗапроса, СоответствиеПараметров) Экспорт
	...
	ЗарплатаКадрыОбщиеНаборыДанныхПереопределяемый.ПриПолученииЗапросаПоПредставлению(
		Запрос, ТекстЗапроса, СоответствиеПараметров, СтандартнаяОбработка);
	Если Не СтандартнаяОбработка Тогда
		Возврат Запрос;
	КонецЕсли;
	
	СвойстваТаблицы = ЗарплатаКадрыОбщиеНаборыДанных.СвойстваПереопределяемойТаблицы(ТекстЗапроса);
	Если ВРег(СвойстваТаблицы.ИмяПредставления) = ВРег("Периоды") Тогда
		
		НачалоИнтервала = ЗарплатаКадрыОбщиеНаборыДанных.ПараметрЗапроса("НачалоИнтервала", СвойстваТаблицы.ПараметрыЗапроса);
		ОкончаниеИнтервала = ЗарплатаКадрыОбщиеНаборыДанных.ПараметрЗапроса("ОкончаниеИнтервала", СвойстваТаблицы.ПараметрыЗапроса);
		
		Периодичность = ЗарплатаКадрыОбщиеНаборыДанных.ПараметрЗапроса("Периодичность", СвойстваТаблицы.ПараметрыЗапроса);
		...
		ПредставлениеИспользоватьКонецПериода = ЗарплатаКадрыОбщиеНаборыДанных.ПараметрЗапроса("ИспользоватьКонецПериода", СвойстваТаблицы.ПараметрыЗапроса);
		Если Периодичность = Неопределено Тогда
		...
		Запрос = ЗарплатаКадрыОбщиеНаборыДанных.ЗапросВТПериоды(
			...
			Периодичность,
			ИмяПоляПериод,
			СвойстваТаблицы.ИмяИсточникаДанных,
			ИспользоватьКонецПериода);
		
	ИначеЕсли ВРег(СвойстваТаблицы.ИмяПредставления) = ВРег("ТаблицаРегистра")
		ИЛИ ВРег(СвойстваТаблицы.ИмяПредставления) = ВРег("СрезПоследних")
		ИЛИ ВРег(СвойстваТаблицы.ИмяПредставления) = ВРег("СрезПервых") Тогда
		
		ИмяРегистра = СвойстваТаблицы.ИмяПараметра;
		ИмяСоздаваемойТаблицы = СвойстваТаблицы.ИмяИсточникаДанных;
		
		ИмяВТФильтра = СвойстваТаблицы.ИменаВТИсточниковПараметров[0];
		...
		Если ВРег(СвойстваТаблицы.ИмяПредставления) = ВРег("ТаблицаРегистра") Тогда
			ПараметрыПостроения = ЗарплатаКадрыОбщиеНаборыДанных.ПараметрыПостроенияДляСоздатьВТИмяРегистра();
		Иначе
			ПараметрыПостроения = ЗарплатаКадрыОбщиеНаборыДанных.ПараметрыПостроенияДляСоздатьВТИмяРегистраСрез();
		КонецЕсли;
			
		ПараметрыПостроения.Отборы = ЗарплатаКадрыОбщиеНаборыДанных.КоллекцияОтборПоПараметрам(СвойстваТаблицы.ПараметрыЗапроса);
		
		ПсевдонимыПолейСКД = СокрЛП(Строка(ЗарплатаКадрыОбщиеНаборыДанных.ПараметрЗапроса("ПсевдонимыПолейСКД", СвойстваТаблицы.ПараметрыЗапроса)));
		...
		ПредставлениеФормироватьСПериодичностьДень = ЗарплатаКадрыОбщиеНаборыДанных.ПараметрЗапроса("ПараметрыПостроения_ФормироватьСПериодичностьДень", СвойстваТаблицы.ПараметрыЗапроса);
		...
		Если ВРег(СвойстваТаблицы.ИмяПредставления) = ВРег("ТаблицаРегистра") Тогда
			...
			ПредставлениеВключатьЗаписиНаНачалоПериода = ЗарплатаКадрыОбщиеНаборыДанных.ПараметрЗапроса("ПараметрыПостроения_ВключатьЗаписиНаНачалоПериода", СвойстваТаблицы.ПараметрыЗапроса);
			...
			Запрос = ЗарплатаКадрыОбщиеНаборыДанных.ЗапросВТИмяРегистра(ИмяРегистра, СвойстваТаблицы.ТолькоРазрешенные, ОписаниеФильтра, ПараметрыПостроения, ИмяСоздаваемойТаблицы);
			
		ИначеЕсли ВРег(СвойстваТаблицы.ИмяПредставления) = ВРег("СрезПоследних") Тогда
			Запрос = ЗарплатаКадрыОбщиеНаборыДанных.ЗапросВТИмяРегистраСрез(ИмяРегистра, СвойстваТаблицы.ТолькоРазрешенные, ОписаниеФильтра, ПараметрыПостроения, Истина, ИмяСоздаваемойТаблицы);
		Иначе
			Запрос = ЗарплатаКадрыОбщиеНаборыДанных.ЗапросВТИмяРегистраСрез(ИмяРегистра, СвойстваТаблицы.ТолькоРазрешенные, ОписаниеФильтра, ПараметрыПостроения, Ложь, ИмяСоздаваемойТаблицы);
		КонецЕсли;
		
	ИначеЕсли ВРег(СвойстваТаблицы.ИмяПредставления) = ВРег("КадровыеДанныеФизическихЛиц") Тогда
		
		Отбор = ЗарплатаКадрыОбщиеНаборыДанных.КоллекцияОтборПоПараметрам(СвойстваТаблицы.ПараметрыЗапроса);
		...
		ОписательТаблицыОтборов = КадровыйУчет.ОписаниеВременнойТаблицыОтборовФизическихЛиц(
			СвойстваТаблицы.ИменаВТИсточниковПараметров[0],
		...
		Запрос = КадровыйУчет.ЗапросВТКадровыеДанныеФизическихЛиц(
			СвойстваТаблицы.ТолькоРазрешенные,
			ОписательТаблицыОтборов,
			СвойстваТаблицы.КоллекцияПолей,
			Отбор,
			,
			СвойстваТаблицы.ИмяИсточникаДанных);
		
	ИначеЕсли ВРег(СвойстваТаблицы.ИмяПредставления) = ВРег("КадровыеДанныеСотрудников") Тогда
		
		ФормироватьСПериодичностьДень = Истина;
		
		ПредставлениеФормироватьСПериодичностьДень = ЗарплатаКадрыОбщиеНаборыДанных.ПараметрЗапроса("ФормироватьСПериодичностьДень", СвойстваТаблицы.ПараметрыЗапроса);
	...
	ИначеЕсли ВРег(СвойстваТаблицы.ИмяПредставления) = ВРег("РабочиеМестаСотрудников") Тогда
		
		Организация = ЗарплатаКадрыОбщиеНаборыДанных.ПараметрЗапроса("Организация", СвойстваТаблицы.ПараметрыЗапроса);
		Подразделение = ЗарплатаКадрыОбщиеНаборыДанных.ПараметрЗапроса("Подразделение", СвойстваТаблицы.ПараметрыЗапроса);
		ИмяВТИсточникДанных = СвойстваТаблицы.ИменаВТИсточниковПараметров[0];
	...
	ИначеЕсли ВРег(СвойстваТаблицы.ИмяПредставления) = ВРег("СотрудникиОрганизации") Тогда
		
		Организация = ЗарплатаКадрыОбщиеНаборыДанных.ПараметрЗапроса("Организация", СвойстваТаблицы.ПараметрыЗапроса);
		Подразделение = ЗарплатаКадрыОбщиеНаборыДанных.ПараметрЗапроса("Подразделение", СвойстваТаблицы.ПараметрыЗапроса);
		
		Если СвойстваТаблицы.ИменаВТИсточниковПараметров.Количество() > 0 Тогда
			Параметры = КадровыйУчет.ПараметрыПолученияСотрудниковОрганизацийПоВременнойТаблице();
			Параметры.ИмяВТФизическиеЛица = СвойстваТаблицы.ИменаВТИсточниковПараметров[0];
		Иначе
			Параметры = КадровыйУчет.ПараметрыПолученияСотрудниковОрганизацийПоСпискуФизическихЛиц();
		КонецЕсли;
		
		ПредставлениеОтбиратьПоГоловнойОрганизации = ЗарплатаКадрыОбщиеНаборыДанных.ПараметрЗапроса("ОтбиратьПоГоловнойОрганизации", СвойстваТаблицы.ПараметрыЗапроса);
		Параметры.ОтбиратьПоГоловнойОрганизации = ВРег(ПредставлениеОтбиратьПоГоловнойОрганизации) = ВРег("Истина");
		
		Параметры.Организация = Организация;
		Параметры.Подразделение = Подразделение;
		
		НачалоПериода = ЗарплатаКадрыОбщиеНаборыДанных.ПараметрЗапроса("НачалоПериода", СвойстваТаблицы.ПараметрыЗапроса);
		Если ЗначениеЗаполнено(НачалоПериода) Тогда
			Параметры.НачалоПериода = НачалоПериода;
		КонецЕсли;
		
		ОкончаниеПериода = ЗарплатаКадрыОбщиеНаборыДанных.ПараметрЗапроса("ОкончаниеПериода", СвойстваТаблицы.ПараметрыЗапроса);
		Если ЗначениеЗаполнено(ОкончаниеПериода) Тогда
			Параметры.ОкончаниеПериода = ОкончаниеПериода;
		КонецЕсли;
		
		Параметры.КадровыеДанные = СвойстваТаблицы.КоллекцияПолей;
	...
	ИначеЕсли ВРег(СвойстваТаблицы.ИмяПредставления) = ВРег("ОтработанноеВремя") Тогда
		
		НачалоПериода = ЗарплатаКадрыОбщиеНаборыДанных.ПараметрЗапроса("НачалоПериода", СвойстваТаблицы.ПараметрыЗапроса);
		ОкончаниеПериода = ЗарплатаКадрыОбщиеНаборыДанных.ПараметрЗапроса("ОкончаниеПериода", СвойстваТаблицы.ПараметрыЗапроса);
		
		Запрос = ЗарплатаКадрыОбщиеНаборыДанных.ЗапросВТПредставленияОтработанноеВремя(
			СвойстваТаблицы.ИменаВТИсточниковПараметров[0], НачалоПериода, ОкончаниеПериода, СвойстваТаблицы.ИмяИсточникаДанных);
	...
	ИначеЕсли ВРег(СвойстваТаблицы.ИмяПредставления) = ВРег("КадровыеДанныеСотрудниковАнализНачисленийИУдержаний") Тогда
	
		Запрос = ЗарплатаКадрыОбщиеНаборыДанных.ЗапросПредставленияКадровыеДанныеСотрудниковАнализНачисленийИУдержаний(ТекстЗапроса, СвойстваТаблицы.ТолькоРазрешенные);
	...
	ИначеЕсли ВРег(СвойстваТаблицы.ИмяПредставления) = ВРег("ПодразделенияСортировкиСотрудников") Тогда
		
		Запрос = ЗарплатаКадрыОбщиеНаборыДанных.ЗапросПредставленияПодразделенияСортировкиСотрудников();
		
	ИначеЕсли ВРег(СвойстваТаблицы.ИмяПредставления) = ВРег("НачисленныеДоходыНДФЛ") Тогда
