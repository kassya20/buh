...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура =
		"РегистрыСведений.ВидыДокументовГосОргановДляПоиска.ЗаполнитьВидыДокументовГосОргановДляПоиска";
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия     = "1.2.1.269";
	Обработчик.Процедура  = "ЭлектронныйДокументооборотСКонтролирующимиОрганами.ЗаполнитьСлужебныеРегистрыОбменаСЭДО";
	Обработчик.Комментарий = НСтр("ru = 'Заполнение служебных регистров обмена с СЭДО СФР.'");
	Обработчик.НачальноеЗаполнение = Ложь;
	Обработчик.РежимВыполнения = "Оперативно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор();

	Обработчик = Обработчики.Добавить();
	Обработчик.Версия     = "1.2.1.282";
	Обработчик.Процедура  = "ЭлектронныйДокументооборотСКонтролирующимиОрганами.ОбновитьНастройкиПодключенияСЭДО";
	Обработчик.Комментарий = НСтр("ru = 'Обновление настроек подключения к СЭДО СФР.'");
	Обработчик.НачальноеЗаполнение = Ложь;
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор();
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.2.1.313";
	Обработчик.Процедура  = "Справочники.ВидыОтправляемыхДокументов.ОчиститьУдаленныеВидыОтправляемыхДокументовБухОтчетности";
	Обработчик.Комментарий = НСтр("ru = 'Очистка удаленных видов отправляемых документов бухгалтерской отчетности'");
	Обработчик.НачальноеЗаполнение = Истина;
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор();
...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ЗаменитьДублиСправочникаВидыОтправляемыхДокументов");
	Методы.Вставить("ИсправитьСостояниеОтправкиЗаявленияОВвозеТоваров");
	Методы.Вставить("ВключитьАвтоматическийОбменСКонтролирующимиОрганамиПриОбновлении");
КонецПроцедуры
