...
Процедура ПриПолученииПредопределенныхНаборовСвойств(Наборы) Экспорт
	...
	УчетОбесцененияАктивов.НастроитьНаборыСвойств(Наборы);
	Документы.ИзменениеУсловийАренды.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	Документы.ВыплатыСамозанятым.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	Документы.ПереводОСВМалоценноеОборудование.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	Документы.ПрекращениеАренды.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	Документы.ИнвентаризацияКассы.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	УчетПроцентовПоОбязательствам.НастроитьНаборыСвойств(Наборы);
	Справочники.ОснованияЛьготПоИмущественнымНалогам.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	Справочники.ДокументыПодтверждающиеЛьготыПоИмущественнымНалогам.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	Справочники.ОбъектыВыполненияРабот.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	Справочники.КомпонентыАмортизацииОС.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	Документы.ОперацияПоЕдиномуНалоговомуСчету.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	Документы.УведомлениеОбИсчисленныхСуммахНалогов.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	Документы.ЗаявлениеОЗачетеВСчетПредстоящейОбязанности.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	Документы.УведомлениеОбОстаткахПрослеживаемыхТоваров.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	Документы.УведомлениеОбУменьшенииНалогаПоПатенту.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	Документы.ОперацияСПатентом.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	Документы.КорректировкаЕНС.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	Документы.СведенияОбУплатеНалогов.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	Документы.ЗаявлениеОВвозеТоваровПолученное.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	Документы.ТаможеннаяДекларацияЭкспорт.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	Документы.ГТДИмпорт.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	Документы.ЗаявлениеОВвозеТоваров.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	Документы.ПодтверждениеОплатыНДСВБюджет.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	КомпонентыАмортизацииОС.НастроитьНаборыСвойств(Наборы);
	Документы.ПрочееВзаимодействие.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	Документы.ИнвентаризацияНМА.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	Документы.НачалоСтадииРазработокНМА.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	Документы.НачислениеТуристическогоНалога.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	Документы.ИнвентаризацияОбъектовУчета.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	Документы.КоммерческоеПредложение.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	Документы.ОперацияСИнвестиционнымВычетом.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	
	УчетОбособленныхПодразделений.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
