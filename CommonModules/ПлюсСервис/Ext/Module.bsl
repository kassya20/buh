...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("СинхронизацияРекомендаций", Истина);
	Методы.Вставить("СинхронизацияССервисом", Истина);
	Методы.Вставить("ВыполнитьЗаданиеРасширения", Истина);
	Методы.Вставить("ОповеститьМенеджерСервисаОбУдалении", Истина);
	Методы.Вставить("ПодтвердитьУстановкуРасширенияВФоне", Истина);
