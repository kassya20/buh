...
Процедура ПервичныйДокументНачалоВыбораУведомлениеОбОстатках(ВидОперации, Форма) Экспорт
	...
	Если ВидОперации = 
		...
		Если ЗначениеЗаполнено(Форма.ПервичныйДокумент) Тогда
			...
			Если ТипЗнч(Форма.ПервичныйДокумент) = Тип("ДокументСсылка.ИнвентаризацияТоваровНаСкладе") Тогда
				
				ТипПервичногоДокумента = "ИнвентаризацияТоваровНаСкладе";
				
			ИначеЕсли ТипЗнч(Форма.ПервичныйДокумент) = Тип("ДокументСсылка.ВозвратТоваровОтПокупателя") Тогда
				
				ТипПервичногоДокумента = "ВозвратТоваровОтПокупателя";
			Иначе 
		...
		Иначе
			...
			СписокВыбора.Добавить("ИнвентаризацияТоваровНаСкладе",  НСтр("ru='Инвентаризация товаров'"));
			СписокВыбора.Добавить("ВозвратТоваровОтПокупателя", НСтр("ru='Возврат товаров от покупателя'"));
			СписокВыбора.Добавить("КорректировкаРеализации", НСтр("ru='Корректировка реализации'"));
