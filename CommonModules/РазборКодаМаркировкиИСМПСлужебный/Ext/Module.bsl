...
Функция ИспользуетсяСтандартноеОписаниеКодаМаркировки(ВидПродукции)
	...
	Возврат ВидПродукции = Перечисления.ВидыПродукцииИС.Духи
		...
		Или ВидПродукции = Перечисления.ВидыПродукцииИС.ЛегкаяПромышленность2026
		...
		Или ВидПродукции = Перечисления.ВидыПродукцииИС.НапиткиССодержаниемМолокаКакаоПрочие
		...
		Или ВидПродукции = Перечисления.ВидыПродукцииИС.БритвыИЛезвия
		...
		Или ВидПродукции = Перечисления.ВидыПродукцииИС.РастворимыеЗавариваемыеНапитки
		...
		Или ВидПродукции = Перечисления.ВидыПродукцииИС.АвтозапчастиИКомплектующиеТранспортныхСредств
		...
		Или ВидПродукции = Перечисления.ВидыПродукцииИС.ТоварыИзНатуральногоМеха;
...
Функция ИспользуетсяСтандартныйКодМаркировки(ВидПродукции)
	...
	Если ВидПродукции = Перечисления.ВидыПродукцииИС.Духи
		...
		Или ВидПродукции = Перечисления.ВидыПродукцииИС.ТоварыИзНатуральногоМеха Тогда
		Возврат Истина;
	...
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.АвтозапчастиИКомплектующиеТранспортныхСредств Тогда
		Возврат ОбщегоНазначенияИСМПКлиентСервер.АвтозапчастиИКомплектующиеТранспортныхСредствИспользуетСтандартныйКМ();
...
Функция ИспользуетсяУкороченныйКодМаркировки(ВидПродукции)
	...
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.АвтозапчастиИКомплектующиеТранспортныхСредств Тогда
		Возврат ОбщегоНазначенияИСМПКлиентСервер.АвтозапчастиИКомплектующиеТранспортныхСредствИспользуетУкороченныйКМ();
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.ПолимерныеТрубы Тогда
...
Процедура ОписаниеКодаМаркировкиПродукцииИСМП(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, ДлинаСерийногоНомера)
	...
	Если ВидПродукции = Перечисления.ВидыПродукцииИС.ИгрыИИгрушкиДляДетей
		Или ВидПродукции = Перечисления.ВидыПродукцииИС.ПиротехническиеИзделияИСредстваПожарнойБезопасности
		Или ВидПродукции = Перечисления.ВидыПродукцииИС.СладостиИКондитерскиеИзделия
		Или ВидПродукции = Перечисления.ВидыПродукцииИС.АвтозапчастиИКомплектующиеТранспортныхСредств Тогда
	...
	Параметры.Вставить("Вес",        РазборКодаМаркировкиИСМПСлужебныйКлиентСервер.КодВидаПродукцииМожетСодержатьВес(ВидПродукции));
	Параметры.Вставить("Объем",      РазборКодаМаркировкиИСМПСлужебныйКлиентСервер.КодВидаПродукцииМожетСодержатьОбъем(ВидПродукции));
	Параметры.Вставить("Длина",      РазборКодаМаркировкиИСМПСлужебныйКлиентСервер.КодВидаПродукцииМожетСодержатьДлину(ВидПродукции));
	Параметры.Вставить("Количество", РазборКодаМаркировкиИСМПСлужебныйКлиентСервер.КодВидаПродукцииМожетСодержатьКоличество(ВидПродукции));
	
	Для Каждого ВидУпаковки Из ВидыУпаковки Цикл
		Если ИспользуетсяСтандартныйКодМаркировки Тогда
			Параметры.Вставить("ВидУпаковки", ВидУпаковки);
			Параметры.Вставить("ДлинаСерийногоНомера", ДлинаСерийногоНомераСтандартногоКМ);
			ОписаниеСтандартногоКодаМаркировкиПродукцииИСМП(
				ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Параметры);
		КонецЕсли;
		Если ИспользуетсяУкороченныйКодМаркировки Тогда
			Параметры.Вставить("ВидУпаковки", ВидУпаковки);
			Параметры.Вставить("ДлинаСерийногоНомера", ДлинаСерийногоНомераУкороченногоКМ);
...
Процедура ОписаниеСтандартногоКодаМаркировкиПродукцииИСМП(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Параметры)
	
	Алфавит = ДанныеОписанийКодаМаркировки.Алфавит;
	
	СписокСвойств = "GTIN, СерийныйНомер, КлючПроверки, Подпись";
	
	ОписаниеЭлементовКМ = Новый Структура(СписокСвойств);
	ОписаниеЭлементовКМ.GTIN          = ОписаниеЭлементаКодаМаркировки("01", "GTIN",          14);
	ОписаниеЭлементовКМ.СерийныйНомер = ОписаниеЭлементаКодаМаркировки("21", "СерийныйНомер", Параметры.ДлинаСерийногоНомера, Алфавит.БуквыЦифрыЗнаки);
	...
	ТипШтрихкодаИВидУпаковки.ВидУпаковки  = Параметры.ВидУпаковки;
	...
	Если Параметры.ВидУпаковки = Перечисления.ВидыУпаковокИС.Потребительская Тогда
		
		Если Параметры.Вес Тогда
			ИмяСвойства = "МассаНеттоВКг";
			ПрефиксПоказателя = "310";
			ДобавитьОписаниеПоказателяСтандартногоКодаМаркировки(ИмяСвойства, ПрефиксПоказателя, Алфавит,
				ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Параметры);
		КонецЕсли;
		
		Если Параметры.Объем Тогда
			ИмяСвойства = "ОбъемВЛитрах";
			ПрефиксПоказателя = "335";
			ДобавитьОписаниеПоказателяСтандартногоКодаМаркировки(ИмяСвойства, ПрефиксПоказателя, Алфавит,
				ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Параметры);
		КонецЕсли;
		
		Если Параметры.Длина Тогда
			ИмяСвойства = "ДлинаВМетрах";
			ПрефиксПоказателя = "311";
			ДобавитьОписаниеПоказателяСтандартногоКодаМаркировки(ИмяСвойства, ПрефиксПоказателя, Алфавит,
				ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Параметры);
		КонецЕсли;
		
		Если Параметры.Количество Тогда
			ДобавитьОписаниеКоличестваСтандартногоКодаМаркировки(Алфавит,
				ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Параметры)
		КонецЕсли;
...
Процедура ДобавитьОписаниеПоказателяСтандартногоКодаМаркировки(ИмяСвойства, ПрефиксПоказателя, Алфавит,
	ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Параметры)
	
	СписокСвойств = "GTIN, СерийныйНомер, КлючПроверки, Подпись, " + ИмяСвойства;
	
	Для Положение = 0 По 5 Цикл
		
		Идентификатор = СтрШаблон("%1%2", ПрефиксПоказателя, Положение);
		...
		ОписаниеЭлементовКМ.КлючПроверки  = ОписаниеЭлементаКодаМаркировки("91", "КлючПроверки",   4, Алфавит.БуквыЦифрыЗнаки);
		ОписаниеЭлементовКМ.Подпись       = ОписаниеЭлементаКодаМаркировки("92", "Подпись",       44, Алфавит.БуквыЦифрыЗнаки);
		ОписаниеЭлементовКМ[ИмяСвойства]  = ОписаниеЭлементаКодаМаркировки(Идентификатор, ИмяСвойства, 6, Алфавит.Цифры);
		
		ШаблоныСтрокой = Новый Массив;
		ШаблоныСтрокой.Добавить("GTIN + СерийныйНомер + КлючПроверки + Подпись + " + ИмяСвойства);
		...
		СоставКодаМаркировки = НовыйСоставКодаМаркировкиИСМП(ТипШтрихкодаИВидУпаковки);
		СоставКодаМаркировки.Вставить(ИмяСвойства, Неопределено);
...
Процедура ДобавитьОписаниеКоличестваСтандартногоКодаМаркировки(Алфавит,
	ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Параметры)
	
	ИмяСвойства = "КоличествоВШтуках";
	СписокСвойств = "GTIN, СерийныйНомер, КлючПроверки, Подпись, " + ИмяСвойства;
	
	Для Положение = 1 По 8 Цикл
		...
		ОписаниеЭлементовКМ.КлючПроверки  = ОписаниеЭлементаКодаМаркировки("91", "КлючПроверки",   4, Алфавит.БуквыЦифрыЗнаки);
		ОписаниеЭлементовКМ.Подпись       = ОписаниеЭлементаКодаМаркировки("92", "Подпись",       44, Алфавит.БуквыЦифрыЗнаки);
		ОписаниеЭлементовКМ[ИмяСвойства]  = ОписаниеЭлементаКодаМаркировки("30", ИмяСвойства, Положение, Алфавит.Цифры);
...
Процедура ОписаниеУкороченногоКодаМаркировкиПродукцииИСМП(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Параметры)
	
	Алфавит = ДанныеОписанийКодаМаркировки.Алфавит;
	
	СписокСвойств = "GTIN, СерийныйНомер, КодПроверки";
	...
	Если Параметры.ВидУпаковки = Перечисления.ВидыУпаковокИС.Потребительская Тогда
		...
		Если Параметры.Вес Тогда
			ИмяСвойства = "МассаНеттоВКг";
			ПрефиксПоказателя = "310";
			ДобавитьОписаниеПоказателяУкороченногоКодаМаркировки(ИмяСвойства, ПрефиксПоказателя, Алфавит,
				ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Параметры);
		КонецЕсли;
		...
		Если Параметры.Количество Тогда
			ДобавитьОписаниеКоличестваУкороченногоКодаМаркировки(Алфавит,
				ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Параметры);
		КонецЕсли;
...
Процедура ДобавитьОписаниеПоказателяУкороченногоКодаМаркировки(ИмяСвойства, ПрефиксПоказателя, Алфавит,
	ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Параметры)
	
	СписокСвойств = "GTIN, СерийныйНомер, КодПроверки, " + ИмяСвойства;
	...
	Для Положение = 0 По 5 Цикл
		...
		ШаблоныСтрокой = Новый Массив;
		ШаблоныСтрокой.Добавить("GTIN + СерийныйНомер + КодПроверки + " + ИмяСвойства);
...
Процедура ДобавитьОписаниеКоличестваУкороченногоКодаМаркировки(Алфавит,
	ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Параметры)
...
Процедура ОписаниеКодаМаркировкиПродукцииПиво(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, ВидУпаковки, ДлинаСерийногоНомера)
	...
	Если РазборКодаМаркировкиИСМПСлужебныйКлиентСервер.КодВидаПродукцииМожетСодержатьОбъем(ВидПродукции) Тогда
		// Шаблоны с объемом
...
// Формирует описание кода маркировки для Пиво
Процедура ОписаниеКодаМаркировкиПродукцииПивоБелоруссия(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, ВидУпаковки)
