...
Процедура ОповеститьОЗаписиПлатежногоПорученияНаУплатуНалога(Объект, ДокументОплачен) Экспорт
	...
	ПлатежиВБюджетКлиент.ОповеститьОЗаписиПлатежаНаУплатуНалога(Объект, ДокументОплачен);
...
Процедура ОповеститьОЗаписиПлатежногоПорученияНаВыплатуПоДоговорамПодряда(Объект, ДокументОплачен) Экспорт
...
Процедура ОткрытьФормуРедактированияРеквизитовПлатежаВБюджет(Форма, ОписаниеОповещения, ИсправитьОшибки = Ложь, АдресОшибок = "") Экспорт
	...
	Для каждого ОписаниеРеквизита Из ПлатежиВБюджетКлиентСерверПереопределяемый.РеквизитыДокумента_ПлатежноеПоручение() Цикл
		Если Объект.Свойство(ОписаниеРеквизита.Значение)
			И РеквизитыПлатежаВБюджет.Свойство(ОписаниеРеквизита.Ключ) Тогда
	...
	СвойстваКонтекста.Налогоплательщик                   = Объект.Налогоплательщик;
	...
	СвойстваКонтекста.ПеречислениеВБюджет                = Объект.ПеречислениеВБюджет;
	СвойстваКонтекста.ПеречислениеПоИсполнительномуЛисту = Объект.ПеречислениеПоИсполнительномуЛисту;
	СвойстваКонтекста.ВидГосударственногоОргана          = Форма.ВидГосударственногоОргана;
	Если Объект.ПеречислениеПоИсполнительномуЛисту Тогда
		Если СвойстваКонтекста.ВидГосударственногоОргана = ПредопределенноеЗначение("Перечисление.ВидыГосударственныхОрганов.НалоговыйОрган") Тогда
			СвойстваКонтекста.ВидПеречисления = ПредопределенноеЗначение("Перечисление.ВидыПеречисленийВБюджет.НалоговыйПлатеж");
		Иначе
			СвойстваКонтекста.ВидПеречисления = ПредопределенноеЗначение("Перечисление.ВидыПеречисленийВБюджет.ИнойПлатеж");
		КонецЕсли;
	КонецЕсли;
