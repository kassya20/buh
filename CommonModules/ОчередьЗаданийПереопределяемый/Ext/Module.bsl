...
Процедура ПриПолученииСпискаШаблонов(ШаблоныЗаданий) Экспорт
	...
	ИнтеграцияАУСН.ПриПолученииСпискаШаблоновОчередиЗаданий(ШаблоныЗаданий);
	...
	// РекламныйСервис
	РекламныйСервис.ПриПолученииСпискаШаблонов(ШаблоныЗаданий);
...
Процедура ПриОпределенииПсевдонимовОбработчиков(СоответствиеИменПсевдонимам) Экспорт
	...
	СоответствиеИменПсевдонимам.Вставить(Метаданные.РегламентныеЗадания.АвтоматическоеЗакрытиеМесяца.ИмяМетода);
	СоответствиеИменПсевдонимам.Вставить(Метаданные.РегламентныеЗадания.АвтоматическаяЗагрузкаОтчетовМаркетплейсов.ИмяМетода);
	...
	РассылкаСообщений.ДополнитьПсевдонимыОбработчиковОчередиЗаданий(СоответствиеИменПсевдонимам);
	...
	ОплатаСервисаПлатежнаяСистемаЮKassaБП.ПриОпределенииПсевдонимовОбработчиков(СоответствиеИменПсевдонимам);
	
	ИнтеграцияАУСН.ПриОпределенииПсевдонимовОбработчиков(СоответствиеИменПсевдонимам);
	ИнтеграцияСтатусСамозанятогоБП.ПриОпределенииПсевдонимовОбработчиков(СоответствиеИменПсевдонимам);
	...
	// Конец Регламентые задания ГосИС

	УчетКассовыхЧековПодотчетныхЛиц.ЗарегистрироватьМетодОчередиЗаданий(СоответствиеИменПсевдонимам);
	
	КалендарьОтчетности.ЗарегистрироватьМетодОчередиЗаданий(СоответствиеИменПсевдонимам);
	
	// РекламныйСервис
	РекламныйСервис.ПриОпределенииПсевдонимовОбработчиков(СоответствиеИменПсевдонимам);
	// Конец РекламныйСервис
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ИнтеграцияС1СДокументооборотом") Тогда
		...
		МодульИнтеграцияС1СДокументооборотБазоваяФункциональность.ПриОпределенииПсевдонимовОбработчиков(
			СоответствиеИменПсевдонимам);
	КонецЕсли;
	// Конец ИнтеграцияС1СДокументооборотом
	
	//Мобильный клиент
	СоответствиеИменПсевдонимам.Вставить(Метаданные.РегламентныеЗадания.РассылкаPushУведомлений.ИмяМетода);
	//
