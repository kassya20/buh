...
//   * ОтображатьВПанелиРазвделов - Булево - Управляет отображением личного кабинета сервиса
...
Процедура ПриВключении(Используется) Экспорт
	...
	ИнтеграцияСБанкамиВключена = 
		Справочники.НастройкиИнтеграцииСБанками.ИнтеграцияВИнформационнойБазеВключена();
	Используется = Не ИнтеграцияСБанкамиВключена;
