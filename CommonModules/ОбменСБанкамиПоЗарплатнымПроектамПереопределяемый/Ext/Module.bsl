...
// Позволяет заполнить данные платежного документа из реквизитов платежного документа.
//
// Параметры:
//		ДанныеПлатежногоДокумента   - Структура - содержит:
//		   * Дата  - Дата
//		   * Номер - Строка
//		ПлатежныйДокумент    - ДокументОбъект - платежный документ, данные которого следует использовать.
//		СтандартнаяОбработка - Булево - Ложь, если установлено переопределение заполнения данных платежного документа
//
Процедура ЗаполнитьДанныеПлатежногоДокумента(ДанныеПлатежногоДокумента, ПлатежныйДокумент, СтандартнаяОбработка) Экспорт
