...
Функция ДлинаСерийногоНомераКодаМаркировки(ВидПродукции, СтандартныйКМ = Неопределено) Экспорт
	...
	Если ОбщегоНазначенияИСКлиентСервер.ЭтоПродукцияМОТП(ВидПродукции)
		...
		Результат = 7;
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.Фотоаппараты")
	...
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.АвтозапчастиИКомплектующиеТранспортныхСредств") Тогда
		Результат = АвтозапчастиИКомплектующиеТранспортныхСредствДлинаСерийногоНомера();
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ТоварыИзНатуральногоМеха") Тогда
		Результат = ТоварыИзНатуральногоМехаДлинаСерийногоНомера();
	Иначе
		Результат = 13;
	КонецЕсли;
...
Функция КодВидаПродукцииМожетСодержатьВес(ВидПродукции) Экспорт
...
Функция КодВидаПродукцииМожетСодержатьОбъем(ВидПродукции) Экспорт
...
Функция КодВидаПродукцииМожетСодержатьДлину(ВидПродукции) Экспорт
	
	Возврат ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.РадиоэлектроннаяПродукция");
	
КонецФункции

Функция КодВидаПродукцииМожетСодержатьКоличество(ВидПродукции) Экспорт
...
Функция АвтозапчастиИКомплектующиеТранспортныхСредствДлинаСерийногоНомера()
	Возврат 13;
КонецФункции

Функция ТоварыИзНатуральногоМехаДлинаСерийногоНомера()
	Возврат 13;
КонецФункции
