...
Процедура ПриОпределенииНастроек(Настройки) Экспорт
	...
	РеквизитыДляПредставления = Новый Массив;
	РеквизитыДляПредставления.Добавить("Сумма");
	РеквизитыДляПредставления.Добавить("ВалютаВзаиморасчетов");
...
Процедура ПриПолученииПредставления(ТипДанных, Данные, Представление, СтандартнаяОбработка) Экспорт
	...
	Если ТипДанных = Тип("СправочникСсылка.ДоговорыКонтрагентов") Тогда
		...
		МетаданныеОбъекта = Метаданные.Справочники.ДоговорыКонтрагентов;
		
		Представление = СтрШаблон(НСтр("ru = '%1 %2'"),
			ОбщегоНазначения.ПредставлениеОбъекта(МетаданныеОбъекта),
			Данные.Представление);
		
		Если ЗначениеЗаполнено(Данные.ДополнительныйРеквизит1) Тогда
			Представление = СтрШаблон(НСтр("ru = '%1 на сумму %2 %3'"),
				Представление,
				Данные.ДополнительныйРеквизит1,
				Данные.ДополнительныйРеквизит2);
		КонецЕсли;
	...
	Иначе
		...
		Если ОбщегоНазначения.ЭтоДокумент(МетаданныеОбъекта) Тогда
			...
			ПредставлениеДокумента = РегистрыСведений.ДанныеПервичныхДокументов.ПредставлениеДокумента(
				Данные.Ссылка, МетаданныеОбъекта);
			...
			Если ЗначениеЗаполнено(ПредставлениеДокумента) Тогда
				...
				Если ЗначениеЗаполнено(Данные.СуммаДокумента) Тогда
					Представление = СтрШаблон(НСтр("ru = '%1 на сумму %2 %3'"),
						Представление,
