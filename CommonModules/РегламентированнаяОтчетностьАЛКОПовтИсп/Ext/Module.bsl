...
Функция ПолучитьВерсиюЧислом(знач СтрокаВерсии) Экспорт
	...
	Возврат РегламентированнаяОтчетностьАЛКОКлиентСервер.ПолучитьВерсиюЧислом(СтрокаВерсии);
...
Функция ПолучитьВерсиюБСПЧислом() Экспорт
	...
	Версия = РегламентированнаяОтчетностьАЛКОКлиентСервер.СкопироватьРекурсивноАЛКО(ВерсияБСПЧислом);
...
Функция Стили_БРО_АЛКО() Экспорт
	
	Стиль_БРО_АЛКО = Новый Соответствие;
	
	Шрифт_ОбычногоТекста = 
		РегламентированнаяОтчетностьАЛКОКлиентСервер.ШрифтПоОписанию("Arial", 10);
	Шрифт_ОбычногоТекста_Полужирный = 
		РегламентированнаяОтчетностьАЛКОКлиентСервер.ШрифтПоОписанию("Arial", 10, Истина);
	Шрифт_ЗаголовокКолонокТаблиц = 
		РегламентированнаяОтчетностьАЛКОКлиентСервер.ШрифтПоОписанию("Arial", 9);
	Шрифт_ЗаголовокКолонокТаблиц_Полужирный = 
		РегламентированнаяОтчетностьАЛКОКлиентСервер.ШрифтПоОписанию("Arial", 9, Истина);
	
	// Группа.
	Стиль_БРО_АЛКО["ГруппаВыделенноеПолеЗаголовокТекстЦвет"] = Новый Цвет(51, 51, 51);
	Стиль_БРО_АЛКО["ГруппаВыделенноеПолеЗаголовокШрифт"] = Шрифт_ОбычногоТекста_Полужирный;
	Стиль_БРО_АЛКО["ГруппаВыделенноеПолеРамкаЦвет"] = Новый Цвет(160, 160, 160);
	Стиль_БРО_АЛКО["ГруппаВыделенноеПолеТекстЦвет"] = Новый Цвет(51, 51, 51);
	Стиль_БРО_АЛКО["ГруппаВыделенноеПолеТекстШрифт"] = Шрифт_ОбычногоТекста_Полужирный;
	Стиль_БРО_АЛКО["ГруппаВыделенноеПолеФон"] = Новый Цвет(230, 230, 230);
	Стиль_БРО_АЛКО["ГруппаЗаголовокТекстЦвет"] = Новый Цвет(51, 51, 51);
	Стиль_БРО_АЛКО["ГруппаЗаголовокШрифт"] = Шрифт_ОбычногоТекста;
	Стиль_БРО_АЛКО["ГруппаПолеЗаголовокТекстЦвет"] = Новый Цвет(51, 51, 51);
	Стиль_БРО_АЛКО["ГруппаПолеЗаголовокШрифт"] = Шрифт_ОбычногоТекста;
	Стиль_БРО_АЛКО["ГруппаПолеРамкаЦвет"] = Новый Цвет(160, 160, 160);
	Стиль_БРО_АЛКО["ГруппаПолеТекстЦвет"] = Новый Цвет(51, 51, 51);
	Стиль_БРО_АЛКО["ГруппаПолеТекстШрифт"] = Шрифт_ОбычногоТекста;
	Стиль_БРО_АЛКО["ГруппаПолеФон"] = Новый Цвет(240, 240, 240);
	Стиль_БРО_АЛКО["ГруппаФон"] = Новый Цвет(250, 250, 250);
	
	// Страница.
	Стиль_БРО_АЛКО["СтраницаВыделенноеПолеЗаголовокТекстЦвет"] = Новый Цвет(51, 51, 51);
	Стиль_БРО_АЛКО["СтраницаВыделенноеПолеЗаголовокШрифт"] = Шрифт_ОбычногоТекста_Полужирный;
	Стиль_БРО_АЛКО["СтраницаВыделенноеПолеРамкаЦвет"] = Новый Цвет(160, 160, 160);
	Стиль_БРО_АЛКО["СтраницаВыделенноеПолеТекстЦвет"] = Новый Цвет(51, 51, 51);
	Стиль_БРО_АЛКО["СтраницаВыделенноеПолеТекстШрифт"] = Шрифт_ОбычногоТекста_Полужирный;
	Стиль_БРО_АЛКО["СтраницаВыделенноеПолеФон"] = Новый Цвет(230, 230, 230);
	Стиль_БРО_АЛКО["СтраницаЗаголовокТекстЦвет"] = Новый Цвет(51, 51, 51);
	Стиль_БРО_АЛКО["СтраницаЗаголовокШрифт"] = Шрифт_ОбычногоТекста;
	Стиль_БРО_АЛКО["СтраницаПолеЗаголовокТекстЦвет"] = Новый Цвет(51, 51, 51);
	Стиль_БРО_АЛКО["СтраницаПолеЗаголовокШрифт"] = Шрифт_ОбычногоТекста;
	Стиль_БРО_АЛКО["СтраницаПолеРамкаЦвет"] = Новый Цвет(160, 160, 160);
	Стиль_БРО_АЛКО["СтраницаПолеТекстЦвет"] = Новый Цвет(51, 51, 51);
	Стиль_БРО_АЛКО["СтраницаПолеТекстШрифт"] = Шрифт_ОбычногоТекста;
	Стиль_БРО_АЛКО["СтраницаПолеФон"] = Новый Цвет(240, 240, 240);
	Стиль_БРО_АЛКО["СтраницаФон"] = Новый Цвет(245, 245, 245);
	
	
	// Страницы.
	Стиль_БРО_АЛКО["СтраницыЗаголовокТекстЦвет"] = Новый Цвет(51, 51, 51);
	Стиль_БРО_АЛКО["СтраницыЗаголовокШрифт"] = Шрифт_ОбычногоТекста;
		
	// Таблицы.
	Стиль_БРО_АЛКО["ТаблицыЗаголовокКолонокТекстЦвет"] = Новый Цвет(240, 240, 240);
	Стиль_БРО_АЛКО["ТаблицыЗаголовокКолонокТекстЦветВыделенное"] = Новый Цвет(240, 240, 240);
	Стиль_БРО_АЛКО["ТаблицыЗаголовокКолонокТекстШрифт"] = Шрифт_ЗаголовокКолонокТаблиц;
	Стиль_БРО_АЛКО["ТаблицыЗаголовокКолонокТекстШрифтВыделенное"] = Шрифт_ЗаголовокКолонокТаблиц_Полужирный;
	Стиль_БРО_АЛКО["ТаблицыЗаголовокКолонокФон"] = Новый Цвет(51, 51, 51);
	Стиль_БРО_АЛКО["ТаблицыЗаголовокКолонокФонВыделенное"] = Новый Цвет(51, 51, 51);
	Стиль_БРО_АЛКО["ТаблицыЗаголовокЦвет"] = Новый Цвет(0, 0, 0);
	Стиль_БРО_АЛКО["ТаблицыЗаголовокШрифт"] = Шрифт_ОбычногоТекста_Полужирный;
		
	Стиль_БРО_АЛКО["ТаблицыПодвалКолонокТекстЦвет"] = Новый Цвет(0, 0, 0);
	Стиль_БРО_АЛКО["ТаблицыПодвалКолонокТекстЦветВыделенное"] = Новый Цвет(0, 0, 0);
	Стиль_БРО_АЛКО["ТаблицыПодвалКолонокТекстШрифт"] = Шрифт_ОбычногоТекста;
	Стиль_БРО_АЛКО["ТаблицыПодвалКолонокТекстШрифтВыделенное"] = Шрифт_ОбычногоТекста_Полужирный;
	Стиль_БРО_АЛКО["ТаблицыПодвалКолонокФон"] = Новый Цвет(240, 240, 240);
	Стиль_БРО_АЛКО["ТаблицыПодвалКолонокФонВыделенное"] = Новый Цвет(240, 240, 240);
	
	Стиль_БРО_АЛКО["ТаблицыРамкаЦвет"] = Новый Цвет(160, 160, 160);
	Стиль_БРО_АЛКО["ТаблицыТекстЦвет"] = Новый Цвет(51, 51, 51);
	Стиль_БРО_АЛКО["ТаблицыТекстШрифт"] = Шрифт_ОбычногоТекста;
		
	Стиль_БРО_АЛКО["ТаблицыФон"] = Новый Цвет(230, 230, 230);
	
	// Вспомогательные.
	Стиль_БРО_АЛКО["ПоясняющийПроблемуТекст"] = Новый Цвет(255, 99, 71);
	Стиль_БРО_АЛКО["ЦветНезаполненныйРеквизитБРО"] = Новый Цвет(178, 34, 34);
	Стиль_БРО_АЛКО["ЦветГиперссылкиБРО"] = Новый Цвет(28, 85, 174);
	
	
	Возврат Стиль_БРО_АЛКО;

КонецФункции

Функция ТекущийИнтерфейс85() Экспорт

	Возврат РегламентированнаяОтчетностьАЛКОКлиентСервер.ТекущийИнтерфейс85();
...
// Возвращает размер оперативной памяти в мегабайтах.
//
// Возвращаемое значение:
//  Число
//
Функция ОперативнаяПамять() Экспорт
