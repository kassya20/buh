...
Процедура ЗаполнитьПараметрыЗаказаНаДоставку(Параметры) Экспорт
	СервисДоставкиБП.ЗаполнитьПараметрыЗаказаНаДоставку(Параметры);
КонецПроцедуры
...
Процедура ЗаполнитьПараметрыКонтрагента(Параметры) Экспорт
	СервисДоставкиБП.ЗаполнитьПараметрыКонтрагента(Параметры);
КонецПроцедуры
...
Процедура ЗаполнитьПараметрыКонтактногоЛицаПоУмолчанию(Форма, Параметры, ИмяЭлемента = "") Экспорт
	...
	СервисДоставкиБП.ЗаполнитьПараметрыКонтактногоЛицаПоУмолчанию(Форма, Параметры);
...
Процедура ЗаполнитьПараметрыВалюты(Параметры) Экспорт
	Параметры.Ссылка = Справочники.Валюты.НайтиПоКоду(Параметры.Код).Ссылка;
КонецПроцедуры
...
Процедура ПриОпределенииОснованийЗаказаНаДоставку(СписокОснований) Экспорт
	...
	СервисДоставкиБП.ПриОпределенииОснованийЗаказаНаДоставку(СписокОснований);
...
// Заполняет перечень типов документов-оснований, для которых можно оформить оплату доставки наложенным платежом в СДЭК.
// 
// Возвращаемое значение:
//  Массив из ОписаниеТипов - 
Функция ТипыОснованийДляНаложенногоПлатежаСДЭК() Экспорт
...
Процедура ПередЗаписьюОснованияЗаказаНаДоставку(ДокументОбъект) Экспорт
	СервисДоставкиБП.ПередЗаписьюОснованияЗаказаНаДоставку(ДокументОбъект);
КонецПроцедуры
...
Процедура ЗаполнитьСписокВыбораСпособаОпределенияКонтактногоЛица(Форма) Экспорт
	СервисДоставкиБП.ЗаполнитьСписокВыбораСпособаОпределенияКонтактногоЛица(Форма);
КонецПроцедуры
...
// Дополнить владельцев контактной информации.
// 
// Параметры:
//  Контрагент - СправочникСсылка.Контрагенты
//  МассивВладельцев - Массив Из СправочникСсылка
Процедура ДополнитьВладельцевКонтактнойИнформации(Контрагент, МассивВладельцев) Экспорт
КонецПроцедуры
