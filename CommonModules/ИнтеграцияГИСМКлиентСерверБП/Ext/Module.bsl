...
Функция ДатаПереходаНаСистемуМаркировки() Экспорт
	
	Возврат '2022-09-01';
	
КонецФункции

Функция МожноИспользоватьКонтрольныеЗнакиГИСМ(Период) Экспорт
	
	Возврат Период < ДатаПереходаНаСистемуМаркировки();
