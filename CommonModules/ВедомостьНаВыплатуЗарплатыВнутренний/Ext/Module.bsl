...
Процедура СоздатьВТУсловияВозвратаЗадолженности(МенеджерВременныхТаблиц) Экспорт
	ВедомостьНаВыплатуЗарплатыБазовый.СоздатьВТУсловияВозвратаЗадолженности(МенеджерВременныхТаблиц);
КонецПроцедуры

Процедура ПрименитьОграниченияПогашенийЗадолженностей(Зарплата, ИгнорируемыеРегистраторы, ПериодРегистрации) Экспорт
	ВедомостьНаВыплатуЗарплатыБазовый.ПрименитьОграниченияПогашенийЗадолженностей(Зарплата, ИгнорируемыеРегистраторы, ПериодРегистрации);
КонецПроцедуры
...
Функция ДополнительныеРеквизиты(Ведомость) Экспорт
	Возврат ВедомостьНаВыплатуЗарплатыБазовый.ДополнительныеРеквизиты(Ведомость);
КонецФункции
