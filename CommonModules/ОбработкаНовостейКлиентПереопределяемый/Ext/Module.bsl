...
Процедура РазрешенаРаботаСНовостямиТекущемуПользователю(Результат) Экспорт
	...
	Если Результат = Истина Тогда
		ЭтоНачалоРаботы = Ложь;
		СтандартныеПодсистемыКлиент.ПараметрыРаботыКлиентаПриЗапуске().Свойство("НачалоРаботы", ЭтоНачалоРаботы);
		РежимИнтерфейсаРазрешаетРаботуСНовостями = Ложь;
		СтандартныеПодсистемыКлиент.ПараметрыРаботыКлиента().Свойство("РежимИнтерфейсаПользователяРазрешаетРаботуСНовостями", РежимИнтерфейсаРазрешаетРаботуСНовостями);
		Результат = ЭтоНачалоРаботы <> Истина
			И РежимИнтерфейсаРазрешаетРаботуСНовостями = Истина;
	КонецЕсли;
