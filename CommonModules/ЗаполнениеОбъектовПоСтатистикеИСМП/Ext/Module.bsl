...
Функция ДанныеЗаполненияПеремещениеМеждуМОД_ИСМП(Организация) Экспорт
	...
	ДанныеЗаполнения.Вставить("ВидПродукции", Новый ОписаниеТипов("ПеречислениеСсылка.ВидыПродукцииИС"));
	...
	ВидыПродукцииУчета = Документы.ПеремещениеМеждуМОДИСМП.ДоступныеВидыПродукцииИСМП();
	...
	|	ПеремещениеМеждуМОД_ИСМП.ВидПродукции КАК ВидПродукции,
	...
	ЗаполнитьПоСтатистике(
		"Организация, ВидПродукции, Отправитель, Получатель",
		ДанныеЗаполнения, ДанныеПоследнихДокументов, "");
	...
	Для Каждого СтрокаТовары Из СтрокиТовары Цикл
		...
		Если Не ЗначениеЗаполнено(СтрокаТовары.Шаблон) Тогда
			...
			ИначеЕсли Объект.ВидПродукции = Перечисления.ВидыПродукцииИС.БАДы
				Или Объект.ВидПродукции = Перечисления.ВидыПродукцииИС.БАДы2025
				Или Объект.ВидПродукции = Перечисления.ВидыПродукцииИС.СпортивноеПитание Тогда
			...
			ИначеЕсли Объект.ВидПродукции = Перечисления.ВидыПродукцииИС.ОптоволокноИОптоволоконнаяПродукция Тогда
				...
				КонецЕсли;
			ИначеЕсли Объект.ВидПродукции = Перечисления.ВидыПродукцииИС.ПарфюмерныеИКосметическиеСредстваИБытоваяХимия
				Или Объект.ВидПродукции = Перечисления.ВидыПродукцииИС.ТоварыЛичнойГигиены
				Или Объект.ВидПродукции = Перечисления.ВидыПродукцииИС.БритвыИЛезвия Тогда
			...
			ИначеЕсли Объект.ВидПродукции = Перечисления.ВидыПродукцииИС.МоторныеМасла Тогда
				...
				КонецЕсли;
			ИначеЕсли Объект.ВидПродукции = Перечисления.ВидыПродукцииИС.АвтозапчастиИКомплектующиеТранспортныхСредств Тогда
				Если ОбщегоНазначенияИСМПКлиентСервер.АвтозапчастиИКомплектующиеТранспортныхСредствИспользуетСтандартныйКМ() Тогда
					СтрокаТовары.Шаблон = Перечисления.ШаблоныКодовМаркировкиСУЗ.АвтозапчастиИКомплектующиеТранспортныхСредствСтандартныйКМ;
				Иначе
					СтрокаТовары.Шаблон = Перечисления.ШаблоныКодовМаркировкиСУЗ.АвтозапчастиИКомплектующиеТранспортныхСредств;
				КонецЕсли;
			ИначеЕсли Объект.ВидПродукции = Перечисления.ВидыПродукцииИС.Бакалея
				Или Объект.ВидПродукции = Перечисления.ВидыПродукцииИС.РастворимыеЗавариваемыеНапитки Тогда
