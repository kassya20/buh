...
Функция ДанныеЯчейкиШапкиНаСервере(ПараметрыПолучения) Экспорт
	...
	|	РаспознанныйДокументРеквизитыДокумента.КоординатыТекста КАК КоординатыТекста,
	...
	Если Выборка.Следующий() Тогда
		...
		Если ДвоичныеДанные = Неопределено Тогда
			...
			ИсходноеИзображение = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ПараметрыПолучения.Ссылка, "ИсходноеИзображение");
			
			Координаты = Выборка.КоординатыТекста.Получить();
...
Функция ДанныеЯчейкиТаблицыНаСервере(ПараметрыПолучения) Экспорт
	...
	|	РаспознанныйДокументРеквизитыТабличныхЧастей.КоординатыТекста КАК КоординатыТекста,
