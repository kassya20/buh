...
Процедура ЗаполнитьОписаниеТаблицыОтчета(ОписаниеТаблицыОтчета, ИмяТаблицыОтчета)
	...
	ЗаполнениеБухгалтерскойОтчетностиПоясненияФинансовыеВложения.ОписатьТаблицуОтчета(ОписаниеТаблицыОтчета, ИмяТаблицыОтчета);
...
Процедура ОпределитьСоставЗаполняемыхТаблицОтчета(ТаблицыОтчетаКЗаполнению, КонтекстОтчета)
	...
	ЗаполнениеБухгалтерскойОтчетностиПоясненияФинансовыеВложения.ОпределитьСоставЗаполняемыхПояснений(ТаблицыОтчетаКЗаполнению, КонтекстОтчета);
...
Процедура ПолучитьДанныеТаблицОтчета(ПолучениеДанныхТаблицОтчета, Классификаторы)
	...
	ЗаполнениеБухгалтерскойОтчетностиПоясненияФинансовыеВложения.ЗаполнитьТаблицыОтчета(ПолучениеДанныхТаблицОтчета, Классификаторы, ПолучениеДанныхТаблицОтчета.КонтекстЗаполненияОтчета);
