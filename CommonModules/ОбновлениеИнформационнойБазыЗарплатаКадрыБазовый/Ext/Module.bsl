...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	РегистрыСведений.МинимальнаяОплатаТрудаРФ.ПриДобавленииОбработчиковОбновления(Обработчики);
	...
	КлассыУсловийТруда.ЗарегистрироватьОбработчикиОбновления(Обработчики);
	...
	Интеграция1СПерсонал.ЗарегистрироватьОбработчикиОбновления(Обработчики);
	
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ИнтеграцияС1САрхивомЗарплатаКадры") Тогда
		МодульОбменСАрхивом = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияС1САрхивом");
		МодульОбменСАрхивом.ЗарегистрироватьОбработчикиОбновления(Обработчики);;
	КонецЕсли;
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ИнтеграцияС1САрхивом") Тогда
		МодульОбновлениеИнформационнойБазыБИА = ОбщегоНазначения.ОбщийМодуль("ОбновлениеИнформационнойБазыБИА");
		МодульОбновлениеИнформационнойБазыБИА.ПриДобавленииОбработчиковОбновления(Обработчики);
	КонецЕсли;
...
Функция ПодготовитьОбновлениеДанных(ПараметрыОбновления, ИмяПространстваБлокировки, ПолеБлокировки, ЗначениеБлокировки) Экспорт
	...
	Исключение
		...
		ТекстОшибки = СтрШаблон(НСтр("ru = 'Пространство блокировки: %1, поле: %2, значение %3, ошибка: %4'"),
