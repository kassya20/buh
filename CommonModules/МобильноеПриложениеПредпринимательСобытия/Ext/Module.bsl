...
Функция ВыбратьУзлыРегистрацииИзменений(УзелОтправитель)
	...
	Запрос.Текст =
	"ВЫБРАТЬ
	|	МобильноеПриложениеПредприниматель.Ссылка КАК Ссылка
	|ИЗ
	|	ПланОбмена.МобильноеПриложениеПредприниматель КАК МобильноеПриложениеПредприниматель
	|ГДЕ
	|	НЕ МобильноеПриложениеПредприниматель.ЭтотУзел
	|	И МобильноеПриложениеПредприниматель.Ссылка <> &УзелОтправитель";
	Запрос.УстановитьПараметр("УзелОтправитель", УзелОтправитель);
