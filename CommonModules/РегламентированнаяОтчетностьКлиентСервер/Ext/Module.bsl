...
Функция ОперацииСРегламентированнымОтчетом(ИмяОтчета, ИмяФормы) Экспорт
	...
	РеглОтчеты.Вставить(ВРег("РегламентированныйОтчет3_НДФЛ.ФормаОтчета2025Кв4"),
		Новый ФиксированнаяСтруктура(ОперацииСРеглОтчетом));
	...
	РеглОтчеты.Вставить(ВРег("РегламентированныйОтчетПрибыль.ФормаОтчета2025Кв1"),
		Новый ФиксированнаяСтруктура(ОперацииСРеглОтчетом));
	РеглОтчеты.Вставить(ВРег("РегламентированныйОтчетПрибыль.ФормаОтчета2025Кв4"),
		Новый ФиксированнаяСтруктура(ОперацииСРеглОтчетом));
	...
	РеглОтчеты.Вставить(ВРег("РегламентированныйОтчетНДС.ФормаОтчета2025Кв1"),
		Новый ФиксированнаяСтруктура(ОперацииСРеглОтчетом));
	РеглОтчеты.Вставить(ВРег("РегламентированныйОтчетНДС.ФормаОтчета2026Кв1"),
		Новый ФиксированнаяСтруктура(ОперацииСРеглОтчетом));
	...
	РеглОтчеты.Вставить(ВРег("РегламентированныйОтчетУСН.ФормаОтчета2024Кв1"),
		Новый ФиксированнаяСтруктура(ОперацииСРеглОтчетом));
	РеглОтчеты.Вставить(ВРег("РегламентированныйОтчетУСН.ФормаОтчета2025Кв1"),
		Новый ФиксированнаяСтруктура(ОперацииСРеглОтчетом));
	...
	РеглОтчеты.Вставить(ВРег("РегламентированныйОтчетРасчетПоСтраховымВзносам.ФормаОтчета2025Кв1"),
		Новый ФиксированнаяСтруктура(ОперацииСРеглОтчетом));
	РеглОтчеты.Вставить(ВРег("РегламентированныйОтчетРасчетПоСтраховымВзносам.ФормаОтчета2026Кв1"),
		Новый ФиксированнаяСтруктура(ОперацииСРеглОтчетом));
	...
	РеглОтчеты.Вставить(ВРег("РегламентированныйОтчетБухОтчетностьМП.ФормаОтчета2015Кв4"),
		Новый ФиксированнаяСтруктура(ОперацииСРеглОтчетом));
	РеглОтчеты.Вставить(ВРег("РегламентированныйОтчетБухОтчетностьМП.ФормаОтчета2025Кв1"),
		Новый ФиксированнаяСтруктура(ОперацииСРеглОтчетом));
	...
	РеглОтчеты.Вставить(ВРег("РегламентированныйОтчетИмущество.ФормаОтчета2024Кв4"),
		Новый ФиксированнаяСтруктура(ОперацииСРеглОтчетом));
	РеглОтчеты.Вставить(ВРег("РегламентированныйОтчетИмущество.ФормаОтчета2025Кв4"),
		Новый ФиксированнаяСтруктура(ОперацииСРеглОтчетом));
...
Функция СтатусыОбъектовРеглОтчетностиПриРучномВводе(ОбъектРеглОтчетности = Неопределено, ВидКонтролирующегоОргана = Неопределено) Экспорт
	...
	Если ВидКонтролирующегоОргана = ПредопределенноеЗначение("Перечисление.ТипыКонтролирующихОрганов.Минобороны") ИЛИ
		...
		Параметры.ИсточникОтчета = "РегламентированныйОтчетКассовыйПланГОЗ" ИЛИ
		Параметры.ИсточникОтчета = "РегламентированныйОтчетГОЗФорма1д" ИЛИ
		Параметры.ИсточникОтчета = "РегламентированныйОтчетГОЗФорма2д" ИЛИ
		Параметры.ИсточникОтчета = "РегламентированныйОтчетГОЗФорма3д" Тогда
	...
	ИначеЕсли ТипЗнч(ОбъектРеглОтчетности) = Тип("ФормаКлиентскогоПриложения")
		...
		Статусы.Добавить(ИнтерфейсыВзаимодействияБРОКлиентСервер.СтатусВРаботеСтрокой());
...
// Возвращает адрес личного кабинета природопользователя
Функция АдресЛичногоКабинетаПриродопользователя() Экспорт 
	Возврат "https://lk.rpn.gov.ru/";
КонецФункции
...
#Область ПреобразованиеРеквизитовФормы

// Преобразует таблицу значений в массив структур. Применяется для передачи набора данных
// между формами, если не требуется передача управления на сервер. Для обратной загрузки
// рекомендуется использовать РегламентированнаяОтчетностьКлиентСервер.МассивВРеквизитТаблицаЗначений.
// 
// Параметры:
//  Реквизит - ДанныеФормыКоллекция
//  Колонки - Строка
// 
// Возвращаемое значение:
//  Массив из Структура
// 
Функция РеквизитТаблицаЗначенийВМассив(Реквизит, Колонки) Экспорт
	
	ДанныеРеквизита = Новый Массив();
	
	Для Каждого СтрокаКоллекции Из Реквизит Цикл
		ПредставлениеСтрокиКоллекции = Новый Структура(Колонки);
		ЗаполнитьЗначенияСвойств(ПредставлениеСтрокиКоллекции, СтрокаКоллекции);
		ДанныеРеквизита.Добавить(ПредставлениеСтрокиКоллекции);
	КонецЦикла;
...
// Загружает представление таблицы значений в реквизит формы с типом Таблица значений.
// Используется для загрузки в реквизит сведений, полученных при помощи
// РегламентированнаяОтчетностьКлиентСервер.РеквизитТаблицаЗначенийВМассив.
// 
// Параметры:
//  Реквизит - ДанныеФормыКоллекция
//  ПредставлениеКоллекции - Массив из Структура
// 
Процедура МассивВРеквизитТаблицаЗначений(Реквизит, ПредставлениеКоллекции) Экспорт
	
	Если ТипЗнч(ПредставлениеКоллекции) <> Тип("Массив") Тогда
		Возврат;
	КонецЕсли;
	
	Для Каждого ПредставлениеЭлементаКоллекции Из ПредставлениеКоллекции Цикл
		СтрокаЭлементаКоллекции = Реквизит.Добавить();
		ЗаполнитьЗначенияСвойств(СтрокаЭлементаКоллекции, ПредставлениеЭлементаКоллекции);
	КонецЦикла;
	
КонецПроцедуры

// Преобразует дерево значений в структуру. Применяется для передачи набора данных
// между формами, если не требуется передача управления на сервер. Для обратной загрузки
// рекомендуется использовать РегламентированнаяОтчетностьКлиентСервер.СтруктураВРеквизитДеревоЗначений.
// 
// Параметры:
//  Реквизит - ДанныеФормыДерево
//  Колонки - Строка
// 
// Возвращаемое значение:
//  Структура:
//   * Значения - Структура, Неопределено -
//   * Строки - Массив из Структура
// 
Функция РеквизитДеревоЗначенийВСтруктуру(Реквизит, Колонки) Экспорт
	
	ПредставлениеДерева = Новый Структура("Значения, Строки", Неопределено, Новый Массив());
	
	// Применяется итеративный поиск в ширину. Структура в очереди содержит в себе элемент пребразуемой коллекции
	// и узел представления дерева, для последующего добавления к нему дочерних элементов.
	ОчередьОбхода = Новый Массив();
	ОчередьОбхода.Добавить(Новый Структура("Элемент, Узел", Реквизит, ПредставлениеДерева));
	
	Пока ОчередьОбхода.Количество() > 0 Цикл
		ОбходимыйЭлемент = ОчередьОбхода[0];
		ОчередьОбхода.Удалить(0);
		Для Каждого ЭлементКоллекции Из ОбходимыйЭлемент.Элемент.ПолучитьЭлементы() Цикл
			ДанныеУзла = Новый Структура(Колонки);
			ЗаполнитьЗначенияСвойств(ДанныеУзла, ЭлементКоллекции);
			УзелЭлемента = Новый Структура("Значения, Строки", ДанныеУзла, Новый Массив());
			ОбходимыйЭлемент.Узел.Строки.Добавить(УзелЭлемента);
			ОчередьОбхода.Добавить(Новый Структура("Элемент, Узел", ЭлементКоллекции, УзелЭлемента));
		КонецЦикла;
	КонецЦикла;
	
	Возврат ПредставлениеДерева;
	
КонецФункции

// Загружает представление дерева значений в реквизит формы с типом Дерево значений.
// Используется для загрузки в реквизит сведений, полученных при помощи
// РегламентированнаяОтчетностьКлиентСервер.РеквизитДеревоЗначенийВСтруктуру.
// 
// Параметры:
//  Реквизит - ДанныеФормыДерево
//  ПредставлениеДерева - Структура:
//   * Значения - Структура, Неопределено -
//   * Строки - Массив из Структура
// 
Процедура СтруктураВРеквизитДеревоЗначений(Реквизит, ПредставлениеДерева) Экспорт
	
	Если ТипЗнч(ПредставлениеДерева) <> Тип("Структура") Тогда
		Возврат;
	КонецЕсли;
	
	ОчередьОбхода = Новый Массив();
	ОчередьОбхода.Добавить(Новый Структура("УзелПредставления, ЭлементДерева", ПредставлениеДерева, Реквизит));
	
	Пока ОчередьОбхода.Количество() > 0 Цикл
		ОбходимыйЭлемент = ОчередьОбхода[0];
		ОчередьОбхода.Удалить(0);
		Для Каждого ЭлементПредставления Из ОбходимыйЭлемент.УзелПредставления.Строки Цикл
			ЭлементДерева = ОбходимыйЭлемент.ЭлементДерева.ПолучитьЭлементы().Добавить();
			ЗаполнитьЗначенияСвойств(ЭлементДерева, ЭлементПредставления.Значения);
			ОчередьОбхода.Добавить(Новый Структура("УзелПредставления, ЭлементДерева",
				ЭлементПредставления, ЭлементДерева));
		КонецЦикла;
	КонецЦикла;
...
Функция ПредставлениеПериодаРасширенное(ДатаНачала, ДатаОкончания, ДополнительныеПараметры) Экспорт
	...
	Если ВРег(СтрЗаменить(ФорматнаяСтрока, " ", "")) = "ФП=ИСТИНА" И Год(ДатаНачала) = Год(ДатаОкончания)
		...
		Возврат СтрШаблон(НСтр("ru='%1 полугодие %2 г.'"), Месяц(ДатаОкончания) / 6, Формат(ДатаОкончания, "ДФ=гггг"));
