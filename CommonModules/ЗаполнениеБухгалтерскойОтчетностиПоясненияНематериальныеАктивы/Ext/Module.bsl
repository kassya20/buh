...
Процедура ЗаполнитьПояснениеНематериальныеАктивы(ЗаполняемыеДанные, Классификаторы, КонтекстЗаполненияОтчета)
	...
	|			И (&УсловиеОбъекты)
	|		ЛЕВОЕ СОЕДИНЕНИЕ Перечисление.ВидыНематериальныхАктивов КАК ВидыНематериальныхАктивов
	...
	ПараметрыРасшифровки = ПараметрыРасшифровкиНематериальныеАктивы(КонтекстЗаполненияОтчета);
	...
	ЗаполнитьПояснениеНематериальныеАктивыАмортизируемыеНеамортизируемые(ЗаполняемыеДанные, ИмяТаблицы, ПараметрыРасшифровки, Запрос, КлассификаторыТаблицы);
	
КонецПроцедуры

Процедура ЗаполнитьПояснениеНематериальныеАктивыНаличиеДвижение(ЗаполняемыеДанные, ИмяТаблицы, ПараметрыРасшифровки, Запрос)
	
	ШаблоныРасшифровки = ШаблоныРасшифровкиНематериальныеАктивыНаличиеДвижение(ПараметрыРасшифровки);
	...
	Пока ВыборкаГруппа.Следующий() Цикл
		...
		Пока ВыборкаВидПрава.Следующий() Цикл
			...
			УстановитьПараметрыТекстовРасшифровки(ПараметрыРасшифровки, ИмяТаблицы, ВыборкаВидПрава);
...
Процедура ЗаполнитьПояснениеНематериальныеАктивыСозданныеОрганизациейНаличиеДвижение(ЗаполняемыеДанные, ИмяТаблицы, ПараметрыРасшифровки, Запрос)
	
	ШаблоныРасшифровки = ШаблоныРасшифровкиНематериальныеАктивыСозданныеОрганизациейНаличиеДвижение(ПараметрыРасшифровки);
...
Процедура ЗаполнитьПояснениеНематериальныеАктивыАмортизируемыеНеамортизируемые(ЗаполняемыеДанные, ИмяТаблицы, ПараметрыРасшифровки, Запрос, Классификаторы)
	...
	ШаблоныРасшифровки = ШаблоныРасшифровкиНематериальныеАктивыАмортизируемыеНеамортизируемые(ПараметрыРасшифровки);
	...
	Пока ВыборкаВид.Следующий() Цикл
		...
		Пока ВыборкаГруппа.Следующий() Цикл
			...
			Пока ВыборкаСпособПоступления.Следующий() Цикл
				...
				УстановитьПараметрыТекстовРасшифровки(ПараметрыРасшифровки, ИмяТаблицы, ВыборкаСпособПоступления);
...
Процедура НачатьДобавлениеСтрокиНематериальныеАктивыНаличиеДвижение(ВыводТаблицы, Выборка, ШаблоныРасшифровки, ПараметрыРасшифровки)
...
Процедура ДобавитьСлагаемое(ВыводТаблицы, ШаблоныРасшифровки, ПараметрыРасшифровки, Выборка)
	...
	Для Каждого ШаблонРасшифровки Из ШаблоныРасшифровки Цикл
		...
		ВывестиРасшифровкуНаличиеДвижениеНМА(ВыводТаблицы, ИмяКолонки, ШаблоныРасшифровки, ПараметрыРасшифровки, Выборка);
		
	КонецЦикла;
	
КонецПроцедуры

Функция НачатьДобавлениеСтрокиТаблицыОтчета(ВыводТаблицы, ШаблоныРасшифровки, ПараметрыРасшифровки)
...
Процедура НачатьДобавлениеСтрокиНематериальныеАктивыАмортизируемыеНеамортизируемые(ВыводТаблицы, Выборка, ШаблоныРасшифровки, ПараметрыРасшифровки)
...
Процедура ДобавитьСлагаемоеАмортизируемыеПриобретенные(ВыводТаблицы,  ШаблоныРасшифровки, ПараметрыРасшифровки, Выборка, ИсключаемыеОбъекты)
	
	СтрокаТаблицы = ЗаполнениеБухгалтерскойОтчетностиТабличное.КрайняяСтрокаТаблицы(ВыводТаблицы);
	
	ЗначенияНастроекОтчета = ЗаполнениеБухгалтерскойОтчетностиРасшифровка.ЗначенияНастроекОтчетаНематериальныеАктивы("", ПараметрыРасшифровки, Выборка);
...
Функция ПараметрыРасшифровкиНематериальныеАктивы(КонтекстЗаполненияОтчета)
	...
	ПараметрыТекстов.Вставить("ИмяРеквизитаИсключительноеПраво",
		Метаданные.Справочники.НематериальныеАктивы.Реквизиты.ЭтоИсключительноеПраво.Представление());
	ПараметрыТекстов.Вставить("Организации", КонтекстЗаполненияОтчета.Организации);
...
Функция СчетаРасшифровки()
	...
	ПараметрыСчетов.Вставить("СчетОбесценение", ЗаполнениеБухгалтерскойОтчетностиИтоги.Счет("05.02"));
	ПараметрыСчетов.Вставить("СчетДолгосрочныеАктивыКПродаже", ЗаполнениеБухгалтерскойОтчетностиИтоги.Счет("04.09"));
...
Функция ШаблоныРасшифровкиНематериальныеАктивыНаличиеДвижение(ПараметрыРасшифровки)
	
	СчетаРасшифровки = ПараметрыРасшифровки.СчетаРасшифровки;
	...
	ДобавитьЗаголовокШаблонаРасшифровки(Шаблоны,
		...
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Сальдо по счету %1 (кроме %2) [НаименованиеГруппыПорядокРасчета]'"),
			СчетаРасшифровки.СчетСтоимость.Код,
			СчетаРасшифровки.СчетДолгосрочныеАктивыКПродаже.Код));
	...
	ДобавитьЗаголовокШаблонаРасшифровки(Шаблоны,
		...
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Оборот по кредиту счета %1 (кроме %2) [НаименованиеГруппыПорядокРасчета].
			|Исключаются обороты по передаче между филиалами, переоценке, переклассификации в долгосрочные активы к продаже'"),
			СчетаРасшифровки.СчетСтоимость.Код,
			СчетаРасшифровки.СчетДолгосрочныеАктивыКПродаже.Код));
	...
	ДобавитьЗаголовокШаблонаРасшифровки(Шаблоны,
		...
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Оборот по дебету счета %1 в корреспонденции со счетом %2 [НаименованиеГруппыПорядокРасчета].
			|Исключаются обороты по переклассификации в долгосрочные активы к продаже'"),
	...
	ДобавитьЗаголовокШаблонаРасшифровки(Шаблоны,
		...
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			...
			ПараметрыРасшифровки.ВидСтатьиПереоценка));
	...
	ДобавитьЗаголовокШаблонаРасшифровки(Шаблоны,
		...
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Оборот по дебету счета %1 в корреспонденции со счетом %2 по объектам, имеющим на отчетную дату сальдо по счету %1, [НаименованиеГруппыПорядокРасчета]'"),
			СчетаРасшифровки.СчетДолгосрочныеАктивыКПродаже.Код, // 04.09
			СчетаРасшифровки.СчетСтоимость.Код)); // 04
	...
	ДобавитьЗаголовокШаблонаРасшифровки(Шаблоны,
		...
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Оборот по кредиту счета %1 в корреспонденции со счетом %2 по объектам, имеющим на отчетную дату сальдо по счету %1, [НаименованиеГруппыПорядокРасчета]'"),
			СчетаРасшифровки.СчетДолгосрочныеАктивыКПродаже.Код, // 04.09
			СчетаРасшифровки.СчетАмортизацияОбесценение.Код)); // 05
	...
	НачалоПервоначальная.Вставить(
		"СтоимостьДАП",
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Исключая сальдо по счету %1'"),
			СчетаРасшифровки.СчетДолгосрочныеАктивыКПродаже.Код)); // 04.09
	...
	СписаноПервоначальная.Вставить(
		"СтоимостьДАП",
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'За вычетом оборота по кредиту счета %1'"),
			СчетаРасшифровки.СчетДолгосрочныеАктивыКПродаже.Код)); // 04.09
		
	СписаноПервоначальная.Вставить(
		"Переклассификация",
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'За вычетом оборота по дебету счета %1 в корреспонденции со счетом %2 по объектам, имеющим на отчетную дату сальдо по счету %1'"),
			СчетаРасшифровки.СчетДолгосрочныеАктивыКПродаже.Код, //04.09
			СчетаРасшифровки.СчетСтоимость.Код)); // 04
	...
	СписаноПервоначальная.Вставить(
		"МежфилиальныйОборот",
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'За вычетом оборота по кредиту счета %1 в корреспонденции со счетом %2 по обособленным подразделениям, включенным в состав отчетности'"),
			СчетаРасшифровки.СчетСтоимость.Код, // 04
	...
	СписаноАмортизация.Вставить(
		"Переклассификация",
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'За вычетом оборота по дебету счета %1 в корреспонденции со счетом %2 по объектам, имеющим на отчетную дату сальдо по счету %2'"),
			СчетаРасшифровки.СчетАмортизацияОбесценение.Код, // 05
			СчетаРасшифровки.СчетДолгосрочныеАктивыКПродаже.Код)); // 04.09
	...
	Амортизация.Вставить(
		"СтоимостьАмортизацияОбесценение",
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Оборот по кредиту счета %1 (исключая оборот по кредиту счета %2)'"),
			СчетаРасшифровки.СчетАмортизацияОбесценение.Код, // 05
			СчетаРасшифровки.СчетОбесценение.Код)); // 05.02
	...
	Амортизация.Вставить(
		"МежфилиальныйОборот",
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'За вычетом оборота по кредиту счета %1 (исключая оборот по кредиту счета %2) в корреспонденции со счетом %3 по обособленным подразделениям, включенным в состав отчетности'"),
			СчетаРасшифровки.СчетАмортизацияОбесценение.Код, // 05
			СчетаРасшифровки.СчетОбесценение.Код, // 05.02
			СчетаРасшифровки.СчетПередачи.Код)); // 79
		
	// Обесценение
	Обесценение = Шаблоны["Обесценение"];
	
	Обесценение.Вставить(
		"СтоимостьАмортизацияОбесценение",
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Оборот по кредиту счета %1'"),
			СчетаРасшифровки.СчетОбесценение.Код)); // 05.02
	...
	ПереклассифицированоПервоначальная.Вставить(
		"Переклассификация",
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Оборот по дебету счета %1 в корреспонденции со счетом %2 по объектам, имеющим на отчетную дату сальдо по счету %1'"),
			СчетаРасшифровки.СчетДолгосрочныеАктивыКПродаже.Код, // 04.09
			СчетаРасшифровки.СчетСтоимость.Код)); // 04
	...
	ПереклассифицированоАмортизация.Вставить(
		"Переклассификация",
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Оборот по кредиту счета %1 в корреспонденции со счетом %2 по объектам, имеющим на отчетную дату сальдо по счету %1'"),
			СчетаРасшифровки.СчетДолгосрочныеАктивыКПродаже.Код, // 04.09
			СчетаРасшифровки.СчетАмортизацияОбесценение.Код)); // 05
...
Функция ШаблоныРасшифровкиНематериальныеАктивыАмортизируемыеНеамортизируемые(ПараметрыРасшифровки)
	...
	ТекстПорядокРасчета = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = 'Сальдо по счетам %1, %2 (кроме %3) [НаименованиеГруппыПорядокРасчета]'"),
		СчетаРасшифровки.СчетСтоимость.Код,
		СчетаРасшифровки.СчетАмортизацияОбесценение.Код,
		СчетаРасшифровки.СчетДолгосрочныеАктивыКПродаже.Код);
	...
	ШаблоныНаличиеДвижение = ШаблоныРасшифровкиНематериальныеАктивыНаличиеДвижение(ПараметрыРасшифровки);
...
Процедура ВывестиРасшифровкуНаличиеДвижениеНМА(ВыводТаблицы, ИмяКолонки, ШаблоныРасшифровки, ПараметрыРасшифровки, Выборка)
	...
	ЗначенияНастроекОтчета = ЗаполнениеБухгалтерскойОтчетностиРасшифровка.ЗначенияНастроекОтчетаНематериальныеАктивы(ИмяКолонки, ПараметрыРасшифровки, Выборка);
	...
	Если ВыводТаблицы.ИмяТаблицы = "НематериальныеАктивыНаличиеДвижение" Тогда
		...
		ЗаполнениеБухгалтерскойОтчетностиРасшифровка.НастроитьОтборПоВидуСубконто(
			ЗначенияНастроекОтчета,
			"Субконто%1.ЭтоИсключительноеПраво",
			ЗначенияНастроекОтчета.Счет,
			ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.НематериальныеАктивы,
			Выборка.ВидПрава = "Исключительное");
...
Процедура УстановитьПараметрыТекстовРасшифровки(ПараметрыРасшифровки, ИмяТаблицы, Выборка)
	...
	Если ИмяТаблицы = "НематериальныеАктивыАмортизируемыеНеамортизируемые" Тогда
		...
		ТекстСпособПоступленияПорядокРасчета = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				...
				ПараметрыРасшифровки.СпособПоступленияСтроительство,
				ПараметрыРасшифровки.ВидОбъектовНИОКР);
				
		ПараметрыРасшифровки.НаименованиеГруппы =
		...
		ПараметрыРасшифровки.НаименованиеГруппыПорядокРасчета =
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
	...
	Иначе
		...
		ШаблонНаименованияПорядокРасчета = НСтр("ru = '%1, у которых не отмечен реквизит ""%2""%3'");
		
		Если Исключительное Тогда
			ШаблонНаименования = НСтр("ru = '%1%2 (исключительные права)'");
			ШаблонНаименованияПорядокРасчета = НСтр("ru = '%1, у которых отмечен реквизит ""%2""%3'");
		КонецЕсли;
		...
		ПараметрыРасшифровки.НаименованиеГруппыПорядокРасчета =
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				ШаблонНаименованияПорядокРасчета,
				НаименованиеГруппыПорядокРасчета,
				ПараметрыРасшифровки.ИмяРеквизитаИсключительноеПраво,
				ТекстСозданныеОрганизациейПорядокРасчета);
...
Процедура СоздатьНаличиеДвижениеНМА(МенеджерВременныхТаблиц, КонтекстЗаполненияОтчета)
	...
	Запрос.УстановитьПараметр("Счет_05_02",   ИерархияСчета("05.02"));
	Запрос.УстановитьПараметр("Счет_04",      ИерархияСчета("04"));
	Запрос.УстановитьПараметр("Счет_04_09",   ИерархияСчета("04.09"));
	...
	|	СУММА(ХозрасчетныйОстаткиИОбороты.СуммаОборотКт) КАК КО,
	|	СУММА(ХозрасчетныйОстаткиИОбороты.СуммаКонечныйОстатокДт) КАК СКД
	|ПОМЕСТИТЬ Счет_04_09
	|ИЗ
	|	РегистрБухгалтерии.Хозрасчетный.ОстаткиИОбороты(&НачПериода, &КонПериода, , , Счет В (&Счет_04_09), &СубконтоНМА, Организация В (&Организации)) КАК ХозрасчетныйОстаткиИОбороты
	|
	|СГРУППИРОВАТЬ ПО
	|	ХозрасчетныйОстаткиИОбороты.Субконто1,
	|	ХозрасчетныйОстаткиИОбороты.Организация
	...
	|	СУММА(ВЫБОР
	|			КОГДА ХозрасчетныйОстаткиИОбороты.Счет В (&Счет_05_02)
	|				ТОГДА 0
	...
	|				И НЕ МежфилиальныйОборот.Счет В (&Счет_05_02)
	|			ТОГДА МежфилиальныйОборот.СуммаОборотКт
	|		ИНАЧЕ 0
	|	КОНЕЦ КАК ОБ_79__05_01,
	|	ВЫБОР
	|		КОГДА МежфилиальныйОборот.Счет В (&Счет_05_02)
	|			ТОГДА МежфилиальныйОборот.СуммаОборотКт
	|		ИНАЧЕ 0
	|	КОНЕЦ КАК ОБ_79__05_02
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	Счет_04_09.НМА КАК ДАП
	|ПОМЕСТИТЬ ДолгосрочныеАктивыКПродаже
	|ИЗ
	|	Счет_04_09 КАК Счет_04_09
	|ГДЕ
	|	Счет_04_09.СКД > 0
	|
	|ИНДЕКСИРОВАТЬ ПО
	...
	|	СУММА(ВЫБОР
	|			КОГДА ХозрасчетныйОбороты.Счет В (&Счет_04)
	|					И НЕ ХозрасчетныйОбороты.Счет В (&Счет_04_09)
	|				ТОГДА ХозрасчетныйОбороты.СуммаОборотКт
	|			ИНАЧЕ 0
	|		КОНЕЦ) КАК ОБ_04_09__04,
	|	СУММА(ВЫБОР
	|			КОГДА ХозрасчетныйОбороты.Счет В (&Счет_05)
	|				ТОГДА ХозрасчетныйОбороты.СуммаОборотДт
	|			ИНАЧЕ 0
	|		КОНЕЦ) КАК ОБ_05__04_09
	|ПОМЕСТИТЬ Счет_0405__04_09
	|ИЗ
	|	РегистрБухгалтерии.Хозрасчетный.Обороты(
	|			&НачПериода,
	|			&КонПериода,
	...
	|				И Субконто1 В
	|					(ВЫБРАТЬ
	|						ДолгосрочныеАктивыКПродаже.ДАП КАК ДАП
	|					ИЗ
	|						ДолгосрочныеАктивыКПродаже КАК ДолгосрочныеАктивыКПродаже),
	|			КорСчет В (&Счет_04_09),
	|			&СубконтоНМА) КАК ХозрасчетныйОбороты
	|
	|СГРУППИРОВАТЬ ПО
	|	ХозрасчетныйОбороты.Субконто1,
	|	ХозрасчетныйОбороты.Организация
	...
	|		0
	|	ИЗ
	|		Счет_04_09 КАК СтоимостьДАП
	|	
	|	ОБЪЕДИНИТЬ ВСЕ
	|	
	|	ВЫБРАТЬ
	|		Переклассификация.Организация,
	|		""Переклассификация"",
	|		Переклассификация.НМА,
	|		0,
	|		0,
	|		0,
	|		Переклассификация.ОБ_04_09__04,
	|		-Переклассификация.ОБ_05__04_09,
	|		0,
	|		0,
	|		0,
	|		0,
	...
	|		0
	|	ИЗ
	|		Счет_0405__04_09 КАК Переклассификация
	|	
	|	ОБЪЕДИНИТЬ ВСЕ
	|	
	|	ВЫБРАТЬ
	...
	|		0,
	|		0,
	|		-СтоимостьАмортизацияОбесценение.КО_05_01,
	|		-СтоимостьАмортизацияОбесценение.КО_05_02,
	|		0,
	|		0,
	|		0,
	|		0,
	...
	|		0,
	|		МежфилиальныйОборот.ОБ_79__05_01,
	|		МежфилиальныйОборот.ОБ_79__05_02,
	|		0,
	|		0,
	|		0,
	|		0,
	...
	|	ПоясненияПоРасшифровкам.Организация КАК Организация,
	|	ВЫБОР
	|		КОГДА НематериальныеАктивы.ВидНематериальногоАктива ЕСТЬ NULL
	|				ИЛИ НематериальныеАктивы.ВидНематериальногоАктива = ЗНАЧЕНИЕ(Перечисление.ВидыНематериальныхАктивов.ПустаяСсылка)
	|			ТОГДА ЗНАЧЕНИЕ(Перечисление.ВидыНематериальныхАктивов.ДругиеНМА)
	|		ИНАЧЕ НематериальныеАктивы.ВидНематериальногоАктива
	|	КОНЕЦ КАК Группа,
	|	ВЫБОР
	|		КОГДА ЕСТЬNULL(НематериальныеАктивы.ЭтоИсключительноеПраво, ЛОЖЬ)
	...
	|	ПервоначальныеСведения.НачислятьАмортизацию КАК НачислятьАмортизациюНачало,
	...
	|	ПервоначальныеСведения.НачислятьАмортизацию
	|ИЗ
	|	РегистрСведений.ПервоначальныеСведенияНМАБухгалтерскийУчет.СрезПоследних(
	|			&КонецДата,
	|			(Организация, НематериальныйАктив) В
	...
	|	ЭлементыАмортизации.НематериальныйАктив КАК НМА,
	|	ЭлементыАмортизации.Период КАК ПериодНачало,
	|	ЭлементыАмортизации.НачислятьАмортизацию КАК НачислятьАмортизациюНачало,
	|	ДАТАВРЕМЯ(1, 1, 1) КАК ПериодКонец,
	|	ЛОЖЬ КАК НачислятьАмортизациюКонец
	|ПОМЕСТИТЬ ВТ_ЭлементыАмортизацииНМАБухгалтерскийУчет
	|ИЗ
	...
	|					ПоясненияПоОбъектам.НМА
	|				ИЗ
	|					ПоясненияПоОбъектам КАК ПоясненияПоОбъектам)) КАК ЭлементыАмортизации
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	|	ЭлементыАмортизации.Организация,
	|	ЭлементыАмортизации.НематериальныйАктив,
	|	ДАТАВРЕМЯ(1, 1, 1),
	|	ЛОЖЬ,
	...
	|				КОГДА ЕСТЬNULL(ПервоначальныеСведения.ПериодНачало, ДАТАВРЕМЯ(1, 1, 1)) <= ЭлементыАмортизации.ПериодНачало
	|					ТОГДА ЭлементыАмортизации.НачислятьАмортизациюНачало
	|				ИНАЧЕ ПервоначальныеСведения.НачислятьАмортизациюНачало
	|			КОНЕЦ, ЛОЖЬ)) КАК АмортизируемыеНачало,
	|	МАКСИМУМ(ЕСТЬNULL(ВЫБОР
	|				КОГДА ЕСТЬNULL(ПервоначальныеСведения.ПериодКонец, ДАТАВРЕМЯ(1, 1, 1)) <= ЭлементыАмортизации.ПериодКонец
	|					ТОГДА ЭлементыАмортизации.НачислятьАмортизациюКонец
	|				ИНАЧЕ ПервоначальныеСведения.НачислятьАмортизациюКонец
	|			КОНЕЦ, ЛОЖЬ)) КАК АмортизируемыеКонец
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_ЭлементыАмортизацииНМАБухгалтерскийУчет КАК ЭлементыАмортизации
	|		ПО ПоясненияПоОбъектам.Организация = ЭлементыАмортизации.Организация
	|			И ПоясненияПоОбъектам.НМА = ЭлементыАмортизации.НМА
	|
	|СГРУППИРОВАТЬ ПО
	|	ПоясненияПоОбъектам.Организация,
	|	ПоясненияПоОбъектам.НМА
	...
	|	ЕСТЬNULL(ПоясненияПоОбъектамАмортизируемыеНеамортизируемые.Группа, ЗНАЧЕНИЕ(Перечисление.ВидыНематериальныхАктивов.ПустаяСсылка)) КАК Группа,
	...
	|	ЕСТЬNULL(ПоясненияПоОбъектамАмортизируемыеНеамортизируемые.Группа, ЗНАЧЕНИЕ(Перечисление.ВидыНематериальныхАктивов.ПустаяСсылка))
	|
	|ИМЕЮЩИЕ
	...
	|
	|////////////////////////////////////////////////////////////////////////////////
	|УНИЧТОЖИТЬ ВТ_ЭлементыАмортизацииНМАБухгалтерскийУчет
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
