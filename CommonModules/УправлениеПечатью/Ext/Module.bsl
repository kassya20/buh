...
//
Функция ПодписиИПечатиОбластей(ОбъектыПечати, ПараметрыВывода = Неопределено) Экспорт
	
	ПодписиИПечати = ПодписиИПечатиОбъектов(ОбъектыПечати, ПараметрыВывода);
...
Функция ПодписиИПечатиОбъектов(Знач ОбъектыПечати, ПараметрыВывода = Неопределено) Экспорт
	...
	УправлениеПечатьюПереопределяемый.ПриПолученииПодписейИПечатей(СписокОбъектов, ПодписиИПечати, ПараметрыВывода);
...
Процедура ВыполнитьКомандуПечатиВФайл(КомандаПечати, НастройкиСохранения, СписокОбъектов, Результат)
	...
	Если НастройкиСохранения.ПодписьИПечать Тогда
		Если ДанныеПечати.Свойство("ПараметрыВывода")
			И ДанныеПечати.ПараметрыВывода.Свойство("ОбъектыПечатиДляФаксимилеБП") Тогда
			ОбъектыПечатиОбъединенный = УправлениеПечатьюБП.ОбъединитьОбъектыПечатиФаксимиле(
				ДанныеПечати.ПараметрыВывода.ОбъектыПечатиДляФаксимилеБП, ОбъектыПечати);
			ПодписиИПечатиОбластей = ПодписиИПечатиОбластей(ОбъектыПечатиОбъединенный, ДанныеПечати.ПараметрыВывода);
		Иначе
			ПодписиИПечатиОбластей = ПодписиИПечатиОбластей(ОбъектыПечати, ДанныеПечати.ПараметрыВывода);
		КонецЕсли;
	КонецЕсли;
