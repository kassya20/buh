...
// АПК:134-выкл - Количество параметров более 7, т.к. дополняет обработчик платформы, содержащий много параметров.
...
//  ДанныеВыбора - СписокЗначений из Дата - значения, из которых происходил выбор.
...
// Обработка выбора периода отчета из списка
// 
// Параметры:
//  ВыбранныйПериод - ЭлементСпискаЗначений - выбранное значение
//  ДополнительныеПараметры - Структура - дополнительные сведения которые содержат:
//      * Форма - ФормаКлиентскогоПриложения - форма отчета в которой производится выбор
//      * Список - см. ВыборПериодаКлиентСервер.ПолучитьСписокПериодов
//      * Элемент - ПолеФормы, КнопкаФормы - элемент формы, с которым связано событие
//
