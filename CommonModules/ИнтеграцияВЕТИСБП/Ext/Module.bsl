...
Процедура ЗаполнитьТоварыВЕТИС(ДокументОбъект, ДанныеЗаполнения)
	...
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "%УсловиеПродукцияВЕТИС%", УсловиеПродукцияВЕТИС());
...
Процедура ЗаполнитьСырьеПродукцию(ДокументОбъект, ДанныеЗаполнения)
	...
	Запрос.Текст = СтрЗаменить(ТекстЗапроса, "%УсловиеПродукцияВЕТИС%", УсловиеПродукцияВЕТИС());
...
Процедура ЗаполнитьСырье(ДокументОбъект, ДанныеЗаполнения)
...
Функция УсловиеПродукцияВЕТИС()
	
	Возврат  "(СправочникНоменклатура.ВидМаркировки = ЗНАЧЕНИЕ(Перечисление.ВидыПродукцииИС.ПодконтрольнаяПродукцияВЕТИС)
	...
	|	ИЛИ СправочникНоменклатура.ВидМаркировки = ЗНАЧЕНИЕ(Перечисление.ВидыПродукцииИС.МорепродуктыПодконтрольныеВЕТИС)
	|	ИЛИ СправочникНоменклатура.ВидМаркировки = ЗНАЧЕНИЕ(Перечисление.ВидыПродукцииИС.КонсервированнаяПродукцияПодконтрольнаяВЕТИС)
	|	ИЛИ СправочникНоменклатура.ВидМаркировки = ЗНАЧЕНИЕ(Перечисление.ВидыПродукцииИС.КормаДляЖивотныхПодконтрольныеВЕТИС)
	|	ИЛИ СправочникНоменклатура.ВидМаркировки = ЗНАЧЕНИЕ(Перечисление.ВидыПродукцииИС.КормаДляЖивотныхВлажныеПодконтрольныеВЕТИС)
	|	ИЛИ СправочникНоменклатура.ВидМаркировки = ЗНАЧЕНИЕ(Перечисление.ВидыПродукцииИС.МолочнаяПродукцияПодконтрольнаяВЕТИС))";
