...
//
Функция НачатьЗагрузкуОперацийОнлайнОплат(Знач ПараметрыЗагрузки) Экспорт
	
	ДлительнаяОперация = ОнлайнОплатыБП.НачатьЗагрузкуОперацийОнлайнОплат(ПараметрыЗагрузки);
...
Процедура ЗаполнитьПараметрыСообщенияБезШаблона(ПараметрыСообщения) Экспорт
	...
	ОнлайнОплатыБП.ЗаполнитьПараметрыСообщенияБезШаблона(ПараметрыСообщения);
