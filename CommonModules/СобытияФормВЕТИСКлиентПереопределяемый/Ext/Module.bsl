...
Процедура ОткрытьФормуВыбораНоменклатуры(Форма, ПараметрыНоменклатуры = Неопределено) Экспорт
	...
	ПродукцияПодконтрольнаяВЕТИС		= ИнтеграцияИСКлиентСервер.ВидыПродукцииПодконтрольныеВЕТИС();
	...
	ЭлементОтбора.ПравоеЗначение 		= ПродукцияПодконтрольнаяВЕТИС;
...
Процедура ОткрытьФормуСозданияНоменклатуры(Форма, ПараметрыНоменклатуры, ЕдиницаИзмеренияВЕТИС) Экспорт
	...
	Если ЗначениеЗаполнено(ПараметрыНоменклатуры) Тогда
		...
		ЗначенияЗаполнения.Вставить("ВидМаркировки"		, ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ПодконтрольнаяПродукцияВЕТИС"));
