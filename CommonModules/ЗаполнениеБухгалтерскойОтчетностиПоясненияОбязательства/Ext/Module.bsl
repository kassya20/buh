...
Процедура ЗаполнитьПояснениеОбеспеченияОбязательств(ЗаполняемыеДанные, Классификаторы, КонтекстЗаполненияОтчета)
	...
	ПравилаУчета = Новый Структура;
	ПравилаУчета.Вставить("СчетаУчета", Новый Структура);
	ПравилаУчета.СчетаУчета.Вставить("Полученные", ПланыСчетов.Хозрасчетный.ОбеспеченияОбязательствИПлатежейПолученные);
	ПравилаУчета.СчетаУчета.Вставить("Выданные",   ПланыСчетов.Хозрасчетный.ОбеспеченияОбязательствИПлатежейВыданные);
	...
	ДетальныйУчет = ПолучитьФункциональнуюОпцию("УчетОбеспеченийОбязательствИПлатежей");
	...
	Если ПолучитьФункциональнуюОпцию("УчетОбеспеченийОбязательствИПлатежей") Тогда
	...
	|	ДоговорыКонтрагентов.ВидОбеспеченияОбязательствИПлатежей КАК ВидОбеспечения,
	|	ДоговорыКонтрагентов.ОбеспечениеВыданоЗа КАК ОбеспечениеВыданоЗа,
	|	Представление(ДоговорыКонтрагентов.ОбеспечениеВыданоЗа) КАК ОбеспечениеВыданоЗаПредставление,
