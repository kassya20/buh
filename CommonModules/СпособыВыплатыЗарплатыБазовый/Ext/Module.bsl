...
Процедура НачальноеЗаполнение() Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ЗарплатаКадрыДляНебольшихОрганизаций.Выплаты") Тогда
		...
		МодульВыплатаЗарплатыДляНебольшихОрганизаций.СпособыВыплатыЗарплатыДобавитьМежрасчетныеВыплаты();
	КонецЕсли;
...
Процедура ОбработкаПолученияДанныхВыбора(ДанныеВыбора, Параметры, СтандартнаяОбработка) Экспорт
	...
	ГруппаСпособов = ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(Параметры, "ГруппаСпособов", "ВсеВариантыВыплаты");
	ДоступныеСпособыРасчетов = Перечисления.СпособыРасчетовСФизическимиЛицами.ДоступныеСпособыРасчетов(ГруппаСпособов);
	...
	|	И СпособыВыплатыЗарплаты.СтатьяРасходов.СпособРасчетовСФизическимиЛицами В(&ДоступныеСпособыРасчетов)
	|	И &ПараметрыОтбора
	|
	|УПОРЯДОЧИТЬ ПО
	|	Вес,
