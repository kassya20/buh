...
Функция ОписаниеОперацииВыплаты() Экспорт
	...
	ОписаниеОперации.Вставить("ВидДокументаОснования", Перечисления.ВидыДокументовОснованийВедомостейНаВыплатуЗарплаты.ПустаяСсылка());
...
Функция ЗарплатаКВыплатеФизическихЛиц(
	...
	|	ЕСТЬNULL(ЗарплатаКВыплате.Организация, Сотрудники.Организация) КАК Организация,
...
Функция ВзысканияПоИсполнительнымДокументам(ЗарплатаКВыплате, ПорядокВыплаты, РассчитыватьВзысканныеСуммыПропорциональноВыплате, Финансирование)
	
	Если ПорядокВыплаты = Перечисления.ХарактерВыплатыЗарплаты.Аванс Тогда
		Взыскания = ВзысканияПоИсполнительнымДокументамАванс(ЗарплатаКВыплате, РассчитыватьВзысканныеСуммыПропорциональноВыплате, Финансирование);
	ИначеЕсли ПорядокВыплаты = Перечисления.ХарактерВыплатыЗарплаты.Зарплата Тогда
		Взыскания = ВзысканияПоИсполнительнымДокументамЗарплата(ЗарплатаКВыплате, РассчитыватьВзысканныеСуммыПропорциональноВыплате, Финансирование);
	Иначе
		Взыскания = ВзысканияПоИсполнительнымДокументамМежрасчет(ЗарплатаКВыплате, РассчитыватьВзысканныеСуммыПропорциональноВыплате, Финансирование);
	КонецЕсли;
...
Функция ВзысканияПоИсполнительнымДокументамАванс(ЗарплатаКВыплате, РассчитыватьВзысканныеСуммыПропорциональноВыплате, Финансирование)
	
	НачисленнаяЗарплата = ВзаиморасчетыССотрудниками.НачисленныйАвансФизическихЛицПоДокументам(ЗарплатаКВыплате, РассчитыватьВзысканныеСуммыПропорциональноВыплате, Финансирование);
	УчитываемыеВыплаты = ВзысканияПоИсполнительнымДокументамУчитываемыеВыплаты(ЗарплатаКВыплате, НачисленнаяЗарплата);
	
	ВзысканияПоДокументамОснованиям = ИсполнительныеЛисты.УдержанныеСуммыФизическихЛицПоДокументамАвансом(УчитываемыеВыплаты.Прямые, РассчитыватьВзысканныеСуммыПропорциональноВыплате, Финансирование);
	
	Возврат ВзысканияПоДокументамОснованиям;
	
КонецФункции

Функция ВзысканияПоИсполнительнымДокументамМежрасчет(ЗарплатаКВыплате, РассчитыватьВзысканныеСуммыПропорциональноВыплате, Финансирование)
	
	НачисленнаяЗарплата = ВзаиморасчетыССотрудниками.НачисленнаяЗарплатаФизическихЛицПоДокументам(ЗарплатаКВыплате, РассчитыватьВзысканныеСуммыПропорциональноВыплате, Финансирование);
	УчитываемыеВыплаты = ВзысканияПоИсполнительнымДокументамУчитываемыеВыплаты(ЗарплатаКВыплате, НачисленнаяЗарплата);
	
	// В межрасчет взыскания берем без учета ограничений.
	ВзысканияПоДокументамОснованиям = ИсполнительныеЛисты.УдержанныеСуммыФизическихЛицПоДокументам(УчитываемыеВыплаты.Прямые, РассчитыватьВзысканныеСуммыПропорциональноВыплате, Финансирование,
																									Ложь, УчитываемыеВыплаты.Сторно.Количество() > 0);
	
	УчестьВзысканноеВАванс(ВзысканияПоДокументамОснованиям, УчитываемыеВыплаты, РассчитыватьВзысканныеСуммыПропорциональноВыплате, Финансирование);
	
	Возврат ВзысканияПоДокументамОснованиям;
	
КонецФункции

Функция ВзысканияПоИсполнительнымДокументамЗарплата(ЗарплатаКВыплате, РассчитыватьВзысканныеСуммыПропорциональноВыплате, Финансирование)
	...
	ВзысканияПоДокументамОснованиям = ИсполнительныеЛисты.УдержанныеСуммыФизическихЛицПоДокументам(УчитываемыеВыплаты.Прямые, РассчитыватьВзысканныеСуммыПропорциональноВыплате, Финансирование,
																									Истина, УчитываемыеВыплаты.Сторно.Количество() > 0);
...
Функция ВзысканияПоИсполнительнымДокументамУчитываемыеВыплаты(ЗарплатаКВыплате, НачисленнаяЗарплата)
	...
	Разрезы = "ФизическоеЛицо, ДокументОснование, ПериодВзаиморасчетов";
	...
	Выплаты.Колонки.Добавить("СуммаНачисленнойЗарплаты", Метаданные.ОпределяемыеТипы.ДенежнаяСуммаЛюбогоЗнака.Тип);
	...
	Для Каждого Выплата Из Выплаты Цикл
		...
		Иначе
			...
			КонецЕсли;
			Выплата.СуммаНачисленнойЗарплаты = НачисленияВыплаты[0].Сумма;
		КонецЕсли;
	КонецЦикла;
	...
	Новый Структура(
			"Прямые,
			|Сторно",
			Выплаты.Скопировать(, Разрезы + ", Сумма, СуммаНачисленнойЗарплаты"),
			Выплаты.Скопировать(Новый Структура("Сторно", Истина), Разрезы + ", Сумма, СуммаНачисленнойЗарплаты"));
...
Процедура СоздатьВТЗарплатаКВыплате(
	...
	ПараметрыПолученияЗарплатыКВыплате.ВидДокументаОснования = ОписаниеОперации.ВидДокументаОснования;
...
Процедура УчестьВзысканноеВАванс(Взыскания, УчитываемыеВыплаты, РассчитыватьВзысканныеСуммыПропорциональноВыплате, Финансирование)
	
	ВзысканияАвансом = ИсполнительныеЛисты.УдержанныеСуммыФизическихЛицПоДокументамАвансом(УчитываемыеВыплаты.Сторно, РассчитыватьВзысканныеСуммыПропорциональноВыплате, Финансирование);
	
	Для каждого Строка Из ВзысканияАвансом Цикл
		НоваяСтрока = Взыскания.Добавить();
		ЗаполнитьЗначенияСвойств(НоваяСтрока, Строка);
		НоваяСтрока.СуммаВзыскано = -НоваяСтрока.СуммаВзыскано;
	КонецЦикла;
...
Процедура СоздатьВТУсловияВозвратаЗадолженности(МенеджерВременныхТаблиц) Экспорт
	ВедомостьНаВыплатуЗарплатыВнутренний.СоздатьВТУсловияВозвратаЗадолженности(МенеджерВременныхТаблиц);
КонецПроцедуры

Процедура ПрименитьОграниченияПогашенийЗадолженностей(Зарплата, ИгнорируемыеРегистраторы, ПериодРегистрации) Экспорт
	ВедомостьНаВыплатуЗарплатыВнутренний.ПрименитьОграниченияПогашенийЗадолженностей(Зарплата, ИгнорируемыеРегистраторы, ПериодРегистрации);
КонецПроцедуры
...
Процедура ЗагрузитьВыплаты(Ведомость, Зарплата, НДФЛ, КлючевыеПоляСостава = "ФизическоеЛицо") Экспорт
	...
	ДополнительныеРеквизиты = ВедомостьНаВыплатуЗарплатыВнутренний.ДополнительныеРеквизиты(Ведомость);
	...
	Для Каждого Группа Из Группы Цикл
		...
		Для Каждого СтрокаЗарплаты Из ЗарплатаГруппы Цикл
			...
			ЗаполнитьЗначенияСвойств(СтрокаТЧЗарплата, ДополнительныеРеквизиты);
...
Процедура УстановитьВзыскания(Ведомость, Зарплата, Финансирование = Неопределено) Экспорт
	
	РассчитыватьВзысканныеСуммыПропорциональноВыплате = Ложь;
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыРасширеннаяПодсистемы") Тогда
		...
		НастройкиЗарплаты = МодульРасчетЗарплатыРасширенный.НастройкиРасчетаЗарплаты();
		НастройкиЗарплаты.Свойство("РассчитыватьВзысканныеСуммыПропорциональноВыплате", РассчитыватьВзысканныеСуммыПропорциональноВыплате);
	КонецЕсли;
	
	ИспользоватьСтатьиФинансированияЗарплата = ПолучитьФункциональнуюОпцию("ИспользоватьСтатьиФинансированияЗарплата");
	
	КолонкиГруппировок = "ФизическоеЛицо, ДокументОснование";
	Если РассчитыватьВзысканныеСуммыПропорциональноВыплате И ИспользоватьСтатьиФинансированияЗарплата Тогда
		КолонкиГруппировок = КолонкиГруппировок + ", СтатьяРасходов, СтатьяФинансирования";
	КонецЕсли;
	...
	Взыскания = ВзысканияПоИсполнительнымДокументам(Зарплата, ПорядокВыплаты, РассчитыватьВзысканныеСуммыПропорциональноВыплате, Финансирование);
	Взыскания.Свернуть(КолонкиГруппировок, "СуммаВзыскано, СуммаКВыплате, СуммаНачисленнойЗарплаты");
	
	ФизическиеЛица = ОбщегоНазначения.ВыгрузитьКолонку(Взыскания, "ФизическоеЛицо", Истина);
	
	Для каждого ФизическоеЛицо Из ФизическиеЛица Цикл
		СуммаВзысканоФизическогоЛица = 0;
		ВзысканияФизическогоЛица = Взыскания.НайтиСтроки(Новый Структура ("ФизическоеЛицо", ФизическоеЛицо));
		Для каждого Строка Из ВзысканияФизическогоЛица Цикл
			СуммаВзысканоФизическогоЛица = СуммаВзысканоФизическогоЛица + Строка.СуммаВзыскано;
		КонецЦикла;
		
		// Отражаем взысканную сумму только в том случае, если она больше нуля по физическому лицу.
		Если СуммаВзысканоФизическогоЛица > 0 Тогда
			
			// Переносим взыскания с расшифровкой по документам-основаниям в таблицу зарплаты.
			Отбор = Новый Структура(КолонкиГруппировок);
			Для каждого ВзысканиеПоДокументамОснованиям Из ВзысканияФизическогоЛица Цикл
				Если ВзысканиеПоДокументамОснованиям.СуммаВзыскано <> 0 Тогда
					
					ЗаполнитьЗначенияСвойств(Отбор, ВзысканиеПоДокументамОснованиям);
					ВзысканиеЗарплата = Ведомость.Зарплата.НайтиСтроки(Отбор);
					
					Если ВзысканиеЗарплата.Количество() > 0 Тогда
						// относим на первую строку зарплаты
						Если РассчитыватьВзысканныеСуммыПропорциональноВыплате
							И ВзысканиеПоДокументамОснованиям.СуммаНачисленнойЗарплаты <> 0 Тогда
							ВзысканиеЗарплата[0].ВзысканнаяСумма = Окр(ВзысканиеПоДокументамОснованиям.СуммаКВыплате * ВзысканиеПоДокументамОснованиям.СуммаВзыскано / ВзысканиеПоДокументамОснованиям.СуммаНачисленнойЗарплаты, 2);
						Иначе
							ВзысканиеЗарплата[0].ВзысканнаяСумма = ВзысканиеПоДокументамОснованиям.СуммаВзыскано;
						КонецЕсли;
					КонецЕсли;
	...
	// Переносим также взыскания в таблицу состава, связывая с первой строкой состава этого физического лица.
	Для Каждого ФизическоеЛицо Из ФизическиеЛица Цикл
		СтрокаСостава = Ведомость.Состав.Найти(ФизическоеЛицо, "ФизическоеЛицо");
		Если СтрокаСостава = Неопределено Тогда
			Продолжить;
		КонецЕсли;
		Взыскания = Ведомость.Зарплата.НайтиСтроки(Новый Структура("ФизическоеЛицо", ФизическоеЛицо));
		
		ВзысканнаяСумма = 0;
		Для каждого Взыскание Из Взыскания Цикл
			ВзысканнаяСумма = ВзысканнаяСумма + Взыскание.ВзысканнаяСумма;
		КонецЦикла;
		
		СтрокаСостава.ВзысканнаяСумма = ВзысканнаяСумма;
	КонецЦикла;
