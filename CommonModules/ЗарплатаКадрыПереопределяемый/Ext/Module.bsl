...
// Переопределяет признак того, что организация применяет АУСН и передает данные об НДФЛ в банк/ЛК ФНС (автоматически или в ручном режиме).
//
// Параметры:
//   Организация - СправочникСсылка.Организации - Для чтения. Организация, для которой определяется признак.
//   ЗарегистрированоДляПередачиВБанкНаАУСН - Булево - Для изменения. По умолчанию Ложь. Следует изменить на Истина
//       в случае, если организация применяет АУСН и автоматически передает данные об НДФЛ в банк/ЛК ФНС.
//   МесяцАктуальности - Дата - Для чтения. Дата актуальности на которую необходимо получить признак.
Процедура ОрганизацияНаАУСНПередаетНДФЛвБанк(Организация, ЗарегистрированоДляПередачиВБанкНаАУСН, МесяцАктуальности) Экспорт
	
	ЗарегистрированоДляПередачиВБанкНаАУСН = УчетнаяПолитика.ПрименяетсяАУСН(Организация, МесяцАктуальности);
