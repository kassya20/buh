...
Процедура ПриОпределенииНастроекПечати(Настройки) Экспорт
	...
	УправлениеПечатьюБП.ПриОпределенииНастроекПечати(Настройки);
...
Процедура ПередДобавлениемКомандПечати(ИмяФормы, КомандыПечати, СтандартнаяОбработка) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ИнтеграцияС1СДокументооборотом") Тогда
		...
		МодульИнтеграцияС1СДокументооборотБазоваяФункциональность.ПередДобавлениемКомандПечати(
			ИмяФормы,
			КомандыПечати,
...
Процедура ПриПолученииНастроекСпискаКомандПечати(НастройкиСписка) Экспорт
	...
	Если НастройкиСписка.МенеджерКомандПечати = ЖурналыДокументов.Деньги
		...
		Или НастройкиСписка.МенеджерКомандПечати = ЖурналыДокументов.ПередачаМатериалов
		Или НастройкиСписка.МенеджерКомандПечати = ЖурналыДокументов.Документы 
		Или НастройкиСписка.МенеджерКомандПечати = ЖурналыДокументов.РозничныеПродажи
		Или НастройкиСписка.МенеджерКомандПечати = ЖурналыДокументов.Инвентаризация Тогда
		НастройкиСписка.АвтоматическоеЗаполнение = Ложь;
	КонецЕсли;
...
//
Процедура ПриПолученииПодписейИПечатей(Документы, ПодписиИПечати, ПараметрыВывода = Неопределено) Экспорт
	
	УправлениеПечатьюБП.ПриПолученииПодписейИПечатей(Документы, ПодписиИПечати, ПараметрыВывода);
...
Процедура ПечатьДокументовПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка) Экспорт
	...
	// Вызов делаем после ЭлектронноеВзаимодействие.ПечатьДокументовПриСозданииНаСервере,
	// т.к. производится переопределение некоторых команд ЭДО.
...
Процедура ПечатьДокументовПриЗагрузкеДанныхИзНастроекНаСервере(Форма, Настройки) Экспорт
	...
	УправлениеПечатьюБП.ПрочитатьНастройкиПечатиПриЗагрузкеДанныхИзНастроек(Форма, Настройки);
...
Процедура ПриОпределенииИсточниковДанныхПечати(Объект, ИсточникиДанныхПечати) Экспорт
	...
	УправлениеПечатьюБП.ПриОпределенииИсточниковДанныхПечати(Объект, ИсточникиДанныхПечати);
...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	СписокОбъектов.Добавить(Документы.АктОРасхожденияхПолученный);
	...
	СписокОбъектов.Добавить(Документы.ВыплатыСамозанятым);
	...
	СписокОбъектов.Добавить(Документы.ЗаявлениеОЗачетеВСчетПредстоящейОбязанности);
	...
	СписокОбъектов.Добавить(Документы.ИнвентаризацияКассы);
	...
	СписокОбъектов.Добавить(Документы.КоммерческоеПредложение);
	...
	СписокОбъектов.Добавить(Документы.НачалоСтадииРазработокНМА);
	...
	СписокОбъектов.Добавить(Документы.ОперацияПоЕдиномуНалоговомуСчету);
	СписокОбъектов.Добавить(Документы.ОперацияСИнвестиционнымВычетом);
	...
	СписокОбъектов.Добавить(Документы.ПереводОСВМалоценноеОборудование);
	...
	СписокОбъектов.Добавить(Документы.ПрекращениеАренды);
	...
	СписокОбъектов.Добавить(Документы.СведенияОбУдержанномНДФЛ);
	...
	СписокОбъектов.Добавить(Документы.ОбесценениеВнеоборотныхАктивов);
	...
	СписокОбъектов.Добавить(Документы.УведомлениеОбУменьшенииНалогаПоПатенту);
	...
	СписокОбъектов.Добавить(Документы.НачислениеТуристическогоНалога);
	...
	СписокОбъектов.Добавить(ЖурналыДокументов.Инвентаризация);
	...
	КомпонентыАмортизацииОС.ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов);
