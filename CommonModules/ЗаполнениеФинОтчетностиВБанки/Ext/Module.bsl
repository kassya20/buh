...
Функция ОписаниеВидовОтчетов() Экспорт
	...
	НоваяСтрока.ПредставлениеГруппы = ПредставлениеГруппы;
	НоваяСтрока.НомерГруппы         = НомерГруппы;
	НоваяСтрока.ИсточникОтчетаБРО   = "РегламентированныйОтчет3_НДФЛ";
	НоваяСтрока.ШаблонИмениФайла    = "BANK_NDFL3_%2_%3";
...
//
// Возвращаемое значение:
//	Структура - структура результата подготовки:
//  * Выгружен - Булево.
//  * Подготовлен - Булево.
//  * Ошибки - Массив.
//  * ТаблицаСообщений - ТаблицаЗначения.
//  * ИмяФайлаАрхива - Строка.
//  * ПодготовленныеФайлы  - Массив.
//
