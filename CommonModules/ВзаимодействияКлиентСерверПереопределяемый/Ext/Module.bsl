...
Процедура ПриОпределенииВозможныхПредметов(ТипыПредметов) Экспорт
	...
	ТипыПредметов.Добавить("ДокументСсылка.КоммерческоеПредложение");
	ТипыПредметов.Добавить("ДокументСсылка.ПрочееВзаимодействие");
	ТипыПредметов.Добавить("ЗадачаСсылка.ЗадачаИсполнителя");
