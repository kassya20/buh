...
Функция СоответсвиеПеречисленийСтатусам() Экспорт
	...
	СоответствиеВрем.Вставить(ПредопределенноеЗначение("Перечисление.СтатусыОтправки.ПустаяСсылка"), ИнтерфейсыВзаимодействияБРОКлиентСервер.СтатусВРаботеСтрокой());
...
Функция СоответсвиеСтатусовПеречислениям() Экспорт
	...
	СоответствиеВрем.Вставить(ИнтерфейсыВзаимодействияБРОКлиентСервер.СтатусВРаботеСтрокой(), ПредопределенноеЗначение("Перечисление.СтатусыОтправки.ПустаяСсылка"));
...
// Возвращает свойства криптопровайдера, поддерживаемого обменом с минобороны, или криптопровайдера из массива.
//
// Параметры:
//  Имя                            - Строка - имя криптопровайдера.
//  Тип                            - Число  - тип криптопровайдера.
