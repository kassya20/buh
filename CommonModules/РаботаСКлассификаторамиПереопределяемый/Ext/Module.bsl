...
Процедура ПриДобавленииКлассификаторов(Классификаторы) Экспорт
	...
	РегистрыСведений.РегистрирующиеНалоговыеОрганы.ПриДобавленииКлассификаторов(Классификаторы);
	
	РегистрыСведений.КлассификаторОКОПФ.ПриДобавленииКлассификаторов(Классификаторы);
	РегистрыСведений.КлассификаторОКФС.ПриДобавленииКлассификаторов(Классификаторы);
	РегистрыСведений.СредняяЗарплатаПоРегионамИОКВЭД.ПриДобавленииКлассификаторов(Классификаторы);
	РегистрыСведений.СтавкиАкцизаПоставляемый.ПриДобавленииКлассификаторов(Классификаторы);
	
	Справочники.ЗадачиБухгалтера.ПриДобавленииКлассификаторов(Классификаторы);
	РаботаСБанкамиБП.ПриДобавленииКлассификаторов(Классификаторы);
	РегистрыСведений.УполномоченныеБанкиАУСН.ПриДобавленииКлассификаторов(Классификаторы);
...
Процедура ПриЗагрузкеКлассификатора(Идентификатор, Версия, Адрес, Обработан, ДополнительныеПараметры) Экспорт
	...
	РегистрыСведений.РегистрирующиеНалоговыеОрганы.ПриЗагрузкеКлассификатора(Идентификатор, Версия, Адрес, Обработан);
	
	РегистрыСведений.КлассификаторОКОПФ.ПриЗагрузкеКлассификатора(Идентификатор, Версия, Адрес, Обработан);
	РегистрыСведений.КлассификаторОКФС.ПриЗагрузкеКлассификатора(Идентификатор, Версия, Адрес, Обработан);
	РегистрыСведений.СредняяЗарплатаПоРегионамИОКВЭД.ПриЗагрузкеКлассификатора(Идентификатор, Версия, Адрес, Обработан);
	РегистрыСведений.СтавкиАкцизаПоставляемый.ПриЗагрузкеКлассификатора(Идентификатор, Версия, Адрес, Обработан);
	
	// БП
	РаботаСБанкамиБП.ПриЗагрузкеКлассификатора(Идентификатор, Версия, Адрес, Обработан, ДополнительныеПараметры);
	Справочники.ЗадачиБухгалтера.ПриЗагрузкеКлассификатора(Идентификатор, Версия, Адрес, Обработан, ДополнительныеПараметры);
	РегистрыСведений.УполномоченныеБанкиАУСН.ПриЗагрузкеКлассификатора(Идентификатор, Версия, Адрес, Обработан);
	// Конец БП
