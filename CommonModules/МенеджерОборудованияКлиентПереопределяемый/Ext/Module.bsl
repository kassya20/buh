...
Процедура ПриОткрытииСменыНаККТ(ИдентификаторУстройстваККТ, ПараметрыРегистрации) Экспорт
	МенеджерОборудованияБПКлиент.ПриОткрытииСменыНаККТ(ИдентификаторУстройстваККТ, ПараметрыРегистрации);
КонецПроцедуры
...
Процедура ЭкземплярОборудованияПередЗаписью(Объект, ЭтаФорма, Отказ, ПараметрыЗаписи) Экспорт
	МенеджерОборудованияБПКлиент.ЭкземплярОборудованияПередЗаписью(Объект, ЭтаФорма, Отказ, ПараметрыЗаписи);
КонецПроцедуры
...
Процедура ЭкземплярОборудованияПослеЗаписи(Объект, ЭтаФорма, ПараметрыЗаписи) Экспорт
	МенеджерОборудованияБПКлиент.ЭкземплярОборудованияПослеЗаписи(Объект, ЭтаФорма, ПараметрыЗаписи);
КонецПроцедуры
...
Процедура ЭкземплярОборудованияОбработкаНавигационнойСсылки(Объект, ЭтаФорма, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка) Экспорт
	МенеджерОборудованияБПКлиент.ЭкземплярОборудованияОбработкаНавигационнойСсылки(Объект, ЭтаФорма, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка);
КонецПроцедуры
...
Процедура ЭкземплярОборудованияТипОборудованияВыбор(Объект, ЭтаФорма, ЭтотОбъект, Элемент, ВыбранноеЗначение) Экспорт
	МенеджерОборудованияБПКлиент.ЭкземплярОборудованияТипОборудованияВыбор(Объект, ЭтаФорма, ЭтотОбъект, Элемент, ВыбранноеЗначение);
КонецПроцедуры
...
Процедура ЭкземплярОборудованияПриИзмененииЭлементаФормы(Объект, ЭтотОбъект, Элемент) Экспорт
	МенеджерОборудованияБПКлиент.ЭкземплярОборудованияПриИзмененииЭлементаФормы(Объект, ЭтотОбъект, Элемент);
КонецПроцедуры
