...
Функция ВидимостьКнопкиОтправкаПоСостоянию(
	...
	Возврат ((СостояниеСдачиОтчетности <> ПредопределенноеЗначение("Перечисление.СостояниеСдачиОтчетности.ПоложительныйРезультатДокументооборота")
			...
			И СостояниеСдачиОтчетности <> ПредопределенноеЗначение("Перечисление.СостояниеСдачиОтчетности.ПодтверждениеНеТребуется")
			И СостояниеСдачиОтчетности <> ПредопределенноеЗначение("Перечисление.СостояниеСдачиОтчетности.ОбязанностьПодтвержденияНеОпределена");
...
Функция ДопустимыеТипыФайловТребования() Экспорт
	...
	МассивФорматов.Добавить("tif");
	МассивФорматов.Добавить("png");
	МассивФорматов.Добавить("pdf");
	МассивФорматов.Добавить("ods");
	
	Возврат СтрСоединить(МассивФорматов, ";");
