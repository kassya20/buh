...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ПереносДанныхЭДОПриОбновлении20");
	Методы.Вставить("ЗаполнениеДанныхЭДОПриОбновлении20");
	Методы.Вставить("ПолностьюЗаполнитьСправочникВидыОтправляемыхДокументов");
