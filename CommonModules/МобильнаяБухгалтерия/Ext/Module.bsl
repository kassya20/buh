...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ИсправитьИнтерфейсБизнесСтарт");
	Методы.Вставить("ОчиститьДвиженияУдаленныхДокументов");
	Методы.Вставить("ЗаполнитьГоловнойКонтрагентВСервисе");
	
	Методы.Вставить("НачатьОтправкуДекларацииИспользуяДокументооборотСКО", Истина);
	Методы.Вставить("ЗавершитьОтправкуДекларацииИспользуяДокументооборотСКО", Истина);
	Методы.Вставить("ПроверитьСтатусыОтправкиОтчетов", Истина);
	Методы.Вставить("ПодготовитьДанныеДляВыгрузки", Истина);
	Методы.Вставить("АктуализироватьРасчетНалогов", Истина);
	Методы.Вставить("АктуализироватьДанныеЗадачиБухгалтера", Истина);
		...
		Для Каждого ИмяПечатнойФормы Из МассивПечатныхФорм Цикл
			...
			Если ОписаниеКоманды <> Неопределено Тогда
				...
				Если ЗначениеЗаполнено(ОписаниеКоманды.Обработчик) Тогда
					ПечатныеФормыОбъекта = ОтправкаПочтовыхСообщений.ВыполнитьОбработчикОтправки(ОписаниеКоманды, ЕстьОшибки);
