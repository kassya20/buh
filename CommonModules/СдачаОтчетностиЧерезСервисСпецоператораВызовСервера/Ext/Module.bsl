...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ПолучитьРезультатыОтправкиОтчетности", Истина);
	Методы.Вставить("ОбновитьИнформациюОНаправленияхСдачиОтчетности", Истина);
	Методы.Вставить("ОтправитьОтчетность", Истина);
КонецПроцедуры
...
Функция ОпределениеReporting(ВебАдрес, ОписаниеОшибки = "") Экспорт
...
КонецФункции // ОпределениеУдаленногоАдминистрирования()
...
Функция ПолучитьСведенияИзУправляющегоПриложения()
	...
	ОпределенияСервиса = ОпределениеReporting(ВебАдрес, ОписаниеОшибки);
