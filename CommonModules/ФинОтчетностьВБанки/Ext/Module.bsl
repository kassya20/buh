...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ОбновитьДанныеСервисаФинОтчетности", Истина);
	Методы.Вставить("ОбновитьСтатусыОтчетов", Истина);
	
	Методы.Вставить("СброситьВерсиюУслугБанка");
...
Процедура ФинОтчетностьВБанкиПриЗаписиРегламентированногоОтчета(Источник, Отказ) Экспорт
	...
	ПараметрыУстановкиСтатуса.ДатаОтправки     = Источник.ДатаОтправки;
