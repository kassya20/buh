...
// Показывает предупреждение о ранее напечатанном чеке и активирует гиперссылку для
// перехода на него (см. ПечатьФискальныхДокументовКлиент.ОбработкаНавигационнойСсылки)
//
// Параметры:
//  <Форма>  - <УправляемаяФорма>
//  <КомандаПечатиЧека>  - <Строка> - имя элемента формы
//                 с командой печати чека
//
...
// Подготавливает форму в части отражения команд печати чека
//
// Параметры:
//  <Форма>  - <УправляемаяФорма>
//  <КомандаПечатиЧека>  - <Строка> - имя элемента формы
...
Функция ДополнитьКод(КодТРУ) Экспорт
	Возврат СтроковыеФункцииКлиентСервер.ДополнитьСтроку(КодТРУ, 30, "0", "Справа");
КонецФункции 
