...
Процедура ОбработкаЗаполненияДокумента(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка) Экспорт
	...
	ИнтеграцияСАТУРНБП.ОбработкаЗаполненияДокументовСАТУРН(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка);
...
Процедура ПриОпределенииОбработкиПроверкиЗаполнения(ДокументОбъект, Отказ, ПроверяемыеРеквизиты, МассивНепроверяемыхРеквизитов) Экспорт
	...
	ИначеЕсли ТипЗнч(ДокументОбъект) = Тип("ДокументОбъект.ЗапросОстатковПартийСАТУРН") Тогда
		  ...
		  МассивНепроверяемыхРеквизитов.Добавить("ОстаткиПоДаннымСАТУРН.Характеристика");
...
Процедура ПриОпределенииРеквизитовТранспортногоСредства(Реквизиты, ТранспортноеСредство) Экспорт
	...
	РеквизитыТС 							= ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ТранспортноеСредство
															, "РегистрационныйЗнак,РегистрационныйЗнакПрицепа");
	Реквизиты.НомерТранспортногоСредства   	= РеквизитыТС.РегистрационныйЗнак;
	Реквизиты.НомерТранспортногоПрицепа 	= РеквизитыТС.РегистрационныйЗнакПрицепа;
