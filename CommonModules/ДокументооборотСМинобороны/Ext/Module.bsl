...
Функция СтатусУстановленВручную(Отправка, Знач СтатусИзЖурнала) Экспорт
	...
	Возврат СтатусИзЖурнала = ИнтерфейсыВзаимодействияБРОКлиентСервер.СтатусВРаботеСтрокой() 
		Или НЕ ЗначениеЗаполнено(Отправка) 
		Или (ЗначениеЗаполнено(Отправка) И Отправка.СтатусОтправки <> СтатусИзЖурналаПеречисление);
