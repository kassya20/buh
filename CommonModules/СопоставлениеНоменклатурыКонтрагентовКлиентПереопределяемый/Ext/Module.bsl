...
Процедура ПриСозданииНоменклатурыПоДаннымКонтрагента(Знач НаборНоменклатурыКонтрагентов, Знач ОповещениеОЗавершении, 
	...
	ЭлектронноеВзаимодействиеБПКлиент.ПриСозданииНоменклатурыПоДаннымКонтрагента(НаборНоменклатурыКонтрагентов, ОповещениеОЗавершении, Контекст, СтандартнаяОбработка);
...
Процедура ОткрытьФормуНоменклатуры(Знач Параметры, Знач Владелец, Знач Уникальность, Знач ОповещениеОЗакрытии) Экспорт
	...
	ЭлектронноеВзаимодействиеБПКлиент.ВыбратьТипСправочникаПриСозданииЭлементаПоДаннымКонтрагента(Параметры, Владелец, Уникальность, ОповещениеОЗакрытии);
