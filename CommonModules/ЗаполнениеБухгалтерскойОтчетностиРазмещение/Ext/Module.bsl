...
Функция СоставТаблицОтчета() Экспорт
	...
	// Пояснения: Финансовые вложения (#5)
	СоставТаблиц.Добавить("ФинансовыеВложенияНаличиеДвижение");	
	// Пояснения: Запасы (#6)
...
Функция ПланКонтейнераТаблицыОтчета(ИмяТаблицыОтчета) Экспорт
	...
	ИначеЕсли ИмяТаблицыОтчета = "ФинансовыеВложенияНаличиеДвижение" Тогда
		// 5.1. Наличие и движение финансовых вложений
		ЗаполнитьПланКонтейнераФинансовыеВложенияНаличиеДвижение(ПланКонтейнера);
...
Процедура ЗаполнитьПланКонтейнераФинансовыеВложенияНаличиеДвижение(План)
	...
	План.СтрокиПоПериодам.Вставить("Долгосрочные", Список("5311, 5312")); // "Долгосрочные финансовые вложения - всего"
	План.СтрокиПоПериодам.Вставить("Краткосрочные", Список("5313, 5314")); // "Краткосрочные финансовые вложения - всего"
	
	План.ИдентификаторыМногострочныхЧастей.Вставить("Долгосрочные", "П1000105311"); // "Долгосрочные финансовые вложения - всего" - "в том числе"
	План.СтрокиМСЧПоПериодам.Вставить("П1000105311", Список("5311, 5312"));
	План.ИдентификаторыМногострочныхЧастей.Вставить("Краткосрочные", "П1000105313"); // "Краткосрочные финансовые вложения - всего" - "в том числе"
	План.СтрокиМСЧПоПериодам.Вставить("П1000105313", Список("5313, 5314"));
	
	План.ГрафыПоПериодам.Вставить("ПервоначальнаяНачало", Список("03")); // "На начало года - первоначальная стоимость"
	План.ГрафыПоПериодам.Вставить("КорректировкаНачало", Список("04")); // "На начало года - накопленная корректировка"
	План.ГрафыПоПериодам.Вставить("ПервоначальнаяПоступило", Список("05")); // "Изменения за период - поступило"
	План.ГрафыПоПериодам.Вставить("ПервоначальнаяСписано", Список("06")); // "Изменения за период - списано - первоначальная стоимость"
	План.ГрафыПоПериодам.Вставить("КорректировкаСписано", Список("07")); // "Изменения за период - списано - накопленная корректировка"
	План.ГрафыПоПериодам.Вставить("КорректировкаПроценты", Список("08")); // "Изменения за период - проценты (включая доведение первоначальной стоимости до номинальной)"
	План.ГрафыПоПериодам.Вставить("КорректировкаПереоценка", Список("09")); // "Изменения за период - текущей рыночной стоимости/резерва под обесценение"
	План.ГрафыПоПериодам.Вставить("Переклассифицировано", Список("10")); // "Изменения за период - переклассифицировано"
	План.ГрафыПоПериодам.Вставить("ПервоначальнаяКонец", Список("11")); // "На конец периода - первоначальная стоимость"
	План.ГрафыПоПериодам.Вставить("КорректировкаКонец", Список("12")); // "На конец периода - накопленная корректировка"
