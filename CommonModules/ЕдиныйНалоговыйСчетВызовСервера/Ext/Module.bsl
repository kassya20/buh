	...
	Иначе
		...
		Если Не НалогУплачиваетсяОтдельно
			...
			СвойстваКонтрагента = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(
				Контрагент, "ГосударственныйОрган, ВидГосударственногоОргана");
			НалогУплачиваетсяОтдельно = ЗначениеЗаполнено(СвойстваКонтрагента.ГосударственныйОрган)
				И Не (СвойстваКонтрагента.ГосударственныйОрган
