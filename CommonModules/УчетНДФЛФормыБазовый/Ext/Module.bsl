	...
	Если ДобавлятьЭлементыФормы Тогда
		...
		Если ВычетыНаДетейИИмущественные <> Неопределено И ГруппаВычетыНаДетейИИмущественные <> Неопределено Тогда
			...
			Если Таблица = Неопределено Тогда
				...
				Поле = Форма.Элементы.Добавить(Таблица.Имя + "НалоговаяБаза", Тип("ПолеФормы"), Таблица);
				Поле.Вид = ВидПоляФормы.ПолеВвода;
				Поле.Заголовок = НСтр("ru = 'Вид налоговой базы'");
				Поле.ПутьКДанным = Таблица.ПутьКДанным + ".НалоговаяБаза";
				Поле.БыстрыйВыбор = Истина;
				МассивПараметровВыбора = Новый Массив;
				МассивПараметровВыбора.Добавить(Новый ПараметрВыбора("Отбор.Ссылка", УчетНДФЛПовтИсп.ПереченьНалоговыхБаз2025()));
				Поле.ПараметрыВыбора = Новый ФиксированныйМассив(МассивПараметровВыбора);
		...
		Если ВычетыЛичные <> Неопределено Тогда
			...
			Если ГруппаВычетыЛичные <> Неопределено И ГруппаВычетыЛичные.ПодчиненныеЭлементы.Количество() = 0 Тогда
				...
				ИмяГруппыЭлементов = ГруппаФормыПанельВычеты.Имя + "ГруппаВертикальная";
				ГруппаВертикальная = Форма.Элементы.Добавить(ИмяГруппыЭлементов, Тип("ГруппаФормы"), ГруппаВычетыЛичные);
				ГруппаВертикальная.Вид = ВидГруппыФормы.ОбычнаяГруппа;
				ГруппаВертикальная.ОтображатьЗаголовок = Ложь;
				ГруппаВертикальная.Заголовок = НСтр("ru = 'Настройка напоминания'");
				...
				Поле = Форма.Элементы.Добавить(ГруппаФормыПанельВычеты.Имя + "ПримененныйВычетЛичныйНалоговаяБаза", Тип("ПолеФормы"), ГруппаВертикальная);
				Поле.Вид = ВидПоляФормы.ПолеВвода;
				...
				Поле.ПутьКДанным = ГруппаФормыПанельВычеты.Имя + "ПримененныйВычетЛичныйНалоговаяБаза";
				Поле.УстановитьДействие("ПриИзменении", "Подключаемый_ВычетыЛичныеПриИзмененииНалоговаяБаза");
				МассивПараметровВыбора = Новый Массив;
				МассивПараметровВыбора.Добавить(Новый ПараметрВыбора("Отбор.Ссылка", УчетНДФЛПовтИсп.ПереченьНалоговыхБаз2025()));
				Поле.ПараметрыВыбора = Новый ФиксированныйМассив(МассивПараметровВыбора);
				
				ИмяГруппыЭлементов = ГруппаФормыПанельВычеты.Имя + "ГруппаГоризонтальная";
				ГруппаГоризонтальная = Форма.Элементы.Добавить(ИмяГруппыЭлементов, Тип("ГруппаФормы"), ГруппаВертикальная);
				ГруппаГоризонтальная.Вид = ВидГруппыФормы.ОбычнаяГруппа;
				ГруппаГоризонтальная.ОтображатьЗаголовок = Ложь;
				ГруппаГоризонтальная.Заголовок = НСтр("ru = 'Настройка напоминания'");
				...
				Поле = Форма.Элементы.Добавить(ГруппаФормыПанельВычеты.Имя + "ПримененныйВычетЛичныйКодВычета", Тип("ПолеФормы"), ГруппаГоризонтальная);
				Поле.Вид = ВидПоляФормы.ПолеВвода;
				Поле.Заголовок = НСтр("ru = 'Код'");
				Поле.Ширина = 5;
				Поле.АвтоМаксимальнаяШирина = Ложь;
				...
				Поле = Форма.Элементы.Добавить(ГруппаФормыПанельВычеты.Имя + "ПримененныйВычетЛичный", Тип("ПолеФормы"), ГруппаГоризонтальная);
				Поле.Вид = ВидПоляФормы.ПолеВвода;
				Поле.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Нет;
				Поле.Ширина = 8;
				Поле.АвтоМаксимальнаяШирина = Ложь;
				...
				Поле = Форма.Элементы.Добавить(ГруппаФормыПанельВычеты.Имя + "ПримененныйВычетЛичныйКЗачетуВозвратуКодВычета", Тип("ПолеФормы"), ГруппаГоризонтальная);
				Поле.Вид = ВидПоляФормы.ПолеВвода;
				Поле.Заголовок = НСтр("ru = 'Код'");
				Поле.Ширина = 5;
				Поле.АвтоМаксимальнаяШирина = Ложь;
				...
				Поле = Форма.Элементы.Добавить(ГруппаФормыПанельВычеты.Имя + "ПримененныйВычетЛичныйКЗачетуВозврату", Тип("ПолеФормы"), ГруппаГоризонтальная);
				Поле.Вид = ВидПоляФормы.ПолеВвода;
				Поле.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Нет;
				Поле.Ширина = 8;
				Поле.АвтоМаксимальнаяШирина = Ложь;
...
Процедура ДополнитьМассивРеквизитовПанелиВычетов(Форма, МассивДобавляемыхРеквизитов, МассивИменРеквизитовФормы, ОписаниеПанелиВычеты = Неопределено) Экспорт
	...
	Если ВычетыЛичные <> Неопределено Тогда
		...
		Реквизит = Новый РеквизитФормы(ИмяГруппыФормыПанелиВычеты + "ПримененныйВычетЛичныйНалоговаяБаза", 
			Новый ОписаниеТипов("ПеречислениеСсылка.КатегорииДоходовНДФЛ"),
			,
			,
			Истина);
		МассивДобавляемыхРеквизитов.Добавить(Реквизит);
...
Процедура СоздатьВТНачисленияДокументаДляФормированияДоходовНДФЛ(МенеджерВременныхТаблиц,
	...
	ПараметрыЗапросаЗаданыДляКаждойТаблицы = Ложь;
	Для Каждого ИмяТаблицыНачислений Из ИменаТаблицНачислений Цикл
		Если ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(ПараметрыЗапроса, ИмяТаблицыНачислений) = Неопределено Тогда
			ПараметрыЗапросаЗаданыДляКаждойТаблицы = Истина;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	...
	Для Каждого ИмяТаблицыНачислений Из ИменаТаблицНачислений Цикл
		...
		Если ПараметрыЗапроса <> Неопределено Тогда
			Если ПараметрыЗапросаЗаданыДляКаждойТаблицы Тогда
				ПараметрыТекущегоЗапроса = ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(ПараметрыЗапроса, ИмяТаблицыНачислений);
			Иначе
				ПараметрыТекущегоЗапроса = ПараметрыЗапроса;
			КонецЕсли;
			Если ПараметрыТекущегоЗапроса <> Неопределено Тогда
				Для Каждого КлючИЗначение Из ПараметрыТекущегоЗапроса Цикл
					ИмяПоля = КлючИЗначение.Ключ;
