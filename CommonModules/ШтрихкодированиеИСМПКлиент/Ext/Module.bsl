...
Функция НовыйЭлементПроверкиСредствамиККТПоДаннымРаспределения(РезультатРаспределения) Экспорт
	...
	ЗаполнитьЗначенияСвойств(
		...
		"ВидПродукции,ВидУпаковки,КодМаркировки,ПолныйКодМаркировки,СоставКодаМаркировки,ШтрихкодУпаковки,Сумма,
		|Количество,ТекстОшибки,КодЕдиницыИзмерения,КоличествоПотребительскихУпаковок,ЗапрещеноИгнорироватьОшибку,МинимальнаяРозничнаяЦена,
