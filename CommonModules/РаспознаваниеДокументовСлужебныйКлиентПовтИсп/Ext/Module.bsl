...
Функция ПолучитьИмяОткрываемойФормыПоТипу(ТипДокумента, ВариантОбработки) Экспорт
	...
	ИначеЕсли ТипДокумента = ПредопределенноеЗначение("Перечисление.ТипыДокументовРаспознаваниеДокументов.УКД") Тогда
		
		ИмяФормы = "Обработка.КорректировкаРеализацииПоступленияРаспознаваниеДокументов.Форма";
