...
// Производит дополнительную обработку данных после актуализации контрагентов бизнес-сети.
//
Процедура ВыполнитьОбработкуПослеАктуализацииКонтрагентов() Экспорт
	
	СервисСверкиРасчетов.ОбновитьКэшДанныхОРелевантныхКонтрагентах();
