...
Процедура УстановитьДоступныеВозвращаемыеДанные(ДоступныеВозвращаемыеДанные) Экспорт
	...
	КонтрольПраваПримененияСпецрежима.УстановитьДоступныеВозвращаемыеДанные(ДоступныеВозвращаемыеДанные);
	
	МодульЕдиныйНалоговыйСчетИнтеграцияБП = ОбщегоНазначения.ОбщийМодуль("ЕдиныйНалоговыйСчетИнтеграцияБП");
	МодульЕдиныйНалоговыйСчетИнтеграцияБП.УстановитьДоступныеВозвращаемыеДанные(ДоступныеВозвращаемыеДанные);
