...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ПолучитьКарусельБаннеров", Истина);
	Методы.Вставить("ПолучитьСтраницуПриЗагрузкеФайла", Истина);
...
Функция ПолучитьКарусельБаннеров(Размещение, ПоказатьПредыдущий) Экспорт
	...
	Если БаннерыВРотации.Количество() > 0 Тогда
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ru = 'Распознавание документов. Персонализированные предложения. Показан баннер'", ОбщегоНазначения.КодОсновногоЯзыка()),
...
Процедура СохранитьОткрытиеБаннера(КарусельБаннеров) Экспорт
	...
	ЗаписьЖурналаРегистрации(
		НСтр("ru = 'Распознавание документов. Персонализированные предложения. Открыт баннер'", ОбщегоНазначения.КодОсновногоЯзыка()),
...
Процедура СохранитьЗакрытиеБаннера(КарусельБаннеров) Экспорт
	...
	ЗаписьЖурналаРегистрации(
		НСтр("ru = 'Распознавание документов. Персонализированные предложения. Закрыт баннер'", ОбщегоНазначения.КодОсновногоЯзыка()),
		УровеньЖурналаРегистрации.Информация, , , КарусельБаннеров.Баннер.Идентификатор);
