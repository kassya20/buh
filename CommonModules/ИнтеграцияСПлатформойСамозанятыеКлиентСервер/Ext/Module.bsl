...
//
// Параметры:
//   МетодВзаимодействия - Строка - имя метода из списка методов ИнтеграцияСПлатформойСамозанятые.МетодыВзаимодействия()
//
...
Функция НовыеПараметрыМетодаВзаимодействия(МетодВзаимодействия) Экспорт
	...
	ИначеЕсли МетодВзаимодействия = "СписокАннулированныхЧеков" Тогда
		...
		Возврат НовыеПараметры_СписокАннулированныхЧеков(МетодВзаимодействия);
...
// Возвращает состояние, при котором доступна интеграция с сервисом Мой налог
//
// Возвращаемое значение:
//   ПеречислениеСсылка.СостоянияИнтеграцииСПлатформойСамозанятые 
//
Функция СостояниеПодключенияКСервису() Экспорт

	Возврат ПредопределенноеЗначение("Перечисление.СостоянияИнтеграцииСПлатформойСамозанятые.Подключено");
...
Функция НовыеПараметры_СписокАннулированныхЧеков(МетодВзаимодействия)
