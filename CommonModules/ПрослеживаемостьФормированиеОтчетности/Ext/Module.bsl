...
Процедура ОпределитьСвойстваОбъектовДляОтображенииВФормеОтчетность(СвойстваОбъектов) Экспорт
	...
	Если МассивУведомленийОбОстатках.Количество() > 0 Тогда
		...
		|	ВЫБОР
		|		КОГДА ЕСТЬNULL(УведомлениеОбОстаткахПрослеживаемыхТоваров.Организация.КрупнейшийНалогоплательщик, ЛОЖЬ)
		|			ТОГДА ЕСТЬNULL(УведомлениеОбОстаткахПрослеживаемыхТоваров.Организация.КодНалоговогоОрганаПолучателя, """")
		|		ИНАЧЕ ЕСТЬNULL(УведомлениеОбОстаткахПрослеживаемыхТоваров.Организация.РегистрацияВНалоговомОргане.Код, """")
	...
	Если МассивУведомленийОВвозе.Количество() > 0 Тогда
		...
		|	ВЫБОР
		|		КОГДА ЕСТЬNULL(УведомлениеОВвозеПрослеживаемыхТоваров.Организация.КрупнейшийНалогоплательщик, ЛОЖЬ)
		|			ТОГДА ЕСТЬNULL(УведомлениеОВвозеПрослеживаемыхТоваров.Организация.КодНалоговогоОрганаПолучателя, """")
		|		ИНАЧЕ ЕСТЬNULL(УведомлениеОВвозеПрослеживаемыхТоваров.Организация.РегистрацияВНалоговомОргане.Код, """")
		|	КОНЕЦ КАК КодКонтролирующегоОргана
		|ИЗ
	...
	Если МассивУведомленийОПеремещении.Количество() > 0 Тогда
		...
		|	ВЫБОР
		|		КОГДА ЕСТЬNULL(УведомлениеОПеремещенииПрослеживаемыхТоваров.Организация.КрупнейшийНалогоплательщик, ЛОЖЬ)
		|			ТОГДА ЕСТЬNULL(УведомлениеОПеремещенииПрослеживаемыхТоваров.Организация.КодНалоговогоОрганаПолучателя, """")
		|		ИНАЧЕ ЕСТЬNULL(УведомлениеОПеремещенииПрослеживаемыхТоваров.Организация.РегистрацияВНалоговомОргане.Код, """")
		|	КОНЕЦ КАК КодКонтролирующегоОргана
		|ИЗ
