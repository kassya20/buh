...
Функция ПолучитьПризнакПрослеживаемости(ОсновноеСредство, ДатаСведений) Экспорт
	
	Возврат Справочники.ОсновныеСредства.ПризнакПрослеживаемостиНаДату(ОсновноеСредство, ДатаСведений);
