...
//			- ИнвалидностьДатаУстановления			 	- Дата.
//
...
//			- ЕдиноличныйРуководительКоммерческойОрганизации - Булево (Ложь)
//
...
//          - ПриказОПриемеДлительностьИспытательногоСрока 	- Число (0)
//
...
Функция НеобходимыСведенияЗависящиеОтФункциональныхОпцийОрганизации(Знач ИмяПоля) Экспорт
	...
	Возврат КадровыйУчетБазовый.НеобходимыСведенияЗависящиеОтФункциональныхОпцийОрганизации(ИмяПоля);
...
Процедура КадроваяИсторияСотрудниковПередЗаписью(НаборЗаписей, Отказ, Замещение) Экспорт
	...
	КадровыйУчетБазовый.КадроваяИсторияСотрудниковПередЗаписью(НаборЗаписей, Отказ, Замещение);
	
КонецПроцедуры

Процедура КадроваяИсторияСотрудниковПриЗаписи(НаборЗаписей, Отказ, Замещение) Экспорт
	
	КадровыйУчетБазовый.КадроваяИсторияСотрудниковПриЗаписи(НаборЗаписей, Отказ, Замещение);
	
КонецПроцедуры

Процедура ПлановыеНачисленияПередЗаписью(НаборЗаписей, Отказ, Замещение) Экспорт
	
	КадровыйУчетБазовый.ПлановыеНачисленияПередЗаписью(НаборЗаписей, Отказ, Замещение);
	
КонецПроцедуры

Процедура ПлановыеНачисленияПриЗаписи(НаборЗаписей, Отказ, Замещение) Экспорт
	
	КадровыйУчетБазовый.ПлановыеНачисленияПриЗаписи(НаборЗаписей, Отказ, Замещение);
	
КонецПроцедуры

Процедура ОбновитьВторичныеКадровыеДанныеСотрудников(НаборЗаписей, Замещение) Экспорт
	
	КадровыйУчетБазовый.ОбновитьВторичныеКадровыеДанныеСотрудников(НаборЗаписей, Замещение);
...
Функция ОписанияСоставаНачисленийПоВременнойТаблице(МенеджерВременныхТаблиц, ИмяВТСотрудникиПериоды, ИмяПоляПериод, ИмяПоляСотрудник, ИмяПоляДатаОкончания, ИспользоватьКраткиеПредставления, ВыводитьДенежныеПоказателиСВалютой, ФормироватьСПериодичностьДень, ИмяПоляНачисление) Экспорт
	...
	Возврат КадровыйУчетБазовый.ОписанияСоставаНачисленийПоВременнойТаблице(МенеджерВременныхТаблиц, ИмяВТСотрудникиПериоды, ИмяПоляПериод, ИмяПоляСотрудник, ИмяПоляДатаОкончания, ИспользоватьКраткиеПредставления, ВыводитьДенежныеПоказателиСВалютой, ФормироватьСПериодичностьДень, ИмяПоляНачисление);
...
//			- ПриказОПриемеДата
//			- ПриказОПриемеНомер
//			- ПриказоПриемеДлительностьИспытательногоСрок
//			- ПриказОбУвольнении
...
Функция СведенияОСреднемЗаработкеДляСправкиДетямСиротам(КадровыеДанныеСотрудников, ДатаСправки) Экспорт
	...
	Возврат КадровыйУчетБазовый.СведенияОСреднемЗаработкеДляСправкиДетямСиротам(КадровыеДанныеСотрудников, ДатаСправки);
	
КонецФункции

Процедура СоздатьВТОбложениеДоговоровГПХНСПЗ(МенеджерВременныхТаблиц) Экспорт
	
	КадровыйУчетБазовый.СоздатьВТОбложениеДоговоровГПХНСПЗ(МенеджерВременныхТаблиц);
...
Процедура ПриОпределенииДоступныхДляПереводаМакетов(Макеты) Экспорт
	...
	КадровыйУчетБазовый.ПриОпределенииДоступныхДляПереводаМакетов(Макеты);
...
Функция ДоступноОбъединениеДублейПерсональныхДанных() Экспорт
	...
	Возврат КадровыйУчетБазовый.ДоступноОбъединениеДублейПерсональныхДанных();
