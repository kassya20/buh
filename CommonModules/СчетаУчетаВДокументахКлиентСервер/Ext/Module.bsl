...
Процедура НастроитьСубконтоЗатрат(Форма, ОписаниеСубконто) Экспорт
	...
	БухгалтерскийУчетКлиентСервер.ПриВыбореСчета(Форма.Объект[ОписаниеСубконто.ИмяСчета], Форма, ПоляФормы, ПараметрыОтображения);
...
Функция ПараметрыВыбораСубконтоЗатрат(Форма, ШаблонИмяПоляОбъекта, ИмяСчета) Экспорт
	...
	БухгалтерскийУчетКлиентСервер.ДополнитьСписокПараметровСубконто(ПараметрыВыбора, Объект, ШаблонИмяПоляОбъекта);
