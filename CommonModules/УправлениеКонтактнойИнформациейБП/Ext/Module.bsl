...
Функция СравнитьНаселенныеПункты(Адрес1, Адрес2) Экспорт
	...
	ДополнительныеПараметры = Новый Структура("НаименованиеВключаетСокращение, БезПредставлений", Истина, Истина);
	
	МассивАдресов = ОбщегоНазначенияКлиентСервер.МассивЗначений(Адрес1, Адрес2);
	СведенияОбАдресах = РаботаСАдресами.СведенияОбАдресах(МассивАдресов, ДополнительныеПараметры);
	
	Если Не ЗначениеЗаполнено(СведенияОбАдресах) Или СведенияОбАдресах.Количество() < 2 Тогда
		Возврат Ложь;
	КонецЕсли;
	
	СведенияОбАдресе1 = СведенияОбАдресах[0];
	СведенияОбАдресе2 = СведенияОбАдресах[1];
	...
	ЗаполнитьЗначенияСвойств(НаселенныйПункт1, СведенияОбАдресе1);
	ЗаполнитьЗначенияСвойств(НаселенныйПункт2, СведенияОбАдресе2);
	
	Если ОбщегоНазначенияБП.ДанныеБезУчетаРегистраСовпадают(НаселенныйПункт1, НаселенныйПункт2)
		Или МестоположениеАдресовСовпадает(СведенияОбАдресе1, СведенияОбАдресе2) Тогда
		
		НаселенныеПунктыСовпадают = Истина;
	Иначе
		КодыАдреса1 = АдресныйКлассификатор.КодыАдреса(Адрес1, АдресныйКлассификаторБП.ИсточникПолученияСведенийОбАдресныхСведениях());
		КодыАдреса2 = АдресныйКлассификатор.КодыАдреса(Адрес2, АдресныйКлассификаторБП.ИсточникПолученияСведенийОбАдресныхСведениях());
...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	Справочники.КонтактныеЛица.ПриНачальномЗаполненииВидовКонтактнойИнформации(КодыЯзыков, Элементы, ТабличныеЧасти);
	
	Справочники.Организации.ПриНачальномЗаполненииВидовКонтактнойИнформации(КодыЯзыков, Элементы, ТабличныеЧасти);
	
	Справочники.ОбъектыВыполненияРабот.ПриНачальномЗаполненииВидовКонтактнойИнформации(КодыЯзыков, Элементы, ТабличныеЧасти);
	
	#Область Пользователи
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "ДругаяИнформацияПользователя";
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
		"ru = 'Контактная информация справочника ""Контрагенты""'", КодыЯзыков);
	...
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "EmailКонтрагенты";
	...
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "СправочникПодразделенияОрганизаций";
	Элемент.ЭтоГруппа = Истина;
	Элемент.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
		"ru = 'Контактная информация справочника ""Подразделения организаций""'", КодыЯзыков);
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "ФактическийАдресПодразделенияОрганизаций";
	Элемент.Родитель = Справочники.ВидыКонтактнойИнформации.СправочникПодразделенияОрганизаций;
	Элемент.Тип      = Перечисления.ТипыКонтактнойИнформации.Адрес;
	Элемент.РазрешитьВводНесколькихЗначений = Ложь;
	Элемент.ВидРедактирования = "Диалог";
	...
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "ТелефонПодразделенияОрганизаций";
	Элемент.Тип = Перечисления.ТипыКонтактнойИнформации.Телефон;
	Элемент.Родитель = Справочники.ВидыКонтактнойИнформации.СправочникПодразделенияОрганизаций;
	Элемент.МожноИзменятьСпособРедактирования = Истина;
	Элемент.РазрешитьВводНесколькихЗначений = Истина;
	...
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "ФаксПодразделенияОрганизаций";
	Элемент.Тип = Перечисления.ТипыКонтактнойИнформации.Факс;
	Элемент.Родитель = Справочники.ВидыКонтактнойИнформации.СправочникПодразделенияОрганизаций;
	Элемент.МожноИзменятьСпособРедактирования = Истина;
	Элемент.РазрешитьВводНесколькихЗначений = Истина;
	...
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "EmailПодразделенияОрганизаций";
	Элемент.Тип = Перечисления.ТипыКонтактнойИнформации.АдресЭлектроннойПочты;
	Элемент.Родитель = Справочники.ВидыКонтактнойИнформации.СправочникПодразделенияОрганизаций;
	Элемент.МожноИзменятьСпособРедактирования = Истина;
	Элемент.РазрешитьВводНесколькихЗначений = Истина;
	...
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "ДругаяИнформацияПодразделенияОрганизаций";
	Элемент.Тип = Перечисления.ТипыКонтактнойИнформации.Другое;
	Элемент.Родитель = Справочники.ВидыКонтактнойИнформации.СправочникПодразделенияОрганизаций;
	Элемент.МожноИзменятьСпособРедактирования = Истина;
	Элемент.РазрешитьВводНесколькихЗначений = Ложь;
	...
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "СправочникОсновныеСредства";
	Элемент.ЭтоГруппа = Истина;
	Элемент.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
		"ru = 'Контактная информация справочника ""Основные средства""'", КодыЯзыков);
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "АдресМестонахожденияОсновныеСредства";
	Элемент.Родитель = Справочники.ВидыКонтактнойИнформации.СправочникОсновныеСредства;
	Элемент.Тип      = Перечисления.ТипыКонтактнойИнформации.Адрес;
	Элемент.РазрешитьВводНесколькихЗначений = Ложь;
	Элемент.ВидРедактирования = "Диалог";
	Элемент.МожноИзменятьСпособРедактирования = Истина;
	...
	Элемент.ЗапретитьРедактированиеПользователем = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
		"ru = 'Адрес местонахождения'", КодыЯзыков);
	...
	Элемент.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
		"ru = 'Контактная информация справочника ""Торговые точки""'", КодыЯзыков);
	...
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "СправочникГостиницы";
	Элемент.ЭтоГруппа = Истина;
	Элемент.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
		"ru = 'Контактная информация справочника ""Гостиницы""'", КодыЯзыков);
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "АдресГостиницы";
	Элемент.Родитель = Справочники.ВидыКонтактнойИнформации.СправочникГостиницы;
	Элемент.Тип      = Перечисления.ТипыКонтактнойИнформации.Адрес;
	Элемент.РазрешитьВводНесколькихЗначений = Ложь;
	Элемент.ВидРедактирования = "Диалог";
	Элемент.МожноИзменятьСпособРедактирования = Истина;
	...
	Элемент.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
		"ru = 'Контактная информация справочника ""Склады""'", КодыЯзыков);
...
//   Дата           - Дата - Необязательный (дата, с которой действует запись контактной информации)
//   АдресВСтруктуру - Булево - адрес представлен в виде структуры
//
// Возвращаемое значение:
//   СписокЗначений
//
Функция СписокАдресовОбъекта(СсылкаНаОбъект, Дата = Неопределено, АдресВСтруктуру = Ложь) Экспорт
	...
	Для Каждого Адрес Из Адреса Цикл
		АдресСтруктурой = Новый Структура("Вид, Значение, Представление");
		ЗаполнитьЗначенияСвойств(АдресСтруктурой, Адрес);
		СписокАдресов.Добавить(
			?(АдресВСтруктуру, АдресСтруктурой, АдресСтруктурой.Представление), 
			СтрШаблон("%1: %2", Адрес.Вид, Адрес.Представление));
...
Функция МестоположениеАдресовСовпадает(СведенияОбАдресе1, СведенияОбАдресе2)
	
	// В некоторых случаях для города федерального значение в качестве региона из ЕГР приходит некорректное значение,
	// напр., "Г.Москва" вместо нужного по ФИАС "Москва г".
	// или неправильно распознается регион: Ростовская Область и Ростовская обл.
	// или неправильно распознается город и указывается в населенном пункте.
	// Из-за чего считается, что местоположение отличается.
	
	Если СведенияОбАдресе1.КодСтраны <> СведенияОбАдресе2.КодСтраны Тогда
		Возврат Ложь;
	КонецЕсли;
	
	// Вначале проверим города федерального значения
	ГородФЗ1 = ПривестиГородФедеральногоЗначенияКФорматуФИАС(СведенияОбАдресе1.Регион);
	ГородФЗ2 = ПривестиГородФедеральногоЗначенияКФорматуФИАС(СведенияОбАдресе2.Регион);
	
	Если ГородФЗ1 = ГородФЗ2 И РаботаСАдресами.ЭтоГородФедеральногоЗначения(ГородФЗ1) Тогда
		Возврат Истина;
	КонецЕсли;
	
	// Убираем упоминание о типе региона
	// Бывают ситуации, когда тип региона не распознается и отображается в наименовании региона
	Регион1 = ПривестиЗначениеБезСокращений(СведенияОбАдресе1.Регион, СведенияОбАдресе1.РегионТипПолный, СведенияОбАдресе1.РегионТипКраткий);
	Регион2 = ПривестиЗначениеБезСокращений(СведенияОбАдресе2.Регион, СведенияОбАдресе2.РегионТипПолный, СведенияОбАдресе2.РегионТипКраткий);
	
	Если Регион1 <> Регион2 Тогда
		Возврат Ложь;
	КонецЕсли;
	
	Если РаботаСАдресами.ЭтоГородФедеральногоЗначения(Регион1) Тогда
		Возврат Истина;
	КонецЕсли;
	
	// Если сравниваемые адреса указаны с типом муниципального адреса, то проверяем муниципальный район
	Если Не РаботаСАдресамиКлиентСервер.ЭтоАдминистративноТерриториальныйАдрес(СведенияОбАдресе1.ТипАдреса)
		И Не РаботаСАдресамиКлиентСервер.ЭтоАдминистративноТерриториальныйАдрес(СведенияОбАдресе2.ТипАдреса) Тогда
		
		МуниципальныйРайон1 = ПривестиЗначениеБезСокращений(СведенияОбАдресе1.МуниципальныйРайон,
			СведенияОбАдресе1.МуниципальныйРайонТипПолный,
			СведенияОбАдресе1.МуниципальныйРайонТипКраткий);
		МуниципальныйРайон2 = ПривестиЗначениеБезСокращений(СведенияОбАдресе2.МуниципальныйРайон,
			СведенияОбАдресе2.МуниципальныйРайонТипПолный,
			СведенияОбАдресе2.МуниципальныйРайонТипКраткий);
		
		Если МуниципальныйРайон1 <> МуниципальныйРайон2 Тогда
			Возврат Ложь;
		КонецЕсли;
		
	КонецЕсли;
	
	Город1 = ПривестиГородБезСокращений(СведенияОбАдресе1);
	Город2 = ПривестиГородБезСокращений(СведенияОбАдресе2);
	
	Возврат (Город1 = Город2);
	
КонецФункции

Функция ПривестиЗначениеБезСокращений(ЗначениеПолное, ТипПолный, ТипКраткий)
	
	Результат = Новый Массив;
	
	Разделитель = " ";
	СтрокиЗначения = СтрРазделить(ВРег(ЗначениеПолное), Разделитель, Ложь);
	
	Для Каждого ТекущаяСтрока Из СтрокиЗначения Цикл
		Если ТекущаяСтрока = ВРег(ТипПолный) Или ТекущаяСтрока = ВРег(ТипКраткий) Тогда
			Продолжить;
		КонецЕсли;
		Результат.Добавить(ТекущаяСтрока);
	КонецЦикла;
	
	Возврат СокрЛП(СтрСоединить(Результат, Разделитель));
	
КонецФункции

Функция ПривестиГородБезСокращений(СведенияОбАдресе)
	
	Результат = "";
	
	// В ГАР бывают адреса, в которых поле Город пустой - в этом случае, город указывается в других полях
	
	// Город может указываться в поле НаселенныйПункт, напр. г. Екатеринбург
	Если ПустаяСтрока(СведенияОбАдресе.Город) Тогда
		Результат = ПривестиЗначениеБезСокращений(СведенияОбАдресе.НаселенныйПункт,
			СведенияОбАдресе.НаселенныйПунктТипПолный,
			СведенияОбАдресе.НаселенныйПунктТипКраткий);
	Иначе
		Результат = ПривестиЗначениеБезСокращений(СведенияОбАдресе.Город,
			СведенияОбАдресе.ГородТипПолный,
			СведенияОбАдресе.ГородТипКраткий);
	КонецЕсли;
	
	СокращениеТипаГород = Новый Массив;
	СокращениеТипаГород.Добавить("г");
	СокращениеТипаГород.Добавить("г.");
	
	// Город может указываться в поле Район, напр. г. Истра, г. Коломна
	Если Не ЗначениеЗаполнено(Результат)
		И ЗначениеЗаполнено(СведенияОбАдресе.Район)
		И СокращениеТипаГород.Найти(НРег(СокрЛП(СведенияОбАдресе.РайонСокращение))) <> Неопределено Тогда
		
		Результат = ПривестиЗначениеБезСокращений(СведенияОбАдресе.Район,
			СведенияОбАдресе.РайонТипПолный,
			СведенияОбАдресе.РайонТипКраткий);
	КонецЕсли;
...
Функция ПривестиГородФедеральногоЗначенияКФорматуФИАС(Регион)
	
	// В некоторых случаях для города федерального значение в качестве региона из ЕГР приходит некорректное значение,
	// напр., "Г.Москва" вместо нужного по ФИАС "Москва г".
	// Из-за чего считается, что местоположение отличается.
	
	Результат = ВРег(Регион);
	Если СтрНачинаетсяС(Результат, "Г.") Тогда
		Результат = СтрШаблон("%1 Г", Сред(Результат, 3));
	КонецЕсли;
