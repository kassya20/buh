...
Функция ТоварнаяГруппаЧислом(Знач ЗначениеПоиска, ВидПродукции = Неопределено) Экспорт
	...
	Если ТипЗнч(ЗначениеПоиска) = Тип("Число") Тогда
		Если ЗначениеПоиска = 1 Тогда
			...
			ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ЛегкаяПромышленность2026") Тогда
		...
		ИначеЕсли ЗначениеПоиска = ТоварыИзНатуральногоМехаКодТоварнойГруппы() Тогда
	...
	ИначеЕсли ТипЗнч(ЗначениеПоиска) = Тип("ПеречислениеСсылка.ВидыПродукцииИС") Тогда
		Если ЗначениеПоиска = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ЛегкаяПромышленность")
			Или ЗначениеПоиска = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ЛегкаяПромышленность2025")
			Или ЗначениеПоиска = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ЛегкаяПромышленность2026") Тогда
			Возврат 1;
		...
		ИначеЕсли ЗначениеПоиска = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.СладостиИКондитерскиеИзделия") Тогда
			Возврат 45;
		ИначеЕсли ЗначениеПоиска = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ТоварыИзНатуральногоМеха") Тогда
			Возврат ТоварыИзНатуральногоМехаКодТоварнойГруппы();
		КонецЕсли;
	КонецЕсли;
...
//  * МРЦ - Число - для табачной продукции
//  * МинимальнаяРозничнаяЦена - Число - для никотиносодержащей продукции
...
Функция ПараметрыКодаМаркировкиПоДаннымРазрешительногоРежима(ЭлементДанных, ВидПродукции = Неопределено, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Если ВидПродукцииДляРазбораКода = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.Табак") Тогда
	...
	ИначеЕсли ВидПродукцииДляРазбораКода = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.НикотиносодержащаяПродукция") Тогда
...
Функция ТоварыИзНатуральногоМехаКодТоварнойГруппы()
	Возврат 49;
КонецФункции
