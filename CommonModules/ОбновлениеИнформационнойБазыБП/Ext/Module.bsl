...
#КонецОбласти
	...
	Обработчик = Обработчики.Добавить();
    Обработчик.Версия              = "3.0.196.4";
    Обработчик.Процедура           = "УчетАкцизов.ОбновитьСтавкиПоАкцизам";
    Обработчик.НачальноеЗаполнение  = Истина;
    Обработчик.РежимВыполнения     = "Отложенно";
	Обработчик.Комментарий         = НСтр("ru='Акцизы. Начальное заполнение.'");
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия               = "3.0.195.5";
	Обработчик.Процедура            = "ОбновлениеИнформационнойБазыБП.ЗаполнитьРеквизитыКлючевыхОпераций";
	Обработчик.НачальноеЗаполнение  = Истина; // Процедура должна запускаться при переходе с 2БП на 3БП
	Обработчик.ОбщиеДанные          = Истина;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "3.0.195.14";
	Обработчик.НачальноеЗаполнение = Истина;
	Обработчик.Процедура = "Константы.ОтображатьДополнительнуюИнформациюВСпискеИмущество.УстановитьЗначениеПоУмолчанию";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "3.0.195.18";
	Обработчик.Процедура           = "УчетЗарплаты.УстановитьПризнакУчетаСреднейПоМРОТ";
	Обработчик.Комментарий         = НСтр("ru = 'Установка признака признак ""Учитывать минимальный размер оплаты труда"" в документах Отпуск и Увольнение'");
	Обработчик.РежимВыполнения     = "Отложенно";
	Обработчик.Идентификатор       = Новый УникальныйИдентификатор("9bf6ca1e-4fda-4dc1-8550-60a56936bbbf");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "3.0.195.20";
	Обработчик.Процедура           = "Справочники.ДоговорыКонтрагентов.ЗаполнитьВидыАгентскихДоговоров";
	Обработчик.Комментарий         = НСтр("ru = 'Заполнение видов агентских договоров значением по умолчанию в договорах с учетом агентского НДС покупателем'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "3.0.196.4";
	Обработчик.НачальноеЗаполнение = Истина;
	Обработчик.Процедура           = "Константы.ОтображатьИтогиПоНачислениямИВыплатамВСпискеСотрудников.ВключитьПриОбновлении";
	Обработчик.Комментарий         = НСтр(
		"ru = 'Включает отображение итогов по начислениям и выплатам в списке сотрудников'",
		ОбщегоНазначения.КодОсновногоЯзыка());
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "3.0.196.4";
	Обработчик.НачальноеЗаполнение = Истина;
	Обработчик.Процедура           = "ОбновлениеИнформационнойБазыБП.ВключитьРазделЗарплатаВПростомИнтерфейсе";
	Обработчик.Комментарий         = НСтр(
		"ru = 'Включает отображеие раздела «Зарплата» в простом интерфейсе при ведении учета во внешней программе.'",
		ОбщегоНазначения.КодОсновногоЯзыка());
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия               = "3.0.196.7";
	Обработчик.Процедура            = "РегистрыСведений.НастройкиУчетаНДС.ПроставитьПериодичностьРегистрацииСводныхСправок";
	Обработчик.Комментарий          = НСтр("ru = 'Устанавливает реквизит ""Периодичность регистрации сводных справок"" в регистре сведений ""Настройки учета НДС""'");
	Обработчик.РежимВыполнения      = "Отложенно";
	Обработчик.Идентификатор        = Новый УникальныйИдентификатор("2534953f-f326-4592-b4ec-6f352cdd687d");
	Обработчик.НачальноеЗаполнение  = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "3.0.197.6";
	Обработчик.Процедура           = "Справочники.СтатьиДвиженияДенежныхСредств.УстановитьВидСтатьиДДСДоходРасход";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "3.0.197.6";
	Обработчик.Процедура           = "Справочники.НаправленияДеятельности.ВключитьИспользованиеДополнительныхРеквизитовИСведений";
	Обработчик.НачальноеЗаполнение = Истина;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "3.0.197.14";
	...
	Обработчик.РежимВыполнения     = "Отложенно";
	Обработчик.Идентификатор       = Новый УникальныйИдентификатор("a39a128e-29da-4552-b250-836a1d9c1d2f");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "3.0.198.9";
	Обработчик.Процедура = "ИнтеграцияСтатусСамозанятогоБП.ВключитьИспользоватьСтатусСамозанятогоПриОбновлении";
	Обработчик.Комментарий =
		НСтр("ru = 'Установка начального значения настройки Использовать сервис 1С:Статус самозанятого'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия               = "3.0.198.16";
	Обработчик.Процедура            = "Документы.ЗаявлениеОВвозеТоваров.ЗаполнитьВидОперацииПоУмолчанию";
	Обработчик.Комментарий          = НСтр("ru = 'Устанавливает реквизит ""Вид операции"" в документе ""Ввоз товаров из ЕАЭС""'");
	Обработчик.РежимВыполнения      = "Отложенно";
	Обработчик.Идентификатор        = Новый УникальныйИдентификатор("e0e8985a-9580-4d09-9d1f-816e0a700228");
	Обработчик.НачальноеЗаполнение  = Ложь;
...
Процедура ПередОбновлениемИнформационнойБазы() Экспорт
	...
	Обработки.ФункциональностьПрограммы.ПроверитьКорректностьОписанияФункциональности();
...
Процедура ПослеОбновленияИнформационнойБазы(Знач ПредыдущаяВерсия, Знач ТекущаяВерсия,
	...
	Обработки.ПанелиПростойИнтерфейс.СброситьНастройкуИспользоватьПилотныйРазделБухгалтерияПослеОбновления(ПредыдущаяВерсия, ТекущаяВерсия);
...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("СоздатьНастройкиУчетаЗарплаты");
	Методы.Вставить("ЗаполнениеСлужебныхРегистровВетИС");
	Методы.Вставить("ОбновитьНаименованияНаборовИСвойств");
	Методы.Вставить("ОбработкаДокументовУчетаЗарплаты");
	Методы.Вставить("ОбновитьДвиженияРегистраРублевыеСуммыДокументовВВалюте");
	Методы.Вставить("УдалитьРегистрациюДопустимыеЗначенияПотребительскихСвойствЗЕРНО");
	Методы.Вставить("УстановитьДатуТекущейВерсии");
	Методы.Вставить("ПередатьЦентруМониторингаСтатистикуПризнакНКО");
	Методы.Вставить("ЗаменитьСсылкиНаДублирующиесяНаборыДополнительныхРеквизитовИСведений");
	Методы.Вставить("УстановитьНастройкуПоказыватьСчетаУчетаВДокументах");
	Методы.Вставить("ЗарегистрироватьИзменинияИдентификаторовОбъектовМетаданных");
	Методы.Вставить("ЗаполнитьКодВидаИмущества");
	Методы.Вставить("ОбработкаДобавленияНовогоСчета_53");
	Методы.Вставить("ЗаполнитьРеквизитыСчетовВспомогательныеПроизводства");
	Методы.Вставить("УстановитьСтатусЗадачПоУведомлениям");
	Методы.Вставить("ПереустановитьПолныйИнтерфейсВРежимеСервиса");
	Методы.Вставить("ЗарегистрироватьИзмененияОбъектовМаркировки");
	Методы.Вставить("ОпределитьПараметруУчетаРасчетовСРаботниками");
	Методы.Вставить("УстановитьВестиУчетРасчетовСКонтрагентами");
	Методы.Вставить("УстановитьКорректировкуДляДокументовПоНалогамСФОТ");
	Методы.Вставить("ВключитьПростойИнтерфейсБизнесСтарт");
	Методы.Вставить("ОграничитьСрокиДействияПатентовУСН");
	Методы.Вставить("УстановитьИспользоватьРучнуюКорректировкуДвижений");
	Методы.Вставить("ИзменитьНаименованиеПредопределенныхНаборовРеквизитовВыпускПродукции");
	Методы.Вставить("УстановитьКонстантуОтправкаЧеков");
	Методы.Вставить("ЗаполнитьСпособПризнанияНИОКР");
	Методы.Вставить("ЗаполнениеКодовБыстрогоВыбора");
	Методы.Вставить("ПередатьЦентруМониторингаИспользованиеИнтеграцииСЛКФТС");
	Методы.Вставить("ЗаполнитьРеквизитыКлючевыхОпераций");
	Методы.Вставить("ОбновитьСчетФактуруПолученный");
	Методы.Вставить("ОбновитьРеквизитВидОбменаСКонтролирующимиОрганамиСправочникаОрганизации");
	Методы.Вставить("УстановитьСубконтоНаСчетахПереводыВПути");
	Методы.Вставить("ОбработатьКорректировочныеСчетаФактуры");
	Методы.Вставить("ПеренестиНастройкиКолонтитулов");
	Методы.Вставить("УстановитьКонстантуИспользоватьВыпускПродукции");
	Методы.Вставить("ЗаполнитьРеквизитыСчетовМалоценки");
	Методы.Вставить("ЗаписатьОперациюБизнесСтатистикиПоАкцизам");
	Методы.Вставить("ЗаполнитьКонстантуУчетОбеспеченийОбязательствИПлатежей");
	Методы.Вставить("ЗаполнитьПустойТипКонтактнойИнформации");
	Методы.Вставить("ЗарегистрироватьИзмененияКадровыхСведений");
	Методы.Вставить("ЗаменитьТипыСкладовВРегистреСчетовУчетаНоменклатуры");
	Методы.Вставить("ПервыйЗапускОбщиеДанные");
	Методы.Вставить("УстановитьКонстантыПоКомиссионнойДеятельности");
	Методы.Вставить("ДозаполнениеКодовБыстрогоВыбора");
	Методы.Вставить("УстановитьОрганизациюФискальныеДанные");
	Методы.Вставить("УстановитьВедетсяУчетИмпортаТоваров");
	Методы.Вставить("ЗаполнитьДатуПоследнейЗагрузкиЭкземпляраПодключаемогоОборудованияЭвотор");
	Методы.Вставить("ЗаполнениеНоменклатурныхГруппРеализацииПродукцииУслуг");
	Методы.Вставить("СократитьАдресСервисаРегиональныеСтавкиНалогов");
	Методы.Вставить("ЗаполнитьПараметрыЗагрузкиЭкземпляраПодключаемогоОборудованияЭвотор");
	Методы.Вставить("ОчиститьКэшСобытийСервисаМониторингБанков");
	Методы.Вставить("УстановитьКонстантуИспользоватьВалютныйУчетОтложенно");
	Методы.Вставить("УстановитьРежимТакси");
	Методы.Вставить("УстановитьКонстантуОтображатьДополнительныеКолонкиВСписках");
	Методы.Вставить("ВключитьПроверкуКонтрагентов");
	Методы.Вставить("ОчиститьТиповыеОперации20Отложенно");
	Методы.Вставить("ОбновитьКалендарныеГрафики");
	Методы.Вставить("ЗаполнитьКонстантуНачалоРаботы");
	Методы.Вставить("ЗаполнитьВидыЦикловОбменаЦиклОбменаСФСГС");
	Методы.Вставить("ЗаменитьСсылкиНаНаборыДополнительныхРеквизитовИСведений");
	Методы.Вставить("СбросИспользованияРегламентногоЗаданияЗагрузкаВалют");
	Методы.Вставить("ЗаполнениеКонстантТипаПоставки");
	Методы.Вставить("ЗаполнитьТабличныеЧастиДляСписков");
	Методы.Вставить("ЗаполнитьДвиженияПоУведомлениямСОтрицательнойСуммой");
	Методы.Вставить("ЗаполнитьРеквизитыСчетовУчетаСУчредителями");
	Методы.Вставить("УстановитьПредельноеКоличествоЗаписейВРазделеДекларацииПоНДС");
	Методы.Вставить("УстановитьКонстантыУчетаНДСспецРежимы");
	Методы.Вставить("ОбработкаДобавленияНовогоСчета_50_04");
	Методы.Вставить("ЗаполнитьРеквизитыСчетовВозвратнаяТара");
	Методы.Вставить("ПереустановитьПростойИнтерфейс");
	Методы.Вставить("ПроверитьПоддержкуСовместительства");
	Методы.Вставить("ЗаменитьРольДобавлениеИзменениеНеразделяемыхДанныхРегламентированнойОтчетности");
	Методы.Вставить("ЗаполнитьРеквизитыСчетовУчетаРезервов");
	Методы.Вставить("ЗаполнитьИсториюРегистрацийВНалоговомОргане");
	Методы.Вставить("УстановитьВедетсяУчетИмпортныхТоваров");
	Методы.Вставить("УстановитьИспользованиеДополнительныхОтчетовИОбработок");
	Методы.Вставить("ЗарегистрироватьИзмененияУчетныхЗаписейЭлектроннойПочты");
	Методы.Вставить("ЗарегистрироватьИзмененияВидовОтправляемыхДокументов");
	Методы.Вставить("ВыполнитьКонвертациюСчетовФактур");
	Методы.Вставить("ОбработатьДвиженияПоРегистрамНДС");
	Методы.Вставить("УстановитьКонстантуРегистрироватьСчетаФактурыНаСуммовыеРазницы");
	Методы.Вставить("РазделитьЗадолженностьВДокументах");
	Методы.Вставить("ОбработатьЖурналУчетаСчетовФактур");
	Методы.Вставить("УстановитьКонстантуИспользоватьЛоготипОрганизацииВШтампеЭП");
	Методы.Вставить("ОбновитьОрганизацииКонтрагентыЮрФизЛицо");
	Методы.Вставить("ОбновитьДокументыКорректировкаДолга");
	Методы.Вставить("ИзменитьНаименованиеПредопределенныхНаборовРеквизитовРасходМатериалов");
	Методы.Вставить("ОбновитьЗарплатуКВыплатеОрганизаций");
	Методы.Вставить("ОбновитьТипыПредопределеннойКонтактнойИнформации");
	Методы.Вставить("ПереносДвиженийДокументовУчетаЗарплаты");
	Методы.Вставить("УстановитьКонстантуИспользоватьДокументыПоступленияИП");
	Методы.Вставить("ПереносДвиженийИсчисленныеСтраховыеВзносы");
	Методы.Вставить("УстановитьИспользоватьСтатьиДвиженияДенежныхСредств");
	Методы.Вставить("ОбновлениеРегистраРеквизитыУплатыНалоговИПлатежейВБюджет");
	Методы.Вставить("УстановитьКонстантуИспользоватьТабличныеФормыБанковскихДокументов");
	Методы.Вставить("ОбработкаИзмененияПризнакаСчетаВНО");
	Методы.Вставить("КонтактнаяИнформацияОбновлениеИБ");
	Методы.Вставить("ЗаполнениеКППКонтрагентаЖурналаУчетаСчетовФактур");
	Методы.Вставить("УстановитьКорректировкуДляСчетовФактурПолученных_НДСПредъявленКВычету");
	Методы.Вставить("ЗаполнениеВидаКодаОперацииСчетФактуры");
	Методы.Вставить("ЗаполнитьВидОперацииВОтчетеКомитентуОПродажах");
	Методы.Вставить("ПервыйЗапуск");
	Методы.Вставить("ЗаполнениеОсновнойНоменклатурнойГруппыВидовДеятельностиИП");
	Методы.Вставить("ОбновитьНаименованиеРубля");
	Методы.Вставить("УстановитьКорректировкуДляРегистрацийОплатыОсновныхСредствИП");
	Методы.Вставить("УстановитьКорректировкуДляДокументовВНОПоНалогам");
	Методы.Вставить("ВключитьРежимРазделенияИтоговРегистровНакопленийИБухгалтерии");
	Методы.Вставить("УстановитьДатуНачалаДействияПостановления1137");
	Методы.Вставить("ЗаполнитьТЧПокупателиОтчетКомиссионераОПродажах");
	Методы.Вставить("КонвертацияСведенийОбОтраженииЗарплатыВУчете");
	Методы.Вставить("ОбработатьДобавлениеСчетовКорректировкиПрошлогоПериода");
	Методы.Вставить("ЗаполнитьВидАктиваДляРБП");
	Методы.Вставить("УдалениеСубконтоДокументыРасчетовСчет_76_НА");
	Методы.Вставить("ЗаполнитьТабличныеЧастиРасчетовПоЗаработнойПлатеДокументаВНО");
	Методы.Вставить("УстановитьКонстантыВестиУчетПоОрганизациям");
	Методы.Вставить("УстановитьФорматСохраненияРегистровУчета");
	Методы.Вставить("ЗаполнитьТабличныеЧастиДанныхПоНДСДокументаВНО");
	Методы.Вставить("ЗаполнитьКлючиСвязейТабличныхЧастейДокументаВНО");
	Методы.Вставить("УстановитьПоказыватьСчетаВДокументах");
	Методы.Вставить("ЗаполнитьТабличныеЧастиРасчетовСПодотчетнымиЛицамиДокументаВНО");
	Методы.Вставить("ЗаписатьОперациюБизнесСтатистикиИспользоватьТабличныеФормыБанковскихДокументов");
	Методы.Вставить("ЗаполнитьТабличныеЧастиРасчетовСКонтрагентамиДокументаВНО");
	Методы.Вставить("ЗаполнитьТабличныеЧастиНоменклатурыДокументаВНО");
	Методы.Вставить("УстановитьКонстантуИспользоватьСервисМониторингБанков");
	Методы.Вставить("ЗаполнитьЗначениеРеквизитаВалютный");
	Методы.Вставить("УстановитьКорректировкуДляДокументовПоЗП");
	Методы.Вставить("ВключитьРазделЗарплатаВПростомИнтерфейсе");
...
Процедура ДобавитьОбработчикиОбновленияПоставляемыхДанных(Обработчики)
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "3.0.195.16";
	Обработчик.Процедура           = "Справочники.ВидыНалоговИПлатежейВБюджет.ЗаполнитьПоставляемыеДанные";
	Обработчик.НачальноеЗаполнение = Ложь; // Для начального заполнения вызывается в 3.0.39.29
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "3.0.196.17";
	Обработчик.Процедура           = "РегистрыСведений.КлассПрофессиональногоРискаИСтавкаВзносаНаСтрахованиеОтНесчастныхСлучаев.ЗаполнитьПоставляемыеДанные";
	Обработчик.ОбщиеДанные         = Истина;
	Обработчик.НачальноеЗаполнение = Истина;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "3.0.197.11";
	Обработчик.Процедура           = "Справочники.ЗадачиБухгалтера.ЗаполнитьТребованиямиНормативныхДокументов";
...
Процедура УстановитьДатуТекущейВерсии() Экспорт
	...
	Константы.ДатаТекущейВерсии.Установить(Дата(2026,05,23));
...
Процедура ЗаполнитьТаблицуЦелевогоВремениКлючевыхОпераций(ТаблицаКлючевыхОпераций)
	...
	ДобавитьЦелевоеВремя(ТаблицаКлючевыхОпераций, "ФормированиеОтчетаСправкаРасчетКлассификацияПоСрокамЗадолженности", 10);
	///////////////////////
	// Обработки
...
Процедура ВключитьРазделЗарплатаВПростомИнтерфейсе() Экспорт

	ВключитьРаздел = Константы.ИнтерфейсТаксиПростой.Получить()
		И Константы.ОтображатьПодсистемуСотрудники.Получить()
		И Константы.УчетЗарплатыИКадровВоВнешнейПрограмме.Получить();
	
	Если Не ВключитьРаздел Тогда
		Возврат;
	КонецЕсли;
	
	МенеджерЗначения = Константы.ОтображатьПодсистемуЗарплата.СоздатьМенеджерЗначения();
	МенеджерЗначения.Значение = Истина;
	ОбновлениеИнформационнойБазы.ЗаписатьДанные(МенеджерЗначения);
	
	МенеджерЗначения = Константы.ОтображатьПодсистемуСотрудники.СоздатьМенеджерЗначения();
