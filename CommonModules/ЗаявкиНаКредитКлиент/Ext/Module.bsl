...
Функция ПараметрыПодписанияИОтправки(СервисОбменаСБанками) Экспорт
	...
	// Ссылка на перечисление ТипыТранзакцийОбменаСБанкамиЗаявкиНаКредит или ТипыТранзакцийОбменаСБанкамиЗаявкиНаЛизинг.
...
Процедура ОповеститьОНовыхСообщенияхОтБанков(НовыеСообщенияОтБанков) Экспорт 
	...
	Для	Каждого ОписаниеСообщения Из НовыеСообщенияОтБанков Цикл
		...
		Пояснение = СтрШаблон(НСтр("ru='Новое сообщение от сервиса %1'"), ОписаниеСообщения.СервисОбменаСБанками);
