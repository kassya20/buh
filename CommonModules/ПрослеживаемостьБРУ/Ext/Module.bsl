...
Функция ПодготовитьПараметрыТаблицыРеализацияПрослеживаемыхТоваров(ТаблицаТоваров, ТаблицаРеквизитов, КорректировочныеДокументы)
	...
	Параметры.Вставить("КорректировочныеДокументы", ОбщегоНазначенияБПВызовСервера.ПолучитьТаблицуПараметровПроведения(
...
Функция ПараметрыУведомленияОПеремещении(Документ)
	...
	Если ДатаДокумента >= ПрослеживаемостьБРУ.ДатаИзмененияФорматаУведомленияОПеремещенииС4Кв2022() Тогда 
