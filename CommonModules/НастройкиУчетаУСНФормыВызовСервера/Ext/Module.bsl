...
Функция НастройкиОрганизацииИСистемыНалогообложения(Организация, Период) Экспорт
	
	Настройки = Новый Структура;
	
	// Настройки, зависящие от организации.
	
	НастройкиОрганизации = НастройкиОрганизации(Организация, Период);
	
	Настройки.Вставить("ЭтоЮрЛицо",              НастройкиОрганизации.ЭтоЮрЛицо);
	Настройки.Вставить("КодРегиона",             НастройкиОрганизации.КодРегиона);
	Настройки.Вставить("СписокПатентов",         НастройкиОрганизации.СписокПатентов);
	
	// Настройки, зависящие от системы налогообложения организации.
	...
	Настройки.Вставить("ПрименяетсяАУСН",                  УчетнаяПолитика.ПрименяетсяАУСН(Организация, Период));
	
	Возврат Настройки;
	
КонецФункции

Функция НастройкиОрганизации(Организация, Период) Экспорт
	
	Настройки = Новый Структура;
	
	Настройки.Вставить("ЭтоЮрЛицо", ЭтоЮрЛицо(Организация));
	Настройки.Вставить("КодРегиона", Справочники.Организации.КодРегионаПоМестуРегистрации(Организация, Период));
