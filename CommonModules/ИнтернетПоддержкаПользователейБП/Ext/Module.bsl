...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("УстановитьВидимостьНовостейРазделов");
...
Процедура ПриДобавленииПараметровРаботыКлиента(Параметры) Экспорт
	...
	Параметры.Вставить("РежимИнтерфейсаПользователяРазрешаетРаботуСНовостями", Истина);
	Если ОбщегоНазначения.РазделениеВключено()
			И ОбщегоНазначения.ДоступноИспользованиеРазделенныхДанных()
			И (ОбщегоНазначенияБП.ЭтоИнтерфейсИнтеграцииСБанком()) Тогда
		Параметры.РежимИнтерфейсаПользователяРазрешаетРаботуСНовостями = Ложь;
	КонецЕсли;
...
#Область ОбработкаЧастоЗадаваемыеВопросы

// Функция - возвращает ссылку на элемент справочника "Ленты новостей" - часто задаваемые новости
// 
// Возвращаемое значение:
//  СправочникСсылка.ЛентыНовостей - ссылка на справочник
//
Функция ЛентаНовостейЧастоЗадаваемыеВопросы() Экспорт
	
	Возврат ОбработкаНовостейПовтИсп.ПолучитьЛентуНовостейПоКоду("FAQ");
	
КонецФункции

// Функция - ленты новостей "Часто задаваемые вопросы"
// 
// Возвращаемое значение:
//  Строка - перечисление через запятую порядка сортировки новостей
//
Функция ПорядокЧастоЗадаваемыхВопросов() Экспорт
	
	Возврат "ДатаПубликации Убыв, Важность Убыв";
