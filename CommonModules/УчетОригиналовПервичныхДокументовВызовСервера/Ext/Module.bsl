...
Процедура ЗаписатьСостоянияОригиналовПослеПечати(ОбъектыПечати, СписокПечати, Записано = Ложь) Экспорт
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьУчетОригиналовПервичныхДокументов") И Не Пользователи.ЭтоСеансВнешнегоПользователя() Тогда
		...
		ОбъектыПечатиОригиналов = Новый СписокЗначений;
		Для Каждого ОбъектПечати Из ОбъектыПечати Цикл
			ОбъектыПечатиОригиналов.Добавить(ОбъектПечати.Значение, ОбъектПечати.Представление, ОбъектПечати.Пометка, ОбъектПечати.Картинка);
		КонецЦикла;
		УчетОригиналовПервичныхДокументовБП.ДополнитьОбъектыПечатиИМакетыПриЗаписиСостоянийОригиналовПослеПечати(
			ОбъектыПечатиОригиналов, СписокПечати);
		
		УчетОригиналовПервичныхДокументов.ПриОпределенииСпискаПечатныхФорм(ОбъектыПечатиОригиналов, СписокПечати);
		Если СписокПечати.Количество() = 0 Тогда
			Возврат;
		КонецЕсли;
		УчетОригиналовПервичныхДокументов.ЗаписатьСостоянияОригиналовДокументаПослеПечатиФормы(ОбъектыПечатиОригиналов, СписокПечати, Записано);
	КонецЕсли;
