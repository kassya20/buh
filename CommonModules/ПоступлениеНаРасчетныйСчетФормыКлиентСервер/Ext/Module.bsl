...
Функция ДокументМожетБытьОформленВВалюте(ВидОперации) Экспорт
	...
	Возврат ВидОперации <> ПредопределенноеЗначение("Перечисление.ВидыОперацийПоступлениеДенежныхСредств.ВозвратЗаймаРаботником")
		  ...
		  И ВидОперации <> ПредопределенноеЗначение("Перечисление.ВидыОперацийПоступлениеДенежныхСредств.ВзносВУставныйКапитал")
		  И ВидОперации <> ПредопределенноеЗначение("Перечисление.ВидыОперацийПоступлениеДенежныхСредств.ВозвратНалога")
...
Функция ДокументМожетБытьОформленВЦифровыхРублях(ВидОперации) Экспорт
	...
	Возврат ВидОперации <> ПредопределенноеЗначение("Перечисление.ВидыОперацийПоступлениеДенежныхСредств.ВзносНаличными")
		  И ВидОперации <> ПредопределенноеЗначение("Перечисление.ВидыОперацийПоступлениеДенежныхСредств.Инкассация")
		  И ВидОперации <> ПредопределенноеЗначение("Перечисление.ВидыОперацийПоступлениеДенежныхСредств.ПолучениеКредита")
		  И ВидОперации <> ПредопределенноеЗначение("Перечисление.ВидыОперацийПоступлениеДенежныхСредств.РасчетыПоКредитамИЗаймам")
		  И ВидОперации <> ПредопределенноеЗначение("Перечисление.ВидыОперацийПоступлениеДенежныхСредств.ПолучениеЗайма")
		  И ВидОперации <> ПредопределенноеЗначение("Перечисление.ВидыОперацийПоступлениеДенежныхСредств.ВозвратЗаймаКонтрагентом")
		  И ВидОперации <> ПредопределенноеЗначение("Перечисление.ВидыОперацийПоступлениеДенежныхСредств.ВозвратЗаймаРаботником")
		  И ВидОперации <> ПредопределенноеЗначение("Перечисление.ВидыОперацийПоступлениеДенежныхСредств.ПриобретениеИностраннойВалюты")
		  И ВидОперации <> ПредопределенноеЗначение("Перечисление.ВидыОперацийПоступлениеДенежныхСредств.ПоступленияОтПродажиИностраннойВалюты")
		  И ВидОперации <> ПредопределенноеЗначение("Перечисление.ВидыОперацийПоступлениеДенежныхСредств.ПоступленияОтПродажПоПлатежнымКартамИБанковскимКредитам")
		  И ВидОперации <> ПредопределенноеЗначение("Перечисление.ВидыОперацийПоступлениеДенежныхСредств.ЛичныеСредстваПредпринимателя")
		  И ВидОперации <> ПредопределенноеЗначение("Перечисление.ВидыОперацийПоступлениеДенежныхСредств.Депозит");
...
Функция ПараметрыУстановкиСвойствСубконто(Форма, Префикс = "", Постфикс = "") Экспорт
	...
	Если Постфикс = "УслугиБанка" И Не ЗначениеЗаполнено(Форма.Объект.СчетУчетаРасчетовСКонтрагентом) Тогда
...
Функция ТекущиеПараметрыОбъекта(Форма) Экспорт
	...
	Если ФормаДокументаОднострочная(Форма) Тогда
		...
		ПараметрыОбъекта.СуммаВозврата = Форма.РасшифровкаПлатежаСуммаВозврата;
		...
		Если Форма.СвойстваПлатежа = Неопределено Тогда
			...
			ПараметрыОбъекта.ПорядокОтраженияАванса = Форма.РасшифровкаПлатежаПорядокОтраженияАванса;
		Иначе
			ПараметрыОбъекта.УслугаНПД = Форма.СвойстваПлатежа.УслугаНПД;
			ПараметрыОбъекта.ПорядокОтраженияАванса = Форма.СвойстваПлатежа.ПорядокОтраженияАванса;
		КонецЕсли;
	Иначе
		Если Форма.СвойстваПлатежа = Неопределено Тогда
			...
			ПараметрыОбъекта.СуммаВозврата      = 0;
		Иначе
			ПараметрыОбъекта.ДоговорКонтрагента = Форма.СвойстваПлатежа.ДоговорКонтрагента;
			...
			ПараметрыОбъекта.СуммаВозврата      = Форма.СвойстваПлатежа.СуммаВозврата;
			ПараметрыОбъекта.УслугаНПД          = Форма.СвойстваПлатежа.УслугаНПД;
			ПараметрыОбъекта.ПорядокОтраженияАванса = Форма.СвойстваПлатежа.ПорядокОтраженияАванса;
		КонецЕсли;
	КонецЕсли;
	...
	СтатьяДДС = УчетДенежныхСредствВызовСервера.СтатьяДДСПоУмолчанию(Форма.Объект.ВидОперации, Форма.Объект.Дата);
...
Процедура ОбновитьИтоги(Форма) Экспорт
	...
	РасшифровкаПлатежаПлатежныеКартыПолучитьИтоги(Форма);
...
Процедура ВидимостьДоступностьПолейПриИзмененииСпособаПогашения(Форма) Экспорт
	...
	Если НазваниеТабличнойЧасти <> "РасшифровкаПлатежа"
		И НазваниеТабличнойЧасти <> "РасшифровкаПлатежаПлатежныеКарты" Тогда
		Возврат;
	КонецЕсли;
	...
	ПогашениеЗадолженностиПоДокументу =
		СтрокаПлатежа.СпособПогашенияЗадолженности = ПредопределенноеЗначение("Перечисление.СпособыПогашенияЗадолженности.ПоДокументу");
	
	Элементы.ГруппаСделка.Видимость = ПогашениеЗадолженностиПоДокументу;
	Элементы.ГруппаПлатежныеКартыСделка.Видимость = ПогашениеЗадолженностиПоДокументу;
...
Процедура СформироватьПрочееТекстДоходыУСН(Форма) Экспорт
	...
	Если Не Форма.ПрименениеУСН И Не Форма.ПрименяетсяАУСН Тогда
...
Процедура РассчитатьСуммуВзаиморасчетов(СтрокаПлатеж, Форма, Знач ПересчитатьКурсВзаиморасчетов = Ложь) Экспорт
	...
	ИначеЕсли Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийПоступлениеДенежныхСредств.ПриобретениеИностраннойВалюты") Тогда
		...
		Если ПересчитатьКурсВзаиморасчетов Тогда
			СтрокаПлатеж.КурсВзаиморасчетов = ?(СтрокаПлатеж.СуммаПлатежа = 0,
				0,
				Окр(СтрокаПлатеж.КратностьВзаиморасчетов * СтрокаПлатеж.СуммаВзаиморасчетов / СтрокаПлатеж.СуммаПлатежа, 4));
		Иначе
...
Функция ПлательщикНДССВычетами(ПараметрыПлатежа) Экспорт
	
	ПлательщикНДС = ПараметрыПлатежа.ПлательщикНДС
		Или ПараметрыПлатежа.ПлательщикНДСПриУСН
			И ПараметрыПлатежа.СтавкаНДСПриУСН = ПредопределенноеЗначение("Перечисление.ВидыСтавокНДС.Общая");
	
	Возврат ПлательщикНДС;
	
КонецФункции

Процедура ВыводПредупрежденияОНастройкеПорядкаОтраженияКомиссииВРасходах(Форма, ЕстьТабличнаяЧасть) Экспорт
	
	Если ФормаРасшифровкиПлатежа(Форма) Или БанкИКассаФормыКлиентСервер.ФормаДокументаИнтеграцииСБанком(Форма) Тогда
		Возврат;
	КонецЕсли;
	...
	Если ЕстьТабличнаяЧасть Тогда
		...
		СуммаУслуг = РасшифровкаПлатежа.Итог("СуммаУслуг");
	Иначе
		СуммаУслуг = Форма.РасшифровкаПлатежаСуммаУслуг;
	КонецЕсли;
	
	Если СуммаУслуг > 0
		И ЗначениеЗаполнено(Форма.СвойстваПлатежа.ВидОплаты)
		И Форма.СвойстваПлатежа.ВидОплатыРеквизиты.УчитыватьНДСПоКомиссииЭталон
		И Не Форма.СвойстваПлатежа.ВидОплатыРеквизиты.УчитыватьНДСПоКомиссии Тогда
		Элементы.ГруппаСуммаУслуг.ЦветФона = Форма.ЦветПредупрежденияОНастройке;
		
		ФорматированныеСтроки = Новый Массив;
		ФорматированныеСтроки.Добавить(НСтр("ru = 'Для выделения НДС настройте'"));
		ФорматированныеСтроки.Добавить(" ");
		
		ТекстНастройки = НСтр("ru = 'отражение в расходах'");
		НавигационнаяСсылка = ПолучитьНавигационнуюСсылку(Форма.СвойстваПлатежа.ВидОплаты);
		Гиперссылка = Новый ФорматированнаяСтрока(ТекстНастройки,,,, НавигационнаяСсылка);
		ФорматированныеСтроки.Добавить(Гиперссылка);
		
		ТекстПредупреждения = Новый ФорматированнаяСтрока(ФорматированныеСтроки);
		
		Элементы.ГруппаСуммаУслуг.РасширеннаяПодсказка.Заголовок = ТекстПредупреждения;
		Элементы.ГруппаСуммаУслуг.ОтображениеПодсказки = ОтображениеПодсказки.ОтображатьСправа;
		
		Если Не ФормаДокументаОднострочная(Форма)
			И Элементы.ГруппаПлатежныеКартыСтраницы.ТекущаяСтраница <> Элементы.ГруппаПлатежныеКартыУслугиБанка Тогда
			Элементы.ГруппаПлатежныеКартыСтраницы.ТекущаяСтраница = Элементы.ГруппаПлатежныеКартыУслугиБанка;
		КонецЕсли;
	Иначе
		Элементы.ГруппаСуммаУслуг.ЦветФона = Форма.ЦветОтсутствияПредупреждения;
		Элементы.ГруппаСуммаУслуг.РасширеннаяПодсказка.Заголовок = "";
		Элементы.ГруппаСуммаУслуг.ОтображениеПодсказки = ОтображениеПодсказки.Авто;
	КонецЕсли;
...
Функция ИменаЭлементовОтраженияДохода() Экспорт
	...
	Имена.Добавить("РасшифровкаПлатежаПлатежныеКартыОтражениеАвансаПредставление");
...
Процедура ЗаполнитьРеквизитыРасшифровкаПлатежа(Форма, ЗаполнитьРеквизитыФормы = Ложь, СтрокаПлатежа = Неопределено) Экспорт
	...
	Если Не ЗаполнитьРеквизитыФормы И Не Форма.Модифицированность И ЗначениеЗаполнено(Форма.Объект.Ссылка) Тогда
	...
	ОднаСтрокаВТаблице = Объект.РасшифровкаПлатежа.Количество() = 1;
	
	Для Каждого КлючИЗначение Из РеквизитыРасшифровкаПлатежа() Цикл
		Если ОднаСтрокаВТаблице Тогда
			...
			КонецЕсли;
		ИначеЕсли ЗаполнитьРеквизитыФормы И СтрокаПлатежа = Неопределено И СтрНайти(КлючИЗначение.Ключ, "Сумма") > 0
			И ТипЗнч(Объект.РасшифровкаПлатежа[0][КлючИЗначение.Ключ]) = Тип("Число") Тогда
			Форма["РасшифровкаПлатежа" + КлючИЗначение.Ключ] = Объект.РасшифровкаПлатежа.Итог(КлючИЗначение.Ключ);
		КонецЕсли;
	КонецЦикла;
	...
	Если Не ЗаполнитьРеквизитыФормы Тогда
		Если Объект.РасшифровкаПлатежа.Количество() = 1 Тогда
			...
			Объект.СуммаВозврата      = Форма.РасшифровкаПлатежаСуммаВозврата;
		КонецЕсли;
		
		Объект.ДоговорКонтрагента = Форма.РасшифровкаПлатежаДоговорКонтрагента;
	КонецЕсли;
...
Функция ДанныеРасшифровкиПлатежаОднострочнойФормы(Форма) Экспорт
	...
	Результат.СуммаВозврата                  = Форма.РасшифровкаПлатежаСуммаВозврата;
...
Функция ПустаяСтруктураСвойстваПлатежа() Экспорт
	...
	СвойстваПлатежа = Новый Структура("ДоговорКонтрагента, УслугаНПД,
		...
		|СуммаУслуг, ВидОплаты, ВидОплатыРеквизиты,
		|СуммаВозврата,
		|СтатьяДвиженияДенежныхСредств");
...
Функция СвойстваСтрокРасшифровкиПлатежа(ПараметрыОбъекта, ПолучатьДоговор) Экспорт
	...
	Если (НЕ ЗначениеЗаполнено(ПараметрыОбъекта.ВидОперации)
		...
		КонецЕсли;
		Если ЗначениеЗаполнено(ПараметрыОбъекта.ПорядокОтраженияАванса) Тогда
			СвойстваПлатежа.ПорядокОтраженияАванса = ПараметрыОбъекта.ПорядокОтраженияАванса;
		КонецЕсли;
	...
	Иначе
		...
		ПараметрыПлатежа = Новый Структура("ВидОперации, Организация, Дата, Контрагент, ДоговорКонтрагента,
			...
			|НазначениеПлатежа,
			|СтавкаНДСПриУСН, ПорядокОтраженияАванса, Ссылка");
...
Процедура ПлатежныеКартыОбработатьИзменениеСуммыУслуг(Форма, ЕстьТабличнаяЧасть = Истина, Настройки = Неопределено) Экспорт
	...
	Если Форма.СвойстваПлатежа.ДоговорКонтрагента = Неопределено Тогда
		...
		ПараметрыОбъекта.СуммаВозврата      = СтрокаПлатеж.СуммаВозврата;
	...
	Форма.СвойстваПлатежа.СуммаВозврата = СтрокаПлатеж.СуммаВозврата;
	
	РасшифровкаПлатежаПлатежныеКартыПолучитьИтоги(Форма);
	
	ВыводПредупрежденияОНастройкеПорядкаОтраженияКомиссииВРасходах(Форма, ЕстьТабличнаяЧасть);
	
КонецПроцедуры

Процедура РасшифровкаПлатежаПлатежныеКартыПолучитьИтоги(Форма)
	
	Объект = Форма.Объект;
	
	Если ФормаДокументаОднострочная(Форма)
		Или НазваниеТаблицыРасшифровкиПлатежа(Объект.ВидОперации) <> "РасшифровкаПлатежаПлатежныеКарты" Тогда
		Возврат;
	КонецЕсли;
	...
	РасшифровкаПлатежа = ПолучитьРасшифровкаПлатежа(Форма);
	ИтогоСуммаПлатежа  = РасшифровкаПлатежа.Итог("СуммаПлатежа");
	ИтогоСуммаУслуг    = РасшифровкаПлатежа.Итог("СуммаУслуг");
	ИтогоСуммаВозврата = РасшифровкаПлатежа.Итог("СуммаВозврата");
	
	Элементы.РасшифровкаПлатежаПлатежныеКартыСуммаПлатежа.ТекстПодвала  = Формат(ИтогоСуммаПлатежа,  "ЧЦ=15; ЧДЦ=2");
	Элементы.РасшифровкаПлатежаПлатежныеКартыСуммаУслуг.ТекстПодвала    = Формат(ИтогоСуммаУслуг,    "ЧЦ=15; ЧДЦ=2");
	Элементы.РасшифровкаПлатежаПлатежныеКартыСуммаВозврата.ТекстПодвала = Формат(ИтогоСуммаВозврата, "ЧЦ=15; ЧДЦ=2");
...
Процедура ПлатежныеКартыОбработатьИзменениеСуммыВозврата(Форма, ЕстьТабличнаяЧасть = Истина) Экспорт
	
	Объект = Форма.Объект;
	
	Если ЕстьТабличнаяЧасть Тогда
		РасшифровкаПлатежа = ПоступлениеНаРасчетныйСчетФормыКлиентСервер.ПолучитьРасшифровкаПлатежа(Форма);
		Объект.СуммаВозврата = РасшифровкаПлатежа.Итог("СуммаВозврата");
	Иначе
		Объект.СуммаВозврата = Форма.РасшифровкаПлатежаСуммаВозврата;
	КонецЕсли;
...
Процедура ВидимостьДоступностьСуммыДокумента(Форма) Экспорт
...
Функция НачатьЗаполнениеСчетовУчета(ПричиныИзменения, Объект = Неопределено, СтрокаСписка = Неопределено, КонтейнерОбъект = Неопределено, КонтейнерСтрокаСписка = Неопределено) Экспорт
	...
	Если ПараметрыЗаполнения.ПричиныИзменения.Найти("Налог") <> Неопределено Тогда
		Если ПараметрыЗаполнения.Заполнять = Ложь
			...
			ПредопределенноеЗначение("Перечисление.ВидыОперацийПоступлениеДенежныхСредств.ВозвратНалога") Тогда
	...
	Если ПараметрыЗаполнения.Свойство("Контейнер") Тогда
		...
		Если ПараметрыЗаполнения.ПричиныИзменения.Найти("ДоговорКонтрагента") <> Неопределено Тогда
			...
			СчетаУчетаВДокументахКлиентСервер.ДополнитьДанныеЗаполнения(ПараметрыЗаполнения, "Объект", "ВалютаДокумента");
			СчетаУчетаВДокументахКлиентСервер.ДополнитьДанныеЗаполнения(ПараметрыЗаполнения, "Строка", "СчетУчетаРасчетовПоАвансам");
			СчетаУчетаВДокументахКлиентСервер.ДополнитьДанныеЗаполнения(ПараметрыЗаполнения, "Объект", "НазначениеПлатежа");
			СчетаУчетаВДокументахКлиентСервер.ДополнитьДанныеЗаполнения(ПараметрыЗаполнения, "Объект", "СчетУчетаРасчетовСКонтрагентом");
			СчетаУчетаВДокументахКлиентСервер.ДополнитьДанныеЗаполнения(ПараметрыЗаполнения, "Объект", "СубконтоКт1");
			СчетаУчетаВДокументахКлиентСервер.ДополнитьДанныеЗаполнения(ПараметрыЗаполнения, "Объект", "СубконтоКт2");
			СчетаУчетаВДокументахКлиентСервер.ДополнитьДанныеЗаполнения(ПараметрыЗаполнения, "Объект", "СубконтоКт3");
			СчетаУчетаВДокументахКлиентСервер.ДополнитьДанныеЗаполнения(ПараметрыЗаполнения, "Объект", "ПодразделениеКт");
			СчетаУчетаВДокументахКлиентСервер.ДополнитьДанныеЗаполнения(ПараметрыЗаполнения, "Объект", "БезЗакрывающихДокументов");
			СчетаУчетаВДокументахКлиентСервер.ДополнитьДанныеЗаполнения(ПараметрыЗаполнения, "Объект", "Ссылка");
		КонецЕсли;
