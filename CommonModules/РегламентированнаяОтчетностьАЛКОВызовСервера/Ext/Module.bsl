...
Функция ЭтоWindowsСервер() Экспорт
	...
	Возврат РегламентированнаяОтчетностьАЛКО.ЭтоWindowsСервер()
...
Функция ЭтоLinuxСервер() Экспорт
	...
	Возврат РегламентированнаяОтчетностьАЛКО.ЭтоLinuxСервер()
...
//
Функция ЭтоLinuxСерверХ64() Экспорт

	Возврат РегламентированнаяОтчетностьАЛКО.ЭтоLinuxСерверХ64();
...
//  Булево - Истина, если сервер работает под управлением ОС Linux Х64.
//
Функция ЭтоWindowsСерверХ64() Экспорт

	Возврат РегламентированнаяОтчетностьАЛКО.ЭтоWindowsСерверХ64();
...
//  Число
//
Функция ОперативнаяПамятьСервера() Экспорт

	Возврат РегламентированнаяОтчетностьАЛКО.ОперативнаяПамятьСервера();
...
Функция ВерсияПлатформыБольшеИлиРавнаЧем(ВерсияСравнения, ТекущаяВерсия = Неопределено) Экспорт

	ТекущаяВерсия = ВерсияПлатформы();
...
Процедура ДобавитьСтраницыПоОПвДекларации(Форма, 
	...
	РегламентированнаяОтчетностьАЛКО.ДобавитьСтраницыПоОПвДекларации(Форма, 
					НаименованиеОП, ПредставлениеАдреса, АдресXML, КПП, 
...
Функция Стили_БРО_АЛКО() Экспорт
	...
	Возврат ОбщегоНазначения.СкопироватьРекурсивно(
				РегламентированнаяОтчетностьАЛКОПовтИсп.Стили_БРО_АЛКО());
	
КонецФункции

Процедура СброситьНастройкиОкна(ИмяФормы) Экспорт

	РегламентированнаяОтчетностьАЛКО.СброситьНастройкиОкна(ИмяФормы);

КонецПроцедуры

Процедура СохранитьМасштаб(ИмяФормы, Масштаб) Экспорт
	
	РегламентированнаяОтчетностьАЛКО.СохранитьМасштаб(ИмяФормы, Масштаб);
	
КонецПроцедуры

Процедура ПодготовкаИнтерфейсаФормыАЛКО(Форма) Экспорт
	
	РегламентированнаяОтчетностьАЛКО.ПодготовкаИнтерфейсаФормыАЛКО(Форма);
	
КонецПроцедуры

Функция ТекущийИнтерфейс85() Экспорт
	Возврат РегламентированнаяОтчетностьАЛКО.ТекущийИнтерфейс85();
КонецФункции
