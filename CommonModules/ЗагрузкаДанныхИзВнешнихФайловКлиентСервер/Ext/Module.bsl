...
Функция СтатистикаСтатусовСтрокТаблицы(ТаблицаСоСтатусами) Экспорт
	...
	Статистика = Новый Структура("Всего, Найденные, Новые, Дубли, НовыеДоговоры", 0, 0, 0, 0, 0);
	...
	Для Каждого СтрокаТаблицы Из ТаблицаСоСтатусами Цикл
		...
		ИначеЕсли СтрокаТаблицы.Статус = СтатусНовыйДоговор() Тогда
			Статистика.НовыеДоговоры = Статистика.НовыеДоговоры + 1;
		КонецЕсли;
...
Функция СтатусНовыйДоговор() Экспорт
