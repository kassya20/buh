...
Процедура ПриОпределенииНастроекПодключения(Настройки) Экспорт
	...
	Настройки.Вставить("ОбъектМетаданных",  Метаданные.РегистрыСведений.СоответствиеНастроекИнтеграцииИнтернетЭквайринг);
...
Процедура ПриЗаписиНастроекПодключения(
	...
	Запись = РегистрыСведений.СоответствиеНастроекИнтеграцииИнтернетЭквайринг.СоздатьМенеджерЗаписи();
	Запись.НастройкаПодключения =  ПрикладныеНастройки["НастройкаПодключения"];
	Запись.Организация   = ПрикладныеНастройки["Организация"];
	Запись.ВидОплаты     = ПрикладныеНастройки["ВидОплаты"];
	Запись.Записать();
...
Процедура ПриФормированииЗаказаНаВозврат(
	...
	РеквизитыДокумента = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ДокументВозврата, 
		Новый Структура("ДатаВозврата,СуммаВозврата", "Дата", "СуммаДокумента"));
		
	ЗаполнитьЗначенияСвойств(ЗаказНаВозврат, РеквизитыДокумента, "ДатаВозврата,СуммаВозврата");
КонецПроцедуры
