...
Функция СпособВводаВОборотСУЗПоВидуОперации(ВидОперации, ВидПродукции = Неопределено) Экспорт
	...
	ИначеЕсли ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийИСМП.ВводВОборотМаркировкаОстатков") Тогда
		Если ИнтеграцияИСКлиентСервер.ДоступенСпособВводаВОборотМаркировкаОстатков(ВидПродукции) Тогда
...
// Возвращаемое значение:
//   Булево - параметры сканирования дополнены спецификой ИС МП.
Функция ЗаполнитьПараметрыСканированияДокументаРозничнойПродажи(ПараметрыСканирования, ВидПродукции, Контекст = Неопределено) Экспорт
...
// Возвращаемое значение:
//   Булево - параметры сканирования дополнены спецификой ИС МП.
Функция ЗаполнитьПараметрыСканированияДокументаОптовогоВозврата(ПараметрыСканирования, ВидПродукции, Контекст = Неопределено) Экспорт
...
// Возвращаемое значение:
//   Булево - параметры сканирования дополнены спецификой ИС МП.
Функция ЗаполнитьПараметрыСканированияДокументаЗакупки(ПараметрыСканирования, ВидПродукции, Контекст = Неопределено) Экспорт
...
// Возвращаемое значение:
//   Булево - параметры сканирования дополнены спецификой ИС МП.
Функция ЗаполнитьПараметрыСканированияДокументаВнутреннегоПеремещения(ПараметрыСканирования, ВидПродукции, Контекст = Неопределено) Экспорт
...
// * НеПоддерживаетсяОСУ                             - Булево - Истина, если отсканирован код ОСУ в случае, где отгрузка по ОСУ недоступна по датам.
Функция ПараметрыРасширенногоОписанияОшибки() Экспорт
	...
	ВозвращаемоеЗначение.Вставить("НеПоддерживаетсяОСУ",                             Ложь);
...
Процедура ЗаполнитьПараметрыСканированияМаркировкаТоваров(Контекст, ПараметрыСканирования, ПараметрыРежимаИсправленияОшибок = Неопределено)
	...
	ПараметрыСканирования.ДопустимыйСпособВводаВОборот = СпособВводаВОборотСУЗПоВидуОперации(Операция, ВидПродукции);
...
Процедура ЗаполнитьПараметрыСканированияВыводаИзОборота(Контекст, ПараметрыСканирования)
	...
	Если ИнтеграцияИСМПСлужебныйКлиентСервер.ДоступнаПередачаУведомленияОбЭкспорте(
			ИсточникДанных.ВидПродукции, ИсточникДанных.Операция) Тогда
	...
	Если Не ИсточникДанных.ОбъемноСортовойУчет
		И ОбщегоНазначенияИСКлиентСерверПовтИсп.ПоддерживаетсяЧастичноеВыбытие(ВидПродукции, Операция) Тогда
		ПараметрыСканирования.ТребуетсяЧастичноеВыбытие = Истина;
	КонецЕсли;
...
Процедура ЗаполнитьПараметрыСканированияОтгрузкаТоваровИСМП(Контекст, ПараметрыСканирования)
	...
	Если Операция = ПредопределенноеЗначение("Перечисление.ВидыОперацийИСМП.ОтгрузкаЕАЭССПризнаниемКИ") Тогда
		ПараметрыСканирования.ДопустимыйСпособВводаВОборот =
			СпособВводаВОборотСУЗПоВидуОперации(Операция, ВидПродукции);
	КонецЕсли;
...
Процедура ЗаполнитьПараметрыСканированияПеремещениеМеждуМОД_ИСМП(Контекст, ПараметрыСканирования) Экспорт
	...
	ПараметрыСканирования.ПоддерживаетсяОбъемноСортовойУчет  = Истина;
	ПараметрыСканирования.ДопустимыеВидыПродукции            = Новый Массив(ОбщегоНазначенияИСМПКлиентСерверПовтИсп.ВидыПродукцииВнутреннегоПеремещенияМеждуМОД());
...
Процедура ЗаполнитьПараметрыСканированияОтчетОбИмпортеЕГАИС(ПараметрыСканирования, Контекст)
	...
	ИначеЕсли ТипЗнч(Контекст) = Тип("ДокументСсылка.ОтчетОбИмпортеЕГАИС") Тогда
		СтруктураПараметров = Новый Структура("Организация, ДокументОснование", "ОрганизацияЕГАИС.Контрагент", "ДокументОснование");
		ИсточникДанных = ОбщегоНазначенияИСВызовСервера.ЗначенияРеквизитовОбъекта(Контекст, СтруктураПараметров);
