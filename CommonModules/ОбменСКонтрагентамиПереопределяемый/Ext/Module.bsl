...
Процедура ПриОпределенииИспользуемыхТиповЭлектронныхДокументов(ИспользуемыеТипы) Экспорт
	...
	ОбменСКонтрагентами.ДобавитьИспользуемыйТипДокумента(ИспользуемыеТипы, ТипыДокументов.АктВыполненныхРабот);
	ОбменСКонтрагентами.ДобавитьИспользуемыйТипДокумента(ИспользуемыеТипы, ТипыДокументов.СчетФактура);
	ОбменСКонтрагентами.ДобавитьИспользуемыйТипДокумента(ИспользуемыеТипы, ТипыДокументов.КорректировочныйСчетФактура);
	ОбменСКонтрагентами.ДобавитьИспользуемыйТипДокумента(ИспользуемыеТипы, ТипыДокументов.СоглашениеОбИзмененииСтоимости);
	ОбменСКонтрагентами.ДобавитьИспользуемыйТипДокумента(ИспользуемыеТипы, ТипыДокументов.АктНаПередачуПрав);
	ОбменСКонтрагентами.ДобавитьИспользуемыйТипДокумента(ИспользуемыеТипы, ТипыДокументов.УПД);
	ОбменСКонтрагентами.ДобавитьИспользуемыйТипДокумента(ИспользуемыеТипы, ТипыДокументов.УКД);
	ОбменСКонтрагентами.ДобавитьИспользуемыйТипДокумента(ИспользуемыеТипы, ТипыДокументов.АктОРасхождениях);
	ОбменСКонтрагентами.ДобавитьИспользуемыйТипДокумента(ИспользуемыеТипы, ТипыДокументов.АктСверкиВзаиморасчетов);
	ОбменСКонтрагентами.ДобавитьИспользуемыйТипДокумента(ИспользуемыеТипы, ТипыДокументов.АктПриемкиСтроительныхРаботУслуг);
	ОбменСКонтрагентами.ДобавитьИспользуемыйТипДокумента(ИспользуемыеТипы, ТипыДокументов.ДоговорныйДокумент);
	
	// Для обмена по форматам CML 2.
	ОбменСКонтрагентами.ДобавитьИспользуемыйТипДокумента(ИспользуемыеТипы, ТипыДокументов.СчетНаОплату);
	ОбменСКонтрагентами.ДобавитьИспользуемыйТипДокумента(ИспользуемыеТипы, ТипыДокументов.ОтчетОПродажахКомиссионногоТовара);
...
Процедура ПодготовитьСтруктуруОбъектовКомандЭДО(СоставКомандЭДО) Экспорт
	...
	ДокументАктСверкиРасчетов = "Документ.АктСверкиВзаиморасчетов";
	ЖурналДокументы = "ЖурналДокументов.Документы";
	...
	СоставКомандЭДО.Исходящие.Добавить("Документ.ПередачаТоваров");
	СоставКомандЭДО.Исходящие.Добавить("Документ.РеализацияУслугПоПереработке");
	СоставКомандЭДО.Исходящие.Добавить("Документ.ПередачаОС");
	СоставКомандЭДО.Исходящие.Добавить(ДокументАктСверкиРасчетов);   
	СоставКомандЭДО.Исходящие.Добавить("Справочник.ДоговорыКонтрагентов");
	СоставКомандЭДО.Исходящие.Добавить(ЖурналДокументы);
	...
	СоставКомандЭДО.Входящие.Добавить("Документ.ПоступлениеИзПереработки");
	СоставКомандЭДО.Входящие.Добавить("Документ.ВозвратТоваровОтПокупателя");
	СоставКомандЭДО.Входящие.Добавить(ДокументАктСверкиРасчетов);
	СоставКомандЭДО.Входящие.Добавить(ЖурналДокументы);
	...
	СоставКомандЭДО.БезПодписи.Добавить("Документ.АктОРасхождениях");
	СоставКомандЭДО.БезПодписи.Добавить("Документ.ВозвратТоваровОтПокупателя");
	СоставКомандЭДО.БезПодписи.Добавить("Документ.АктОбОказанииПроизводственныхУслуг");
	СоставКомандЭДО.БезПодписи.Добавить("Документ.ПередачаТоваров");
	СоставКомандЭДО.БезПодписи.Добавить("Документ.РеализацияУслугПоПереработке");
	СоставКомандЭДО.БезПодписи.Добавить("Документ.ПередачаОС");
	...
	СоставКомандЭДО.БезПодписи.Добавить(ДокументАктСверкиРасчетов);
	...
	СоставКомандЭДО.Внутренние.Добавить("Документ.ИнвентаризацияРасчетовСКонтрагентами");
	СоставКомандЭДО.Внутренние.Добавить("Документ.ИнвентаризацияТоваровНаСкладе");
	СоставКомандЭДО.Внутренние.Добавить("Документ.ПутевойЛист");
	СоставКомандЭДО.Внутренние.Добавить("Документ.ТребованиеНакладная");
	СоставКомандЭДО.Внутренние.Добавить("Документ.АвансовыйОтчет");
	СоставКомандЭДО.Внутренние.Добавить("Документ.ОперацияБух");
...
Процедура РазрешеноИспользоватьВнутреннийЭДО(Использовать) Экспорт
	...
	ОбменСКонтрагентамиБП.РазрешеноИспользоватьВнутреннийЭДО(Использовать);
...
Процедура ПриОпределенииОбъектовМетаданныхСПоддержкойДиагностикиОшибок(СписокЭлементов) Экспорт
	...
	СписокЭлементов.Добавить(Метаданные.Документы.СчетНаОплатуПоставщика);
	СписокЭлементов.Добавить(Метаданные.Документы.РеализацияТоваровУслуг);
	СписокЭлементов.Добавить(Метаданные.Документы.СчетНаОплатуПокупателю);
	СписокЭлементов.Добавить(Метаданные.Документы.ПоступлениеТоваровУслуг);
	СписокЭлементов.Добавить(Метаданные.Документы.РеализацияТоваровУслуг);
	СписокЭлементов.Добавить(Метаданные.Документы.ПоступлениеДопРасходов);
	СписокЭлементов.Добавить(Метаданные.Документы.ОтчетКомитентуОПродажах);
	СписокЭлементов.Добавить(Метаданные.Документы.ОтчетКомиссионераОПродажах);
	...
	СписокЭлементов.Добавить(Метаданные.Документы.ВозвратТоваровПоставщику);
	СписокЭлементов.Добавить(Метаданные.Документы.ВозвратТоваровОтПокупателя);
	СписокЭлементов.Добавить(Метаданные.Документы.АктОРасхожденияхПолученный);
	СписокЭлементов.Добавить(Метаданные.Документы.АктОРасхождениях);
	СписокЭлементов.Добавить(Метаданные.Документы.АктОбОказанииПроизводственныхУслуг);
	СписокЭлементов.Добавить(Метаданные.Документы.РеализацияУслугПоПереработке);
	СписокЭлементов.Добавить(Метаданные.Документы.ПередачаТоваров);
	СписокЭлементов.Добавить(Метаданные.Документы.ПередачаОС);
...
Процедура ПриОпределенииПечатныхФормЗапрещенныхДляФормированияДокумента(СписокИдентификаторов) Экспорт
	...
	СписокИдентификаторов.Добавить("Реестр");
	СписокИдентификаторов.Добавить("СчетФактура");
	СписокИдентификаторов.Добавить("СчетФактура981");
	СписокИдентификаторов.Добавить("КорректировочныйСчетФактура981");
	СписокИдентификаторов.Добавить("УниверсальныйПередаточныйДокумент");
	СписокИдентификаторов.Добавить("СоглашениеОбИзмененииСтоимости");
	СписокИдентификаторов.Добавить("УниверсальныйКорректировочныйДокумент");
	СписокИдентификаторов.Добавить("ТОРГ2");
	СписокИдентификаторов.Добавить("УПДСтатус1_981");
	СписокИдентификаторов.Добавить("УПДСтатус2_981");
	СписокИдентификаторов.Добавить("ТОРГ12_БезУслуг");
	СписокИдентификаторов.Добавить("ТОРГ12");
	СписокИдентификаторов.Добавить("ТОРГ12_Возврат");
	СписокИдентификаторов.Добавить("УКДСтатус1_981");
	СписокИдентификаторов.Добавить("Конверт");
	СписокИдентификаторов.Добавить("Договора");
	СписокИдентификаторов.Добавить("ПриложениеКДоговору");
	СписокИдентификаторов.Добавить("КомплектДокументов");
...
Процедура ПриОпределенииНастроекПодключаемыхКомандЭДО(Настройки) Экспорт
	...
	Если ОбщегоНазначенияБП.ЭтоПростойИнтерфейс() Тогда
		Настройки.СкрыватьПереходКТекущиеДелаЭДО = Истина;
	КонецЕсли;
...
Процедура ЗаполнитьСоответствиеВидовДоговоровКонтрагентов(Соответствие) Экспорт
	...
	ОбменСКонтрагентамиБП.ЗаполнитьСоответствиеВидовДоговоровКонтрагентов(Соответствие);
...
Процедура ЗаполнитьСоответствиеВидовДоговоровПротивоположноеЗначениюКонтрагентов(Соответствие) Экспорт
	...
	ОбменСКонтрагентамиБП.ЗаполнитьСоответствиеВидовДоговоровПротивоположноеЗначениюКонтрагентов(Соответствие);
...
Процедура СоответствиеИсходящихТиповЭлектронныхДокументовДокументамИБ(СоответствиеТиповЭлектронныхДокументовДокументамИБ) Экспорт 
	...
	СоответствиеТиповЭлектронныхДокументовДокументамИБ.Вставить(ТипыДокументов.ТоварнаяНакладная,
		НСтр("ru = 'Реализация товаров'"));
	СоответствиеТиповЭлектронныхДокументовДокументамИБ.Вставить(ТипыДокументов.АктВыполненныхРабот,
		НСтр("ru = 'Реализация услуг, оказание производственных услуг'"));
	СоответствиеТиповЭлектронныхДокументовДокументамИБ.Вставить(ТипыДокументов.АктНаПередачуПрав,
		НСтр("ru = 'Акт на передачу прав'"));
	СоответствиеТиповЭлектронныхДокументовДокументамИБ.Вставить(ТипыДокументов.СчетФактура,
	...
	СоответствиеТиповЭлектронныхДокументовДокументамИБ.Вставить(ТипыДокументов.СоглашениеОбИзмененииСтоимости,
		НСтр("ru = 'Корректировка реализации, возврат от покупателя'"));
	СоответствиеТиповЭлектронныхДокументовДокументамИБ.Вставить(ТипыДокументов.КорректировочныйСчетФактура,
		НСтр("ru = 'Корректировочный счет-фактура'"));
	СоответствиеТиповЭлектронныхДокументовДокументамИБ.Вставить(ТипыДокументов.СчетНаОплату,
		НСтр("ru = 'Счет покупателю'"));
	СоответствиеТиповЭлектронныхДокументовДокументамИБ.Вставить(ТипыДокументов.ОтчетОПродажахКомиссионногоТовара,
		НСтр("ru = 'Отчет о продажах комитенту'"));
	СоответствиеТиповЭлектронныхДокументовДокументамИБ.Вставить(ТипыДокументов.АктОРасхождениях,
		НСтр("ru = 'Акт о расхождениях'"));
	СоответствиеТиповЭлектронныхДокументовДокументамИБ.Вставить(ТипыДокументов.УПД,
		НСтр("ru = 'Акты, накладные, счета-фактуры'"));
	СоответствиеТиповЭлектронныхДокументовДокументамИБ.Вставить(ТипыДокументов.УКД,
		НСтр("ru = 'Акты, накладные, счета-фактуры (Корректировка)'"));
	СоответствиеТиповЭлектронныхДокументовДокументамИБ.Вставить(ТипыДокументов.АктСверкиВзаиморасчетов,
		НСтр("ru = 'Акт сверки расчетов с контрагентом'"));
	СоответствиеТиповЭлектронныхДокументовДокументамИБ.Вставить(ТипыДокументов.АктПриемкиСтроительныхРаботУслуг,
		НСтр("ru = 'Акт о приемке выполненных строительных работ'"));
...
Процедура СписокТиповДокументовПоТипуЭлектронногоДокумента(ТипДокумента, ОписанияОбъектовУчета) Экспорт
	...
	Если ТипДокумента = ТипыДокументов.ТоварнаяНакладная
		...
		Если ТипДокумента = ТипыДокументов.ТоварнаяНакладная Тогда
			ОписанияОбъектовУчета.Добавить(Документы.ВозвратТоваровОтПокупателя.ПустаяСсылка(),
				Метаданные.Документы.ВозвратТоваровОтПокупателя.Представление());
		КонецЕсли;
	...
	ИначеЕсли ТипДокумента = ТипыДокументов.РеквизитыОрганизации Тогда
		...
		ОписанияОбъектовУчета.Добавить(Справочники.Контрагенты.ПустаяСсылка(),
			Метаданные.Справочники.Контрагенты.Представление());	
			
	ИначеЕсли ТипДокумента	= ТипыДокументов.СчетНаОплату Тогда
		
		ОписанияОбъектовУчета.Добавить(Документы.СчетНаОплатуПоставщика.ПустаяСсылка(),
	...
	ИначеЕсли ТипДокумента = ТипыДокументов.ОтчетОПродажахКомиссионногоТовара Тогда
		...
		ОписанияОбъектовУчета.Добавить(Документы.ОтчетКомиссионераОПродажах.ПустаяСсылка(),
...
Процедура ЗаполнитьПараметрыЭДПоИсточнику(Источник, ПараметрыЭлектронногоДокумента) Экспорт
	...
	ОбменСКонтрагентамиБП.ЗаполнитьПараметрыЭДПоИсточнику(Источник, ПараметрыЭлектронногоДокумента);
...
Процедура ПриОтраженииВУчетеДокументаТЭДО(ДокументУчета, Знач СпособОбработки, Знач ДанныеТЭДО, ОписаниеОшибки) Экспорт
	...
	ОбменСКонтрагентамиБП.ПриОтраженииВУчетеДокументаТЭДО(ДокументУчета, СпособОбработки, ДанныеТЭДО);
...
Процедура ЗаполнитьДанныеУПД_5_02_ИнформацияПродавца(Знач Основание, Знач Настройки, Данные, Описание, Отказ) Экспорт
	...
	ОбменСКонтрагентамиБП.ЗаполнитьДанныеУПД_5_02_ИнформацияПродавца(Основание, Настройки, Данные, Описание, Отказ);
...
Процедура ЗаполнитьДанныеУПД_5_02_ИнформацияПокупателя(Знач Основания, Данные, Отказ) Экспорт
	...
	ОбменСКонтрагентамиБП.ЗаполнитьДанныеУПД_5_02_ИнформацияПокупателя(Основания, Данные, Отказ);
...
Процедура ЗаполнитьДанныеУПД2019_ИнформацияПродавца(Знач Основание, Знач Настройки, Данные, Описание, Отказ) Экспорт
	...
	ОбменСКонтрагентамиБП.ЗаполнитьДанныеУПД2019_ИнформацияПродавца(Основание, Настройки, Данные, Описание, Отказ);
...
Процедура ЗаполнитьДанныеУПД2019_ИнформацияПокупателя(Знач Основания, Данные, Отказ) Экспорт
	...
	ОбменСКонтрагентамиБП.ЗаполнитьДанныеУПД2019_ИнформацияПокупателя(Основания, Данные, Отказ);
...
Процедура ЗаполнитьДанныеУКД_ИнформацияПродавца(Знач Основание, Знач Настройки, Данные, Описание, Отказ) Экспорт 
	...
	ОбменСКонтрагентамиБП.ЗаполнитьДанныеУКД_ИнформацияПродавца(Основание, Настройки, Данные, Описание, Отказ);
...
Процедура ЗаполнитьДанныеУКД_ИнформацияПокупателя(Знач Основания, Данные, Отказ) Экспорт
	...
	ОбменСКонтрагентамиБП.ЗаполнитьДанныеУКД_ИнформацияПокупателя(Основания, Данные, Отказ);
...
Процедура ЗаполнитьДанныеПередачаТоваров_ИнформацияПродавца(Знач Основание, Знач Настройки, Данные, Описание, Отказ) Экспорт
	...
	ОбменСКонтрагентамиБП.ЗаполнитьДанныеПередачаТоваров_ИнформацияПродавца(Основание, Настройки, Данные, Описание, Отказ);
...
Процедура ЗаполнитьДанныеПередачаТоваров_ИнформацияПокупателя(Знач Основания, Данные, Отказ) Экспорт
	...
	ОбменСКонтрагентамиБП.ЗаполнитьДанныеПоТорг12ПокупательФНС(Основания, Данные, Отказ);
...
Процедура ЗаполнитьДанныеПередачаУслуг_ИнформацияПродавца(Знач Основание, Знач Настройки, Данные, Описание, Отказ) Экспорт
	...
	ОбменСКонтрагентамиБП.ЗаполнитьДанныеПередачаУслуг_ИнформацияПродавца(Основание, Настройки, Данные, Описание, Отказ);
...
Процедура ЗаполнитьДанныеПередачаУслуг_ИнформацияПокупателя(Знач Основания, Данные, Отказ) Экспорт
	...
	ОбменСКонтрагентамиБП.ЗаполнитьДанныеПередачаУслуг_ИнформацияПокупателя(Основания, Данные, Отказ);
...
Процедура ЗаполнитьДанныеАктОРасхождениях_ИнформацияПокупателя(Знач Основание, Знач Настройки, Данные, Описание, Отказ) Экспорт
	...
	ОбменСКонтрагентамиБП.ЗаполнитьДанныеАктОРасхождениях_ИнформацияПокупателя(Основание, Настройки, Данные, Описание, Отказ);
...
Процедура ЗаполнитьДанныеАктОРасхождениях_ДополнительныеСведения(Знач Основание, Данные, Отказ) Экспорт
	...
	// К документу формируются дополнительные сведения
	ЭлектронноеВзаимодействие.ЗаполнитьЗначениеРеквизитаВДереве(Данные, "ФормированиеДополнительныхСведений", "5"); 
	
	ЭлектронноеВзаимодействие.ЗаполнитьЗначениеРеквизитаВДереве(Данные, "СодержаниеДополнительныхСведений",
		НСтр("ru = 'Информация о расхождениях принята'"));
	
	РеквизитыОбъекта = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Основание, "Организация, Организация.НаименованиеПолное");
	
	Если ЗначениеЗаполнено(РеквизитыОбъекта.Организация) Тогда
		ЭлектронноеВзаимодействие.ЗаполнитьЗначениеРеквизитаВДереве(
			Данные, "СоставительДокументаНаименование", РеквизитыОбъекта.ОрганизацияНаименованиеПолное);
	Иначе
		ТекстСообщения = СтрШаблон(НСтр("ru = 'Заполните поле ""Организация"" в документе %1'"), Основание);
		ОбщегоНазначения.СообщитьПользователю(ТекстСообщения, Основание, "Организация",, Отказ); 
	КонецЕсли;
...
Процедура ЗаполнитьДанныеАктОПриемкеВыполненныхРаботВСтроительстве_ИнформацияПодрядчика(СсылкаНаОбъект, КонструкторЭД,
	...
	ОбменСКонтрагентамиБП.ЗаполнитьДанныеАктОПриемкеВыполненныхРаботВСтроительстве_ИнформацияПодрядчика(СсылкаНаОбъект, КонструкторЭД, Отказ);
...
Процедура ЗаполнитьДанныеАктОПриемкеВыполненныхРаботВСтроительстве_ИнформацияЗаказчика(СсылкаНаОбъект, КонструкторЭД,
	...
	ОбменСКонтрагентамиБП.ЗаполнитьДанныеАктОПриемкеВыполненныхРаботВСтроительстве_ИнформацияЗаказчика(СсылкаНаОбъект, КонструкторЭД, Отказ);
...
Процедура ЗаполнитьДанныеАктСверкиВзаиморасчетов_ИнформацияОтправителя(Знач Основание, Знач Настройки, Данные, Описание,
	...
	ОбменСКонтрагентамиБП.ЗаполнитьДанныеАктСверкиВзаиморасчетов_ИнформацияОтправителя(Основание, Настройки, Данные, Описание, Отказ);
...
Процедура ЗаполнитьДанныеАктСверкиВзаиморасчетов_ИнформацияПолучателя(Знач Основание, Знач Настройки, Данные, Описание,
	...
	ОбменСКонтрагентамиБП.ЗаполнитьДанныеАктСверкиВзаиморасчетов_ИнформацияПолучателя(Основание, Настройки, Данные, Описание, Отказ);
...
Процедура ЗаполнитьАктСверкиВзаиморасчетовПоДаннымПолучателя(ДанныеДокумента, ОбъектыУчета = Неопределено) Экспорт
	...
	ОбменСКонтрагентамиБП.ЗаполнитьАктСверкиВзаиморасчетовПоДаннымПолучателя(ДанныеДокумента, ОбъектыУчета);
...
Процедура ЗаполнитьДанныеПоСчетуНаОплату_5_01(Знач Основание, Знач Настройки, Данные, Описание, Отказ) Экспорт
	...
	ОбменСКонтрагентамиБП.ЗаполнитьДанныеПоСчетуНаОплату_5_01(Основание, Настройки, Данные, Описание, Отказ);
...
Процедура ЗаполнитьДанныеПоДоговорномуДокументу101(СсылкаНаОбъект, КонструкторЭД, Отказ) Экспорт
	...
	ОбменСКонтрагентамиБП.ЗаполнитьДанныеПоДоговорномуДокументу101(СсылкаНаОбъект, КонструкторЭД, Отказ);
...
Процедура ЗаполнитьДанныеРеквизитыОрганизации(СсылкаНаОбъект, Данные, Отказ) Экспорт
	...
	ОбменСКонтрагентамиБП.ЗаполнитьДанныеРеквизитыОрганизации(СсылкаНаОбъект, Данные, Отказ);
...
Процедура ЗаполнитьДанныеПоСчету(СсылкаНаОбъект, ДеревоДокумента, Отказ) Экспорт
	...
	ОбменСКонтрагентамиБП.ЗаполнитьДанныеПоСчету(СсылкаНаОбъект, ДеревоДокумента, Отказ);
...
Процедура ЗаполнитьДанныеПоОтчетуОПродажахКомиссионногоТовара(СсылкаНаОбъект, ДеревоДокумента, Отказ) Экспорт
	...
	ОбменСКонтрагентамиБП.ЗаполнитьДанныеПоОтчетуОПродажахКомиссионногоТовара(СсылкаНаОбъект, ДеревоДокумента, Отказ);
...
Процедура СпособыОтраженияВУчетеТипаЭлектронногоДокумента(ТипДокумента, СпособыОтраженияВУчете) Экспорт 
	...
	ОбменСКонтрагентамиБП.СпособыОтраженияВУчетеТипаЭлектронногоДокумента(ТипДокумента, СпособыОтраженияВУчете);
...
Процедура ИмяОбъектаМетаданныхПоСпособуОтраженияВУчете(СпособОтраженияВУчете, ИмяДокумента) Экспорт 
	...
	ОбменСКонтрагентамиБП.ИмяОбъектаМетаданныхПоСпособуОтраженияВУчете(СпособОтраженияВУчете, ИмяДокумента);
...
Процедура ТаблицаПредопределенногоПрофиля(ТаблицаПрофиля, Профиль) Экспорт 
	...
	Если Профиль = "ПервоначальноеЗаполнение" Тогда
		ТипыДокументов = ОбменСКонтрагентами.ТипыДокументов();
		СпособыОбработки = ОбменСКонтрагентамиБП.СпособыОбработкиВходящихЭД();
		Для Каждого СтрокаТаблицы Из ТаблицаПрофиля Цикл
			Если СтрокаТаблицы.ТипДокумента = ТипыДокументов.АктВыполненныхРабот Тогда
				СтрокаТаблицы.СпособОбработки = СпособыОбработки.ОпределяетсяПрограммой;
			ИначеЕсли СтрокаТаблицы.ТипДокумента = ТипыДокументов.СоглашениеОбИзмененииСтоимости Тогда
				СтрокаТаблицы.СпособОбработки = СпособыОбработки.ОпределяетсяПрограммой;
			ИначеЕсли СтрокаТаблицы.ТипДокумента = ТипыДокументов.ТоварнаяНакладная Тогда
				СтрокаТаблицы.СпособОбработки = СпособыОбработки.ПоступлениеТоваров;
			КонецЕсли;
		КонецЦикла;
	КонецЕсли;
...
Процедура ПослеФормированияЭлектронногоДокумента(ЭлектронныйДокумент) Экспорт
	...
	Если ПолучитьФункциональнуюОпцию("ВестиУчетМаркируемойПродукцииИСМП")
		...
		ОбщегоНазначенияКлиентСервер.ДополнитьМассив(ТипыКПроверке, Метаданные.ОпределяемыеТипы.ОснованиеРазрешениеНаОтгрузкуИСМП.Тип.Типы());
...
Процедура ПослеЗавершенияОбменаЭлектроннымДокументом(ЭлектронныйДокумент) Экспорт
	...
	ОснованияЭлектронногоДокумента = ОбменСКонтрагентами.СведенияОбЭлектронномДокументе(ЭлектронныйДокумент).ОбъектыУчета;
...
Процедура ПослеИзмененияОтраженияВУчете(ЭлектронныйДокумент, ДобавленныеОбъектыУчета, УдаленныеОбъектыУчета) Экспорт
	...
	Основания = ОбщегоНазначения.СкопироватьРекурсивно(ДобавленныеОбъектыУчета);
	ОбщегоНазначенияКлиентСервер.ДополнитьМассив(Основания, УдаленныеОбъектыУчета, Истина);
	
	ЭлектронныйДокументооборотСКонтролирующимиОрганами.ЗаписатьИсточникиВРегистрДокументыПоТребованиюФНС(Основания);
...
Процедура ПослеВозникновенииСобытияПоЭлектронномуСчетуФактуре(ДокументыУчета, Событие, СостояниеОбработки) Экспорт
	...
	Если ДатыЗапретаИзменения.ИзменениеЗапрещено(СчетФактура.Метаданные().ПолноеИмя(), СчетФактура) Тогда
		// Записываемые данные не важны для учета НДС и они доступны в ответном титуле электронного документа,
		// поэтому не пытаемся вносить изменения в счет-фактуры в закрытом периоде.
		Возврат;
	КонецЕсли;
	...
	ИначеЕсли Событие = "ПолученПДО" Тогда
		...
		Попытка
			...
			СчетФактура.КодСпособаПолучения = 2;
			СчетФактура.Записать(?(СчетФактура.Проведен, РежимЗаписиДокумента.Проведение, РежимЗаписиДокумента.Запись));
	...
	ИначеЕсли Событие = "ПолученИоП" Тогда
		...
		Попытка
			...
			Если ЗначениеЗаполнено(ДатаВыставленияЭСФ) И (НЕ СчетФактура.Выставлен ИЛИ СчетФактура.КодСпособаВыставления <> 2
	...
	ИначеЕсли Событие = "ПолученИоППДО" Тогда
		...
		Попытка
			...
			Если СчетФактура.КодСпособаПолучения <> 2 Тогда
...
Процедура ПриПолученииОписанияОснованияЭлектронногоДокумента(ОснованиеОбъект, Описание, СтандартнаяОбработка) Экспорт
	...
	Если ТипОснования = Тип("ДокументОбъект.РеализацияТоваровУслуг") 
		Или ТипОснования = Тип("ДокументОбъект.СчетФактураВыданный")
		Или ТипОснования = Тип("ДокументСсылка.РеализацияТоваровУслуг") 
		Или ТипОснования = Тип("ДокументСсылка.СчетФактураВыданный")
		Или ТипОснования = Тип("ДокументСсылка.РеализацияУслугПоПереработке")
		Или ТипОснования = Тип("ДокументОбъект.РеализацияУслугПоПереработке") Тогда
	...
	ИначеЕсли ТипОснования = Тип("ДокументОбъект.СчетНаОплатуПокупателю")
	...
	ИначеЕсли ТипОснования = Тип("ДокументОбъект.АктСверкиВзаиморасчетов") 
		Или ТипОснования = Тип("ДокументСсылка.АктСверкиВзаиморасчетов") Тогда
	...
	ИначеЕсли ТипОснования = Тип("СправочникОбъект.ДоговорыКонтрагентов")
		...
		Если ОснованиеОбъект.СуммаВключаетНДС Тогда
			Описание.СуммаДокумента = ОснованиеОбъект.Сумма;
		Иначе
			Описание.СуммаДокумента = ОснованиеОбъект.Сумма + ОснованиеОбъект.СуммаНДС;
		КонецЕсли;
...
Процедура СсылкаНаОбъектПоИННКПП(ТипОбъекта, ИНН, КПП, Ссылка, ДатаСведений = Неопределено) Экспорт
	...
	ОбменСКонтрагентамиБП.СсылкаНаОбъектПоИННКПП(ТипОбъекта, ИНН, КПП, Ссылка, ДатаСведений);
...
Процедура ДанныеСвидетельстваОРегистрацииИП(ИП, Сведения) Экспорт
	...
	Если ТипЗнч(ИП) = Тип("СправочникСсылка.Организации") Тогда
		СведенияОбУчастнике = Новый Структура(ОбменСКонтрагентамиБППовтИсп.ПолучитьДанныеЮрФизЛица(ИП));
		Сведения = БухгалтерскийУчетПереопределяемый.СвидетельствоОРегистрации(СведенияОбУчастнике);
	Иначе
		Сведения = "";
	КонецЕсли;
...
Процедура ПриОпределенииТипаУчастникаЭДО(ПроверяемоеЛицо, Признаки) Экспорт
	...
	СведенияОбУчастнике = ОбменСКонтрагентамиБППовтИсп.ПолучитьДанныеЮрФизЛица(ПроверяемоеЛицо);
	...
	ИначеЕсли ЗначениеЗаполнено(СведенияОбУчастнике.ИНН)
...
Процедура СведенияФизЛицаПользователя(Знач Пользователь, Знач Организация, СведенияФизЛица) Экспорт
	...
	ОбменСКонтрагентамиБП.СведенияФизЛицаПользователя(Пользователь, Организация, СведенияФизЛица);
...
Процедура ПолучитьНомерДатаДоговораДокументов(МассивСсылок, ВозвращаемоеСоответствие) Экспорт
	...
	ВозвращаемоеСоответствие = ЭлектронныйДокументооборотСКонтролирующимиОрганамиВызовСервераПереопределяемый.ПолучитьНомерДатаДоговораДокументов(МассивСсылок);
...
Процедура ПриОпределенииОсновногоВариантаИнтерфейса(ВариантИнтерфейса) Экспорт 
	...
	Если ОбщегоНазначенияБП.ЭтоПростойИнтерфейс() Тогда
		ВариантИнтерфейса = ОбменСКонтрагентамиКлиентСервер.ВариантыИнтерфейсаЭДО().Легкий;
	КонецЕсли;
...
Процедура НайтиСоздатьУниверсальныйПередаточныйДокумент_5_02(ДеревоДанных, СсылкиНаВладельцев = Неопределено, СпособОбработки = Неопределено, ОписаниеОшибки = "") Экспорт
	...
	ОбменСКонтрагентамиБП.НайтиСоздатьУниверсальныйПередаточныйДокумент_5_02(ДеревоДанных, СсылкиНаВладельцев, СпособОбработки, ОписаниеОшибки);
...
Процедура НайтиСоздатьУниверсальныйПередаточныйДокумент_2019(ДеревоДанных, СсылкиНаВладельцев = Неопределено, СпособОбработки = Неопределено, ОписаниеОшибки = "") Экспорт
	...
	ОбменСКонтрагентамиБП.НайтиСоздатьУниверсальныйПередаточныйДокумент_2019(ДеревоДанных, СсылкиНаВладельцев, СпособОбработки, ОписаниеОшибки);	
...
Процедура НайтиСоздатьДокументПередачаТоваров(ДеревоДанных, СсылкаНаВладельца, СпособОбработки = "", ОписаниеОшибки = "") Экспорт
	...
	ОбменСКонтрагентамиБП.НайтиСоздатьДокументПередачаТоваров(ДеревоДанных, СсылкаНаВладельца, СпособОбработки, ОписаниеОшибки);
...
Процедура НайтиСоздатьДокументПередачаРезультатовРабот(ДеревоДанных, СсылкаНаВладельца, СпособОбработки = "", ОписаниеОшибки = "") Экспорт
	...
	ОбменСКонтрагентамиБП.НайтиСоздатьДокументПередачаРезультатовРабот(ДеревоДанных, СсылкаНаВладельца, СпособОбработки, ОписаниеОшибки);
...
Процедура НайтиСоздатьАктОПриемкеСтроительныхРаботУслуг(КонструкторЭД, ДокументУчета = Неопределено,
	...
	ОбменСКонтрагентамиБП.НайтиСоздатьАктОПриемкеСтроительныхРаботУслуг(КонструкторЭД, ДокументУчета, СпособОбработки, ОписаниеОшибки);
...
Процедура НайтиСоздатьАктСверкиВзаиморасчетов(ДеревоДанных, ДокументУчета = Неопределено, СпособОбработки = "",
	...
	ОбменСКонтрагентамиБП.НайтиСоздатьАктСверкиВзаиморасчетов(ДеревоДанных, ДокументУчета, СпособОбработки, ОписаниеОшибки);
...
Процедура НайтиСоздатьСчетНаОплату_5_01(ДеревоДанных, ДокументУчета = Неопределено, СпособОбработки = "", ОписаниеОшибки = "") Экспорт
	...
	ОбменСКонтрагентамиБП.НайтиСоздатьСчетНаОплату_5_01(ДеревоДанных, ДокументУчета, СпособОбработки, ОписаниеОшибки);
...
Процедура НайтиСоздатьСчетНаОплату101(ДеревоДанных, ДокументУчета = Неопределено, СпособОбработки = "", ОписаниеОшибки = "") Экспорт
	...
	ОбменСКонтрагентамиБП.НайтиСоздатьСчетНаОплату101(ДеревоДанных, ДокументУчета, СпособОбработки, ОписаниеОшибки);
...
Процедура НайтиСоздатьДоговорнойДокумент101(КонструкторЭД, ДокументУчета = Неопределено,
	...
	ОбменСКонтрагентамиБП.НайтиСоздатьДоговорнойДокумент101(КонструкторЭД, ДокументУчета, ОписаниеОшибки);
...
Процедура НайтиСоздатьДоговорныйДокументXML(ДанныеФайлаЭД, ДокументУчета = Неопределено,
	...
	ОбменСКонтрагентамиБП.НайтиСоздатьДоговорныйДокументXML(ДанныеФайлаЭД, ДокументУчета, ОписаниеОшибки);
...
Процедура СохранитьДанныеОбъектаВБД(СтрокаДляЗагрузки, ДеревоРазбора, ПараметрыОбработки = Неопределено,
	...
	ОбменСКонтрагентамиБП.СохранитьДанныеОбъектаВБД(СтрокаДляЗагрузки, ДеревоРазбора, ПараметрыОбработки, НайденныйОбъект, ОписаниеОшибки);
...
Процедура ЗаполнитьДанныеПоСчетуНаОплату101(Знач Основание, Знач Настройки, Данные, Описание, Отказ) Экспорт
	...
	ОбменСКонтрагентамиБП.ЗаполнитьДанныеПоСчетуНаОплату101(Основание, Настройки, Данные, Описание, Отказ);
