...
Процедура ДобавитьВеткуЕСХН(ОтчетыВходяшиеВРасширенныйФункционал, КорневойУровень, ФлагиУчета)
	...
	ДобавитьВеткуВДеревоУведомлений(ОтчетыВходяшиеВРасширенныйФункционал, ЭлементыПапки, Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.ОтказЕСХН);
	ДобавитьВеткуВДеревоУведомлений(ОтчетыВходяшиеВРасширенныйФункционал, ЭлементыПапки, Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.УтратаПраваЕСХН);
