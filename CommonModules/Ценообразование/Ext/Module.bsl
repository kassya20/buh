...
Функция ПолучитьТаблицуЦенНоменклатурыДокументов(МассивНоменклатуры, СпособЗаполненияЦены, Дата) Экспорт
	...
	Если СпособЗаполненияЦены = Перечисления.СпособыЗаполненияЦен.ПоПродажнымЦенам
		И Константы.НастройкаЗаполненияЦеныПродажи.Получить() = Перечисления.НастройкаЗаполненияЦеныПродажи.НеЗаполнять Тогда
		Возврат ЦеныНоменклатуры;
	КонецЕсли;
	
	Если СпособЗаполненияЦены = Перечисления.СпособыЗаполненияЦен.ПоЗакупочнымЦенам
		И Константы.НастройкаЗаполненияЦеныПокупки.Получить() = Перечисления.НастройкаЗаполненияЦеныПродажи.НеЗаполнять Тогда
		Возврат ЦеныНоменклатуры;
	КонецЕсли;
...
Процедура ОбновитьЦеныНоменклатуры(ДокументСсылка, СпособЗаполненияЦены, Валюта = Неопределено, СуммаВключаетНДС = Ложь) Экспорт	
	...
	Если (СпособЗаполненияЦены = Перечисления.СпособыЗаполненияЦен.ПоЗакупочнымЦенам И Константы.НастройкаЗаполненияЦеныПокупки.Получить() <> Перечисления.НастройкаЗаполненияЦеныПродажи.ПредыдущийДокумент)
		ИЛИ (СпособЗаполненияЦены = Перечисления.СпособыЗаполненияЦен.ПоПродажнымЦенам И Константы.НастройкаЗаполненияЦеныПродажи.Получить() <> Перечисления.НастройкаЗаполненияЦеныПродажи.ПредыдущийДокумент) Тогда
		Возврат;
	КонецЕсли;
	...
	+ "ВЫБРАТЬ
	  ...
	  |	ТаблицаНоменклатуры.ЦенаВключаетНДС КАК ЦенаВключаетНДС
	  ...
	  |	ТаблицаНоменклатурыСМаксимальнойЦеной.ЦенаВключаетНДС КАК ЦенаВключаетНДС
	  |ИЗ
...
Процедура ЗаполнитьТипЦенПоУмолчанию(ДокументОбъект, МетаданныеДокумента) Экспорт
	
	Если МетаданныеДокумента.Имя = "АктОбОказанииПроизводственныхУслуг"
		ИЛИ МетаданныеДокумента.Имя = "ВозвратТоваровОтПокупателя"
		ИЛИ МетаданныеДокумента.Имя = "КоммерческоеПредложение" 
		ИЛИ МетаданныеДокумента.Имя = "ОприходованиеТоваров" 
		ИЛИ МетаданныеДокумента.Имя = "ОтражениеНачисленияНДС" 
		ИЛИ МетаданныеДокумента.Имя = "ОтчетКомиссионераОПродажах" 
		ИЛИ МетаданныеДокумента.Имя = "ОтчетКомитентуОПродажах" 
		ИЛИ МетаданныеДокумента.Имя = "РеализацияТоваровУслуг" 
		ИЛИ МетаданныеДокумента.Имя = "РеализацияУслугПоПереработке" 
		ИЛИ МетаданныеДокумента.Имя = "СчетНаОплатуПокупателю" Тогда
		
		Если Константы.НастройкаЗаполненияЦеныПродажи.Получить() = Перечисления.НастройкаЗаполненияЦеныПродажи.ПоТипуЦен Тогда
			ДокументОбъект.ТипЦен = Константы.ОсновнойТипЦеныПродажи.Получить();
		КонецЕсли;
		
	ИначеЕсли МетаданныеДокумента.Имя = "АвансовыйОтчет"
		ИЛИ МетаданныеДокумента.Имя = "ВозвратТоваровПоставщику"
		ИЛИ МетаданныеДокумента.Имя = "ОтражениеНДСКВычету" 
		ИЛИ МетаданныеДокумента.Имя = "ПоступлениеТоваровУслуг" 
		ИЛИ МетаданныеДокумента.Имя = "СчетНаОплатуПоставщика" Тогда
		
		Если Константы.НастройкаЗаполненияЦеныПокупки.Получить() = Перечисления.НастройкаЗаполненияЦеныПродажи.ПоТипуЦен Тогда
			ДокументОбъект.ТипЦен = Константы.ОсновнойТипЦеныПокупки.Получить();
		КонецЕсли;
