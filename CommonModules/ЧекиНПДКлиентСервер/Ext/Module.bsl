...
Функция НовыйПараметрыОжиданияФормированияЧека() Экспорт
	...
	// Кэш данных чека в промежутках между запросами -
	// см. РегистрыСведений.ЧекиНПД.НовыйСведенияОЧеке()
	ПараметрыОжидания.Вставить("СведенияОЧеке", Неопределено);
...
// Проверяет, требуется ли обновить сведения о чеке НПД по данным ФНС.
//
// Параметры:
//   СведенияОЧеке - Структура - См. РегистрыСведений.ЧекиНПД.НовыйСведенияОЧеке()
//
// Возвращаемое значение:
//   Булево - Истина, если чек требуется обновить по данным ФНС.
//
Функция ТребуетсяОбновитьСведенияОЧекеНПД(СведенияОЧеке) Экспорт
	
	Возврат ЗначениеЗаполнено(СведенияОЧеке)
		И (СведенияОЧеке.Состояние = ПредопределенноеЗначение("Перечисление.СостоянияЧековНПД.Зарегистрирован")
		Или СведенияОЧеке.Состояние = ПредопределенноеЗначение("Перечисление.СостоянияЧековНПД.ОшибкаПриАннулировании"))
		И Не СведенияОЧеке.ПроизведенВозвратПоЧеку;
...
Функция ИмяСтатусаЧекаНПД() Экспорт
	
	Возврат "СтатусЧекаНПД";
