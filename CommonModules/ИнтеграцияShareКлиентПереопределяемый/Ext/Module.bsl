...
Процедура ПриОпределенииПараметровОтправкиЭлектронногоПисьма(ПараметрыОтправки, Знач ПараметрыДокумента) Экспорт
	...
	ДанныеУчастника.Вставить("Контакт", ПараметрыДокумента.Контрагент);	
	ДанныеУчастника.Вставить("КакСвязаться", ПараметрыОтправки.Получатель);
	ДанныеУчастника.Вставить("Представление", Строка(ПараметрыДокумента.Контрагент));	
...
Процедура ПослеЗагрузкиДокументаПоСсылке(Знач ДанныеДокумента) Экспорт
	...
	Если ДанныеДокумента.ЕстьДополнительныеФайлы Тогда
		АдресВложенныхФайлов = ПоместитьВоВременноеХранилище(ДанныеДокумента.ДополнительныеФайлыДокумента);
		ПараметрыФормы = Новый Структура;
		ПараметрыФормы.Вставить("Владелец", ДанныеДокумента.ОбъектУчета);
		ПараметрыФормы.Вставить("АдресВложенныхФайлов", АдресВложенныхФайлов);
		
		ОткрытьФорму("Документ.СчетНаОплатуПоставщика.Форма.ФормаВложенныхФайловShare", ПараметрыФормы);
	КонецЕсли;
