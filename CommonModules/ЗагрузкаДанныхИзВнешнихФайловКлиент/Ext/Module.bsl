...
//
// Параметры:
//   ИмяОткрываемойФормы - Строка - имя формы, которая будет открыта после выбора файла
//   УникальныйИдентификатор - Строка - идентификатор формы
//   ДополнительныеПараметры - Структура - см. НовыйПараметрыЗагрузкиВТабЧасть()
//
...
// Возвращает массив обязательных колонок.
//
// Параметры:
//   ОписаниеКолонок - ОписаниеКолонок - проверяемое описание колонок.
//
// Возвращаемое значение:
//   Массив - массив идентификаторов колонок.
//
Функция ОбязательныеКолонки(ОписаниеКолонок) Экспорт
...
Функция НовыйПараметрыПрикладнойЗагрузки()
	...
	ПараметрыЗагрузкиДанных.Вставить("ТолькоТаблицу", Ложь); // используется, если в файле помимо таблицы может быть и шапка с незначимыми данными
	...
	ПараметрыЗагрузкиДанных.Вставить("ВидДоговора", Неопределено); // используется при загрузке остатков взаиморасчетов с покупателями и поставщиками
