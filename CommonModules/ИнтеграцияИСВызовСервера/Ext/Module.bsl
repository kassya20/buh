...
Функция ПредставлениеНастройкиПараметровНоменклатуры(ПараметрыФормирования) Экспорт
	...
	ЭтоМоторныеМасла               = (ВидПродукции = Перечисления.ВидыПродукцииИС.МоторныеМасла);
	ЭтоБезалкогольныеНапитки       = (ВидПродукции = Перечисления.ВидыПродукцииИС.БезалкогольныеНапитки);
	ТолькоПросмотр                 = Ложь;
	...
	Если ПоддерживаетсяЧастичноеВыбытие Тогда
		...
		Если ЭтоОтдельнаяНоменклаутра Тогда
			...
			Если ЭтоДухи Или ЭтоПиво Или ЭтоАлкоголь Или ЭтоМоторныеМасла Тогда
	...
	Если Не ЭтоОтдельнаяНоменклаутра Тогда
		...
		ИначеЕсли ВариантИспользованияЕдиницы = Перечисления.ВариантыИспользованияЕдиницыХраненияИС.ПотребительскаяУпаковка
			...
			Если ЭтоМолочнаяПродукция Или ЭтоПиво Или ЭтоБАПиво Или ЭтоНСП Или ЭтоБАД Или ЭтоМорепродукты Или ЭтоКреслаКоляски
				Или ЭтоРастительныеМасла Или ЭтоБезалкогольныеНапитки Тогда
				...
				ИначеЕсли ЭтоНСП Или ЭтоБАД Или ЭтоКреслаКоляски Тогда
					ДанныеПредставления.Добавить(
						СтрШаблон(
							...
							ОписаниеНоменклатуры.ЕмкостьПотребительскойУпаковки));
				ИначеЕсли ЭтоМорепродукты Или ЭтоМоторныеМасла Тогда
					ДанныеПредставления.Добавить(
						СтрШаблон(
