...
Процедура ПриОпределенииНастроек(Настройки) Экспорт
	...
	Настройки.ОтображатьПодсказкуВФормеИзмененияСостояний = Ложь;
...
Процедура ПриИзмененииОбщегоСостоянияОригинала(Документ, СостояниеОригинала) Экспорт
	...
	УчетОригиналовПервичныхДокументовБП.УстановитьСостояниеДокументаПоСостояниюОригинала(Документ, СостояниеОригинала);
...
Процедура ПриОпределенииОбъектовСКомандамиУчетаОригиналов(СписокОбъектов) Экспорт
	...
	СписокОбъектов.Добавить("ЖурналДокументов.ЖурналОпераций.Форма.ФормаУчетаОригиналовПервичныхДокументов");
...
Процедура ЗаполнитьТаблицуУчетаОригиналов(ТаблицаУчетаОригиналов) Экспорт
	...
	УчетОригиналовПервичныхДокументовБП.ЗаполнитьТаблицуУчетаОригиналов(ТаблицаУчетаОригиналов);
