...
// Возвращает причину отключения провекри ФНС для иностранной организации
//
// Возвращаемое значение:
//   Строка - Причина отключения для иностранной организации
//
Функция ПричинаОтключенияПроверкиФНСИностраннаяОрганизация() Экспорт
	
	Возврат НСтр("ru='проверке подлежат только российские контрагенты'");
	
КонецФункции

// Возвращает причину отключения провекри ФНС для физических лиц
//
// Возвращаемое значение:
//   Строка - Причина отключения для физических лиц
//
Функция ПричинаОтключенияПроверкиФНСФизическоеЛицоОтстуствуетВБазеФНС() Экспорт
	
	Возврат НСтр("ru='физические лица, незарегистрированные в качестве индивидаульного предпринимателя, отсутствуют в базе ФНС'");
	
КонецФункции

// Получает список контрагентов, имеющих заданный ИНН
//
// Параметры:
//  ИНН - Строка - значение реквищита ИНН
//
// Возвращаемое значение:
//  Массив - ссылки на найденных контрагентов.
//
Функция НайтиКонтрагентовПоИНН(ИНН) Экспорт
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		Контрагенты.Добавить(ВыборкаДетальныеЗаписи.Контрагент);
	КонецЦикла;
...
Процедура ЗаполнитьКонтактнуюИнформациюКонтрагентаПоДаннымПрограммы(ИнформацияОСвязях, Контрагент)
	...
	Если ИнформацияОСвязях.Свойство("ЮридическийАдрес") 
			И ИнформацияОСвязях.ЮридическийАдрес <> Неопределено
