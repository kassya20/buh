...
Процедура ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных) Экспорт
	...
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.СогласиеНаПрисоединениеКЭДОБЗК",		"Дата",			"КадровыйУчет", "Организация");
	...
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.РегистрацияОблагаемойБазыРуководителя",                        "ПериодРегистрации",        "СтраховыеВзносы", "Организация");	
	...
	// Учет зарплаты для небольших организаций
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ЗарплатаКадрыДляНебольшихОрганизаций") Тогда
		...
		МодульРасчетЗарплатыДляНебольшихОрганизаций.ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных);
	КонецЕсли;
...
Процедура ПриПолученииПредопределенныхНаборовСвойств(Наборы) Экспорт
	...
	// ЗарплатаКадрыПодсистемы.ЭДОБЗК
	ЭДОБЗК.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	// Конец ЗарплатаКадрыПодсистемы.ЭДОБЗК
	
	// ЗарплатаКадрыПодсистемы.ИнтеграцияУправлениеПерсоналом.ИнтеграцияКабинетСотрудника
	ИнтеграцияКабинетСотрудника.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
...
Процедура ОтчетыПриАктивизацииСтрокиНаСервере(СсылкаНаОбъект) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ИнтеграцияС1САрхивомЗарплатаКадры") Тогда
		...
		МодульИнтеграцияС1САрхивом.УстановитьВидимостьИДоступностьКоманд(СсылкаНаОбъект);
	КонецЕсли;
...
Процедура ФормаРегламентированнойОтчетности_ПриСозданииНаСервере(Форма) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ИнтеграцияС1САрхивомЗарплатаКадры") Тогда
		МодульИнтеграцияС1САрхивом = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияС1САрхивом");
		МодульИнтеграцияС1САрхивом.ФормаРегламентированнойОтчетности_ПриСозданииНаСервере(Форма);
	КонецЕсли;
...
Процедура ЗаполнитьПоказателиРегламентированногоОтчета(ПоказателиОтчета, ИДОтчета, ИДРедакцииОтчета, ПараметрыОтчета = Неопределено) Экспорт
	...
	// ЗарплатаКадрыПодсистемы.КлассыУсловийТруда
	КлассыУсловийТруда.ПриПолученииСведенийОПоказателяхОтчета(ПоказателиОтчета, ИДОтчета, ИДРедакцииОтчета, ПараметрыОтчета);
	// Конец ЗарплатаКадрыПодсистемы.КлассыУсловийТруда
...
Процедура ЗаполнитьРегламентированныйОтчет(ИДОтчета, ИДРедакцииОтчета, ПараметрыОтчета, Контейнер) Экспорт
	...
	// ЗарплатаКадрыПодсистемы.КлассыУсловийТруда
	КлассыУсловийТруда.ПриЗаполненииРегламентированногоОтчета(ИДОтчета, ИДРедакцииОтчета, ПараметрыОтчета, Контейнер);
	// Конец ЗарплатаКадрыПодсистемы.КлассыУсловийТруда
...
Процедура ПриОпределенииОбработчиковТекущихДел(Обработчики) Экспорт
	...
	ЭДОБЗК.ПриОпределенииОбработчиковТекущихДел(Обработчики);
...
Процедура ПриОтключенииТекущихДел(ОтключаемыеДела) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.ТекущиеДела") Тогда
		Модуль = ОбщегоНазначения.ОбщийМодуль("ТекущиеДелаСлужебный");
		ВидимостьДел = Модуль.СохраненныеНастройкиОтображения().ВидимостьДел;
		Для Каждого КлючЗначение Из ВидимостьДел Цикл
			Если КлючЗначение.Значение = Ложь Тогда
				ОтключаемыеДела.Добавить(КлючЗначение.Ключ);
			КонецЕсли;
		КонецЦикла;
	КонецЕсли;
...
Процедура ПриСозданииНаСервере(Форма, ПараметрыРазмещения, ЭтоФормаОбъекта) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ИнтеграцияС1САрхивомЗарплатаКадры") Тогда
		МодульИнтеграцияС1САрхивом = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияС1САрхивом");
		МодульИнтеграцияС1САрхивом.ПриСозданииНаСервере(Форма, ПараметрыРазмещения, ЭтоФормаОбъекта);
	КонецЕсли;
...
Функция ЭтоФормаОбъекта(Форма) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ИнтеграцияС1САрхивомЗарплатаКадры") Тогда
		МодульИнтеграцияС1САрхивом = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияС1САрхивом");
		Возврат МодульИнтеграцияС1САрхивом.ЭтоФормаОбъекта(Форма);
	КонецЕсли;
...
Функция ИмяРеквизитаФормыСодержащегоИнтегрируемыйОбъект(Форма) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ИнтеграцияС1САрхивомЗарплатаКадры") Тогда
		МодульИнтеграцияС1САрхивом = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияС1САрхивом");
		Возврат МодульИнтеграцияС1САрхивом.ИмяРеквизитаФормыСодержащегоИнтегрируемыйОбъект(Форма);
	КонецЕсли;
...
Процедура ПриОпределенииИменИсключаемыхКоманд(Форма, ИменаИсключаемыхКоманд) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ИнтеграцияС1САрхивомЗарплатаКадры") Тогда
		МодульИнтеграцияС1САрхивом = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияС1САрхивом");
		МодульИнтеграцияС1САрхивом.ПриОпределенииИменИсключаемыхКоманд(Форма, ИменаИсключаемыхКоманд);
	КонецЕсли;
...
Процедура УстановитьВидимостьИДоступностьКоманд(Форма, СтандартнаяОбработка) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ИнтеграцияС1САрхивомЗарплатаКадры") Тогда
		МодульИнтеграцияС1САрхивом = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияС1САрхивом");
		МодульИнтеграцияС1САрхивом.УстановитьВидимостьИДоступностьКоманд(Форма, СтандартнаяОбработка);
	КонецЕсли;
...
Процедура ПроверитьГотовностьДокументаКОтправке(Ссылка, Отказ) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ИнтеграцияС1САрхивомЗарплатаКадры") Тогда
		МодульИнтеграцияС1САрхивом = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияС1САрхивом");
		МодульИнтеграцияС1САрхивом.ПроверитьГотовностьДокументаКОтправке(Ссылка, Отказ);
	КонецЕсли;
...
Функция ТаблицаДанныхНСИДляВыгрузки(СсылкиНаОбъектыНСИ, ТипОбъектаXDTO) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ИнтеграцияС1САрхивомЗарплатаКадры") Тогда
		МодульИнтеграцияС1САрхивом = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияС1САрхивом");
		Возврат МодульИнтеграцияС1САрхивом.ТаблицаДанныхНСИДляВыгрузки(СсылкиНаОбъектыНСИ, ТипОбъектаXDTO);
	КонецЕсли;
...
Процедура ОбновитьВидыДокументовПриОбновленииКонфигурации(ПараметрОбработчика) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ИнтеграцияС1САрхивомЗарплатаКадры") Тогда
		МодульИнтеграцияС1САрхивом = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияС1САрхивом");
		МодульИнтеграцияС1САрхивом.ОбновитьВидыДокументовПриОбновленииКонфигурации(ПараметрОбработчика);
	КонецЕсли;
...
Функция СоздатьДокументыБИА(СсылкаНаОбъектИсточник) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ИнтеграцияС1САрхивомЗарплатаКадры") Тогда
		МодульИнтеграцияС1САрхивом = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияС1САрхивом");
		Возврат МодульИнтеграцияС1САрхивом.СоздатьДокументыБИА(СсылкаНаОбъектИсточник);
	КонецЕсли;
...
Процедура ПриЗаписиКонстантыИнтеграцияС1САрхивом(Объект, Отказ) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ИнтеграцияС1САрхивомЗарплатаКадры") Тогда
		МодульИнтеграцияС1САрхивом = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияС1САрхивом");
		МодульИнтеграцияС1САрхивом.ПриЗаписиКонстантыИнтеграцияС1САрхивом(Объект, Отказ);
	КонецЕсли;
...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	СписокОбъектов.Добавить(Документы.РегистрацияОблагаемойБазыРуководителя);
	// Конец ЗарплатаКадрыПодсистемы.УчетСтраховыхВзносов
	...
	// ЗарплатаКадрыПодсистемы.ЭДОБЗК
	ЭДОБЗК.ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов);
	// Конец ЗарплатаКадрыПодсистемы.ЭДОБЗК
	
	// ЗарплатаКадрыПодсистемы.ИнтеграцияУправлениеПерсоналом.КабинетСотрудника
	ИнтеграцияКабинетСотрудника.ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов);
	// Конец ЗарплатаКадрыПодсистемы.ИнтеграцияУправлениеПерсоналом.КабинетСотрудника
...
Процедура ПриОпределенииНастроекПечати(Настройки) Экспорт
	...
	Настройки.ПроверкаПроведенияПередПечатью = Истина;
...
Процедура ПриПолученииКомандПечати(КомандыПечати, ИмяОбъекта) Экспорт
	...
	ЭДОБЗК.ПриПолученииКомандПечати(КомандыПечати, ИмяОбъекта);
...
Процедура ПриОпределенииОбъектовПечатнойФормы(ОбъектыПечатнойФормы, ИдентификаторПечатнойФормы, ИмяМенеджераПечати, ПараметрыПечати) Экспорт
	...
	ЭДОБЗК.ПриОпределенииОбъектовПечатнойФормы(ОбъектыПечатнойФормы, ИдентификаторПечатнойФормы, ИмяМенеджераПечати, ПараметрыПечати);
...
Процедура ПриПечати(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	ЭДОБЗК.ПриПечати(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода);
	
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ИнтеграцияС1САрхивомЗарплатаКадры") Тогда
		МодульИнтеграцияС1САрхивом = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияС1САрхивом");
		МодульИнтеграцияС1САрхивом.ПриПечати(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода);;
	КонецЕсли;
...
Процедура ПриЗаполненииСписковСОграничениемДоступа(Списки) Экспорт
	...
	// ЗарплатаКадрыПодсистемы.ЭДОБЗК
	ЭДОБЗК.ПриЗаполненииСписковСОграничениемДоступа(Списки);
	// Конец ЗарплатаКадрыПодсистемы.ЭДОБЗК
...
Процедура ПриЗаполненииВидовОграниченийПравОбъектовМетаданных(Описание) Экспорт
	...
	// ЗарплатаКадрыПодсистемы.ЭДОБЗК
	ЭДОБЗК.ПриЗаполненииВидовОграниченийПравОбъектовМетаданных(Описание);
	// Конец ЗарплатаКадрыПодсистемы.ЭДОБЗК
...
Процедура ПриОпределенииВидовПодключаемыхКоманд(ВидыПодключаемыхКоманд) Экспорт
	...
	// ЗарплатаКадрыПодсистемы.ЭДОБЗК
	ЭДОБЗК.ПриОпределенииВидовПодключаемыхКоманд(ВидыПодключаемыхКоманд);
	// Конец ЗарплатаКадрыПодсистемы.ЭДОБЗК
	
	// ИнтеграцияС1САрхивом
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ИнтеграцияС1САрхивомЗарплатаКадры") Тогда
		МодульИнтеграцияС1САрхивом = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияС1САрхивом");
		МодульИнтеграцияС1САрхивом.ПриОпределенииВидовПодключаемыхКоманд(ВидыПодключаемыхКоманд);
	КонецЕсли;
...
Процедура ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды) Экспорт
	...
	// ЗарплатаКадрыПодсистемы.ЭДОБЗК
	ЭДОБЗК.ПриОпределенииКомандПодключенныхКОбъекту(
		НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды);
	// Конец ЗарплатаКадрыПодсистемы.ЭДОБЗК
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ИнтеграцияС1САрхивомЗарплатаКадры") Тогда
		МодульИнтеграцияС1САрхивом = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияС1САрхивом");
		МодульИнтеграцияС1САрхивом.ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды);
	КонецЕсли;
	// Конец ИнтеграцияС1САрхивом
...
Процедура ОпределитьОбъектыСКомандамиОтчетов(Объекты) Экспорт
	...
	ЭДОБЗК.ОпределитьОбъектыСКомандамиОтчетов(Объекты);
...
Процедура ПриСозданииНаСервереФормыОтчета(Форма, Отказ, СтандартнаяОбработка) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ИнтеграцияС1САрхивомЗарплатаКадры") Тогда
		МодульИнтеграцияС1САрхивом = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияС1САрхивом");
		МодульИнтеграцияС1САрхивом.ПриСозданииНаСервереФормыОтчета(Форма, Отказ, СтандартнаяОбработка);
	КонецЕсли;
...
Процедура ПриДобавленииПереименованийОбъектовМетаданных(Итог) Экспорт
	...
	ОбщегоНазначения.ДобавитьПереименование(Итог,
		"3.1.34.51",
		"Подсистема.ЗарплатаКадрыПодсистемы.Подсистема.КадровыйЭДО",
		"Подсистема.ЗарплатаКадрыПодсистемы.Подсистема.ЭДОБЗК",
		"ЗарплатаКадрыБазовая");
	
	ОбщегоНазначения.ДобавитьПереименование(Итог,
		"3.1.37.63",
		"Подсистема.ЗарплатаКадрыПодсистемы.Подсистема.КадровыйУчет.Подсистема.ИнтеграцияСРаботаВРоссии",
		"Подсистема.ЗарплатаКадрыПодсистемы.Подсистема.КадровыйУчет.Подсистема.ИнтеграцияСРаботаРоссии",
		"ЗарплатаКадрыБазовая");
...
Процедура ОбработкаДокументовПечатныхФорм() Экспорт
	...
	ЭДОБЗК.ВыполнитьОтправкуПечатныхФормПоЭлектроннойПочте();
	ИнтеграцияСРаботаРоссии.ВыполнитьПередачуПечатныхФорм();
	ИнтеграцияУправлениеПерсоналомСобытия.ВыполнитьРегистрациюКПередачеФайловДокументовЭДОБЗК();
	ОбсужденияБЗК.ОбновитьУведомленияОНеобходимостиПодписанияФайловДокументовЭДОБЗК();
...
Процедура ПриСозданииФормыСпискаФайлов(Форма) Экспорт
	...
	ЭДОБЗК.ПриСозданииФормыСпискаФайлов(Форма);
	
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ИнтеграцияС1САрхивомЗарплатаКадры") Тогда
		МодульИнтеграцияС1САрхивом = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияС1САрхивом");
		МодульИнтеграцияС1САрхивом.ПриСозданииФормыСпискаФайлов(Форма);
	КонецЕсли;
...
Процедура ПриСозданииФормыЭлементаФайлов(Форма) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ИнтеграцияС1САрхивомЗарплатаКадры") Тогда
		МодульИнтеграцияС1САрхивом = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияС1САрхивом");
		МодульИнтеграцияС1САрхивом.ПриСозданииФормыЭлементаФайлов(Форма);
	КонецЕсли;
...
Процедура ПриОпределенииОбъектовСКомандамиСозданияНаОсновании(Объекты) Экспорт
	...
	Объекты.Добавить(Метаданные.Документы.Отпуск);
	Объекты.Добавить(Метаданные.Документы.ПриемНаРаботу);
	Объекты.Добавить(Метаданные.Документы.СведенияДляОплатыОтпускаСФР);
...
Процедура ПриОпределенииПроверок(ГруппыПроверок, Проверки) Экспорт
	...
	ЭДОБЗК.ОпределитьПроверкиВеденияУчета(ГруппыПроверок, Проверки);
...
Процедура УстановитьНачальныеЗначения(ИменаОбъектовМетаданных) Экспорт
	...
	Для каждого ОбрабатываемоеИмя Из ОбрабатываемыеИменаОбъектов Цикл
		...
		// Зарплата и кадры
		Если ПустаяСтрока(ОбрабатываемоеИмя) ИЛИ ВРег(ОбрабатываемоеИмя) = ВРег("РегистрСведений.СтавкаРефинансированияЦБ") Тогда
