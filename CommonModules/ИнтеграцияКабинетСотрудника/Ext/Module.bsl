...
Процедура ЗарегистрироватьОбработчикиОбновления(Обработчики) Экспорт
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия 			= "3.1.35.31";
	Обработчик.Процедура 		= "ИнтеграцияКабинетСотрудника.ОбновитьНастройкиФункциональности";
	Обработчик.РежимВыполнения 	= "Монопольно";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия 			= "3.1.36.11";
	Обработчик.Процедура 		= "ИнтеграцияКабинетСотрудника.ОбновитьРегистрациюОбработчиковОбмена";
	Обработчик.РежимВыполнения 	= "Отложенно";
	Обработчик.Идентификатор 	= Новый УникальныйИдентификатор("72a9da4b-9928-4bb5-9730-f5ea08293c4e");
	Обработчик.Комментарий 		= НСтр("ru = 'Обновление регистрации обработчиков обмена с сервисом 1С:Кабинет сотрудника.'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия 			= "3.1.36.28";
	...
	Обработчик.Процедура 		= "ИнтеграцияКабинетСотрудника.ОбновитьВидыДокументовЭДО";
	Обработчик.РежимВыполнения 	= "Отложенно";
	Обработчик.Идентификатор 	= Новый УникальныйИдентификатор("d20003d7-4ef7-4869-a507-8f8ac2ff55c0");
	Обработчик.Комментарий 		= НСтр("ru = 'Обновление видов документов ЭДО.'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия 			= "3.1.37.3";
	Обработчик.Процедура 		= "ИнтеграцияКабинетСотрудника.ОтменитьРегистрациюГруппВидыДокументовЭДО";
	Обработчик.РежимВыполнения 	= "Отложенно";
	Обработчик.Идентификатор 	= Новый УникальныйИдентификатор("67d75da9-06a8-4135-b2b9-e4f0b2e5faa7");
	Обработчик.Комментарий 		= НСтр("ru = 'Отмена выгрузки групп видов документов ЭДО.'");
...
Процедура ОбновитьНастройкиСервисаФоновоеЗадание(Параметры, АдресХранилища) Экспорт
	...
	РегистрыСведений.НастройкиОтсутствийКабинетСотрудника.УстановитьТребуетсяОбновитьНастройки();
...
Процедура ВыполнитьДействияПриПереходеНаВерсиюDTO(ТекущаяВерсияDTO, НоваяВерсияDTO)
	...
	Если ИнтеграцияУправлениеПерсоналом.ВерсияФорматаМеньшеВерсии(ТекущаяВерсияDTO, "3.2")
		И ИнтеграцияУправлениеПерсоналом.ВерсияФорматаБольшеИлиРавнаВерсии(НоваяВерсияDTO, "3.2") Тогда
		УстановитьНовыеНастройкиФункциональности_3_2();
		ЗарегистрироватьОбработчикОбмена(ИмяОбработчикаЗарегистрироватьВидыЛичныхКабинетов());
		ЗарегистрироватьОбработчикОбмена(ИмяОбработчикаЗарегистрироватьШаблоныДокументов_3_2());
		Если ИнтеграцияУправлениеПерсоналом.ДоступенРасширенныйФункционал() Тогда
			ЗарегистрироватьОбработчикОбмена(ИмяОбработчикаЗарегистироватьОбновлениеГрафиковОтпусков_3_2());
		КонецЕсли;
	КонецЕсли;
	
	Если ИнтеграцияУправлениеПерсоналом.ВерсияФорматаМеньшеВерсии(ТекущаяВерсияDTO, "3.3")
		И ИнтеграцияУправлениеПерсоналом.ВерсияФорматаБольшеИлиРавнаВерсии(НоваяВерсияDTO, "3.3") Тогда
		ЗарегистрироватьОбработчикОбмена(ИмяОбработчикаЗарегистрироватьВидыДокументовЭДО_3_3());
		ЗарегистрироватьОбработчикОбмена(ИмяОбработчикаОбновитьВсеШаблоныДокументов());
	КонецЕсли;
	
	Если ИнтеграцияУправлениеПерсоналом.ВерсияФорматаМеньшеВерсии(ТекущаяВерсияDTO, "3.4")
		И ИнтеграцияУправлениеПерсоналом.ВерсияФорматаБольшеИлиРавнаВерсии(НоваяВерсияDTO, "3.4") Тогда
		ЗарегистрироватьОбработчикОбмена(ИмяОбработчикаЗарегистрироватьШаблоныДокументов_3_4());
		ЗарегистрироватьОбработчикОбмена(ИмяОбработчикаЗарегистрироватьВыгрузкуПодразделенийОрганизации());
	КонецЕсли;
...
Процедура ТипыОбъектовДляРучнойРегистрацииИзменений(ТипыОбъектов) Экспорт
	...
	ИспользуетсяЭДО = ПолучитьФункциональнуюОпцию("ИспользуетсяЭДОБЗККабинетСотрудника");
	...
	Если ИспользуетсяЭДО И ИспользуетсяВерсияDTO("2.0") Тогда
		НоваяСтрока = ТипыОбъектов.Добавить();
	...
	Если ИспользуетсяВерсияDTO("3.2") Тогда
		НоваяСтрока = ТипыОбъектов.Добавить();
		НоваяСтрока.ТипОбъекта = Перечисления.ТипыОбъектовИнтеграцияУправлениеПерсоналом.ВидЛичногоКабинета;
		НоваяСтрока.ИмяТаблицы = ОбщегоНазначения.ИмяТаблицыПоСсылке(Справочники.ФизическиеЛица.ПустаяСсылка());
	КонецЕсли;
	
	Если ИспользуетсяЭДО И ИспользуетсяВерсияDTO("3.3") Тогда
		НоваяСтрока = ТипыОбъектов.Добавить();
		НоваяСтрока.ТипОбъекта = Перечисления.ТипыОбъектовИнтеграцияУправлениеПерсоналом.ВидДокументаЭДО;
		НоваяСтрока.ИмяТаблицы = ОбщегоНазначения.ИмяТаблицыПоСсылке(Справочники.ВидыДокументовЭДОБЗК.ПустаяСсылка());
	КонецЕсли;
...
Процедура ВключитьНастройкиПрограммыПослеПодключенияПриложения() Экспорт
	...
	Если ИспользуетсяВерсияDTO("3.2") Тогда
		ЗарегистрироватьШаблоныДокументов_3_2();
	КонецЕсли;
	
	Если ИспользуетсяВерсияDTO("3.3") Тогда
		ЗарегистрироватьВидыДокументовЭДО_3_3();
	КонецЕсли;
	
	Если ИспользуетсяВерсияDTO("3.4") Тогда
		ЗарегистрироватьШаблоныДокументов_3_4();
		ЗарегистрироватьВыгрузкуПодразделенийОрганизации();
	КонецЕсли;
...
Процедура ЗаписатьНастройкиПриПодключенииПриложения(Ответственный, ОписаниеПриложения, ОписаниеИС) Экспорт
	...
	УстановитьТребуетсяОбновитьНастройкиФункциональности(Истина);
	УстановитьНастройкиОтсутствийПоУмолчанию();
	Если ИспользуетсяВерсияDTO("2.0") Тогда
...
Процедура ПодключениеКСервисуЛокальноФоновоеЗадание(Параметры, АдресХранилища) Экспорт
	...
	Если Не Отказ Тогда
		Если Не ЗарегистрироватьОпубликоватьОтветственного(Параметры.Ответственный) Тогда
...
Процедура СохранитьНастройкиФункциональностиСервиса(НовыеНастройки, ВызыватьИсключение = Ложь) Экспорт
	...
	ИспользуетсяВерсияDTO_3_2 = ИспользуетсяВерсияDTO("3.2");
	...
	Попытка
		...
		Если ИспользуетсяВерсияDTO_3_1 Тогда
			...
			Если ТекущиеНастройки.ПоказыватьМедицинскиеОсмотры <> НовыеНастройки.ПоказыватьМедицинскиеОсмотры
				...
				КонецЕсли;
			КонецЕсли;
			Если ИспользуетсяВерсияDTO_3_2
				И ТекущиеНастройки.ПоказыватьСредстваИЗ <> НовыеНастройки.ПоказыватьСредстваИЗ Тогда
				Если НовыеНастройки.ПоказыватьСредстваИЗ Тогда
					ЗарегистрироватьОбработчикОбмена(ИмяОбработчикаЗарегистрироватьОбновлениеСИЗ(), Ложь);
					ОтключитьОбработчикОбмена(ИмяОбработчикаОтменитьВыгрузкуСИЗ());
				Иначе
					ЗарегистрироватьОбработчикОбмена(ИмяОбработчикаОтменитьВыгрузкуСИЗ(), Ложь);
					ОтключитьОбработчикОбмена(ИмяОбработчикаЗарегистрироватьОбновлениеСИЗ());
				КонецЕсли;
			КонецЕсли;
...
Функция НастройкиФункциональностьДляОбновления() Экспорт
	...
	НастройкиФункциональности.Вставить("РазделКомандировки", 					Ложь);
	//
	...
	НастройкиФункциональности.Вставить("ПоказыватьСредстваИЗ", 							Ложь);
	//
	...
	НастройкиФункциональности.Вставить("ИзменятьГрафикиОтпусков", 						Ложь);
	НастройкиФункциональности.Вставить("ИсполнениеГособязанностей", 					Ложь);
	
	НастройкиФункциональности.Вставить("ОтчетыОЗатратахВКомандировках", 				Ложь);
	НастройкиФункциональности.Вставить("ОтчетыОбИтогахКомандировки", 					Ложь);
	НастройкиФункциональности.Вставить("ИспользоватьБронированиеБилетовПроживания", 	Ложь);
	НастройкиФункциональности.Вставить("ИспользоватьПроизвольныеЗаявления", 			Ложь);
	НастройкиФункциональности.Вставить("ИспользоватьЗаявленияОСпособеВыплатыЗарплаты", 	Ложь);
	...
	НастройкиФункциональности.Вставить("УходЗаРебенкомИнвалидомОтдельнымЗаявлением", 	Истина);
	НастройкиФункциональности.Вставить("ОформлятьКомандировкуОтдельнымЗаявлением", 		Истина);
	НастройкиФункциональности.Вставить("ВнешнееУправлениеЛичнымиКабинетами", 			Истина);
	НастройкиФункциональности.Вставить("ВыходныеДляУходаЗаДетьмиИнвалидамиПоНесколькимРабочимМестам", Истина);
	...
	Если ИнтеграцияУправлениеПерсоналом.ДоступенРасширенныйФункционал() Тогда
		...
		НастройкиФункциональности.ПоказыватьСредстваИЗ 				= ИспользоватьСредстваИндивидуальнойЗащиты() И НастройкиФункциональности.ПоказыватьСредстваИЗ;
		...
		НастройкиФункциональности.ОтчетыОЗатратахВКомандировках 		= НастройкиФункциональности.Командировка И НастройкиФункциональности.ОтчетыОЗатратахВКомандировках;
		НастройкиФункциональности.ОтчетыОбИтогахКомандировки 			= НастройкиФункциональности.Командировка И НастройкиФункциональности.ОтчетыОбИтогахКомандировки;
		НастройкиФункциональности.ИспользоватьБронированиеБилетовПроживания = ДоступноБронированиеБилетовПроживания()
			И НастройкиФункциональности.Командировка И НастройкиФункциональности.ИспользоватьБронированиеБилетовПроживания;
...
Функция ДоступныеНастройкиСервиса() Экспорт
	...
	ИспользуетсяВерсияDTO_1_0 = ИспользуетсяВерсияDTO("1.0");
	ИспользуетсяВерсияDTO_2_0 = ИспользуетсяВерсияDTO("2.0");
	ИспользуетсяВерсияDTO_2_3 = ИспользуетсяВерсияDTO("2.3");
	ИспользуетсяВерсияDTO_3_0 = ИспользуетсяВерсияDTO("3.0");
	ИспользуетсяВерсияDTO_3_1 = ИспользуетсяВерсияDTO("3.1");
	ИспользуетсяВерсияDTO_3_2 = ИспользуетсяВерсияDTO("3.2");
	ИспользуетсяВерсияDTO_3_4 = ИспользуетсяВерсияDTO("3.4");
	...
	Настройки.ИспользоватьПроизвольныеЗаявления 			= ИспользуетсяВерсияDTO_3_2;
	Настройки.ИспользоватьЗаявленияОСпособеВыплатыЗарплаты 	= ИспользуетсяВерсияDTO_3_4;
	...
	Если ДоступенРасширенныйФункционал Тогда
		...
		Настройки.ПоказыватьСредстваИЗ 							= ДоступноИспользованиеСредствИндивидуальнойЗащиты();
		...
		Настройки.ИзменятьГрафикиОтпусков 		= ИспользуетсяВерсияDTO_3_2;
		Настройки.ИсполнениеГособязанностей 	= ИспользуетсяВерсияDTO_3_2;
		
		Настройки.РазделКомандировки 			= ИспользуетсяВерсияDTO_3_2;
		Настройки.ОтчетыОЗатратахВКомандировках = ИспользуетсяВерсияDTO_3_2;
		Настройки.ОтчетыОбИтогахКомандировки 	= ИспользуетсяВерсияDTO_3_2;
		Настройки.ИспользоватьБронированиеБилетовПроживания = ИспользуетсяВерсияDTO_3_2 И ДоступноБронированиеБилетовПроживания();
...
Функция НастройкиСервисаПоУмолчанию() Экспорт
	...
	Настройки.ИспользоватьЗаявленияОСпособеВыплатыЗарплаты 	= Ложь;
	...
	Если ИнтеграцияУправлениеПерсоналом.ДоступенРасширенныйФункционал() Тогда
		...
		Настройки.РазделКомандировки 		= Истина;
...
Процедура УстановитьНовыеНастройкиФункциональности_3_2()
	
	Если ИнтеграцияУправлениеПерсоналом.ДоступенРасширенныйФункционал() Тогда
		Настройки = РегистрыСведений.НастройкиКабинетСотрудника.Настройки();
		НастройкиОтсутствийПоУмолчанию = НастройкиОтсутствийПоУмолчанию();
		НастройкиОтсутствий = ОбщегоНазначенияБЗК.ТаблицаЗначенийПоИмениРегистраСведений("НастройкиОтсутствийКабинетСотрудника");
		Если Настройки.УходЗаРебенкомИнвалидом Тогда
			НастройкиОтсутствия = НастройкиОтсутствийПоУмолчанию[Перечисления.ПричиныОтсутствийЗаявокКабинетСотрудника.ДниУходаЗаДетьмиИнвалидами];
			Если НастройкиОтсутствия <> Неопределено Тогда
				НоваяСтрока = НастройкиОтсутствий.Добавить();
				ЗаполнитьЗначенияСвойств(НоваяСтрока, НастройкиОтсутствия);
				НоваяСтрока.ПричинаОтсутствия = Перечисления.ПричиныОтсутствийЗаявокКабинетСотрудника.ДниУходаЗаДетьмиИнвалидами;
			КонецЕсли;
		КонецЕсли;
		Если Настройки.Командировка Тогда
			НастройкиОтсутствия = НастройкиОтсутствийПоУмолчанию[Перечисления.ПричиныОтсутствийЗаявокКабинетСотрудника.Командировка];
			Если НастройкиОтсутствия <> Неопределено Тогда
				НоваяСтрока = НастройкиОтсутствий.Добавить();
				ЗаполнитьЗначенияСвойств(НоваяСтрока, НастройкиОтсутствия);
				НоваяСтрока.ПричинаОтсутствия = Перечисления.ПричиныОтсутствийЗаявокКабинетСотрудника.Командировка;
			КонецЕсли;
		КонецЕсли;
		Если ЗначениеЗаполнено(НастройкиОтсутствий) Тогда
			СохранитьНастройкиОтсутствий(НастройкиОтсутствий);
		КонецЕсли;
	КонецЕсли;
	УстановитьТребуетсяОбновитьНастройкиФункциональности(Истина);
...
Функция ДоступноБронированиеБилетовПроживания()

	ИмяОпции = "ИспользоватьБронированиеКомандировок";
...
Функция НастройкиКабинетСотрудника()
	
	УстановитьПривилегированныйРежим(Истина);
	Возврат РегистрыСведений.НастройкиКабинетСотрудника.Настройки();
...
Функция НастройкиОтсутствийДляОбновления() Экспорт
	...
	УстановитьПривилегированныйРежим(Истина);
	Настройки = РегистрыСведений.НастройкиОтсутствийКабинетСотрудника.НастройкиДляОбновления();
	ДоступныеНастройки = ДоступныеНастройкиОтсутствий();
	Для каждого СтрокаТЗ Из Настройки Цикл
		ДоступныеНастройкиОтсутствия = ДоступныеНастройки[СтрокаТЗ.ПричинаОтсутствия];
		Если ДоступныеНастройкиОтсутствия <> Неопределено Тогда
			СтрокаТЗ.ИспользоватьВнутрисменные = ДоступныеНастройкиОтсутствия.ИспользоватьВнутрисменные И СтрокаТЗ.ИспользоватьВнутрисменные;
		КонецЕсли;
	КонецЦикла;
...
Процедура УстановитьНастройкиОтсутствийПоУмолчанию()

	Настройки = ОбщегоНазначенияБЗК.ТаблицаЗначенийПоИмениРегистраСведений("НастройкиОтсутствийКабинетСотрудника");
	НастройкиОтсутствийПоУмолчанию = НастройкиОтсутствийПоУмолчанию();
	Для каждого КлючИЗначение Из НастройкиОтсутствийПоУмолчанию Цикл
		НоваяСтрока = Настройки.Добавить();
		ЗаполнитьЗначенияСвойств(НоваяСтрока, КлючИЗначение.Значение);
		НоваяСтрока.ПричинаОтсутствия = КлючИЗначение.Ключ;
		НоваяСтрока.ТребуетсяОбновление = Истина;
	КонецЦикла;
	СохранитьНастройкиОтсутствий(Настройки);
	
КонецПроцедуры

Функция НастройкиОтсутствийПоУмолчанию() Экспорт
	
	НастройкиПоУмолчанию = Новый Соответствие;
	
	ИменаСвойств = "ОформлятьЗаднимЧислом,КоличествоДнейДоНачалаОтсутствияДляИзмененияЗаявки,ИспользоватьВнутрисменные";
	...
	Для каждого СтрокаТЗ Из Настройки Цикл
		...
		НастройкиОтсутствия = Новый Структура(ИменаСвойств);
		НастройкиОтсутствия.ОформлятьЗаднимЧислом 		= Ложь;
		НастройкиОтсутствия.ИспользоватьВнутрисменные 	= Ложь;
		НастройкиОтсутствия.КоличествоДнейДоНачалаОтсутствияДляИзмененияЗаявки = 7;
		
		НастройкиПоУмолчанию.Вставить(СтрокаТЗ.ПричинаОтсутствия, НастройкиОтсутствия)
...
Функция ДоступныеНастройкиОтсутствий() Экспорт
	
	ДоступныеНастройки = Новый Соответствие;
	...
	Для каждого СтрокаТЗ Из Настройки Цикл
		...
		ДоступныеНастройкиОтсутствия = Новый Структура(ИменаСвойств);
		ДоступныеНастройкиОтсутствия.ОформлятьЗаднимЧислом 								= Истина;
		ДоступныеНастройкиОтсутствия.КоличествоДнейДоНачалаОтсутствияДляИзмененияЗаявки = Истина;
		ДоступныеНастройкиОтсутствия.ИспользоватьВнутрисменные 							= Ложь;
		
		Если ДоступенРасширенныйФункционал И СтрокаТЗ.ПричинаОтсутствия = Перечисления.ПричиныОтсутствийЗаявокКабинетСотрудника.ИсполнениеГособязанностей Тогда
			ДоступныеНастройкиОтсутствия.ИспользоватьВнутрисменные = НастройкиРасчетаЗарплаты.ИспользоватьОплатуПоСреднемуЗаработкуВнутрисменную;
		КонецЕсли;
		
		ДоступныеНастройки.Вставить(СтрокаТЗ.ПричинаОтсутствия, ДоступныеНастройкиОтсутствия)
...
Функция ДобавитьПолеСведенийОДатахОтключенияФизическихЛиц(Знач ИмяПоля, ТекстыОписанияПолей, ИсточникиДанных) Экспорт
...
Функция НеобходимыДатыОтключенияФизическихЛиц(Знач ИмяПоля) Экспорт
...
Функция ПутьКДаннымСведенийОДатахОтключенияФизическихЛиц(Знач ИмяПоля)
...
Функция ПоказыватьОхрануТруда()
	...
	Настройки = НастройкиКабинетСотрудника();
...
Функция ДоступноИспользованиеСредствИндивидуальнойЗащиты() Экспорт
	...
	Если ИспользуетсяВерсияDTO("3.2") Тогда
		Возврат ИнтеграцияКабинетСотрудникаВнутренний.ДоступноИспользованиеСредствИндивидуальнойЗащиты();
	Иначе
		Возврат Ложь;
	КонецЕсли;
...
Функция ИспользоватьСредстваИндивидуальнойЗащиты() Экспорт
	
	Настройки = НастройкиКабинетСотрудника();
	Возврат Настройки.ПоказыватьСредстваИЗ И ДоступноИспользованиеСредствИндивидуальнойЗащиты();
...
Процедура ОбновитьРегистрациюОбработчиковОбмена(ПараметрыОбновления = Неопределено) Экспорт
	...
	|	ЗНАЧЕНИЕ(Перечисление.ПриложенияДляИнтеграции.КабинетСотрудника) КАК Приложение,
	|	Обработчики.Выполнено КАК Выполнено,
	...
	|ИЗ
	|	РегистрСведений.ОбработчикиОбменаУправлениеПерсоналом КАК Обработчики
	|ГДЕ
	|	Обработчики.Приложение = ЗНАЧЕНИЕ(Перечисление.ПриложенияДляИнтеграции.ПустаяСсылка)";
	РезультатЗапроса = Запрос.Выполнить();
	...
	Пока Выборка.Следующий() Цикл
		...
		Если Не ОбновлениеИнформационнойБазыЗарплатаКадрыБазовый.ПодготовитьОбновлениеДанных(ПараметрыОбновления, "РегистрСведений.ОбработчикиОбменаУправлениеПерсоналом", "Обработчик", Выборка.Обработчик) Тогда
			ОбработкаЗавершена = Ложь;
		Иначе
			
			НаборЗаписей = РегистрыСведений.ОбработчикиОбменаУправлениеПерсоналом.СоздатьНаборЗаписей();
			НаборЗаписей.Отбор.Обработчик.Установить(Выборка.Обработчик);
...
Процедура ОбновитьВидыДокументовЭДО(ПараметрыОбновления = Неопределено) Экспорт

	Если Не ПолучитьФункциональнуюОпцию("ИспользуетсяСервисКабинетСотрудника")
		Или Не ИспользуетсяВерсияDTO("3.3") Тогда
		ОбновлениеИнформационнойБазыЗарплатаКадрыБазовый.УстановитьПараметрОбновления(ПараметрыОбновления, "ОбработкаЗавершена", Истина);
		Возврат;
	КонецЕсли;
	...
	|ИЗ
	|	Справочник.ВидыДокументовЭДОБЗК КАК ВидыДокументов
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ВыгруженныеОбъектыУправлениеПерсоналом КАК ВыгруженныеОбъекты
	|		ПО ВидыДокументов.Ссылка = ВыгруженныеОбъекты.Ссылка
	|			И (ВыгруженныеОбъекты.Приложение = ЗНАЧЕНИЕ(Перечисление.ПриложенияДляИнтеграции.КабинетСотрудника))
	|			И (ВыгруженныеОбъекты.ТипОбъекта = ЗНАЧЕНИЕ(Перечисление.ТипыОбъектовИнтеграцияУправлениеПерсоналом.ВидДокументаЭДО))
	|ГДЕ
	|	НЕ ВидыДокументов.ПометкаУдаления
	|	И НЕ ВидыДокументов.ЭтоГруппа
	|	И ВыгруженныеОбъекты.Выгружался ЕСТЬ NULL";
	РезультатЗапроса = Запрос.Выполнить();
...
Процедура ОтменитьРегистрациюГруппВидыДокументовЭДО(ПараметрыОбновления = Неопределено) Экспорт
	...
	|		ПО ВидыДокументовЭДОБЗК.Ссылка = ИзмененияДляОбмена.Ссылка
	|			И (ИзмененияДляОбмена.ТипОбъекта = ЗНАЧЕНИЕ(Перечисление.ТипыОбъектовИнтеграцияУправлениеПерсоналом.ВидДокументаЭДО))
	|ГДЕ
	|	ВидыДокументовЭДОБЗК.ЭтоГруппа";
	РезультатЗапроса = Запрос.Выполнить();
...
Процедура ОтправитьИспользованиеИнтеграции1СПерсонал() Экспорт
	...
	Если Не ИнтеграцияУправлениеПерсоналом.Используется1СПерсонал()
		Или Не ИспользуетсяВерсияDTO("2.0") Тогда
		Возврат;
	КонецЕсли;
...
Процедура ЗарегистрироватьОбновлениеВидаЛичногоКабинета(ФизическиеЛица) Экспорт

	ТипОбъекта = Перечисления.ТипыОбъектовИнтеграцияУправлениеПерсоналом.ВидЛичногоКабинета;
...
Процедура ВыполнитьОбработчикиОбмена(МенеджерОбмена) Экспорт
	...
	|	И Обработчики.Приложение = ЗНАЧЕНИЕ(Перечисление.ПриложенияДляИнтеграции.КабинетСотрудника)";
	Выборка = Запрос.Выполнить().Выбрать();
	Пока Выборка.Следующий() Цикл
		...
		ИначеЕсли Выборка.Обработчик = ИмяОбработчикаЗарегистрироватьШаблоныДокументов_3_1() Тогда
			ЗарегистрироватьШаблоныДокументов_3_1();
		ИначеЕсли Выборка.Обработчик = ИмяОбработчикаЗарегистрироватьОбновлениеСИЗ() Тогда
			ЗарегистрироватьОбновлениеСИЗ();
		ИначеЕсли Выборка.Обработчик = ИмяОбработчикаОтменитьВыгрузкуСИЗ() Тогда
			ОтменитьВыгрузкуСИЗ();
		ИначеЕсли Выборка.Обработчик = ИмяОбработчикаЗарегистироватьОбновлениеГрафиковОтпусков_3_2() Тогда
			ЗарегистироватьОбновлениеГрафиковОтпусков_3_2();
		ИначеЕсли Выборка.Обработчик = ИмяОбработчикаЗарегистрироватьШаблоныДокументов_3_2() Тогда
			ЗарегистрироватьШаблоныДокументов_3_2();
		ИначеЕсли Выборка.Обработчик = ИмяОбработчикаЗарегистрироватьВидыЛичныхКабинетов() Тогда
			ЗарегистрироватьВидыЛичныхКабинетов();
		ИначеЕсли Выборка.Обработчик = ИмяОбработчикаЗарегистрироватьВидыДокументовЭДО_3_3() Тогда
			ЗарегистрироватьВидыДокументовЭДО_3_3();
		ИначеЕсли Выборка.Обработчик = ИмяОбработчикаОбновитьВсеШаблоныДокументов() Тогда
			ЗарегистрироватВсеШаблоныДокументов();
		ИначеЕсли Выборка.Обработчик = ИмяОбработчикаЗарегистрироватьВыгрузкуПодразделенийОрганизации() Тогда
			ЗарегистрироватьВыгрузкуПодразделенийОрганизации();
		КонецЕсли;
	КонецЦикла;
...
Процедура ЗарегистрироватьОбработчикОбмена(ИмяОбработчика, ПроверятьРегистрацию = Истина) Экспорт
	...
	Если ПроверятьРегистрацию Тогда
		...
		|ИЗ
		|	РегистрСведений.ОбработчикиОбменаУправлениеПерсоналом КАК ОбработчикиОбмена
		|ГДЕ
		|	ОбработчикиОбмена.Обработчик = &ИмяОбработчика
		|	И ОбработчикиОбмена.Приложение = ЗНАЧЕНИЕ(Перечисление.ПриложенияДляИнтеграции.КабинетСотрудника)";
		РезультатЗапроса = Запрос.Выполнить();
		Если Не РезультатЗапроса.Пустой() Тогда
			Возврат;
		КонецЕсли;
	...
	МенеджерЗаписи = РегистрыСведений.ОбработчикиОбменаУправлениеПерсоналом.СоздатьМенеджерЗаписи();
...
Процедура ЗарегистрироватьОбновлениеВидовОтпусков()
	...
	ТаблицаОбъектов = ИнтеграцияУправлениеПерсоналомВнутренний.ТаблицаВидовОтпусковДляОбновления();
	Если Не ЗначениеЗаполнено(ТаблицаОбъектов) Тогда
...
Функция ИмяОбработчикаЗарегистрироватьОбновлениеСИЗ()

	Возврат "ЗарегистрироватьОбновлениеСИЗ";

КонецФункции

Процедура ЗарегистрироватьОбновлениеСИЗ()

	ИмяОбработчика = ИмяОбработчикаЗарегистрироватьОбновлениеСИЗ();
	
	Запрос = Новый Запрос;
	Запрос.Текст = 
	"ВЫБРАТЬ
	|	ВыгружаемыеОбъекты.Ссылка КАК Ссылка,
	|	ЗНАЧЕНИЕ(Перечисление.ТипыОбъектовИнтеграцияУправлениеПерсоналом.ИнформацияОСредствахИЗ) КАК ТипОбъекта
	|ИЗ
	|	РегистрСведений.ВыгружаемыеОбъектыКабинетСотрудника КАК ВыгружаемыеОбъекты
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ИзмененияДляОбменаКабинетСотрудника КАК Изменения
	|		ПО ВыгружаемыеОбъекты.Ссылка = Изменения.Ссылка
	|			И (Изменения.ТипОбъекта = ЗНАЧЕНИЕ(Перечисление.ТипыОбъектовИнтеграцияУправлениеПерсоналом.ИнформацияОСредствахИЗ))
	|ГДЕ
	|	ВыгружаемыеОбъекты.Ссылка ССЫЛКА Справочник.ФизическиеЛица
	|	И Изменения.ВыгружатьУдаление ЕСТЬ NULL
	|
	...
	|ВЫБРАТЬ
	|	ВыгружаемыеОбъекты.Ссылка,
	|	ЗНАЧЕНИЕ(Перечисление.ТипыОбъектовИнтеграцияУправлениеПерсоналом.Антропометрия)
	|ИЗ
	|	РегистрСведений.ВыгружаемыеОбъектыКабинетСотрудника КАК ВыгружаемыеОбъекты
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ИзмененияДляОбменаКабинетСотрудника КАК Изменения
	|		ПО ВыгружаемыеОбъекты.Ссылка = Изменения.Ссылка
	|			И (Изменения.ТипОбъекта = ЗНАЧЕНИЕ(Перечисление.ТипыОбъектовИнтеграцияУправлениеПерсоналом.Антропометрия))
	|ГДЕ
	|	ВыгружаемыеОбъекты.Ссылка ССЫЛКА Справочник.ФизическиеЛица
	|	И Изменения.ВыгружатьУдаление ЕСТЬ NULL";
	ТаблицаОбъектов = Запрос.Выполнить().Выгрузить();
...
Функция ИмяОбработчикаОтменитьВыгрузкуСИЗ()

	Возврат "ОтменитьВыгрузкуСИЗ";

КонецФункции

Процедура ОтменитьВыгрузкуСИЗ()

	ИмяОбработчика = ИмяОбработчикаОтменитьВыгрузкуСИЗ();
	...
	|	РегистрСведений.ИзмененияДляОбменаКабинетСотрудника КАК Изменения
	|ГДЕ
	|	Изменения.ТипОбъекта = ЗНАЧЕНИЕ(Перечисление.ТипыОбъектовИнтеграцияУправлениеПерсоналом.ИнформацияОСредствахИЗ)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|	РегистрСведений.ИзмененияДляОбменаКабинетСотрудника КАК Изменения
	|ГДЕ
	|	Изменения.ТипОбъекта = ЗНАЧЕНИЕ(Перечисление.ТипыОбъектовИнтеграцияУправлениеПерсоналом.Антропометрия)";
	ТаблицаОбъектов = Запрос.Выполнить().Выгрузить();
	Если Не ЗначениеЗаполнено(ТаблицаОбъектов) Тогда
		ОтключитьОбработчикОбмена(ИмяОбработчика);
		Возврат;
...
Функция ИмяОбработчикаЗарегистироватьОбновлениеГрафиковОтпусков_3_2()

	Возврат "ЗарегистироватьОбновлениеГрафиковОтпусков_3_2";

КонецФункции

Процедура ЗарегистироватьОбновлениеГрафиковОтпусков_3_2()

	ИмяОбработчика = ИмяОбработчикаЗарегистироватьОбновлениеГрафиковОтпусков_3_2();
	
	Запрос = Новый Запрос;
	Запрос.Текст = 
	"ВЫБРАТЬ
	|	ВыгружаемыеОбъекты.Ссылка КАК Ссылка,
	|	ЗНАЧЕНИЕ(Перечисление.ТипыОбъектовИнтеграцияУправлениеПерсоналом.ГрафикОтпусков) КАК ТипОбъекта
	|ИЗ
	|	РегистрСведений.ВыгружаемыеОбъектыКабинетСотрудника КАК ВыгружаемыеОбъекты
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ИзмененияДляОбменаКабинетСотрудника КАК Изменения
	|		ПО ВыгружаемыеОбъекты.Ссылка = Изменения.Ссылка
	|			И (Изменения.ТипОбъекта = ЗНАЧЕНИЕ(Перечисление.ТипыОбъектовИнтеграцияУправлениеПерсоналом.ГрафикОтпусков))
	|ГДЕ
	|	ВыгружаемыеОбъекты.Ссылка ССЫЛКА Справочник.Сотрудники
	|	И Изменения.ВыгружатьУдаление ЕСТЬ NULL";
	ТаблицаОбъектов = Запрос.Выполнить().Выгрузить();
...
Функция ИмяОбработчикаЗарегистрироватьШаблоныДокументов_3_2()

	Возврат "ЗарегистрироватьШаблоныДокументов_3_2";

КонецФункции

Процедура ЗарегистрироватьШаблоныДокументов_3_2()
	
	ИмяОбработчика = ИмяОбработчикаЗарегистрироватьШаблоныДокументов_3_2();
	
	Шаблоны = Новый Массив;
	
	СсылкаПредопределенного = ОбщегоНазначения.ПредопределенныйЭлемент("Справочник.ШаблоныДокументов.ЗаявлениеОбИзмененииЛичныхДанных");
	Если ЗначениеЗаполнено(СсылкаПредопределенного) Тогда
		Шаблоны.Добавить(СсылкаПредопределенного);
	КонецЕсли;
	
	СсылкаПредопределенного = ОбщегоНазначения.ПредопределенныйЭлемент("Справочник.ШаблоныДокументов.ЗаявлениеНаОтмену");
	Если ЗначениеЗаполнено(СсылкаПредопределенного) Тогда
		Шаблоны.Добавить(СсылкаПредопределенного);
	КонецЕсли;
	
	СсылкаПредопределенного = ОбщегоНазначения.ПредопределенныйЭлемент("Справочник.ШаблоныДокументов.ЗаявлениеВПроизвольнойФорме");
	Если ЗначениеЗаполнено(СсылкаПредопределенного) Тогда
		Шаблоны.Добавить(СсылкаПредопределенного);
	КонецЕсли;
	
	ИнтеграцияКабинетСотрудникаВнутренний.ДополнитьШаблоныДокументов_3_2(Шаблоны);
...
Функция ИмяОбработчикаЗарегистрироватьВидыЛичныхКабинетов()

	Возврат "ЗарегистрироватьВидыЛичныхКабинетов";

КонецФункции

Процедура ЗарегистрироватьВидыЛичныхКабинетов()
	
	ИмяОбработчика = ИмяОбработчикаЗарегистрироватьВидыЛичныхКабинетов();
	
	Запрос = Новый Запрос;
	Запрос.Текст = 
	"ВЫБРАТЬ
	|	ВыгружаемыеОбъекты.Ссылка КАК Ссылка,
	|	ЗНАЧЕНИЕ(Перечисление.ТипыОбъектовИнтеграцияУправлениеПерсоналом.ВидЛичногоКабинета) КАК ТипОбъекта
	|ИЗ
	|	РегистрСведений.ВыгружаемыеОбъектыКабинетСотрудника КАК ВыгружаемыеОбъекты
	|ГДЕ
	|	НЕ ВыгружаемыеОбъекты.ВыгружаетсяПоСсылке
	|	И ВыгружаемыеОбъекты.Ссылка ССЫЛКА Справочник.ФизическиеЛица";
	ТаблицаОбъектов = Запрос.Выполнить().Выгрузить();
	Если Не ЗначениеЗаполнено(ТаблицаОбъектов) Тогда
		ОтключитьОбработчикОбмена(ИмяОбработчика);
		Возврат;
...
Функция ИмяОбработчикаЗарегистрироватьВидыДокументовЭДО_3_3()

	Возврат "ЗарегистироватьОбновлениеВидыДокументовЭДО_3_3";

КонецФункции

Процедура ЗарегистрироватьВидыДокументовЭДО_3_3()
	
	ИмяОбработчика = ИмяОбработчикаЗарегистрироватьВидыДокументовЭДО_3_3();
	
	Запрос = Новый Запрос;
	Запрос.Текст = 
	"ВЫБРАТЬ
	|	ВидыДокументовЭДО.Ссылка КАК Ссылка,
	|	ЗНАЧЕНИЕ(Перечисление.ТипыОбъектовИнтеграцияУправлениеПерсоналом.ВидДокументаЭДО) КАК ТипОбъекта
	|ИЗ
	|	Справочник.ВидыДокументовЭДОБЗК КАК ВидыДокументовЭДО
	|ГДЕ
	|	НЕ ВидыДокументовЭДО.ПометкаУдаления
	|	И НЕ ВидыДокументовЭДО.ЭтоГруппа";
	ТаблицаОбъектов = Запрос.Выполнить().Выгрузить();
	Если Не ЗначениеЗаполнено(ТаблицаОбъектов) Тогда
		ОтключитьОбработчикОбмена(ИмяОбработчика);
		Возврат;
...
Функция ИмяОбработчикаОбновитьВсеШаблоныДокументов()

	Возврат "ОбновитьВсеШаблоныДокументов";

КонецФункции

Процедура ЗарегистрироватВсеШаблоныДокументов()
	
	ИмяОбработчика = ИмяОбработчикаОбновитьВсеШаблоныДокументов();
	...
	|ГДЕ
	|	НЕ ШаблоныДокументов.ПометкаУдаления";
	Шаблоны = Запрос.Выполнить().Выгрузить().ВыгрузитьКолонку("Ссылка");;
	Если Не ЗначениеЗаполнено(Шаблоны) Тогда
		ОтключитьОбработчикОбмена(ИмяОбработчика);
		Возврат;
	КонецЕсли;
...
Функция ИмяОбработчикаЗарегистрироватьВыгрузкуПодразделенийОрганизации()

	Возврат "ЗарегистрироватьВыгрузкуПодразделенийОрганизации";

КонецФункции

Процедура ЗарегистрироватьВыгрузкуПодразделенийОрганизации()
	
	ИмяОбработчика = ИмяОбработчикаЗарегистрироватьВыгрузкуПодразделенийОрганизации();
	
	Запрос = Новый Запрос;
	Запрос.Текст = 
	"ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ШтатноеРасписание.Подразделение КАК Ссылка,
	|	ЗНАЧЕНИЕ(Перечисление.ТипыОбъектовИнтеграцияУправлениеПерсоналом.ПодразделениеОрганизации) КАК ТипОбъекта
	|ИЗ
	|	РегистрСведений.ВыгружаемыеОбъектыКабинетСотрудника КАК ВыгружаемыеОбъекты
	...
	ТаблицаПодразделений = РезультатЗапроса[0].Выгрузить();
	ТаблицаОбъектов = НоваяТаблицаИзмененияДляОбмена();
	ОбщегоНазначенияКлиентСервер.ДополнитьТаблицу(ТаблицаПодразделений, ТаблицаОбъектов);
	ОбщегоНазначенияКлиентСервер.ДополнитьТаблицу(РезультатЗапроса[1].Выгрузить(), ТаблицаОбъектов);
	...
	Попытка
		...
		ЭлементБлокировки.ИспользоватьИзИсточникаДанных("ТипОбъекта", "ТипОбъекта");
		ЭлементБлокировки = Блокировка.Добавить("РегистрСведений.ВыгружаемыеОбъектыКабинетСотрудника");
		ЭлементБлокировки.ИсточникДанных = ТаблицаПодразделений;
		ЭлементБлокировки.ИспользоватьИзИсточникаДанных("Ссылка", "Ссылка");
...
Функция ИмяОбработчикаЗарегистрироватьШаблоныДокументов_3_4()
	
	Возврат "ЗарегистрироватьШаблоныДокументов_3_4";
	
КонецФункции

Процедура ЗарегистрироватьШаблоныДокументов_3_4()
	
	ИмяОбработчика = ИмяОбработчикаЗарегистрироватьШаблоныДокументов_3_4();
	
	Шаблоны = Новый Массив;
	
	СсылкаПредопределенного = ОбщегоНазначения.ПредопределенныйЭлемент("Справочник.ШаблоныДокументов.ЗаявлениеОСпособеВыплатыЗарплаты");
	Если ЗначениеЗаполнено(СсылкаПредопределенного) Тогда
		Шаблоны.Добавить(СсылкаПредопределенного);
	КонецЕсли;
...
Процедура ЗавершитьСценарийОтложенногоПодключенияФоновоеЗадание(Параметры, АдресХранилища) Экспорт
	...
	ВключитьНастройкиПрограммыПослеПодключенияПриложения();
