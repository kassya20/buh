...
Функция ВидыНоменклатурыДляВыбора(ОсновнойВидНоменклатуры, СписокВидовНоменклатуры) Экспорт
	...
	Для Каждого ВидНоменклатуры Из ВидыНоменклатуры Цикл
		...
		ИначеЕсли ВРег(ВидНоменклатуры) = ВРег("Продукция") Тогда
			ЗапросыДляОбъединения.Добавить(ТекстЗапроса("ГотоваяПродукция"));
		ИначеЕсли ВРег(ВидНоменклатуры) = ВРег("Полуфабрикаты") Тогда
			ЗапросыДляОбъединения.Добавить(ТекстЗапроса("Полуфабрикаты"));
