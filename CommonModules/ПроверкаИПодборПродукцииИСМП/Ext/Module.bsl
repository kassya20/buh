...
//     * ДанныеКонтроляВидаПродукцииПоРазделеннымДатам - см. СтруктураДанныхКонтроляПоРазделеннымДатам
Функция ПараметрыОкончанияПроверки() Экспорт
	...
	Результат.Вставить("ПараметрыСканирования");
	...
	Результат.Вставить("ДанныеКонтроляВидаПродукцииПоРазделеннымДатам");
