...
Процедура ПолучитьСведенияОПоказателяхОтчетаОперацииСДенежнымиСредствамиНФО2017Кв2(ПоказателиОтчета) Экспорт
	...
	ПолучитьСведенияОПоказателяхОтчетаОперацииСДенежнымиСредствамиНФО(ПоказателиОтчета);
...
//                 Содержание структуры определяется БРО.
//
Процедура ПолучитьСведенияОПоказателяхОтчетаОперацииСДенежнымиСредствамиНФО2021Кв3(ПоказателиОтчета) Экспорт
...
//                 Содержание структуры определяется БРО.
//
Процедура ПолучитьСведенияОПоказателяхОтчетаОперацииСДенежнымиСредствамиНФО2022Кв2(ПоказателиОтчета) Экспорт
...
Процедура ЗаполнитьРегламентированныйОтчетОперацииСДенежнымиСредствамиНФО2017Кв2(ПараметрыОтчета, Контейнер) Экспорт
	...
	ЗаполнитьРегламентированныйОтчетОперацииСДенежнымиСредствамиНФО(ПараметрыОтчета, Контейнер);
...
//                 Содержит свойства: Раздел1, Раздел21, Раздел22.
//
Процедура ЗаполнитьРегламентированныйОтчетОперацииСДенежнымиСредствамиНФО2021Кв3(ПараметрыОтчета, Контейнер) Экспорт
...
//                 Содержит свойства: Раздел1, Раздел21, Раздел22.
//
Процедура ЗаполнитьРегламентированныйОтчетОперацииСДенежнымиСредствамиНФО2022Кв2(ПараметрыОтчета, Контейнер) Экспорт
...
// Указание автоматически заполняемых показателей отчета для форм отчетности, начиная с 2017 года.
//
// Параметры:
//  ПоказателиОтчета  - Структура - структура, описывающая показатели отчета.
//                 Содержание структуры определяется БРО.
//
Процедура ПолучитьСведенияОПоказателяхОтчетаОперацииСДенежнымиСредствамиНФО(ПоказателиОтчета)
...
// Заполнение показателей отчета для форм отчетности, начиная с 2017 года.
//
// Параметры:
//  ПараметрыОтчета  - Структура - структура, описывающая параметры формируемого отчета.
//                 Содержит свойства: Организация, мДатаНачалаПериодаОтчета, мДатаКонцаПериодаОтчета.
...
//                 Содержит свойства: Раздел1, Раздел21, Раздел22.
//
Процедура ЗаполнитьРегламентированныйОтчетОперацииСДенежнымиСредствамиНФО(ПараметрыОтчета, Контейнер)
	
	ПараметрыЗаполнения = ОбщегоНазначенияКлиентСервер.СкопироватьСтруктуру(ПараметрыОтчета);
	ПараметрыЗаполнения.Вставить("ЗнакиДробнойЧасти", 5);
	ОперацииНФО = ПодготовитьОперацииСДенежнымиСредствамиНФО(ПараметрыЗаполнения);
	
	// В версиях, начиная с 2017 года, в составе показателей Раздела1 отсутствует БИК.
...
Функция ПодготовитьОперацииСДенежнымиСредствамиНФО(ПараметрыОтчета) Экспорт
	...
	// В отчете, действующем с мая 2022, указывается полное и сокращенное наименования банка, ранее - только сокращенное
	НачалоПериода = ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(ПараметрыОтчета, "мДатаНачалаПериодаОтчета", '2399-12-31');
	УказыватьПолноеНаименованиеБанка = НачалоПериода >= '2022-05-01'; 
	...
	Для каждого СтрокаБанк Из ДанныеОтчета.Банки.Строки Цикл
		...
		Если УказыватьПолноеНаименованиеБанка 
			И Не ПустаяСтрока(СтрокаБанк.ПолноеНаименование) Тогда
			СтрокаРаздел1.Данные.СокрНаимКредОрг = СтрШаблон("%1, %2", СтрокаБанк.ПолноеНаименование, СтрокаБанк.Наименование);
		Иначе
...
Функция ДанныеОтчетаОперацииСДенежнымиСредствамиНФО(ПараметрыОтчета)
	...
	|	ЕСТЬNULL(РегистрационныеНомераБанков.ПолноеНаименование, """") КАК ПолноеНаименование,
