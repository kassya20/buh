...
Функция ДоступенСпособВводаВОборотМаркировкаОстатков(ВидПродукции) Экспорт
	...
	Возврат ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.Антисептики")
		...
		Или ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ЛегкаяПромышленность2026")
...
Функция ВидПродукцииПодлежитВозвратуВОборот(ВидПродукции = Неопределено) Экспорт
	...
	Результат.Добавить(ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ЛегкаяПромышленность2026"));
	...
	КонецЕсли;
	Если ТоварыИзНатуральногоМехаПодлежитВозвратуВОборот() Тогда
		Результат.Добавить(ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ТоварыИзНатуральногоМеха"));
	КонецЕсли;
...
Функция ВидПродукцииИспользуетОтчетыОНанесенииКодовМаркировки(ВидПродукции) Экспорт
	...
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ТоварыИзНатуральногоМеха") Тогда
		Возврат ТоварыИзНатуральногоМехаИспользуетОтчетыОНанесенииКодовМаркировки();
	КонецЕсли;
...
Функция ВидПродукцииПоддерживаетАгрегациюКодовМаркировкиЧерезСУЗ(ВидПродукции) Экспорт
	...
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ТоварыИзНатуральногоМеха") Тогда
		Возврат ТоварыИзНатуральногоМехаПоддерживаетАгрегациюКодовМаркировкиЧерезСУЗ();
	КонецЕсли;
...
Функция ВидПродукцииИспользуетПолучениеПродукцииОтФизическихЛиц(ВидПродукции) Экспорт
	...
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ТоварыИзНатуральногоМеха") Тогда
		Возврат ТоварыИзНатуральногоМехаИспользуетПолучениеПродукцииОтФизическихЛиц();
	КонецЕсли;
...
Функция ВидПродукцииИспользуетСвидетельствоОГосударственнойРегистрации(ВидПродукции) Экспорт
	...
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.ТоварыИзНатуральногоМеха") Тогда
		Возврат ТоварыИзНатуральногоМехаИспользуетСвидетельствоОГосударственнойРегистрации();
	КонецЕсли;
...
Функция ТоварыИзНатуральногоМехаПодлежитВозвратуВОборот()
	Возврат Истина;
КонецФункции
...
Функция ТоварыИзНатуральногоМехаИспользуетОтчетыОНанесенииКодовМаркировки()
	Возврат Истина;
КонецФункции
...
Функция ТоварыИзНатуральногоМехаИспользуетПроизводствоВнеЕАЭС() Экспорт
	Возврат Истина;
КонецФункции
...
Функция ТоварыИзНатуральногоМехаПоддерживаетАгрегациюКодовМаркировкиЧерезСУЗ()
	Возврат Ложь;
КонецФункции
...
Функция ТоварыИзНатуральногоМехаИспользуетПолучениеПродукцииОтФизическихЛиц()
	Возврат Ложь;
КонецФункции
...
Функция ТоварыИзНатуральногоМехаИспользуетСвидетельствоОГосударственнойРегистрации()
	Возврат Истина;
КонецФункции
