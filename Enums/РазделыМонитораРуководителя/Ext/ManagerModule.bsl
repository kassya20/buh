...
Функция ДанныеРазделаДоступны(Раздел) Экспорт
	...
	ИначеЕсли Раздел = ПродажиПоКонтрагентам 
		Или Раздел = ПродажиПоНоменклатурнымГруппам Тогда
	...
	ИначеЕсли Раздел = ОстаткиДенежныхСредств Тогда
...
Функция СтруктураРасшифровкиРаздела(Раздел) Экспорт
	...
	Если Раздел = ОстаткиДенежныхСредств Тогда
		...
		СтруктураРасшифровки.Вставить("КлючВарианта", "ОстаткиДенежныхСредств");
	...
	ИначеЕсли Раздел = ПоступлениеДенежныхСредств Тогда
		...
		СтруктураРасшифровки.Вставить("КлючВарианта", "ПоступленияДенежныхСредств");
	...
	ИначеЕсли Раздел = РасходДенежныхСредств Тогда
		...
		СтруктураРасшифровки.Вставить("ГруппировкаОтчета", СтандартныеГруппировкиДенежныхСредств());
		СтруктураРасшифровки.Вставить("КлючВарианта", "РасходыДенежныхСредств");
	...
	ИначеЕсли Раздел = Доходы Или Раздел = Расходы Или Раздел = Прибыль Тогда
		
		СтруктураРасшифровки.Вставить("СсылкаНаОтчет",    "e1cib/app/Отчет.ДоходыРасходы");
		СтруктураРасшифровки.Вставить("ФормаОтчета",      "Отчет.ДоходыРасходы.Форма.ФормаОтчета");
		СтруктураРасшифровки.Вставить("КлючВарианта",     "ДоходыРасходы");
		СтруктураРасшифровки.Вставить("КлючеваяОперация", "МониторРасшифровкаРазделаДоходыРасходы");
...
Функция СтандартныеГруппировкиДенежныхСредств()
	...
	ГруппировкаОтчета.Добавить(Новый Структура("Поле, Представление, Использование, ТипГруппировки", "ВидДенежныхСредств",
		"Вид денежных средств", Истина, 0));
	ГруппировкаОтчета.Добавить(Новый Структура("Поле, Представление, Использование, ТипГруппировки", "Размещение",
		"Размещение", Истина, 0));
