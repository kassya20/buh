...
//  ФиксированныйМассив Из ПеречислениеСсылка.ВидыАктивовИОбязательств - значения перечисления, соответствующие
//                                                                       неиспользованным налоговым убыткам и вычетам.
//
Функция НеиспользованныеНалоговыеУбыткиВычеты() Экспорт
	
	НеиспользованныеНалоговыеУбыткиВычеты = Новый Массив;
	НеиспользованныеНалоговыеУбыткиВычеты.Добавить(ФедеральныйИнвестиционныйВычет);
