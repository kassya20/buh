...
// Возвращает признак того, что переданный через параметр вид операции относится к выплате заработной платы
//
// Параметры:
//  ВидОперации - ПеречислениеСсылка.ВидыОперацийРКО - проверяемый вид операции
//
// Возвращаемое значение:
//  Булево - принимает значение Истина, если проверяемый вид операции относится к выплате заработной платы
//
Функция ЭтоВыплатаЗарплаты(ВидОперации) Экспорт
	
	ОперацииВыплатыЗарплаты = Новый Массив;
	ОперацииВыплатыЗарплаты.Добавить(Перечисления.ВидыОперацийРКО.ВыплатаЗаработнойПлатыРаботнику);
	ОперацииВыплатыЗарплаты.Добавить(Перечисления.ВидыОперацийРКО.ВыплатаЗаработнойПлатыПоВедомостям);
	ОперацииВыплатыЗарплаты.Добавить(Перечисления.ВидыОперацийРКО.ВыплатаСотрудникуПоДоговоруПодряда);
	ОперацииВыплатыЗарплаты.Добавить(Перечисления.ВидыОперацийРКО.ВыплатаДепонентов);
	Возврат ОперацииВыплатыЗарплаты.Найти(ВидОперации) <> Неопределено;
