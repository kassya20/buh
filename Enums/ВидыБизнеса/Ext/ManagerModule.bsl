...
Функция НеобходимаяФункциональность(ВидБизнеса) Экспорт
	...
	Возврат КонстантыФункциональныхОпций(МакетНастроек.ПолучитьОбласть("ФункциональностьПрограммы"), НомерКолонки);
	
КонецФункции

Функция ОписанияВидовБизнеса() Экспорт
	
	Описания = Новый СписокЗначений;
	
	КоллекцияМетаданных = Метаданные.Перечисления.ВидыБизнеса.ЗначенияПеречисления;
	Для Каждого МетаданныеЗначения Из КоллекцияМетаданных Цикл
		Описания.Добавить(Перечисления.ВидыБизнеса[МетаданныеЗначения.Имя], МетаданныеЗначения.Комментарий);
	КонецЦикла;
...
Функция ОписанияВидовБизнесаДляСамозанятых() Экспорт
	
	Описания = Новый СписокЗначений;
	ДоступныеВидыБизнеса = ВидыБизнесаДляСамозанятых();
	
	КоллекцияМетаданных = Метаданные.Перечисления.ВидыБизнеса.ЗначенияПеречисления;
	
	Для Каждого ВидБизнеса Из ДоступныеВидыБизнеса Цикл
		Описания.Добавить(ВидБизнеса, КоллекцияМетаданных[Индекс(ВидБизнеса)].Комментарий);
	КонецЦикла;
...
Функция ИдентификаторыВидовБизнеса() Экспорт
	...
	ИдентификаторыВидовБизнеса.Вставить("marketplace_sales", Перечисления.ВидыБизнеса.ПродажиНаМаркетплейсах);
	ИдентификаторыВидовБизнеса.Вставить("default", Перечисления.ВидыБизнеса.Другое);
	Возврат ИдентификаторыВидовБизнеса;
	
КонецФункции

// Возвращает виды бизнеса, для которых приоритетным видом номенклатуры является услуга
//
// Возвращаемое значение:
//  Массив из ПеречислениеСсылка.ВидыБизнеса
//
Функция ВидыБизнесаСПриоритетнымВидомНоменклатурыУслуга() Экспорт
	
	ИменаВидовБизнеса = Новый Массив;
	ИменаВидовБизнеса.Добавить(УслугиОрганизациям);
	ИменаВидовБизнеса.Добавить(УслугиНаселению);
	ИменаВидовБизнеса.Добавить(АгентскиеУслуги);
	ИменаВидовБизнеса.Добавить(Обучение);
	ИменаВидовБизнеса.Добавить(ТранспортЛогистика);
	
	Возврат ИменаВидовБизнеса;
...
Функция ВидыБизнесаДляСамозанятых()
	
	ИменаВидовБизнеса = Новый Массив;
	
	ИменаВидовБизнеса.Добавить(УслугиОрганизациям);
	ИменаВидовБизнеса.Добавить(УслугиНаселению);
	ИменаВидовБизнеса.Добавить(ИнтернетМагазин);
	ИменаВидовБизнеса.Добавить(Обучение);
	ИменаВидовБизнеса.Добавить(СельскоеХозяйство);
	ИменаВидовБизнеса.Добавить(Другое);
