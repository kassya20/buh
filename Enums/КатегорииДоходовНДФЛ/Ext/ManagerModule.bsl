...
// С 1 янв 2028 года в отчетности и при регистрации доходов тариф АУСН не учитывается.
//
// Параметры:
...
//    Массив - Значения типа ПеречислениеСсылка.КатегорииДоходовНДФЛ
//
Функция ДоходыАУСН(ДатаАктуальности = '00010101') Экспорт
	
	Категории = Новый Массив;
	Если Не ЗначениеЗаполнено(ДатаАктуальности) Или ДатаАктуальности < '20280101'  Тогда
		Категории.Добавить(ОплатаТрудаАУСН);
		Категории.Добавить(РайонныеСеверныеНадбавкиАУСН);
