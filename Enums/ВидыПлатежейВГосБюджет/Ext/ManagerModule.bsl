...
Функция СписокВидовНалоговыхОбязательств(НалогСсылка, Знач Период = Неопределено) Экспорт
	...
	// Налог, Взносы
	НеактуальныеНалоги = ПлатежиВБюджетКлиентСерверПереопределяемый.НеактуальныеНалоги(Период);
	...
	ИначеЕсли ВидНалога = Перечисления.ВидыНалогов.ФиксированныеВзносы_ФСС
		И УчетСтраховыхВзносовИП.РазделятьУплатуДобровольныхВзносов(Период) Тогда
		СписокВыбора.Добавить(Перечисления.ВидыПлатежейВГосБюджет.Налог, НСтр("ru = 'Взносы'"));
		СписокВыбора.Добавить(Перечисления.ВидыПлатежейВГосБюджет.ДобровольныеВзносыСамозанятого, НСтр("ru = 'Добровольные взносы самозанятого'"));
	...
	Если ВидНалога <> Перечисления.ВидыНалогов.ЕдиныйНалоговыйПлатеж
		И ВидНалога <> Перечисления.ВидыНалогов.ФиксированныеВзносы_ФСС Тогда
		// Пени, Проценты, Штраф
...
Функция ПолучитьДоступныеЗначения(Отбор, СтрокаПоиска)
	...
	Если Отбор.Свойство("СчетУчета", СчетУчета) Тогда
		Если СчетУчета = ПланыСчетов.Хозрасчетный.ЕдиныйНалоговыйСчет Тогда
			Исключения.Добавить(Перечисления.ВидыПлатежейВГосБюджет.НалогСам);
			Исключения.Добавить(Перечисления.ВидыПлатежейВГосБюджет.НалогАкт);
			Исключения.Добавить(Перечисления.ВидыПлатежейВГосБюджет.Штраф);
			Исключения.Добавить(Перечисления.ВидыПлатежейВГосБюджет.РасходыПоСтрахованию);
			Исключения.Добавить(Перечисления.ВидыПлатежейВГосБюджет.ПениСам);
			Исключения.Добавить(Перечисления.ВидыПлатежейВГосБюджет.ПениАкт);
			Исключения.Добавить(Перечисления.ВидыПлатежейВГосБюджет.ПолученоИзФонда);
			Исключения.Добавить(Перечисления.ВидыПлатежейВГосБюджет.НеПринято);
			Исключения.Добавить(Перечисления.ВидыПлатежейВГосБюджет.Проценты);
			Исключения.Добавить(Перечисления.ВидыПлатежейВГосБюджет.ВзносыСвышеПредела);
			Исключения.Добавить(Перечисления.ВидыПлатежейВГосБюджет.ВзносыБезСпецоценки);
			Исключения.Добавить(Перечисления.ВидыПлатежейВГосБюджет.ГосрегистрацияОрганизацийЧерезМФЦ);
		ИначеЕсли СчетУчета <> ПланыСчетов.Хозрасчетный.ПФР_доп_ВредныеУсловияТруда
