...
Процедура СоздатьУвольнение(Команда)
	...
	ОткрытьФорму("Документ.Увольнение.ФормаОбъекта", ПараметрыСозданияДокумента(), ЭтотОбъект);
	
КонецПроцедуры

&НаКлиенте
Процедура СоздатьПремию(Команда)
	
	ОткрытьФорму("Документ.Премия.Форма.ФормаДокумента", ПараметрыСозданияДокумента(), ЭтотОбъект);
