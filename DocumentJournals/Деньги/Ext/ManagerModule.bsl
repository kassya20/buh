...
// Показывает предупреждение по работе с маркетплейсами в зависимости от настроек организации и функциональных опций.
//
// Параметры:
//   Элементы - КоллекцияЭлементовФормы - элементы формы, содержащие группу для отображения предупреждения
//   Организация - СправочникСсылка.Организации - организация, для которой выполняется проверка
Процедура ПоказатьПредупреждениеПоРаботеСМаркетплейсами(Элементы, Организация) Экспорт
	
	ПараметрыБаннера = Обработки.ПомощникРасчетаНалогаУСН.ПараметрыПредупрежденияПоРаботеСМаркетплейсами(
		Организация,
		ТекущаяДатаСеанса(),
		ИмяНастройкиПредупрежденияПоРаботеСМаркетплейсами());
	
	Элементы.ТекстПредупреждениеПоРаботеСМаркетплейсами.Заголовок = ПараметрыБаннера.ТекстПредупреждения;
...
// Возвращает имя настройки для хранения предупреждений по работе с маркетплейсами.
//
// Возвращаемое значение:
//   Строка - имя настройки
Функция ИмяНастройкиПредупрежденияПоРаботеСМаркетплейсами() Экспорт
	Возврат "ЖурналДеньги";
КонецФункции

// Возвращает ключ настройки для определения видимости предупреждения по работе с маркетплейсами.
//
// Возвращаемое значение:
//   Строка - ключ настройки видимости предупреждения
Функция КлючНастройкиПредупрежденияПоРаботеСМаркетплейсами() Экспорт
	Возврат Обработки.ПомощникРасчетаНалогаУСН.КлючНастройкиПредупрежденияПоРаботеСМаркетплейсами();
КонецФункции
