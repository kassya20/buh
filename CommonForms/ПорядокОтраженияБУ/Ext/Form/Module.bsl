...
Процедура Подбор(Команда)
	...
	ПараметрыФормы.Вставить("СчетУчета",                               ЭтотОбъект.Счет);
...
Процедура УстановитьЗаголовкиИДоступностьСубконто(Форма)
	...
	ПараметрыОтображения.ЗаголовкиПолей = ЗаголовкиПолей;
	
	БухгалтерскийУчетКлиентСервер.ПриВыбореСчета(Счет, Форма, ПоляФормы, ПараметрыОтображения);
...
Функция СписокПараметровВыбораСубконто(Форма, ПараметрыОбъекта, ШаблонИмяПоляОбъекта)
	...
	БухгалтерскийУчетКлиентСервер.ДополнитьСписокПараметровСубконто(СписокПараметров, ПараметрыОбъекта, ШаблонИмяПоляОбъекта);
...
Процедура ЗаполнитьНаСервере()
	...
	РеквизитыДокумента.Вставить("СчетУчета",                  ЭтотОбъект.Счет);
...
Функция ОписаниеТипаРеквизитаДокументРасчетов()
	...
	Возврат Метаданные.Документы.СписаниеСРасчетногоСчета.ТабличныеЧасти.НалоговыйАгентНДС.Реквизиты.ДокументРасчетов.Тип;
