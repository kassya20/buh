...
Процедура ОграничитьКоличествоВыводимыхПоУмолчаниюБлоков(НастройкиБлоков, КоллекцияБлоков)
	...
	КоличествоБлоковПоУмолчанию = ИнформационнаяПанель.КоличествоБлоковПоУмолчанию();
...
Процедура МобильныйКлиентАдаптацияФормы()
	...
	УстановитьУсловноеОформлениеМК();
...
Процедура АдаптироватьМКШапкаФормы()
	...
	Элементы.ДоступныеБлоки.РежимВыбора = Истина;
	Элементы.ВыбранныеБлоки.РежимВыбора = Истина;
	
	МобильныйКлиентБПФормаОбъекта.ВстроитьЭлементФормыВГруппаМКФормаВажное(Элементы,
		Элементы.ГруппаДоступныеБлоки);
	
	Элементы.КоманднаяПанельДоступныеБлоки.Группировка = ГруппировкаПодчиненныхЭлементовФормы.ГоризонтальнаяВсегда;
	
	МобильныйКлиентБПФормаОбъекта.ВстроитьЭлементФормыВГруппаМКФормаВажное(Элементы,
		Элементы.ГруппаВыбранныеБлоки);
	
	МобильныйКлиентБПФормаОбъекта.ВстроитьЭлементФормыВГруппаМКФормаВажное(Элементы,
		Элементы.КоманднаяПанельФормы);
...
Процедура АдаптироватьМККоманднаяПанельФормы()
	...
	Элементы.СтандартныеНастройки.ПоложениеВКоманднойПанели = ПоложениеКнопкиВКоманднойПанели.ВДополнительномПодменю;
	
	Элементы.КоманднаяПанельДоступныеБлоки.ГоризонтальноеПоложениеПодчиненных = ГоризонтальноеПоложениеЭлемента.Право;
	Элементы.КоманднаяПанельДоступныеБлоки.РастягиватьПоГоризонтали = Истина;
	
	Элементы.ГруппаДоступныеБлоки.РастягиватьПоГоризонтали = Истина;
	Элементы.ГруппаВыбранныеБлоки.РастягиватьПоГоризонтали = Истина;
	
	Элементы.ГруппаДоступныеБлокиСтандартныеНастройки.Объединенная = Истина;
	Элементы.ГруппаВыбранныеБлокиКоманднаяПанельФормы.Объединенная = Истина;
	
	Элементы.УдалитьВсе.ГоризонтальноеПоложениеВГруппе = ГоризонтальноеПоложениеЭлемента.Право;
	Элементы.УдалитьВсе.Заголовок = "Сбросить все";
	Элементы.Удалить.Заголовок = "Удалить";
	
	МобильныйКлиентБПФормаОбъекта.ПеренестиКомандуВМККомандыФормы(Элементы, Элементы.УдалитьВсе);
	МобильныйКлиентБПФормаОбъекта.ПеренестиКомандуВМККомандыФормы(Элементы, Элементы.СтандартныеНастройки);
	МобильныйКлиентБПФормаОбъекта.СкрытьЭлементФормы(Элементы, Элементы.КоманднаяПанельДоступныеБлоки);
	МобильныйКлиентБПФормаОбъекта.СкрытьЭлементФормы(Элементы, Элементы.КоманднаяПанельВыбранныеБлоки);
	
	Элементы.Переместить(Элементы.КоманднаяПанельФормы, ЭтотОбъект);
КонецПроцедуры

&НаСервере
Процедура УстановитьУсловноеОформлениеМК()
	
	ДоступныеРазделыНаМК = БлокиИнформационнойПанелиКлиентСервер.ДоступныеРазделыНаМК();
	
	СписокДоступныхРазделовМК = Новый СписокЗначений();
	СписокДоступныхРазделовМК.ЗагрузитьЗначения(ДоступныеРазделыНаМК);
	
	ЭлементУО = УсловноеОформление.Элементы.Добавить();
	
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУО.Поля, "ДоступныеБлокиЗначение");
	
	ОбщегоНазначенияКлиентСервер.ДобавитьЭлементКомпоновки(ЭлементУО.Отбор,
		"ДоступныеБлоки.Значение", ВидСравненияКомпоновкиДанных.НеВСписке, СписокДоступныхРазделовМК);
	
	ЭлементУО.Оформление.УстановитьЗначениеПараметра("ЦветТекста", ЦветаСтиля.ЦветНедоступногоТекста);
	
	ЭлементУО = УсловноеОформление.Элементы.Добавить();
	
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУО.Поля, "ВыбранныеБлокиЗначение");
	
	ОбщегоНазначенияКлиентСервер.ДобавитьЭлементКомпоновки(ЭлементУО.Отбор,
		"ВыбранныеБлоки.Значение", ВидСравненияКомпоновкиДанных.НеВСписке, СписокДоступныхРазделовМК);
