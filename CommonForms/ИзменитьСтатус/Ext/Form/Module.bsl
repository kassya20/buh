...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТипЗнч(СтатусыДокумента.Статус) = Тип("ПеречислениеСсылка.СтатусыДокументовПоступления") Тогда
		...
		Элементы.СтатусДокументаКоммерческоеПредложение.Видимость = Ложь;
	ИначеЕсли ТипЗнч(СтатусыДокумента.Статус) = Тип("ПеречислениеСсылка.СтатусыДокументовРеализации") Тогда
		...
		Элементы.СтатусДокументаКоммерческоеПредложение.Видимость = Ложь;
	ИначеЕсли ТипЗнч(СтатусыДокумента.Статус) = Тип("ПеречислениеСсылка.СтатусыКоммерческогоПредложения") Тогда
		КлючНазначенияИспользования = "КоммерческоеПредложение";
		Элементы.СтатусДокументаПоступления.Видимость = Ложь;
		Элементы.СтатусДокументаРеализации.Видимость = Ложь;
		Элементы.СтатусДокументаКоммерческоеПредложение.Видимость = Истина;
	Иначе
		Отказ = Истина;
		Возврат;
	КонецЕсли;
