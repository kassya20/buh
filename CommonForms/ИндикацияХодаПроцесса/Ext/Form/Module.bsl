...
Процедура ПриЗакрытии(ЗавершениеРаботы)
	...
	Если Не ДлительнаяОперацияЗавершена Тогда
		ДлительнаяОперация = ЗакрытиеМесяцаВызовСервера.ЗапуститьОстановкуФоновогоЗаданияЗакрытияМесяца(
			ТекущаяОрганизация, УникальныйИдентификатор, ИдентификаторЗадания);
		
		ПараметрыОжидания = ДлительныеОперацииКлиент.ПараметрыОжидания(Неопределено);
		ПараметрыОжидания.ВыводитьОкноОжидания = Истина;
		ПараметрыОжидания.ТекстСообщения = НСтр("ru = 'Выполняется завершение операции.'");
