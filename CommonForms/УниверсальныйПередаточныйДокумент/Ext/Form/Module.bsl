...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьЗначенияСвойств(ЭтотОбъект, Параметры,
		"Дата,Организация,СчетФактура,КодВидаОперации,НДСПредъявленКВычету,АдресХранилищаПродавцы,
	...
	ДоступенВычетНДС = НЕ ЭтоВыданныйДокумент
		И НЕ РаздельныйУчетНДС
...
Процедура УправлениеФормой(Форма)
	...
	Элементы.НДСПредъявленКВычету.Видимость  = Форма.ДоступенВычетНДС;
