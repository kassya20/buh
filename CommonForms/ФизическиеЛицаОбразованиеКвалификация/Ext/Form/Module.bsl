...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
			Элементы,
			"ГруппаНаучныеДостижения",
			"Видимость",
			Ложь);
	КонецЕсли;
	
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОбучениеРазвитие.ОбразованиеГосслужащих") Тогда
		МодульОбразованиеГосслужащих = ОбщегоНазначения.ОбщийМодуль("ОбразованиеГосслужащих");
		МодульОбразованиеГосслужащих.ПриСозданииНаСервереФормыОбразованиеКвалификация(ЭтотОбъект, Элементы.ОбщаяГруппа, Элементы.ГруппаФизическоеЛицоПрофессии);
	КонецЕсли;
...
Процедура ПриОткрытии(Отказ)
	...
	Элементы.ОбразованиеФизическихЛицТолькоУчитываемыеВТ2.Пометка = ПоказыватьТолькоУчитываемыеВТ2;
	УстановитьИспользованиеОтбораУчитываемыеВТ2();
...
&НаКлиенте
Процедура Подключаемый_ОбразовательныеСертификатыИзменить(Команда)
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОбучениеРазвитие.ОбразованиеГосслужащих") Тогда
		МодульОбразованиеГосслужащихКлиент = ОбщегоНазначенияКлиент.ОбщийМодуль("ОбразованиеГосслужащихКлиент");
		МодульОбразованиеГосслужащихКлиент.ОткрытьФормуОбразованияГосслужащего(ЭтотОбъект);
	КонецЕсли;
КонецПроцедуры
...
&НаКлиенте
Процедура ТолькоУчитываемыеВТ2(Команда)
	
	ПоказыватьТолькоУчитываемыеВТ2 = Не ПоказыватьТолькоУчитываемыеВТ2;
	Элементы.ОбразованиеФизическихЛицТолькоУчитываемыеВТ2.Пометка = ПоказыватьТолькоУчитываемыеВТ2;
	УстановитьИспользованиеОтбораУчитываемыеВТ2();
КонецПроцедуры
#КонецОбласти
...
Процедура ПроинициализироватьФорму()
	...
	МожноРедактировать = ПравоДоступа("Редактирование", Метаданные.Справочники.ОбразованиеФизическихЛиц);
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы,
		"ФизическоеЛицоПрофессииИзменить",
		"Доступность",
		МожноРедактировать);
	
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы,
		"ФизическоеЛицоСпециальностиИзменить",
		"Доступность",
		МожноРедактировать);
	
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы,
		"ФизическоеЛицоЗнаниеЯзыковИзменить",
		"Доступность",
		МожноРедактировать);
...
&НаКлиенте
Процедура УстановитьИспользованиеОтбораУчитываемыеВТ2()
	
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
		ОбразованиеФизическихЛиц, "СкрыватьВТ2", Ложь,,, ПоказыватьТолькоУчитываемыеВТ2);
