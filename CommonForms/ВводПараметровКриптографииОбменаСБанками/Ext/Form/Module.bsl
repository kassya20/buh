...
Функция ПодобратьМашиночитаемыеДоверенностиОрганизаций(МЧД = Неопределено)
	...
	Для Каждого СвойстваДоверенности Из ВыборкаДоверенностей Цикл
		...
		Если МодульМашиночитаемыеДоверенности.ДоверенностьДействительнаПоСвойствам(
				СвойстваДоверенности.Значение, КонецДня(ПараметрыОтбораДоверенность.Дата) - 1) Тогда
