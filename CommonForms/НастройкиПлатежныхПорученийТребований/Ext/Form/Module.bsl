...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЭтоСчетОрганизации ИЛИ ОткрытИзПлатежки Тогда
		...
		ИначеЕсли ЗначениеЗаполнено(СтруктураБанковскийСчетОрганизации.ТекстКорреспондента) Тогда
			НаименованиеПлательщикаПриПеречисленииВБюджет              = СтруктураБанковскийСчетОрганизации.ТекстКорреспондента;
		Иначе
...
Процедура БанковскийСчетОрганизацииТекстКорреспондентаИспользованиеПриИзменении(Элемент)
	...
	НаименованиеПлательщикаПриПеречисленииВБюджетИзменение();
...
&НаКлиенте
Процедура БанковскийСчетОрганизацииТекстКорреспондентаПриИзменении(Элемент)
	
	Если НаименованиеПлательщикаПриПеречисленииВБюджетИспользование = 0 Тогда
		НаименованиеПлательщикаПриПеречисленииВБюджет = БанковскийСчетОрганизацииТекстКорреспондента;
	КонецЕсли;
...
Процедура Отмена(Команда)
	...
	ПеренестиДанныеВБанковскийСчет = Ложь;
	Закрыть();
...
&НаКлиенте
Процедура НаименованиеПлательщикаПриПеречисленииВБюджетИзменение()
	
	Если НаименованиеПлательщикаПриПеречисленииВБюджетИспользование = 0 Тогда
		Если БанковскийСчетОрганизацииТекстКорреспондентаИспользование = 1 Тогда
			НаименованиеПлательщикаПриПеречисленииВБюджет = БанковскийСчетОрганизацииАвтоТекстКорреспондента;
		Иначе
			НаименованиеПлательщикаПриПеречисленииВБюджет = АвтоНаименованиеПлательщикаПриПеречисленииВБюджет;
		КонецЕсли;
	КонецЕсли;
...
Процедура УправлениеФормой(Форма)
	...
	Элементы.БанковскийСчетОрганизацииТекстКорреспондентаИспользование.Доступность = Форма.ЕстьДоступНаИзменениеОрганизации;
	...
	Элементы.БанковскийСчетОрганизацииТекстКорреспондента.Доступность  = Форма.ЕстьДоступНаИзменениеОрганизации
		И Форма.БанковскийСчетОрганизацииТекстКорреспондентаИспользование;
