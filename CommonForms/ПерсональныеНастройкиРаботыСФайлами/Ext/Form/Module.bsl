...
Процедура ПриОткрытии(Отказ)
	// СтандартныеПодсистемы.РаботаСФайлами
	Элементы.НастройкаСканирования.Видимость = РаботаСФайламиКлиент.ДоступноСканирование();
	// Конец СтандартныеПодсистемы.РаботаСФайлами
КонецПроцедуры
...
Процедура НастройкаРабочегоКаталога(Команда)
	...
	ФайловаяСистемаКлиент.ПодключитьРасширениеДляРаботы1СПредприятия(ОписаниеОповещения,, Ложь);
