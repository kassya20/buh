...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьЗначенияСвойств(ЭтотОбъект, Параметры,
		...
		|ПоставщикРезидентТаможенногоСоюза, КодВидаТранспорта, ДОПП, Организация, Контрагент");
	...
	УчетНДСКлиентСервер.ЗаполнитьСписокВыбораВидовТранспорта(Элементы.КодВидаТранспорта.СписокВыбора);
...
Процедура ПриЗакрытии(ЗавершениеРаботы)
	...
	Если ПеренестиВДокумент Тогда
		...
		СтруктураРезультат.Вставить("ДОПП", ДОПП);
