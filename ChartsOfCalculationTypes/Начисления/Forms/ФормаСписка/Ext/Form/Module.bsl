...
&НаКлиенте
Процедура ПоказатьНачисленияВАрхиве(Команда)
	
	ПоказыватьНачисленияВАрхиве = Не ПоказыватьНачисленияВАрхиве;
	УстановитьОтборИспользуемых(Список.Отбор, ПоказыватьНачисленияВАрхиве);
	Элементы.ФормаПоказатьНачисленияВАрхиве.Пометка = ПоказыватьНачисленияВАрхиве;
