...
Процедура ЗагрузитьСообщение105(Страхователь, РегистрацияИдентификатор, ТекстXML, Результат, Кэш) Экспорт
	...
	ТекстыОшибок = СЭДОФСС.ПредставлениеСпискаОшибокXML(РеквизитыКорня.errorList, НСтр("ru = 'Ошибки'"));
	ТекстыПредупреждений = СЭДОФСС.ПредставлениеСпискаОшибокXML(РеквизитыКорня.warnList, НСтр("ru = 'Предупреждения'"));
