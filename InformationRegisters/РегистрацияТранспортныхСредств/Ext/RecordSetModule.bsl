...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если Количество() = 1 Тогда
		...
		Если Запись.ВидЗаписи = Перечисления.ВидЗаписиОРегистрации.СнятиеСРегистрационногоУчета Тогда
			...
			МассивНепроверяемыхРеквизитов.Добавить("ВидТранспортногоСредства");
			...
			МассивНепроверяемыхРеквизитов.Добавить("СуммаУменьшения");
			МассивНепроверяемыхРеквизитов.Добавить("ЭкологическийКласс");
			МассивНепроверяемыхРеквизитов.Добавить("ВидЗаписи");
			
		КонецЕсли;
		
		Если Запись.ВидЗаписи <> Перечисления.ВидЗаписиОРегистрации.СнятиеСРегистрационногоУчета
			 И ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Запись.ОснованиеЛьготы, "ВидЛьготы") <>
				Перечисления.ВидыЛьготПоИмущественнымНалогам.СнижениеСуммыНаСумму Тогда
			МассивНепроверяемыхРеквизитов.Добавить("СуммаУменьшения");
		КонецЕсли;
...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	РегистрыСведений.РегистрацияТранспортныхСредств.ПроверитьОпциюУплачиваетсяТранспортныйНалог(ЭтотОбъект);
