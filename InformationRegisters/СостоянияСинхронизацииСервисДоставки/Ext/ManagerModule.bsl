...
// 
// Параметры:
//  ТипГрузоперевозки - ПеречислениеСсылка.ТипыГрузоперевозки - Тип грузоперевозки. Определяет сервис перевозчика, с которым происходит синхронизация.
//  ОрганизацияБизнесСети - СправочникСсылка.Организации - Организация, подключенная к 1С:Бизнес-сеть.
