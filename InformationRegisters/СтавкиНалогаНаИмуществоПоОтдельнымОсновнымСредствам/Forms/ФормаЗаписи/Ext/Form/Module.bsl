...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если Запись.НалоговаяБаза = Перечисления.НалоговаяБазаПоНалогуНаИмущество.КадастроваяСтоимость
		 И Запись.НеоблагаемаяКадастроваяСтоимость > Запись.КадастроваяСтоимость Тогда
	...
	Если Запись.НалоговаяБаза = Перечисления.НалоговаяБазаПоНалогуНаИмущество.КадастроваяСтоимость
		 И Запись.НеоблагаемаяКадастроваяСтоимость > 0 
		 И ВидЛьготыНалогНаИмущество <> Перечисления.ВидыЛьготПоИмущественнымНалогам.СнижениеНалоговойБазыНаСумму Тогда
		ТекстСообщения = НСтр("ru = 'Указана необлагаемая кадастровая стоимость. В этом случае должна быть выбрана льгота в виде снижения налоговой базы.'");
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(ТекстСообщения, , "Запись.ОснованиеЛьготы", "", Отказ);
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(Запись.ОснованиеЛьготы) Тогда
		Если ВидЛьготыНалогНаИмущество = ПредопределенноеЗначение("Перечисление.ВидыЛьготПоИмущественнымНалогам.СнижениеСуммыНаСумму")
			 И Не ЗначениеЗаполнено(Запись.СуммаУменьшения) Тогда
			ТекстСообщения = НСтр("ru = 'Не указана сумма, на которую уменьшен налог'");
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(ТекстСообщения, , "СуммаУменьшения", "Запись", Отказ);
		КонецЕсли;	
	КонецЕсли;
	...
	Если (ТекущийОбъект.КодВидаИмущества = "01" ИЛИ ТекущийОбъект.КБК = "18210602020021000110")
	  И Не УсловияПримененияТребованийЗаконодательства.ЕстьИмуществоЕСГС() Тогда
		ПараметрыЗаписи.Вставить("ПоявилосьИмуществоЕСГС", Истина);
	КонецЕсли;
	
	ПараметрыЗаписи.Вставить("УплачиваетсяНалогНаИмуществоПоКадастровойСтоимостиПередЗаписью",
...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	...
	ПараметрыЗаписи.Вставить("УплачиваетсяНалогНаИмуществоПоКадастровойСтоимостиПослеЗаписи",
		ПолучитьФункциональнуюОпцию("УплачиваетсяНалогНаИмуществоПоКадастровойСтоимости"));
...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	...
	Перем УплачиваетсяНалогНаИмуществоПоКадастровойСтоимостиПередЗаписью,
		УплачиваетсяНалогНаИмуществоПоКадастровойСтоимостиПослеЗаписи;
	
	Если ПараметрыЗаписи.Свойство("УплачиваетсяНалогНаИмуществоПоКадастровойСтоимостиПередЗаписью",
		 УплачиваетсяНалогНаИмуществоПоКадастровойСтоимостиПередЗаписью)
		И ПараметрыЗаписи.Свойство("УплачиваетсяНалогНаИмуществоПоКадастровойСтоимостиПослеЗаписи",
		 УплачиваетсяНалогНаИмуществоПоКадастровойСтоимостиПослеЗаписи) Тогда
		
		Если УплачиваетсяНалогНаИмуществоПоКадастровойСтоимостиПередЗаписью <>
			 УплачиваетсяНалогНаИмуществоПоКадастровойСтоимостиПослеЗаписи Тогда
			ОбновитьИнтерфейс();
		КонецЕсли;
...
Процедура НалоговаяБазаПриИзменении(Элемент)
	...
	Если Запись.НалоговаяБаза = ПредопределенноеЗначение("Перечисление.НалоговаяБазаПоНалогуНаИмущество.КадастроваяСтоимость") Тогда
		...
		ВосстановитьЗначениеРеквизитаФормы("ОснованиеЛьготы", Запись, СтруктураСохраняемыхРеквизитов);
	...
	Иначе
		...
		Если ВидЛьготыНалогНаИмущество = ПредопределенноеЗначение("Перечисление.ВидыЛьготПоИмущественнымНалогам.СнижениеНалоговойБазыНаСумму") Тогда
			// Льгота возможна только для кадастровой стоимости
			СохранитьЗначениеРеквизитаФормы("ОснованиеЛьготы", ЭтотОбъект, Запись, СтруктураСохраняемыхРеквизитов);
		КонецЕсли;
		Запись.КодВидаИмущества = "03";
	КонецЕсли;
	
	УстановитьПараметрыВыбораЛьготы(ЭтотОбъект);
	УправлениеФормой(ЭтотОбъект);
...
Процедура НалоговаяСтавкаПриИзменении(Элемент)
	...
	Если ЗначениеЗаполнено(Запись.ОснованиеЛьготы) 
		 И ВидЛьготыНалогНаИмущество = ПредопределенноеЗначение("Перечисление.ВидыЛьготПоИмущественнымНалогам.СнижениеСтавкиНаПроцент") Тогда
		Запись.СниженнаяНалоговаяСтавка = Запись.НалоговаяСтавка * (100 - ПроцентУменьшенияСтавкиНалогаНаИмущество) / 100;
	КонецЕсли;	
...
Процедура ОснованиеЛьготыПриИзменении(Элемент)
	...
	Если Не ЗначениеЗаполнено(Запись.ОснованиеЛьготы) Тогда
		СохранитьЗначениеРеквизитаФормы("СниженнаяНалоговаяСтавка", ЭтотОбъект, Запись, СтруктураСохраняемыхРеквизитов);
		СохранитьЗначениеРеквизитаФормы("СуммаУменьшения", ЭтотОбъект, Запись, СтруктураСохраняемыхРеквизитов);
	ИначеЕсли ВидЛьготыНалогНаИмущество = ПредопределенноеЗначение("Перечисление.ВидыЛьготПоИмущественнымНалогам.Освобождение") Тогда
		СохранитьЗначениеРеквизитаФормы("СниженнаяНалоговаяСтавка", ЭтотОбъект, Запись, СтруктураСохраняемыхРеквизитов);
		СохранитьЗначениеРеквизитаФормы("СуммаУменьшения", ЭтотОбъект, Запись, СтруктураСохраняемыхРеквизитов);
	ИначеЕсли ВидЛьготыНалогНаИмущество = ПредопределенноеЗначение("Перечисление.ВидыЛьготПоИмущественнымНалогам.СнижениеСтавкиНаПроцент") Тогда
		СохранитьЗначениеРеквизитаФормы("СниженнаяНалоговаяСтавка", ЭтотОбъект, Запись, СтруктураСохраняемыхРеквизитов);
		СохранитьЗначениеРеквизитаФормы("СуммаУменьшения", ЭтотОбъект, Запись, СтруктураСохраняемыхРеквизитов);
		Запись.СниженнаяНалоговаяСтавка = Запись.НалоговаяСтавка * (100 - ПроцентУменьшенияСтавкиНалогаНаИмущество) / 100;
	ИначеЕсли ВидЛьготыНалогНаИмущество = ПредопределенноеЗначение("Перечисление.ВидыЛьготПоИмущественнымНалогам.СнижениеСтавкиДоУказанной") Тогда
		СохранитьЗначениеРеквизитаФормы("СуммаУменьшения", ЭтотОбъект, Запись, СтруктураСохраняемыхРеквизитов);
		ВосстановитьЗначениеРеквизитаФормы("СниженнаяНалоговаяСтавка", Запись, СтруктураСохраняемыхРеквизитов);
	ИначеЕсли ВидЛьготыНалогНаИмущество = ПредопределенноеЗначение("Перечисление.ВидыЛьготПоИмущественнымНалогам.СнижениеСуммыНаПроцент") Тогда
		СохранитьЗначениеРеквизитаФормы("СниженнаяНалоговаяСтавка", ЭтотОбъект, Запись, СтруктураСохраняемыхРеквизитов);
		СохранитьЗначениеРеквизитаФормы("СуммаУменьшения", ЭтотОбъект, Запись, СтруктураСохраняемыхРеквизитов);
	ИначеЕсли ВидЛьготыНалогНаИмущество = ПредопределенноеЗначение("Перечисление.ВидыЛьготПоИмущественнымНалогам.СнижениеСуммыНаСумму") Тогда
		СохранитьЗначениеРеквизитаФормы("СниженнаяНалоговаяСтавка", ЭтотОбъект, Запись, СтруктураСохраняемыхРеквизитов);
		ВосстановитьЗначениеРеквизитаФормы("СуммаУменьшения", Запись, СтруктураСохраняемыхРеквизитов);
	КонецЕсли;
...
Процедура ОснованиеЛьготыРасширеннаяПодсказкаОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	СтавкиНалогаНаИмуществоФормыКлиент.ОснованиеЛьготыРасширеннаяПодсказкаОбработкаНавигационнойСсылки(
		ЭтотОбъект, "Запись", СтандартнаяОбработка);
...
Процедура УправлениеФормой(Форма)
	...
	ПрименяетсяЛьгота = ЗначениеЗаполнено(Объект.Организация) И ЗначениеЗаполнено(Объект.ОсновноеСредство) И ЗначениеЗаполнено(Объект.ОснованиеЛьготы);
	...
	Элементы.СуммаУменьшения.Видимость = (Форма.ВидЛьготыНалогНаИмущество = ПредопределенноеЗначение("Перечисление.ВидыЛьготПоИмущественнымНалогам.СнижениеСуммыНаСумму"));
	...
	Элементы.ГруппаПараметрыРегистрации.Видимость = Не Объект.НеПодлежитНалогообложению;
...
Процедура СохранитьЗначениеРеквизитаФормы(ИмяРеквизита, Форма, Данные, СтруктураРеквизитов)
	...
	Если Не Форма.Элементы[ИмяРеквизита].Видимость Или Не Форма.Элементы[ИмяРеквизита].Доступность Тогда
		Возврат;
	КонецЕсли;
...
Процедура ЗаполнитьДанныеПоОсновномуСредству()
	...
	|	СтавкиНалогаНаИмуществоПоОтдельнымОсновнымСредствамСрезПоследних.НеПодлежитНалогообложению,
	...
	|	СтавкиНалогаНаИмуществоПоОтдельнымОсновнымСредствамСрезПоследних.ОснованиеЛьготы,
	|	СтавкиНалогаНаИмуществоПоОтдельнымОсновнымСредствамСрезПоследних.НачалоДействияЛьготы,
	|	СтавкиНалогаНаИмуществоПоОтдельнымОсновнымСредствамСрезПоследних.ОкончаниеДействияЛьготы,
	|	СтавкиНалогаНаИмуществоПоОтдельнымОсновнымСредствамСрезПоследних.СуммаУменьшения
	|ИЗ
...
Процедура ЗаполнитьПараметрыЛьготы()
	...
	СтавкиНалогаНаИмуществоФормы.ЗаполнитьПараметрыЛьготы(ЭтотОбъект);
...
Процедура УстановитьТекстПодсказкиЛьготы()
	...
	СтавкиНалогаНаИмуществоФормы.УстановитьТекстПодсказкиЛьготы(ЭтотОбъект);
			
КонецПроцедуры

&НаКлиентеНаСервереБезКонтекста
Процедура УстановитьПараметрыВыбораЛьготы(Форма)
	
	ПараметрыВыбора = Новый Массив;
	ПараметрыВыбора.Добавить(Новый ПараметрВыбора(
		"Отбор.Налог",
		ПредопределенноеЗначение("Перечисление.ВидыИмущественныхНалогов.НалогНаИмущество")));
	...
	Если Форма.Запись.НалоговаяБаза = ПредопределенноеЗначение("Перечисление.НалоговаяБазаПоНалогуНаИмущество.КадастроваяСтоимость") Тогда
	...
	Форма.Элементы.ОснованиеЛьготы.ПараметрыВыбора = Новый ФиксированныйМассив(ПараметрыВыбора);
