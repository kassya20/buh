...
Процедура СформироватьТаблицуМаркированныхТоваровОснований(Запрос, ИмяВременнойТаблицыСКолонкойДокументОснование)
	...
	|			ИЛИ Товары.Ссылка.ВидПродукции = ЗНАЧЕНИЕ(Перечисление.ВидыПродукцииИС.ЛегкаяПромышленность2026)
	...
	|			ИЛИ Товары.Ссылка.ВидПродукции = ЗНАЧЕНИЕ(Перечисление.ВидыПродукцииИС.СпортивноеПитание)
	...
	|			ИЛИ Товары.Ссылка.ВидПродукции = ЗНАЧЕНИЕ(Перечисление.ВидыПродукцииИС.НапиткиССодержаниемМолокаКакаоПрочие)
...
Функция НастройкиУдаленияНеиспользованныхКодовМаркировки()
	...
	Строка = ТаблицаНастроек.Добавить();
	Строка.ВидПродукции = Перечисления.ВидыПродукцииИС.СпортивноеПитание;
	Строка.ДатаЭмиссии  = СрокХранения;
	...
	Строка = ТаблицаНастроек.Добавить();
	Строка.ВидПродукции = Перечисления.ВидыПродукцииИС.СоковаяПродукция;
	Строка.ДатаЭмиссии  = СрокХранения;
	
	Строка = ТаблицаНастроек.Добавить();
	Строка.ВидПродукции = Перечисления.ВидыПродукцииИС.БезалкогольныеНапитки;
	Строка.ДатаЭмиссии  = СрокХранения;
	
	Строка = ТаблицаНастроек.Добавить();
	Строка.ВидПродукции = Перечисления.ВидыПродукцииИС.НапиткиССодержаниемМолокаКакаоПрочие;
	Строка.ДатаЭмиссии  = СрокХранения;
	
	Строка = ТаблицаНастроек.Добавить();
	Строка.ВидПродукции = Перечисления.ВидыПродукцииИС.Велосипеды;
	Строка.ДатаЭмиссии  = СрокХранения;
	
	Строка = ТаблицаНастроек.Добавить();
	Строка.ВидПродукции = Перечисления.ВидыПродукцииИС.КормаДляЖивотныхБезВЕТИС;
	Строка.ДатаЭмиссии  = СрокХранения;
	
	Строка = ТаблицаНастроек.Добавить();
	Строка.ВидПродукции = Перечисления.ВидыПродукцииИС.КормаДляЖивотныхПодконтрольныеВЕТИС;
	Строка.ДатаЭмиссии  = СрокХранения;
	
	Строка = ТаблицаНастроек.Добавить();
	Строка.ВидПродукции = Перечисления.ВидыПродукцииИС.КормаДляЖивотныхВлажныеБезВЕТИС;
	Строка.ДатаЭмиссии  = СрокХранения;
	
	Строка = ТаблицаНастроек.Добавить();
	Строка.ВидПродукции = Перечисления.ВидыПродукцииИС.КормаДляЖивотныхВлажныеПодконтрольныеВЕТИС;
	Строка.ДатаЭмиссии  = СрокХранения;
	
	Строка = ТаблицаНастроек.Добавить();
	Строка.ВидПродукции = Перечисления.ВидыПродукцииИС.КонсервированнаяПродукцияБезВЕТИС;
	Строка.ДатаЭмиссии  = СрокХранения;
	
	Строка = ТаблицаНастроек.Добавить();
	Строка.ВидПродукции = Перечисления.ВидыПродукцииИС.КонсервированнаяПродукцияПодконтрольнаяВЕТИС;
	Строка.ДатаЭмиссии  = СрокХранения;
	
	Строка = ТаблицаНастроек.Добавить();
	Строка.ВидПродукции = Перечисления.ВидыПродукцииИС.РастительныеМасла;
	Строка.ДатаЭмиссии  = СрокХранения;
	
	Строка = ТаблицаНастроек.Добавить();
	Строка.ВидПродукции = Перечисления.ВидыПродукцииИС.ВетеринарныеПрепараты;
	Строка.ДатаЭмиссии  = СрокХранения;
	
	Строка = ТаблицаНастроек.Добавить();
	Строка.ВидПродукции = Перечисления.ВидыПродукцииИС.РадиоэлектроннаяПродукция;
	Строка.ДатаЭмиссии  = СрокХранения;
	
	Строка = ТаблицаНастроек.Добавить();
	Строка.ВидПродукции = Перечисления.ВидыПродукцииИС.ТелефоныИНоутбуки;
	Строка.ДатаЭмиссии  = СрокХранения;
	
	Строка = ТаблицаНастроек.Добавить();
	Строка.ВидПродукции = Перечисления.ВидыПродукцииИС.ПечатныеПлаты;
	Строка.ДатаЭмиссии  = СрокХранения;
	
	Строка = ТаблицаНастроек.Добавить();
	Строка.ВидПродукции = Перечисления.ВидыПродукцииИС.Бакалея;
	Строка.ДатаЭмиссии  = СрокХранения;
	
	Строка = ТаблицаНастроек.Добавить();
	Строка.ВидПродукции = Перечисления.ВидыПродукцииИС.РастворимыеЗавариваемыеНапитки;
	Строка.ДатаЭмиссии  = СрокХранения;
	
	Строка = ТаблицаНастроек.Добавить();
	Строка.ВидПродукции = Перечисления.ВидыПродукцииИС.МоторныеМасла;
	Строка.ДатаЭмиссии  = СрокХранения;
	...
	Строка = ТаблицаНастроек.Добавить();
	Строка.ВидПродукции = Перечисления.ВидыПродукцииИС.БезалкогольноеПиво;
	Строка.ДатаЭмиссии  = СрокХранения;
	
	Строка = ТаблицаНастроек.Добавить();
	Строка.ВидПродукции = Перечисления.ВидыПродукцииИС.ПарфюмерныеИКосметическиеСредстваИБытоваяХимия;
	Строка.ДатаЭмиссии  = СрокХранения;
	
	Строка = ТаблицаНастроек.Добавить();
	Строка.ВидПродукции = Перечисления.ВидыПродукцииИС.ТоварыЛичнойГигиены;
	Строка.ДатаЭмиссии  = СрокХранения;
	
	Строка = ТаблицаНастроек.Добавить();
	Строка.ВидПродукции = Перечисления.ВидыПродукцииИС.БритвыИЛезвия;
	Строка.ДатаЭмиссии  = СрокХранения;
	...
	Строка = ТаблицаНастроек.Добавить();
	Строка.ВидПродукции = Перечисления.ВидыПродукцииИС.ЛегкаяПромышленность2026;
	Строка.ДатаЭмиссии  = СрокХранения;
...
Функция ДополнитьШаблоныНовыхТоварныхГруппВЗапросе()
	...
	|ИЛИ Товары.Ссылка.ВидПродукции = ЗНАЧЕНИЕ(Перечисление.ВидыПродукцииИС.ТоварыЛичнойГигиены)
	|ИЛИ Товары.Ссылка.ВидПродукции = ЗНАЧЕНИЕ(Перечисление.ВидыПродукцииИС.БритвыИЛезвия)";
	...
	|ИЛИ Товары.Ссылка.ВидПродукции = ЗНАЧЕНИЕ(Перечисление.ВидыПродукцииИС.РастворимыеЗавариваемыеНапитки)";
	...
	Результат = Результат + "
	|КОГДА Товары.Ссылка.ВидПродукции = ЗНАЧЕНИЕ(Перечисление.ВидыПродукцииИС.АвтозапчастиИКомплектующиеТранспортныхСредств)";
	Если ОбщегоНазначенияИСМПКлиентСервер.АвтозапчастиИКомплектующиеТранспортныхСредствИспользуетСтандартныйКМ() Тогда
		Результат = Результат + "
		|	ТОГДА ЗНАЧЕНИЕ(Перечисление.ШаблоныКодовМаркировкиСУЗ.АвтозапчастиИКомплектующиеТранспортныхСредствСтандартныйКМ)";
	Иначе
		Результат = Результат + "
		|	ТОГДА ЗНАЧЕНИЕ(Перечисление.ШаблоныКодовМаркировкиСУЗ.АвтозапчастиИКомплектующиеТранспортныхСредств)";
	КонецЕсли;
	...
	Результат = Результат + "
	|КОГДА Товары.Ссылка.ВидПродукции = ЗНАЧЕНИЕ(Перечисление.ВидыПродукцииИС.ТоварыИзНатуральногоМеха)
	|	ТОГДА ЗНАЧЕНИЕ(Перечисление.ШаблоныКодовМаркировкиСУЗ.ТоварыИзНатуральногоМеха)";
