...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ЗаполнитьИзмерениеСчетФактураВыданныйПокупателю");
	Методы.Вставить("ОчиститьКППКонтрагента");
	Методы.Вставить("ЗаполнитьРесурсДатаСчетаФактурыПоГТД");
