...
Функция ДобавитьЗаписьПравила(Организация, ПлатежноеПоручение, ПравилоНалоговогоПлатежа, ПериодСобытия, ОплатаЗадолженности = Ложь, РегистрацияВНалоговомОргане = Неопределено) Экспорт
...
Функция НовыйСтруктураРегистра()
	...
	Возврат Новый Структура("Организация, ПлатежноеПоручение, Правило, ПериодСобытия, ОплатаЗадолженности, РегистрацияВНалоговомОргане");
