...
Процедура ОбновитьСостояние(Регистратор, ДокументОснование, УдалениеПроведения = Ложь) Экспорт
	...
	ТаблицаЗапросаТоваровВСоставеОС = ТаблицаЗапроса.Скопировать(
		Новый Структура("ВидОперации", Перечисления.ВидыОперацийРегистрацииПрослеживаемыхТоваров.РегистрацияКомплектующихОС));
		
	ТаблицаОС = ТаблицаЗапросаТоваровВСоставеОС.Скопировать(,"ОсновноеСредство");
	ТаблицаОС.Свернуть("ОсновноеСредство");
	
	Для Каждого ТекущееОС Из ТаблицаОС Цикл
		
		Набор = РегистрыСведений.РегистрацияПрослеживаемыхТоваров.СоздатьНаборЗаписей();
		Набор.Отбор.ВидОперации.Установить(Перечисления.ВидыОперацийРегистрацииПрослеживаемыхТоваров.РегистрацияКомплектующихОС);
		Набор.Отбор.ОсновноеСредство.Установить(ТекущееОС.ОсновноеСредство);
		
		НайденныеСтроки = 
			ТаблицаЗапросаТоваровВСоставеОС.НайтиСтроки(Новый Структура("ОсновноеСредство",ТекущееОС.ОсновноеСредство));
