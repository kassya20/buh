...
// Возвращает признак, что это первый год учета после ввода остатков
//
// Параметры:
// Организация - СправочникСсылка.Организация - организация для проверки
// Перид - Дата - проверяемый период
//
// Возвращаемое значение:
// Булево - если первый год, то Истина
//
Функция ЭтоПервыйГодПослеВводаОстатков(Организация, Период) Экспорт
	
	ДатаВводаНачальныхОстатков = ДатаВводаНачальныхОстатков(Организация);
	Возврат ЗначениеЗаполнено(ДатаВводаНачальныхОстатков) И Год(ДатаВводаНачальныхОстатков) = Год(Период) - 1;
