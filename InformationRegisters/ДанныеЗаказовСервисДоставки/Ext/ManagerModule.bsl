...
Функция СписокЗаказовПоОснованию(ПараметрыОтбораЗаказов) Экспорт
	...
	СервисДоставкиПереопределяемый.ПриОпределенииОснованийЗаказаНаДоставку(ДокументОснование);
...
//
// Возвращаемое значение:
// 	Соотвествие Из Число - Количество заказов по документам основаниям.
Функция КоличествоЗаказовПоОснованиям(Источник) Экспорт
	...
	СервисДоставкиПереопределяемый.ПриОпределенииОснованийЗаказаНаДоставку(ДокументыОснования);
	...
	Выборка = Запрос.Выполнить().Выбрать();
	Пока Выборка.Следующий() Цикл
		Результат.Вставить(Выборка.ДокументОснование, Выборка.Количество);
	КонецЦикла;
