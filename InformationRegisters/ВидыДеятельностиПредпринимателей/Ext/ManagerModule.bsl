...
//
// Параметры:
//   ВидДеятельности - СправочникСсылка.ВидыДеятельностиПредпринимателей - вид деятельности
//   ИсключаяХарактерДеятельности - ПеречислениеСсылка.ХарактерДеятельности - характер вида деятельности
//
//
// Возвращаемое значение:
//   Массив из Строка - массив строк оповещений пользователю, в обычной ситуации
...
Функция ОчиститьСписокНоменклатуныхГрупп(ВидДеятельности, ИсключаяХарактерДеятельности) Экспорт
	...
	МенеджерЗаписиРегистра = СоздатьМенеджерЗаписи();
...
Функция ПолучитьВидДеятельности(ХарактерДеятельности, НоменклатурнаяГруппа) Экспорт
	...
	Если Не ЗначениеЗаполнено(НоменклатурнаяГруппа) Или Не ЗначениеЗаполнено(ХарактерДеятельности) Тогда
...
Функция ВидДеятельностиПоУмолчанию(Организация) Экспорт
	...
	Если Не ЗначениеЗаполнено(ХарактерДеятельности) Или Не ЗначениеЗаполнено(НоменклатурнаяГруппа) Тогда
		Возврат Неопределено;
	КонецЕсли;
...
Функция ПолучитьПервуюНоменклатурнуюГруппу(ВидДеятельности, ХарактерДеятельности) Экспорт
	...
	Если Не ЗначениеЗаполнено(ВидДеятельности) Или Не ЗначениеЗаполнено(ХарактерДеятельности) Тогда
		Возврат Неопределено;
	КонецЕсли;
