...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ГруппаБаннер.Видимость = ДетализацияПоВидамДеятельности;
...
Процедура РаспределитьВыручкуНажатие(Элемент)
	...
	ОткрытьФорму("Обработка.КлассификацияВыручкиПоОКВЭД.Форма", ПараметрыФормы, ЭтотОбъект);
...
Процедура ОбработатьРаспределениеВыручкиНаСервере(АдресРаспределениеВыручки)
	...
	НаборЗаписейРегистр = РеквизитФормыВЗначение("НаборЗаписей");
	РегистрыСведений.НастройкиКлассификацииВыручки.ЗаполнитьРаспределениеВыручкиПоОКВЭД(
		АдресРаспределениеВыручки, Организация, ОбъектНаблюдения,, СообщенияОбОшибках, НаборЗаписейРегистр);
	ЗначениеВРеквизитФормы(НаборЗаписейРегистр, "НаборЗаписей");
