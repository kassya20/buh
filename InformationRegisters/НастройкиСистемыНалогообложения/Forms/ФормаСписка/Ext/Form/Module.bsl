...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Список.Параметры.УстановитьЗначениеПараметра("ДатаНачалаДействияПатентнойСистемы",
		УчетПСН.ДатаНачалаДействияПатентнойСистемы());
	...
	Список.Параметры.УстановитьЗначениеПараметра("ПредставлениеЕНВД", НСтр("ru = 'ЕНВД (до конца 2020 года)'"));
	Список.Параметры.УстановитьЗначениеПараметра("ПредставлениеУСНДоходы", НСтр("ru = 'УСН (доходы)'"));
	Список.Параметры.УстановитьЗначениеПараметра("ПредставлениеУСНДоходыМинусРасходы", НСтр("ru = 'УСН (доходы минус расходы)'"));
	Список.Параметры.УстановитьЗначениеПараметра("ПредставлениеАУСНДоходы", НСтр("ru = 'Автоматизированная УСН (доходы)'"));
	Список.Параметры.УстановитьЗначениеПараметра("ПредставлениеАУСНДоходыМинусРасходы", НСтр("ru = 'Автоматизированная УСН (доходы минус расходы)'"));
...
Процедура УправлениеФормой(Форма)
	...
	Если Элементы.ГруппаОтборОрганизация.Видимость Тогда
	...
	Иначе
		ИспользоватьДатуИзменения = НастройкиСистемыНалогообложенияФормыВызовСервера.ИспользуетсяДатаИзменения(Неопределено);
	КонецЕсли;
