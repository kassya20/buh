...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ЗагрузитьСтавкиИзСервисаКлассификаторов", Истина);
...
Процедура ПриЗагрузкеКлассификатора(Идентификатор, Версия, Адрес, Обработан) Экспорт
	...
	ТаблицаРегионов = АдресныйКлассификаторБП.РегионыРФ();  // вспомогательная таблица для вывода наименования региона в сообщениях
