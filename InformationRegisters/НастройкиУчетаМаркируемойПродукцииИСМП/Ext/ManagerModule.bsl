...
Функция ДатыРаздельногоКонтроляМаркируемойПродукцииПоУмолчанию(ВидМаркируемойПродукции) Экспорт
	...
	ИначеЕсли ВидМаркируемойПродукции = Перечисления.ВидыПродукцииИС.ЛегкаяПромышленность2026 Тогда
		
		СтруктураДат.ДатаЗапретПродажиНемаркированныхОстатков = Дата(2026, 08, 01);
		СтруктураДат.ДатаКонтрольПроизводства                 = Дата(2026, 03, 01);
		СтруктураДат.ДатаРозницаУведомительныйРежим           = Дата(2026, 03, 01);
	...
	ИначеЕсли ВидМаркируемойПродукции = Перечисления.ВидыПродукцииИС.ТелефоныИНоутбуки Тогда
		...
		СтруктураДат.ДатаКонтрольПроизводства                 = Дата(2026, 05, 01);
		СтруктураДат.ДатаЗапретПродажиНемаркированныхОстатков = Дата(2026, 12, 01);
		СтруктураДат.ДатаКонтрольВыводИзОборота               = Дата(2027, 03, 01);
	...
	ИначеЕсли ВидМаркируемойПродукции = Перечисления.ВидыПродукцииИС.ТоварыИзНатуральногоМеха Тогда
