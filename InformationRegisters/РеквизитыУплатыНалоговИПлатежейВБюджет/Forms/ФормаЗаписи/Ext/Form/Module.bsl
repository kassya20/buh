...
Процедура ЗаполнитьСпискиРеквизитовПлатежейВБюджет()
	...
	ЗаполнитьСписокВыбора(
		...
		ПлатежиВБюджетКлиентСервер.СтатусыПлательщика(РабочаяДатаСеанса));
	
	ЗаполнитьСписокВыбора(
		Элементы.ПоказательОснования,
		ПлатежиВБюджетКлиентСервер.ОснованияПлатежа(Перечисления.ВидыПеречисленийВБюджет.НалоговыйПлатеж, РабочаяДатаСеанса));
	
	ЗаполнитьСписокВыбора(
		Элементы.ПоказательОснованияТаможня,
		ПлатежиВБюджетКлиентСервер.ОснованияПлатежа(Перечисления.ВидыПеречисленийВБюджет.ТаможенныйПлатеж, РабочаяДатаСеанса));
