...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	Если ДополнительныеСвойства.Свойство("УстановитьОсновноеРабочееМесто") Тогда
		...
		РегистрыСведений.ТекущиеКадровыеДанныеСотрудников.УстановитьОсновноеРабочееМестоВОрганизации(ЭтотОбъект, Замещение);
	...
	Если Не ПолучитьФункциональнуюОпцию("ИспользоватьКадровыйУчет")
		И Не КадровыйУчет.НастройкиКадровогоУчета().ИспользуютсяДанныеСотрудниковВнешнихИсточников Тогда
		...
		ИнтеграцияУправлениеПерсоналомСобытия.ТекущиеКадровыеДанныеСотрудниковПередЗаписью(ЭтотОбъект, Замещение);
...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	ИнтеграцияУправлениеПерсоналомСобытия.ТекущиеКадровыеДанныеСотрудниковПриЗаписи(ЭтотОбъект, Замещение);
