...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ОтветственныйЗаВУР.ТолькоПросмотр = ТолькоПросмотр;
	Элементы.ОтветственныйЗаВУРДолжность.ТолькоПросмотр = ТолькоПросмотр;
	
	Элементы.ГруппаВУРФИО.Видимость = ПолучитьФункциональнуюОпцию("ИспользоватьВоинскийУчетБП");
...
&НаКлиенте
Процедура ОтветственныйЗаВУРДолжностьПриИзменении(Элемент)
	
	ИзмененОтветственныйЗаВУР = истина;
...
&НаКлиенте
Процедура ОтветственныйЗаВУРПриИзменении(Элемент)
	
	ИзмененОтветственныйЗаВУР = истина;
	
	ЭтотОбъект.Модифицированность = Истина;
	
	Если ЗначениеЗаполнено(ОтветственныйЗаВУРФизЛицо) тогда
		
		ДанныеФизЛица = ОбщегоНазначенияБПВызовСервера.ДанныеФизЛица(Организация, ОтветственныйЗаВУРФизЛицо, ТекущаяДата());
		ОтветственныйЗаВУРДолжность = ДанныеФизЛица.Должность;
...
&НаКлиенте
Процедура ДекорацияОтветственныйЗаВУРИсторияНажатие(Элемент)
	
	ДекорацияИсторияНажатие(Элемент,"ОтветственныйЗаВУР");
...
&НаКлиенте
Процедура ОтветственныйЗаВУРДолжностьАвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ОтветственныйЗаВУРДолжностьОкончаниеВводаТекста(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ОтветственныйЗаВУРДолжностьОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
...
Процедура ОбновитьОтветственныхЛиц()
	...
	ОтветственныйЗаВУРКлючЗаписи						= РегистрыСведений.ОтветственныеЛицаОрганизаций.ПустойКлюч();
	...
	|			ТОГДА ""Исполнитель""
	|		КОГДА ОтветственныеЛицаОрганизацийСрезПоследних.ОтветственноеЛицо = ЗНАЧЕНИЕ(Перечисление.ОтветственныеЛицаОрганизаций.ОтветственныйЗаВУР)
	|			ТОГДА ""ОтветственныйЗаВУР""
	|		ИНАЧЕ """"
	...
	|			ИЛИ ОтветственныеЛицаОрганизацийСрезПоследних.ОтветственноеЛицо = ЗНАЧЕНИЕ(Перечисление.ОтветственныеЛицаОрганизаций.ОтветственныйЗаВУР))";
...
Процедура ЗаписатьОтветственныхНаСервере()
	...
	Если ИзмененОтветственныйЗаВУР Тогда
		
		ЗаписатьНаборЗаписейИсторииДолжностныхЛиц("ОтветственныйЗаВУР", Организация, НЕ ЗначениеЗаполнено(ОтветственныйЗаВУРКлючЗаписи.период));
	КонецЕсли;
