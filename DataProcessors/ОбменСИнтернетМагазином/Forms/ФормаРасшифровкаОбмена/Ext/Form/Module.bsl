...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		...
		Если ЗагружатьОнлайнОплаты Тогда
			...
			ДанныеОнлайнОплат = РезультатОбмена.СтатистикаЗагрузки.ОнлайнОплаты;
			
			Элементы.ДекорацияОплаты.Заголовок = СтрШаблон(НСтр("ru = 'Обработано онлайн-оплат: %1'"), ДанныеОнлайнОплат.Обработано);
			
			ЗаполнитьСписокДокументовНаФорме(СписокСостоянийОплат, ДанныеОнлайнОплат.Создано,   "Создана");
			ЗаполнитьСписокДокументовНаФорме(СписокСостоянийОплат, ДанныеОнлайнОплат.Обновлено, "Обновлена");
			ЗаполнитьСписокПропущенныхДокументовНаФорме(СписокСостоянийОплат, ДанныеОнлайнОплат.Пропущено, "Пропущена");
