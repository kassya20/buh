...
Функция ЗаполнитьПоВедомости()
	...
	СтруктураОбъекта.Вставить("РежимПомощника",                Параметры.РежимПомощника);
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ИспользоватьСтатьиДвиженияДенежныхСредств Тогда
		...
		Объект.СтатьяДвиженияДенежныхСредств = УчетДенежныхСредствБП.СтатьяДДСПоУмолчанию(КонтекстОперации, Объект.ДатаРКО);
	КонецЕсли;
	...
	Элементы.ПлатежнаяВедомость.ТолькоПросмотр = Параметры.РежимПомощника;
