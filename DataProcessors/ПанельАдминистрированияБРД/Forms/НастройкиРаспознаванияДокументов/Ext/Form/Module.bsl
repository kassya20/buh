...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДоступноРаспознаваниеЧеков = Истина;
	РаспознаваниеДокументовПереопределяемый.ДоступноРаспознаваниеЧеков(ДоступноРаспознаваниеЧеков);
	
	Элементы.АвтоматическиРегистрироватьЧеки.Видимость = ДоступноРаспознаваниеЧеков;
...
&НаКлиенте
Процедура ОткрыватьСозданныйДокументДляПроверкиПриИзменении(Элемент)
...
&НаКлиенте
Процедура АвтоматическиУстанавливатьОригиналПолученПриИзменении(Элемент)
			...
			Если ОбщегоНазначения.РазделениеВключено() И ТипАутентификации = "ПоТикетуИТС" Тогда
				...
				СостояниеПодключенияРаспознавания = 
					НСтр("ru = 'Используется учетная запись Портала 1С:ИТС.
					           ...
					           |Укажите свой e-mail и мы уведомим вас по факту подключения.'");
