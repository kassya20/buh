...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Отключим видимость этой группы, т.к. настраивать почтовый клиент не нужно.
...
Процедура ИспользоватьБизнесПроцессыИЗадачиПриИзменении(Элемент)
	...
	СохранитьНастройкуИнформационнойПанели();
...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если (РеквизитПутьКДанным = "НаборКонстант.ИспользоватьБизнесПроцессыИЗадачи" ИЛИ РеквизитПутьКДанным = "")
		...
		МоиЗадачи.ИспользоватьБизнесПроцессыИЗадачиПриИзменении(ЭтотОбъект);
...
&НаСервере
Процедура СохранитьНастройкуИнформационнойПанели()
	
	Если НаборКонстант.ИспользоватьБизнесПроцессыИЗадачи Тогда
		МоиЗадачи.ВключитьБлокМоиЗадачиДляВсехПользователей();
	КонецЕсли;
