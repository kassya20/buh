...
Процедура ТоварыСодержаниеПриИзменении(Элемент)
	...
	РаботаСНоменклатуройКлиентБП.СодержаниеПриИзменении(ТекущиеДанные, ДокументДата);
КонецПроцедуры
...
&НаКлиенте
Процедура ТоварыЕдиницаИзмеренияУпаковкаНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
...
Процедура ПослеВыбораУпаковкиЕдиницыИзмерения(ВыбранныйЭлемент, ДополнительныеПараметры) Экспорт
	...
	УпаковкиКлиент.ТоварыУпаковкаПриИзменении(ЭтаФорма);
...
Процедура ТоварыСуммаПриИзменении(Элемент)
	...
	УпаковкиКлиент.ТоварыСуммаПриИзменении(СтрокаТабличнойЧасти, Объект);
...
Процедура ПодготовитьФормуНаСервере()
	...
	Элементы.ТоварыГруппаКоличествоУпаковок.Видимость 	= ИспользуютсяУпаковки;
	Элементы.ТоварыЦенаЗаУпаковку.Видимость 			= ИспользуютсяУпаковки;
    Элементы.ТоварыГруппаКоличество.Видимость 			= Не ИспользуютсяУпаковки;
	Элементы.ТоварыЦена.Видимость 						= Не ИспользуютсяУпаковки;
...
Процедура ДобавитьДанныеИзДокумента(ДокументИсточник, ИмяТаблицыИсточника)
	...
	Для Каждого СтрокаТовара ИЗ ТаблицаТоваровДокумента Цикл
		...
		Иначе
			...
			Если ТипЗнч(ДокументИсточник) = Тип("ДокументСсылка.СчетНаОплатуПокупателю") Тогда
				НоваяСтрока.СчетНаОплатуПокупателю = ДокументИсточник;
			КонецЕсли; 
...
&НаСервере
Процедура ПересчитатьКоличествоЦенуУпаковкиНаСервере()
	
	Для Каждого СтрокаТовары Из Объект.Товары Цикл
		СтрокаТовары.КоличествоУпаковок = Окр(СтрокаТовары.Количество / СтрокаТовары.КоэффициентУпаковки, 3);
