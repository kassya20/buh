...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("СоздатьИнвентаризациюОбОстаткахВФоне", Истина);
	Методы.Вставить("ДанныеЗаполненияПомощникаПолученияРНПТ", Истина);
	Методы.Вставить("ЗаписьПолученныхРНПТВФоне", Истина);
	Методы.Вставить("СоздатьКорректировочныеУведомленияВФоне", Истина);
	Методы.Вставить("СоздатьУведомленияПоТоварамВФоне", Истина);
	Методы.Вставить("СоздатьУведомленияПоОСВФоне", Истина);
	Методы.Вставить("СоздатьИнвентаризациюОСОбОстаткахВФоне", Истина);
