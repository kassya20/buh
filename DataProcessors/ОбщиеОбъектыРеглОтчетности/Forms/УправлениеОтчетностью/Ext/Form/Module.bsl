...
Процедура ОбработатьАктивизациюСтрокиОсновнойТаблицы()
	...
	ИсточникиОтчетовЗаявление.Добавить("РегламентированныйОтчетОценочнаяКартаУБ");
	...
	ИсточникиОтчетовПредставление.Добавить("РегламентированныйОтчетДеятельностьИнОргВРФ");
	...
	ИсточникиОтчетовФСГС.Добавить("РегламентированныйОтчетСтатистикаФорма1Лицензия");
	ИсточникиОтчетовФСГС.Добавить("РегламентированныйОтчетСтатистикаФорма1ППриложениеТЗВ");
	ИсточникиОтчетовФСГС.Добавить("РегламентированныйОтчетСтатистикаФорма1ИПторговля");
...
Процедура ПоказатьСДвухмернымШтрихкодомPDF417(Команда)
	...
	Если Элементы.ЖурналОтчетов.ТекущиеДанные.НаименованиеОтчета = "Декларация по водному налогу"
		И ОписаниеРегОтчета(Элементы.ЖурналОтчетов.ТекущаяСтрока).ВыбраннаяФорма = "ФормаОтчета2026Кв2" Тогда
		ПоказатьПредупреждение(, НСтр(
