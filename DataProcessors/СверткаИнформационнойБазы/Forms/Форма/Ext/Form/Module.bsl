...
Процедура ПриОткрытии(Отказ)
	...
	Если ОбщегоНазначенияКлиентСервер.ЭтоLinuxКлиент() Тогда
		...
		Элементы.СоздатьРезервнуюКопию.Доступность = Ложь;
		Элементы.ДекорацияLinux.Видимость = Истина;
...
Функция ПроверитьДоступКИБ()
	...
	Попытка
		#Если МобильныйКлиент Тогда
			...
			ВызватьИсключение НСтр("ru = 'Функциональность недоступна в мобильном клиенте'");
		#Иначе
