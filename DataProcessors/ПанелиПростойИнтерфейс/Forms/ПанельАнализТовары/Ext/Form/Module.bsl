...
Процедура АдаптироватьМКШапкаФормы()
	...
	ИменаДоступныхЭлементов = "ОтчетДвижениеТоваровКомандаДвижениеТоваров,ОтчетОборачиваемостьТоваровКомандаОборачиваемостьТоваров,
	|ОтчетОстаткиТоваровКомандаОстаткиТоваров,ОтчетОстаткиТоваровПоСрокамХраненияКомандаОстаткиТоваровПоСрокамХранения";
