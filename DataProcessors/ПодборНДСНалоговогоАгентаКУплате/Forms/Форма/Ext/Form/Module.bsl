...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьЗначенияСвойств(ЭтотОбъект, Параметры,
		"ДатаДокумента,Организация,АдресТаблицыНалоговыйАгентНДСВХранилище,СуммаПоПлатежномуПоручению,ДокументСсылка,СчетУчета,ОграничитьПериодОсмотра");
...
Процедура ЗаполнитьЗадолженностьНаСервере()
	...
	РеквизитыДокумента = Новый Структура(
		"Организация,ДатаДокумента,ТекущийДокумент,СчетУчета,ОграничитьПериодОсмотра", 
		ЭтотОбъект.Организация, ЭтотОбъект.ДатаДокумента, ЭтотОбъект.ДокументСсылка, ЭтотОбъект.СчетУчета, Ложь);
