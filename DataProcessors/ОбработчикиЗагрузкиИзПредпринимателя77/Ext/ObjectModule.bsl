...
Процедура Конвертация_ПередЗагрузкойДанных(ФайлОбмена, Отказ) Экспорт
	...
	НаборКонстант = Константы.СоздатьНабор("ИспользоватьВыпускПродукции, ВедетсяПроизводственнаяДеятельность, ВедетсяРозничнаяТорговля, ИспользуетсяНДФЛИП, 
		|ИспользуетсяУСН, ИспользуетсяУСНПатент, ОсуществляетсяРеализацияТоваровУслугКомитентов, 
		|ОсуществляетсяРеализацияТоваровУслугЧерезКомиссионеров, ИспользуетсяЕНВД, ИспользоватьНесколькоСкладов, ИспользоватьТипыЦенНоменклатуры, ИспользоватьНесколькоНоменклатурныхГрупп");
