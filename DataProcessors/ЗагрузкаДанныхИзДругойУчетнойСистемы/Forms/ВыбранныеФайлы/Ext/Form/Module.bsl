...
Процедура ОбработкаВыбораФайла(Результат, ДополнительныеПараметры) Экспорт
	...
	СостояниеФормы = ВсеСостоянияФормы().ВыборФайла;
...
Процедура УправлениеФормой()
	...
	Если СостояниеФормы = Состоянияформы.Ожидание Тогда
		Элементы.СтраницыФормы.ТекущаяСтраница = Элементы.СтраницаОжидание;
	Иначе
		Элементы.СтраницыФормы.ТекущаяСтраница = Элементы.СтраницаВыборФайла;
	КонецЕсли;
...
Функция ВсеСостоянияФормы()
	...
	Результат.Вставить("ВыборФайла", "ВыборФайла");
