...
Процедура ВыполнитьПеренумерацию(Параметры, АдресРезультата) Экспорт
	...
	// Принудительно выполним обновление нумерации, чтобы последующие документы учитывали результаты текущей перенумерации.
	УстановитьПривилегированныйРежим(Истина);
	ОбновитьНумерациюОбъектов(Метаданные.НайтиПоПолномуИмени(ВидДокументов));
