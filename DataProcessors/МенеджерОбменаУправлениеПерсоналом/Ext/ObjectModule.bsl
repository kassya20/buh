...
Процедура ЗаполнитьТипОбъектаАдресРесурса()
	...
	Описание.Вставить(МенеджерТипОбъекта.ПодразделениеОрганизации, 				РесурсПодразделенияОрганизаций());
	...
	Описание.Вставить(МенеджерТипОбъекта.ИнформацияОСредствахИЗ,				РесурсИнформацияОСИЗ());
	Описание.Вставить(МенеджерТипОбъекта.Антропометрия,							РесурсАнтропометрия());
	Описание.Вставить(МенеджерТипОбъекта.ГрафикОтпусковПоРабочимМестам, 		РесурсГрафикОтпусковПоРабочимМестам());
	Описание.Вставить(МенеджерТипОбъекта.ЛичныйКабинет, 						РесурсЛичныеКабинеты());
	Описание.Вставить(МенеджерТипОбъекта.ВидЛичногоКабинета, 					РесурсЛичныеКабинеты());
	Описание.Вставить(МенеджерТипОбъекта.ВидДокументаЭДО, 						РесурсВидыДокументовЭДОБЗК());
	Описание.Вставить(МенеджерТипОбъекта.ДоступностьПриложения, 				РесурсДоступностьПриложения());
...
Процедура ЗаполнитьТипОбъектаАдресРесурсаЗапрос()
	...
	Описание.Вставить(МенеджерТипОбъекта.ЗаявкаНаИзменениеГрафикаОтпуска,		РесурсЗапросИзменениеГрафикаОтпусков());
	Описание.Вставить(МенеджерТипОбъекта.ЗаявкаИсполнениеГособязанностей,		РесурсЗапросЗаявкаИсполнениеГособязанностей());
	Описание.Вставить(МенеджерТипОбъекта.ЗаявкаВыходныеДляУходаЗаДетьмиИнвалидами, РесурсЗапросЗаявкаВыходныеДляУходаЗаДетьмиИнвалидами());
	Описание.Вставить(МенеджерТипОбъекта.ЗаявлениеНаКомандировку, 			РесурсЗапросЗаявлениеНаКомандировку());
	Описание.Вставить(МенеджерТипОбъекта.ОтчетОбИтогахКомандировки, 		РесурсЗапросОтчетОбИтогахКомандировки());
	Описание.Вставить(МенеджерТипОбъекта.ОтчетОРасходахВКомандировке,		РесурсЗапросОтчетРасходыКомандировки());
	Описание.Вставить(МенеджерТипОбъекта.ЗаявлениеВПроизвольнойФорме,		РесурсЗапросЗаявлениеВПроизвольнойФорме());
	Описание.Вставить(МенеджерТипОбъекта.ЗаявлениеОСпособеВыплатыЗарплаты,	РесурсЗапросЗаявлениеОСпособеВыплатыЗарплаты());
...
Процедура ОбновитьВерсиюDTO() Экспорт
...
Процедура ЗаполнитьАдресаРесурсовШаблонов()
	...
	АдресаРесурсовШаблонов.Вставить("ИзменениеГрафикаОтпусков", 						РесурсШаблонДокументаЗаявлениеНаИзменениеГрафикаОтпуска());
	АдресаРесурсовШаблонов.Вставить("ЗаявлениеНаИсполнениеГособязанностей", 			РесурсШаблонДокументаЗаявкаИсполнениеГособязанностей());
	АдресаРесурсовШаблонов.Вставить("ЗаявлениеВыходныеДляУходаЗаДетьмиИнвалидами", 		РесурсШаблонДокументаЗаявкаВыходныеДляУходаЗаДетьмиИнвалидами());
	АдресаРесурсовШаблонов.Вставить("ЗаявлениеНаКомандировку", 			РесурсШаблонДокументаЗаявлениеНаКомандировку());
	АдресаРесурсовШаблонов.Вставить("ОтчетПоКомандировке", 				РесурсШаблонОтчетаПоКомандировке());
	АдресаРесурсовШаблонов.Вставить("ОтчетРасходыВКомандировке", 		РесурсШаблонОтчетаРасходыКомандировки());
	АдресаРесурсовШаблонов.Вставить("ЗаявлениеВПроизвольнойФорме", 		РесурсШаблонЗаявлениеВПроизвольнойФорме());
	АдресаРесурсовШаблонов.Вставить("ЗаявлениеОСпособеВыплатыЗарплаты", РесурсШаблонЗаявлениеОСпособеВыплатыЗарплаты());
...
Функция ВсеРесурсы() Экспорт
	...
	Если ИспользуетсяВерсия("2.3") Тогда
		...
		ВсеРесурсы.Добавить(РесурсЗапросДанныеДляОформленияНаРаботу());
		ВсеРесурсы.Добавить(РесурсДанныеДляОформленияНаРаботу());
		ВсеРесурсы.Добавить(РесурсЗапросПособиеПриРожденииРебенка());
		ВсеРесурсы.Добавить(РесурсШаблонДокументаПособиеПриРожденииРебенка());
		ВсеРесурсы.Добавить(РесурсЗапросПособиеПоУходуЗаРебенком());
		ВсеРесурсы.Добавить(РесурсШаблонДокументаПособиеПоУходуЗаРебенком());
		ВсеРесурсы.Добавить(РесурсЗапросОтпускПоУходуЗаРебенком());
		ВсеРесурсы.Добавить(РесурсШаблонДокументаОтпускПоУходуЗаРебенком());
		ВсеРесурсы.Добавить(РесурсЗапросОтпускПоБеременностиИРодам());
		ВсеРесурсы.Добавить(РесурсШаблонДокументаОтпускПоБеременностиИРодам());
		ВсеРесурсы.Добавить(РесурсЗапросВозвратИзОтпускаПоУходуЗаРебенком());
		ВсеРесурсы.Добавить(РесурсШаблонДокументаВозвратИзОтпускаПоУходуЗаРебенком());
	КонецЕсли;
	
	Если ИспользуетсяВерсия("2.4") Тогда
		ВсеРесурсы.Добавить(РесурсИнформацияОСИЗ());
		ВсеРесурсы.Добавить(РесурсАнтропометрия());
		Если Приложение = Перечисления.ПриложенияДляИнтеграции.УправлениеПерсоналом Тогда
			ВсеРесурсы.Добавить(РесурсВидыОтпусков());
		КонецЕсли;
		ВсеРесурсы.Добавить(РесурсГрафикОтпусковПоРабочимМестам());
		ВсеРесурсы.Добавить(РесурсЗапросИзменениеГрафикаОтпусков());
		ВсеРесурсы.Добавить(РесурсШаблонДокументаЗаявлениеНаИзменениеГрафикаОтпуска());
		ВсеРесурсы.Добавить(РесурсЗапросЗаявкаИсполнениеГособязанностей());
		ВсеРесурсы.Добавить(РесурсШаблонДокументаЗаявкаИсполнениеГособязанностей());
		ВсеРесурсы.Добавить(РесурсЗапросЗаявкаВыходныеДляУходаЗаДетьмиИнвалидами());
		ВсеРесурсы.Добавить(РесурсШаблонДокументаЗаявкаВыходныеДляУходаЗаДетьмиИнвалидами());
		ВсеРесурсы.Добавить(РесурсЗапросЗаявлениеНаКомандировку());
		ВсеРесурсы.Добавить(РесурсЗапросОтчетОбИтогахКомандировки());
		ВсеРесурсы.Добавить(РесурсЗапросОтчетРасходыКомандировки());
		ВсеРесурсы.Добавить(РесурсШаблонДокументаЗаявлениеНаКомандировку());
		ВсеРесурсы.Добавить(РесурсШаблонОтчетаПоКомандировке());
		ВсеРесурсы.Добавить(РесурсШаблонОтчетаРасходыКомандировки());
		ВсеРесурсы.Добавить(РесурсШаблонЗаявлениеВПроизвольнойФорме());
		ВсеРесурсы.Добавить(РесурсЗапросЗаявлениеВПроизвольнойФорме());
	КонецЕсли;
	
	Если ИспользуетсяВерсия("2.5") Тогда
		ВсеРесурсы.Добавить(РесурсВидыДокументовЭДОБЗК());
	КонецЕсли;
	
	Если ИспользуетсяВерсия("2.6") Тогда
		ВсеРесурсы.Добавить(РесурсПодразделенияОрганизаций());
		ВсеРесурсы.Добавить(РесурсЗапросПодразделенияОрганизаций());
		ВсеРесурсы.Добавить(РесурсШаблонЗаявлениеОСпособеВыплатыЗарплаты());
		ВсеРесурсы.Добавить(РесурсЗапросЗаявлениеОСпособеВыплатыЗарплаты());
	КонецЕсли;
...
Функция РесурсПодразделенияОрганизаций()
	
	Если ИспользуетсяВерсия("2.6") Тогда
		Возврат "/legalEntityDivisions";
	Иначе
		Возврат "";
	КонецЕсли;
...
Функция РесурсЗапросПодразделенияОрганизаций()
	
	Если ИспользуетсяВерсия("2.6") Тогда
		Возврат "/legalEntityDivisions/{ID}";
	Иначе
		Возврат "";
	КонецЕсли;
...
Функция РесурсВидыОтпусков()
	...
	Если Приложение = Перечисления.ПриложенияДляИнтеграции.КабинетСотрудника И ИспользуетсяВерсия("2.2")
		Или Приложение = Перечисления.ПриложенияДляИнтеграции.УправлениеПерсоналом И ИспользуетсяВерсия("2.4") Тогда
...
Функция РесурсИнформацияОСИЗ()
	
	Если ИспользуетсяВерсия("2.4") Тогда
		Возврат "/personal-protective-equipment";
	Иначе
		Возврат "";
	КонецЕсли;
...
Функция РесурсАнтропометрия()
	
	Если ИспользуетсяВерсия("2.4") Тогда
		Возврат "/anthropometry";
	Иначе
		Возврат "";
	КонецЕсли;
...
Функция РесурсГрафикОтпусковПоРабочимМестам() 
	
	Если ИспользуетсяВерсия("2.4") Тогда
		Возврат СтрШаблон("%1/%2",РесурсГрафикОтпусков(),"employee-data");
	Иначе
		Возврат "";
	КонецЕсли;
...
Функция РесурсЗапросИзменениеГрафикаОтпусков()
	
	Если ИспользуетсяВерсия("2.4") Тогда
		Возврат "/change-vacations-schedule-requests/requests/{ID}";
	Иначе
		Возврат "";
	КонецЕсли;
...
Функция РесурсШаблонДокументаЗаявлениеНаИзменениеГрафикаОтпуска()
	
	Если ИспользуетсяВерсия("2.4") Тогда
		Возврат "/change-vacations-schedule-requests/document-template";
	Иначе
		Возврат "";
	КонецЕсли;
...
Функция РесурсЗапросЗаявкаИсполнениеГособязанностей()
	
	Если ИспользуетсяВерсия("2.4") Тогда
		Возврат "/state-leave/applications/{ID}";
	Иначе
		Возврат "";
	КонецЕсли;
...
Функция РесурсШаблонДокументаЗаявкаИсполнениеГособязанностей()
	
	Если ИспользуетсяВерсия("2.4") Тогда
		Возврат "/state-leave/document-template";
	Иначе
		Возврат "";
	КонецЕсли;
...
Функция РесурсЗапросЗаявкаВыходныеДляУходаЗаДетьмиИнвалидами()
	
	Если ИспользуетсяВерсия("2.4") Тогда
		Возврат "/disabled-child-care-leave-requests/requests/{ID}";
	Иначе
		Возврат "";
	КонецЕсли;
...
Функция РесурсШаблонДокументаЗаявкаВыходныеДляУходаЗаДетьмиИнвалидами()
	
	Если ИспользуетсяВерсия("2.4") Тогда
		Возврат "/disabled-child-care-leave-requests/document-template";
	Иначе
		Возврат "";
	КонецЕсли;
...
Функция РесурсЛичныеКабинеты()

	Если ИспользуетсяВерсия("2.4") Тогда
		Возврат "/personal-accounts";
	Иначе
		Возврат "";
	КонецЕсли;
...
Функция РесурсЗапросЗаявлениеНаКомандировку()
	
	Если ИспользуетсяВерсия("2.4") Тогда
		Возврат "/business-trips/requests/{ID}";
	Иначе
		Возврат "";
	КонецЕсли;
...
Функция РесурсЗапросОтчетОбИтогахКомандировки()
	
	Если ИспользуетсяВерсия("2.4") Тогда
		Возврат "/business-trips/reports/{ID}";
	Иначе
		Возврат "";
	КонецЕсли;
...
Функция РесурсЗапросОтчетРасходыКомандировки()
	
	Если ИспользуетсяВерсия("2.4") Тогда
		Возврат "/business-trips/expenses/{ID}";
	Иначе
		Возврат "";
	КонецЕсли;
...
Функция РесурсШаблонДокументаЗаявлениеНаКомандировку()
	
	Если ИспользуетсяВерсия("2.4") Тогда
		Возврат "/business-trips/requests-document-template";
	Иначе
		Возврат "";
	КонецЕсли;
...
Функция РесурсШаблонОтчетаПоКомандировке()
	
	Если ИспользуетсяВерсия("2.4") Тогда
		Возврат "/business-trips/reports-document-template";
	Иначе
		Возврат "";
	КонецЕсли;
...
Функция РесурсШаблонОтчетаРасходыКомандировки()
	
	Если ИспользуетсяВерсия("2.4") Тогда
		Возврат "/business-trips/expenses-document-template";
	Иначе
		Возврат "";
	КонецЕсли;
...
Функция РесурсВидыДокументовЭДОБЗК()

	Если ИспользуетсяВерсия("2.5") Тогда
		Возврат "/document-kinds";
	Иначе
		Возврат "";
	КонецЕсли;
...
Функция РесурсШаблонЗаявлениеВПроизвольнойФорме()
	
	Если ИспользуетсяВерсия("2.4") Тогда
		Возврат "/free-form-application/document-template";
	Иначе
		Возврат "";
	КонецЕсли;
...
Функция РесурсЗапросЗаявлениеВПроизвольнойФорме()
	
	Если ИспользуетсяВерсия("2.4") Тогда
		Возврат "/free-form-application/requests/{ID}";
	Иначе
		Возврат "";
	КонецЕсли;
...
Функция РесурсШаблонЗаявлениеОСпособеВыплатыЗарплаты()
	
	Если ИспользуетсяВерсия("2.6") Тогда
		Возврат "/payment-bank-details/application/template";
	Иначе
		Возврат "";
	КонецЕсли;
...
Функция РесурсЗапросЗаявлениеОСпособеВыплатыЗарплаты()
	
	Если ИспользуетсяВерсия("2.6") Тогда
		Возврат "/payment-bank-details/applications/{ID}";
	Иначе
		Возврат "";
	КонецЕсли;
...
// Устанавливает доступность приложения.
// В приложении есть возможность изменить доступность пользователей, а так же доступность информационных систем.
// Данный метод изменяет доступность только пользователей.
//
// Параметры:
//	БлокировкаДоступаПользователей - Булево - флаг доступности пользователей, который необходимо установить в приложении
//												Истина - заблокировать доступ пользователей
//												Ложь - разблокировать доступ пользователей
//
// Возвращаемое значение:
//	Булево - флаг успешной установки состояния блокировки
//
Функция УстановитьДоступностьПриложения(БлокировкаДоступаПользователей) Экспорт
	
	ТекущаяДоступность = ДоступностьПриложения();
	Если ТекущаяДоступность = Неопределено Тогда
		Возврат Ложь;
	КонецЕсли;
	
	ТипОбъекта = Перечисления.ТипыОбъектовИнтеграцияУправлениеПерсоналом.ДоступностьПриложения;
	Объект = Новый Структура("ДоступностьПользователей, ДоступностьИнформационнойСистемы");
	Объект.ДоступностьПользователей = ?(БлокировкаДоступаПользователей, "недоступно", "доступно");
	Объект.ДоступностьИнформационнойСистемы = ТекущаяДоступность.ДоступностьИнформационнойСистемы;
...
Функция ВыгрузитьФайлы(КоллекцияОбъектов, ИменаСвойствФайл)
	...
	Для каждого ОбъектКоллекции Из КоллекцияОбъектов Цикл
		...
		Для каждого ИмяСвойства Из ИменаСвойствФайл Цикл
			Если КоллекцияМассив Тогда
				ОписаниеФайла = ИнтеграцияУправлениеПерсоналом.ЗначениеСвойстваОбъекта(ОбъектКоллекции, ИмяСвойства);
			Иначе
...
Функция ВосстановлениеJSON(Знач Свойство, Значение, ДополнительныеПараметры) Экспорт
	...
	Если ТипЗнч(Значение) = Тип("Массив") Тогда
		...
		Для каждого ЭлементКоллекции Из Значение Цикл
			Попытка
				ПолученноеЗначение = ПрочитатьДатуJSON(ЭлементКоллекции, ФорматДатыJSON.ISO);
			Исключение
				ПолученноеЗначение = Дата(1,1,1);
			КонецПопытки;
