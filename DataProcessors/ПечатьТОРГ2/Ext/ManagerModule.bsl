...
Функция ПечатьАктаОбРасхождениях(МассивОбъектов, ОбъектыПечати)
	...
	Для каждого ОбъектыТипа Из ТипыОбъектов Цикл
		...
		Пока ДанныеПечати.Следующий() Цикл
			...
			ДанныеГрузоотправителя = БухгалтерскийУчетПереопределяемый.СведенияОЮрФизЛице(ДанныеПечати.Грузоотправитель, ДанныеПечати.ДатаДокумента);
			ДанныеЗаполнения.Вставить("Грузоотправитель", ОбщегоНазначенияБПВызовСервера.ОписаниеОрганизации(ДанныеГрузоотправителя, "ПолноеНаименование,ЮридическийАдрес,Телефоны"));
			...
			Область = Макет.ПолучитьОбласть("СтрокаРучногоЗаполнения");
			ТабличныйДокумент.Вывести(Область);
