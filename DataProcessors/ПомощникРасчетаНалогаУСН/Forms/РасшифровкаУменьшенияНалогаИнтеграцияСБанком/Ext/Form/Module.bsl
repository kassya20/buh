...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПриниматьКУчетуЗадолженностьДоЕНС =
		УчетСтраховыхВзносовИППовтИсп.УпрощенныйЗачетФиксированныхВзносов(Организация, КонецПериода)
		И УчетСтраховыхВзносовИП.ПриниматьКУчетуЗадолженностьДоЕНС(КонецПериода);
	
	СчетаУчетаВзносовИП = Новый Массив;
	ОбщегоНазначенияКлиентСервер.ДополнитьМассив(СчетаУчетаВзносовИП,
	...
	Список.Параметры.УстановитьЗначениеПараметра("ПриниматьКУчетуЗадолженностьДоЕНС", ПриниматьКУчетуЗадолженностьДоЕНС);
	Список.Параметры.УстановитьЗначениеПараметра("СчетаУчетаВзносовИП", СчетаУчетаВзносовИП);
	Список.Параметры.УстановитьЗначениеПараметра("ВидДвижения", ВидДвиженияНакопления.Расход);
	Список.Параметры.УстановитьЗначениеПараметра("ДатаПереходаНаЕНС",
		НастройкиУчетаКлиентСервер.ДатаПереходаНаЕдиныйНалоговыйПлатеж());
