...
Процедура Оплатить(СпособОплаты)
	...
	ОписаниеДействияПлатеж = ОписаниеДействияДляДокументаУплатыЗадолженности(Организация, ПлательщикЕНП,
		СуммаПлатежа, СпособОплаты, Период);
...
&НаСервереБезКонтекста
Функция ОписаниеДействияДляДокументаУплатыЗадолженности(Организация, ПлательщикЕНП, Сумма, СпособУплатыНалога, ПериодСобытия)
	...
	СтруктураРеквизитовУплатыНалога.ОплатаЗадолженности = Истина;
	СтруктураРеквизитовУплатыНалога.Правило             = Неопределено;
