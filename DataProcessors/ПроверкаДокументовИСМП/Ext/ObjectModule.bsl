			...
			Если ПредварительнаяПроверкаВозможна Тогда
				...
				Если ПараметрыУказанияДанныхПоМОДВЭлектронномДокументе.ПрисутствуетПрослеживаемаяПоМОДПродукция
					...
					Для Каждого ПараметрыУказанияМОД Из ПараметрыУказанияДанныхПоМОДВЭлектронномДокументе.ПараметрыУказанияМОДПоВидамПродукции Цикл
						...
						Если ПараметрыУказанияМОД.Значение.ПроверятьМОДТолькоПоПодконтрольнымОбъектамВЕТИС Тогда
							ПроверятьТоварныеГруппы = Истина;
						КонецЕсли;
						
						Если ПроверятьТоварныеГруппы Тогда
							Прервать;
						КонецЕсли;
...
Функция НаличиеЗарегистрированногоМОДаОрганизации(ПараметрыОбработки, ПараметрыУказанияДанныхПоМОДВЭлектронномДокументе)
	...
	Для Каждого ДанныеПоВидуПродукции Из ПараметрыУказанияДанныхПоМОДВЭлектронномДокументе.ПараметрыУказанияМОДПоВидамПродукции Цикл
		...
		Если ДанныеПоВидуПродукции.Значение.ПроверятьМОДТолькоПоПодконтрольнымОбъектамВЕТИС И ПараметрыОбработки.Свойство("ТоварныеГруппыОрганизацииПоДаннымСервиса") Тогда
			
			ПодконтрольностьВЕТИС = ПараметрыОбработки.ТоварныеГруппыОрганизацииПоДаннымСервиса.Получить(ИнтерфейсИСМПОбщегоНазначения.ТоварнаяГруппа(ДанныеПоВидуПродукции.Ключ));
			...
			ПараметрыУказанияМОД.ТребуетсяУказаниеКодаФИАСПоМОДИндивидуальныхПредпринимателей = ПараметрыУказанияМОД.ТребуетсяУказаниеКодаФИАСПоМОДИндивидуальныхПредпринимателей И ДанныеПоВидуПродукции.Значение.ТребуетсяУказаниеКодаФИАСПоМОДИндивидуальныхПредпринимателей;
			ПараметрыУказанияМОД.ТребуетсяУказаниеКодаФИАСПоМОДЮридическихЛиц                 = ПараметрыУказанияМОД.ТребуетсяУказаниеКодаФИАСПоМОДЮридическихЛиц Или ПодконтрольностьВЕТИС И ДанныеПоВидуПродукции.Значение.ТребуетсяУказаниеКодаФИАСПоМОДЮридическихЛиц;
		...
		Иначе
			...
			ПараметрыУказанияМОД.ТребуетсяУказаниеКодаФИАСПоМОДИндивидуальныхПредпринимателей = ПараметрыУказанияМОД.ТребуетсяУказаниеКодаФИАСПоМОДИндивидуальныхПредпринимателей Или ДанныеПоВидуПродукции.Значение.ТребуетсяУказаниеКодаФИАСПоМОДИндивидуальныхПредпринимателей;
			ПараметрыУказанияМОД.ТребуетсяУказаниеКодаФИАСПоМОДЮридическихЛиц                 = ПараметрыУказанияМОД.ТребуетсяУказаниеКодаФИАСПоМОДЮридическихЛиц Или ДанныеПоВидуПродукции.Значение.ТребуетсяУказаниеКодаФИАСПоМОДЮридическихЛиц;
	...
	ТребуетсяУказаниеКодаФИАС = ПараметрыУказанияМОД.ТребуетсяУказаниеКодаФИАСПоМОДЮридическихЛиц И Не РеквизитыДокумента.ОтправительИндивидуальныйПредприниматель
		Или ПараметрыУказанияМОД.ТребуетсяУказаниеКодаФИАСПоМОДИндивидуальныхПредпринимателей И РеквизитыДокумента.ОтправительИндивидуальныйПредприниматель;
...
Функция НаличиеЗарегистрированногоМОДаКонтрагента(ПараметрыОбработки, ПараметрыУказанияДанныхПоМОДВЭлектронномДокументе)
	...
	Для Каждого ДанныеПоВидуПродукции Из ПараметрыУказанияДанныхПоМОДВЭлектронномДокументе.ПараметрыУказанияМОДПоВидамПродукции Цикл
		...
		Если ДанныеПоВидуПродукции.Значение.ПроверятьМОДТолькоПоПодконтрольнымОбъектамВЕТИС И ПараметрыОбработки.Свойство("ТоварныеГруппыКонтрагентаПоДаннымСервиса") Тогда
			
			ПодконтрольностьВЕТИС = ПараметрыОбработки.ТоварныеГруппыКонтрагентаПоДаннымСервиса.Получить(ИнтерфейсИСМПОбщегоНазначения.ТоварнаяГруппа(ДанныеПоВидуПродукции.Ключ));
			...
			ПараметрыУказанияМОД.ТребуетсяУказаниеКодаФИАСПоМОДИндивидуальныхПредпринимателей = ПараметрыУказанияМОД.ТребуетсяУказаниеКодаФИАСПоМОДИндивидуальныхПредпринимателей Или ПодконтрольностьВЕТИС И ДанныеПоВидуПродукции.Значение.ТребуетсяУказаниеКодаФИАСПоМОДИндивидуальныхПредпринимателей;
			ПараметрыУказанияМОД.ТребуетсяУказаниеКодаФИАСПоМОДЮридическихЛиц                 = ПараметрыУказанияМОД.ТребуетсяУказаниеКодаФИАСПоМОДЮридическихЛиц Или ПодконтрольностьВЕТИС И ДанныеПоВидуПродукции.Значение.ТребуетсяУказаниеКодаФИАСПоМОДЮридическихЛиц;
	...
	ТребуетсяУказаниеКодаФИАС = ПараметрыУказанияМОД.ТребуетсяУказаниеКодаФИАСПоМОДЮридическихЛиц И Не РеквизитыДокумента.ПолучательИндивидуальныйПредприниматель
		Или ПараметрыУказанияМОД.ТребуетсяУказаниеКодаФИАСПоМОДИндивидуальныхПредпринимателей И РеквизитыДокумента.ПолучательИндивидуальныйПредприниматель;
...
Процедура ЗаполнитьДанныеАдресаОтправителяПоПараметрамУказанияДанныхПоМОД(ПараметрыУказанияМОД, ПараметрыОбработки)
	...
	ТребуетсяУказаниеФИАС = РеквизитыДокумента.ОтправительИндивидуальныйПредприниматель И ПараметрыУказанияМОД.ТребуетсяУказаниеКодаФИАСПоМОДИндивидуальныхПредпринимателей
		Или Не РеквизитыДокумента.ОтправительИндивидуальныйПредприниматель И ПараметрыУказанияМОД.ТребуетсяУказаниеКодаФИАСПоМОДЮридическихЛиц;
...
Процедура ЗаполнитьДанныеАдресаПолучателяПоПараметрамУказанияДанныхПоМОД(ПараметрыУказанияМОД, ПараметрыОбработки)
	...
	ТребуетсяУказаниеФИАС = РеквизитыДокумента.ПолучательИндивидуальныйПредприниматель И ПараметрыУказанияМОД.ТребуетсяУказаниеКодаФИАСПоМОДИндивидуальныхПредпринимателей
		Или Не РеквизитыДокумента.ПолучательИндивидуальныйПредприниматель И ПараметрыУказанияМОД.ТребуетсяУказаниеКодаФИАСПоМОДЮридическихЛиц;
			...
			Иначе
				...
				Если ДанныеОбработки.Свойство("productGroupInfo") Тогда
					...
					Для Каждого ДанныеПоТоварнойГруппе Из ДанныеОбработки.productGroupInfo Цикл
						...
						Иначе
							ВозвращаемоеЗначение.ТоварныеГруппы.Вставить(ДанныеПоТоварнойГруппе.productGroup, Ложь);
						КонецЕсли;
