...
Процедура КалендарьПриАктивизацииДаты(Элемент)
	...
	ПериодБольшеГода = ДатаОкончания > ДобавитьМесяц(ДатаНачала, 12);
	Если ПериодБольшеГода И ВыбраннаяДата = ДатаНачала Тогда
		ДатаОкончания = ДобавитьМесяц(ДатаНачала, 12);
	ИначеЕсли ПериодБольшеГода И ВыбраннаяДата = ДатаОкончания Тогда
...
Процедура ОК(Команда)
	...
	Закрыть(Новый Структура("ДатаНачала, ДатаОкончания", ДатаНачала, ДатаОкончания));
