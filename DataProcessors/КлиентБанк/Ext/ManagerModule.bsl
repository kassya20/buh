		...
		Иначе
			...
			Если ОбменДоступен Тогда
				...
				Если НастройкаДиректБанк <> Неопределено Тогда
					ПрограммаБанка = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(НастройкаДиректБанк, "ПрограммаБанка");
					Если Валютный Тогда
						ОбменДоступен = ПрограммаБанка <> Перечисления.ПрограммыБанка.SberAPI;
					КонецЕсли;
