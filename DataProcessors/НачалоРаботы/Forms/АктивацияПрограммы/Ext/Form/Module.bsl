...
Процедура УправлениеФормой(Форма)
	...
	Элементы.ТорговыйСбор.Видимость = Форма.СистемыНалогообложенияДопускающиеСовмещение.НайтиПоЗначению(Форма.СистемаНалогообложения) <> Неопределено
		Или Форма.СистемаНалогообложения = "АУСНДоходы" Или Форма.СистемаНалогообложения = "АУСНДоходыМинусРасходы";
...
Процедура ЗаполнитьСписокВыбораСистемНалогообложения()
	...
	КонецЕсли;
	Элементы.СистемаНалогообложения.СписокВыбора.Добавить("УпрощеннаяДоходы", НСтр("ru='Упрощенная (доходы)'"));
	Элементы.СистемаНалогообложения.СписокВыбора.Добавить("УпрощеннаяДоходыМинусРасходы", НСтр("ru='Упрощенная (доходы минус расходы)'"));
