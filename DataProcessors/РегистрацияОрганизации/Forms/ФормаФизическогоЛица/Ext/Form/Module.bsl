...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Ключ.Пустая() Тогда
		...
		Параметры.Свойство("ИНН", ФизическоеЛицо.ИНН);
	...
	Если ПустаяСтрока(ФизическоеЛицо.МестоРожденияПредставление) Тогда
...
Процедура ФамилияАвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
	...
	Если РегистрацияОрганизацииКлиент.ПроверитьЯзыкВвода(Текст, "ФизическоеЛицо.Фамилия", ЗаголовокЭлемента, Истина) Тогда
...
Процедура ФамилияОкончаниеВводаТекста(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, СтандартнаяОбработка)
	...
	ЗаголовокЭлемента = НСтр("ru = 'Фамилия'");
	РегистрацияОрганизацииКлиент.ПроверитьЯзыкВвода(Текст, "ФизическоеЛицо.Фамилия", ЗаголовокЭлемента, Истина);
...
Процедура ИмяАвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
	...
	Если РегистрацияОрганизацииКлиент.ПроверитьЯзыкВвода(Текст, "ФизическоеЛицо.Имя", ЗаголовокЭлемента, Истина) Тогда
...
Процедура ИмяОкончаниеВводаТекста(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, СтандартнаяОбработка)
	...
	ЗаголовокЭлемента = НСтр("ru = 'Имя'");
	РегистрацияОрганизацииКлиент.ПроверитьЯзыкВвода(Текст, "ФизическоеЛицо.Имя", ЗаголовокЭлемента, Истина);
...
Процедура ОтчествоАвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
	...
	Если РегистрацияОрганизацииКлиент.ПроверитьЯзыкВвода(Текст, "ФизическоеЛицо.Отчество", ЗаголовокЭлемента, Истина) Тогда
		Если ЗначениеЗаполнено(ФизическоеЛицо.Фамилия) Тогда
			ПараметрыПолученияДанных.Отбор = Новый Структура("Фамилия", ФизическоеЛицо.Фамилия);
		КонецЕсли;
...
Процедура ОтчествоОкончаниеВводаТекста(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, СтандартнаяОбработка)
	...
	ЗаголовокЭлемента = НСтр("ru = 'Отчество'");
	РегистрацияОрганизацииКлиент.ПроверитьЯзыкВвода(Текст, "ФизическоеЛицо.Отчество", ЗаголовокЭлемента, Истина);
	
КонецПроцедуры

&НаКлиенте
Процедура ПаспортМестоРожденияАвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ПаспортМестоРожденияОкончаниеВводаТекста(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, СтандартнаяОбработка)
...
Процедура ПаспортКемВыданАвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
	...
	РегистрацияОрганизацииКлиент.ПроверитьЯзыкВвода(
		Текст, "ПаспортныеДанные.КемВыдан", ЗаголовокЭлемента, Истина);
...
Процедура ОповеститьОВыбореИЗакрыть()
	...
	РезультатВыбора.Вставить("Наименование", ФизическоеЛицо.Наименование);
	Если ИспользоватьДолжность Тогда
...
Функция ИменаРеквизитовФизическогоЛица()
	...
	ИменаРеквизитовФизическогоЛица.Вставить("ИностранныйПаспортСерияНомер", "ИностранныйПаспортСерияНомер");
	ИменаРеквизитовФизическогоЛица.Вставить("ДанныеОснованияДляПроживанияВРФ", "ДанныеОснованияДляПроживанияВРФ");
	ИменаРеквизитовФизическогоЛица.Вставить("СерияНомерОснованияДляПроживания", "СерияНомерОснованияДляПроживания");
	ИменаРеквизитовФизическогоЛица.Вставить("ВидОснованияДляПроживанияВРФ", "ВидДокумента");
	ИменаРеквизитовФизическогоЛица.Вставить("Гражданство", "Гражданство");
...
Процедура УправлениеФормой(Форма)
	...
	Элементы.ГруппаАдресРФ.Видимость = ГражданствоРФ;
	Элементы.ГруппаИностранныйАдрес.Видимость = Не ГражданствоРФ;
	...
	Если Элементы.ОснованиеДляПроживанияВРФ.Видимость Тогда
...
Процедура ПроверитьЗаполнениеПаспортныхДанных(Отказ)
	...
	ИначеЕсли НЕ СтроковыеФункцииКлиентСервер.ТолькоКириллицаВСтроке(
		ФизическоеЛицо.Фамилия, Истина, ДопустимоКромеКириллицы) Тогда
	...
	Если НЕ СтроковыеФункцииКлиентСервер.ТолькоКириллицаВСтроке(
		ФизическоеЛицо.Отчество, Истина, ДопустимоКромеКириллицы) Тогда
	...
	// Кем выдан паспорт
	Если ЕстьГражданство И Не ЗначениеЗаполнено(ПаспортныеДанные.КемВыдан) Тогда
	...
	ИначеЕсли ЕстьГражданство И Не СтроковыеФункцииКлиентСервер.ТолькоКириллицаВСтроке(
		ПаспортныеДанные.КемВыдан, Ложь, ДопустимоКромеКириллицы) Тогда
		ТекстСообщения = НСтр("ru = 'Кем выдан паспорт заполняется на русском языке'");
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(ТекстСообщения, ,
			"ПаспортныеДанные.КемВыдан", , Отказ);
	КонецЕсли;
	
	// Дата выдачи паспорта
	Если ЕстьГражданство И Не ЗначениеЗаполнено(ПаспортныеДанные.ДатаВыдачи) Тогда
...
Процедура ОбработатьИзменениеСтраныГражданства()
	...
	Если Не ГражданствоРФ Тогда
		...
		ПаспортныеДанные.КодПодразделения = "";
	КонецЕсли;
	...
	Если Не ГражданствоРФ Тогда
		ВидНаЖительствоБессрочный = Не ЗначениеЗаполнено(ДанныеОснованияДляПроживанияВРФ.СрокДействия);
	Иначе
		ВидНаЖительствоБессрочный = Ложь;
	КонецЕсли;
