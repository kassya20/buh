...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	НоваяРегистрация = Параметры.НоваяРегистрация;
	
	Если НоваяРегистрация Тогда
		// Перед запуском очищаем старые настройки предыдущего запуска
		Обработки.РегистрацияОрганизации.УдалитьДанныеПомощникаРегистрации();
	КонецЕсли;
