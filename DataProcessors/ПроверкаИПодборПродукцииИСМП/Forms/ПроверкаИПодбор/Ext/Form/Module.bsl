...
Процедура СформироватьПараметрыПроверкиКодовМаркировки(ПараметрыСканированияСервер)
	...
	ПараметрыПроверкиКодовМаркировки.Вставить("ДатаКонтроляРазрешительнойДокументации",  Неопределено);
	...
	ПараметрыПроверкиКодовМаркировки.ДатаКонтроляРазрешительнойДокументации = ОбщегоНазначенияИСМППовтИсп.ДатаКонтроляРазрешительнойДокументации(ВидМаркируемойПродукции)
...
Процедура ДобавитьНовуюМаркируемуюПродукциюВДерево(ДанныеШтрихкода, ДобавлятьВУпаковку = Неопределено)
	...
	Если ДанныеШтрихкода.ДанныеРазрешительнойДокументации <> Неопределено Тогда
