...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("СопоставитьДанныеИзФайла", Истина);
	Методы.Вставить("ОбработатьДанныеИзФайлаВФоне", Истина);
	Методы.Вставить("УдалитьВсеЛишнее", Истина);
...
Процедура СопоставитьЗагружаемыеДанные(ЗагружаемыеДанные, ТипДанных, ИмяКолонки)
	...
	ОбъектОписания = Метаданные.НайтиПоТипу(ТипДанных);
	...
	Запрос.Параметры.Вставить("СправочникПустаяСсылка", Справочники[ИмяСправочника].ПустаяСсылка());
