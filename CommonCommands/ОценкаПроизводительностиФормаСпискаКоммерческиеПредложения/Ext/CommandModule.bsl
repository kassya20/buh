...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	ПараметрыОткрытия.Заголовок               = НСтр("ru = 'Коммерческие предложения'");
	ПараметрыОткрытия.ИмяФормы                = "Документ.КоммерческоеПредложение.ФормаСписка";
	ПараметрыОткрытия.ЗамерПроизводительности = "СозданиеФормыСпискаКоммерческоеПредложение";
