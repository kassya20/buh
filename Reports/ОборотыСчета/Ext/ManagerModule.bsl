...
Функция ПолучитьПараметрыИсполненияОтчета() Экспорт
	...
	Результат.Вставить("КоличествоКолонокПоказателей",       0);
...
Процедура ПроверитьКорректностьИтогов(ПараметрыОтчета, Результат) Экспорт
	...
	КоличествоПоказателей = БухгалтерскиеОтчетыВызовСервера.КоличествоПоказателей(ПараметрыОтчета);
	ПерваяИзЯчеекИтогов = ПерваяИзЯчеекИтогов(КоличествоПоказателей, ПараметрыОтчета, Результат);
...
Функция КоличествоКолонокПоказателей(ПараметрыОтчета, Результат) Экспорт
	...
	Возврат ПоследняяИзЯчеекИтогов - ПерваяИзЯчеекИтогов + 1;
...
Функция ПерваяИзЯчеекИтогов(КоличествоПоказателей, ПараметрыОтчета, Результат)
