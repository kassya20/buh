...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТекущаяДатаСеанса() < '20260602' Тогда 
		НовСтр = ТаблицаЗначенийПредопределенныхРеквизитов.Добавить();
		НовСтр.ИмяОсобогоПоля = "КОД_ПЕРЕХОДА";
		НовСтр.Код = "4";
		НовСтр.Название = "с 1 января 2026 года для индивидуальных предпринимателей, применявших в" 
			+ " декабре 2025 года патентную систему налогообложения, доход которых в 2025 году превысил 20 млн рублей";
	КонецЕсли;
КонецПроцедуры
