...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел2" Тогда
		...
		ИначеЕсли НЕ СтрНайти(ОбластьИмя, "ОКАТОРаздел2") > 0 Тогда
			...
			СтруктураГруппы1[Число(НомерСтроки) - 1][Колонка] = ТабличныйДокумент.ТекущаяОбласть.Значение;
...
Процедура ТабличныйДокументПриАктивизации(Элемент)
	...
	Если СтрЧислоВхождений(ТабличныйДокумент.ТекущаяОбласть.Имя, "П0000200020") > 0 Тогда
...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли Элементы.РазделыОтчета.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Раздел1" Тогда
		...
		Ячейка = ТабличныйДокумент.ТекущаяОбласть.Имя;
