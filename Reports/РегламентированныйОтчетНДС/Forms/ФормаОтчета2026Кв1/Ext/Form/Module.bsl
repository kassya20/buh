...
Функция ВыполнитьДокументированиеНаСервере()
	...
	СтруктураРезультата.Вставить("НаименованиеФормы"	, "2026Кв1");
	...
	ДанныеКС 			= Новый Структура;
	ДанныеКС.Вставить("Счетчик"		, 0); 
	ДанныеКС.Вставить("ГодОтчета"	, 2026);
...
#Область ФормированиеДанныхПоставляемыхРазделов
	...
	ТаблицаР08К52 = ПолучитьТаблицуПоКодуОперации(ТаблицаР08, "52");
	ТаблицаР08К53 = ПолучитьТаблицуПоКодуОперации(ТаблицаР08, "53");
	ТаблицаР08К58 = ПолучитьТаблицуПоКодуОперации(ТаблицаР08, "58");
	ТаблицаР08К59 = ПолучитьТаблицуПоКодуОперации(ТаблицаР08, "59");
	ТаблицаР08К60 = ПолучитьТаблицуПоКодуОперации(ТаблицаР08, "60");
	ТаблицаР08К61 = ПолучитьТаблицуПоКодуОперации(ТаблицаР08, "61");
	...
	ТаблицаР81К52 = ПолучитьТаблицуПоКодуОперации(ТаблицаР81, "52");
	ТаблицаР81К53 = ПолучитьТаблицуПоКодуОперации(ТаблицаР81, "53");
	ТаблицаР81К58 = ПолучитьТаблицуПоКодуОперации(ТаблицаР81, "58");
	ТаблицаР81К59 = ПолучитьТаблицуПоКодуОперации(ТаблицаР81, "59");
	ТаблицаР81К60 = ПолучитьТаблицуПоКодуОперации(ТаблицаР81, "60");
	ТаблицаР81К61 = ПолучитьТаблицуПоКодуОперации(ТаблицаР81, "61");
	...
	ТаблицаР09К52 = ПолучитьТаблицуПоКодуОперации(ТаблицаР09, "52");
	ТаблицаР09К53 = ПолучитьТаблицуПоКодуОперации(ТаблицаР09, "53");
	ТаблицаР09К58 = ПолучитьТаблицуПоКодуОперации(ТаблицаР09, "58");
	ТаблицаР09К59 = ПолучитьТаблицуПоКодуОперации(ТаблицаР09, "59");
	ТаблицаР09К60 = ПолучитьТаблицуПоКодуОперации(ТаблицаР09, "60");
	ТаблицаР09К61 = ПолучитьТаблицуПоКодуОперации(ТаблицаР09, "61");
	...
	ТаблицаР91К52 = ПолучитьТаблицуПоКодуОперации(ТаблицаР91, "52");
	ТаблицаР91К53 = ПолучитьТаблицуПоКодуОперации(ТаблицаР91, "53");
	ТаблицаР91К58 = ПолучитьТаблицуПоКодуОперации(ТаблицаР91, "58");
	ТаблицаР91К59 = ПолучитьТаблицуПоКодуОперации(ТаблицаР91, "59");
	ТаблицаР91К60 = ПолучитьТаблицуПоКодуОперации(ТаблицаР91, "60");
	ТаблицаР91К61 = ПолучитьТаблицуПоКодуОперации(ТаблицаР91, "61");
	...
	ЗаполнитьДанныеРаздела(ТаблицаР08К52	, ДанныеР08, "Р08С180К52");
	ЗаполнитьДанныеРаздела(ТаблицаР08К53	, ДанныеР08, "Р08С180К53");
	ЗаполнитьДанныеРаздела(ТаблицаР08К58	, ДанныеР08, "Р08С180К58");
	ЗаполнитьДанныеРаздела(ТаблицаР08К59	, ДанныеР08, "Р08С180К59");
	ЗаполнитьДанныеРаздела(ТаблицаР08К60	, ДанныеР08, "Р08С180К60");
	ЗаполнитьДанныеРаздела(ТаблицаР08К61	, ДанныеР08, "Р08С180К61");
	...
	ЗаполнитьДанныеРаздела(ТаблицаР81К52	, ДанныеР81, "Р81С180К52");
	ЗаполнитьДанныеРаздела(ТаблицаР81К53	, ДанныеР81, "Р81С180К53");
	ЗаполнитьДанныеРаздела(ТаблицаР81К58	, ДанныеР81, "Р81С180К58");
	ЗаполнитьДанныеРаздела(ТаблицаР81К59	, ДанныеР81, "Р81С180К59");
	ЗаполнитьДанныеРаздела(ТаблицаР81К60	, ДанныеР81, "Р81С180К60");
	ЗаполнитьДанныеРаздела(ТаблицаР81К61	, ДанныеР81, "Р81С180К61");
	...
	ЗаполнитьДанныеРаздела(ТаблицаР09К52	, ДанныеР09, "Р09С200К52, Р09С211К52, Р09С212К52");
	ЗаполнитьДанныеРаздела(ТаблицаР09К53	, ДанныеР09, "Р09С200К53, Р09С211К53, Р09С212К53");
	ЗаполнитьДанныеРаздела(ТаблицаР09К58	, ДанныеР09, "Р09С200К58, Р09С211К58, Р09С212К58");
	ЗаполнитьДанныеРаздела(ТаблицаР09К59	, ДанныеР09, "Р09С200К59, Р09С211К59, Р09С212К59");
	ЗаполнитьДанныеРаздела(ТаблицаР09К60	, ДанныеР09, "Р09С200К60, Р09С211К60, Р09С212К60");
	ЗаполнитьДанныеРаздела(ТаблицаР09К61	, ДанныеР09, "Р09С200К61, Р09С211К61, Р09С212К61");
	...
	ЗаполнитьДанныеРаздела(ТаблицаР91К52	, ДанныеР91, "Р91С280К52, Р91С291К52, Р91С292К52");
	ЗаполнитьДанныеРаздела(ТаблицаР91К53	, ДанныеР91, "Р91С280К53, Р91С291К53, Р91С292К53");
	ЗаполнитьДанныеРаздела(ТаблицаР91К58	, ДанныеР91, "Р91С280К58, Р91С291К58, Р91С292К58");
	ЗаполнитьДанныеРаздела(ТаблицаР91К59	, ДанныеР91, "Р91С280К59, Р91С291К59, Р91С292К59");
	ЗаполнитьДанныеРаздела(ТаблицаР91К60	, ДанныеР91, "Р91С280К60, Р91С291К60, Р91С292К60");
	ЗаполнитьДанныеРаздела(ТаблицаР91К61	, ДанныеР91, "Р91С280К61, Р91С291К61, Р91С292К61");
...
Функция СформироватьСоответствиеИмен()
	...
	СоответствиеИмен.Вставить("Р09С170", "СтоимПродСФ22");		// 2026
	СоответствиеИмен.Вставить("Р09С175", "СтоимПродСФ20");		// 2026
	СоответствиеИмен.Вставить("Р09С180", "СтоимПродСФ10");
	СоответствиеИмен.Вставить("Р09С181", "СтоимПродСФ7");		
	СоответствиеИмен.Вставить("Р09С182", "СтоимПродСФ5");		
	СоответствиеИмен.Вставить("Р09С190", "СтоимПродСФ0");
	СоответствиеИмен.Вставить("Р09С200", "СумНДССФ22");			// 2026
	СоответствиеИмен.Вставить("Р09С205", "СумНДССФ20");			// 2026
	СоответствиеИмен.Вставить("Р09С210", "СумНДССФ10");
	СоответствиеИмен.Вставить("Р09С211", "СумНДССФ7");			
	СоответствиеИмен.Вставить("Р09С212", "СумНДССФ5");			
	СоответствиеИмен.Вставить("Р09С220", "СтоимПродОсв");
	СоответствиеИмен.Вставить("Р09С230", "СтПродБезНДС22");		// 2026
	СоответствиеИмен.Вставить("Р09С235", "СтПродБезНДС20");		// 2026
	СоответствиеИмен.Вставить("Р09С240", "СтПродБезНДС10");
	СоответствиеИмен.Вставить("Р09С241", "СтПродБезНДС7");		
	СоответствиеИмен.Вставить("Р09С242", "СтПродБезНДС5");		
	СоответствиеИмен.Вставить("Р09С250", "СтПродБезНДС0");
	СоответствиеИмен.Вставить("Р09С260", "СумНДСВсКПр22");		// 2026
	СоответствиеИмен.Вставить("Р09С265", "СумНДСВсКПр20");		// 2026
	СоответствиеИмен.Вставить("Р09С270", "СумНДСВсКПр10");
	СоответствиеИмен.Вставить("Р09С271", "СумНДСВсКПр7");		
	СоответствиеИмен.Вставить("Р09С272", "СумНДСВсКПр5");		
	СоответствиеИмен.Вставить("Р09С280", "СтПродОсвВсКПр");
	
	// Приложение 1 к Разделу 9
	СоответствиеИмен.Вставить("Р91С020", "ИтСтПродКПр22");		// 2026
	СоответствиеИмен.Вставить("Р91С025", "ИтСтПродКПр20");		// 2026
	СоответствиеИмен.Вставить("Р91С030", "ИтСтПродКПр10");
	СоответствиеИмен.Вставить("Р91С031", "ИтСтПродКПр7");		
	СоответствиеИмен.Вставить("Р91С032", "ИтСтПродКПр5");		
	СоответствиеИмен.Вставить("Р91С040", "ИтСтПродКПр0");
	СоответствиеИмен.Вставить("Р91С050", "СумНДСИтКПр22");		// 2026
	СоответствиеИмен.Вставить("Р91С055", "СумНДСИтКПр20"); 		// 2026
	СоответствиеИмен.Вставить("Р91С060", "СумНДСИтКПр10");
	СоответствиеИмен.Вставить("Р91С061", "СумНДСИтКПр7");		
	СоответствиеИмен.Вставить("Р91С062", "СумНДСИтКПр5");		
	СоответствиеИмен.Вставить("Р91С070", "ИтСтПродОсвКПр");
	СоответствиеИмен.Вставить("Р91С240", "СтоимПродСФ");
	СоответствиеИмен.Вставить("Р91С250", "СтоимПродСФ22");		// 2026
	СоответствиеИмен.Вставить("Р91С255", "СтоимПродСФ20");		// 2026
	СоответствиеИмен.Вставить("Р91С260", "СтоимПродСФ10");
	СоответствиеИмен.Вставить("Р91С261", "СтоимПродСФ7");		
	СоответствиеИмен.Вставить("Р91С262", "СтоимПродСФ5");		
	СоответствиеИмен.Вставить("Р91С270", "СтоимПродСФ0");
	СоответствиеИмен.Вставить("Р91С280", "СумНДССФ22");			// 2026
	СоответствиеИмен.Вставить("Р91С285", "СумНДССФ20");			// 2026
	СоответствиеИмен.Вставить("Р91С290", "СумНДССФ10");
	СоответствиеИмен.Вставить("Р91С291", "СумНДССФ7");			
	СоответствиеИмен.Вставить("Р91С292", "СумНДССФ5");			
	СоответствиеИмен.Вставить("Р91С300", "СтоимПродОсв");
	СоответствиеИмен.Вставить("Р91С310", "СтПродВсП1Р9_22");	// 2026
	СоответствиеИмен.Вставить("Р91С315", "СтПродВсП1Р9_20");	// 2026
	СоответствиеИмен.Вставить("Р91С320", "СтПродВсП1Р9_10");
	СоответствиеИмен.Вставить("Р91С321", "СтПродВсП1Р9_7");		
	СоответствиеИмен.Вставить("Р91С322", "СтПродВсП1Р9_5");		
	СоответствиеИмен.Вставить("Р91С330", "СтПродВсП1Р9_0");
	СоответствиеИмен.Вставить("Р91С340", "СумНДСВсП1Р9_22"); 	// 2026
	СоответствиеИмен.Вставить("Р91С345", "СумНДСВсП1Р9_20");	// 2026
	СоответствиеИмен.Вставить("Р91С350", "СумНДСВсП1Р9_10"); 
	СоответствиеИмен.Вставить("Р91С351", "СумНДСВсП1Р9_7");		
	СоответствиеИмен.Вставить("Р91С352", "СумНДСВсП1Р9_5");		
...
Процедура ПодготовитьНастройки(Заголовки)
	...
	НомераКС3 = СтрРазделить(
		"1.69", ",");
	НомераКС4 = СтрРазделить(
		"1.4,1.7,1.11,1.26.02,1.67.1,1.67.2,1.68", ",");
	...
	Если ДанныеКС.ГодОтчета >= 2025 Тогда
		...
		ИначеЕсли НЕ НомераКС4.Найти(НастройкиКС.НомерКС) = Неопределено Тогда 
			НастройкиКС.Вставить("Основание", "Письмо ФНС России от 20.02.2026 № СД-36-3/1314@");
...
Процедура ПроверкаКС_1_37()
	...
	Заголовки.Вставить("Описание"			,
		НСтр("ru='Сумма налога по ставке 22% в стр.260 Раздела 9 = сумме стр.200 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_46()
	...
	Заголовки.Вставить("Описание"			,
		НСтр("ru='Сумма налога по ставке 20% или 18% в стр.265 Раздела 9 = стр.205 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_42()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма налога по ставке 22% в стр.340 Приложения 1 к Разделу 9 = стр.(050 + 280) Приложения 1 '") +
		НСтр("ru='к Разделу 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %4 (%2 + %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_48()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма налога по ставке 20% или 18% в стр.345 Приложения 1 к Разделу 9 = стр.(055 + 285) Приложения 1 '") +
		НСтр("ru='к Разделу 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %4 (%2 + %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_04()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Требуется соблюдение равенства: гр.3 стр.(003 + 005 + 007 + 010 + 020 + 030 + 040 + 041 + 042) '") +
		НСтр("ru='Раздела 3) / (гр.3 стр.(003 + 005 + 007 + 010 + 020 + 030 + 040 + 041 + 042) Раздела 3 + '") +
		НСтр("ru='(сумма гр.2 Раздела 7 по кодам 1010800 - 1010842, 1011450, 1011451 (кроме 1010821, 1010836))) '") +
		НСтр("ru='= гр.3 стр.(120 + 135 + 150 + 160) Раздела 3 / (гр.3 стр.(120 + 135 + 150 + 160) Раздела 3 + '") +
		НСтр("ru='(сумма гр.4 Раздела 7 по кодам 1010800 - 1010842, 1011450, 1011451 (кроме 1010821, 1010836)))'"));
	...
	Для Счетчик = 0 По 42 Цикл
		Если Счетчик = 21 ИЛИ Счетчик = 36 Тогда
			Продолжить;
		КонецЕсли;
		МассивКодов.Добавить("10108" + Формат(Счетчик, "ЧЦ=2; ЧН=; ЧВН="));
	КонецЦикла;
	МассивКодов.Добавить("1011450");
	МассивКодов.Добавить("1011451");
	
	ИменаПоказателейЛевЧисл = Новый Структура;
	ИменаПоказателейЛевЧисл.Вставить("Р03С003"	, "П000300000303");
	ИменаПоказателейЛевЧисл.Вставить("Р03С005"	, "П000300000503");
	ИменаПоказателейЛевЧисл.Вставить("Р03С007"	, "П000300000703");
	...
	ИменаПоказателейПрвЧисл.Вставить("Р03С135"	, "П000300013503");
	...
	Для Инд = 1 По КолвоСтрок Цикл
		...
		Если ЗначениеЗаполнено(ПоказателиЛевЗнам.Р07С001Г1.Значение) 
			И НЕ МассивКодов.Найти(ПоказателиЛевЗнам.Р07С001Г1.Значение) = Неопределено Тогда
	...
	Для Инд = 1 По КолвоСтрок Цикл
		...
		Если ЗначениеЗаполнено(ПоказателиПрвЗнам.Р07С001Г1.Значение) 
			И НЕ МассивКодов.Найти(ПоказателиПрвЗнам.Р07С001Г1.Значение) = Неопределено Тогда
	...
	РасчетнаяСуммаЛев = Окр(?(РасчетнаяСуммаЛевЧисл = 0 ИЛИ РасчетнаяСуммаЛевЗнам = 0, 0, 
		РасчетнаяСуммаЛевЧисл/РасчетнаяСуммаЛевЗнам), 1);
	РасчетнаяСуммаПрв = Окр(?(РасчетнаяСуммаПрвЧисл = 0 ИЛИ РасчетнаяСуммаПрвЗнам = 0, 0, 
		РасчетнаяСуммаПрвЧисл/РасчетнаяСуммаПрвЗнам), 1);
	
	НастройкиКС.ЭтоОшибка = НЕ РасчетнаяСуммаЛев = РасчетнаяСуммаПрв;
	НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации,
...
Процедура ПроверкаКС_1_07()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма налога в гр.5 стр.118 Раздела 3 >= гр.5 стр.(003 + 005 + 007 + 010 + 020 + 021 + 022 + 030 '") +
		НСтр("ru='+ 031 + 032 + 033 + 034 + 040 + 041 + 042 + 050 + 060 + 070 + 080 + 105 + 110 + 115) Раздела 3'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
	...
	ИменаПоказателейСуммы.Вставить("Р03С003Г5", "П000300000305");
	ИменаПоказателейСуммы.Вставить("Р03С005Г5", "П000300000505");
	ИменаПоказателейСуммы.Вставить("Р03С007Г5", "П000300000705");
...
Процедура ПроверкаКС_1_11()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма налога, подлежащей вычету в гр.3 стр.170 Раздела 3 <= гр.5 стр.(003 + 005 + 007 '") +
		НСтр("ru='+ 020 + 021 + 022 + 032 + 033 + 034 + 040) Раздела 3'"));
	...
	ИменаПоказателей.Вставить("Р03С003Г5", "П000300000305");
	ИменаПоказателей.Вставить("Р03С005Г5", "П000300000505");
	ИменаПоказателей.Вставить("Р03С007Г5", "П000300000705");
	...
	НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации,
		Показатели.Р03С170Г3.Значение, РасчетнаяСумма, Показатели.Р03С003Г5.Значение, Показатели.Р03С005Г5.Значение, 
		Показатели.Р03С007Г5.Значение, Показатели.Р03С020Г5.Значение, Показатели.Р03С021Г5.Значение, 
		Показатели.Р03С022Г5.Значение, Детализация2);
	ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_1_23_01()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Стоимость продаж по ставке 22% в стр.020 Приложения 1 к Разделу 9 >= стр.230 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_23_02()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Стоимость продаж по ставке 20% или 18% в стр.025 Приложения 1 к Разделу 9 >= стр.235 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_23_07()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма налога по ставке 22% в стр.050 Приложения 1 к Разделу 9 >= стр.260 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_23_08()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма налога по ставке 20% или 18% в стр.055 Приложения 1 к Разделу 9 >= стр.265 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_26_02()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru='58, 59, 60, 61 + стр.(280 + 291 + 292) Приложения 1 к Разделу 9 в которых стр.090 = '") +
		НСтр("ru='41, 42, 43, 44, 58, 59, 60, 61 - (стр.180 Раздела 8 в которых стр.010 = '") +
		НСтр("ru='41, 42, 43, 44, 58, 59, 60, 61 + стр.180 Приложения 1 к Разделу 8 в которых стр.010 = '") +
		НСтр("ru='41, 42, 43, 44, 58, 59, 60, 61), с учетом погрешности округления (при наличии)'"));
	...
	ИменаПоказателейР89.Вставить("Р09С200К58");
	ИменаПоказателейР89.Вставить("Р09С200К59");
	ИменаПоказателейР89.Вставить("Р09С200К60");
	ИменаПоказателейР89.Вставить("Р09С200К61");
	...
	ИменаПоказателейР89.Вставить("Р09С211К58");
	ИменаПоказателейР89.Вставить("Р09С211К59");
	ИменаПоказателейР89.Вставить("Р09С211К60");
	ИменаПоказателейР89.Вставить("Р09С211К61");
	...
	ИменаПоказателейР89.Вставить("Р09С212К58");
	ИменаПоказателейР89.Вставить("Р09С212К59");
	ИменаПоказателейР89.Вставить("Р09С212К60");
	ИменаПоказателейР89.Вставить("Р09С212К61");
	...
	ИменаПоказателейР89.Вставить("Р91С280К58");
	ИменаПоказателейР89.Вставить("Р91С280К59");
	ИменаПоказателейР89.Вставить("Р91С280К60");
	ИменаПоказателейР89.Вставить("Р91С280К61");
	...
	ИменаПоказателейР89.Вставить("Р91С291К58");
	ИменаПоказателейР89.Вставить("Р91С291К59");
	ИменаПоказателейР89.Вставить("Р91С291К60");
	ИменаПоказателейР89.Вставить("Р91С291К61");
	...
	ИменаПоказателейР89.Вставить("Р91С292К58");
	ИменаПоказателейР89.Вставить("Р91С292К59");
	ИменаПоказателейР89.Вставить("Р91С292К60");
	ИменаПоказателейР89.Вставить("Р91С292К61");
	...
	ИменаПоказателейР89.Вставить("Р08С180К58");
	ИменаПоказателейР89.Вставить("Р08С180К59");
	ИменаПоказателейР89.Вставить("Р08С180К60");
	ИменаПоказателейР89.Вставить("Р08С180К61");
	...
	ИменаПоказателейР89.Вставить("Р81С180К58");
	ИменаПоказателейР89.Вставить("Р81С180К59");
	ИменаПоказателейР89.Вставить("Р81С180К60");
	ИменаПоказателейР89.Вставить("Р81С180К61");
...
Процедура ПроверкаКС_1_34()
	...
	Заголовки.Вставить("Описание"			,
		НСтр("ru='Стоимость продаж, облагаемых налогом по ставке 22% в стр.230 Раздела 9 >= сумме стр.170 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 >= %2'"));
...
Процедура ПроверкаКС_1_39()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Стоимость продаж по ставке 22% в стр.310 Приложения 1 к Разделу 9 >= стр.(020 + 250) Приложения 1 '") +
		НСтр("ru='к Разделу 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 >= %4 (%2 + %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_45()
	...
	Заголовки.Вставить("Описание"			,
		НСтр("ru='Стоимость продаж, облагаемых налогом по ставке 20% или 18% в стр.235 Раздела 9 >= стр.175 Раздела 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Возможна ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_47()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Стоимость продаж по ставке 20% или 18% в стр.315 Приложения 1 к Разделу 9 >= стр.(025 + 255) '") +
		НСтр("ru='Приложения 1 к Разделу 9'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 >= %4 (%2 + %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Возможно ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
&НаСервере
Процедура ПроверкаКС_1_67_1()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='1.67.1'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма налога в стр.040 Раздела 1 >= стр.041 Раздела 1, если стр.041 Раздела 1 > 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 >= %2, если %2 > 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму налога стр.040 Раздела 1");
	Заголовки.Вставить("Основание"			, НСтр("ru='ст. 80 НК РФ'"));
	ПодготовитьНастройки(Заголовки);
...
&НаСервере
Процедура ПроверкаКС_1_67_код()
	
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р01С040"	, "П000100004003");
	ИменаПоказателей.Вставить("Р01С041"	, "П000100004103");
	...
	Если НастройкиКС.БольшеНуля Тогда
		НастройкиКС.ЭтоОшибка = Показатели.Р01С041.Значение > 0 И Показатели.Р01С040.Значение < Показатели.Р01С041.Значение;
	Иначе
		НастройкиКС.ЭтоОшибка = Показатели.Р01С040.Значение = 0 И НЕ Показатели.Р01С041.Значение = 0;
	КонецЕсли;
	
	НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации,
		Показатели.Р01С040.Значение, Показатели.Р01С041.Значение);
	ДополнитьТаблицуРезультата();
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_1_67_2()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='1.67.2'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Если сумма налога в стр.040 Раздела 1 = 0, то стр.041 Раздела 1 = 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='Если %1 = 0, то %2 = 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, "Укажите сумму налога в стр.041 Раздела 1 = 0");
	Заголовки.Вставить("Основание"			, НСтр("ru='ст. 80 НК РФ'"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_68()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Если сумма налога в стр.041 Раздела 1 > 0, стр.041 Раздела 1 <= стр.(200 + 211 + 212) Раздела 9, '") +
		НСтр("ru='в которых стр.010 = 52, 53 + стр.(280 + 291 + 292) Приложения 1 к Разделу 9, в которых стр.090 = '") +
		НСтр("ru='52, 53 - (стр.180 Раздела 8, в которых стр.010 = 52, 53 + стр.180 Приложения 1 к Разделу 8, '") +
		НСтр("ru='в которых стр.010 = 52, 53), с учетом погрешности округления (при наличии)'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 <= %5 (%2 - (%3 + %4) + 0,49)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Возможно ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму НДС в стр.041 Раздела 1");
	Заголовки.Вставить("Основание"			, НСтр("ru='ст.161, п.4, 4.1 ст.173 НК РФ'"));
	Заголовки.Вставить("Комментарий"		, 
		НСтр("ru='Возможно влияние погрешности в результате округления показателей'"));
	ПодготовитьНастройки(Заголовки);
	...
	ИменаПоказателейР01 = Новый Структура;
	ИменаПоказателейР01.Вставить("Р01С041"	, "П000100004103");
	
	ИменаПоказателейР89 = Новый Структура;
	ИменаПоказателейР89.Вставить("Р09С200К52");
	ИменаПоказателейР89.Вставить("Р09С200К53");
	ИменаПоказателейР89.Вставить("Р09С211К52");
	ИменаПоказателейР89.Вставить("Р09С211К53");
	ИменаПоказателейР89.Вставить("Р09С212К52");
	ИменаПоказателейР89.Вставить("Р09С212К53");
	ИменаПоказателейР89.Вставить("Р91С280К52");
	ИменаПоказателейР89.Вставить("Р91С280К53");
	ИменаПоказателейР89.Вставить("Р91С291К52");
	ИменаПоказателейР89.Вставить("Р91С291К53");
	ИменаПоказателейР89.Вставить("Р91С292К52");
	ИменаПоказателейР89.Вставить("Р91С292К53");
	ИменаПоказателейР89.Вставить("Р08С180К52");
	ИменаПоказателейР89.Вставить("Р08С180К53");
	ИменаПоказателейР89.Вставить("Р81С180К52");
	ИменаПоказателейР89.Вставить("Р81С180К53");
	
	ПоказателиР01 = СформироватьПоказатели(ИменаПоказателейР01);
	ПоказателиР89 = СформироватьПоказатели(ИменаПоказателейР89);
	ЗарегистрироватьПроверку();
	
	ЗаполнитьИРасшифроватьПоказатель(ПоказателиР01.Р01С041, ДанныеКС.ДанныеР01);
	УсловиеВыполнено = ЗначениеЗаполнено(ПоказателиР01.Р01С041.Значение);
	...
	РасчетнаяСумма = Окр(Сумма09_200 + Сумма09_211 + Сумма09_212 + Сумма91_280 + Сумма91_291 + Сумма91_292 -
		Сумма08_180 - Сумма81_180 + 0.49);
	НастройкиКС.ЭтоОшибка = УсловиеВыполнено И ПоказателиР01.Р01С041.Значение > РасчетнаяСумма;
	РасшифровкаР9 = СтрШаблон(ШаблонДетализацииР9,
		Сумма09_200, Сумма09_211, Сумма09_212, Сумма91_280, Сумма91_291, Сумма91_292);
	НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации,
		ПоказателиР01.Р01С041.Значение, РасшифровкаР9, Сумма08_180, Сумма81_180, РасчетнаяСумма);
	ДополнитьТаблицуРезультата();
...
Процедура ЗаполнитьСтруктуруЗависимыхЯчеекДляАвторасчета()
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000300000305", "П000300000303");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000300000505", "П000300000503");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000300000705", "П000300000703");
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000300011805", "П000300000303;П000300000503;П000300000703;П000300001003;П000300002003;П000300002103;П000300002203;П000300003003;П000300003103;П000300003203;П000300003303;П000300003403;П000300004003;П000300004103;П000300004203;П000300005005;П000300006003;П000300007005;П000300008005;П000300010505;П000300011005;П000300011505");
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000300020003", "П000300000303;П000300000503;П000300000703;П000300001003;П000300002003;П000300002103;П000300002203;П000300003003;П000300003103;П000300003203;П000300003303;П000300003403;П000300004003;П000300004103;П000300004203;П000300005005;П000300006003;П000300007005;П000300008005;П000300010505;П000300011005;П000300011505;П000300012003;П000300013003;П000300013503;П000300014003;П000300015003;П000300016003;П000300017003;П000300018003;П000300018503");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000300021003", "П000300000303;П000300000503;П000300000703;П000300001003;П000300002003;П000300002103;П000300002203;П000300003003;П000300003103;П000300003203;П000300003303;П000300003403;П000300004003;П000300004103;П000300004203;П000300005005;П000300006003;П000300007005;П000300008005;П000300010505;П000300011005;П000300011505;П000300012003;П000300013003;П000300013503;П000300014003;П000300015003;П000300016003;П000300017003;П000300018003;П000300018503");
...
Процедура СформироватьСпискиВыбора()
	...
	МакетСоставаПоказателей = ОбъектОтчета(ИмяФормы).ПолучитьМакет("Списки2026Кв1");
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "Период", 2, ,
		"Выбор кода периода", КоллекцияСписковВыбора[?(СтруктураРеквизитовФормы.ИП,
		"КодыНалоговыхПериодов_ИП", "КодыНалоговыхПериодов_ЮЛ")]);
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П0001М1005503", 2, ,
		"Выбор кода основания", КоллекцияСписковВыбора["КодыОснованияПримененияЗПВН"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000100008503", 1, ,
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000200004003", 20, ,
		"Выбор КБК", КоллекцияСписковВыбора["КодыБюджетнойКлассификации_Раздел2"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000200007003", 7, ,
		"Выбор кода операции", КоллекцияСписковВыбора["КодыОпераций_Раздел2"]);
	
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000310002001", 7, ,
		"Выбор кода операции", КоллекцияСписковВыбора["КодыОпераций_Раздел3_Прил1"]);
	
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П0004М1001003", 7, ,
		"Выбор кода операции", КоллекцияСписковВыбора["КодыОпераций_Раздел4"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П0004М2006003", 7, ,
		"Выбор кода операции", КоллекцияСписковВыбора["КодыОпераций_Раздел4"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П0004М3009003", 7, ,
		"Выбор кода операции", КоллекцияСписковВыбора["КодыОпераций_Раздел4"]);
	
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000500002003", 2, ,
		"Выбор кода периода", КоллекцияСписковВыбора["КодыНалоговыхПериодов_Раздел5"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000500003003", 7, ,
		"Выбор кода операции", КоллекцияСписковВыбора["КодыОпераций_Раздел5"]);
	
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П0006М1001003", 7, ,
		"Выбор кода операции", КоллекцияСписковВыбора["КодыОпераций_Раздел6"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П0006М2007003", 7, ,
		"Выбор кода операции", КоллекцияСписковВыбора["КодыОпераций_Раздел6"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П0006М3011003", 7, ,
		"Выбор кода операции", КоллекцияСписковВыбора["КодыОпераций_Раздел6"]);
	
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000700000101", 7, ,
		"Выбор кода операции", КоллекцияСписковВыбора["КодыОпераций_Раздел7"]);
	...
	ИначеЕсли ИмяСтраницыПанели = "Раздел3" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяСтраницыПанели Тогда
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000300000305, ОбластьИмя) > 0 Тогда
				ОкрП000300000303 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(
					Форма, Форма.ТабличныйДокумент.Области.П000300000303.Значение);
				Форма.ТабличныйДокумент.Области.П000300000305.Значение = ОкрП000300000303 * 22 / 100;
			КонецЕсли;
			
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000300000505, ОбластьИмя) > 0 Тогда
				ОкрП000300000503 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(
					Форма, Форма.ТабличныйДокумент.Области.П000300000503.Значение);
				Форма.ТабличныйДокумент.Области.П000300000505.Значение = ОкрП000300000503 * 22 / 122;
			КонецЕсли;
			
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000300000705, ОбластьИмя) > 0 Тогда
				ОкрП000300000703 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(
					Форма, Форма.ТабличныйДокумент.Области.П000300000703.Значение);
				Форма.ТабличныйДокумент.Области.П000300000705.Значение = ОкрП000300000703 * 18.03 / 100;
			КонецЕсли;
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				...
				ОкрП000300000305 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(
					Форма, Форма.ТабличныйДокумент.Области.П000300000305.Значение);
				ОкрП000300000505 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(
					Форма, Форма.ТабличныйДокумент.Области.П000300000505.Значение);
				ОкрП000300000705 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(
					Форма, Форма.ТабличныйДокумент.Области.П000300000705.Значение);
				...
				Форма.ТабличныйДокумент.Области.П000300011805.Значение
					= ОкрП000300000305 + ОкрП000300000505 + ОкрП000300000705 + ОкрП000300001005 + ОкрП000300002005
					+ ОкрП000300002105 + ОкрП000300002205 + ОкрП000300003005 + ОкрП000300003105 + ОкрП000300003205
					+ ОкрП000300003305 + ОкрП000300003405 + ОкрП000300004005 + ОкрП000300004105 + ОкрП000300004205
					+ ОкрП000300005005 + ОкрП000300006005 + ОкрП000300007005 + ОкрП000300008005 + ОкрП000300010505
					+ ОкрП000300011005 + ОкрП000300011505;
		...
		Иначе
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000300000305, ОбластьИмя) > 0 Тогда
				ОкрП000300000303 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(
					Форма, Форма.СтруктураДанныхРаздел3.П000300000303);
				Форма.СтруктураДанныхРаздел3.П000300000305 = ОкрП000300000303 * 22 / 100;
			КонецЕсли;
			
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000300000505, ОбластьИмя) > 0 Тогда
				ОкрП000300000503 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(
					Форма, Форма.СтруктураДанныхРаздел3.П000300000503);
				Форма.СтруктураДанныхРаздел3.П000300000505 = ОкрП000300000503 * 22 / 122;
			КонецЕсли;
			
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000300000705, ОбластьИмя) > 0 Тогда
				ОкрП000300000703 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(
					Форма, Форма.СтруктураДанныхРаздел3.П000300000703);
				Форма.СтруктураДанныхРаздел3.П000300000705 = ОкрП000300000703 * 18.03 / 100;
			КонецЕсли;
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(
				...
				ОкрП000300000305 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(
					Форма, Форма.СтруктураДанныхРаздел3.П000300000305);
				ОкрП000300000505 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(
					Форма, Форма.СтруктураДанныхРаздел3.П000300000505);
				ОкрП000300000705 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(
					Форма, Форма.СтруктураДанныхРаздел3.П000300000705);
				ОкрП000300001005 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(
...
Процедура ПриОткрытииЗавершение(Отказ, ДополнительныеПараметры) Экспорт
	...
	ИначеЕсли РезультатЗапуска <> Неопределено И РезультатЗапуска.Статус = "Выполнено" Тогда
		ОбработатьЗавершениеАвтозаполненияВФоне(РезультатЗапуска, Неопределено);
	КонецЕсли;
...
Процедура УстановитьДоступностьОбластей(Форма, ИмяТекРаздела)
	...
	ИначеЕсли ИмяТекРаздела = "Раздел1" Тогда
		...
		Если ЗначениеЗаполнено(Форма.ТабличныйДокумент.Области.П000100001003.Значение) Тогда
			...
			РазрешитьВводДанныхВОбласть(Форма, Форма.ТабличныйДокумент.Области.П000100004103);
		...
		Иначе
			...
			ЗапретитьВводДанныхВОбласть(Форма.мСтруктураЦветовРаскраски, Форма.ТабличныйДокумент.Области.П000100004103);
...
Функция ЗаполнитьАвтоНаСервере()
	...
	ЭтаФормаИмя = "ВнешнийОтчет.РегламентированныйОтчетНДС.Форма.ФормаОтчета2026Кв1";
...
Процедура ПроставитьНаВсехЛистах(Форма, Знач ЗначениеПоказателя)
	...
	Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел1" Тогда
		ЗаполненаХотяБыОднаИзСтрок030_040_041_050Раздела1
		...
		ИЛИ ЗначениеЗаполнено(Форма.ТабличныйДокумент.Область("П000100004103").Значение)
		ИЛИ ЗначениеЗаполнено(Форма.ТабличныйДокумент.Область("П000100005003").Значение);
	Иначе
		ЗаполненаХотяБыОднаИзСтрок030_040_041_050Раздела1 = Ложь;
		Если Форма.СтруктураДанныхРаздел1.Свойство("П000100003003") Тогда
			ЗаполненаХотяБыОднаИзСтрок030_040_041_050Раздела1 = ЗаполненаХотяБыОднаИзСтрок030_040_041_050Раздела1
		...
		КонецЕсли;
		Если Форма.СтруктураДанныхРаздел1.Свойство("П000100004103") Тогда
			ЗаполненаХотяБыОднаИзСтрок030_040_041_050Раздела1 = ЗаполненаХотяБыОднаИзСтрок030_040_041_050Раздела1
			ИЛИ ЗначениеЗаполнено(Форма.СтруктураДанныхРаздел1.П000100004103);
		КонецЕсли;
	...
	Если КодПоМесту = "231" И НЕ ЗаполненаХотяБыОднаИзСтрок030_040_041_050Раздела1 Тогда
...
Процедура ПроверитьВозможностьВыгрузкиВФоне()
	...
	ШаблоныОшибок = Отчеты.РегламентированныйОтчетНДС.ПолучитьМакет("ШаблоныСообщенийОбОшибках2026Кв1");
