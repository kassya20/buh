...
Процедура ТабличныйДокументПриАктивизации(Элемент)
	...
	Если СтрЧислоВхождений(ТабличныйДокумент.ТекущаяОбласть.Имя, "УдалитьСтроку") = 0
		И (СтрНачинаетсяС(ТабличныйДокумент.ТекущаяОбласть.Имя, "П0001М1")
		ИЛИ СтрЧислоВхождений(ТабличныйДокумент.ТекущаяОбласть.Имя, "П0003200001") > 0
		ИЛИ СтрНачинаетсяС(ТабличныйДокумент.ТекущаяОбласть.Имя, "П0004М1")
		ИЛИ СтрНачинаетсяС(ТабличныйДокумент.ТекущаяОбласть.Имя, "П0004М2")
		ИЛИ СтрНачинаетсяС(ТабличныйДокумент.ТекущаяОбласть.Имя, "П0004М3")
		ИЛИ СтрНачинаетсяС(ТабличныйДокумент.ТекущаяОбласть.Имя, "П0006М1")
		ИЛИ СтрНачинаетсяС(ТабличныйДокумент.ТекущаяОбласть.Имя, "П0006М2")
		ИЛИ СтрНачинаетсяС(ТабличныйДокумент.ТекущаяОбласть.Имя, "П0006М3")
		ИЛИ СтрЧислоВхождений(ТабличныйДокумент.ТекущаяОбласть.Имя, "П0007000001") > 0
		ИЛИ ((СтрЧислоВхождений(ТабличныйДокумент.ТекущаяОбласть.Имя, "П00050000") > 0)
		И СтрЧислоВхождений(ТабличныйДокумент.ТекущаяОбласть.Имя, "_") > 0)) Тогда
