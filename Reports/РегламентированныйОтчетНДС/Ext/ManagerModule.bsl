...
Функция ТаблицаФормОтчета() Экспорт
	...
	НоваяФорма.ОписаниеОтчета     = "Утверждена приказом Минфина РФ от 15.10.2009 № 104н.";
	...
	НоваяФорма.ОписаниеОтчета =
		"Утверждена приказом Минфина РФ от 15.10.2009 № 104н (в ред. приказа Минфина РФ от 21.04.2010 № 36н).";
	...
	НоваяФорма.ОписаниеОтчета     = "Утверждена приказом ФНС России от 29.10.2014 № ММВ-7-3/558@.";
	...
	НоваяФорма.ОписаниеОтчета =
		"Утверждена приказом ФНС России от 29.10.2014 № ММВ-7-3/558@ (в ред. приказа ФНС России от 20.12.2016 № ММВ-7-3/696@).";
	...
	НоваяФорма.ОписаниеОтчета =
		"Утверждена приказом ФНС России от 29.10.2014 № ММВ-7-3/558@ (в ред. приказа ФНС России от 28.12.2018 № СА-7-3/853@).";
	...
	НоваяФорма.ОписаниеОтчета =
		"Утверждена приказом ФНС России от 29.10.2014 № ММВ-7-3/558@ (в ред. приказа ФНС России от 19.08.2020 № ЕД-7-3/591@).";
	...
	НоваяФорма.ОписаниеОтчета =
		"Утверждена приказом ФНС России от 29.10.2014 № ММВ-7-3/558@ (в ред. приказа ФНС России от 12.12.2022 № ЕД-7-3/1191@).";
	...
	НоваяФорма.ОписаниеОтчета =
		"Утверждена приказом ФНС России от 29.10.2014 № ММВ-7-3/558@ (в ред. приказа ФНС России от 24.12.2021 № ЕД-7-3/1149@).";
	...
	НоваяФорма.ОписаниеОтчета =
		"Утверждена приказом ФНС России от 29.10.2014 № ММВ-7-3/558@ (в ред. приказа ФНС России от 26.03.2021 № ЕД-7-3/228@).";
	...
	НоваяФорма.ОписаниеОтчета =
		"Утверждена приказом ФНС России от 05.11.2024 № ЕД-7-3/989@ (в ред. приказа ФНС России от 18.12.2025 № ЕД-7-3/1227@).";
	НоваяФорма.РедакцияФормы      = "от 18.12.2025 № ЕД-7-3/1227@).";
	Если ТекущаяДатаСеанса() >= ДатаПримененияФормыВНовойРедакции() Тогда
		НоваяФорма.ДатаНачалоДействия = '2026-01-01';
	Иначе
		НоваяФорма.ДатаНачалоДействия = '2026-04-01';
	КонецЕсли;
	НоваяФорма.ДатаКонецДействия  = РегламентированнаяОтчетностьКлиентСервер.ПустоеЗначениеТипа(Тип("Дата"));
	
	НоваяФорма = ТаблицаФормОтчета.Добавить();
	НоваяФорма.ФормаОтчета        = "ФормаОтчета2025Кв1";
	НоваяФорма.ОписаниеОтчета     = "Утверждена приказом ФНС России от 05.11.2024 № ЕД-7-3/989@.";
	НоваяФорма.РедакцияФормы      = "от 05.11.2024 № ЕД-7-3/989@.";
	НоваяФорма.ДатаНачалоДействия = '2025-01-01';
	НоваяФорма.ДатаКонецДействия  = '2026-03-31';
...
Функция ДанныеДляРасчетаНалога(ЭкземплярРеглОтчета) Экспорт
	...
	Если ЭкземплярРеглОтчета.ВыбраннаяФорма = "ФормаОтчета2026Кв1"
		...
		// Начисления.
		КодРеализация22         = "П000300000305";
		КодРеализация22_122     = "П000300000505";
		КодРеализация18_03      = "П000300000705";
		...
		ДанныеДляРасчетаНалога.Реализация = ПоказателиОтчета[КодРеализация20] + ПоказателиОтчета[КодРеализация10]
			+ ПоказателиОтчета[КодРеализация20_120] + ПоказателиОтчета[КодРеализация10_110]
			+ ПоказателиОтчета[КодРеализация18] + ПоказателиОтчета[КодРеализация18_118];
		
		Если ВРег(ЭкземплярРеглОтчета.ВыбраннаяФорма) = ВРег("ФормаОтчета2026Кв1") Тогда
			
			ДанныеДляРасчетаНалога.Реализация = ДанныеДляРасчетаНалога.Реализация + ПоказателиОтчета[КодРеализация22]
				+ ПоказателиОтчета[КодРеализация22_122] + ПоказателиОтчета[КодРеализация18_03];
			
		КонецЕсли;
		
		Если ВРег(ЭкземплярРеглОтчета.ВыбраннаяФорма) = ВРег("ФормаОтчета2026Кв1")
			ИЛИ ВРег(ЭкземплярРеглОтчета.ВыбраннаяФорма) = ВРег("ФормаОтчета2025Кв1") Тогда
			
			ДанныеДляРасчетаНалога.Реализация = ДанныеДляРасчетаНалога.Реализация + ПоказателиОтчета[КодРеализация7]
				+ ПоказателиОтчета[КодРеализация5] + ПоказателиОтчета[КодРеализация16_67] + ПоказателиОтчета[КодРеализация9_09]
				+ ПоказателиОтчета[КодРеализация7_107] + ПоказателиОтчета[КодРеализация5_105];
...
Функция ДеревоФормИФорматов() Экспорт
	...
	"1151001", '20251218', "ЕД-7-3/1227@", "ФормаОтчета2026Кв1", '20260101');
	ОпределитьФорматВДеревеФормИФорматов(Форма2026Кв1, "5.12");
