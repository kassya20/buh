...
Процедура ЗаполнитьРаздел1ПоУмолчанию(ИмяФормы, СтруктураДанныхРаздел1, СтруктураРеквизитовФормы) Экспорт
	...
	Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
		...
		Если НЕ СтруктураДанныхРаздел1.Свойство("П000100004103") Тогда
			СтруктураДанныхРаздел1.Вставить("П000100004103", 0);
		КонецЕсли;
	...
	Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1")
		...
		Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
			...
			ОкрП000300000303 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(
				ФорматОкругленияЧисла, РазделыОтчета.Раздел3.Данные.П000300000303);
			РазделыОтчета.Раздел3.Данные.П000300000305 = ОкрП000300000303 * 22 / 100;
			
			ОкрП000300000503 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(
				ФорматОкругленияЧисла, РазделыОтчета.Раздел3.Данные.П000300000503);
			РазделыОтчета.Раздел3.Данные.П000300000505 = ОкрП000300000503 * 22 / 122;
			
			ОкрП000300000703 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(
				ФорматОкругленияЧисла, РазделыОтчета.Раздел3.Данные.П000300000703);
			РазделыОтчета.Раздел3.Данные.П000300000705 = ОкрП000300000703 * 18.03 / 100;
		...
		Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
			...
			ОкрП000300000305 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(
				ФорматОкругленияЧисла, РазделыОтчета.Раздел3.Данные.П000300000305);
			ОкрП000300000505 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(
				ФорматОкругленияЧисла, РазделыОтчета.Раздел3.Данные.П000300000505);
			ОкрП000300000705 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(
				ФорматОкругленияЧисла, РазделыОтчета.Раздел3.Данные.П000300000705);
		...
		Иначе// "ФормаОтчета2025Кв1"
			...
			РазделыОтчета.Раздел3.Данные.П000300011805
				= ОкрП000300001005 + ОкрП000300002005 + ОкрП000300002105 + ОкрП000300002205 + ОкрП000300003005
				+ ОкрП000300003105 + ОкрП000300003205 + ОкрП000300003305 + ОкрП000300003405 + ОкрП000300004005
				+ ОкрП000300004105 + ОкрП000300004205 + ОкрП000300005005 + ОкрП000300006005 + ОкрП000300007005
				+ ОкрП000300008005 + ОкрП000300010505 + ОкрП000300011005 + ОкрП000300011505;
...
Функция УниверсальнаяВыгрузка(Параметры) Экспорт
	...
	Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
		РезультатВыгрузки.Вставить("ТипФайлаВыгрузки", "НДС2026Разделы1_7");
...
Функция ИзвлечьСтруктуруXML(ИмяФормы) Экспорт
	...
	Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
		ИмяМакетаСтруктурыВыгрузки = "СхемаВыгрузки512";
	ИначеЕсли ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2025Кв1") Тогда
...
Процедура ЗаполнитьСодержательнуюЧасть(ИмяФормы, ДанныеОтчета, СтруктураРеквизитовФормы, УзелРодитель)
	...
	Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
		...
		ЗадатьЗначениеЭлемента(ИмяФормы, УзелСумУплНП, "СумСрокПр1992", Раздел1.П000100004103);
...
Функция ВыгрузкаРаздел8(ИмяФормы, СтруктураРеквизитовФормы, СписокСтраницРаздела, ПараметрыВыгрузки)
	...
	Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
		КомпоновщикXML_ВывестиАтрибут(ИмяФормы, КомпоновщикXML, "ВерсФорм", "5.12");
	ИначеЕсли ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2025Кв1") Тогда
	...
	Если ПараметрыВыгрузки.ВидДок <> "0" Тогда
		КомпоновщикXML_ВывестиАтрибут(ИмяФормы, КомпоновщикXML, "ПризнСвед8",
	...
	Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
		РезультатВыгрузки.Вставить("ТипФайлаВыгрузки", "НДС2026" + ИмяРаздела);
	ИначеЕсли ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2025Кв1") Тогда
...
Процедура ВыгрузитьСтрокуСведенийРаздела8(ИмяФормы, КомпоновщикXML, СтрокаДанных)
	...
	Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
		...
		Для Инд = 0 По СтрокаДанных.СвЧастСчФ.Количество() - 1 Цикл
			КомпоновщикXML_СоздатьУзел(ИмяФормы, КомпоновщикXML, "СвЧастСчФ");
			
			КомпоновщикXML_ВывестиАтрибут(ИмяФормы, КомпоновщикXML, "НомЧастСчФ",
				СтрокаДанных.СвЧастСчФ[Инд].НомЧастСчФ, "Т,1000");
			КомпоновщикXML_ВывестиАтрибут(ИмяФормы, КомпоновщикXML, "ДатаЧастСчФ",
				СтрокаДанных.СвЧастСчФ[Инд].ДатаЧастСчФ, "Т,10");
	...
	Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1")
		...
		ВыгрузитьСведенияОПрослеживаемомТоваре(ИмяФормы, КомпоновщикXML, СтрокаДанных);
...
Функция ВыгрузкаРаздел9(ИмяФормы, СтруктураРеквизитовФормы, СписокСтраницРаздела, ПараметрыВыгрузки)
	...
	Если ПараметрыВыгрузки.ВидДок = "0" ИЛИ ПараметрыВыгрузки["АктуальностьСведений" + ИмяРаздела] = "0" Тогда
		...
		Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
			...
			КомпоновщикXML_ВывестиНеобязательныйАтрибут(ИмяФормы, КомпоновщикXML, "СтПродБезНДС22",
				ИтогиРаздела.СтПродБезНДС22, "Ч,19,2");
		...
		Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
			...
			КомпоновщикXML_ВывестиНеобязательныйАтрибут(ИмяФормы, КомпоновщикXML, "СумНДСВсКПр22",
				ИтогиРаздела.СумНДСВсКПр22, "Ч,19,2");
...
Процедура ВыгрузитьСтрокуСведенийРаздела9(ИмяФормы, КомпоновщикXML, СтрокаДанных)
	...
	КомпоновщикXML_ВывестиНеобязательныйАтрибут(ИмяФормы, КомпоновщикXML, "НомИспрСчФ",
		СтрокаДанных.НомИспрСчФ, "Ч,3");
	КомпоновщикXML_ВывестиНеобязательныйАтрибут(ИмяФормы, КомпоновщикXML, "ДатаИспрСчФ",
		СтрокаДанных.ДатаИспрСчФ, "Т,10");
	
	КомпоновщикXML_ВывестиНеобязательныйАтрибут(ИмяФормы, КомпоновщикXML, "НомКСчФПрод",
		СтрокаДанных.НомКСчФПрод, "Т,256");
	КомпоновщикXML_ВывестиНеобязательныйАтрибут(ИмяФормы, КомпоновщикXML, "ДатаКСчФПрод",
		СтрокаДанных.ДатаКСчФПрод, "Т,10");
	
	КомпоновщикXML_ВывестиНеобязательныйАтрибут(ИмяФормы, КомпоновщикXML, "НомИспрКСчФ", СтрокаДанных.НомИспрКСчФ, "Ч,3");
	КомпоновщикXML_ВывестиНеобязательныйАтрибут(ИмяФормы, КомпоновщикXML, "ДатаИспрКСчФ",
		СтрокаДанных.ДатаИспрКСчФ, "Т,10");
	...
	ВыгружатьНулевойАтрибут_СтоимПродСФ
		= НЕ ЗначениеЗаполнено(СтрокаДанных.СтоимПродСФ) И НЕ ЗначениеЗаполнено(СтрокаДанных.СтоимПродОсв);
	...
	Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
		...
		КомпоновщикXML_ВывестиНеобязательныйАтрибут(ИмяФормы, КомпоновщикXML, "СтоимПродСФ22",
			СтрокаДанных.СтоимПродСФ22, "Ч,19,2");
	...
	Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
		...
		ВыгружатьНулевойАтрибут_СумНДССФ22 = ЗначениеЗаполнено(СтрокаДанных.СтоимПродСФ22);
		Если ВыгружатьНулевойАтрибут_СумНДССФ22 Тогда
			КомпоновщикXML_ВывестиАтрибут(ИмяФормы, КомпоновщикXML, "СумНДССФ22", СтрокаДанных.СумНДССФ22, "Ч,19,2");
		Иначе
			КомпоновщикXML_ВывестиНеобязательныйАтрибут(ИмяФормы, КомпоновщикXML, "СумНДССФ22",
				СтрокаДанных.СумНДССФ22, "Ч,19,2");
		КонецЕсли;
	...
	Иначе// "ФормаОтчета2020Кв4", "ФормаОтчета2019Кв1", "ФормаОтчета2017Кв1"
		...
		Для Инд = 0 По СтрокаДанных.РегНомТД.Количество() - 1 Цикл
			КомпоновщикXML_ВывестиНеобязательныйМножественныйЭлемент(ИмяФормы, КомпоновщикXML, "РегНомТД",
				СтрокаДанных.РегНомТД[Инд], "Т,27");
		КонецЦикла;
	...
	Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1")
		...
		Для Инд = 0 По СтрокаДанных.КодВидТовар.Количество() - 1 Цикл
			КомпоновщикXML_ВывестиНеобязательныйМножественныйЭлемент(ИмяФормы, КомпоновщикXML, "КодВидТовар",
				СтрокаДанных.КодВидТовар[Инд], "Т,10");
		КонецЦикла;
	КонецЕсли;
...
Функция ВыгрузкаРаздел9_Прил1(ИмяФормы, СтруктураРеквизитовФормы, СписокСтраницРаздела, ПараметрыВыгрузки)
	...
	Если ПараметрыВыгрузки.ВидДок = "0" ИЛИ ПараметрыВыгрузки["АктуальностьСведений" + ИмяРаздела] = "0" Тогда
		...
		Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
			...
			КомпоновщикXML_ВывестиНеобязательныйАтрибут(ИмяФормы, КомпоновщикXML, "ИтСтПродКПр22",
				ИтогиРаздела.ИтСтПродКПр22, "Ч,19,2");
		...
		Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
			...
			КомпоновщикXML_ВывестиНеобязательныйАтрибут(ИмяФормы, КомпоновщикXML, "СумНДСИтКПр22",
				ИтогиРаздела.СумНДСИтКПр22, "Ч,19,2");
		...
		Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
			...
			КомпоновщикXML_ВывестиНеобязательныйАтрибут(ИмяФормы, КомпоновщикXML, "СтПродВсП1Р9_22",
				ИтогиРаздела.СтПродВсП1Р9_22, "Ч,19,2");
		...
		Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
			...
			КомпоновщикXML_ВывестиНеобязательныйАтрибут(ИмяФормы, КомпоновщикXML, "СумНДСВсП1Р9_22",
				ИтогиРаздела.СумНДСВсП1Р9_22, "Ч,19,2");
...
Процедура ВыгрузитьСтрокуСведенийРаздела10(ИмяФормы, КомпоновщикXML, СтрокаДанных)
	...
	Для Инд = 0 По СтрокаДанных.СвСчФОтПрод.Количество() -1 Цикл
		...
		Если ВыгружатьАтрибуты_СтоимТовСчФВс_СумНДССчФ Тогда
			КомпоновщикXML_ВывестиАтрибут(ИмяФормы, КомпоновщикXML, "СтоимТовСчФВс",
				ДанныеОДеятельности.СтоимТовСчФВс, "Ч,19,2");
			КомпоновщикXML_ВывестиАтрибут(ИмяФормы, КомпоновщикXML, "СумНДССчФ", ДанныеОДеятельности.СумНДССчФ, "Ч,19,2");
		КонецЕсли;
		
		ЕстьКорректировкаСчетаФактуры
			= ЗначениеЗаполнено(СтрокаДанных.НомКСчФПрод) ИЛИ ЗначениеЗаполнено(СтрокаДанных.ДатаКСчФПрод)
			ИЛИ ЗначениеЗаполнено(СтрокаДанных.НомИспрКСчФ) ИЛИ ЗначениеЗаполнено(СтрокаДанных.ДатаИспрКСчФ);
		
		ВыгружатьНулевойАтрибут_РазСтКСчФУм
			= ЕстьКорректировкаСчетаФактуры И НЕ ЗначениеЗаполнено(ДанныеОДеятельности.РазСтКСчФУв);
		...
		ВыгружатьНулевойАтрибут_РазСтКСчФУв = ЕстьКорректировкаСчетаФактуры
			И НЕ ЗначениеЗаполнено(ДанныеОДеятельности.РазСтКСчФУм) И НЕ ВыгружатьНулевойАтрибут_РазСтКСчФУм;
		...
		ВыгружатьНулевойАтрибут_РазНДСКСчФУм
			= ВыгружатьНулевойАтрибут_РазСтКСчФУм ИЛИ ЗначениеЗаполнено(ДанныеОДеятельности.РазСтКСчФУм);
		...
		ВыгружатьНулевойАтрибут_РазНДСКСчФУв
			= ВыгружатьНулевойАтрибут_РазСтКСчФУв ИЛИ ЗначениеЗаполнено(ДанныеОДеятельности.РазСтКСчФУв);
		...
		Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1")
			...
			ВыгрузитьСведенияОПрослеживаемомТоваре(ИмяФормы, КомпоновщикXML, ДанныеОДеятельности);
...
Процедура ВыгрузитьСтрокуСведенийРаздела11(ИмяФормы, КомпоновщикXML, СтрокаДанных)
	...
	Иначе
		КомпоновщикXML_ВывестиНеобязательныйАтрибут(ИмяФормы, КомпоновщикXML, "РазСтКСчФУм",
			СтрокаДанных.РазСтКСчФУм, "Ч,19,2");
	КонецЕсли;
	...
	Иначе
		КомпоновщикXML_ВывестиНеобязательныйАтрибут(ИмяФормы, КомпоновщикXML, "РазСтКСчФУв",
			СтрокаДанных.РазСтКСчФУв, "Ч,19,2");
	КонецЕсли;
	
	ВыгружатьНулевойАтрибут_РазНДСКСчФУм
		= ВыгружатьНулевойАтрибут_РазСтКСчФУм ИЛИ ЗначениеЗаполнено(СтрокаДанных.РазСтКСчФУм);
	Если ВыгружатьНулевойАтрибут_РазНДСКСчФУм Тогда
		КомпоновщикXML_ВывестиАтрибут(ИмяФормы, КомпоновщикXML, "РазНДСКСчФУм", СтрокаДанных.РазНДСКСчФУм, "Ч,19,2");
	Иначе
		КомпоновщикXML_ВывестиНеобязательныйАтрибут(ИмяФормы, КомпоновщикXML, "РазНДСКСчФУм",
			СтрокаДанных.РазНДСКСчФУм, "Ч,19,2");
	КонецЕсли;
	
	ВыгружатьНулевойАтрибут_РазНДСКСчФУв
		= ВыгружатьНулевойАтрибут_РазСтКСчФУв ИЛИ ЗначениеЗаполнено(СтрокаДанных.РазСтКСчФУв);
	Если ВыгружатьНулевойАтрибут_РазНДСКСчФУв Тогда
		КомпоновщикXML_ВывестиАтрибут(ИмяФормы, КомпоновщикXML, "РазНДСКСчФУв", СтрокаДанных.РазНДСКСчФУв, "Ч,19,2");
	Иначе
		КомпоновщикXML_ВывестиНеобязательныйАтрибут(ИмяФормы, КомпоновщикXML, "РазНДСКСчФУв",
			СтрокаДанных.РазНДСКСчФУв, "Ч,19,2");
	КонецЕсли;
...
Процедура ВыгрузитьСведенияОПрослеживаемомТоваре(ИмяФормы, КомпоновщикXML, СтрокаДанных)
	
	Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
		
		СтрокаФормата_СтоимТовПросл = "Ч,19,2";
		
	Иначе// "ФормаОтчета2025Кв1", "ФормаОтчета2023Кв1", "ФормаОтчета2022Кв1", "ФормаОтчета2021Кв3"
		
		СтрокаФормата_СтоимТовПросл = "Ч,17";
	...
	Для Инд = 0 По СтрокаДанных.СвРегНом.Количество() - 1 Цикл
		...
		КомпоновщикXML_ВывестиАтрибут(ИмяФормы, КомпоновщикXML, "РегНомПросл",
			СтрокаДанных.СвРегНом[Инд].РегНомПросл, "Т,29");
		
		Если ЗначениеЗаполнено(СтрокаДанных.СвРегНом[Инд].ОКЕИ) Тогда
			
			КомпоновщикXML_ВывестиАтрибут(ИмяФормы, КомпоновщикXML, "ОКЕИ",
				СтрокаДанных.СвРегНом[Инд].ОКЕИ, "Т,4");
			
			КомпоновщикXML_ВывестиАтрибут(ИмяФормы, КомпоновщикXML, "КолТовПросл",
				СтрокаДанных.СвРегНом[Инд].КолТовПросл, "Ч,10");
			
			КомпоновщикXML_ВывестиАтрибут(ИмяФормы, КомпоновщикXML, "СтоимТовПросл",
				СтрокаДанных.СвРегНом[Инд].СтоимТовПросл, СтрокаФормата_СтоимТовПросл);
			
		Иначе
			
			КомпоновщикXML_ВывестиНеобязательныйАтрибут(ИмяФормы, КомпоновщикXML, "ОКЕИ",
				СтрокаДанных.СвРегНом[Инд].ОКЕИ, "Т,4");
			
			КомпоновщикXML_ВывестиНеобязательныйАтрибут(ИмяФормы, КомпоновщикXML, "КолТовПросл",
				СтрокаДанных.СвРегНом[Инд].КолТовПросл, "Ч,10");
			
			КомпоновщикXML_ВывестиНеобязательныйАтрибут(ИмяФормы, КомпоновщикXML, "СтоимТовПросл",
				СтрокаДанных.СвРегНом[Инд].СтоимТовПросл, СтрокаФормата_СтоимТовПросл);
	...
	Для Каждого Запись Из Данные.Записи Цикл
		...
		Если СтруктураПараметров.ИмяСтраницы = "Раздел8" Тогда
			...
			Если Запись <> "" И НЕ (СтруктураРеквизитовФормы.АктуальностьСведенийРаздел8 = 1
				...
				ТекКолвоСтрокБлокаРаздел8_4 = 0;
				
				ИсхКолвоСтрокБлокаРаздел8_1 = 7;
				ИсхКолвоСтрокБлокаРаздел8_2 = 1;
				ИсхКолвоСтрокБлокаРаздел8_3 = 1;
				ИсхКолвоСтрокБлокаРаздел8_4 = 0;
				
				Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
					
					ТекКолвоСтрокБлокаРаздел8_4 = Запись.СвЧастСчФ.Количество();
					ИсхКолвоСтрокБлокаРаздел8_4 = 1;
				...
				Если (ТекКолвоСтрокБлокаРаздел8_1 > 0 И ИсхКолвоСтрокБлокаРаздел8_1 > 0)
					...
					ИЛИ (ТекКолвоСтрокБлокаРаздел8_3 > 0 И ИсхКолвоСтрокБлокаРаздел8_3 > 0)
					ИЛИ (ТекКолвоСтрокБлокаРаздел8_4 > 0 И ИсхКолвоСтрокБлокаРаздел8_4 > 0) Тогда
					...
					ДробноеКолвоЛистовМЧБ = Макс(
						...
						?(ТекКолвоСтрокБлокаРаздел8_4 > ИсхКолвоСтрокБлокаРаздел8_4, ТекКолвоСтрокБлокаРаздел8_4 / ИсхКолвоСтрокБлокаРаздел8_4, 1));
					...
					Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
						...
						СтрокиБлокаРаздел8_4 = Новый Массив(2);
						СтрокиБлокаРаздел8_4.Вставить(0, ИсхКолвоСтрокБлокаРаздел8_4);
						СтрокиБлокаРаздел8_4.Вставить(1, ТекКолвоСтрокБлокаРаздел8_4);
						
						ИменаПоказателей.Вставить("П000800011503", СтрокиБлокаРаздел8_4);
						ИменаПоказателей.Вставить("П000800011703", СтрокиБлокаРаздел8_4);
			...
			Если Запись <> "" И НЕ (СтруктураРеквизитовФормы.АктуальностьСведенийРаздел8_Прил1 = 1
				...
				Если (ТекКолвоСтрокБлокаРаздел8_1 > 0 И ИсхКолвоСтрокБлокаРаздел8_1 > 0)
					...
					Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
						...
						ИменаПоказателей.Вставить("П000810011503", СтрокиБлокаРаздел8_4);
						ИменаПоказателей.Вставить("П000810011703", СтрокиБлокаРаздел8_4);
		...
		ИначеЕсли СтруктураПараметров.ИмяСтраницы = "Раздел9" Тогда
			...
			Если Запись <> "" И НЕ (СтруктураРеквизитовФормы.АктуальностьСведенийРаздел9 = 1
				...
				ТекКолвоСтрокБлокаРаздел9_Прод1_1 = Запись.ДокПдтвОпл.Количество();
				ТекКолвоСтрокБлокаРаздел9_Прод1_2 = 0;
				
				ИсхКолвоСтрокБлокаРаздел9_Прод1_1 = 1;
				ИсхКолвоСтрокБлокаРаздел9_Прод1_2 = 0;
				
				Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
					
					ТекКолвоСтрокБлокаРаздел9_Прод1_2 = Запись.СвЧастСчФ.Количество();
					ИсхКолвоСтрокБлокаРаздел9_Прод1_2 = 1;
					
				КонецЕсли;
				
				Если (ТекКолвоСтрокБлокаРаздел9_Прод1_1 > 0 И ИсхКолвоСтрокБлокаРаздел9_Прод1_1 > 0)
					ИЛИ (ТекКолвоСтрокБлокаРаздел9_Прод1_2 > 0 И ИсхКолвоСтрокБлокаРаздел9_Прод1_2 > 0) Тогда
					
					ДробноеКолвоЛистовМЧБ = Макс(
						?(ТекКолвоСтрокБлокаРаздел9_Прод1_1 > ИсхКолвоСтрокБлокаРаздел9_Прод1_1,
						ТекКолвоСтрокБлокаРаздел9_Прод1_1 / ИсхКолвоСтрокБлокаРаздел9_Прод1_1, 1),
						?(ТекКолвоСтрокБлокаРаздел9_Прод1_2 > ИсхКолвоСтрокБлокаРаздел9_Прод1_2,
						ТекКолвоСтрокБлокаРаздел9_Прод1_2 / ИсхКолвоСтрокБлокаРаздел9_Прод1_2, 1));
					
					ЦелоеКолвоЛистовМЧБ = Цел(ДробноеКолвоЛистовМЧБ);
					
					КолвоЛистовМЧБ = ?(ДробноеКолвоЛистовМЧБ = ЦелоеКолвоЛистовМЧБ, ЦелоеКолвоЛистовМЧБ, ЦелоеКолвоЛистовМЧБ + 1);
					
					СтрокиБлокаРаздел9_Прод1_1 = Новый Массив(2);
					СтрокиБлокаРаздел9_Прод1_1.Вставить(0, ИсхКолвоСтрокБлокаРаздел9_Прод1_1);
					СтрокиБлокаРаздел9_Прод1_1.Вставить(1, ТекКолвоСтрокБлокаРаздел9_Прод1_1);
					
					ИменаПоказателей = Новый Структура;
					ИменаПоказателей.Вставить("П000900012003", СтрокиБлокаРаздел9_Прод1_1);
					ИменаПоказателей.Вставить("П000900013003", СтрокиБлокаРаздел9_Прод1_1);
					
					Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
						
						СтрокиБлокаРаздел9_Прод1_2 = Новый Массив(2);
						СтрокиБлокаРаздел9_Прод1_2.Вставить(0, ИсхКолвоСтрокБлокаРаздел9_Прод1_2);
						СтрокиБлокаРаздел9_Прод1_2.Вставить(1, ТекКолвоСтрокБлокаРаздел9_Прод1_2);
						
						ИменаПоказателей.Вставить("П000900013503", СтрокиБлокаРаздел9_Прод1_2);
						ИменаПоказателей.Вставить("П000900013703", СтрокиБлокаРаздел9_Прод1_2);
		...
		ИначеЕсли СтруктураПараметров.ИмяСтраницы = "Раздел9_Прил1" Тогда
			...
			Если Запись <> "" И НЕ (СтруктураРеквизитовФормы.АктуальностьСведенийРаздел9_Прил1 = 1
				...
				ТекКолвоСтрокБлокаРаздел9_Прил1_4 = 0;
				
				ИсхКолвоСтрокБлокаРаздел9_Прил1_3 = 1;
				ИсхКолвоСтрокБлокаРаздел9_Прил1_4 = 0;
				
				Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
					
					ТекКолвоСтрокБлокаРаздел9_Прил1_4 = Запись.СвЧастСчФ.Количество();
					ИсхКолвоСтрокБлокаРаздел9_Прил1_4 = 1;
					
				КонецЕсли;
				
				Если (ТекКолвоСтрокБлокаРаздел9_Прил1_3 > 0 И ИсхКолвоСтрокБлокаРаздел9_Прил1_3 > 0)
					ИЛИ (ТекКолвоСтрокБлокаРаздел9_Прил1_4 > 0 И ИсхКолвоСтрокБлокаРаздел9_Прил1_4 > 0) Тогда
					...
					Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
						...
						ИменаПоказателей.Вставить("П000910021503", СтрокиБлокаРаздел9_Прил1_4);
						ИменаПоказателей.Вставить("П000910021703", СтрокиБлокаРаздел9_Прил1_4);
		...
		ИначеЕсли СтруктураПараметров.ИмяСтраницы = "Раздел10" Тогда
			...
			Если Запись <> "" И НЕ (СтруктураРеквизитовФормы.АктуальностьСведенийРаздел10 = 1
				...
				Если ТекКолвоСтрокБлокаРаздел10 > 0 И ИсхКолвоСтрокБлокаРаздел10 > 0 Тогда
					...
					ДробноеКолвоЛистовМЧБ = ?(ТекКолвоСтрокБлокаРаздел10 > ИсхКолвоСтрокБлокаРаздел10,
						ТекКолвоСтрокБлокаРаздел10 / ИсхКолвоСтрокБлокаРаздел10, 1);
		...
		ИначеЕсли СтруктураПараметров.ИмяСтраницы = "Раздел11" Тогда
			...
			Если Запись <> "" И НЕ (СтруктураРеквизитовФормы.АктуальностьСведенийРаздел11 = 1
				...
				Если ТекКолвоСтрокБлокаРаздел11 > 0 И ИсхКолвоСтрокБлокаРаздел11 > 0 Тогда
					...
					ДробноеКолвоЛистовМЧБ = ?(ТекКолвоСтрокБлокаРаздел11 > ИсхКолвоСтрокБлокаРаздел11,
						ТекКолвоСтрокБлокаРаздел11 / ИсхКолвоСтрокБлокаРаздел11, 1);
...
Процедура ЗаполнитьПоказателиРазделов8_12(ИмяФормы,
	...
	Если ИмяРаздела + ДопПараметры.ПостфиксВИмениРаздела = "Раздел8" Тогда
		...
		Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
			...
			ДопПараметры.Вставить("ИмяПокНомЧастСчФ",  "П000800011503");
			ДопПараметры.Вставить("ИмяПокДатаЧастСчФ", "П000800011703");
			
			ЗаполнитьНаМЧБСведенияОСчФПриОтгрузкеВСчетРанееПолучОплаты(ИмяФормы, Показатели, ДанныеРазделов8_12, ДопПараметры);
	...
	ИначеЕсли ИмяРаздела + ДопПараметры.ПостфиксВИмениРаздела = "Раздел8_Прод" Тогда
		...
		Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1")
			...
			ЗаполнитьНаМЧБСведенияОПрослеживаемомТоваре(ИмяФормы, Показатели, ДанныеРазделов8_12, ДопПараметры);
	...
	ИначеЕсли ИмяРаздела + ДопПараметры.ПостфиксВИмениРаздела = "Раздел8_Прил1" Тогда
		...
		Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
			...
			ДопПараметры.Вставить("ИмяПокНомЧастСчФ",  "П000810011503");
			ДопПараметры.Вставить("ИмяПокДатаЧастСчФ", "П000810011703");
	...
	ИначеЕсли ИмяРаздела + ДопПараметры.ПостфиксВИмениРаздела = "Раздел9_Прод1" Тогда
		...
		Если НЕ ДопПараметры.ПечатьПустыхБланков Тогда
			...
			Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
				...
				НовСтр.Значение = ?(ТипЗнч(ДанныеРазделов8_12.СтоимПродСФ22) = Тип("Число"), ДанныеРазделов8_12.СтоимПродСФ22, 0);
				НовСтр.Значение = ?(ДопПараметры.ИндексЛистаМЧБ = 0, НовСтр.Значение, 0);
				НовСтр.ЗначениеМЧБ = Формат(НовСтр.Значение, "ЧЦ=19;ЧДЦ=2;ЧН=-;ЧРД=.;ЧГ=");
			...
			Иначе// "ФормаОтчета2025Кв1" - "ФормаОтчета2020Кв4"
			...
			Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
				...
				НовСтр.Значение = ?(ТипЗнч(ДанныеРазделов8_12.СумНДССФ22) = Тип("Число"), ДанныеРазделов8_12.СумНДССФ22, 0);
				НовСтр.Значение = ?(ДопПараметры.ИндексЛистаМЧБ = 0, НовСтр.Значение, 0);
				НовСтр.ЗначениеМЧБ = Формат(НовСтр.Значение, "ЧЦ=19;ЧДЦ=2;ЧН=-;ЧРД=.;ЧГ=");
		...
		Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
			...
			ДопПараметры.Вставить("ИмяПокНомЧастСчФ",  "П000900013503");
			ДопПараметры.Вставить("ИмяПокДатаЧастСчФ", "П000900013703");
		...
		Если НЕ ДопПараметры.ПечатьПустыхБланков Тогда
			...
			Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1")
				...
				Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
					...
					Если ДопПараметры.ЭтоПоследняяСтраницаРаздела Тогда
						НовСтр.Значение = ?(ТипЗнч(ДопПараметры.Итоги.СтПродБезНДС22) = Тип("Число"), ДопПараметры.Итоги.СтПродБезНДС22, 0);
					Иначе
						НовСтр.Значение = 0;
					КонецЕсли;
					НовСтр.ЗначениеМЧБ = Формат(НовСтр.Значение, "ЧЦ=19;ЧДЦ=2;ЧН=-;ЧРД=.;ЧГ=");
				...
				Иначе// "ФормаОтчета2025Кв1" - "ФормаОтчета2021Кв3"
				...
				Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
					...
					Если ДопПараметры.ЭтоПоследняяСтраницаРаздела Тогда
						НовСтр.Значение = ?(ТипЗнч(ДопПараметры.Итоги.СумНДСВсКПр22) = Тип("Число"), ДопПараметры.Итоги.СумНДСВсКПр22, 0);
					Иначе
						НовСтр.Значение = 0;
					КонецЕсли;
					НовСтр.ЗначениеМЧБ = Формат(НовСтр.Значение, "ЧЦ=19;ЧДЦ=2;ЧН=-;ЧРД=.;ЧГ=");
	...
	ИначеЕсли ИмяРаздела + ДопПараметры.ПостфиксВИмениРаздела = "Раздел9_Прил1" Тогда
		...
		Если НЕ ДопПараметры.ПечатьПустыхБланков Тогда
			...
			Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
				...
				НовСтр.Значение = ?(ТипЗнч(ДопПараметры.Итоги.ИтСтПродКПр22) = Тип("Число"), ДопПараметры.Итоги.ИтСтПродКПр22, 0);
			...
			Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
				...
				НовСтр.Значение = ?(ТипЗнч(ДопПараметры.Итоги.СумНДСИтКПр22) = Тип("Число"), ДопПараметры.Итоги.СумНДСИтКПр22, 0);
				НовСтр.Значение = ?(ДопПараметры.ЭтоПерваяСтраницаРаздела, НовСтр.Значение, 0);
				НовСтр.ЗначениеМЧБ = Формат(НовСтр.Значение, "ЧЦ=19;ЧДЦ=2;ЧН=-;ЧРД=.;ЧГ=");
	...
	ИначеЕсли ИмяРаздела + ДопПараметры.ПостфиксВИмениРаздела = "Раздел9_Прил1_Прод2" Тогда
		...
		Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
			...
			ДопПараметры.Вставить("ИмяПокНомЧастСчФ",  "П000910021503");
			ДопПараметры.Вставить("ИмяПокДатаЧастСчФ", "П000910021703");
	...
	ИначеЕсли ИмяРаздела + ДопПараметры.ПостфиксВИмениРаздела = "Раздел9_Прил1_Прод3" Тогда
		...
		Если НЕ ДопПараметры.ПечатьПустыхБланков Тогда
			...
			Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
				...
				Если ДопПараметры.ЭтоПоследняяСтраницаРаздела Тогда
					НовСтр.Значение
					= ?(ТипЗнч(ДопПараметры.Итоги.СтПродВсП1Р9_22) = Тип("Число"), ДопПараметры.Итоги.СтПродВсП1Р9_22, 0);
				Иначе
					НовСтр.Значение = 0;
				КонецЕсли;
				НовСтр.ЗначениеМЧБ = Формат(НовСтр.Значение, "ЧЦ=19;ЧДЦ=2;ЧН=-;ЧРД=.;ЧГ=");
			...
			Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
				...
				Если ДопПараметры.ЭтоПоследняяСтраницаРаздела Тогда
					НовСтр.Значение
					= ?(ТипЗнч(ДопПараметры.Итоги.СумНДСВсП1Р9_22) = Тип("Число"), ДопПараметры.Итоги.СумНДСВсП1Р9_22, 0);
				Иначе
					НовСтр.Значение = 0;
				КонецЕсли;
				НовСтр.ЗначениеМЧБ = Формат(НовСтр.Значение, "ЧЦ=19;ЧДЦ=2;ЧН=-;ЧРД=.;ЧГ=");
	...
	ИначеЕсли ИмяРаздела + ДопПараметры.ПостфиксВИмениРаздела = "Раздел10_Прод" Тогда
		...
		Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1")
			...
			ЗаполнитьНаМЧБСведенияОПрослеживаемомТоваре(ИмяФормы, Показатели, Сведения, ДопПараметры);
...
Процедура ЗаполнитьНаМЧБСведенияОПрослеживаемомТоваре(ИмяФормы, Показатели, ДанныеРазделов8_12, ДопПараметры)
	
	Если ВРег(СокрЛП(ИмяФормы)) = ВРег("ФормаОтчета2026Кв1") Тогда
		
		СтрокаФормата_СтоимТовПросл = "ЧЦ=19;ЧДЦ=2;ЧН=-;ЧГ=";
		
	Иначе// "ФормаОтчета2025Кв1" - "ФормаОтчета2021Кв3"
		
		СтрокаФормата_СтоимТовПросл = "ЧЦ=17;ЧДЦ=0;ЧН=-;ЧГ=";
	...
	Если НЕ ДопПараметры.ПечатьПустыхБланков Тогда
		...
		КонецЕсли;
		НовСтр.ЗначениеМЧБ = Формат(НовСтр.Значение, СтрокаФормата_СтоимТовПросл);
...
Процедура ЗаполнитьНаМЧБСведенияОСчФПриОтгрузкеВСчетРанееПолучОплаты(ИмяФормы, Показатели, ДанныеРазделов8_12, ДопПараметры)
	
	Если НЕ ДопПараметры.ПечатьПустыхБланков Тогда
		
		НовСтр = Показатели.Добавить();
		НовСтр.Имя = ДопПараметры["ИмяПокНомЧастСчФ"] + "_" + Формат(ДопПараметры.ИндексЛистаМЧБ + 1, "ЧГ=");
		ИндексВМассиве = ДопПараметры.ИндексЛистаМЧБ;
		Если ИндексВМассиве + 1 <= ДанныеРазделов8_12.СвЧастСчФ.Количество() Тогда
			НовСтр.Значение = СокрЛП(ДанныеРазделов8_12.СвЧастСчФ[ИндексВМассиве].НомЧастСчФ);
		Иначе
			НовСтр.Значение = "";
		КонецЕсли;
		НовСтр.ЗначениеМЧБ = НовСтр.Значение;
		...
		НовСтр = Показатели.Добавить();
		НовСтр.Имя = ДопПараметры["ИмяПокДатаЧастСчФ"] + "_" + Формат(ДопПараметры.ИндексЛистаМЧБ + 1, "ЧГ=");
		ИндексВМассиве = ДопПараметры.ИндексЛистаМЧБ;
		Если ИндексВМассиве + 1 <= ДанныеРазделов8_12.СвЧастСчФ.Количество() Тогда
			НовСтр.Значение = СтрЗаменить(СокрЛП(ДанныеРазделов8_12.СвЧастСчФ[ИндексВМассиве].ДатаЧастСчФ), ".", "");
		Иначе
			НовСтр.Значение = "";
		КонецЕсли;
		НовСтр.ЗначениеМЧБ = НовСтр.Значение;
	...
	Иначе
		...
		НовСтр = Показатели.Добавить();
		НовСтр.Имя = ДопПараметры["ИмяПокНомЧастСчФ"] + "_1";
		НовСтр.Значение = "";
		НовСтр.ЗначениеМЧБ = НовСтр.Значение;
		
		НовСтр = Показатели.Добавить();
		НовСтр.Имя = ДопПараметры["ИмяПокДатаЧастСчФ"] + "_1";
		НовСтр.Значение = "";
		НовСтр.ЗначениеМЧБ = НовСтр.Значение;
