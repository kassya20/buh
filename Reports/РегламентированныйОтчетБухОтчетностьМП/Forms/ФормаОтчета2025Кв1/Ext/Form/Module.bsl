...
&НаСервере
Перем ОбъектОтчета; // ОтчетОбъект.РегламентированныйОтчетБухОтчетностьМП - кэш объекта отчета для обращения
...
Процедура ПриОткрытии(Отказ)
	...
	УстановитьВариантЗаполненияПояснений();
	ПоказатьPDFПояснений();
...
&НаКлиенте
Процедура ВариантПоясненийПриИзменении(Элемент)
	
	УстановитьВариантЗаполненияПояснений();
	Если ВариантПояснений = 0 И НЕ ЗначениеЗаполнено(ТекстПояснений.ПолучитьТекст()) Тогда
		ЗаполнитьШаблонПояснений();
	КонецЕсли;
...
&НаКлиенте
Процедура ТекстПоясненийПриИзменении(Элемент)
...
Процедура РазделыОтчетаПриАктивизацииСтроки(Элемент)
	...
	ЗафиксироватьДействиеСФормой("Переход." + Элемент.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим);
...
Процедура ОткрытьФормуНастроек(Команда)
	...
	ЗафиксироватьДействиеСФормой("Команда.ОткрытьФормуНастроек");
...
Процедура СохранитьОтчет(Команда)
	...
	ЗафиксироватьДействиеСФормой("Команда.СохранитьОтчет");
...
Процедура ЗаполнитьАвто(Команда)
	...
	ЗафиксироватьДействиеСФормой("Команда.ЗаполнитьВсе");
	Отказ = Ложь;
...
Процедура ЗаполнитьТекущий(Команда)
	...
	ЗафиксироватьДействиеСФормой("Команда.ЗаполнитьТекущий");
	Отказ = Ложь;
	РегламентированнаяОтчетностьКлиентПереопределяемый.ПроверитьВозможностьАвтоЗаполненияРеглОтчета(ИмяФормы, Отказ);
	Если Отказ Тогда
		Возврат;
...
Процедура ОчиститьОтчет(Команда)
	...
	ЗафиксироватьДействиеСФормой("Команда.ОчиститьОтчет");
...
Процедура ОчиститьТекущуюСтраницу(Команда)
	...
	ЗафиксироватьДействиеСФормой("Команда.ОчиститьТекущуюСтраницу");
...
Процедура Обновить(Команда)
	...
	ЗафиксироватьДействиеСФормой("Команда.Обновить");
...
Процедура Расшифровать(Команда)
	...
	ЗафиксироватьДействиеСФормой("Команда.Расшифровать");
...
Процедура ПовторитьОтправкуВСПАРКИзОтчета(Команда)
	...
	ЗафиксироватьДействиеСФормой("Команда.ПовторитьОтправкуВСПАРКИзОтчета");
	ОтправкаОтчетностиВИнтерфакс = "РегламентированнаяОтчетность.ЭлектронныйДокументооборотСКонтролирующимиОрганами.ОтправкаОтчетностиВИнтерфакс";
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует(ОтправкаОтчетностиВИнтерфакс) Тогда
		МодульОтправкаРегОтчетовВСПАРККлиент = ОбщегоНазначенияКлиент.ОбщийМодуль("ОтправкаРегОтчетовВСПАРККлиент");
...
Процедура ОтправитьВСПАРКИзОтчета(Команда)
	...
	ЗафиксироватьДействиеСФормой("Команда.ОтправитьВСПАРКИзОтчета");
	ОтправкаОтчетностиВИнтерфакс = "РегламентированнаяОтчетность.ЭлектронныйДокументооборотСКонтролирующимиОрганами.ОтправкаОтчетностиВИнтерфакс";
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует(ОтправкаОтчетностиВИнтерфакс) Тогда
		МодульОтправкаРегОтчетовВСПАРККлиент = ОбщегоНазначенияКлиент.ОбщийМодуль("ОтправкаРегОтчетовВСПАРККлиент");
...
Процедура ОтправитьВКонтролирующийОрган(Команда)
	...
	ЗафиксироватьДействиеСФормой("Команда.ОтправитьВКонтролирующийОрган");
...
Процедура ОтправитьНеотправленноеИзвещение(Команда)
	...
	ЗафиксироватьДействиеСФормой("Команда.ОтправитьНеотправленноеИзвещение");
...
Процедура ОтправитьЧерезПредставителя(Команда)
	...
	ЗафиксироватьДействиеСФормой("Команда.ОтправитьЧерезПредставителя");
	Если СтруктураРеквизитовФормы.ЭтоИП Тогда
		РегламентированнаяОтчетностьКлиент.ПоказатьПредупреждениеОНевозможностиОтправкиОтчета();
		Возврат;
	КонецЕсли;
...
Процедура Выгрузить(Команда)
	...
	ЗафиксироватьДействиеСФормой("Команда.Выгрузить");
	Если СтруктураРеквизитовФормы.ЭтоИП Тогда
...
Процедура ЗагрузитьИзФайла(Команда)
	...
	ЗафиксироватьДействиеСФормой("Команда.ЗагрузитьИзФайла");
...
Процедура ОбновитьОтправку(Команда)
	...
	ЗафиксироватьДействиеСФормой("Команда.ОбновитьОтправку");
...
Процедура Печатать(Команда)
	...
	ЗафиксироватьДействиеСФормой("Команда.Печатать");
	РежимНастройки = Ложь;
	...
	ПараметрыФормы.Вставить("РедакцияФормы", "от 07.11.2025 № 159н");
...
Процедура ПроверитьВИнтернете(Команда)
	...
	ЗафиксироватьДействиеСФормой("Команда.ПроверитьВИнтернете");
	Если СтруктураРеквизитовФормы.ЭтоИП Тогда
		РегламентированнаяОтчетностьКлиент.ПоказатьПредупреждениеОНевозможностиОтправкиОтчета();
		Возврат;
	КонецЕсли;
...
Процедура ПроверитьВыгрузку(Команда)
	...
	ЗафиксироватьДействиеСФормой("Команда.ПроверитьВыгрузку");
	Если СтруктураРеквизитовФормы.ЭтоИП Тогда
		РегламентированнаяОтчетностьКлиент.ПоказатьПредупреждениеОНевозможностиВыгрузкиОтчета();
		Возврат;
	КонецЕсли;
...
Процедура НастроитьЗаполнение(Команда)
	...
	ЗафиксироватьДействиеСФормой("Команда.НастроитьЗаполнение");
...
Процедура СоздатьНовыйОтчет()
	...
	ПоместитьДеревоРазделовВКэш(ДеревоДанныхРазделов());
...
Процедура УстановитьПервоначальнуюВидимостьЭлементов()
	...
	Элементы.ОтправитьВКонтролирующийОрган.Видимость =
		ОнлайнСервисыРегламентированнойОтчетностиВызовСервера.СобытиеНаступило("Отпр.бух.отч.упрощ.25к1", '20260101');
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("РегламентированнаяОтчетность.ЭлектронныйДокументооборотСКонтролирующимиОрганами")
		...
		ПоказыватьБаннерВводВРубляхКопейках = ОбщегоНазначения.ХранилищеОбщихНастроекЗагрузить(
			"РегламентированныйОтчетБухОтчетностьМП", "ПоказыватьБаннерВводВРубляхКопейках", Истина);
	КонецЕсли;
...
Процедура СформироватьСтруктуруСтраницОтчета()
	...
	СтрокаУровня1.ОриентацияСтраницы       = "Портрет";
	СтрокаУровня1.ВыводНаПечать            = 1;
	СтрокаУровня1.ПоказатьСтраницу         = ?(ЭтоОтчетностьНКО, НеПоказывать, Показать);
	СтрокаУровня1.ВыгрузитьСтраницу        = 2;
	СтрокаУровня1.АвторасчетПоказателей    = Истина;
	...
	СтрокаУровня1.ОриентацияСтраницы       = "Портрет";
	СтрокаУровня1.ВыводНаПечать            = 1;
	СтрокаУровня1.ПоказатьСтраницу         = ?(ЭтоОтчетностьНКО, Показать, НеПоказывать);
	СтрокаУровня1.ВыгрузитьСтраницу        = 2;
	СтрокаУровня1.АвторасчетПоказателей    = Истина;
	
	СтрокаУровня1 = мДеревоСтраницОтчета.ПолучитьЭлементы().Добавить();
	СтрокаУровня1.ИмяСтраницы              = "Пояснения";
	СтрокаУровня1.Представление            = ПредставлениеРазделаПоИдентификатору(СтрокаУровня1.ИмяСтраницы);
	СтрокаУровня1.ОриентацияСтраницы       = "Портрет";
...
Процедура СформироватьСтруктуруРаздела_Баланс(ДеревоДанныхРазделов)
	...
	Иначе
		ДобавитьОбъявлениеМногострочныхЧастей_Полное(ОписаниеРаздела, "1300");
	КонецЕсли;
	ДобавитьОбъявлениеМногострочныхЧастей_Полное(ОписаниеРаздела, "1410");
	ДобавитьОбъявлениеМногострочныхЧастей_Полное(ОписаниеРаздела, "1450");
	...
	ДобавитьОбъявлениеМногострочныхЧастей_Полное(ОписаниеРаздела, "1550");
...
Процедура СформироватьСтруктуруРаздела_ОФР(ДеревоДанныхРазделов)
	...
	ДобавитьОбъявлениеМногострочныхЧастей_Полное(ОписаниеРаздела, "2130");
	...
	ДобавитьОбъявлениеМногострочныхЧастей_Полное(ОписаниеРаздела, "2410");
...
Процедура СформироватьСтруктуруРаздела_ОЦИС(ДеревоДанныхРазделов)
	...
	ДобавитьОбъявлениеМногострочныхЧастей_Полное(ОписаниеРаздела, "6310");
	ДобавитьОбъявлениеМногострочныхЧастей_Полное(ОписаниеРаздела, "6320");
...
// Вызывается из общего модуля "РегламентированнаяОтчетностьЗагрузкаКлиент".
//
&НаКлиенте
...
Процедура СформироватьСоставПоказателей_Баланс()
	...
	Если СтруктураРеквизитовФормы.ЭтоБалансНекоммерческойОрганизации Тогда
		ПараметрыПоказателей.Строки = "1150, 1170, 1210, 1250, 1240, 1350, 1410, 1450, 1510, 1520, 1550";
	Иначе
		ПараметрыПоказателей.Строки = "1150, 1170, 1210, 1250, 1240, 1300, 1410, 1450, 1510, 1520, 1550";
	КонецЕсли;
	
	ДобавитьПоказателиРаздела(ПараметрыПоказателей);
	
	ПараметрыПоказателей.Графы = "01С0, 04Е4, 05Е4, 06Е4";
	ПараметрыПоказателей.Строки = "1600, 1700";
	ДобавитьПоказателиРаздела(ПараметрыПоказателей);
...
Процедура СформироватьСоставПоказателей_ОФР()
	...
	ПараметрыПоказателей.Строки = "2110, 2120, 2130, 2340, 2350, 2410";
	ДобавитьПоказателиРаздела(ПараметрыПоказателей);
	
	ПараметрыПоказателей.Графы = "01С0, 04Е4, 05Е4";
	ПараметрыПоказателей.Строки = "2400";
	ДобавитьПоказателиРаздела(ПараметрыПоказателей);
...
Процедура СформироватьСоставПоказателей_ОЦИС()
	...
	ПараметрыПоказателей.Графы = "01С0, 04Е0, 05Е0";
	ПараметрыПоказателей.Строки = "6100, 6220, 6240, 6250, 6310, 6320, 6330, 6350";
	ДобавитьПоказателиРаздела(ПараметрыПоказателей);
	
	ПараметрыПоказателей.Графы = "01С0, 04Е4, 05Е4";
	ПараметрыПоказателей.Строки = "6200, 6300, 6400";
	ДобавитьПоказателиРаздела(ПараметрыПоказателей);
...
Процедура ЗаполнитьПодписантаВРазделах(ИмяРазделаВТабличномДокументе = "")
	...
	СведенияОПодписанте = СведенияОПодписанте();
	Подписант = СведенияОПодписанте.Подписант;
	Должность = СведенияОПодписанте.Должность;
...
Функция СведенияОПодписанте()
	...
	Возврат Новый Структура("Подписант, Должность", Подписант, Должность);
...
Процедура ИнициализироватьМеханизмыНастройкиЗаполнения()
	...
	Элементы.НастроитьЗаполнение.Видимость = 
		ЛОЖЬ И ЕстьНастраиваемыеРазделыОтчета(СтруктураРеквизитовФормы.РазделыСПоддержкойНастройкиЗаполнения);
...
&НаСервере
Процедура ЗаполнитьШаблонПояснений()
	
	Организация = СтруктураРеквизитовФормы.Организация;
	КонецОтчетногоПерида = СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета;
	
	ШаблонПояснений = Новый ФорматированныйДокумент();
	
	НазваниеПояснений = ?(СтруктураРеквизитовФормы.ЭтоБалансНекоммерческойОрганизации,
		"Пояснения к бухгалтерскому балансу и отчету о целевом использовании средств",
		"Пояснения к бухгалтерскому балансу и отчету о финансовых результатах");
	ЭлементЗаголовка = ШаблонПояснений.Добавить(НазваниеПояснений);
	ЭлементЗаголовка.Шрифт = Новый Шрифт(ЭлементЗаголовка.Шрифт,, 14, Истина);
	ЭлементЗаголовка.Родитель.ГоризонтальноеПоложение = ГоризонтальноеПоложение.Центр;
	
	ШаблонПояснений.Элементы.Добавить();
	ШаблонПояснений.Элементы.Добавить();
	Раздел1Заголовок = ШаблонПояснений.Добавить("1. Деятельность");
	Раздел1Заголовок.Шрифт = Новый Шрифт(Раздел1Заголовок.Шрифт,, 12, Истина);
	
	СведенияОбОрганизации = РегламентированнаяОтчетностьВызовСервера.ПолучитьСведенияОбОрганизации(
		Организация, КонецОтчетногоПерида, "ОКВЭД2, ОснВидДеят2");
	КодОКВЭД = ?(ЗначениеЗаполнено(СведенияОбОрганизации.ОКВЭД2),
		"код ОКВЭД " + СокрЛП(СведенияОбОрганизации.ОКВЭД2),"<код ОКВЭД>");
	НазваниеДеятельности = ?(ЗначениеЗаполнено(СведенияОбОрганизации.ОснВидДеят2),
		СокрЛП(СведенияОбОрганизации.ОснВидДеят2),"<название вида деятельности>");
	
	ШаблонПояснений.Элементы.Добавить();
	ШаблонПояснений.Элементы.Добавить();
	ВывестиСтрокуШтрифтом10(ШаблонПояснений, "Основной вид деятельности организации в отчетном периоде:");
	ВывестиСтрокуШтрифтом10(ШаблонПояснений, СтрШаблон("%1 (%2)", НазваниеДеятельности, КодОКВЭД));
	
	ШаблонПояснений.Элементы.Добавить();
	Раздел2Заголовок = ШаблонПояснений.Добавить("2. Учетная политика");
	Раздел2Заголовок.Шрифт = Новый Шрифт(Раздел2Заголовок.Шрифт,, 12, Истина);
	ШаблонПояснений.Элементы.Добавить();
	
	ШаблонПояснений.Элементы.Добавить();
	ВывестиСтрокуШтрифтом10(ШаблонПояснений,
		"Настоящая бухгалтерская отчетность соответствует федеральным стандартам бухгалтерского учета.");
	
	ТекстУчетнойПолитики = БухгалтерскаяОтчетностьБРО.ОписаниеУчетнойПолитикиУБО(Организация, КонецОтчетногоПерида);
	
	Если ТекстУчетнойПолитики.Элементы.Количество() <> 0 Тогда
		ТекстHTML1 = "";
		Вложения1 = Новый Структура();
		ШаблонПояснений.ПолучитьHTML(ТекстHTML1, Вложения1);
		ПозицияТэгаЗавершенияТела = СтрНайти(НРег(ТекстHTML1),"</body>");
		ТекстHTML1 = Лев(ТекстHTML1, ПозицияТэгаЗавершенияТела - 1);
		
		ТекстHTML2 = "";
		Вложения2 = Новый Структура();
		ТекстУчетнойПолитики.ПолучитьHTML(ТекстHTML2, Вложения2);
		ПозицияТэгаНачалаТела = СтрНайти(НРег(ТекстHTML2),"<body>");
		ТекстHTML2 = Сред(ТекстHTML2, ПозицияТэгаНачалаТела + 6);
		
		ОбъединенныйHTML = ТекстHTML1 + ТекстHTML2;
		Для Каждого КлючВложения Из Вложения2 Цикл
			Вложения1.Вставить(КлючВложения, Вложения2[КлючВложения]);
		КонецЦикла;
		
		ШаблонПояснений.УстановитьHTML(ОбъединенныйHTML, Вложения1);
		ШаблонПояснений.Элементы.Добавить();
		
	Иначе
		ВывестиСтрокуШтрифтом10(ШаблонПояснений,
			"Подсказка: заполните сведения об учетной политике организации в соответствии с п.п. 53 ФСБУ 4/2023.");
		ВывестиСтрокуШтрифтом10(ШаблонПояснений,
		...
		ВывестиСтрокуШтрифтом10(ШаблонПояснений,
			"в) иная существенная информация о финансовом положении экономического субъекта на отчетную дату, финансовых результатах его деятельности за отчетный период. В случае существенности информации, подлежащей раскрытию в соответствии с настоящим Стандартом в отчете об изменениях капитала и (или) отчете о движении денежных средств, в упрощенной бухгалтерской отчетности, данная информация раскрывается в виде таких отчетов либо в пояснениях.""");
		
	КонецЕсли;
	
	СведенияОПодписанте = СведенияОПодписанте();
	Подписант = ?(ЗначениеЗаполнено(СведенияОПодписанте.Подписант), СведенияОПодписанте.Подписант, "<расшифровка подписи>");
	Должность = ?(ЗначениеЗаполнено(СведенияОПодписанте.Должность), СведенияОПодписанте.Должность, "<наименование должности>");
	
	ШаблонПояснений.Элементы.Добавить();
	ВывестиСтрокуШтрифтом10(ШаблонПояснений, СтрШаблон("%1 _______________ %2", Должность, Подписант));
	ШаблонПояснений.Элементы.Добавить();
	ВывестиСтрокуШтрифтом10(ШаблонПояснений, Формат(ДатаПодписи, "ДЛФ=DD"));
	
	// Перенос сформированного документа в форму.
	ТекстФорматированногоДокумента = "";
	ВложенияФОрматированногоДокумента = Новый Структура();
	ШаблонПояснений.ПолучитьHTML(ТекстФорматированногоДокумента, ВложенияФОрматированногоДокумента);
	
	ТекстПояснений.УстановитьHTML(ТекстФорматированногоДокумента, ВложенияФОрматированногоДокумента);
	
КонецПроцедуры

&НаСервере
Процедура ВывестиСтрокуШтрифтом10(ШаблонПояснений, ВыводимыйТекст)
	
	ВыведенныйПараграф = ШаблонПояснений.Добавить(ВыводимыйТекст);
	ВыведенныйПараграф.Шрифт = Новый Шрифт(ВыведенныйПараграф.Шрифт,, 10, Ложь);
	ШаблонПояснений.Элементы.Добавить(); // Перевод строки
...
Процедура СохранитьДанныеРаздела(ИмяРаздела)
	...
	Если ИмяРаздела <> "ДополнительныеФайлы" И ИмяРаздела <> "Пояснения" Тогда
		ДеревоДанныхРазделов = ПолучитьИзВременногоХранилища(СтруктураМногострочныхРазделов);
		ДанныеРаздела = ДеревоДанныхРазделов.Строки.Найти(ИмяРаздела, "Идентификатор");
...
Процедура АктивизироватьЯчейку(Ячейка) Экспорт
	...
	Если ИдентификаторРаздела <> "ДополнительныеФайлы" И ИдентификаторРаздела <> "Пояснения" Тогда
...
Процедура ПереключитьРаздел(ИдентификаторРаздела)
	...
	ИначеЕсли ИдентификаторРаздела = "Пояснения" Тогда
		СохранитьДанныеРаздела(СтруктураРеквизитовФормы.НаимТекущегоРаздела);
		Элементы.СтраницыОтчета.ТекущаяСтраница = Элементы.Пояснения;
		Элементы.ЗаполнитьТекущий.Доступность = Ложь;
		Элементы.ОчиститьТекущуюСтраницу.Доступность = Ложь;
...
Процедура ДобавитьОписаниеМСЧ_Баланс()
	...
	ИдентификаторыМСЧ = Список("П1000101150, П10001А1150, П10001Б1150,
		...
		|П1000101450, П10001А1450, П10001Б1450,
		|П1000101510, П10001А1510, П10001Б1510,
		|П1000101520, П10001А1520, П10001Б1520,
		|П1000101550, П10001А1550, П10001Б1550"
		+ ?(СтруктураРеквизитовФормы.ЭтоБалансНекоммерческойОрганизации, ", П1000101350, П10001А1350, П10001Б1350",
			", П1000101300, П10001А1300, П10001Б1300"));
...
Процедура ДобавитьОписаниеМСЧ_ОФР()
	...
	ИдентификаторыМСЧ = Список("П1000102110, П10001А2110, П10001Б2110,
		...
		|П1000102130, П10001А2130, П10001Б2130,
		|П1000102340, П10001А2340, П10001Б2340,
		|П1000102350, П10001А2350, П10001Б2350,
		|П1000102410, П10001А2410, П10001Б2410");
...
Процедура ДобавитьОписаниеМСЧ_ОЦИС()
	...
	ИдентификаторыМСЧ = Список("П1000106220, П10001А6220, П10001Б6220,
		|П1000106240, П10001А6240, П10001Б6240,
		|П1000106250,
		|П1000106310, П10001А6310, П10001Б6310,
		|П1000106320, П10001А6320, П10001Б6320,
	...
	Для Каждого Графа Из Графы Цикл
		...
		Если ЭтоБалансНекоммерческойОрганизации Тогда
			УстановитьЗначениеПоказателя(Показатели, "П0000101700" + Графа,
				...
				+ СуммаМногострочныхПоказателей(Показатели, "П10001А1450" + Графа)
				...
				+ СуммаМногострочныхПоказателей(Показатели, "П10001А1550" + Графа));
		Иначе
			УстановитьЗначениеПоказателя(Показатели, "П0000101700" + Графа,
				ПоказательОтчета(Показатели, "П0000101300" + Графа)
				+ СуммаМногострочныхПоказателей(Показатели, "П10001А1300" + Графа)
				+ ПоказательОтчета(Показатели, "П0000101410" + Графа)
				+ СуммаМногострочныхПоказателей(Показатели, "П10001А1410" + Графа)
				+ ПоказательОтчета(Показатели, "П0000101450" + Графа)
				+ СуммаМногострочныхПоказателей(Показатели, "П10001А1450" + Графа)
...
Процедура Расчет_ОФР(Показатели, ПараметрыРасчета)
	...
	Для Каждого Графа Из Графы Цикл
		УстановитьЗначениеПоказателя(Показатели, "П0000102400" + Графа,
			...
			+ ПоказательОтчетаОкрЕд(ПараметрыРасчета, Показатели, "П0000102130" + Графа)
			+ СуммаМногострочныхПоказателейОкрЕд(ПараметрыРасчета, Показатели, "П10001А2130" + Графа)
...
Процедура ОткрытьФормуВыбораСтраниц(ВариантВыбора)
	...
	ПараметрыФормы.Вставить("РазделыОтчета", РегламентированнаяОтчетностьКлиентСервер.РеквизитДеревоЗначенийВСтруктуру(
		мДеревоСтраницОтчета, "Представление, ВыгрузитьСтраницу, ПоказатьСтраницу, ВыводНаПечать, ОриентацияСтраницы,
			|ИмяОбластиТабличногоПоля, ИмяПоляТабличногоДокум, ИмяСтраницы"));
...
Процедура ПослеСохраненияНаКлиенте(ВыполняемоеОповещение, РезультатСохранения)
	...
	Если ВариантПояснений <> 1 Тогда
		ВнешниеПояснения = Неопределено;
	КонецЕсли;
...
Функция Сохранить(Автосохранение = Ложь, КодИФНС = "не применимо", Вариант,
	...
	СписокСохранения.Вставить("ИсточникПояснений", ПредставлениеИсточникаПояснений(ВариантПояснений));
	
	СписокДополнительныхФайлов = Новый Структура;
	Если ВариантПояснений <> 1 Тогда
		ИмяФайлаПояснительнойЗаписки = "";
		СписокДополнительныхФайлов.Вставить("ИмяФайлаПояснительнойЗаписки", "Пояснения заполненные в отчете");
	Иначе
	...
	// Элемент используется в механизмах отправки отчета с приложенными файлами по телекоммуникационным
	// каналам связи через сервис "1С-Отчетность". По его содержанию определяются приложенные файлы.
	СписокСохранения.Вставить("СписокДополнительныхФайлов", СписокДополнительныхФайлов);
	
	Если ВариантПояснений = 1 Тогда
		СписокСохранения.Вставить("ТекстПояснений", "");
	Иначе
		СписокСохранения.Вставить("ТекстПояснений", ТекстПояснений);
	КонецЕсли;
	...
	Попытка
		...
		Иначе
			СохранитьПредставлениеПояснений();
		КонецЕсли;
...
// Подготавливает и сохраняет PDF-представление Пояснений для последующего извлечения в сценариях
// выгрузки на диски и отправки через 1С-Отчетность, в которых файл извлекается не из отчета, а из
// регистра сведений ДополнительныеФайлыРегламентированныхОтчетов.
//
&НаСервере
Процедура СохранитьПредставлениеПояснений()
	
	ИмяВременногоФайла = ПолучитьИмяВременногоФайла(".pdf");
	ТекстПояснений.Записать(ИмяВременногоФайла, ТипФайлаФорматированногоДокумента.PDF);
	ПредставлениеПояснений = Новый ДвоичныеДанные(ИмяВременногоФайла);
	
	Попытка
		УдалитьФайлы(ИмяВременногоФайла);
	Исключение
		ТекстСообщения = СтрШаблон(НСтр("ru = 'Ошибка при удалении временного файла %1: %2'"),
			ИмяВременногоФайла, ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		
		ЗаписьЖурналаРегистрации(
			"РегламентированныйОтчетБухОтчетностьМП.ВыгрузитьСогласие",
			УровеньЖурналаРегистрации.Ошибка,
			Метаданные.Отчеты.РегламентированныйОтчетБухОтчетностьМП,
			СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка,
			ТекстСообщения);
	КонецПопытки;
	...
	ЗаписьРегистраСведений.СодержимоеФайла = Новый ХранилищеЗначения(ПредставлениеПояснений);
	ЗаписьРегистраСведений.ИмяФайла = "Пояснения.pdf";
	ЗаписьРегистраСведений.Размер = ПредставлениеПояснений.Размер();
...
&НаКлиентеНаСервереБезКонтекста
Функция ПредставлениеИсточникаПояснений(КодИсточника)
	
	Если КодИсточника = 0 Тогда
		Возврат "отчет"
	ИначеЕсли КодИсточника = 1 Тогда
		Возврат "файл"
	КонецЕсли;
...
&НаКлиентеНаСервереБезКонтекста
Функция КодИсточникаПояснений(ПредставлениеИсточника)
	
	Если ПредставлениеИсточника = "отчет" Тогда
		Возврат 0;
	ИначеЕсли ПредставлениеИсточника = "файл" Тогда
		Возврат 1;
	КонецЕсли;
...
Процедура ВосстановитьСохраненныеДанные()
	...
	ТекстПояснений = СохраненныеДанные.ТекстПояснений;
	ВариантПояснений = КодИсточникаПояснений(СохраненныеДанные.ИсточникПояснений);
	ВосстановитьДопРеквизитыФормы(СохраненныеДанные);
	
	ВосстановитьСохраненныеНастройкиДереваРазделов(СохраненныеДанные);
	...
	Если НЕ СтруктураРеквизитовФормы.мБезОткрытияФормы И НЕ СтруктураРеквизитовФормы.мСохраненныйДок = Неопределено Тогда
		РегламентированнаяОтчетность.БлокировкаИлиЗапретРедактированияОтчета(ЭтотОбъект,
			Список("ИмяФайлаПояснительнойЗаписки, ИмяФайлаАудиторскогоЗаключения, РежимНастройки,
				|ВариантПояснений, ТекстПояснений"));
	КонецЕсли;
...
&НаСервере
Процедура ВосстановитьСохраненныеНастройкиДереваРазделов(СохраненныеДанные)
	...
	ВОтчетеЕстьРазделПояснений = Ложь;
	Для Каждого СтрокаНастройкиСтраницы Из СтрокиНастройкиСтраниц Цикл
		...
		ВОтчетеЕстьРазделПояснений = ВОтчетеЕстьРазделПояснений ИЛИ ИмяРаздела = "Пояснения";
	КонецЦикла;
	...
	// При конвертации старых отчетов, не содержавших раздел Пояснения, его надо включить в отчет.
	// Если в разделе "Дополнительные файлы" не приложено аудиторское заключение, то его надо исключить.
	Если Не ВОтчетеЕстьРазделПояснений Тогда
		СтрокаРазделаПояснений = ИсходноеДеревоСтраниц.Строки.Найти("Пояснения", "ИмяСтраницы");
		СтрокаРазделаПояснений.ПоказатьСтраницу = 1;
		...
		Если НЕ ЗначениеЗаполнено(ИмяФайлаАудиторскогоЗаключения) Тогда
			СтрокаРазделаФайлов = ИсходноеДеревоСтраниц.Строки.Найти("ДополнительныеФайлы", "ИмяСтраницы");
			СтрокаРазделаФайлов.ПоказатьСтраницу = 0;
		КонецЕсли;
	КонецЕсли;
...
Процедура ВосстановитьДополнительныеФайлы(СохраненныеДанные)
	...
	Если ВариантПояснений = 1 Тогда
		...
		Если ЗначениеЗаполнено(ИмяФайлаПояснительнойЗаписки) Тогда
			ВосстановитьДанныеДополнительногоФайла(
				СтруктураРеквизитовФормы.ФайлПояснительнойЗаписки, "Пояснительная записка");
		КонецЕсли;
	Иначе
		ИмяФайлаПояснительнойЗаписки = "";
	КонецЕсли;
	...
	ИмяФайлаАудиторскогоЗаключения = СписокДополнительныхФайлов.ИмяФайлаАудиторскогоЗаключения;
	ВосстановитьДанныеДополнительногоФайла(
		СтруктураРеквизитовФормы.ФайлАудиторскогоЗаключения, "Аудиторское заключение");
	
КонецПроцедуры

&НаСервере
Процедура ВосстановитьДанныеДополнительногоФайла(СтруктураДопФайла, ВидДопФайла)
...
&НаКлиенте
Процедура ПоказатьPDFПояснений()
	
	#Если НЕ ВебКлиент Тогда
	
	СтруктураДопФайла = СтруктураРеквизитовФормы.ФайлПояснительнойЗаписки;
	Если ЗначениеЗаполнено(СтруктураДопФайла.ХранилищеФайла) Тогда
		ПотокPDF = ПолучитьИзВременногоХранилища(СтруктураДопФайла.ХранилищеФайла).ОткрытьПотокДляЧтения();
		ВнешниеПояснения.Прочитать(ПотокPDF);
	КонецЕсли;
...
Процедура ЗагрузитьДанныеЗаполнения()
	...
	ПоместитьДеревоРазделовВКэш(РезультатЗаполнения.Контейнер);
...
Функция ЗагрузкаОтчетаИзФайлаНаСервере(ДанныеДляЗагрузки)
	...
	ВычитаемыеПоказатели = ОбъектОтчета().ВычитаемыеПоказатели2025Кв1(ПараметрыОтчета.БалансНекоммерческойОрганизации);
	ПараметрыОтчета.Вставить("ИменаВычитаемыхПоказателей", ВычитаемыеПоказатели);
...
Функция СформироватьНастройкиФормыВыбораПечати()
	...
	НастройкиФормыВыбораПечати.Вставить("РазрешитьВключатьКодыСтрок", Ложь);
...
Функция ПечатьНаСервере(ВидПечати)
	...
	Для Каждого СтрокаУровня1 Из мДеревоСтраницОтчета.ПолучитьЭлементы() Цикл
		Если СтрокаУровня1.ИмяСтраницы = "ДополнительныеФайлы"
			 Или СтрокаУровня1.ИмяСтраницы = "Пояснения" Тогда
			Продолжить;
		КонецЕсли;
...
Функция ПредставлениеРазделаПоИдентификатору(ИдентификаторРаздела)
	...
	ПредставленияРазделов.Вставить("Пояснения", "Пояснения");
...
Процедура УстановитьДоступностьКнопкиНастройкиЗаполнения()
	...
	Элементы.НастроитьЗаполнение.Доступность = РазрешенаМодификацияОтчета() И ЗначениеЗаполнено(ИмяФормыНастройки);
...
Функция ВсеРазделыОтчета(ЗначениеПоУмолчанию = Неопределено)
	...
	ВсеРазделыОтчета.Вставить("Пояснения", ЗначениеПоУмолчанию);
...
Процедура БольшеНеПоказыватьБаннерВводВРубляхКопейках()
	...
	ОбщегоНазначения.ХранилищеОбщихНастроекСохранить("РегламентированныйОтчетБухОтчетностьМП",
		"ПоказыватьБаннерВводВРубляхКопейках", Ложь);
...
&НаКлиенте
Процедура УстановитьВариантЗаполненияПояснений()
	
	Если ВариантПояснений = 0 Тогда
		Элементы.ИмяФайлаПояснительнойЗаписки.Видимость = Ложь;
		Элементы.ГруппаСтраницыОтображенияПояснений.ТекущаяСтраница = Элементы.СтраницаВводаПояснений;
	ИначеЕсли ВариантПояснений = 1 Тогда
		Элементы.ИмяФайлаПояснительнойЗаписки.Видимость = Истина;
		#Если ВебКлиент Тогда
		Элементы.ГруппаСтраницыОтображенияПояснений.ТекущаяСтраница = Элементы.СтраницаОтображенияПоясненийВебКлиент;
		#Иначе
		Элементы.ГруппаСтраницыОтображенияПояснений.ТекущаяСтраница = Элементы.СтраницаОтображенияПояснений;
		#КонецЕсли
	КонецЕсли;
...
&НаКлиенте
Процедура ЗафиксироватьДействиеСФормой(ОписаниеДействия)
	
	ДлинаОчереди = 15;
	ИсторияДействийСФормой.Добавить(ОписаниеДействия);
	Пока ИсторияДействийСФормой.Количество() > ДлинаОчереди Цикл
		ИсторияДействийСФормой.Удалить(0);
	КонецЦикла;
	
КонецПроцедуры

&НаСервере
Функция ИсторияДействий()
	
	История = "";
	Для Каждого ЗафиксированноеДействие Из ИсторияДействийСФормой Цикл
		История = История + ", " + ЗафиксированноеДействие.Значение;
	КонецЦикла;
	Возврат Сред(История, 3);
...
&НаСервере
Процедура ПоместитьДеревоРазделовВКэш(ДеревоДанныхРазделов)
	
	Если НЕ ТипЗнч(ДеревоДанныхРазделов) = Тип("ДеревоЗначений") Тогда
		ИмяПроцедуры = "Отчет.РегламентированныйОтчетБухОтчетностьМП.ФормаОтчета2025Кв1.ПоместитьДеревоРазделовВКэш";
		ВызватьИсключение СтрШаблон(НСтр("ru = 'Процедура %1:
			|Недопустимый тип для дерева данных разделов.
			|История действий: %2'"), ИмяПроцедуры, ИсторияДействий());
	КонецЕсли;
