...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	//Раздел 1
	//стр. 01 = стр. 02+стр. 03+стр. 04+стр.07 по всем графам
	Для Гр = 3 По 12 Цикл
		Графа = Формат(Гр, "ЧЦ=2; ЧВН=");
		Области["П0010010001" + Графа].Значение
			= Области["П0010010002" + Графа].Значение
			+ Области["П0010010003" + Графа].Значение
			+ ?(Гр > 10, 0, Области["П0010010004" + Графа].Значение)
			+ ?(Гр > 10, 0, Области["П0010010007" + Графа].Значение);
	КонецЦикла;
	
	//Раздел 2
	//стр. 09 по всем графам = стр. 10+стр. 15 по соответствующим графам
	Для Гр = 3 по 9 Цикл
		Графа = Формат(Гр, "ЧЦ=2; ЧВН=");
	...
	//Раздел 3
	//стр. 40 по графам 3–7 = Сумм. стр.41 – 45, 48, 49, 51–53 по соответствующим графам
	Для Гр = 3 по 7 Цикл
		Графа = Формат(Гр, "ЧЦ=2; ЧВН=");
		СуммаПоСтр = 0;
	...
	//Раздел 4
	//стр. 54 по графам 3, 6, 7 = Сумм. стр. 55–59, 62, 63, 65–67 по соответствующим графам
	Для Гр = 3 по 7 Цикл
	...
	//стр. 54 по графам 4, 8, 9= Сумм. стр. 55–59, 62, 63, 65–66 по соответствующим графам
	Для Гр = 4 по 9 Цикл
	...
	//стр. 54 по графам 5, 10, 11= Сумм. стр. 55–59, 62, 63 по соответствующим графам
	Для Гр = 5 по 11 Цикл
