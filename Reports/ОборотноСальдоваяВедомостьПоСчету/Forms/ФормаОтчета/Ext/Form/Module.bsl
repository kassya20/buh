...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбработкаНовостейПереопределяемый.КонтекстныеНовости_ПриСозданииНаСервере(
		ЭтаФорма,
		"БП.Отчет.ОборотноСальдоваяВедомостьПоСчету",
		"ФормаОтчета",
		НСтр("ru='Новости: Оборотно-сальдовая ведомость по счету'"),
...
Функция ПолучитьБаннерНаСервере(ПоказатьПредыдущий)
	...
	СтруктураПараметров.Вставить("Размещение", ПерсонализированныеПредложенияСервисов.ИмяРазмещенияОборотноСальдоваяВедомостьПоСчету());
...
Процедура АдаптироватьМККоманднаяПанельФормы()
	...
	МобильныйКлиентБПФормаОбъекта.ПеренестиКомандыВМККомандыФормы(Элементы, Элементы.КоманднаяПанельОтчета.ПодчиненныеЭлементы);
