...
Функция ПолучитьПараметрыИсполненияОтчета() Экспорт
	...
	Результат.Вставить("КоличествоКолонокПоказателей",       6);
...
Процедура ПередКомпоновкойМакета(ПараметрыОтчета, Схема, КомпоновщикНастроек) Экспорт
	...
	Если ЗначениеЗаполнено(ПараметрыОтчета.НачалоПериода) Тогда
		БухгалтерскиеОтчетыКлиентСервер.УстановитьПараметр(КомпоновщикНастроек, "НачалоПериода", 	БухгалтерскиеОтчеты.НачалоПериодаСУчетомВидаПериода(
			НачалоДня(ПараметрыОтчета.НачалоПериода), ПараметрыОтчета.ВидПериода));
	КонецЕсли;
	Если ЗначениеЗаполнено(ПараметрыОтчета.КонецПериода) Тогда
		БухгалтерскиеОтчетыКлиентСервер.УстановитьПараметр(КомпоновщикНастроек, "КонецПериода", 	БухгалтерскиеОтчеты.КонецПериодаСУчетомВидаПериода(
			КонецДня(ПараметрыОтчета.КонецПериода), ПараметрыОтчета.ВидПериода));
...
Процедура ПроверитьКорректностьИтогов(ПараметрыОтчета, Результат) Экспорт
	...
	Если КонтрольноеСоотношение <> 0
	   И (БухгалтерскиеОтчеты.ИспользуютсяОборотныеСубконто(ПараметрыОтчета.Счет, ЭлементыОтбора)
		Или БухгалтерскиеОтчеты.ИспользуетсяОтборПоРесурсам(ЭлементыОтбора)) Тогда
...
Функция ТекстЗапросаДляСчетовБезСубконто()
	...
	Возврат "ВЫБРАТЬ
	        ...
	        |	ХозрасчетныйОстаткиИОбороты.СуммаНачальныйОстатокДт - ЕСТЬNULL(ХозрасчетныйОстаткиИОбороты.СуммаНУНачальныйОстатокДт, 0) КАК СверкаНУНачальныйОстатокДт,
	        |	ХозрасчетныйОстаткиИОбороты.СуммаНачальныйОстатокКт - ЕСТЬNULL(ХозрасчетныйОстаткиИОбороты.СуммаНУНачальныйОстатокКт, 0) КАК СверкаНУНачальныйОстатокКт,
	        |	ХозрасчетныйОстаткиИОбороты.СуммаКонечныйОстатокДт - ЕСТЬNULL(ХозрасчетныйОстаткиИОбороты.СуммаНУКонечныйОстатокДт, 0) КАК СверкаНУКонечныйОстатокДт,
	        |	ХозрасчетныйОстаткиИОбороты.СуммаКонечныйОстатокКт - ЕСТЬNULL(ХозрасчетныйОстаткиИОбороты.СуммаНУКонечныйОстатокКт, 0) КАК СверкаНУКонечныйОстатокКт,
	        |	ХозрасчетныйОстаткиИОбороты.СуммаОборотДт - ЕСТЬNULL(ХозрасчетныйОстаткиИОбороты.СуммаНУОборотДт, 0) КАК СверкаНУОборотДт,
	        |	ХозрасчетныйОстаткиИОбороты.СуммаОборотКт - ЕСТЬNULL(ХозрасчетныйОстаткиИОбороты.СуммаНУОборотКт, 0) КАК СверкаНУОборотКт,
	        ...
	        |	ХозрасчетныйОстаткиИОбороты.СуммаНачальныйРазвернутыйОстатокДт - ЕСТЬNULL(ХозрасчетныйОстаткиИОбороты.СуммаНУНачальныйРазвернутыйОстатокДт, 0) КАК СверкаНУНачальныйРазвернутыйОстатокДт,
	        |	ХозрасчетныйОстаткиИОбороты.СуммаНачальныйРазвернутыйОстатокКт - ЕСТЬNULL(ХозрасчетныйОстаткиИОбороты.СуммаНУНачальныйРазвернутыйОстатокКт, 0) КАК СверкаНУНачальныйРазвернутыйОстатокКт,
	        |	ХозрасчетныйОстаткиИОбороты.СуммаКонечныйРазвернутыйОстатокДт - ЕСТЬNULL(ХозрасчетныйОстаткиИОбороты.СуммаНУКонечныйРазвернутыйОстатокДт, 0) КАК СверкаНУКонечныйРазвернутыйОстатокДт,
	        |	ХозрасчетныйОстаткиИОбороты.СуммаКонечныйРазвернутыйОстатокКт - ЕСТЬNULL(ХозрасчетныйОстаткиИОбороты.СуммаНУКонечныйРазвернутыйОстатокКт, 0) КАК СверкаНУКонечныйРазвернутыйОстатокКт,
	        ...
	        |	НУОборотДт,
	        |	НУОборотКт,
	        |	СверкаНУНачальныйОстатокДт,
	        |	СверкаНУНачальныйОстатокКт,
	        |	СверкаНУКонечныйОстатокДт,
	        |	СверкаНУКонечныйОстатокКт,
	        |	СверкаНУОборотДт,
	        |	СверкаНУОборотКт,
	        ...
	        |	СверкаНУНачальныйРазвернутыйОстатокДт,
	        |	СверкаНУНачальныйРазвернутыйОстатокКт,
	        |	СверкаНУКонечныйРазвернутыйОстатокДт,
	        |	СверкаНУКонечныйРазвернутыйОстатокКт,
...
Функция ШаблонЗапроса(Счетчик)
	...
	Если Счетчик = 1 Тогда
		Возврат "ВЫБРАТЬ
		        ...
		        |	КонтрольКонечныйРазвернутыйОстатокКт}
		        |ИЗ
		        |	РегистрБухгалтерии.Хозрасчетный.ОстаткиИОбороты(&НачалоПериода, &КонецПериода, Месяц {(&Периодичность)}, , Счет В (&ОсобенныеСчета) {(Счет).*}, &ВидыСубконто, {(Организация).*, (Подразделение).*, (Валюта).* &УсловиеПоСубконто}) КАК ХозрасчетныйОстаткиИОбороты
		        |{ГДЕ
		        |	ХозрасчетныйОстаткиИОбороты.СуммаНачальныйОстатокДт КАК БУНачальныйОстатокДт,
		        |	ХозрасчетныйОстаткиИОбороты.СуммаКонечныйОстатокДт КАК БУКонечныйОстатокДт,
		        |	ХозрасчетныйОстаткиИОбороты.СуммаКонечныйОстатокКт КАК БУКонечныйОстатокКт,
