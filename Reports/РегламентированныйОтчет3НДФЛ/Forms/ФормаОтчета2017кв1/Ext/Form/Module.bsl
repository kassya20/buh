...
Процедура ТабличныйДокументПриАктивизации(Элемент)
	...
	Если ТабличноеПолеИмя = "ЛистА" ИЛИ ТабличноеПолеИмя = "ЛистБ" Тогда
		...
		ДлинаИмени = СтрДлина(ТабличныйДокумент.ТекущаяОбласть.Имя) - 2;
		
		Если НЕ ТабличныйДокумент.Области.Найти(Лев(ТабличныйДокумент.ТекущаяОбласть.Имя, ДлинаИмени) +"_2") = Неопределено Тогда
