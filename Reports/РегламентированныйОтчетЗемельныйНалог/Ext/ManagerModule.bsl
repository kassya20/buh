			...
			Для Каждого Лист Из СведенияОтчета.ДанныеМногостраничныхРазделов.Раздел1 Цикл
				...
				Для Инд = 1 По 2 Цикл
					...
					ЗначениеПоказателя = ЗначениеПоказателя
					                   + РегламентированнаяОтчетность.ПоказательОтчета(ДанныеЛиста, "П000010002103" + Постфикс);
				КонецЦикла;
			КонецЦикла;
		Иначе
			ДанныеМногострочнойЧастиРаздела1
		...
		Для Каждого Лист Из СведенияОтчета.ДанныеМногостраничныхРазделов.Раздел1 Цикл
			...
			Для Инд = 1 По 5 Цикл
				...
				ЗначениеПоказателя = ЗначениеПоказателя
				                   ...
				                   - РегламентированнаяОтчетность.ПоказательОтчета(ДанныеЛиста, "П000010004003" + Постфикс);
			КонецЦикла;
		КонецЦикла;
	КонецЕсли;
