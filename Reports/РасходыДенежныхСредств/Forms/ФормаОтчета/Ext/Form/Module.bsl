...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбработкаНовостейПереопределяемый.КонтекстныеНовости_ПриСозданииНаСервере(
		ЭтотОбъект,
		"БП.Отчет.РасходыДенежныхСредств",
		"ФормаОтчета",
		НСтр("ru='Новости: Расходы денежных средств'"),
		"ПриОткрытии");
...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	Название = ?(ЗначениеЗаполнено(Форма.ПредставлениеТекущегоВарианта), Форма.ПредставлениеТекущегоВарианта, НСтр("ru='Расходы денежных средств'"));
...
Функция ПолучитьБаннерНаСервере(ПоказатьПредыдущий)
	...
	СтруктураПараметров.Вставить("Размещение", ПерсонализированныеПредложенияСервисов.ИмяРазмещенияРасходыДенежныхСредств());
