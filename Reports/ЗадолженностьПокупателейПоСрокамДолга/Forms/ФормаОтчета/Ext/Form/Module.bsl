...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбработкаНовостейПереопределяемый.КонтекстныеНовости_ПриСозданииНаСервере(
		ЭтотОбъект,
		"БП.Отчет.ЗадолженностьПокупателейПоСрокамДолга",
		"ФормаОтчета",
		НСтр("ru='Новости: Задолженность покупателей по срокам долга'"),
		"ПриОткрытии");
...
Процедура РезультатВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	Если Область.ГиперСсылка
		...
		Если ЕстьПравоПосмотраСрокиОплатыПокупателями() Тогда
...
Функция ЕстьПравоПосмотраСрокиОплатыПокупателями()
	
	Возврат ПравоДоступа("Просмотр" ,Метаданные.ОбщиеКоманды.СрокиОплатыПокупателями);
