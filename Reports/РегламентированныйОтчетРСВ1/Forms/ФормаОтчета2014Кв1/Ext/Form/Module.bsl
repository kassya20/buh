...
Процедура ТабличныйДокументПриАктивизации(Элемент)
	...
	Если (СтрЧислоВхождений(ТабличныйДокумент.ТекущаяОбласть.Имя, "П0003500001") > 0
	 ИЛИ СтрЧислоВхождений(ТабличныйДокумент.ТекущаяОбласть.Имя, "П0004000001") > 0
	 ИЛИ СтрЧислоВхождений(ТабличныйДокумент.ТекущаяОбласть.Имя, "П0005000001") > 0)
...
Процедура ПроверкаТитульногоЛиста(СтруктураРезультата)
	...
	РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя, НазваниеПоказателя,
		ЗначениеПоказателя, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Титульный", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
	...
	РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя1, НазваниеПоказателя1,
		ЗначениеПоказателя1, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Титульный", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
	РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя2, НазваниеПоказателя2,
		ЗначениеПоказателя2, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Титульный", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
	...
	РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя, НазваниеПоказателя,
		СокрЛП(ЗначениеПоказателя), "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Титульный", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
	...
	РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя1, НазваниеПоказателя1,
		ЗначениеПоказателя1Стр, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Титульный", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
	...
	РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя2, НазваниеПоказателя2,
		ЗначениеПоказателя2, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел1", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
...
Процедура ПроверкаРаздела1(СтруктураРезультата)
	...
	Если Год(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) < 2015 Тогда
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя, НазваниеПоказателя,
			ЗначениеПоказателя, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел1", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
	...
	Для Каждого Показатель Из Раздел1 Цикл
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, Показатель.Ключ, НазваниеПоказателя,
			Показатель.Значение, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел1", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
	...
	РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя, НазваниеПоказателя,
		ЛеваяЧасть, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел1", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
	...
	РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя, НазваниеПоказателя,
		ПраваяЧасть, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел22", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
	...
	РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя1, НазваниеПоказателя1,
		Формат(ЗначениеПоказателя1, "ЧРД=.;ЧН=0"), "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел1", Неопределено, Неопределено,
		СчетчикФормулДляРасшифровок);
	
	РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя2, НазваниеПоказателя2,
		Формат(ЗначениеПоказателя2, "ЧРД=.;ЧН=0"), "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Титульный", Неопределено, Неопределено,
		СчетчикФормулДляРасшифровок);
	...
	РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя, НазваниеПоказателя,
		ЗначениеПоказателя, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел4", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
	...
	РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя, НазваниеПоказателя,
		ПраваяЧастьСтр, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел1", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
...
Процедура ПроверкаРаздела2(СтруктураРезультата)
	...
	Для Каждого СтраницаР21 Из Раздел21 Цикл
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, "П000320032103", "Раздел 3.1",
			Раздел31ЗаполненСтр, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел31", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, "П000330033103", "Раздел 3.2",
			Раздел32ЗаполненСтр, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел31", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
...
Процедура ПроверкаРаздела22(СтруктураРезультата)
	...
	РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяКолЗастрахТитул, 
		НазваниеКолЗастрахТитул, ЗначениеКолЗастрахТитул, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Титульный", Неопределено, Неопределено,
		СчетчикФормулДляРасшифровок);
...
Процедура ПроверкаРаздела31(СтруктураРезультата)
	...
	Для ИндГр = 3 По 6 Цикл 
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя321, 
			НазваниеПоказателя321, ЗначениеПоказателя321, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел31", Неопределено, Неопределено,
			СчетчикФормулДляРасшифровок);
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя322, 
			НазваниеПоказателя322, ЗначениеПоказателя322, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел31", Неопределено, Неопределено,
			СчетчикФормулДляРасшифровок);
	...
	Для ИндГр = 3 По 6 Цикл 
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя323, 
			НазваниеПоказателя323, ЗначениеПоказателя323, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел31", Неопределено, Неопределено,
			СчетчикФормулДляРасшифровок);
	...
	Для ИндГр = 3 По 6 Цикл 
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя331, 
			НазваниеПоказателя331, ЗначениеПоказателя331, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел31", Неопределено, Неопределено,
			СчетчикФормулДляРасшифровок);
	...
	РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя332, 
		НазваниеПоказателя332, ЗначениеПоказателя332, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел31", Неопределено, Неопределено,
		СчетчикФормулДляРасшифровок);
	...
	РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателяССЧ, 
		НазваниеПоказателяССЧ, ЗначениеПоказателяССЧ, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Титульный", Неопределено, Неопределено,
		СчетчикФормулДляРасшифровок);
	...
	Для ИндГр = 3 По 6 Цикл 
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя333, 
			НазваниеПоказателя333, ЗначениеПоказателя333, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел31", Неопределено, Неопределено,
			СчетчикФормулДляРасшифровок);
	...
	Для ИндГр = 3 По 6 Цикл 
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя334, 
			НазваниеПоказателя334, ЗначениеПоказателя334, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел31", Неопределено, Неопределено,
			СчетчикФормулДляРасшифровок);
	...
	Для ИндГр = 3 По 6 Цикл 
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя335, 
			НазваниеПоказателя335, ЗначениеПоказателя335, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел31", Неопределено, Неопределено,
			СчетчикФормулДляРасшифровок);
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя336, 
			НазваниеПоказателя336, ЗначениеПоказателя336, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел31", Неопределено, Неопределено,
			СчетчикФормулДляРасшифровок);
	...
	РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяСт334Гр3, 
		НазваниеСт334Гр3, ЗначениеСт334Гр3, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел31", Неопределено, Неопределено,
		СчетчикФормулДляРасшифровок);
	...
	РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяСт335Гр3, 
		НазваниеСт335Гр3, ЗначениеСт335Гр3, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел31", Неопределено, Неопределено,
		СчетчикФормулДляРасшифровок);
	...
	Для ИндГр = 4 По 6 Цикл 
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяСт334, 
			НазваниеСт334, ЗначениеСт334Стр, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел31", Неопределено, Неопределено,
			СчетчикФормулДляРасшифровок);
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяСт335, 
			НазваниеСт335, ЗначениеСт335Стр, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел31", Неопределено, Неопределено,
			СчетчикФормулДляРасшифровок);
	...
	РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, "П000340034103", "Раздел 3.3",
		Раздел31ЗаполненСтр, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел33", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
	...
	НазваниеПоказателя341, ЗначениеПоказателя341, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел33", Неопределено, Неопределено,
	СчетчикФормулДляРасшифровок);
	...
	НазваниеПоказателя342, ЗначениеПоказателя342, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел33", Неопределено, Неопределено,
	СчетчикФормулДляРасшифровок);
	...
	НазваниеПоказателя343, ЗначениеПоказателя343, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел33", Неопределено, Неопределено,
	СчетчикФормулДляРасшифровок);
	...
	Для ИндГр = 3 По 4 Цикл 
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя344, 
			НазваниеПоказателя344, ЗначениеПоказателя344, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел33", Неопределено, Неопределено,
			СчетчикФормулДляРасшифровок);
	...
	НазваниеПоказателя345, ЗначениеПоказателя345, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел33", Неопределено, Неопределено,
	СчетчикФормулДляРасшифровок);
...
Процедура ПроверкаРаздела34(СтруктураРезультата)
	...
	РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, "П000350000101_1", "Раздел 3.4",
		Раздел34ЗаполненСтр, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел33", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
	...
	Для Инд = 1 По КолвоСтрокВМногострочнойЧасти Цикл
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя203, 
			НазваниеПоказателя203, ЗначениеПоказателя203, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел33", Неопределено, Неопределено,
			СчетчикФормулДляРасшифровок);
		
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя103, 
			НазваниеПоказателя103, ЗначениеПоказателя103, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел33", Неопределено, Неопределено,
			СчетчикФормулДляРасшифровок);
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя104, 
			...
			"Раздел33", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
	...
	РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя204, 
		НазваниеПоказателя204, ЗначениеПоказателя204, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел33", Неопределено, Неопределено,
		СчетчикФормулДляРасшифровок);
	...
	Для Инд = 1 По КолвоСтрокВМногострочнойЧасти Цикл
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя104, 
			НазваниеПоказателя104, ЗначениеПоказателя104, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел33", Неопределено, Неопределено,
			СчетчикФормулДляРасшифровок);
	...
	НазваниеПоказателя351, ЗначениеПоказателя351, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел33", Неопределено, Неопределено,
	СчетчикФормулДляРасшифровок);
...
Процедура ПроверкаРаздела35(СтруктураРезультата)
	...
	РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, "П000360036103", "Раздел 3.5",
		Раздел35ЗаполненСтр, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел35", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
	...
	НазваниеПоказателя361, ЗначениеПоказателя361, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел35", Неопределено, Неопределено,
	СчетчикФормулДляРасшифровок);
	...
	НазваниеПоказателя362, ЗначениеПоказателя362, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел35", Неопределено, Неопределено,
	СчетчикФормулДляРасшифровок);
	...
	РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя363, 
		НазваниеПоказателя363, Формат(ЗначениеПоказателя363, "ЧЦ=8; ЧДЦ=5; ЧН=-"), "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел35", Неопределено, Неопределено,
		СчетчикФормулДляРасшифровок);
	...
	РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, "П000370037103", "Раздел 3.6",
		Раздел36ЗаполненСтр, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел36", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
	...
	Для ИндГр = 3 По 4 Цикл 
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя371, 
			НазваниеПоказателя371, ЗначениеПоказателя371, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел35", Неопределено, Неопределено,
			СчетчикФормулДляРасшифровок);
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя372, 
			НазваниеПоказателя372, ЗначениеПоказателя372, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел35", Неопределено, Неопределено,
			СчетчикФормулДляРасшифровок);
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя373, 
			НазваниеПоказателя373, ЗначениеПоказателя373, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел35", Неопределено, Неопределено,
			СчетчикФормулДляРасшифровок);
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя374, 
			НазваниеПоказателя374, ЗначениеПоказателя374, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел35", Неопределено, Неопределено,
			СчетчикФормулДляРасшифровок);
	...
	Для ИндГр = 3 По 4 Цикл 
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя375, 
			НазваниеПоказателя375, ЗначениеПоказателя375, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел35", Неопределено, Неопределено,
			СчетчикФормулДляРасшифровок);
...
Процедура ПроверкаРаздела4(СтруктураРезультата)
	...
	Для Инд = 1 По КолвоСтрокВМногострочнойЧасти Цикл
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя120, НазваниеПоказателя120,
			ЗначениеПоказателя120, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел1", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяГр7, НазваниеГр7,
			ЗначениеГр7Стр, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел4", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяГр6, НазваниеГр6,
			ЗначениеГр6Стр, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел4", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
	...
	Для Инд = 1 По КолвоСтрокВМногострочнойЧасти Цикл
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяГр9, НазваниеГр9,
			ЗначениеГр9Стр, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел4", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяГр8, НазваниеГр8,
			ЗначениеГр8Стр, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел4", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
	...
	Для Инд = 1 По КолвоСтрокВМногострочнойЧасти Цикл
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяГр4, НазваниеГр4,
			ЗначениеГр4Стр, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел4", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяОтчетГод, НазваниеОтчетГод,
			ЗначениеОтчетГодСтр, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Титульный", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
	...
	Для Инд = 1 По КолвоСтрокВМногострочнойЧасти Цикл
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяГр5, НазваниеГр5,
			ЗначениеГр5Стр, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел4", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПериод, НазваниеПериод,
			ЗначениеПериодСтр, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Титульный", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
	...
	Для Инд = 1 По КолвоСтрокВМногострочнойЧасти Цикл
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя2, НазваниеПоказателя2,
			ЗначениеПоказателя2, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел4", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя4, НазваниеПоказателя4,
			ЗначениеПоказателя4, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел4", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя5, НазваниеПоказателя5,
			ЗначениеПоказателя5, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел4", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
	...
	Для Инд = 1 По КолвоСтрокВМногострочнойЧасти Цикл
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя13, НазваниеПоказателя13,
			ЗначениеПоказателя13, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел4", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя3, НазваниеПоказателя3,
			ЗначениеПоказателя3, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел4", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
	...
	Для ИндГр = 6 По 14 Цикл 
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателяИтого, НазваниеПоказателяИтого,
			ЗначениеПоказателяИтого, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел4", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
...
Процедура ПроверкаРаздела5(СтруктураРезультата)
	...
	Для Инд = 1 По КолвоСтрокВМногострочнойЧасти Цикл
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяГр5, 
			НазваниеГр5, ЗначениеГр5Стр, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел5", Неопределено, Неопределено,
			СчетчикФормулДляРасшифровок);
		...
		Для ИндГр = 6 По 8 Цикл 
			...
			РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя, 
				НазваниеПоказателя, ЗначениеПоказателяСтр, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел5", Неопределено, Неопределено,
				СчетчикФормулДляРасшифровок);
	...
	Для ИндГр = 5 По 8 Цикл 
		...
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателяИтого, НазваниеПоказателяИтого,
			ЗначениеПоказателяИтого, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел5", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
		...
		Для Инд = 1 По КолвоСтрокВМногострочнойЧасти Цикл
			...
			РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяПоказателя, НазваниеПоказателя,
				ЗначениеПоказателя, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел5", Неопределено, Неопределено, СчетчикФормулДляРасшифровок);
		...
		Для ИндГр = 3 По 4 Цикл 
			...
			Если Строка501Заполнена Тогда
				РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, ИмяСт501, 
					НазваниеСт501, ЗначениеСт501Стр, "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел5", Неопределено, Неопределено,
					СчетчикФормулДляРасшифровок);
				Прервать;
			КонецЕсли;
		КонецЦикла;
	...
	Если НЕ Строка501Заполнена Тогда 
		РегламентированнаяОтчетность.ЗарегистрироватьПоказательДляРасшифровки(СписокРасшифровкиПоказателей, "П000500501103", 
			НазваниеСт501, "", "", СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка, "Раздел5", Неопределено, Неопределено,
			СчетчикФормулДляРасшифровок);
	КонецЕсли;
