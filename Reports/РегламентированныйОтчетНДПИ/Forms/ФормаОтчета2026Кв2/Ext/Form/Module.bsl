...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мВерсияФормы = "01/05/2026";
...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если СтруктураЗависимыхЯчеекДляАвторасчета.Свойство(ИмяРаздела) Тогда
		...
		Если ИмяРаздела = "Раздел21" ИЛИ ИмяРаздела = "Раздел211" ИЛИ ИмяРаздела = "Раздел212" ИЛИ ИмяРаздела = "Раздел22"
			ИЛИ ИмяРаздела = "Раздел3" ИЛИ ИмяРаздела = "Раздел31" ИЛИ ИмяРаздела = "Раздел311" ИЛИ ИмяРаздела = "Раздел33"
			ИЛИ ИмяРаздела = "Раздел5" ИЛИ ИмяРаздела = "Раздел51" ИЛИ ИмяРаздела = "Раздел52" ИЛИ ИмяРаздела = "Раздел53"
			ИЛИ ИмяРаздела = "Раздел7" ИЛИ ИмяРаздела = "Раздел71" ИЛИ ИмяРаздела = "Раздел72" ИЛИ ИмяРаздела = "Раздел73"
			ИЛИ ИмяРаздела = "Раздел81" ИЛИ ИмяРаздела = "Раздел82" Тогда
...
Процедура Проверить(Команда)
	...
	ПоказатьПредупреждение(, НСтр(
		...
		|от 10.03.2026 № ЕД-1-3/155@ будет реализована
...
Процедура СформироватьСтруктуруРеквизитовФормы()
	...
	СтруктураРеквизитовФормы.Вставить("мИдГруппыР54М1");
...
Процедура Инициализация(БезОткрытияФормы = Ложь) Экспорт
	...
	СтруктураРеквизитовФормы.Вставить("НастраиваемоеПредставлениеНулевогоЗначения_ИменаПоказателей",
	СтрРазделить("П000030014003,П000330047003", ",", Ложь));
	...
	Если НЕ БезОткрытияФормы Тогда
		...
		Элементы.ГруппаПредставлениеФормы.Видимость = ТекущаяДатаСеанса() < '20260613';
	КонецЕсли;
...
Процедура ИнициализироватьМногострочныеЧасти()
	...
	СтруктураРеквизитовФормы.мИдГруппыР54М1  = "П00054М1";
	...
	// Группа П00054М1.
	ИменаГраф = Новый Массив;
	ИменаГраф.Добавить("П00054М130003");
	ИменаГраф.Добавить("П00054М131003");
	ИменаГраф.Добавить("П00054М132003");
	ИменаГраф.Добавить("П00054М132503");
	ИменаГраф.Добавить("П00054М133003");
	СтруктураМногострочныхЧастей.Вставить(СтруктураРеквизитовФормы.мИдГруппыР54М1, Новый Структура(
	"ИменаГраф,ИсхКолСтрок,УровеньПодчинения,ИменаПодчиненныхГрупп", ИменаГраф, 1, 0, Новый Массив));
...
Процедура ИнициализироватьМногоуровневыеРазделы()
	...
	ИменаПодчиненныхРазделов.Добавить("Раздел54");
	СтруктураРаздела.Вставить("ИменаПодчиненныхРазделов", ИменаПодчиненныхРазделов);
	...
	СтруктураРаздела.Вставить("Многостраничность");
	ИменаГруппМнЧ = Новый Массив;
	ИменаГруппМнЧ.Добавить(СтруктураРеквизитовФормы.мИдГруппыР54М1);
	СтруктураРаздела.Вставить("ИменаГруппМнЧ", ИменаГруппМнЧ);
	СтруктураРаздела.Вставить("Подчиненность");
	СтруктураРаздела.Вставить("ИмяГлавногоРаздела", "Раздел5");
	СтруктураРаздела.Вставить("НаимСтраницы", "Подраздел 5.4");
	мСтруктураМногоуровневыхРазделов.Вставить("Раздел54", СтруктураРаздела);
...
Процедура СформироватьСпискиВыбора()
	...
	"Выбор признака основания для объема газа", КоллекцияСписковВыбора["ПрОснОбГаз_Р33"]);
	...
	//5.4.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П00054М130003", 5, ,
	"Выбор кода драгоценного металла", КоллекцияСписковВыбора["КодыМет_Р54"]);
...
Процедура УстановитьДоступностьОбластей(Форма, ИмяРаздела)
	...
	ИначеЕсли ИмяРаздела = "Раздел22" ИЛИ ИмяРаздела = "Раздел311" ИЛИ ИмяРаздела = "Раздел53"
		ИЛИ ИмяРаздела = "Раздел6" ИЛИ ИмяРаздела = "Раздел71" ИЛИ ИмяРаздела = "Раздел72"
		ИЛИ ИмяРаздела = "Раздел73" ИЛИ ИмяРаздела = "Раздел82" Тогда
	...
	ИначеЕсли ИмяРаздела = "Раздел3" Тогда
		...
		ТДО["СекцияПояснение045"].Видимость = КодВидаПИ = "03200"
	...
	ИначеЕсли ИмяРаздела = "Раздел51" Тогда
		...
		ОбрабатываемаяОбласть = ТДО["П000510014003"];
		Если КодВидаПИ <> "13000" Тогда
			УдалитьИмяАвтоРасчПоказателя(Форма, АвтоРасчПоказатели, ОбрабатываемаяОбласть.Имя);
			РазрешитьВводДанныхВОбласть(Форма, ОбрабатываемаяОбласть);
		КонецЕсли;
...
Процедура ВывестиДанныеВТабличныйДокумент(ИмяТекРаздела, НовыеНомераСтрокМногоуровнегоРаздела = Неопределено)
	...
	Если мСтруктураМногоуровневыхРазделов.Свойство(ИмяТекРаздела) Тогда
		...
		// Особая обработка.
		//
		Если ИмяТекРаздела = "Раздел31" ИЛИ ИмяТекРаздела = "Раздел33" Тогда
...
Процедура Расчет(Форма, ИмяРаздела = "", ОбластьИмя = "") Экспорт
	...
	Если ИмяРаздела = "Раздел21" ИЛИ ИмяРаздела = "Раздел211" ИЛИ ИмяРаздела = "Раздел212" ИЛИ ИмяРаздела = "Раздел22"
		ИЛИ ИмяРаздела = "Раздел3" ИЛИ ИмяРаздела = "Раздел31" ИЛИ ИмяРаздела = "Раздел33" ИЛИ ИмяРаздела = "Раздел311"
		ИЛИ ИмяРаздела = "Раздел5" ИЛИ ИмяРаздела = "Раздел51" ИЛИ ИмяРаздела = "Раздел52" ИЛИ ИмяРаздела = "Раздел53"
		ИЛИ ИмяРаздела = "Раздел7" ИЛИ ИмяРаздела = "Раздел71" ИЛИ ИмяРаздела = "Раздел72" ИЛИ ИмяРаздела = "Раздел73"
		ИЛИ ИмяРаздела = "Раздел81" ИЛИ ИмяРаздела = "Раздел82"Тогда
...
Процедура РасчетВДеревеЗначений(Форма, ИмяРаздела)
	...
	Если ИмяРаздела = "Раздел21" ИЛИ ИмяРаздела = "Раздел211" ИЛИ ИмяРаздела = "Раздел212" ИЛИ ИмяРаздела = "Раздел22" Тогда
		...
		ВозмПрНалВыч_22 = СтрРазделить("01,02,03,04,05,06,09,14", ",", Ложь);
	...
	ИначеЕсли ИмяРаздела = "Раздел3" ИЛИ ИмяРаздела = "Раздел31" ИЛИ ИмяРаздела = "Раздел311" ИЛИ ИмяРаздела = "Раздел33" Тогда
		...
		Для каждого Ветка_3 Из ДеревоДанных.Строки Цикл
			...
			Для каждого Ветка_33 Из Ветка_3.Строки[1].Строки Цикл
	...
	ИначеЕсли ИмяРаздела = "Раздел5" ИЛИ ИмяРаздела = "Раздел51" ИЛИ ИмяРаздела = "Раздел52" ИЛИ ИмяРаздела = "Раздел53" Тогда
		...
		Для каждого Ветка_5 Из ДеревоДанных.Строки Цикл
			...
			Для каждого Ветка_51 Из Ветка_5.Строки[0].Строки Цикл
				...
				// Стр.140.
				Если КодВидаПИ = "13000" Тогда
					Ветка_51.Данные.Вставить("П000510014003", Окр(Ветка_51.Данные["П000510013503"], 2)
					- Окр(Ветка_51.Данные["П000510012003"], 2) - Окр(Ветка_51.Данные["П000510013003"], 2));
				Иначе
	...
	ИначеЕсли ИмяРаздела = "Раздел7" ИЛИ ИмяРаздела = "Раздел71" ИЛИ ИмяРаздела = "Раздел72" ИЛИ ИмяРаздела = "Раздел73" Тогда
		...
		ВозмКоды_Расчет = СтрРазделить("1010,1020,1040,1050,1060,6000,6100", ",", Ложь);
		...
		Для каждого Ветка_7 Из ДеревоДанных.Строки Цикл
			...
			Для каждого Ветка_71 Из Ветка_7.Строки[0].Строки Цикл
				...
				Для каждого СтрокаМнЧ Из ДеревоМнЧ.Строки Цикл
					...
					// Стр.057.
					Если ВозмКоды_Расчет.Найти(КодОснНал) <> Неопределено Тогда
						СтрокаМнЧ.Данные.Вставить("П00071М105703",
						Окр(СтрокаМнЧ.Данные["П00071М105503"] * СтрокаМнЧ.Данные["П00071М105603"]));
						СуммаСтр057_6000 = СуммаСтр057_6000 + ?(КодОснНал = "6000", СтрокаМнЧ.Данные["П00071М105703"], 0);
					Иначе
			...
			// Стр.130.
			Ветка_72.Данные.Вставить("П000720013003", СуммаСтр057_6000);
	...
	ИначеЕсли ИмяРаздела = "Раздел81" ИЛИ ИмяРаздела = "Раздел82" Тогда
		...
		ВозмПрНалВыч_82 = СтрРазделить("01,02,03,04,05,06,09,14", ",", Ложь);
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки)
	...
	Если ТекущаяДатаСеанса() < '20260613' Тогда
		
		СообщитьВТС("До 12.06.2026 (включительно) представление декларации доступно только по форме "
			+ "в редакции приказа ФНС России от 13.11.2025 № ЕД-7-3/976@", "Титульный", "НомерКорректировки");
	...
	Если ЗаполненаМногострочнаяЧасть(ДанныеМнЧ) Тогда
		Для каждого СтрокаМнЧ Из ДанныеМнЧ.Строки Цикл
			...
			Если Окр(СтрокаМнЧ.Данные["П00001М103003"]) < 0 Тогда
				СообщитьВТС("Раздел 1: в строке " + НомСтроки
					+ " значение суммы налога, подлежащей уплате в бюджет, не должно быть отрицательным",
					"Раздел1", "П00001М103003_" + НомСтроки, НомСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
	...
	Если ЗаполненРаздел(ДеревоРаздела, "Раздел2") Тогда
		...
		Для каждого Ветка_2 Из ДеревоРаздела.Строки Цикл
			...
			Для каждого Ветка_21 Из Ветка_2.Строки[0].Строки Цикл
				...
				ИменаПок = СтрРазделить("П000210013003,П000210015003", ",", ЛОжь);
				Для каждого ИмяПок Из ИменаПок Цикл
					Если Окр(Ветка_21.Данные[ИмяПок]) < 0 Тогда
						СообщитьВТС("Раздел 2 -> Страница " + НомСтраницы_2 + " -> Подраздел 2.1 -> Страница " + НомСтраницы_21
							+ ": значение в строке с кодом " + Сред(ИмяПок, 9, 3) + " не должно быть отрицательным",
							"Раздел21", ИмяПок, Координаты_21);
						СтатусПроверки = Ложь;
					КонецЕсли;
				КонецЦикла;
				...
				Если ЗаполненРаздел(Ветка_21.Строки[1], "Раздел212") Тогда
					...
					Для каждого Ветка_212 Из Ветка_21.Строки[1].Строки Цикл
						...
						ИмяПок = "П002120026003";
						Если Окр(Ветка_212.Данные[ИмяПок]) < 0 Тогда
							СообщитьВТС("Раздел 2 -> Страница " + НомСтраницы_2 + " -> Подраздел 2.1 -> Страница " + НомСтраницы_21
								+ " -> Подраздел 2.1.2 -> Страница " + НомСтраницы_212 + ": значение в строке с кодом " + Сред(ИмяПок, 9, 3)
								+ " не должно быть отрицательным", "Раздел212", ИмяПок, Координаты_212);
							СтатусПроверки = Ложь;
						КонецЕсли;
			...
			ИначеЕсли ЗаполненаМногострочнаяЧасть(ДанныеМнЧ) Тогда
				Для каждого СтрокаМнЧ Из ДанныеМнЧ.Строки Цикл
					...
					ИменаПок = СтрРазделить("П00022М132003,П00022М134003", ",", ЛОжь);
					Для каждого ИмяПок Из ИменаПок Цикл
						Если Окр(СтрокаМнЧ.Данные[ИмяПок]) < 0 Тогда
							СообщитьВТС("Раздел 2 -> Страница " + НомСтраницы_2 + " -> Подраздел 2.2: в строке " + НомСтроки
								+ " значение в строке с кодом " + Сред(ИмяПок, 9, 3) + " не должно быть отрицательным",
								"Раздел22", ИмяПок + "_" + НомСтроки, Координаты_22);
							СтатусПроверки = Ложь;
						КонецЕсли;
					КонецЦикла;
	...
	Если ЗаполненРаздел(ДеревоРаздела, "Раздел3") Тогда
		...
		Для каждого Ветка_3 Из ДеревоРаздела.Строки Цикл
			...
			ИменаПок = СтрРазделить("П000030004003,П000030005003", ",", ЛОжь);
			Для каждого ИмяПок Из ИменаПок Цикл
				Если Окр(Ветка_3.Данные[ИмяПок]) < 0 Тогда
					СообщитьВТС("Раздел 3 -> Страница " + НомСтраницы_3 + ": значение в строке с кодом " + Сред(ИмяПок, 9, 3)
						+ " не должно быть отрицательным", "Раздел3", ИмяПок, НомСтраницы_3);
					СтатусПроверки = Ложь;
				КонецЕсли;
			КонецЦикла;
			...
			Для каждого Ветка_31 Из Ветка_3.Строки[0].Строки Цикл
				...
				ИменаПок = СтрРазделить("П000310021003,П000310022003", ",", ЛОжь);
				Для каждого ИмяПок Из ИменаПок Цикл
					Если Окр(Ветка_31.Данные[ИмяПок]) < 0 Тогда
						СообщитьВТС("Раздел 3 -> Страница " + НомСтраницы_3 + " -> Подраздел 3.1 -> Страница " + НомСтраницы_31
							+ ": значение в строке с кодом " + Сред(ИмяПок, 9, 3) + " не должно быть отрицательным",
							"Раздел31", ИмяПок, Координаты_31);
						СтатусПроверки = Ложь;
					КонецЕсли;
				КонецЦикла;
				...
				Для каждого Ветка_311 Из Ветка_31.Строки[0].Строки Цикл
					...
					ИмяПок = "П003110031003";
					Если Окр(Ветка_311.Данные[ИмяПок]) < 0 Тогда
						СообщитьВТС("Раздел 3 -> Страница " + НомСтраницы_3 + " -> Подраздел 3.1 -> Страница " + НомСтраницы_31
							+ " -> Подраздел 3.1.1 -> Страница " + НомСтраницы_311 + ": значение в строке с кодом " + Сред(ИмяПок, 9, 3)
							+ " не должно быть отрицательным", "Раздел311", ИмяПок, Координаты_311);
						СтатусПроверки = Ложь;
					КонецЕсли;
			...
			ЗаполненПодр33 = ЗаполненРаздел(Ветка_3.Строки[1], "Раздел33");
			...
			Если ДолженБытьЗаполненПодр33 И НЕ ЗаполненПодр33 Тогда
				...
				"Раздел33", "П000330037003", НомСтраницы_3 + ",2,1");
				СтатусПроверки = Ложь;
			...
			ИначеЕсли ЗаполненПодр33 Тогда
				...
				Для каждого Ветка_33 Из Ветка_3.Строки[1].Строки Цикл
					...
					НомСтраницы_33 = Формат(Ветка_3.Строки[1].Строки.Индекс(Ветка_33) + 1, "ЧГ=");
					Координаты_33 = НомСтраницы_3 + ",2," + НомСтраницы_33;
	...
	Если ЗаполненРаздел(ДеревоРаздела, "Раздел4") Тогда
		...
		Для каждого Ветка Из ДеревоРаздела.Строки Цикл
			...
			ИмяПок = "П000040013003";
			Если Окр(Ветка.Данные[ИмяПок], 2) < 0 Тогда
				СообщитьВТС("Раздел 4 -> Страница " + НомСтраницы + ": значение в строке с кодом " + Сред(ИмяПок, 9, 3)
				+ " не должно быть отрицательным", "Раздел4", ИмяПок, НомСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			...
			ИменаПок = СтрРазделить("П000040014003,П000040017003", ",", ЛОжь);
			Для каждого ИмяПок Из ИменаПок Цикл
				Если Окр(Ветка.Данные[ИмяПок]) < 0 Тогда
					СообщитьВТС("Раздел 4 -> Страница " + НомСтраницы + ": значение в строке с кодом " + Сред(ИмяПок, 9, 3)
						+ " не должно быть отрицательным", "Раздел4", ИмяПок, НомСтраницы);
					СтатусПроверки = Ложь;
				КонецЕсли;
	...
	Если ЗаполненРаздел(ДеревоРаздела, "Раздел5") Тогда
		...
		ВозможныеКодыМет       = ВозможныеЗначенияИзСпискаВыбораПоказателя("П00054М130003");
		...
		Для каждого Ветка_5 Из ДеревоРаздела.Строки Цикл
			...
			Для каждого Ветка_51 Из Ветка_5.Строки[0].Строки Цикл
				...
				ИмяПок = "П000510014003";
				Если Окр(Ветка_51.Данные[ИмяПок], 2) < 0 Тогда
					СообщитьВТС("Раздел 5 -> Страница " + НомСтраницы_5 + " -> Подраздел 5.1 -> Страница " + НомСтраницы_51
						+ ": значение в строке с кодом " + Сред(ИмяПок, 9, 3) + " не должно быть отрицательным",
						"Раздел51", ИмяПок, Координаты_51);
					СтатусПроверки = Ложь;
				КонецЕсли;
				...
				ИменаПок = СтрРазделить("П000510015003,П000510017003", ",", ЛОжь);
				Для каждого ИмяПок Из ИменаПок Цикл
					Если Окр(Ветка_51.Данные[ИмяПок]) < 0 Тогда
						СообщитьВТС("Раздел 5 -> Страница " + НомСтраницы_5 + " -> Подраздел 5.1 -> Страница " + НомСтраницы_51
							+ ": значение в строке с кодом " + Сред(ИмяПок, 9, 3) + " не должно быть отрицательным",
							"Раздел51", ИмяПок, Координаты_51);
						СтатусПроверки = Ложь;
			...
			Если ВозможныеКодыПИ.МассивЗначений.Найти(КодВидаПИ) <> Неопределено Тогда
				...
				Если Раздел54ДолженБытьЗаполнен(КодВидаПИ) И НЕ ЗаполненРаздел(Ветка_5.Строки[3], "Раздел54") Тогда
					
					СообщитьВТС("Раздел 5 -> Страница " + НомСтраницы_5
					+ " -> Подраздел 5.4 должен быть заполнен при коде вида добытого полезного ископаемого, равном "
					+ КодВидаПИ, "Раздел54", "П000540029903", НомСтраницы_5 + ",4,1");
					СтатусПроверки = Ложь;
					
				ИначеЕсли НЕ Раздел54ДолженБытьЗаполнен(КодВидаПИ) И ЗаполненРаздел(Ветка_5.Строки[3], "Раздел54") Тогда
					
					СообщитьВТС("Раздел 5 -> Страница " + НомСтраницы_5
					+ " -> Подраздел 5.4 не должен быть заполнен при коде вида добытого полезного ископаемого, равном "
					+ КодВидаПИ, "Раздел54", "П000540029903", НомСтраницы_5 + ",4,1");
					СтатусПроверки = Ложь;
					
				ИначеЕсли Раздел54ДолженБытьЗаполнен(КодВидаПИ) И ЗаполненРаздел(Ветка_5.Строки[3], "Раздел54") Тогда
					
					Для каждого Ветка_54 Из Ветка_5.Строки[3].Строки Цикл
						
						НомСтраницы_54 = Формат(Ветка_5.Строки[3].Строки.Индекс(Ветка_54) + 1, "ЧГ=");
						Координаты_54 = НомСтраницы_5 + ",4," + НомСтраницы_54;
						...
						ВозможныеДлиныЗначенияРеквизита.Добавить(4);
						СтруктураПараметров = Новый Структура("ТипРеквизита,ЗначениеРеквизита,ВозможныеДлиныЗначенияРеквизита",
						"Серия", СокрЛП(Ветка_54.Данные["П000540029903"]), ВозможныеДлиныЗначенияРеквизита);
						Если НЕ РеквизитЛицензииСоответствуетТребованиям(СтруктураПараметров, ТекстСообщения) Тогда
							СообщитьВТС("Раздел 5 -> Страница " + НомСтраницы_5 + " -> Подраздел 5.4 -> Страница " + НомСтраницы_54
							+ ": " + ТекстСообщения, "Раздел54", "П000540029903", Координаты_54);
							СтатусПроверки = Ложь;
						КонецЕсли;
						СтруктураПараметров
						= Новый Структура("ТипРеквизита,ЗначениеРеквизита", "Номер", СокрЛП(Ветка_54.Данные["П000540029904"]));
						Если НЕ РеквизитЛицензииСоответствуетТребованиям(СтруктураПараметров, ТекстСообщения) Тогда
							СообщитьВТС("Раздел 5 -> Страница " + НомСтраницы_5 + " -> Подраздел 5.4 -> Страница " + НомСтраницы_54
							+ ": " + ТекстСообщения, "Раздел54", "П000540029904", Координаты_54);
							СтатусПроверки = Ложь;
						КонецЕсли;
						СтруктураПараметров
						= Новый Структура("ТипРеквизита,ЗначениеРеквизита", "Вид", СокрЛП(Ветка_54.Данные["П000540029905"]));
						Если НЕ РеквизитЛицензииСоответствуетТребованиям(СтруктураПараметров, ТекстСообщения) Тогда
							СообщитьВТС("Раздел 5 -> Страница " + НомСтраницы_5 + " -> Подраздел 5.4 -> Страница " + НомСтраницы_54
							+ ": " + ТекстСообщения, "Раздел54", "П000540029905", Координаты_54);
							СтатусПроверки = Ложь;
						КонецЕсли;
						
						ДанныеМнЧ = Ветка_54.ДанныеМногострочныхЧастей[СтруктураРеквизитовФормы.мИдГруппыР54М1];
						
						Для каждого СтрокаМнЧ Из ДанныеМнЧ.Строки Цикл
							ИндСтрокиМнЧ = ДанныеМнЧ.Строки.Индекс(СтрокаМнЧ);
							НомСтроки = Формат(ИндСтрокиМнЧ + 1, "ЧГ=");
							
							ЗначПок = СокрЛП(СтрокаМнЧ.Данные["П00054М130003"]);
							ДлинаЗначПок = СтрДлина(ЗначПок);
							Если ВозможныеКодыМет.МассивЗначений.Найти(ЗначПок) = Неопределено Тогда
								СообщитьВТС("Раздел 5 -> Страница " + НомСтраницы_5 + " -> Подраздел 5.4 -> Страница "
								+ НомСтраницы_54 + ": в строке " + НомСтроки + " " + ?(ДлинаЗначПок = 0, "не задан ", "")
								+ "код драгоценного металла, содержащегося в добытом полезном ископаемом" + ?(ДлинаЗначПок <> 0,
								", должен принимать одно из значений: " + ВозможныеКодыМет.СтрокаЗначений, ""),
								"Раздел54", "П00054М130003_" + НомСтроки, Координаты_54);
								СтатусПроверки = Ложь;
							КонецЕсли;
						КонецЦикла;
	...
	Если ЗаполненРаздел(ДеревоРаздела, "Раздел7") Тогда
		...
		Для каждого Ветка_7 Из ДеревоРаздела.Строки Цикл
			...
			Для каждого Ветка_71 Из Ветка_7.Строки[0].Строки Цикл
				...
				ИмяПок = "П000710005203";
				Если Окр(Ветка_71.Данные[ИмяПок]) < 0 Тогда
					СообщитьВТС("Раздел 7 -> Страница " + НомСтраницы_7 + " -> Подраздел 7.1 -> Страница " + НомСтраницы_71
						+ ": значение в строке с кодом " + Сред(ИмяПок, 9, 3) + " не должно быть отрицательным",
						"Раздел71", ИмяПок, Координаты_71);
					СтатусПроверки = Ложь;
				КонецЕсли;
				...
				Для каждого СтрокаМнЧ Из ДанныеМнЧ.Строки Цикл
					...
					ИмяПок = "П00071М105703";
					Если Окр(СтрокаМнЧ.Данные[ИмяПок]) < 0 Тогда
						СообщитьВТС("Раздел 7 -> Страница " + НомСтраницы_7 + " -> Подраздел 7.1 -> Страница " + НомСтраницы_71
							+ ": в строке " + НомСтроки + " значение в строке с кодом " + Сред(ИмяПок, 9, 3)
							+ " не должно быть отрицательным", "Раздел71", ИмяПок + "_" + НомСтроки, Координаты_71);
						СтатусПроверки = Ложь;
					КонецЕсли;
			...
			ИменаПок = СтрРазделить("П000720013003,П000720015003", ",", ЛОжь);
			Для каждого ИмяПок Из ИменаПок Цикл
				Если Окр(Ветка_72.Данные[ИмяПок]) < 0 Тогда
					СообщитьВТС("Раздел 7 -> Страница " + НомСтраницы_7 + " -> Подраздел 7.2: значение в строке с кодом "
						+ Сред(ИмяПок, 9, 3) + " не должно быть отрицательным", "Раздел72", ИмяПок, Координаты_72);
					СтатусПроверки = Ложь;
				КонецЕсли;
			КонецЦикла;
	...
	Если ЗаполненРаздел(ДеревоРаздела, "Раздел8") Тогда
		...
		Для каждого Ветка_8 Из ДеревоРаздела.Строки Цикл
			...
			Для каждого Ветка_81 Из Ветка_8.Строки[0].Строки Цикл
				...
				ИменаПок = СтрРазделить("П000810015003,П000810018003", ",", ЛОжь);
				Для каждого ИмяПок Из ИменаПок Цикл
					Если Окр(Ветка_81.Данные[ИмяПок]) < 0 Тогда
						СообщитьВТС("Раздел 8 -> Страница " + НомСтраницы_8 + " -> Подраздел 8.1 -> Страница " + НомСтраницы_81
							+ ": значение в строке с кодом " + Сред(ИмяПок, 9, 3) + " не должно быть отрицательным",
							"Раздел81", ИмяПок, Координаты_81);
						СтатусПроверки = Ложь;
					КонецЕсли;
				КонецЦикла;
			...
			ИначеЕсли ЗаполненаМногострочнаяЧасть(ДанныеМнЧ) Тогда
				Для каждого СтрокаМнЧ Из ДанныеМнЧ.Строки Цикл
					...
					ИменаПок = СтрРазделить("П00082М122003,П00082М124003", ",", ЛОжь);
					Для каждого ИмяПок Из ИменаПок Цикл
						Если Окр(СтрокаМнЧ.Данные[ИмяПок]) < 0 Тогда
							СообщитьВТС("Раздел 8 -> Страница " + НомСтраницы_8 + " -> Подраздел 8.2: в строке " + НомСтроки
								+ " значение в строке с кодом " + Сред(ИмяПок, 9, 3) + " не должно быть отрицательным",
								"Раздел82", ИмяПок + "_" + НомСтроки, Координаты_82);
							СтатусПроверки = Ложь;
						КонецЕсли;
					КонецЦикла;
...
Функция ПоказателиНеанализируемыеНаЗаполненность()
	...
	Возврат СтрРазделить(
		"П000020001003,П000020003003,П000330038003,П000080001003,П000080003003", ",", Ложь);
...
Процедура ЗаполнитьСодержательнуюЧасть(УзелРодитель, ПараметрыВыгрузки)
	...
	Если ЗаполненРаздел(ДеревоРаздела, "Раздел2") Тогда
		...
		Для каждого Ветка_2 Из ДеревоРаздела.Строки Цикл
			...
			Для каждого Ветка_21 Из Ветка_2.Строки[0].Строки Цикл
				...
				// Переопределение для строк 140, 150.
	...
	Для каждого Ветка_3 Из ДеревоРаздела.Строки Цикл
		...
		// 3.3.
		Если ЗаполненРаздел(Ветка_3.Строки[1], "Раздел33") Тогда
	...
	Для каждого Ветка_5 Из ДеревоРаздела.Строки Цикл
		...
		// 5.4.
		ДаннРасчКонц = ПолучитьПодчиненныйЭлемент(ЭкзИсчУплНалИскл, "ДаннРасчКонц");
		
		Если Раздел54ДолженБытьЗаполнен(КодВидаПИ) Тогда
			
			Для каждого Ветка_54 Из Ветка_5.Строки[3].Строки Цикл
				
				ЭкзДаннРасчКонц = СкопироватьУзел(ЭкзИсчУплНалИскл, ДаннРасчКонц, ЭкзИсчУплНалИскл.Строки.Количество() - 1);
				
				Для каждого Эл Из ЭкзДаннРасчКонц.Строки Цикл
					Если Эл.Строки.Количество() = 0 Тогда
						ВывестиПоказательВXML(Эл, Ветка_54.Данные[Эл.Ключ]);
					КонецЕсли;
				КонецЦикла;
				
				ДанныеМнЧ = Ветка_54.ДанныеМногострочныхЧастей[СтруктураРеквизитовФормы.мИдГруппыР54М1];
				ДаннРасчКонцКод = ПолучитьПодчиненныйЭлемент(ЭкзДаннРасчКонц, "ДаннРасчКонцКод");
				Для каждого СтрокаМнЧ Из ДанныеМнЧ.Строки Цикл
					ЭкзДаннРасчКонцКод = СкопироватьУзел(ЭкзДаннРасчКонц, ДаннРасчКонцКод, ЭкзДаннРасчКонц.Строки.Количество() - 1);
					Для каждого Эл Из ЭкзДаннРасчКонцКод.Строки Цикл
						ВывестиПоказательВXML(Эл, СтрокаМнЧ.Данные[Эл.Ключ]);
					КонецЦикла;
				КонецЦикла;
				РегламентированнаяОтчетность.УдалитьУзел(ДаннРасчКонцКод);
				
			КонецЦикла;
			
		КонецЕсли;
		
		РегламентированнаяОтчетность.УдалитьУзел(ДаннРасчКонц);
	...
	Если ЗаполненРаздел(ДеревоРаздела, "Раздел8") Тогда
		...
		Для каждого Ветка_8 Из ДеревоРаздела.Строки Цикл
			...
			Для каждого Ветка_81 Из Ветка_8.Строки[0].Строки Цикл
				...
				// Переопределение для строк 165, 180.
...
Процедура ОчиститьНаСервере() Экспорт
	...
	ИначеЕсли СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел53"
		...
		СтруктураРеквизитовФормы.НомераСтрокМногоуровнегоРаздела.Добавить(1);
	ИначеЕсли СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел54" Тогда
...
Процедура Печать(ВидПечати, НеИзФормыОтчета = Ложь) Экспорт
	...
	ПоказатьПредупреждение(, НСтр(
		"ru='Печать без штрихкода PDF417 формы
		|отчета в редакции приказа ФНС России
		|от 10.03.2026 № ЕД-1-3/155@ будет реализована
		|в будущих версиях программы'"));
...
Процедура СформироватьСлужебныеДанные()
	...
	ИменаРазделов.Вставить("Р55", "Раздел54");
	...
	ПредставленияРазделов.Вставить("Р55", "Подраздела 5.4 Раздела 5");
	...
	ДанныеРазделов.Добавить(Новый Структура("Раздел,Подраздел,Уровень,Индекс", "Раздел5"	, "Подраздел54"	, 1, 3));
...
Процедура ПодготовитьНастройки(Заголовки)
	...
	Если НЕ НастройкиКС.Критичность = 3 Тогда 
		НастройкиКС.Критичность = -1;
		НастройкиКС.Основание = НастройкиКС.Основание + ", (проверка носит справочный характер)";
	КонецЕсли;
...
Процедура ПроверкаКС_7_17()
	...
	Заголовки.Вставить("Описание"			, НСтр("ru='Сумма налога в стр.130 подр.7.2 Раздела 7 = стр.057 подр.7.1.1 '") + 
		НСтр("ru='Раздела 7, если стр.054 подр.7.1.1 Раздела 7 = 6000'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Возможно ошибочная сумма расходов'"));
...
Процедура ПроверкаКС_7_18()
	...
	Заголовки.Вставить("Описание"			, НСтр("ru='Сумма расходов в стр.110 подр.7.2 Раздела 7 > 0, '") + 
		НСтр("ru='если стр.054 подр.7.1.1 Раздела 7 = 6000'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 > 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Возможно ошибочная сумма расходов'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru='Укажите сумму расходов в стр.110 подр.7.2 Раздела 7 > 0'"));
	Заголовки.Вставить("Основание"			, НСтр("ru='Письмо ФНС России от 15.01.2025 № СД-4-3/239@'"));
...
Процедура ПроверкаКС_7_20()
	...
	Заголовки.Вставить("Описание"			, НСтр("ru='Сумма налога в стр.150 подр.7.2 Раздела 7 = стр.(130 - 110) '") + 
		НСтр("ru='подр.7.2 Раздела 7, если стр.054 подр.7.1.1 Раздела 7 = 6000'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2 (%3 - %4)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Возможно ошибочная сумма налога'"));
...
&НаСервере
Функция Раздел54ДолженБытьЗаполнен(КодВидаПИ)
	
	Возврат СокрЛП(КодВидаПИ) = "13000";
...
Процедура ВвестиПоказатель(Элемент, Область, КодПоказателя, Знач ЭтоСумма, Знач ТекстВыбора, ТаблицаВыбора, СтандартнаяОбработка, КолонкаПоиска = "Код") Экспорт
	...
	Если Область.Имя = "П002120023003" ИЛИ Область.Имя = "П000030009503" ИЛИ Область.Имя = "П000030011003"
		...
		ИЛИ Область.Имя = "П000510005003" Тогда
...
Процедура ВвестиПоказательЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	Если Область.Имя = КодПоказателя ИЛИ МногострочнаяЧастьТекущейОбласти(ЭтотОбъект, Область.Имя) <> Неопределено Тогда
		...
		Если СтруктураРеквизитовФормы["НастраиваемоеПредставлениеНулевогоЗначения_ИменаПоказателей"].Найти(Область.Имя)
			...
			Область.Формат = ?(РезультатВыбора[КолонкаПоиска] = "0", СтрЗаменить(Область.Формат, "ЧН=-", "ЧН=0"), СтрЗаменить(Область.Формат, "ЧН=0", "ЧН=-"));
...
Процедура АктивизироватьЯчейку(Ячейка) Экспорт
	...
	ИначеЕсли Ячейка.Раздел = "Раздел21" ИЛИ Ячейка.Раздел = "Раздел211" ИЛИ Ячейка.Раздел = "Раздел212"
		ИЛИ Ячейка.Раздел = "Раздел31" ИЛИ Ячейка.Раздел = "Раздел311" ИЛИ Ячейка.Раздел = "Раздел33"
		ИЛИ Ячейка.Раздел = "Раздел51" ИЛИ Ячейка.Раздел = "Раздел52" ИЛИ Ячейка.Раздел = "Раздел54"
...
Процедура УстановитьЧисловойФорматОбласти(ИмяРаздела)
	...
	Если ИмяРаздела = "Раздел21" Тогда
		ТДО["П000210005503"].ТипЗначения = СтруктураРеквизитовФормы.НеотрицательноеЧисло15_10;
		ТДО["П000210006003"].ТипЗначения = СтруктураРеквизитовФормы.Число17_10;
		ТДО["П000210012503"].ТипЗначения = СтруктураРеквизитовФормы.НеотрицательноеЧисло16_10;
	ИначеЕсли ИмяРаздела = "Раздел212" Тогда
		ТДО["П002120020503"].ТипЗначения = СтруктураРеквизитовФормы.НеотрицательноеЧисло15_10;
		ТДО["П002120021003"].ТипЗначения = СтруктураРеквизитовФормы.Число17_10;
	ИначеЕсли ИмяРаздела = "Раздел3" Тогда
		ТДО["П000030018003"].ТипЗначения = СтруктураРеквизитовФормы.НеотрицательноеЧисло16_15;
		ТДО["П000030018503"].ТипЗначения = СтруктураРеквизитовФормы.НеотрицательноеЧисло16_10;
	ИначеЕсли ИмяРаздела = "Раздел54" Тогда
		Индекс = 1;
		ИндексСтр = "1";
		РегламентированнаяОтчетностьКлиентСервер.УстановитьИндекс(Индекс, ИндексСтр);
		Обл = ТДО.Найти("П00054М131003_" + ИндексСтр);
		Пока Обл <> Неопределено Цикл
			Обл.ТипЗначения = СтруктураРеквизитовФормы.НеотрицательноеЧисло11_10;
			РегламентированнаяОтчетностьКлиентСервер.УвеличитьИндекс(Индекс, ИндексСтр);
			Обл = ТДО.Найти("П00054М131003_" + ИндексСтр);
		КонецЦикла;
	КонецЕсли;
