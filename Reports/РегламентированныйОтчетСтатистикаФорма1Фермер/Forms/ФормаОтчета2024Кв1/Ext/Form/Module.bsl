...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	СтрокаИнд = 0;
	СуммаПоСтроке10 = 0;
	//стр.10 = стр.8 + стр.9(по кодам 1020300,1030100,1060000,1080202,1110000,1120000,1130000,2080300,1010900,2000000))
	Пока Истина Цикл
		СтрокаИнд = СтрокаИнд + 1;
		ЯчейкаКодКультуры = "П001001000902" + "_" + СтрокаИнд;
		Если Области.Найти(ЯчейкаКодКультуры) = Неопределено Тогда
			Прервать;
		КонецЕсли;
		Если Области[ЯчейкаКодКультуры].Значение = "1020300" Или Области[ЯчейкаКодКультуры].Значение = "1030100"
		 Или Области[ЯчейкаКодКультуры].Значение = "1060000" Или Области[ЯчейкаКодКультуры].Значение = "1080202"
		 Или Области[ЯчейкаКодКультуры].Значение = "1110000" Или Области[ЯчейкаКодКультуры].Значение = "1120000"
		 Или Области[ЯчейкаКодКультуры].Значение = "1130000" Или Области[ЯчейкаКодКультуры].Значение = "2080300"
		 Или Области[ЯчейкаКодКультуры].Значение = "1010900" Или Области[ЯчейкаКодКультуры].Значение = "2000000" Тогда
	...
	СтрокаИнд = 0;
	СуммаПоСтроке17 = 0;
	//стр.17 = стр.11 + стр.12 + стр.13 + стр.14 + стр.15 + стр.16(код 3020000,3010400,3100000,3110000,3130200,3120200,3140000,3210300,3310000)
	Пока Истина Цикл
		СтрокаИнд = СтрокаИнд + 1;
		ЯчейкаКодКультуры = "П001001001402" + "_" + СтрокаИнд;
		Если Области.Найти(ЯчейкаКодКультуры) = Неопределено Тогда
			Прервать;
		КонецЕсли;
		Если Области[ЯчейкаКодКультуры].Значение = "3020000" Или Области[ЯчейкаКодКультуры].Значение = "3010400"
		 Или Области[ЯчейкаКодКультуры].Значение = "3100000" Или Области[ЯчейкаКодКультуры].Значение = "3110000"
		 Или Области[ЯчейкаКодКультуры].Значение = "3130200" Или Области[ЯчейкаКодКультуры].Значение = "3120200"
		 Или Области[ЯчейкаКодКультуры].Значение = "3140000" Или Области[ЯчейкаКодКультуры].Значение = "3210300"
		 Или Области[ЯчейкаКодКультуры].Значение = "3310000" Тогда
