...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("СформироватьКарту", Истина);
...
Функция ПолучитьТекстЗаголовка(ПараметрыОтчета) Экспорт 
	...
	Если ЗначениеЗаполнено(ПараметрыОтчета.ОрганизацияРасшифровки) Тогда		
		ЗаголовокОтчета = ЗаголовокОтчета + " " + БухгалтерскиеОтчетыВызовСервера.ПолучитьТекстОрганизация(ПараметрыОтчета.ОрганизацияРасшифровки,
			Ложь, ПараметрыОтчета.КонецПериода);
	КонецЕсли;
...
Функция СформироватьКарту(Знач ПараметрыОтчета) Экспорт
