...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка) 
	...
	ОбработкаНовостейПереопределяемый.КонтекстныеНовости_ПриСозданииНаСервере(
		ЭтотОбъект,
		"БП.Отчет.СправкаРасчетКлассификацияПоСрокамРассрочки",
		"ФормаОтчета",
		НСтр("ru = 'Новости: Справка-расчет ""Классификация рассрочки по срокам""'"),
...
Функция ПолучитьЗапрещенныеПоля(Режим = "") Экспорт
	...
	СписокПолей.Добавить("КонтрагентГрафики");
	СписокПолей.Добавить("ДоговорКонтрагентаГрафики");
	СписокПолей.Добавить("ИсточникСрокаПогашения");
	СписокПолей.Добавить("ИсточникСрокаПогашенияДетально");
	СписокПолей.Добавить("ЭтоДокумент");
	СписокПолей.Добавить("ЭтоДокументДетально");
	СписокПолей.Добавить("ДокументИсточникаСрокаПредставление");
	СписокПолей.Добавить("ДокументИсточникаСрокаПредставлениеДетально");
