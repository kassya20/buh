...
Процедура ПередКомпоновкойМакета(ПараметрыОтчета, Схема, КомпоновщикНастроек) Экспорт
	...
	БухгалтерскиеОтчетыКлиентСервер.УстановитьПараметр(КомпоновщикНастроек, "СчетаРасходыПериода", СчетаРасходыПериода);
	
	ВидыКосвенныхРасходовНУ = РегистрыСведений.МетодыОпределенияПрямыхРасходовПроизводстваВНУ.ЗапрещенныеВидыРасходовНУ();
	БухгалтерскиеОтчетыКлиентСервер.УстановитьПараметр(КомпоновщикНастроек, "ВидыКосвенныхРасходовНУ", ВидыКосвенныхРасходовНУ);
	...
	БухгалтерскиеОтчетыКлиентСервер.УстановитьПараметр(
		...
		УчетнаяПолитика.ФормироватьСтоимостьПоПравиламБУ(ПараметрыОтчета.Организация, ПараметрыОтчета.НачалоПериода));
		
	БухгалтерскиеОтчетыКлиентСервер.УстановитьПараметр(
		КомпоновщикНастроек,
		"ВидыСтатейВнереализационныеРасходы",
		ВидыСтатейВнереализационныеРасходы());
...
Функция ВидыСтатейВнереализационныеРасходы()
	
	ВсеВнереализационныеРасходы = Новый Массив;// Включая "приравненные убытки"
	ОбщегоНазначенияКлиентСервер.ДополнитьМассив(ВсеВнереализационныеРасходы, Перечисления.ВидыПрочихДоходовИРасходов.ВнереализационныеРасходы());
	ОбщегоНазначенияКлиентСервер.ДополнитьМассив(ВсеВнереализационныеРасходы, Перечисления.ВидыПрочихДоходовИРасходов.ВнереализационныеУбытки());
	
	ВидыСтатейВнереализационныеРасходы = Новый СписокЗначений;
	ВидыСтатейВнереализационныеРасходы.ЗагрузитьЗначения(ВсеВнереализационныеРасходы);
	
	Возврат ВидыСтатейВнереализационныеРасходы;
