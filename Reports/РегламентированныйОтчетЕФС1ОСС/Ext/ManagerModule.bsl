...
Функция ТаблицаФормОтчета() Экспорт
	...
	= "Приложение № 1 к приказу Фонда пенсионного и социального страхования Российской Федерации от 17.11.2025 № 1462.";
	НоваяФорма.РедакцияФормы      = "от 17.11.2025 № 1462.";
	...
	НоваяФорма.ДатаКонецДействия  = '20260331';
...
Функция ДеревоФормИФорматов() Экспорт
	...
	"ЕФС1ОСС", '2025-11-17', "1462", "ФормаОтчета2026Кв1");
	ОпределитьФорматВДеревеФормИФорматов(ФормаОтчета2026Кв1, "1.20");
...
Процедура ПоказателиОценкиРискаВыезднойНалоговойПроверки(ТаблицаПоказателей, ОписаниеОтчета) Экспорт 
	...
	Если ВРег(СокрЛП(ОписаниеОтчета.ВыбраннаяФорма)) = ВРег("ФормаОтчета2026Кв1")
		ИЛИ ВРег(СокрЛП(ОписаниеОтчета.ВыбраннаяФорма)) = ВРег("ФормаОтчета2024Кв1")
		ИЛИ ВРег(СокрЛП(ОписаниеОтчета.ВыбраннаяФорма)) = ВРег("ФормаОтчета2023Кв1") Тогда
