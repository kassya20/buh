...
Функция ТаблицаФормОтчета() Экспорт
	...
	НоваяФорма.ОписаниеОтчета     = "Приложение № 4 к Порядку представления в форме электронного документа "
...
Функция ДеревоФормИФорматов() Экспорт
	...
	Форма20210101 = ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы, "1152040", '2020-12-17', "396", "ФормаОтчета2021Кв1");
