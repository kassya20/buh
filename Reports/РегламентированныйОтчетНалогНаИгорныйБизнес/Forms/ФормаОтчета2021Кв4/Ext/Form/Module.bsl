...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки)
	...
	Если Год(СтруктураРеквизитовФормы.мСохраненныйДок.ДатаОкончания) >= 2026
		И СтруктураРеквизитовФормы.мСохраненныйДок.Вид = 0 И ТекущаяДатаСеанса() >= '20260504' Тогда
		
		СообщитьВТС("С 04.05.2026 представление первичной декларации по налогу на игорный бизнес, начиная с отчета за период"
			+ " январь 2026 года, доступно только по форме, утвержденной приказом ФНС России от 29.01.2026 № ЕД-1-3/57@",
