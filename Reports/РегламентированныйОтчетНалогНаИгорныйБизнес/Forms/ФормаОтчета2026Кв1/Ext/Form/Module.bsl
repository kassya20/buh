...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли Область.Имя = "П000210008003" И НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов Тогда
		
		СтандартнаяОбработка = Ложь;
		
		СписокКодов = Новый СписокЗначений;
		СписокКодов.Добавить(0, "Пустое значение");
		СписокКодов.Добавить(15000, "15 000 - за один игровой автомат (пп. 2 п. 1 ст. 333.61 НК РФ)");
	...
	ИначеЕсли Область.Имя = "П000220002003" И НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов Тогда
		
		СтандартнаяОбработка = Ложь;
		
		СписокКодов = Новый СписокЗначений;
		СписокКодов.Добавить(0, "Пустое значение");
		СписокКодов.Добавить(250000, "250 000 - за один игровой стол (пп. 1 п. 1 ст. 333.61 НК РФ)");
	...
	ИначеЕсли (Область.Имя = "П000410009003" ИЛИ Область.Имя = "П000420009003")
		...
		СписокКодов = Новый СписокЗначений;
		СписокКодов.Добавить(0, "Пустое значение");
		СписокКодов.Добавить(7, "7% (п. 2 ст. 333.61 НК РФ)");
...
Процедура УстановитьДоступностьОбластей(Форма, ИмяРаздела)
	...
	Иначе
		...
		Если ИмяРаздела = "Раздел22" Тогда
			...
			КоличествоИгровыхПолей = Окр(ТДО["П000220001003"].Значение);
	...
	ИначеЕсли ИмяРаздела = "Раздел2" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяРаздела Тогда
			...
			Если ЗначениеЗаполнено(ОбластьИмя) Тогда
				...
				ТДО["П000210008004"].Значение = Окр(Окр(ТДО["П000210008003"].Значение) * Окр(ТДО["П000020003004"].Значение)
					+ (Окр(ТДО["П000210008003"].Значение) / 2) * Окр(ТДО["П000020004004"].Значение));
	...
	ИначеЕсли ИмяРаздела = "Раздел22" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяРаздела Тогда
			...
			Если ЗначениеЗаполнено(ОбластьИмя) Тогда
				...
				ТДО["П000220003003"].Значение = Окр(ТДО["П000220002003"].Значение) * КоличествоИгровыхПолей;
				
				Если КоличествоИгровыхПолей = 1 Тогда
					
					ТДО["П000220009003"].Значение = Окр(Окр(ТДО["П000220005003"].Значение) * Окр(ТДО["П000220002003"].Значение)
					+ Окр(ТДО["П000220006003"].Значение) * (Окр(ТДО["П000220002003"].Значение) / 2));
					
				ИначеЕсли КоличествоИгровыхПолей > 1 Тогда
					
					ТДО["П000220009003"].Значение = Окр(Окр(ТДО["П000220007003"].Значение) * Окр(ТДО["П000220003003"].Значение)
					+ Окр(ТДО["П000220008003"].Значение) * (Окр(ТДО["П000220003003"].Значение) / 2));
	...
	ИначеЕсли ИмяРаздела = "Раздел3" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяРаздела Тогда
			...
			Если ЗначениеЗаполнено(ОбластьИмя) Тогда
				...
				ТДО["П000030006003"].Значение = Макс(0, Окр(ТДО["П000030001003"].Значение) + Окр(ТДО["П000030002003"].Значение)
					- Окр(ТДО["П000030003003"].Значение) + Окр(ТДО["П000030004003"].Значение) - Окр(ТДО["П000030005003"].Значение));
				
				ТДО["П000030006004"].Значение = Макс(0, Окр(ТДО["П000030001004"].Значение) + Окр(ТДО["П000030002004"].Значение)
					- Окр(ТДО["П000030003004"].Значение) + Окр(ТДО["П000030004004"].Значение) - Окр(ТДО["П000030005004"].Значение));
	...
	ИначеЕсли ИмяРаздела = "Раздел31" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяРаздела Тогда
			...
			Если ЗначениеЗаполнено(ОбластьИмя) Тогда
				...
				ТДО["П000310007003"].Значение = Макс(0, Окр(ТДО["П000310002003"].Значение) + Окр(ТДО["П000310003003"].Значение)
					- Окр(ТДО["П000310004003"].Значение) + Окр(ТДО["П000310005003"].Значение) - Окр(ТДО["П000310006003"].Значение));
	...
	ИначеЕсли ИмяРаздела = "Раздел4" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяРаздела Тогда
			...
			Если ЗначениеЗаполнено(ОбластьИмя) Тогда
				...
				ТДО["П000410006003"].Значение = Окр(ТДО["П000410004003"].Значение) + Окр(ТДО["П000410005003"].Значение);
				ТДО["П000410008003"].Значение = Окр(ТДО["П000410006003"].Значение) - Окр(ТДО["П000410007003"].Значение);
				ТДО["П000410010003"].Значение = Окр(Окр(ТДО["П000410008003"].Значение) * ТДО["П000410009003"].Значение / 100);
				
				ТДО["П000420006003"].Значение = Окр(ТДО["П000420004003"].Значение) + Окр(ТДО["П000420005003"].Значение);
				ТДО["П000420008003"].Значение = Окр(ТДО["П000420006003"].Значение) - Окр(ТДО["П000420007003"].Значение);
				ТДО["П000420010003"].Значение = Окр(Окр(ТДО["П000420008003"].Значение) * ТДО["П000420009003"].Значение / 100);
				
				ТДО["П000040001003"].Значение = Окр(ТДО["П000410010003"].Значение) + Окр(ТДО["П000420010003"].Значение);
...
Процедура РасчетВДеревеЗначений(Форма, ИмяРаздела)
	...
	Если ИмяРаздела = "Раздел1" Тогда
		...
		// Поставка данных из разделов 2, 4.
		//
		...
		Дан2 = ДеревоДанных2.Строки[0].Данные;
		Дан4 = ДеревоДанных4.Строки[0].Данные;
		Дан.Вставить("П000010003003", Окр(Дан2["П000210007004"]) + Окр(Дан2["П000210008004"]) + Окр(Дан4["П000040001003"]));
	...
	ИначеЕсли ИмяРаздела = "Раздел2" Тогда
		...
		//
		ДеревоДанных22 = ПолучитьИзВременногоХранилища(
			Форма.СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел22"]);
		Стр020Гр3 = 0;
		Стр030Гр3 = 0;
		Стр040Гр3 = 0;
		Стр050Гр3 = 0;
		...
		Для каждого Ветка22 Из ДеревоДанных22.Строки Цикл
			...
			КоличествоИгровыхПолей = Окр(Дан22["П000220001003"]);
			Если КоличествоИгровыхПолей > 0 Тогда
				Стр020Гр3 = Стр020Гр3 + Окр(Дан22["П000220004003"]);
				Стр030Гр3 = Стр030Гр3 + Окр(Дан22["П000220005003"]);
				Стр040Гр3 = Стр040Гр3 + Окр(Дан22["П000220006003"]);
				Стр050Гр3 = Стр050Гр3 + Окр(Дан22["П000220007003"]);
				Стр060Гр3 = Стр060Гр3 + Окр(Дан22["П000220008003"]);
				Стр070Гр4 = Стр070Гр4 + Окр(Дан22["П000220009003"]);
			КонецЕсли;
		КонецЦикла;
		Дан.Вставить("П000020002003", Стр020Гр3);
		Дан.Вставить("П000020003003", Стр030Гр3);
		Дан.Вставить("П000020004003", Стр040Гр3);
		Дан.Вставить("П000020005003", Стр050Гр3);
		Дан.Вставить("П000020006003", Стр060Гр3);
		Дан.Вставить("П000210007004", Стр070Гр4);
		
		// Поставка данных из раздела 3.
		//
		ДеревоДанных3 = ПолучитьИзВременногоХранилища(
			Форма.СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел3"]);
		Дан3 = ДеревоДанных3.Строки[0].Данные;
		Дан.Вставить("П000020002004",
			Окр(Дан3["П000030001004"]) + Окр(Дан3["П000030002004"]) + Окр(Дан3["П000030004004"]));
		Дан.Вставить("П000020003004", Макс(0,
			Окр(Дан["П000020002004"]) - Окр(Дан3["П000030004004"]) - Окр(Дан3["П000030005004"])));
		Дан.Вставить("П000020004004", Окр(Дан3["П000030004004"]) + Окр(Дан3["П000030005004"]));
		
		Дан.Вставить("П000210008004", Окр(Окр(Дан["П000210008003"]) * Окр(Дан["П000020003004"])
			+ (Окр(Дан["П000210008003"]) / 2) * Окр(Дан["П000020004004"])));
	...
	ИначеЕсли ИмяРаздела = "Раздел22" Тогда
		...
		Для каждого Ветка Из ДеревоДанных.Строки Цикл
			...
			КоличествоИгровыхПолей = Окр(Дан["П000220001003"]);
			
			Дан.Вставить("П000220003003", Окр(Дан["П000220002003"]) * КоличествоИгровыхПолей);
			
			Дан.Вставить("П000220004003", 0);
			Дан.Вставить("П000220005003", 0);
			Дан.Вставить("П000220006003", 0);
			Дан.Вставить("П000220007003", 0);
			Дан.Вставить("П000220008003", 0);
			Дан.Вставить("П000220009003", 0);
			
			// Поставка данных из раздела 3.1 по условию.
			//
			Если КоличествоИгровыхПолей > 0 Тогда
				ДеревоДанных31 = ПолучитьИзВременногоХранилища(
					Форма.СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел31"]);
				Для каждого Ветка31 Из ДеревоДанных31.Строки Цикл
					Дан31 = Ветка31.Данные;
					Если Окр(Дан31["П000310001003"]) = КоличествоИгровыхПолей Тогда
						Дан.Вставить("П000220004003",
							Окр(Дан31["П000310002003"]) + Окр(Дан31["П000310003003"]) + Окр(Дан31["П000310005003"]));
						Если КоличествоИгровыхПолей = 1 Тогда
							Дан.Вставить("П000220005003", Макс(0,
								Окр(Дан["П000220004003"]) - (Окр(Дан31["П000310005003"]) + Окр(Дан31["П000310006003"]))));
							Дан.Вставить("П000220006003", Окр(Дан31["П000310005003"]) + Окр(Дан31["П000310006003"]));
						ИначеЕсли КоличествоИгровыхПолей > 1 Тогда
							Дан.Вставить("П000220007003", Макс(0,
								Окр(Дан["П000220004003"]) - (Окр(Дан31["П000310005003"]) + Окр(Дан31["П000310006003"]))));
							Дан.Вставить("П000220008003", Окр(Дан31["П000310005003"]) + Окр(Дан31["П000310006003"]));
						КонецЕсли;
			...
			Если КоличествоИгровыхПолей = 1 Тогда
				Дан.Вставить("П000220009003", Окр(Окр(Дан["П000220005003"]) * Окр(Дан["П000220002003"])
					+ Окр(Дан["П000220006003"]) * (Окр(Дан["П000220002003"]) / 2)));
			ИначеЕсли КоличествоИгровыхПолей > 1 Тогда
				Дан.Вставить("П000220009003", Окр(Окр(Дан["П000220007003"]) * Окр(Дан["П000220003003"])
					+ Окр(Дан["П000220008003"]) * (Окр(Дан["П000220003003"]) / 2)));
			КонецЕсли;
	...
	ИначеЕсли ИмяРаздела = "Раздел3" Тогда
		...
		Для каждого Ветка31 Из ДеревоДанных31.Строки Цикл
			Дан31 = Ветка31.Данные;
			КоличествоИгровыхПолей = Окр(Дан31["П000310001003"]);
			Если КоличествоИгровыхПолей > 0 Тогда
				Стр010Гр3 = Стр010Гр3 + Окр(Дан31["П000310002003"]);
				Стр020Гр3 = Стр020Гр3 + Окр(Дан31["П000310003003"]);
				Стр030Гр3 = Стр030Гр3 + Окр(Дан31["П000310004003"]);
				Стр040Гр3 = Стр040Гр3 + Окр(Дан31["П000310005003"]);
				Стр050Гр3 = Стр050Гр3 + Окр(Дан31["П000310006003"]);
			КонецЕсли;
		КонецЦикла;
		Дан.Вставить("П000030001003", Стр010Гр3);
		Дан.Вставить("П000030002003", Стр020Гр3);
		Дан.Вставить("П000030003003", Стр030Гр3);
		Дан.Вставить("П000030004003", Стр040Гр3);
		Дан.Вставить("П000030005003", Стр050Гр3);
		
		Дан.Вставить("П000030006003", Макс(0, Окр(Дан["П000030001003"]) + Окр(Дан["П000030002003"])
			- Окр(Дан["П000030003003"]) + Окр(Дан["П000030004003"]) - Окр(Дан["П000030005003"])));
		Дан.Вставить("П000030006004", Макс(0, Окр(Дан["П000030001004"]) + Окр(Дан["П000030002004"])
			- Окр(Дан["П000030003004"]) + Окр(Дан["П000030004004"]) - Окр(Дан["П000030005004"])));
	...
	ИначеЕсли ИмяРаздела = "Раздел31" Тогда
		...
		Для каждого Ветка Из ДеревоДанных.Строки Цикл
			...
			Дан.Вставить("П000310007003", Макс(0, Окр(Дан["П000310002003"]) + Окр(Дан["П000310003003"])
				- Окр(Дан["П000310004003"]) + Окр(Дан["П000310005003"]) - Окр(Дан["П000310006003"])));
	...
	ИначеЕсли ИмяРаздела = "Раздел4" Тогда
		...
		Дан.Вставить("П000410006003", Окр(Дан["П000410004003"]) + Окр(Дан["П000410005003"]));
		Дан.Вставить("П000410008003", Окр(Дан["П000410006003"]) - Окр(Дан["П000410007003"]));
		Дан.Вставить("П000410010003", Окр(Окр(Дан["П000410008003"]) * Дан["П000410009003"] / 100));
		
		Дан.Вставить("П000420006003", Окр(Дан["П000420004003"]) + Окр(Дан["П000420005003"]));
		Дан.Вставить("П000420008003", Окр(Дан["П000420006003"]) - Окр(Дан["П000420007003"]));
		Дан.Вставить("П000420010003", Окр(Окр(Дан["П000420008003"]) * Дан["П000420009003"] / 100));
		
		Дан.Вставить("П000040001003", Окр(Дан["П000410010003"]) + Окр(Дан["П000420010003"]));
...
Процедура ЗаполнитьСтруктуруЗависимыхЯчеекДляАвторасчета()
	...
	Структ.Вставить("П000040001003");
	Структ.Вставить("П000410006003");
	Структ.Вставить("П000410008003");
	Структ.Вставить("П000410010003");
	Структ.Вставить("П000420006003");
	Структ.Вставить("П000420008003");
	Структ.Вставить("П000420010003");
	...
	Структ.Вставить("П000210007004");
	Структ.Вставить("П000210008004");
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки)
	...
	Если НЕ ЗаполненРаздел(СохрСтруктура.ДанныеМногоуровневыхРазделов["Раздел2"], "Раздел2")
		И НЕ ЗаполненРаздел(СохрСтруктура.ДанныеМногоуровневыхРазделов["Раздел22"], "Раздел22")
		И НЕ ЗаполненРаздел(СохрСтруктура.ДанныеМногоуровневыхРазделов["Раздел4"], "Раздел4") Тогда
		СообщитьВТС("Должен быть заполнен хотя бы один из разделов 2 и 4", "Раздел2", "П000020002003", "1");
		СтатусПроверки = Ложь;
	КонецЕсли;
	...
	Раздел22ДолженБытьЗаполнен
		  = Окр(Данные["П000020002003"]) > 0 ИЛИ Окр(Данные["П000020003003"]) > 0 ИЛИ Окр(Данные["П000020004003"]) > 0
		ИЛИ Окр(Данные["П000020005003"]) > 0 ИЛИ Окр(Данные["П000020006003"]) > 0 ИЛИ Окр(Данные["П000210007004"]) > 0;
	...
	Если ЗаполненРаздел(ДеревоРаздела, "Раздел22") Тогда
		...
		Для каждого Ветка Из ДеревоРаздела.Строки Цикл
			...
			КоличествоИгровыхПолей = Окр(Ветка.Данные["П000220001003"]);
	...
	Раздел31ДолженБытьЗаполнен
		  = Окр(Данные["П000030001003"]) > 0 ИЛИ Окр(Данные["П000030002003"]) > 0 ИЛИ Окр(Данные["П000030003003"]) > 0
		ИЛИ Окр(Данные["П000030004003"]) > 0 ИЛИ Окр(Данные["П000030005003"]) > 0 ИЛИ Окр(Данные["П000030006003"]) > 0;
	...
	Если ЗаполненРаздел(ДеревоРаздела, "Раздел31") Тогда
		...
		Для каждого Ветка Из ДеревоРаздела.Строки Цикл
			...
			НомСтраницы = Формат(ДеревоРаздела.Строки.Индекс(Ветка) + 1, "ЧГ=");
			КоличествоИгровыхПолей = Окр(Ветка.Данные["П000310001003"]);
	...
	Если ЗаполненРаздел(ДеревоРаздела, "Раздел4") Тогда
		...
		Раздел41Заполнен = Ложь;
		Раздел42Заполнен = Ложь;
		
		Для каждого Пок Из Данные Цикл
			Если Окр(Пок.Значение) <> 0 Тогда
				Раздел41Заполнен = Раздел41Заполнен ИЛИ СтрНачинаетсяС(Пок.Ключ, "П00041");
				Раздел42Заполнен = Раздел42Заполнен ИЛИ СтрНачинаетсяС(Пок.Ключ, "П00042");
			КонецЕсли;
		КонецЦикла;
		
		Если НЕ Раздел41Заполнен И НЕ Раздел42Заполнен Тогда
			СообщитьВТС("В разделе 4 должен быть заполнен хотя бы один из подразделов 4.1 и 4.2",
				"Раздел4", "П000410001003", "1");
			СтатусПроверки = Ложь;
		КонецЕсли;
...
Процедура ЗаполнитьСодержательнуюЧасть(УзелРодитель, ПараметрыВыгрузки)
	...
	//
	ДеревоРаздела = СохрСтруктура.ДанныеМногоуровневыхРазделов["Раздел2"];
	РасчНал = ПолучитьПодчиненныйЭлемент(УзелРодитель, "РасчНал1.333.58");
	...
	//
	ДеревоРаздела = СохрСтруктура.ДанныеМногоуровневыхРазделов["Раздел4"];
	РасчНал = ПолучитьПодчиненныйЭлемент(УзелРодитель, "РасчНал2.333.58");
	ЗаполнитьДаннымиУзел(ДеревоРаздела.Строки[0].Данные, РасчНал);
...
Функция ПечатьНаСервере(ВидПечати)
	...
	ВыводитьНаПечатьРаздел2  = Ложь;
	ВыводитьНаПечатьРаздел22 = Ложь;
	Для Каждого СтраницаОтчета Из мДеревоВыбранныхСтраниц.ПолучитьЭлементы() Цикл
		Если СтраницаОтчета.ИмяСтраницы = "Раздел2" И СтраницаОтчета.ВыводНаПечать = 1 Тогда
			ВыводитьНаПечатьРаздел2 = Истина;
		ИначеЕсли СтраницаОтчета.ИмяСтраницы = "Раздел22" И СтраницаОтчета.ВыводНаПечать = 1 Тогда
			ВыводитьНаПечатьРаздел22 = Истина;
		КонецЕсли;
	КонецЦикла;
	ОбщиеРеквизитыРазделов.Вставить("ВыводитьНаПечатьРаздел2",  ВыводитьНаПечатьРаздел2);
	ОбщиеРеквизитыРазделов.Вставить("ВыводитьНаПечатьРаздел22", ВыводитьНаПечатьРаздел22);
	ОбщиеРеквизитыРазделов.Вставить("ВыведенНаПечатьРаздел2_Раздел22", Ложь);
	
	ВыводитьНаПечатьРаздел3  = Ложь;
	ВыводитьНаПечатьРаздел31 = Ложь;
	Для Каждого СтраницаОтчета Из мДеревоВыбранныхСтраниц.ПолучитьЭлементы() Цикл
		Если СтраницаОтчета.ИмяСтраницы = "Раздел3" И СтраницаОтчета.ВыводНаПечать = 1 Тогда
			ВыводитьНаПечатьРаздел3 = Истина;
		ИначеЕсли СтраницаОтчета.ИмяСтраницы = "Раздел31" И СтраницаОтчета.ВыводНаПечать = 1 Тогда
			ВыводитьНаПечатьРаздел31 = Истина;
		КонецЕсли;
	КонецЦикла;
	ОбщиеРеквизитыРазделов.Вставить("ВыводитьНаПечатьРаздел3",  ВыводитьНаПечатьРаздел3);
	ОбщиеРеквизитыРазделов.Вставить("ВыводитьНаПечатьРаздел31", ВыводитьНаПечатьРаздел31);
	ОбщиеРеквизитыРазделов.Вставить("ВыведенНаПечатьРаздел3_Раздел31", Ложь);
...
Процедура ВывестиНаПечатьДанныеМногоуровневогоРаздела(СтруктураПараметров, ОбщиеРеквизитыРазделов, СтрПоля)
	...
	Если ИмяТекРаздела = "Раздел1" ИЛИ ИмяТекРаздела = "Раздел4" Тогда
	...
	ИначеЕсли ИмяТекРаздела = "Раздел2" ИЛИ ИмяТекРаздела = "Раздел22" Тогда
		
		Если НЕ ОбщиеРеквизитыРазделов.ВыведенНаПечатьРаздел2_Раздел22 Тогда
			
			Если ОбщиеРеквизитыРазделов.ВыводитьНаПечатьРаздел2
				И ОбщиеРеквизитыРазделов.ВыводитьНаПечатьРаздел22 Тогда
				
				ДеревоДанныхРаздела22 = ПолучитьИзВременногоХранилища(
					СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел22"]);
				
				Для каждого Ветка Из ДеревоДанныхРаздела22.Строки Цикл
					
					ТабличныйДокумент.Очистить();
					МакетРаздела = ОбъектОтчета(ИмяФормы).ПолучитьМакет(Сред(
						ИмяФормы, СтрНайти(ИмяФормы, "ФормаОтчета")) + "_Раздел2");
					ТабличныйДокумент.Вывести(МакетРаздела);
					МакетРаздела = ОбъектОтчета(ИмяФормы).ПолучитьМакет(Сред(
						ИмяФормы, СтрНайти(ИмяФормы, "ФормаОтчета")) + "_Раздел22");
					ТабличныйДокумент.Вывести(МакетРаздела);
					
					Если ДеревоДанныхРаздела22.Строки.Индекс(Ветка) = 0 Тогда
						
						ДеревоДанныхРаздела2 = ПолучитьИзВременногоХранилища(
							СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел2"]);
						
						Ветка2 = ДеревоДанныхРаздела2.Строки[0];
						
						Для каждого Пок Из Ветка2.Данные Цикл
							Обл = ТабличныйДокумент.Области.Найти(Пок.Ключ);
							Если Обл <> Неопределено Тогда
								Обл.Значение = Пок.Значение;
							КонецЕсли;
					...
					СтруктураПараметровРаздела.Вставить("ИмяСтраницы", "Раздел2");
					СтруктураПараметровРаздела.Вставить("НаименованиеЛиста", "Раздел 2");
					ВывестиНаПечатьЛист(СтруктураПараметровРаздела, ОбщиеРеквизитыРазделов, СтрПоля);
					
				КонецЦикла;
				
			ИначеЕсли ОбщиеРеквизитыРазделов.ВыводитьНаПечатьРаздел2 Тогда
			...
			ИначеЕсли ОбщиеРеквизитыРазделов.ВыводитьНаПечатьРаздел22 Тогда
			...
			ОбщиеРеквизитыРазделов.Вставить("ВыведенНаПечатьРаздел2_Раздел22", Истина);
			
		КонецЕсли;
		
	ИначеЕсли ИмяТекРаздела = "Раздел3" ИЛИ ИмяТекРаздела = "Раздел31" Тогда
		
		Если НЕ ОбщиеРеквизитыРазделов.ВыведенНаПечатьРаздел3_Раздел31 Тогда
			
			Если ОбщиеРеквизитыРазделов.ВыводитьНаПечатьРаздел3
				И ОбщиеРеквизитыРазделов.ВыводитьНаПечатьРаздел31 Тогда
				
				ДеревоДанныхРаздела31 = ПолучитьИзВременногоХранилища(
					СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел31"]);
				
				Для каждого Ветка Из ДеревоДанныхРаздела31.Строки Цикл
					...
					ТабличныйДокумент.Вывести(МакетРаздела);
					МакетРаздела = ОбъектОтчета(ИмяФормы).ПолучитьМакет(Сред(
						ИмяФормы, СтрНайти(ИмяФормы, "ФормаОтчета")) + "_Раздел31");
					ТабличныйДокумент.Вывести(МакетРаздела);
					
					Если ДеревоДанныхРаздела31.Строки.Индекс(Ветка) = 0 Тогда
						
						ДеревоДанныхРаздела3 = ПолучитьИзВременногоХранилища(
							СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел3"]);
						
						Ветка3 = ДеревоДанныхРаздела3.Строки[0];
					...
					СтруктураПараметровРаздела.Вставить("НаименованиеЛиста", "Раздел 3");
					ВывестиНаПечатьЛист(СтруктураПараметровРаздела, ОбщиеРеквизитыРазделов, СтрПоля);
					
				КонецЦикла;
				
			ИначеЕсли ОбщиеРеквизитыРазделов.ВыводитьНаПечатьРаздел3 Тогда
			...
			ИначеЕсли ОбщиеРеквизитыРазделов.ВыводитьНаПечатьРаздел31 Тогда
			...
			ОбщиеРеквизитыРазделов.Вставить("ВыведенНаПечатьРаздел3_Раздел31", Истина);
...
Процедура Проверить(Команда)
	...
	|от 29.01.2026 № ЕД-1-3/57@, будет реализована
...
Процедура АктивизироватьЯчейку(Ячейка) Экспорт
	...
	Если Ячейка.Раздел = "Раздел1" ИЛИ Ячейка.Раздел = "Раздел2"
		ИЛИ Ячейка.Раздел = "Раздел3" ИЛИ Ячейка.Раздел = "Раздел4" Тогда
