...
Процедура ПолеТабличногоДокументаФормаОтчетаПриАктивизации(Элемент)
	...
	#Если ВебКлиент Тогда
		Если ПолеТабличногоДокументаФормаОтчета.ТекущаяОбласть.Имя = "Calc1" Тогда
			ОткрытьФормуДетализацииЧисленность(Элемент, СредняяЧисленность[0]);
			Возврат;
		ИначеЕсли ПолеТабличногоДокументаФормаОтчета.ТекущаяОбласть.Имя = "Calc2" Тогда
			ОткрытьФормуДетализацииЧисленность(Элемент, СредняяЧисленность[1]);
			Возврат;
		ИначеЕсли ПолеТабличногоДокументаФормаОтчета.ТекущаяОбласть.Имя = "Calc3" Тогда
			ОткрытьФормуДетализацииЧисленность(Элемент, СредняяЧисленность[2]);
			Возврат;
		КонецЕсли;
	#КонецЕсли
