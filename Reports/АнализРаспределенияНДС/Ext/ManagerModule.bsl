...
//		* ПоказыватьЗаголовок - Булево - признак видимости строк с заголовком отчета.
//		* ВысотаЗаголовка - Число - параметр, через который возвращается высота заголовка в строках.
//		* ДокументОбъект - ДокументОбъект - если указан, то печать отчета по документу.
//
