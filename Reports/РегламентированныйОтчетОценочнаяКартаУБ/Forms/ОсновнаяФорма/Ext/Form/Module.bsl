...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтаФормаИмя = Строка(ЭтотОбъект.ИмяФормы);
...
Процедура ОткрытьФормуОтчета(Команда)
	...
	ОткрытьФорму(СтрЗаменить(ЭтотОбъект.ИмяФормы, "ОсновнаяФорма", "") + мВыбраннаяФорма, ПараметрыФормы, , Истина);
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если Параметр = "Активизировать" Тогда
		...
		Если ИмяСобытия = ЭтотОбъект.Заголовок Тогда
