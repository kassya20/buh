...
Процедура ОчиститьТабличноеПолеНаСервере()
	...
	СписокПоказателей.Добавить(ВыбТабПоле.Области["НаименованиеТовара"].Значение,      "НаименованиеТовара");
	СписокПоказателей.Добавить(ВыбТабПоле.Области["КодОКП"].Значение,                  "КодОКП");
	СписокПоказателей.Добавить(ВыбТабПоле.Области["КодЕКПС"].Значение,                 "КодЕКПС");
	СписокПоказателей.Добавить(ВыбТабПоле.Области["ФНН"].Значение,                     "ФНН");
	СписокПоказателей.Добавить(ВыбТабПоле.Области["КалькуляционнаяЕдиница"].Значение,  "КалькуляционнаяЕдиница");
	СписокПоказателей.Добавить(ВыбТабПоле.Области["ТехническаяДокументация"].Значение, "ТехническаяДокументация");
	СписокПоказателей.Добавить(ВыбТабПоле.Области["Должность1"].Значение,              "Должность1");
...
Функция ПечатьНаСервере(ВидПечати)
	...
	СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 3д");
