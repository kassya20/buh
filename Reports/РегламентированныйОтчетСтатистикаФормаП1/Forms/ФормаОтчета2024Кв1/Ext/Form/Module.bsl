...
Процедура СформироватьСпискиВыбора()
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "s_okpd2_ei_50_2026", 512, , "Выбор кода");
...
Процедура Инициализация(БезОткрытияФормы = Ложь) Экспорт
	...
	Если Не ДоступноРаспределениеВыручкиПоОКВЭД Тогда
		ПолеТабличногоДокументаФормаОтчета.Области.РаспределитьВыручкуПоОКВЭД.Текст = "";
		ПолеТабличногоДокументаФормаОтчета.Области.РаспределитьВыручкуПоОКВЭД.Гиперссылка = Ложь;
	КонецЕсли;
	...
	ИначеЕсли Не СтруктураРеквизитовФормы.мАвтоВыборКодов Тогда
		...
		ИначеЕсли СтрНайти(Область.Имя, "П000500103_") = 1 Тогда
			...
			Если НомСтр = "50" Тогда
				ИмяСправочника = "s_okpd2_ei_50_2026";
