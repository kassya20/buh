...
Процедура ПроверкаКС_1_19_1()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='КБК в стр.030 подр.1.3 Раздела 1 = '") + ДанныеКС.КБК.Дивиденды_ОтРосКРос + 
...
Процедура ПроверкаКС_1_20_1()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='КБК в стр.030 подр.1.3 Раздела 1 = '") + ДанныеКС.КБК.Проценты_ГосБумаги + 
...
Процедура ПроверкаКС_1_22_1()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='КБК в стр.030 подр.1.3 Раздела 1 = '") + ДанныеКС.КБК.Дивиденды_ОтИнКРос + 
...
Процедура ПроверкаКС_1_24_1()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='КБК в стр.030 подр.1.3 Раздела 1 = '") + ДанныеКС.КБК.Проценты_Облигации + 
