...
Процедура ТабличныйДокументПриАктивизации(Элемент)
	...
	Если ТабличныйДокумент.ТекущаяОбласть.Имя = "ВходитВГруппуОП" И ТабличныйДокумент.ТекущаяОбласть.Гиперссылка Тогда
		
		Если ТабличныйДокумент.ТекущаяОбласть.Значение = "" Тогда
			ТабличныйДокумент.ТекущаяОбласть.Значение = "V";
			ЭтаФорма.ВГруппуОПВходитОрганизация = Истина;
		Иначе
			ТабличныйДокумент.ТекущаяОбласть.Значение = "";
	...
	Если СтрЧислоВхождений(ТабличныйДокумент.ТекущаяОбласть.Имя, "П0001300040") > 0
	 ИЛИ СтрЧислоВхождений(ТабличныйДокумент.ТекущаяОбласть.Имя, "П0021300010") > 0
	 ИЛИ СтрЧислоВхождений(ТабличныйДокумент.ТекущаяОбласть.Имя, "П0021200010") > 0 Тогда
