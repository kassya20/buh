...
Процедура СформироватьОтчет(ПараметрыОтчета, АдресХранилища) Экспорт
	...
	СведенияОрганизации = БухгалтерскийУчетПереопределяемый.СведенияОЮрФизЛице(
		ПараметрыОтчета.Организация, КонецПериодаОтчета, , , , Истина);
...
#КонецОбласти
	...
	Иначе
		...
		Свидетельство = БухгалтерскийУчетПереопределяемый.СвидетельствоОРегистрации(
			СведенияОЮрФизЛице,
			СтруктураПараметров.НалоговыйПериод);
	КонецЕсли;
...
Функция ПолучитьЗаписиЖурналаСчетовФактур(СтруктураПараметров) Экспорт
	...
	|	ЗаписиРегистраЖурналУчетаСчетовФактур.ДатаСведений КАК ДатаСведений
