...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбработкаНовостейПереопределяемый.КонтекстныеНовости_ПриСозданииНаСервере(
		ЭтотОбъект,
		"БП.Отчет.ПоступленияДенежныхСредств",
		"ФормаОтчета",
		НСтр("ru='Новости: Поступления денежных средств'"),
		"ПриОткрытии");
...
Функция ПолучитьБаннерНаСервере(ПоказатьПредыдущий)
	...
	СтруктураПараметров.Вставить("Размещение", ПерсонализированныеПредложенияСервисов.ИмяРазмещенияПоступленияДенежныхСредств());
