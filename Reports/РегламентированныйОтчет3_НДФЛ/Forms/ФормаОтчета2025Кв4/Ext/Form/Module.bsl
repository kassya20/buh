...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Параметры.мСохраненныйДок) И СтруктураРеквизитовФормы.мСкопированаФорма = Неопределено Тогда
		ДанныеОтчета = Параметры.мСохраненныйДок.ДанныеОтчета.Получить();
		ДанныеПомощника = ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(ДанныеОтчета, "ДанныеПомощникаЗаполнения");
		ОтчетСозданИзПомощника = ЗначениеЗаполнено(ДанныеПомощника)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ИнтернетПоддержкаПользователей.Новости") Тогда
		...
		МодульОбработкаНовостей.КонтекстныеНовости_ПриСозданииНаСервере(
			...
			ИмяФормы(ИмяФормы),
			,
			НСтр("ru='Новости: 3-НДФЛ (с 2025 года)'"),
			Ложь,
...
Процедура СформироватьСпискиВыбора()
	...
	Для Каждого Область Из МакетСоставаПоказателей.Области Цикл
		Если Область.ТипОбласти = ТипОбластиЯчеекТабличногоДокумента.Строки Тогда
			...
			ТаблСписка.Колонки.Добавить("Фильтр",,,
			...
			Для НомСтр = ВерхОбласти По НизОбласти Цикл
				...
				Если КодПоказателя <> "###" Тогда
					...
					НовСтрока.Фильтр = СокрП(МакетСоставаПоказателей.Область(НомСтр, 3).Текст);
				КонецЕсли;
			КонецЦикла;
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "КодКатегорииНалогоплательщика", 3, ,
	"Выбор кода категории налогоплательщика", КоллекцияСписковВыбора["КодыКатегории"]);
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "КодСтатусаНалогоплательщика", 1, ,
	"Выбор кода статуса налогоплательщика", КоллекцияСписковВыбора["СтатусыНалогоплательщика"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ПрПодп", 1, ,
	"Выбор признака подписанта", КоллекцияСписковВыбора["ПризнакиПодписанта"]);
	
	// Раздел 1.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П00001М102003", 20, ,
	"Выбор КБК", КоллекцияСписковВыбора["КБК"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П00001М206003", 20, ,
	"Выбор КБК", КоллекцияСписковВыбора["КБК"]);
	
	// Раздел 2.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000020000103", 2, ,
	"Выбор кода группы доходов", КоллекцияСписковВыбора["КодыГруппДоходов"]);
	
	// Приложение 1.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000П1М101003", 3, ,
	"Выбор кода вида дохода", КоллекцияСписковВыбора["КодыВидаДохода"]);
	
	// Приложение 2.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000П20003103", 3, ,
	"Выбор кода вида дохода", КоллекцияСписковВыбора["КодыВидаДохода"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000П20009003", 1, ,
	"Выбор кода вида освобождения", КоллекцияСписковВыбора["КодыВидаОсвобОтНал"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000П20010003", 1, ,
	"Выбор применяемого порядка", КоллекцияСписковВыбора["ПорядокОпределенияПрибУбКИК"]);
	
	// Приложение 3.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000П3М101003", 2, ,
	"Выбор кода вида деятельности", КоллекцияСписковВыбора["КодыВидовДеятельности"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000П3М211003", 1, ,
	"Выбор кода источника дохода", КоллекцияСписковВыбора["КодыИсточникаДохода"]);
	
	// Приложение 7.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000П7М101003", 1, ,
	"Выбор кода наименования объекта", КоллекцияСписковВыбора["КодыНаименованияОбъекта"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000П7М102003", 2, ,
	"Выбор кода признака налогоплательщика", КоллекцияСписковВыбора["КодыПризнакаНалогоплательщика"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000П7М103003", 1, ,
	"Выбор способа приобретения жилого дома", КоллекцияСписковВыбора["СпособыПриобретенияЖилогоДома"]);
	
	// Приложение 8.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000П80001003", 2, ,
	"Выбор кода вида операции", КоллекцияСписковВыбора["КодыВидаОперации"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000П80005003", 1, ,
	"Выбор признака учета убытков", КоллекцияСписковВыбора["ПризнакиУчетаУбытков"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000П8М105103", 2, ,
	"Выбор кода вида операции", КоллекцияСписковВыбора["КодыВидаОперацииУбыт"]);
	
	// Расчет к Приложению 1.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П00П1РМ101003", 1, ,
	"Выбор вида получения дохода", КоллекцияСписковВыбора["ВидыПолученияДохода"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П00П1РМ207003", 1, ,
	"Выбор вида получения дохода", КоллекцияСписковВыбора["ВидыПолученияДохода"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П00П1РМ208003", 2, ,
	"Выбор кода вида транспортного средства", КоллекцияСписковВыбора["КодыВидаТранспортногоСредства"]);
	
	// Расчет к Приложению 5.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П00П5РМ102103", 1, ,
	"Выбор кода вида договора", КоллекцияСписковВыбора["КодыВидаДоговора"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П00П5РМ106103", 1, ,
	"Выбор признака предоставления вычета", КоллекцияСписковВыбора["ПризнакиПредоставленияВычета_1"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П00П5РМ208003", 1, ,
	"Выбор признака основания заявления налогового вычета", КоллекцияСписковВыбора["ПризнакиОснЗаявленияНалВычета"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П00П5РМ216003", 1, ,
	"Выбор признака предоставления вычета", КоллекцияСписковВыбора["ПризнакиПредоставленияВычета_2"]);
...
Процедура ПослеСохраненияНаКлиенте(ВыполняемоеОповещение, РезультатСохранения)
	...
	Если ОтчетСозданИзПомощника Тогда
		// Скрываем плашку про отчет из помощника при сохранении в случае, если отчет был модифицирован.
...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли Область.Имя = "СобратьДанные" Тогда
		ТекстПредупреждения = СтрШаблон(НСтр(
			"ru='Заполнение Раздела %1 по данным декларации
			|в форме, утвержденной приказом ФНС России
			|от 20.10.2025 № ЕД-7-11/913@, будет реализовано
			|в будущих версиях программы'"), Прав(СтруктураРеквизитовФормы.НаимТекущегоРаздела, 1));
	...
	ИначеЕсли СтрРазделить("КодСтраны,П000П20001003,П000П20001103", ",", Ложь).Найти(Область.Имя) <> Неопределено Тогда
	...
	ИначеЕсли Область.Имя = "П000П20003003" Тогда
	...
	ИначеЕсли Область.Имя = "П000П30008003" Тогда
	...
	Иначе
		...
		Если ПараметрВводаПоля <> Неопределено И ПараметрВводаПоля.ТаблицаЗначений.Количество() > 0 Тогда
			...
			Если СтрНачинаетсяС(Область.Имя, "П00001М206003") Тогда
				
				РазмерТЗ = ТЗВыбора.Количество();
				Для Сч = 1 По РазмерТЗ Цикл
					ЭлементТЗ = ТЗВыбора[РазмерТЗ - Сч];
					Если ЗначениеЗаполнено(ЭлементТЗ.Фильтр) И СокрЛП(ЭлементТЗ.Фильтр) <> "НДФЛ_ИП" Тогда
...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если ТипЗнч(ЗначПоказателя) = Тип("Число") И ЗначПоказателя < 0 Тогда
		...
		ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр(
			"ru='Не допускается заполнение декларации отрицательными числовыми значениями. Значение очищено'"));
	...
	Если СтрНачинаетсяС(ИмяПоказателя, "П00001М103003") ИЛИ СтрНачинаетсяС(ИмяПоказателя, "П00001М207003")
		ИЛИ СтрНачинаетсяС(ИмяПоказателя, "П00001М209003") ИЛИ СтрНачинаетсяС(ИмяПоказателя, "П00001М212003")
		ИЛИ СтрНачинаетсяС(ИмяПоказателя, "П00001М215003") ИЛИ СтрНачинаетсяС(ИмяПоказателя, "П000П1М105003") Тогда
	...
	Если СтрНачинаетсяС(ИмяПоказателя, "П00001М102003") ИЛИ СтрНачинаетсяС(ИмяПоказателя, "П00001М206003") Тогда
	...
	Если СтрНачинаетсяС(ИмяПоказателя, "П000П1М103003") Тогда
		...
		Иначе
			Область.Значение = "";
			ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр("ru='ИНН должен состоять из 10 или 12 цифр. Значение очищено'"));
		КонецЕсли;
	КонецЕсли;
	
	Если СтрНачинаетсяС(ИмяПоказателя, "П00П5РМ101003") ИЛИ СтрНачинаетсяС(ИмяПоказателя, "П00П5РМ209003") Тогда
	...
	Если ИмяПоказателя = "ИНН" Тогда
		...
		Иначе
			Область.Значение = "";
			ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр(
				"ru='ИНН налогоплательщика должен состоять из 12 цифр. Значение очищено'"));
		КонецЕсли;
	КонецЕсли;
	
	Если ИмяПоказателя = "ИдЕРН" Тогда
		ИдЕРН = СтрЗаменить(ЗначПоказателя, " ", "");
		ДлинаИдЕРН = СтрДлина(ИдЕРН);
		Если ДлинаИдЕРН = 12 ИЛИ ДлинаИдЕРН = 0 Тогда
			Область.Значение = ИдЕРН;
		Иначе
			Область.Значение = "";
			ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр(
	...
	Если СтрНачинаетсяС(ИмяПоказателя, "П000П1М104003") ИЛИ СтрНачинаетсяС(ИмяПоказателя, "П00П5РМ102003")
		ИЛИ СтрНачинаетсяС(ИмяПоказателя, "П00П5РМ210003") Тогда
	...
	Если СтрНачинаетсяС(ИмяПоказателя, "П000П7М108003") Тогда
		Индекс = "";
		ИндексСтр = "";
		Сум = 0;
		РегламентированнаяОтчетностьКлиентСервер.УстановитьИндекс(Индекс, ИндексСтр);
		ОбрабОбл = ТДО.Найти("П000П7М108003_" + ИндексСтр);
		Пока ОбрабОбл <> Неопределено Цикл
			Сум = Сум + Окр(ОбрабОбл.Значение, 2);
			РегламентированнаяОтчетностьКлиентСервер.УвеличитьИндекс(Индекс, ИндексСтр);
			ОбрабОбл = ТДО.Найти("П000П7М108003_" + ИндексСтр);
		КонецЦикла;
		Если Сум > 2000000 Тогда
			Область.Значение = 0;
			ОбщегоНазначенияКлиент.СообщитьПользователю(СтрШаблон(НСтр("ru='%1 превышать 2 000 000. Значение очищено'"),
				?(Индекс > 2, "Сумма значений в строках 080 не должна", "Значение в строке 080 не должно")));
		КонецЕсли;
	КонецЕсли;
	
	Если СтрНачинаетсяС(ИмяПоказателя, "П000П7М109003") Тогда
		Индекс = "";
		ИндексСтр = "";
		Сум = 0;
		РегламентированнаяОтчетностьКлиентСервер.УстановитьИндекс(Индекс, ИндексСтр);
		ОбрабОбл = ТДО.Найти("П000П7М109003_" + ИндексСтр);
		Пока ОбрабОбл <> Неопределено Цикл
			Сум = Сум + Окр(ОбрабОбл.Значение, 2);
			РегламентированнаяОтчетностьКлиентСервер.УвеличитьИндекс(Индекс, ИндексСтр);
			ОбрабОбл = ТДО.Найти("П000П7М109003_" + ИндексСтр);
		КонецЦикла;
		Если Сум > 3000000 Тогда
			Область.Значение = 0;
			ОбщегоНазначенияКлиент.СообщитьПользователю(СтрШаблон(НСтр("ru='%1 превышать 3 000 000. Значение очищено'"),
				?(Индекс > 2, "Сумма значений в строках 090 не должна", "Значение в строке 090 не должно")));
		КонецЕсли;
	КонецЕсли;
	...
	Если СтруктураЗависимыхЯчеекДляАвторасчета.Свойство(ИмяРаздела)
		...
		ИЛИ ИмяРаздела = "Приложение5Расчет" Тогда
...
Процедура УстановитьДоступностьОбластей(Форма, ИмяРаздела)
	...
	ИначеЕсли ИмяРаздела = "Приложение1" Тогда
		...
		РегламентированнаяОтчетностьКлиентСервер.УстановитьИндекс(Индекс, ИндексСтр);
		ОбрабОбл = ТДО.Найти("П000П1М102003_" + ИндексСтр);
		Пока ОбрабОбл <> Неопределено Цикл
			ОблВидДохода = ТДО.Найти("П000П1М101003_" + ИндексСтр);
			Если ОблВидДохода <> Неопределено Тогда
				ВидДохода = СокрЛП(ОблВидДохода.Значение);
				ОбрабОбл.Формат = ?(ВидДохода = "025" ИЛИ ВидДохода = "046", "ЧН=0", "");
			КонецЕсли;
			РегламентированнаяОтчетностьКлиентСервер.УвеличитьИндекс(Индекс, ИндексСтр);
			ОбрабОбл = ТДО.Найти("П000П1М102003_" + ИндексСтр);
		КонецЦикла;
	...
	ИначеЕсли ИмяРаздела = "Приложение2" Тогда
		...
		ОблВидДохода = ТДО.Найти("П000П20003103");
		ОбрабОбл = ТДО.Найти("П000П20004103");
		Если ОблВидДохода <> Неопределено И ОбрабОбл <> Неопределено Тогда
			ВидДохода = СокрЛП(ОблВидДохода.Значение);
			ОбрабОбл.Формат = ?(ВидДохода = "025" ИЛИ ВидДохода = "046", "ЧН=0", "");
		КонецЕсли;
		
	ИначеЕсли ИмяРаздела = "Приложение3" ИЛИ ИмяРаздела = "Приложение3Продолжение" ИЛИ ИмяРаздела = "Приложение4"
		ИЛИ ИмяРаздела = "Приложение5" ИЛИ ИмяРаздела = "Приложение6" ИЛИ ИмяРаздела = "Приложение7"
		ИЛИ ИмяРаздела = "Приложение8" ИЛИ ИмяРаздела = "Приложение1Расчет" Тогда
...
Процедура ДобавитьСтроку(Команда)
	...
	Если СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Приложение8" Тогда
		
		ИмяПервойГрафы = СтруктураРеквизитовФормы.СтруктураМногострочныхЧастей[
		СтруктураРеквизитовФормы.мИдГруппыП8М1]["ИменаГраф"][0];
		Если ТабличныйДокумент.Области.Найти(ИмяПервойГрафы + "_3") <> Неопределено Тогда
			ТекстПредупреждения = НСтр("ru = 'Возможно не более 3 групп строк 051-052 в приложении 8'");
		КонецЕсли;
...
Процедура Расчет(Форма, ИмяРаздела = "", ОбластьИмя = "") Экспорт
	...
	Если ИмяРаздела = "Приложение2" ИЛИ ИмяРаздела = "Приложение3" ИЛИ ИмяРаздела = "Приложение3Продолжение"
		ИЛИ ИмяРаздела = "Приложение4" ИЛИ ИмяРаздела = "Приложение5" ИЛИ ИмяРаздела = "Приложение6"
		ИЛИ ИмяРаздела = "Приложение7" ИЛИ ИмяРаздела = "Приложение8" ИЛИ ИмяРаздела = "Приложение1Расчет" Тогда
...
Процедура РасчетВДеревеЗначений(Форма, ИмяРаздела)
	...
	ИначеЕсли ИмяРаздела = "Приложение3" Тогда
		...
		ИмяГруппыП3М1 = Форма.СтруктураРеквизитовФормы.мИдГруппыП3М1;
		СтруктураГруппыП3М1 = Форма.СтруктураРеквизитовФормы.СтруктураМногострочныхЧастей[ИмяГруппыП3М1];
		ИменаГрафП3М1 = СтруктураГруппыП3М1["ИменаГраф"];
		
		ИмяГруппыП3М2 = Форма.СтруктураРеквизитовФормы.мИдГруппыП3М2;
		СтруктураГруппыП3М2 = Форма.СтруктураРеквизитовФормы.СтруктураМногострочныхЧастей[ИмяГруппыП3М2];
		...
		Если Ветка = АктивнаяВетка Тогда
			...
			Для каждого СтрокаМнЧ Из ДеревоМнЧП3М1.Строки Цикл
				...
				Для каждого ИмяГрафы Из ИменаГрафП3М1 Цикл
			...
			Для каждого СтрокаМнЧ Из ДеревоМнЧП3М2.Строки Цикл
				ИндСтроки = Формат(ДеревоМнЧП3М2.Строки.Индекс(СтрокаМнЧ) + 1, "ЧГ=");
				Для каждого ИмяГрафы Из ИменаГрафП3М2 Цикл
					СтрокаМнЧ.Данные.Вставить(ИмяГрафы, Форма.ТабличныйДокумент.Области[ИмяГрафы + "_" + ИндСтроки].Значение);
				КонецЦикла;
			КонецЦикла;
		КонецЕсли;
	...
	ИначеЕсли ИмяРаздела = "Приложение5" Тогда
		...
		ДеревоДанныхП5Р = ПолучитьИзВременногоХранилища(
		Форма.СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхПриложение5Расчет"]);
		
		АктивнаяВеткаП5Р = Неопределено;
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Приложение5Расчет" Тогда
			АктивнаяВеткаП5Р = ДеревоДанныхП5Р.Строки[
				Форма.СтруктураРеквизитовФормы.НомераСтрокМногоуровнегоРаздела[0] - 1];
		КонецЕсли;
		
		ИмяГруппыП5РМ1 = Форма.СтруктураРеквизитовФормы.мИдГруппыП5РМ1;
		СтруктураГруппыП5РМ1 = Форма.СтруктураРеквизитовФормы.СтруктураМногострочныхЧастей[ИмяГруппыП5РМ1];
		...
		Если ВеткаП5Р = АктивнаяВеткаП5Р Тогда
			Для каждого Пок Из ВеткаП5Р.Данные Цикл
				ВеткаП5Р.Данные.Вставить(Пок.Ключ, Форма.ТабличныйДокумент.Области[Пок.Ключ].Значение);
			КонецЦикла;
			Для каждого СтрокаМнЧ Из ДеревоМнЧП5РМ1.Строки Цикл
				ИндСтроки = Формат(ДеревоМнЧП5РМ1.Строки.Индекс(СтрокаМнЧ) + 1, "ЧГ=");
				Для каждого ИмяГрафы Из ИменаГрафП5РМ1 Цикл
					СтрокаМнЧ.Данные.Вставить(ИмяГрафы, Форма.ТабличныйДокумент.Области[ИмяГрафы + "_" + ИндСтроки].Значение);
				КонецЦикла;
			КонецЦикла;
		КонецЕсли;
	...
	ИначеЕсли ИмяРаздела = "Приложение7" Тогда
		...
		ИмяГруппыП7М1 = Форма.СтруктураРеквизитовФормы.мИдГруппыП7М1;
		СтруктураГруппыП7М1 = Форма.СтруктураРеквизитовФормы.СтруктураМногострочныхЧастей[ИмяГруппыП7М1];
		...
		Если Ветка = АктивнаяВетка Тогда
			...
			Для каждого СтрокаМнЧ Из ДеревоМнЧП7М1.Строки Цикл
				ИндСтроки = Формат(ДеревоМнЧП7М1.Строки.Индекс(СтрокаМнЧ) + 1, "ЧГ=");
		...
		Если ЗаполненыСведенияОбОбъектеИРасходах Тогда
			...
			ДеревоДанныхДрРазд = ПолучитьИзВременногоХранилища(
			Форма.СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхРаздел2"]);
			
			АктивнаяВеткаДрРазд = Неопределено;
			Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел2" Тогда
				АктивнаяВеткаДрРазд = ДеревоДанныхДрРазд.Строки[
					Форма.СтруктураРеквизитовФормы.НомераСтрокМногоуровнегоРаздела[0] - 1];
			КонецЕсли;
			
			Для каждого ВеткаДрРазд Из ДеревоДанныхДрРазд.Строки Цикл
				Если ВеткаДрРазд = АктивнаяВеткаДрРазд Тогда
					Для каждого Пок Из ВеткаДрРазд.Данные Цикл
						ВеткаДрРазд.Данные.Вставить(Пок.Ключ, Форма.ТабличныйДокумент.Области[Пок.Ключ].Значение);
					КонецЦикла;
				КонецЕсли;
			...
			ДеревоДанныхДрРазд = ПолучитьИзВременногоХранилища(
			Форма.СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхПриложение1"]);
			...
			ИмяГруппыДрРазд = Форма.СтруктураРеквизитовФормы.мИдГруппыП1М1;
			СтруктураГруппыДрРазд = Форма.СтруктураРеквизитовФормы.СтруктураМногострочныхЧастей[ИмяГруппыДрРазд];
			...
			Если ВеткаДрРазд = АктивнаяВеткаДрРазд Тогда
				Для каждого СтрокаМнЧДрРазд Из ДеревоМнЧДрРазд.Строки Цикл
					ИндСтроки = Формат(ДеревоМнЧДрРазд.Строки.Индекс(СтрокаМнЧДрРазд) + 1, "ЧГ=");
					Для каждого ИмяГрафы Из ИменаГрафДрРазд Цикл
						СтрокаМнЧДрРазд.Данные.Вставить(ИмяГрафы, Форма.ТабличныйДокумент.Области[ИмяГрафы + "_" + ИндСтроки].Значение);
					КонецЦикла;
				КонецЦикла;
			КонецЕсли;
			...
			ДеревоДанныхДрРазд = ПолучитьИзВременногоХранилища(
			Форма.СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхПриложение2"]);
			...
			ДеревоДанныхДрРазд = ПолучитьИзВременногоХранилища(
			Форма.СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхПриложение3"]);
			
			АктивнаяВеткаДрРазд = Неопределено;
			Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Приложение3" Тогда
				АктивнаяВеткаДрРазд = ДеревоДанныхДрРазд.Строки[
					Форма.СтруктураРеквизитовФормы.НомераСтрокМногоуровнегоРаздела[0] - 1];
			КонецЕсли;
			
			ИмяГруппыДрРазд = Форма.СтруктураРеквизитовФормы.мИдГруппыП3М2;
			СтруктураГруппыДрРазд = Форма.СтруктураРеквизитовФормы.СтруктураМногострочныхЧастей[ИмяГруппыДрРазд];
			ИменаГрафДрРазд = СтруктураГруппыДрРазд["ИменаГраф"];
			...
			ДеревоДанныхДрРазд = ПолучитьИзВременногоХранилища(
			Форма.СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхПриложение4"]);
			
			АктивнаяВеткаДрРазд = Неопределено;
			Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Приложение4" Тогда
				АктивнаяВеткаДрРазд = ДеревоДанныхДрРазд.Строки[
					Форма.СтруктураРеквизитовФормы.НомераСтрокМногоуровнегоРаздела[0] - 1];
			КонецЕсли;
			...
			ДеревоДанныхДрРазд = ПолучитьИзВременногоХранилища(
			Форма.СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхПриложение5"]);
			
			АктивнаяВеткаДрРазд = Неопределено;
			Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Приложение5" Тогда
				АктивнаяВеткаДрРазд = ДеревоДанныхДрРазд.Строки[
					Форма.СтруктураРеквизитовФормы.НомераСтрокМногоуровнегоРаздела[0] - 1];
			КонецЕсли;
			...
			ДеревоДанныхДрРазд = ПолучитьИзВременногоХранилища(
			Форма.СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхПриложение6"]);
			
			АктивнаяВеткаДрРазд = Неопределено;
			Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Приложение6" Тогда
				АктивнаяВеткаДрРазд = ДеревоДанныхДрРазд.Строки[
					Форма.СтруктураРеквизитовФормы.НомераСтрокМногоуровнегоРаздела[0] - 1];
			КонецЕсли;
			...
			ДеревоДанныхДрРазд = ПолучитьИзВременногоХранилища(
			Форма.СтруктураРеквизитовФормы["АдресВоВрХранилищеДеревоДанныхПриложение8"]);
			
			АктивнаяВеткаДрРазд = Неопределено;
			Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Приложение8" Тогда
				АктивнаяВеткаДрРазд = ДеревоДанныхДрРазд.Строки[
					Форма.СтруктураРеквизитовФормы.НомераСтрокМногоуровнегоРаздела[0] - 1];
			КонецЕсли;
	...
	ИначеЕсли ИмяРаздела = "Приложение8" Тогда
	...
	ИначеЕсли ИмяРаздела = "Приложение1Расчет" Тогда
		...
		ИмяГруппыП1РМ1 = Форма.СтруктураРеквизитовФормы.мИдГруппыП1РМ1;
		СтруктураГруппыП1РМ1 = Форма.СтруктураРеквизитовФормы.СтруктураМногострочныхЧастей[ИмяГруппыП1РМ1];
		...
		Если Ветка = АктивнаяВетка Тогда
			Для каждого СтрокаМнЧ Из ДеревоМнЧП1РМ1.Строки Цикл
				ИндСтроки = Формат(ДеревоМнЧП1РМ1.Строки.Индекс(СтрокаМнЧ) + 1, "ЧГ=");
				Для каждого ИмяГрафы Из ИменаГрафП1РМ1 Цикл
					СтрокаМнЧ.Данные.Вставить(ИмяГрафы, Форма.ТабличныйДокумент.Области[ИмяГрафы + "_" + ИндСтроки].Значение);
				КонецЦикла;
			КонецЦикла;
		КонецЕсли;
...
Процедура ЗаполнитьСтруктуруЗависимыхЯчеекДляАвторасчета()
	...
	Структ.Вставить("П00П1РМ105003");
	Структ.Вставить("П00П1РМ106003");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("Приложение1Расчет", Структ);
	
	Структ = Новый Структура;
	Структ.Вставить("П000П80009003");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("Приложение8", Структ);
	
	Структ = Новый Структура;
	Структ.Вставить("П000П60016003");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("Приложение6", Структ);
	
	Структ = Новый Структура;
	Структ.Вставить("П000П50007103");
	Структ.Вставить("П000П50008003");
	Структ.Вставить("П000П50012003");
	Структ.Вставить("П000П50016003");
	Структ.Вставить("П000П50016103");
	Структ.Вставить("П000П50018003");
	Структ.Вставить("П000П50019003");
	Структ.Вставить("П000П50020003");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("Приложение5", Структ);
	
	Структ = Новый Структура;
	Структ.Вставить("П000П40012003");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("Приложение4", Структ);
	
	Структ = Новый Структура;
	Структ.Вставить("П000П30019003");
	Структ.Вставить("П000П30019103");
	Структ.Вставить("П000П30019203");
	Структ.Вставить("П000П30020003");
	Структ.Вставить("П000П30020103");
	Структ.Вставить("П000П30020203");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("Приложение3Продолжение", Структ);
	
	Структ = Новый Структура;
	Структ.Вставить("П000П3М104003");
	Структ.Вставить("П000П30005003");
	Структ.Вставить("П000П30006003");
	Структ.Вставить("П000П3М215003");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("Приложение3", Структ);
	
	Структ = Новый Структура;
	Структ.Вставить("П000П20007003");
	Структ.Вставить("П000П20014003");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("Приложение2", Структ);
	
	Структ = Новый Структура;
	Структ.Вставить("П000П70014003");
	Структ.Вставить("П000П70017003");
	Структ.Вставить("П000П70018003");
...
Процедура АктивизироватьЯчейку(Ячейка) Экспорт
	...
	Если Ячейка.Раздел = "Раздел1" ИЛИ Ячейка.Раздел = "Раздел1Приложение" ИЛИ Ячейка.Раздел = "Приложение1"
		ИЛИ Ячейка.Раздел = "Приложение3" ИЛИ Ячейка.Раздел = "Приложение3Продолжение" ИЛИ Ячейка.Раздел = "Приложение4"
		ИЛИ Ячейка.Раздел = "Приложение5" ИЛИ Ячейка.Раздел = "Приложение6" ИЛИ Ячейка.Раздел = "Приложение7"
		ИЛИ Ячейка.Раздел = "Приложение7Продолжение" ИЛИ Ячейка.Раздел = "Приложение1Расчет"
		ИЛИ Ячейка.Раздел = "Приложение5Расчет" Тогда
		Для каждого НайденныйРаздел Из РазделыОтчета.ПолучитьЭлементы() Цикл
			...
			КонецЕсли;
		КонецЦикла;
	ИначеЕсли Ячейка.Раздел = "Раздел2" ИЛИ Ячейка.Раздел = "Приложение2" ИЛИ Ячейка.Раздел = "Приложение8" Тогда
		Для каждого НайденныйРаздел Из РазделыОтчета.ПолучитьЭлементы() Цикл
			Если НайденныйРаздел.КолонкаРазделыОтчетаСокрНаим = Ячейка.Раздел Тогда
