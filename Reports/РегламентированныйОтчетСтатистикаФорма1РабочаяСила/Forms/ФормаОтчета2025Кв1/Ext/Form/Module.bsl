...
Процедура ФормироватьСтруктуруСтраницОтчета() Экспорт
	...
	СтрокаУровня1.Представление            = "Статистика: Форма 1 (рабочая сила)";
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Области.П001001000304.Значение
		= Области.П001001000404.Значение
		+ Области.П001001000504.Значение
		+ Области.П001001000604.Значение;
		
	Области.П001001000704.Значение
		= Области.П001001000204.Значение
		+ Области.П001001000304.Значение;
	
	Области.П002001000803.Значение
		= Области.П002001000903.Значение
		+ Области.П002001001003.Значение
		+ Области.П002001001103.Значение
		+ Области.П002001001203.Значение
		+ Области.П002001001303.Значение;
	
	Области.П002001002203.Значение
		= Области.П002001002303.Значение
		+ Области.П002001002403.Значение
		+ Области.П002001002503.Значение;
	
	Сумм = 0;
	Для Стр = 27 По 34 Цикл
		Сумм = Сумм + Области["П00200100" + Стр + "03"].Значение;
	КонецЦикла;
	Области.П002001002603.Значение = Сумм;
	
	Области.П002001003803.Значение
		= Области.П002001003903.Значение
		+ Области.П002001004103.Значение
		+ Области.П002001004203.Значение;
	
	Области.П002001004303.Значение
		= Области.П002001000803.Значение + Области.П002001001503.Значение + Области.П002001001803.Значение
		+ Области.П002001002003.Значение + Области.П002001002203.Значение + Области.П002001002603.Значение
		+ Области.П002001003503.Значение + Области.П002001003703.Значение + Области.П002001003803.Значение;
...
Процедура ОчиститьТабличноеПолеНаСервере()
	...
	Если ВыбТабПоле.Области.Найти("РегистрацияРеспондента") <> Неопределено Тогда
		СписокПоказателей.Добавить(ВыбТабПоле.Области["РегистрацияРеспондента"].Значение,	 "РегистрацияРеспондента");
	КонецЕсли;
