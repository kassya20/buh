...
Процедура ПроверкаКС_20()
	...
	Заголовки.Вставить("Описание"			, НСтр("ru='Код формы реорганизации в стр.220 Раздела 3 = '") + СтрокаЗначений);
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = '") + СтрокаЗначений);
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Возможно ошибочная величина показателя'"));
