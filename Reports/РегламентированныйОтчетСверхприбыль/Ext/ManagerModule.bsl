...
Функция ТаблицаФормОтчета() Экспорт
	...
	НоваяФорма.ОписаниеОтчета     = "Приложение № 1 к приказу ФНС России от 26.09.2023 № ЕД-7-3/676@.";
	НоваяФорма.РедакцияФормы      = "от 26.09.2023 № ЕД-7-3/676@.";
...
Функция ДеревоФормИФорматов() Экспорт
	...
	"1151163", '2023-09-26', "ЕД-7-3/676@", "ФормаОтчета2024Кв1");
