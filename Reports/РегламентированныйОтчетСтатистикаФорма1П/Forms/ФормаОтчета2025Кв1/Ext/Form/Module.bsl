...
Процедура СформироватьСтруктуруРеквизитовФормы()
	...
	СтруктураРеквизитовФормы["ИмяМакетаТабличногоДокумента"] = "ФормаОтчета2025Кв1";
...
Процедура Инициализация(БезОткрытияФормы = Ложь) Экспорт
	...
	ДоступноРаспределениеВыручкиПоОКВЭД = Ложь;
	Если СтруктураРеквизитовФормы.ОтображатьКнопкуЗаполнить Тогда
		...
		РеализованаНастройкаАвтозаполняемыхПоказателей = РегламентированнаяОтчетностьПереопределяемый.РеализованаНастройкаАвтозаполняемыхПоказателейРеглОтчета(ИДОтчета, ИДРедакцииОтчета);
		Если Не РеализованаНастройкаАвтозаполняемыхПоказателей Тогда
		...
		ДоступноРаспределениеВыручкиПоОКВЭД = РеализованаНастройкаАвтозаполняемыхПоказателей
			И РегламентированнаяОтчетностьПереопределяемый.ДоступноРаспределениеВыручкиПоОКВЭД();
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "", Перерасчет = Ложь)
	...
	Если Не Перерасчет Тогда
		...
		ИначеЕсли ИмяТекущейСтраницыПанели = "Раздел6" Тогда
			...
			//Стр.616= сумме строк 617-:-620
			Области.П000060161601.Значение
				= Области.П000060161701.Значение + Области.П000060161801.Значение
				+ Области.П000060161901.Значение + Области.П000060162001.Значение;
...
Процедура РазделыОтчетаПриАктивизацииСтроки(Элемент)
	...
	Если Элемент.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Раздел7_8" И Не ДоступноРаспределениеВыручкиПоОКВЭД Тогда
		ТабличныйДокумент.Области.РаспределитьВыручкуПоОКВЭД.Текст = "";
		ТабличныйДокумент.Области.РаспределитьВыручкуПоОКВЭД.Гиперссылка = Ложь;
	КонецЕсли;
...
Процедура ВывестиНаПечатьЛист(Парам1, ОбщиеРеквизитыРазделов, СтрПоля = Неопределено)
	...
	СоответствиеРазделовМакетам.Вставить("Титульный", "ФормаОтчета2025Кв1_Титульный");
	СоответствиеРазделовМакетам.Вставить("Раздел1_2", "ФормаОтчета2025Кв1_Раздел1_2");
	СоответствиеРазделовМакетам.Вставить("Раздел3_4", "ФормаОтчета2025Кв1_Раздел3_4");
	СоответствиеРазделовМакетам.Вставить("Раздел5",   "ФормаОтчета2025Кв1_Раздел5");
	СоответствиеРазделовМакетам.Вставить("Раздел6",   "ФормаОтчета2025Кв1_Раздел6");
	СоответствиеРазделовМакетам.Вставить("Раздел7_8", "ФормаОтчета2025Кв1_Раздел7_8");
	СоответствиеРазделовМакетам.Вставить("Раздел9",   "ФормаОтчета2025Кв1_Раздел9");
	СоответствиеРазделовМакетам.Вставить("Раздел10",  "ФормаОтчета2025Кв1_Раздел10");
	СоответствиеРазделовМакетам.Вставить("Подписи",   "ФормаОтчета2025Кв1_Подписи");
...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	ОбластьИмя = ТабличныйДокумент.ТекущаяОбласть.Имя;
...
Процедура ОбработкаВыбораРаспределитьВыручкуПоОКВЭДЗавершение(Результат, ДопполнительныеПараметры) Экспорт
	...
	ЗаполнитьЗавершение(Результат, Неопределено);
