...
Процедура ОбработкаЗаписи(ИмяРегистра, 
	...
	Если ИмяРегистра = "СведенияРеглОтчетАлкоПрил40Раздел1Обороты" Тогда
	...
	Если ИмяРегистра = "СведенияРеглОтчетАлкоПрил40Раздел2Поступления" 
		ИЛИ ИмяРегистра = "СведенияРеглОтчетАлкоПрил40Раздел3Возвраты" Тогда

		ИдГруппы = ?(ИмяРегистра = "СведенияРеглОтчетАлкоПрил40Раздел2Поступления", "П0000200003", "П0000300003");
...
Процедура ЗаполнитьСведенияДекларации(НовыйУзелОбъемОборота, ИдОП,
	...
	ТекстЗапросаРаздела = "ВЫБРАТЬ
		|	РегистрСведенийАлко.*
		|ИЗ
		|	РегистрСведений.СведенияРеглОтчетАлкоПрил40Раздел2Поступления КАК РегистрСведенийАлко
		|ГДЕ
	...
	Если (ВсегоСтрокПоРазделу1 + КолСтрокПоРазделу2 <= Лимит)
		...
		Иначе
			...
			ИмяРегистра = "СведенияРеглОтчетАлкоПрил40Раздел2Поступления";
	...
	Если (ВсегоСтрокПоРазделу1 + КолСтрокПоРазделу3 <= Лимит)
		...
		Иначе
			// Формируем пустую таблицу с нужными колонками.
			ИмяРегистра = "СведенияРеглОтчетАлкоПрил40Раздел3Возвраты";
...
Функция ВерсияФорматаВыгрузки(Знач НаДату = Неопределено, ВыбраннаяФорма = Неопределено) Экспорт
	...
	Возврат Отчеты.РегламентированныйОтчетАлкоПриложение40.ВерсияФорматаВыгрузки(НаДату, ВыбраннаяФорма);
		
КонецФункции

Функция ТаблицаФормОтчета() Экспорт
	
	Возврат Отчеты.РегламентированныйОтчетАлкоПриложение40.ТаблицаФормОтчета();
	
КонецФункции

Функция ДанныеРеглОтчета(ЭкземплярРеглОтчета) Экспорт
	
	Возврат Отчеты.РегламентированныйОтчетАлкоПриложение40.ДанныеРеглОтчета(ЭкземплярРеглОтчета);
	
КонецФункции

Функция ДеревоФормИФорматов() Экспорт
	
	Возврат Отчеты.РегламентированныйОтчетАлкоПриложение40.ДеревоФормИФорматов();
