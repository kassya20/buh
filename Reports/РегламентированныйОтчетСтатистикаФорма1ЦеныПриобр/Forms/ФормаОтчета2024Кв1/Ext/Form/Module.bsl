...
Процедура ПолеТабличногоДокументаФормаОтчетаВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли Сред(Область.Имя, 1, 1) = "П" Тогда
		...
		ИначеЕсли Сред(Область.Имя, 12, 2) = "03" Тогда
			...
			ОбластьКод     = Область;
			ИмяСправочника = "l_okpd2_priobr_reg_sx_2025";
		...
		ИначеЕсли ((Сред(Область.Имя, 4, 1) = "1" И Сред(Область.Имя, 12, 2) = "05")
			...
			ОбластьКод     = Область;
			ИмяСправочника = "l_priobr_reg_sx_okei_2025";
...
Процедура СформироватьСпискиВыбора()
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "l_okpd2_priobr_reg_sx_2025",
		512, , "Выбор кода вида товара");
	
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "l_priobr_reg_sx_okei_2025",
