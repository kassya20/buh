...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если (ИмяТекущейСтраницыПанели = "Лист02_Прил1") Или (ИмяТекущейСтраницыПанели = "Лист02_Прил3") Тогда
		Группа = РегламентированнаяОтчетностьКлиент.РазделТекущейОбласти(ЭтаФорма, ТабличныйДокумент.ТекущаяОбласть);
		Если Группа <> Неопределено Тогда
			НомерСтрокиМнгЧ = Сред(ОбластьИмя, 15);
			РегламентированнаяОтчетностьКлиентСервер.СохранитьЗначениеВМногостраничномБлоке(ЭтаФорма, Группа, НомерСтрокиМнгЧ, Сред(ОбластьИмя, 1, 13), ТабличныйДокумент.ТекущаяОбласть.Значение);
		КонецЕсли;
