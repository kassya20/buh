...
Функция ТаблицаФормОтчета() Экспорт
	...
	НоваяФорма.ОписаниеОтчета     = "Приложение № 1 к приказу ФНС России от 26.04.2021 № ЕД-7-15/418@.";
	НоваяФорма.РедакцияФормы      = "от 26.04.2021 № ЕД-7-15/418@.";
...
Функция ДеревоФормИФорматов() Экспорт
	...
	"1150114", '2021-04-26', "ЕД-7-15/418@", "ФормаОтчета2021Кв3");
	ОпределитьФорматВДеревеФормИФорматов(Форма2021Кв3, "5.01");
