...
Процедура ВывестиПримечания(ПараметрыОтчета, Результат)
	...
	ЕстьПравоПросмотраКомандыСрокОплатыПоставщикам =
		ПравоДоступа("Просмотр", Метаданные.ОбщиеКоманды.СрокОплатыПоставщикам);
	...
	Если ЕстьПравоПросмотраКомандыСрокОплатыПоставщикам Тогда
