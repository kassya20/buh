...
Процедура УстановитьПоложениеЗаголовка(Форма)
	...
	ЭлементПолеРедакцияФормы = Форма.Элементы.Найти("ПолеРедакцияФормы");
	
	Если ЭлементПолеРедакцияФормы = Неопределено Тогда
		Возврат;
	КонецЕсли;
	
	Если ЭлементПолеРедакцияФормы.Видимость Тогда
