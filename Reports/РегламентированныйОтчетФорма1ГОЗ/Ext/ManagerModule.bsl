...
Функция ТаблицаФормОтчета() Экспорт
	...
	НоваяФорма.ОписаниеОтчета     = "Размещена на сайте ФАС России 22.03.2017.";
	НоваяФорма.РедакцияФормы      = "от 22.03.2017 № б/н.";
	НоваяФорма.ДатаНачалоДействия = '2018-01-01';
	НоваяФорма.ДатаКонецДействия  = '2019-12-31';
	
	НоваяФорма = ТаблицаФормОтчета.Добавить();
	НоваяФорма.ФормаОтчета        = "ФормаОтчета2020Кв1";
	НоваяФорма.ОписаниеОтчета     = "Размещена на сайте ФАС России 20.03.2020.";
	НоваяФорма.РедакцияФормы      = "от 20.03.2020 № б/н.";
...
Функция ДеревоФормИФорматов() Экспорт
	...
	Форма2018Кв1 = ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы, "ФАС1ГОЗ", '2017-03-22', "б/н", "ФормаОтчета2018Кв1");
	
	Форма2020Кв1 = ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы, "ФАС1ГОЗ", '2020-03-20', "б/н", "ФормаОтчета2020Кв1");
