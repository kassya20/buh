...
Функция ТаблицаФормОтчета() Экспорт
	...
	= "Приложение № 1 к приказу ФНС России от 28.07.2014 № ММВ-7-3/384@ (в ред. приказа ФНС России от 18.12.2020 № ЕД-7-3/926@).";
	НоваяФорма.РедакцияФормы      = "от 18.12.2020 № ЕД-7-3/926@.";
	...
	НоваяФорма.ОписаниеОтчета
	= "Приложение № 1 к приказу ФНС России от 28.07.2014 № ММВ-7-3/384@ (в ред. приказа ФНС России от 01.02.2016 № ММВ-7-3/51@).";
...
Функция ДанныеРеглОтчета(ЭкземплярРеглОтчета) Экспорт
	...
	Если ЭкземплярРеглОтчета.ВыбраннаяФорма = "ФормаОтчета2020Кв1"
...
Функция ДеревоФормИФорматов() Экспорт
	...
	"1151059", '20090622', "57н", "ФормаОтчета2009Кв1");
	...
	"1151059", '20140728', "ММВ-7-3/384@", "ФормаОтчета2014Кв1");
	ОпределитьФорматВДеревеФормИФорматов(Форма20140101, "5.03");
	
	Форма20150101 = ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы,
	"1151059", '20160201', "ММВ-7-3/51@", "ФормаОтчета2015Кв1");
	ОпределитьФорматВДеревеФормИФорматов(Форма20150101, "5.04");
	
	Форма20200101 = ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы,
	"1151059", '20201218', "ЕД-7-3/926@", "ФормаОтчета2020Кв1");
	ОпределитьФорматВДеревеФормИФорматов(Форма20200101, "5.05");
