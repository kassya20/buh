...
Процедура ПослеКомпоновкиМакета(ПараметрыОтчета, МакетКомпоновки) Экспорт
	...
	Группировка = БухгалтерскиеОтчеты.ПодобратьЭлементыИзТелаМакета(
					МакетКомпоновки, ПараметрыОтчета.КлючТекущегоВарианта, ПараметрыПоиска);
	Если Группировка <> Неопределено И Группировка.Имя = ПараметрыОтчета.КлючТекущегоВарианта Тогда
