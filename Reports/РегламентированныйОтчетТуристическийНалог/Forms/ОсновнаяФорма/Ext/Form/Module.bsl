...
Процедура ПоказатьПериод(Форма)
	...
	Если Форма.ДатаПодписи < '20260424'
		И Форма.РезультирующаяТаблица.Количество() = 2
		И СокрЛП(Форма.РезультирующаяТаблица[0].ФормаОтчета) = "ФормаОтчета2026Кв1"
		И СокрЛП(Форма.РезультирующаяТаблица[1].ФормаОтчета) = "ФормаОтчета2025Кв1" Тогда
...
Процедура ОткрытьФормуОтчета(Команда)
	Если мСкопированаФорма <> Неопределено Тогда
		Если мВыбраннаяФорма <> мСкопированаФорма Тогда
			СписокФормПоддерживающихКопирование = "ФормаОтчета2025Кв1,ФормаОтчета2026Кв1";
