...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки)
	...
	Если Год(СтруктураРеквизитовФормы.мСохраненныйДок.ДатаОкончания) >= 2026
		И СтруктураРеквизитовФормы.мСохраненныйДок.Вид = 0 И ТекущаяДатаСеанса() >= '20260329' Тогда
		
		СообщитьВТС("С 29.03.2026 представление первичной декларации по НДС на услуги иностранных организаций "
		+ "в электронной форме, начиная с отчета за период 1 квартал 2026 года, доступно только по форме в "
		+ "редакции приказа ФНС России от 19.12.2025 № ЕД-7-3/1229@", "Титульный", "НомерКорректировки");
