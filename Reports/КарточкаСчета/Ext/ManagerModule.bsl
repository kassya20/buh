...
Процедура ПередКомпоновкойМакета(ПараметрыОтчета, Схема, КомпоновщикНастроек) Экспорт
	...
	БухгалтерскиеОтчеты.ИзменитьСхемуДляОтборовПоДопСвойствамПодразделения(ПараметрыОтчета, Схема, КомпоновщикНастроек);
...
Процедура ПроверитьКорректностьИтогов(ПараметрыОтчета, Результат) Экспорт
	...
	Если КонтрольноеСоотношение <> 0 Тогда
		...
		Если БухгалтерскиеОтчеты.ИспользуютсяОборотныеСубконто(ПараметрыОтчета.Счет, ОтборыОтчета)
		 Или БухгалтерскиеОтчеты.ИспользуетсяОтборПоРегистратору(ОтборыОтчета)
		 Или БухгалтерскиеОтчеты.ИспользуетсяОтборПоРесурсам(ОтборыОтчета) Тогда
