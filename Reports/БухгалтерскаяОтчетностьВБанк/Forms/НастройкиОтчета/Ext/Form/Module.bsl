...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Первоначальные настройки видимости элементов формы.
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("РегламентированнаяОтчетность.Интерфейс85") Тогда
		...
		МодульРегламентированнаяОтчетностьИнтерфейс85.УстановитьВидФлажкаВТаблице(Элементы.ДеревоПоказатьСтраницу);
	КонецЕсли;
	...
	РегламентированнаяОтчетностьКлиентСервер.СтруктураВРеквизитДеревоЗначений(Дерево, Параметры.НастройкиСтраниц);
