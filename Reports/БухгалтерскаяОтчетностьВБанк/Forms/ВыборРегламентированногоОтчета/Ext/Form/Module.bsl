...
Процедура ОткрытьФормуНовогоБухОтчетность(ИсточникБухОтчетности)
	...
	ОписаниеДействия = ОписаниеДействияОткрытияФормыНовогоБухОтчетность(ИсточникБухОтчетности);
...
&НаСервере
Функция ОписаниеДействияОткрытияФормыНовогоБухОтчетность(Знач ИсточникБухОтчетности)
	
	ОписаниеФормыНовогоРеглОтчета = ИнтерфейсыВзаимодействияБРО.ОписаниеФормыНовогоРеглОтчета(
	...
	ОписаниеДействия.Вставить("ИмяФормы", ОписаниеФормыНовогоРеглОтчета.Имя);
	ОписаниеДействия.Вставить("ПараметрыФормы", ОписаниеФормыНовогоРеглОтчета.Параметры);
