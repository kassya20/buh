...
Функция НалоговаяСтавкаВидаПодакцизногоТовара(КодВидаПодакцизногоТовара, ДатаДействия)
	...
	ИначеЕсли ГодДействия = 2026 Тогда
		...
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "410",  5183,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "412",  5183,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "413",  5183,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "414",  5183,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "415",  5183,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "420",  5183,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "430",   351,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "440",  4992,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "441",  4992,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "442",  4992,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "471",    49,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "472", 10915,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "474",     2.4, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "475",  1030,   СтавкаВидаПТ);
		
	ИначеЕсли ГодДействия = 2027 Тогда
		
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "410",  5390,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "412",  5390,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "413",  5390,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "414",  5390,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "415",  5390,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "420",  5390,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "430",   365,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "440",  5192,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "441",  5192,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "442",  5192,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "471",    51,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "472", 11352,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "474",     2.5, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "475",  1071,   СтавкаВидаПТ);
		
	ИначеЕсли ГодДействия = 2028 Тогда
		
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "410",  5606,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "412",  5606,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "413",  5606,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "414",  5606,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "415",  5606,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "420",  5606,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "430",   380,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "440",  5400,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "441",  5400,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "442",  5400,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "471",    53,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "472", 11806,   СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "474",     2.6, СтавкаВидаПТ);
		СтавкаВидаПТ = ?(КодВидаПодакцизногоТовара = "475",  1114,   СтавкаВидаПТ);
...
Процедура СформироватьСлужебныеДанные()
	...
	Если ДанныеКС.ГодОтчета >= 2029 Тогда
		
		СтавкиСигарет = Неопределено;
		
	ИначеЕсли ДанныеКС.ГодОтчета = 2028 Тогда
		
		СтавкиСигарет.Вставить("СтавкаТвердая"		, 3545);
		СтавкиСигарет.Вставить("СтавкаАдвалорная"	, 18);
		СтавкиСигарет.Вставить("СтавкаМинимальная"	, 4815);
		
	ИначеЕсли ДанныеКС.ГодОтчета = 2027 Тогда
		
		СтавкиСигарет.Вставить("СтавкаТвердая"		, 3409);
		СтавкиСигарет.Вставить("СтавкаАдвалорная"	, 18);
		СтавкиСигарет.Вставить("СтавкаМинимальная"	, 4630);
		
	ИначеЕсли ДанныеКС.ГодОтчета = 2026 Тогда
		
		СтавкиСигарет.Вставить("СтавкаТвердая"		, 3278);
		СтавкиСигарет.Вставить("СтавкаАдвалорная"	, 18);
		СтавкиСигарет.Вставить("СтавкаМинимальная"	, 4452);
