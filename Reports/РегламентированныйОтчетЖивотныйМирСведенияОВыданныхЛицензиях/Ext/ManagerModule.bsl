...
Функция ТаблицаФормОтчета() Экспорт
	...
	НоваяФорма.ОписаниеОтчета
		= "Приложение к приказу ФНС России от 26.02.2006 № САЭ-3-21/108 (в ред. приказа ФНС России от 14.11.2013 № ММВ-7-3/501@).";
...
Функция ДеревоФормИФорматов() Экспорт
	...
	ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы,
	"1114005", '2013-11-14', "ММВ-7-3/501@", "ФормаОтчета2013Кв4", , '2024-12-31');
