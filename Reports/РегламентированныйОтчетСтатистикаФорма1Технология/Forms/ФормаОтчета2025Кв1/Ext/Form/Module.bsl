...
Функция ПолучитьМассивКатегорий()
	СтрМногострочныеЧасти = "П0010010001;П0020010202;
		|П0020010203;П0020010204;П0020010205;
		|П0020010206;П0020010207;П0020010208;
		|П0020010209;П0030010001;П0070010601";
	Возврат СтроковыеФункцииКлиентСервер.РазложитьСтрокуВМассивПодстрок(СтрМногострочныеЧасти, ";", Истина, Истина);
КонецФункции
...
Процедура ДополнитьРеквизитыФормы()
	...
	Для Каждого Стр Из КатегорииКлассификатора Цикл
		...
		Если Стр = "П0010010001" Тогда
			...
			КолвоСтрокРазделов   = 6;
			КолвоКолонокРазделов = 11;
			Для Инд = 1 По КолвоКолонокРазделов Цикл
				Если Инд = 8 Или Инд = 9 Или Инд = 10 Тогда
			...
			мСтруктураИсхКолвоСтрокРазделов.Вставить(ИмяДобавляемогоРеквизита, КолвоСтрокРазделов);
			мСтруктураКолвоКолонокРазделов.Вставить(ИмяДобавляемогоРеквизита, КолвоКолонокРазделов);
			СтруктураРеквизитовФормы.мСоответствияМнгЧ.Вставить(ИмяДобавляемогоРеквизита, "МногострочнаяЧасть1");
			
		ИначеЕсли Лев(Стр, 4) = "П002" Тогда
			
			КолвоСтрокРазделов   = 1;
			КолвоКолонокРазделов = 12;
			Для Инд = 1 По КолвоКолонокРазделов Цикл
				Если Инд = 1 Или Инд = 2 Или Инд = 3 Тогда
					ТипКолонки = Новый ОписаниеТипов("Строка");
				Иначе
					ТипКолонки = Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(10, 0));
				КонецЕсли;
			...
			НомМнг = Сред(Стр,11, 1);
			
			ИзменитьРеквизиты(ДобавляемыеРеквизиты);
			СтруктураРеквизитовФормы.Вставить("мИдГруппы" + НомМнг, ИмяДобавляемогоРеквизита);
			мСтруктураМногострочныхРазделов.Вставить(ИмяДобавляемогоРеквизита, ИмяДобавляемогоРеквизита);
			мСтруктураИсхКолвоСтрокРазделов.Вставить(ИмяДобавляемогоРеквизита, КолвоСтрокРазделов);
			мСтруктураКолвоКолонокРазделов.Вставить(ИмяДобавляемогоРеквизита, КолвоКолонокРазделов);
			СтруктураРеквизитовФормы.мСоответствияМнгЧ.Вставить(ИмяДобавляемогоРеквизита, "МногострочнаяЧасть" + НомМнг);
			
		ИначеЕсли Стр = "П0030010001" Тогда
			
			КолвоСтрокРазделов   = 3;
			КолвоКолонокРазделов = 4;
			Для Инд = 1 По КолвоКолонокРазделов Цикл
				ТипКолонки = Новый ОписаниеТипов("Строка");
				ДобавляемыйРеквизит = Новый РеквизитФормы(
					ИмяДобавляемогоРеквизита + Формат(Инд, "ЧЦ=2; ЧВН="), ТипКолонки, ИмяДобавляемогоРеквизита);
		...
		ИначеЕсли Стр = "П0070010601" Тогда
			
			КолвоСтрокРазделов   = 2;
			КолвоКолонокРазделов = 3;
			Для Инд = 1 По КолвоКолонокРазделов Цикл
				ТипКолонки = Новый ОписаниеТипов("Строка");
				ДобавляемыйРеквизит = Новый РеквизитФормы(
					ИмяДобавляемогоРеквизита + Формат(Инд, "ЧЦ=2; ЧВН="), ТипКолонки, ИмяДобавляемогоРеквизита);
			...
			ИзменитьРеквизиты(ДобавляемыеРеквизиты);
			СтруктураРеквизитовФормы.Вставить("мИдГруппы11", ИмяДобавляемогоРеквизита);
			мСтруктураМногострочныхРазделов.Вставить(ИмяДобавляемогоРеквизита, ИмяДобавляемогоРеквизита);
			мСтруктураИсхКолвоСтрокРазделов.Вставить(ИмяДобавляемогоРеквизита, КолвоСтрокРазделов);
			мСтруктураКолвоКолонокРазделов.Вставить(ИмяДобавляемогоРеквизита, КолвоКолонокРазделов);
			СтруктураРеквизитовФормы.мСоответствияМнгЧ.Вставить(ИмяДобавляемогоРеквизита, "МногострочнаяЧасть11");
...
Процедура ПолеТабличногоДокументаФормаОтчетаВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	Иначе
		...
		Если СтрНайти(Область.Имя, "П001001000101_") = 1 Или СтрНайти(Область.Имя, "П001001000104_") = 1 Тогда
			Область           = ПолеТабличногоДокументаФормаОтчета.Области.Найти(СтрЗаменить(Область.Имя, Лев(Область.Имя, 11) + "01_", Лев(Область.Имя, 11) + "04_"));
			СмежнаяОбласть    = ПолеТабличногоДокументаФормаОтчета.Области.Найти(СтрЗаменить(Область.Имя, Лев(Область.Имя, 11) + "04_", Лев(Область.Имя, 11) + "01_"));
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "ГруппаПередовыхТехнологий");
		ИначеЕсли СтрНайти(Область.Имя, "П001001000105_") = 1 Тогда
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "ОКВЭД");
		ИначеЕсли СтрНайти(Область.Имя, "П001001000106_") = 1 Тогда
		...
		ИначеЕсли СтрНайти(Область.Имя, "П002001") = 1 И (Сред(Область.Имя, 12, 2) = "01" Или Сред(Область.Имя, 12, 2) = "03") Тогда
			Группа = "";
			НомСтроки = Сред(Область.Имя, 9, 3);
			Если НомСтроки = "202" Тогда
				Группа = "1000";
			ИначеЕсли НомСтроки = "203" Тогда
				Группа = "2000";
			ИначеЕсли НомСтроки = "204" Тогда
				Группа = "3000";
			ИначеЕсли НомСтроки = "205" Тогда
				Группа = "4000";
			ИначеЕсли НомСтроки = "206" Тогда
				Группа = "5000";
			ИначеЕсли НомСтроки = "207" Тогда
				Группа = "6000";
			ИначеЕсли НомСтроки = "208" Тогда
				Группа = "7000";
			ИначеЕсли НомСтроки = "209" Тогда
				Группа = "9000";
			КонецЕсли;
			Область           = ПолеТабличногоДокументаФормаОтчета.Области.Найти(СтрЗаменить(Область.Имя, Лев(Область.Имя, 11) + "01_", Лев(Область.Имя, 11) + "03_"));
			...
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "ГруппаПередовыхТехнологий" + Группа);
		ИначеЕсли СтрНайти(Область.Имя, "П0030010001") = 1 Тогда
			Если Сред(Область.Имя, 12, 2) = "01" Или Сред(Область.Имя, 12, 2) = "03" Тогда
				Область           = ПолеТабличногоДокументаФормаОтчета.Области.Найти(СтрЗаменить(Область.Имя, Лев(Область.Имя, 11) + "01_", Лев(Область.Имя, 11) + "03_"));
				СмежнаяОбласть    = ПолеТабличногоДокументаФормаОтчета.Области.Найти(СтрЗаменить(Область.Имя, Лев(Область.Имя, 11) + "03_", Лев(Область.Имя, 11) + "01_"));
				ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(ЭтотОбъект, "ГруппаПередовыхТехнологий");
			КонецЕсли;
		ИначеЕсли Лев(Область.Имя, 8) = "П0040010" Тогда
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(
				ЭтотОбъект, "СправочникЭффектыВнедрения");
		ИначеЕсли Лев(Область.Имя, 8) = "П0050010" Тогда
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(
				ЭтотОбъект, "СправочникДаНет");
		ИначеЕсли Лев(Область.Имя, 8) = "П0060010" Тогда
			ПараметрВводаПоля = РегламентированнаяОтчетностьКлиентСервер.НайтиСвойстваПоказателя(
...
Процедура ПеренумерацияСтрокТаблицы(ЭтотОбъект)
	...
	Ячейка1 = Области["П001001000102_1"];
	Если Не ЗначениеЗаполнено(Ячейка1.Значение) Тогда
		Ячейка1.Значение = "101";
	КонецЕсли;
	
	Ячейка2 = Области["П003001000102_1"];
	Если Не ЗначениеЗаполнено(Ячейка2.Значение) Тогда
		Ячейка2.Значение = "230";
	КонецЕсли;
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	//По строкам 201–209:
	//гр. 4 = сумме граф 5, 6, 7, 8;
	Для Стр = 201 По 209 Цикл
		Если Стр > 201 Тогда
			Инд = 0;
			Пока Истина Цикл
				Инд = Инд + 1;
				ИндСтр = Формат(Инд, "ЧГ=");
				ОблГр4 = Области.Найти("П0020010" + Стр + "04_" + ИндСтр);
				Если ОблГр4 = Неопределено Тогда
					Прервать;
				КонецЕсли;
				СуммаПоГрафам = 0;
				Для Гр = 5 По 8 Цикл
					Графа = Формат(Гр, "ЧЦ=2; ЧВН=");
					СуммаПоГрафам = СуммаПоГрафам + Области["П0020010" + Стр + Графа + "_" + ИндСтр].Значение;
				КонецЦикла;
				ОблГр4.Значение = СуммаПоГрафам;
			КонецЦикла;
		КонецЕсли;
		Области["П0020010" + Стр + "04"].Значение
			= Области["П0020010" + Стр + "05"].Значение
			+ Области["П0020010" + Стр + "06"].Значение
			+ Области["П0020010" + Стр + "07"].Значение
			+ Области["П0020010" + Стр + "08"].Значение;
	КонецЦикла;
	...
	Для Стр = 201 По 209 Цикл
		Если Стр > 201 Тогда
			...
			Пока Истина Цикл
				Инд = Инд + 1;
				ИндСтр = Формат(Инд, "ЧГ=");
				ОблГр4 = мФормаОтчета.Области.Найти("П0020010" + Стр + "04_" + ИндСтр);
				Если ОблГр4 = Неопределено Тогда
					Прервать;
				КонецЕсли;
				мФормаОтчета.Области["П0020010" + Стр + "04_" + ИндСтр].ЦветФона = ЦветФонаЗначение;
				мФормаОтчета.Области["П0020010" + Стр + "04_" + ИндСтр].Защита   = Не ОтклАвтоРасчетЗначение;
			КонецЦикла;
		КонецЕсли;
		мФормаОтчета.Области["П0020010" + Стр + "04"].ЦветФона = ЦветФонаЗначение;
		мФормаОтчета.Области["П0020010" + Стр + "04"].Защита   = Не ОтклАвтоРасчетЗначение;
	КонецЦикла;
...
Функция ПечатьНаСервере(ВидПечати)
	...
	Пока ТекущийВерх <= НизМногострочнойЧасти Цикл
		...
		МассивПроверки.Добавить(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть1_3"));
	...
	ВерхСтрокиМнгЧасти = ТабличныйДокумент.Области.ОсновнаяЧасть2_3.Низ + 1;
	ТекущаяОбластьМногострочнойЧасти = ТабличныйДокумент.ПолучитьОбласть(ВерхСтрокиМнгЧасти, , ВерхСтрокиМнгЧасти);
	МассивПроверки.Добавить(ТекущаяОбластьМногострочнойЧасти);
	...
	ВерхСтрокиМнгЧасти = ТабличныйДокумент.Области.ОсновнаяЧасть2_4.Низ + 1;
	ТекущаяОбластьМногострочнойЧасти = ТабличныйДокумент.ПолучитьОбласть(ВерхСтрокиМнгЧасти, , ВерхСтрокиМнгЧасти);
	МассивПроверки.Добавить(ТекущаяОбластьМногострочнойЧасти);
	...
	МассивПроверки = Новый Массив;
	МассивПроверки.Добавить(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть2_5"));
	ВерхСтрокиМнгЧасти = ТабличныйДокумент.Области.ОсновнаяЧасть2_5.Низ + 1;
	ТекущаяОбластьМногострочнойЧасти = ТабличныйДокумент.ПолучитьОбласть(ВерхСтрокиМнгЧасти, , ВерхСтрокиМнгЧасти);
	МассивПроверки.Добавить(ТекущаяОбластьМногострочнойЧасти);
	...
	МассивПроверки = Новый Массив;
	МассивПроверки.Добавить(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть2_6"));
	ВерхСтрокиМнгЧасти = ТабличныйДокумент.Области.ОсновнаяЧасть2_6.Низ + 1;
	ТекущаяОбластьМногострочнойЧасти = ТабличныйДокумент.ПолучитьОбласть(ВерхСтрокиМнгЧасти, , ВерхСтрокиМнгЧасти);
	МассивПроверки.Добавить(ТекущаяОбластьМногострочнойЧасти);
	...
	МассивПроверки = Новый Массив;
	МассивПроверки.Добавить(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть2_7"));
	ВерхСтрокиМнгЧасти = ТабличныйДокумент.Области.ОсновнаяЧасть2_7.Низ + 1;
	ТекущаяОбластьМногострочнойЧасти = ТабличныйДокумент.ПолучитьОбласть(ВерхСтрокиМнгЧасти, , ВерхСтрокиМнгЧасти);
	МассивПроверки.Добавить(ТекущаяОбластьМногострочнойЧасти);
	...
	МассивПроверки = Новый Массив;
	МассивПроверки.Добавить(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть2_8"));
	ВерхСтрокиМнгЧасти = ТабличныйДокумент.Области.ОсновнаяЧасть2_8.Низ + 1;
	ТекущаяОбластьМногострочнойЧасти = ТабличныйДокумент.ПолучитьОбласть(ВерхСтрокиМнгЧасти, , ВерхСтрокиМнгЧасти);
	МассивПроверки.Добавить(ТекущаяОбластьМногострочнойЧасти);
	...
	ПечатнаяФорма.Вывести(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть2_8"));
	ВерхМногострочнойЧасти = ТабличныйДокумент.Области.ОсновнаяЧасть2_8.Низ + 1;
	...
	МассивПроверки = Новый Массив;
	МассивПроверки.Добавить(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть2_9"));
	ВерхСтрокиМнгЧасти = ТабличныйДокумент.Области.ОсновнаяЧасть2_9.Низ + 1;
	ТекущаяОбластьМногострочнойЧасти = ТабличныйДокумент.ПолучитьОбласть(ВерхСтрокиМнгЧасти, , ВерхСтрокиМнгЧасти);
	МассивПроверки.Добавить(ТекущаяОбластьМногострочнойЧасти);
	...
	ПечатнаяФорма.Вывести(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть2_9"));
	ВерхМногострочнойЧасти = ТабличныйДокумент.Области.ОсновнаяЧасть2_9.Низ + 1;
	...
	МассивПроверки = Новый Массив;
	МассивПроверки.Добавить(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть2_10"));
	ВерхСтрокиМнгЧасти = ТабличныйДокумент.Области.ОсновнаяЧасть2_10.Низ + 1;
	ТекущаяОбластьМногострочнойЧасти = ТабличныйДокумент.ПолучитьОбласть(ВерхСтрокиМнгЧасти, , ВерхСтрокиМнгЧасти);
	МассивПроверки.Добавить(ТекущаяОбластьМногострочнойЧасти);
	МассивПроверки.Добавить(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть2_11"));
	...
	ПечатнаяФорма.Вывести(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть2_10"));
	ВерхМногострочнойЧасти = ТабличныйДокумент.Области.ОсновнаяЧасть2_10.Низ + 1;
	...
	Пока ТекущийВерх <= НизМногострочнойЧасти Цикл
		...
		ТекущийВерх = ТекущийВерх + 1;
	КонецЦикла;
	ПечатнаяФорма.Вывести(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть2_11"));
	СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 1-технология");
	...
	Область3_10 = ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть3_3");
	...
	НизМногострочнойЧасти = ТабличныйДокумент.Области.ДобавлениеСтроки11.Верх - 1;
	ТекущийВерх = ВерхМногострочнойЧасти;
	Пока ТекущийВерх <= НизМногострочнойЧасти Цикл
		ТекущаяОбластьМногострочнойЧасти = ТабличныйДокумент.ПолучитьОбласть(ТекущийВерх, , ТекущийВерх);
		Если ПечатнаяФорма.ПроверитьВывод(ТекущаяОбластьМногострочнойЧасти) Тогда
...
Процедура СформироватьСпискиВыбора()
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ГруппаПередовыхТехнологий1000",
		512, , "Выбор кода группы технологий", КоллекцияСписковВыбора["s_teh1000"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ГруппаПередовыхТехнологий2000",
		512, , "Выбор кода группы технологий", КоллекцияСписковВыбора["s_teh2000"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ГруппаПередовыхТехнологий3000",
		512, , "Выбор кода группы технологий", КоллекцияСписковВыбора["s_teh3000"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ГруппаПередовыхТехнологий4000",
		512, , "Выбор кода группы технологий", КоллекцияСписковВыбора["s_teh4000"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ГруппаПередовыхТехнологий5000",
		512, , "Выбор кода группы технологий", КоллекцияСписковВыбора["s_teh5000"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ГруппаПередовыхТехнологий6000",
		512, , "Выбор кода группы технологий", КоллекцияСписковВыбора["s_teh6000"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ГруппаПередовыхТехнологий7000",
		512, , "Выбор кода группы технологий", КоллекцияСписковВыбора["s_teh7000"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ГруппаПередовыхТехнологий9000",
		512, , "Выбор кода группы технологий", КоллекцияСписковВыбора["s_teh9000"]);
...
Процедура ЗаполнитьДанными(ДеревоВыгрузки, ПараметрыВыгрузки) Экспорт 
	...
	Пока Истина Цикл
		Инд = Инд + 1;
		ИндСтр = Формат(Инд, "ЧГ=");
		Если Не ПараметрыВыгрузки.Свойство("П001001000101_" + ИндСтр) Тогда
			Прервать;
		КонецЕсли;
		Если ЗначениеЗаполнено(ПараметрыВыгрузки["П001001000104_" + ИндСтр]) Или ЗначениеЗаполнено(ПараметрыВыгрузки["П001001000105_" + ИндСтр]) Тогда
			ПараметрыВыгрузки.Вставить("ПД01001000112_" + ИндСтр, "1");
		КонецЕсли;
	КонецЦикла;
	...
	Пока Истина Цикл
		Инд = Инд + 1;
		ИндСтр = Формат(Инд, "ЧГ=");
		Если Не ПараметрыВыгрузки.Свойство("П007001060103_" + ИндСтр) Тогда
			Прервать;
		КонецЕсли;
		Если ЗначениеЗаполнено(ПараметрыВыгрузки["П007001060103_" + ИндСтр]) Тогда
			ПараметрыВыгрузки.Вставить("ПД07001060104_" + ИндСтр, "1");
		КонецЕсли;
	КонецЦикла;
