	...
	Для Каждого Лист Из СведенияОтчета.ДанныеМногостраничныхРазделов.Раздел1 Цикл
		...
		Для Инд = 1 По 3 Цикл
			...
			ЗначениеПоказателя = ЗначениеПоказателя
			                   + РегламентированнаяОтчетность.ПоказательОтчета(ДанныеЛиста, "СуммаРаздел1" + Постфикс)
			                   - РегламентированнаяОтчетность.ПоказательОтчета(ДанныеЛиста, "СуммаВозмещенияРаздел1" + Постфикс);
		КонецЦикла;
	КонецЦикла;
