...
Функция УниверсальнаяВыгрузка(Текст = Неопределено, ПроверятьБлокировки = Истина, ПроверятьВозможностьВыгрузки = Истина) Экспорт
	...
	Возврат УниверсальнаяВыгрузкаНаСервере(Текст, ПакетнаяВыгрузка, ПутьВыгрузки, ПроверятьВозможностьВыгрузки);
	
КонецФункции

&НаСервере
Функция УниверсальнаяВыгрузкаНаСервере(Текст, ПакетнаяВыгрузка, ПутьВыгрузки, ПроверятьВозможностьВыгрузки)
