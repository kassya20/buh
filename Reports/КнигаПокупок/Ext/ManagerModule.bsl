...
Функция ТекстЗапросаПодготовленныеЗаписиКнигиПокупок(СтруктураПараметров)
	...
	|
	|ВЫБРАТЬ
	|	ПодготовленныеЗаписиКнигиПокупок.Организация КАК Ссылка,
	|	ПодготовленныеЗаписиКнигиПокупок.ДатаСчетаФактурыСортировка КАК ДатаСведений
	|ИЗ
	|	ПодготовленныеЗаписиКнигиПокупок КАК ПодготовленныеЗаписиКнигиПокупок
	|
...
Функция ТекстЗапросаКнигаПокупок(СтруктураПараметров)
	...
	|		ИНАЧЕ ВЫБОР
	|				КОГДА ПодготовленныеЗаписиКнигиПокупок.СводныйКорректировочный
	|						И ЕСТЬNULL(СведенияОКонтрагентеНаДату.ИНН, """") = """"
	|					ТОГДА ЕСТЬNULL(СведенияОбОрганизацииНаДату.ИНН, """")
	...
	|				КОГДА ПодготовленныеЗаписиКнигиПокупок.СводныйКорректировочный
	|						И ЕСТЬNULL(СведенияОКонтрагентеНаДату.ИНН, """") = """"
	|					ТОГДА ЕСТЬNULL(СведенияОбОрганизацииНаДату.КПП, """")
	|				КОГДА ПодготовленныеЗаписиКнигиПокупок.Контрагент ССЫЛКА Справочник.Организации
	...
	|		КОГДА ПодготовленныеЗаписиКнигиПокупок.СводныйКорректировочный
	|				И ЕСТЬNULL(СведенияОКонтрагентеНаДату.ИНН, """") = """"
	|			ТОГДА ЕСТЬNULL(СведенияОбОрганизацииНаДату.Наименование, """")
	|		ИНАЧЕ ЕСТЬNULL(СведенияОКонтрагентеНаДату.Наименование, """")
	|	КОНЕЦ КАК Продавец,
	...
	|				И ЕСТЬNULL(СведенияОКонтрагентеНаДату.ИНН, """") = """"
	|			ТОГДА ""17""
	|		ИНАЧЕ ПодготовленныеЗаписиКнигиПокупок.КодВидаОперации
	|	КОНЕЦ КАК КодВидаОперации,
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ СведенияОСсылкахНаДаты КАК СведенияОбОрганизацииНаДату
	|		ПО ПодготовленныеЗаписиКнигиПокупок.Организация = СведенияОбОрганизацииНаДату.Ссылка
	|			И ПодготовленныеЗаписиКнигиПокупок.ДатаСчетаФактурыСортировка = СведенияОбОрганизацииНаДату.ДатаСведений
