...
Процедура ТабличныйДокументПриАктивизации(Элемент)
	...
	Если СтрЧислоВхождений(ТабличныйДокумент.ТекущаяОбласть.Имя, "П0000100163") > 0
	 ИЛИ СтрЧислоВхождений(ТабличныйДокумент.ТекущаяОбласть.Имя, "П0000100164") > 0
	 ИЛИ СтрЧислоВхождений(ТабличныйДокумент.ТекущаяОбласть.Имя, "П0000100165") > 0
	 ИЛИ СтрЧислоВхождений(ТабличныйДокумент.ТекущаяОбласть.Имя, "П0000700121") > 0
	 ИЛИ СтрЧислоВхождений(ТабличныйДокумент.ТекущаяОбласть.Имя, "П0000700122") > 0
	 ИЛИ СтрЧислоВхождений(ТабличныйДокумент.ТекущаяОбласть.Имя, "П0000700123") > 0
	 ИЛИ СтрЧислоВхождений(ТабличныйДокумент.ТекущаяОбласть.Имя, "П0003100010") > 0
	 ИЛИ СтрЧислоВхождений(ТабличныйДокумент.ТекущаяОбласть.Имя, "П0004500001") > 0 Тогда
