...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбработкаНовостейПереопределяемый.КонтекстныеНовости_ПриСозданииНаСервере(
		ЭтотОбъект,
		"БП.Отчет.ДинамикаЗадолженностиПоставщикам",
		"ФормаОтчета",
		НСтр("ru='Новости: Динамика задолженности поставщикам'"),
		"ПриОткрытии");
...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	Название = ?(ЗначениеЗаполнено(Форма.ПредставлениеТекущегоВарианта), Форма.ПредставлениеТекущегоВарианта, НСтр("ru='Динамика задолженности по срокам долга'"));
